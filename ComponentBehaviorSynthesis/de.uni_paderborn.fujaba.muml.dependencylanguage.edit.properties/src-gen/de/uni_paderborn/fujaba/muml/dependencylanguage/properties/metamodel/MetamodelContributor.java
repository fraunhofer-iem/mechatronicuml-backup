package de.uni_paderborn.fujaba.muml.dependencylanguage.properties.metamodel;
...
public class MetamodelContributor
	...
	protected void fillItemProviderFactories(
		...
		factories
				.add(new de.uni_paderborn.fujaba.muml.dependencylanguage.provider.DependencylanguageItemProviderAdapterFactory());
