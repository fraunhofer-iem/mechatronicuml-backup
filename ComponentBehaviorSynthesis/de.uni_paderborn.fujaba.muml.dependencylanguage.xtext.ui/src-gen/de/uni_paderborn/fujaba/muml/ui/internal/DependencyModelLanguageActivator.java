...
public class DependencyModelLanguageActivator extends AbstractUIPlugin {
	...
	private static DependencyModelLanguageActivator INSTANCE;
	...
	public static DependencyModelLanguageActivator getInstance() {
		return INSTANCE;
	}
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_UNI_PADERBORN_FUJABA_MUML_DEPENDENCYMODELLANGUAGE.equals(grammar)) {
			return new de.uni_paderborn.fujaba.muml.DependencyModelLanguageRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (DE_UNI_PADERBORN_FUJABA_MUML_DEPENDENCYMODELLANGUAGE.equals(grammar)) {
			return new de.uni_paderborn.fujaba.muml.ui.DependencyModelLanguageUiModule(this);
		}
