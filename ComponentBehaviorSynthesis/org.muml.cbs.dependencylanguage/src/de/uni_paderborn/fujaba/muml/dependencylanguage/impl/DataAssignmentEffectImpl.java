 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getAnnotations <em>Annotation</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getExtensions <em>Extension</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getAssignOperator <em>Assign Operator</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getRhs_assignExpression <em>Rhs assign Expression</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getIncrementDecrementOperator <em>Increment Decrement Operator</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getLhs_typedNamedElementExpression <em>Lhs typed Named Element Expression</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.impl.DataAssignmentEffectImpl#getDirection <em>Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
