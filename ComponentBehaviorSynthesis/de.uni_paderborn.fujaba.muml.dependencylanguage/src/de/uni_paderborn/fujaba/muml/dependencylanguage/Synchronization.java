 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getSendingEvents <em>Sending Events</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getReceivingEvents <em>Receiving Events</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getChannelName <em>Channel Name</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getSelectorType <em>Selector Type</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getGeneralSelectorExpression <em>General Selector Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getSynchronization()
 * @model
 * @generated
 */
public interface Synchronization extends Dependency {
	 ...
	 * The list contents are of type {@link de.uni_paderborn.fujaba.muml.dependencylanguage.Event}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getSynchronization_SendingEvents()
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getSynchronization_ReceivingEvents()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getSynchronization_ChannelName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getChannelName <em>Channel Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getSynchronization_SelectorType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getSelectorType <em>Selector Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getSynchronization_GeneralSelectorExpression()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.dependencylanguage.Synchronization#getGeneralSelectorExpression <em>General Selector Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
