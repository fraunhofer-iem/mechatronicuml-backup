 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#getFromEvent <em>From Event</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#isInitialEnabled <em>Initial Enabled</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#getUntilEvent <em>Until Event</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#isEnabledInfite <em>Enabled Infite</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getEventConstrainedIntervalCondition()
 * @model
 * @generated
 */
public interface EventConstrainedIntervalCondition extends Condition {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getEventConstrainedIntervalCondition_FromEvent()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#getFromEvent <em>From Event</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getEventConstrainedIntervalCondition_InitialEnabled()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#isInitialEnabled <em>Initial Enabled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getEventConstrainedIntervalCondition_UntilEvent()
	 * @model containment="true"
	 * @generated
	 */
	Event getUntilEvent();
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#getUntilEvent <em>Until Event</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.dependencylanguage.DependencylanguagePackage#getEventConstrainedIntervalCondition_EnabledInfite()
	 * @model default="false" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.dependencylanguage.EventConstrainedIntervalCondition#isEnabledInfite <em>Enabled Infite</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
