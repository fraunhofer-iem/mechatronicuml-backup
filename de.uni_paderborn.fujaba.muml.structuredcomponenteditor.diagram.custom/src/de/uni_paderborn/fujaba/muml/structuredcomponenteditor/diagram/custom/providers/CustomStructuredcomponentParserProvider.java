...
import de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.providers.StructuredcomponentParserProvider;

public class CustomStructuredcomponentParserProvider extends
		StructuredcomponentParserProvider {

	private de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.custom.parsers.CustomComponentPartLabelExpressionLabelParser componentPartLabel_5003Parser;

	private IParser getComponentPartLabel_5003Parser() {
		if (componentPartLabel_5003Parser == null) {
			componentPartLabel_5003Parser = new de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.custom.parsers.CustomComponentPartLabelExpressionLabelParser();
		}
