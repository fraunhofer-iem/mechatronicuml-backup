 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.psm.muml_container.impl.SystemConfigurationImpl#getSystemAllocation <em>System Allocation</em>}</li>
 *   <li>{@link org.muml.psm.muml_container.impl.SystemConfigurationImpl#getEcuConfigurations <em>Ecu Configurations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemConfigurationImpl extends MinimalEObjectImpl.Container implements SystemConfiguration {
	...
	protected EClass eStaticClass() {
		return Muml_containerPackage.Literals.SYSTEM_CONFIGURATION;
	}
		...
		if (systemAllocation != null && systemAllocation.eIsProxy()) {
			...
			if (systemAllocation != oldSystemAllocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Muml_containerPackage.SYSTEM_CONFIGURATION__SYSTEM_ALLOCATION, oldSystemAllocation, systemAllocation));
			}
		}
	...
	public void setSystemAllocation(SystemAllocation newSystemAllocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Muml_containerPackage.SYSTEM_CONFIGURATION__SYSTEM_ALLOCATION, oldSystemAllocation, systemAllocation));
	}
	...
	public EList<ECUConfiguration> getEcuConfigurations() {
		if (ecuConfigurations == null) {
			ecuConfigurations = new EObjectContainmentEList<ECUConfiguration>(ECUConfiguration.class, this, Muml_containerPackage.SYSTEM_CONFIGURATION__ECU_CONFIGURATIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Muml_containerPackage.SYSTEM_CONFIGURATION__SYSTEM_ALLOCATION:
