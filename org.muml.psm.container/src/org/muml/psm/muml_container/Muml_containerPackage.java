...
public interface Muml_containerPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int COMPONENT_CONTAINER___PROVIDE_EXTENSION__ECLASS = CorePackage.NAMED_ELEMENT___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int COMPONENT_CONTAINER___GET_ANNOTATION__STRING = CorePackage.NAMED_ELEMENT___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int COMPONENT_CONTAINER___PROVIDE_ANNOTATION__STRING = CorePackage.NAMED_ELEMENT___PROVIDE_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int ECU_CONFIGURATION___PROVIDE_EXTENSION__ECLASS = CorePackage.NAMED_ELEMENT___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int ECU_CONFIGURATION___GET_ANNOTATION__STRING = CorePackage.NAMED_ELEMENT___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int ECU_CONFIGURATION___PROVIDE_ANNOTATION__STRING = CorePackage.NAMED_ELEMENT___PROVIDE_ANNOTATION__STRING;
