package de.uni_paderborn.uppaal.types.qvto;
...
public class PredefinedTypeLibrary {
	...
	private void getLibrary()
	{
		if (LIBRARY == null)
		{
			...
			Resource res = set.getResource(URI.createURI("platform:/plugin/de.uni_paderborn.uppaal/model/stdlib.xmi", false), true);
