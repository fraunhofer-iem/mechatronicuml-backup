...
public class Pattern2ElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType CoordinationPattern_3001 = getElementType("de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.CoordinationPattern_3001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public static final IElementType RoleCoordinationProtocol_4001 = getElementType("de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.RoleCoordinationProtocol_4001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType RoleConnector_4002 = getElementType("de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.RoleConnector_4002"); //$NON-NLS-1$
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(RoleCoordinationProtocol_4001);
	...
	public static IElementType getElementType(int visualID) {
		...
		case RoleCoordinationProtocolEditPart.VISUAL_ID:
			return RoleCoordinationProtocol_4001;
