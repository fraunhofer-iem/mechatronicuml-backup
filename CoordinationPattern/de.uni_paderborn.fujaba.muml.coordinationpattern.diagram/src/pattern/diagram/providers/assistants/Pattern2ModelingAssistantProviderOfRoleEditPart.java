...
public class Pattern2ModelingAssistantProviderOfRoleEditPart extends
	...
	public List<IElementType> doGetRelTypesOnSource(RoleEditPart source) {
		...
		types.add(Pattern2ElementTypes.RoleConnector_4002);
		return types;
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof CoordinationPattern2EditPart) {
			types.add(Pattern2ElementTypes.RoleCoordinationProtocol_4001);
		}
	...
	public List<IElementType> doGetTypesForTarget(RoleEditPart source,
		...
		} else if (relationshipType == Pattern2ElementTypes.RoleConnector_4002) {
	...
	public List<IElementType> doGetTypesForSource(RoleEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == Pattern2ElementTypes.RoleConnector_4002) {
			types.add(Pattern2ElementTypes.Role_3002);
		}
		return types;
	}
