 ...
 * @generated
 */
public abstract class Pattern2AbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = Pattern2DiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected Pattern2AbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
