...
import pattern.diagram.edit.policies.Pattern2TextSelectionEditPolicy;
...
public class CoordinationPatternNameEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new Pattern2TextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Pattern2ParserProvider
					.getParser(
							Pattern2ElementTypes.CoordinationPattern_3001,
							getParserElement(),
							Pattern2VisualIDRegistry
									.getType(pattern.diagram.edit.parts.CoordinationPatternNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					Pattern2EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
