...
public class RoleItemSemanticEditPolicy extends
	...
	public RoleItemSemanticEditPolicy() {
		super(Pattern2ElementTypes.Role_3002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Pattern2VisualIDRegistry.getVisualID(incomingLink) == RoleConnectorEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Pattern2VisualIDRegistry.getVisualID(outgoingLink) == RoleCoordinationProtocolEditPart.VISUAL_ID) {
			...
			if (Pattern2VisualIDRegistry.getVisualID(outgoingLink) == RoleConnectorEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (Pattern2ElementTypes.RoleConnector_4002 == req.getElementType()) {
