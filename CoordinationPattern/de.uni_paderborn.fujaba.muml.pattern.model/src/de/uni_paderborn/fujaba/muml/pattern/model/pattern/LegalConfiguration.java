 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.LegalConfiguration#getParameterBindings <em>Parameter Bindings</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.LegalConfiguration#getCoordinationPattern <em>Coordination Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.pattern.model.pattern.PatternPackage#getLegalConfiguration()
 * @model
 * @generated
 */
public interface LegalConfiguration extends NamedElement, CommentableElement {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.pattern.model.pattern.PatternPackage#getLegalConfiguration_ParameterBindings()
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.CoordinationPattern#getLegalConfigurations <em>Legal Configurations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.pattern.model.pattern.PatternPackage#getLegalConfiguration_CoordinationPattern()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.LegalConfiguration#getCoordinationPattern <em>Coordination Pattern</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
