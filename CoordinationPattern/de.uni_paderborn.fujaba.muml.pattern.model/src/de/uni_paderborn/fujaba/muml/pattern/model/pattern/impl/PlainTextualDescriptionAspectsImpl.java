 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getOverview <em>Overview</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getContext <em>Context</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getProblem <em>Problem</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getSolution <em>Solution</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getBehavior <em>Behavior</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getConsequences <em>Consequences</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getCombineability <em>Combineability</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getVariants <em>Variants</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.model.pattern.impl.PlainTextualDescriptionAspectsImpl#getAlternatives <em>Alternatives</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlainTextualDescriptionAspectsImpl extends EObjectImpl implements PlainTextualDescriptionAspects {
	/**
