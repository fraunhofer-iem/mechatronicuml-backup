...
import pattern.diagram.part.Pattern2DiagramEditor;
 ...
 * @generated
 */
public class Pattern2NavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof Pattern2NavigatorItem) {
					selectedElement = ((Pattern2NavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, Pattern2DiagramEditor.ID);
