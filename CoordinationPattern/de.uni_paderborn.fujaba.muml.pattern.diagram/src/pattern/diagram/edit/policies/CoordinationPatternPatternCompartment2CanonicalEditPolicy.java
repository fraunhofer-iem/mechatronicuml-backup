 ...
 * @generated
 */
public class CoordinationPatternPatternCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {

	private boolean canonicalNodes = true;

	public CoordinationPatternPatternCompartment2CanonicalEditPolicy() {
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return Pattern2DiagramUpdater
				.getCoordinationPatternPatternCompartment_7002SemanticChildren(viewObject);
