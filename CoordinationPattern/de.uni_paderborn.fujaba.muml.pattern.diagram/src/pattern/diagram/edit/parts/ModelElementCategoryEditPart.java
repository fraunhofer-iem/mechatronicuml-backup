...
import pattern.diagram.edit.policies.ModelElementCategoryCanonicalEditPolicy;
import pattern.diagram.edit.policies.ModelElementCategoryItemSemanticEditPolicy;
...
public class ModelElementCategoryEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Pattern2"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ModelElementCategoryItemSemanticEditPolicy());
		...
		installEditPolicy("CustomCanonical",
				new ModelElementCategoryCanonicalEditPolicy(false));
