...
import pattern.diagram.part.Pattern2DiagramEditorUtil;

/**
 * @generated
 */
public class Pattern2MarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = Pattern2DiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			Pattern2DiagramEditorUtil.selectElementsInDiagram(editor,
