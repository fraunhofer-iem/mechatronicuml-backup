...
public class Pattern2ModelingAssistantProviderOfCoordinationPattern2EditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			CoordinationPattern2EditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(CoordinationPattern2EditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		return doGetTypesForTarget(
				(CoordinationPattern2EditPart) sourceEditPart, relationshipType);
	}
	...
	public List<IElementType> doGetTypesForTarget(
			CoordinationPattern2EditPart source, IElementType relationshipType) {
