...
public class PatternNavigatorLabelProvider extends LabelProvider implements
	...
	public void updateLabel(ViewerLabel label, TreePath elementPath) {
		...
		if (element instanceof de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorItem
				&& !isOwnView(((de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorItem) element)
						.getView())) {
			return;
		}
	...
	public Image getImage(Object element) {
		if (element instanceof de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorGroup) {
			de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorGroup group = (de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorGroup) element;
			return de.uni_paderborn.fujaba.muml.pattern.diagram.part.PatternDiagramEditorPlugin
					.getInstance().getBundledImage(group.getIcon());
		}

		if (element instanceof de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorItem) {
			de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorItem navigatorItem = (de.uni_paderborn.fujaba.muml.pattern.diagram.navigator.PatternNavigatorItem) element;
	...
	public Image getImage(View view) {
		...
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.ModelElementCategoryEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Diagram?http://www.fujaba.de/modelinstance/0.4.0?ModelElementCategory", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.ModelElementCategory_1000); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.CoordinationPatternEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://www.fujaba.de/muml/pattern/0.3.18?CoordinationPattern", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.CoordinationPattern_2001); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.RoleEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.fujaba.de/muml/protocol/0.4.0?Role", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.Role_3002); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.CoordinationPattern2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.fujaba.de/muml/pattern/0.3.18?CoordinationPattern", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.CoordinationPattern_3003); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.MessageBufferEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.fujaba.de/muml/connector/0.4.0?MessageBuffer", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.MessageBuffer_3004); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.MessageTypeEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.fujaba.de/muml/msgtype/0.4.0?MessageType", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.MessageType_3005); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.ParameterEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.fujaba.de/muml/behavior/0.4.0?Parameter", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.Parameter_3006); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.ConnectorQualityOfServiceAssumptionsEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.fujaba.de/muml/protocol/0.4.0?ConnectorQualityOfServiceAssumptions", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.ConnectorQualityOfServiceAssumptions_3007); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.RoleConnectorEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.fujaba.de/muml/protocol/0.4.0?RoleConnector", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.RoleConnector_4001); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.AbstractCoordinationSpecificationRolesEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.fujaba.de/muml/protocol/0.4.0?AbstractCoordinationSpecification?roles", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.AbstractCoordinationSpecificationRoles_4002); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.DiscreteInteractionEndpointReceiverMessageBufferEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.fujaba.de/muml/connector/0.4.0?DiscreteInteractionEndpoint?receiverMessageBuffer", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.DiscreteInteractionEndpointReceiverMessageBuffer_4003); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.RoleConnectorConnectorQualityOfServiceAssumptionsEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.fujaba.de/muml/protocol/0.4.0?RoleConnector?connectorQualityOfServiceAssumptions", de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.RoleConnectorConnectorQualityOfServiceAssumptions_4004); //$NON-NLS-1$
		}
	...
	private Image getImage(String key, IElementType elementType) {
		ImageRegistry imageRegistry = de.uni_paderborn.fujaba.muml.pattern.diagram.part.PatternDiagramEditorPlugin
				.getInstance().getImageRegistry();
		Image image = imageRegistry.get(key);
		if (image == null
				&& elementType != null
				&& de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes
						.isKnownElementType(elementType)) {
			image = de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes
	...
	private String getRole_3002Text(View view) {
		IParser parser = de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternParserProvider
				.getParser(
	...
	private String getConnectorQualityOfServiceAssumptions_3007Text(View view) {
		IParser parser = de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternParserProvider
				.getParser(
						de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.ConnectorQualityOfServiceAssumptions_3007,
						view.getElement() != null ? view.getElement() : view,
						de.uni_paderborn.fujaba.muml.pattern.diagram.part.PatternVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getDiscreteInteractionEndpointReceiverMessageBuffer_4003Text(
			View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getRoleConnectorConnectorQualityOfServiceAssumptions_4004Text(
			View view) {
		return ""; //$NON-NLS-1$
	}
