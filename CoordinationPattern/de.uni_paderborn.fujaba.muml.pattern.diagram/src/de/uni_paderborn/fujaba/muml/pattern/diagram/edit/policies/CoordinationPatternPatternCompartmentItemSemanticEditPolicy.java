...
public class CoordinationPatternPatternCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.CoordinationPattern_3003 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_paderborn.fujaba.muml.pattern.diagram.edit.commands.CoordinationPattern2CreateCommand(
					req));
		}
		if (de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.Role_3002 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_paderborn.fujaba.muml.pattern.diagram.edit.commands.RoleCreateCommand(
					req));
		}
		if (de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.MessageBuffer_3004 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_paderborn.fujaba.muml.pattern.diagram.edit.commands.MessageBufferCreateCommand(
					req));
		}
		if (de.uni_paderborn.fujaba.muml.pattern.diagram.providers.PatternElementTypes.ConnectorQualityOfServiceAssumptions_3007 == req
				.getElementType()) {
