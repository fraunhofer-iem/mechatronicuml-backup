...
public class PatternOCLFactory {
	 ...
	 * @generated
	 */
	private final de.uni_paderborn.fujaba.muml.pattern.diagram.expressions.PatternAbstractExpression[] expressions;
	...
	protected PatternOCLFactory() {
		this.expressions = new de.uni_paderborn.fujaba.muml.pattern.diagram.expressions.PatternAbstractExpression[17];
	 ...
	 * @generated
	 */
	private static PatternOCLFactory getInstance() {
		PatternOCLFactory instance = de.uni_paderborn.fujaba.muml.pattern.diagram.part.PatternDiagramEditorPlugin
		...
		if (instance == null) {
			de.uni_paderborn.fujaba.muml.pattern.diagram.part.PatternDiagramEditorPlugin
					.getInstance().setPatternOCLFactory(
							instance = new PatternOCLFactory());
		}
		return instance;
	}
	 ...
	 * @generated
	 */
	public static de.uni_paderborn.fujaba.muml.pattern.diagram.expressions.PatternAbstractExpression getExpression(
			int index, EClassifier context, Map<String, EClassifier> environment) {
		PatternOCLFactory cached = getInstance();
	...
	private static class Expression
			extends
			de.uni_paderborn.fujaba.muml.pattern.diagram.expressions.PatternAbstractExpression {
