...
public class PatternDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return de.uni_paderborn.fujaba.muml.pattern.diagram.part.PatternDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new de.uni_paderborn.fujaba.muml.pattern.diagram.part.ValidateAction(
				page);
