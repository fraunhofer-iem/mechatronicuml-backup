...
public class MessageTypeParametersCompartmentCanonicalEditPolicy extends
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] { de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.ParameterEditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.ParameterEditPart.VISUAL_ID == de.uni_paderborn.fujaba.muml.pattern.diagram.part.PatternVisualIDRegistry
				.getVisualID(view);
	}
