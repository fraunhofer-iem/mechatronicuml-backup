...
import de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.edit.parts.CoordinationPatternEditPart;
import de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.part.PatternVisualIDRegistry;

public class CustomModelElementCategoryEditPart extends de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.edit.parts.ModelElementCategoryEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy("CustomCanonical", new de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.edit.policies.ModelElementCategoryCanonicalEditPolicy(false) {
			...
			protected EditPart getSourceEditPart(UpdaterLinkDescriptor descriptor,
				...
				if (/*descriptor.getVisualID() == CoordinationProtocolRolesEditPart.VISUAL_ID &&*/ sourceEditPart != null && sourceEditPart.getModel() instanceof View) {
					...
					String wrongHint = de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.part.PatternVisualIDRegistry
