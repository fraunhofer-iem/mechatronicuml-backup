package de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.custom.edit.helpers;
	...
	protected ICommand getAfterConfigureCommand(final ConfigureRequest request) {
		...
		return new ConfigureElementCommand(request) {
			...
			protected CommandResult doExecuteWithResult(
				...
				CoordinationPattern coordinationProtocol = (CoordinationPattern) request.getElementToConfigure();
