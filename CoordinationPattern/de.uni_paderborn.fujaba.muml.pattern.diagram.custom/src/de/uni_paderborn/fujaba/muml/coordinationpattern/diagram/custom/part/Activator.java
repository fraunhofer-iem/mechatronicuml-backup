package de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.custom.part;
...
public class Activator extends AbstractUIPlugin {
	...
	public static final String ID = "de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.custom"; //$NON-NLS-1$

	public static final String CREATE_ROLE_RTSC = "/de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.custom/transforms/CreateRoleRTSC.qvto";
	public static final String TRANSFORM_PATTERN_TO_PROTOCOL = "/de.uni_paderborn.fujaba.muml.coordinationpattern.diagram.custom/transforms/TransformPatternToProtocol.qvto";
