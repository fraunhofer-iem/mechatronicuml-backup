...
public class AssemblyConnectorReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.muml.component.AssemblyConnector) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.component.AssemblyConnector getLink() {
		return (de.uni_paderborn.fujaba.muml.component.AssemblyConnector) getElementToEdit();
	}
