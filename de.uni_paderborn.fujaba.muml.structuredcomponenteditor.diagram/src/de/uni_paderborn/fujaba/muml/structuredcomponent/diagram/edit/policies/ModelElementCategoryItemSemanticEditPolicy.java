...
public class ModelElementCategoryItemSemanticEditPolicy
	...
	public ModelElementCategoryItemSemanticEditPolicy() {
		super(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.ModelElementCategory_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.StaticStructuredComponent_2005 == req
				.getElementType()) {
