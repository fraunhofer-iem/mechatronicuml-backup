...
public class StructuredcomponentDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "de.uni_paderborn.fujaba.muml.structuredcomponent.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.MumlDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.policies.MumlBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.ElementInitializers initializers;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions.MumlOCLFactory oclFactory;
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.MumlDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.MumlDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.policies.MumlBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.policies.MumlBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions.MumlOCLFactory getMumlOCLFactory() {
		return oclFactory;
	}
	...
	public void setMumlOCLFactory(
			de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions.MumlOCLFactory f) {
		this.oclFactory = f;
	}
