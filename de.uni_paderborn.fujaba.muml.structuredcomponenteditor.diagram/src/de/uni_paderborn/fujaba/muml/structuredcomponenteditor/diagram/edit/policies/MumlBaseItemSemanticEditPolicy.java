		...
		public boolean canExistAssemblyConnector_4001(
			...
			try {
				if (target == null) {
					...
					de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.expressions.MumlAbstractExpression expression = de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.expressions.MumlOCLFactory
							.getExpression(
									12,
