...
public class MumlBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(
					de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.edit.helpers.MumlBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(
				de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.edit.helpers.MumlBaseEditHelper.CONTEXT_ELEMENT_TYPE,
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.providers.MumlElementTypes
		...
		public boolean canExistAssemblyConnector_4001(
			...
			try {
				if (target == null) {
					...
					Object targetVal = de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.expressions.MumlOCLFactory
							.getExpression(
									12,
									de.uni_paderborn.fujaba.muml.model.connector.ConnectorPackage.eINSTANCE
											.getConnectorEndpoint(), envType)
							.evaluate(target, env); //$NON-NLS-1$
		...
		public boolean canExistDelegationConnector_4002(
			...
			try {
				if (source == null) {
					...
					Object sourceVal = de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.expressions.MumlOCLFactory
							.getExpression(
									13,
									de.uni_paderborn.fujaba.muml.model.connector.ConnectorPackage.eINSTANCE
											.getConnectorEndpoint(), envType)
							.evaluate(source, env); //$NON-NLS-1$
