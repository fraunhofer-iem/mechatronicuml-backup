...
public class MessageFormatParser
		extends
		de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.part.Messages.MessageFormatParser_InvalidInputError,
