 ...
 * @generated
 */
public class OperationRepositoryNameEditPart extends CompartmentEditPart
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.operationrepository.diagram.providers.MumlParserProvider
					.getParser(
