...
public class MumlNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(de.uni_paderborn.fujaba.muml.operationrepository.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof de.uni_paderborn.fujaba.muml.operationrepository.diagram.navigator.MumlNavigatorItem) {
					selectedElement = ((de.uni_paderborn.fujaba.muml.operationrepository.diagram.navigator.MumlNavigatorItem) selectedElement)
							.getView();
