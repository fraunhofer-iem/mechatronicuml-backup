	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof de.uni_paderborn.fujaba.muml.operationrepository.diagram.navigator.MumlAbstractNavigatorItem
		...
		}, de.uni_paderborn.fujaba.muml.operationrepository.diagram.navigator.MumlAbstractNavigatorItem.class);
	}
