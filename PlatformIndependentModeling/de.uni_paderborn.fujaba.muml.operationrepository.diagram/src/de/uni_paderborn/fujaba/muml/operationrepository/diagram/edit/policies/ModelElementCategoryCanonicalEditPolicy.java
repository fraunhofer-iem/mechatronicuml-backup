...
public class ModelElementCategoryCanonicalEditPolicy extends
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] { de.uni_paderborn.fujaba.muml.operationrepository.diagram.edit.parts.OperationRepositoryEditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return de.uni_paderborn.fujaba.muml.operationrepository.diagram.edit.parts.OperationRepositoryEditPart.VISUAL_ID == de.uni_paderborn.fujaba.muml.operationrepository.diagram.part.MumlVisualIDRegistry
				.getVisualID(view);
	}
