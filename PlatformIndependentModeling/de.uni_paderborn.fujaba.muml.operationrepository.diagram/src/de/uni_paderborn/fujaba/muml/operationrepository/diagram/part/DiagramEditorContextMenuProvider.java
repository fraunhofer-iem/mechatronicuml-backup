...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.operationrepository.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new de.uni_paderborn.fujaba.muml.operationrepository.diagram.part.DeleteElementAction(part);
		deleteAction.init();
	}
