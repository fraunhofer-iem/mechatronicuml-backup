...
import org.muml.pim.operationrepository.diagram.edit.policies.ParameterItemSemanticEditPolicy;
	...
	*/
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel2EditPart) {
			((WrappingLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureParameterLabel());
			return true;
		}
		return false;
	}
