...
public class ModelElementCategoryEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.operationrepository.diagram.edit.policies.ModelElementCategoryItemSemanticEditPolicy());
		...
		installEditPolicy("CustomCanonical",
				new org.muml.pim.operationrepository.diagram.edit.policies.ModelElementCategoryCanonicalEditPolicy(
						false));
