	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.operationrepository.diagram.edit.policies.OperationRepositoryItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pim.operationrepository.diagram.edit.parts.OperationRepositoryNameEditPart) {
			((org.muml.pim.operationrepository.diagram.edit.parts.OperationRepositoryNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureOperationRepositoryNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pim.operationrepository.diagram.edit.parts.OperationRepositoryOperationCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureOperationCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((org.muml.pim.operationrepository.diagram.edit.parts.OperationRepositoryOperationCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof org.muml.pim.operationrepository.diagram.edit.parts.OperationRepositoryOperationCompartmentEditPart) {
