...
public class MumlCreationWizard extends AbstractFujabaDiagramNewWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(OperationRepositoryDiagramEditorPlugin
	...
	public AdapterFactory getItemProvidersAdapterFactory() {
		return OperationRepositoryDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory();
	}
