...
public class ModelElementCategoryCanonicalEditPolicy extends CanonicalEditPolicy
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { OperationRepositoryEditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return OperationRepositoryEditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
