...
public class MumlPaletteFactory {
	...
	private PaletteContainer createOperationrepositoryeditor1Group() {
		PaletteGroup paletteContainer = new PaletteGroup(
				org.muml.pim.operationrepository.diagram.part.Messages.Operationrepositoryeditor1Group_title);
	...
	private ToolEntry createOperationRepository1CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				org.muml.pim.operationrepository.diagram.part.Messages.OperationRepository1CreationTool_title,
				org.muml.pim.operationrepository.diagram.part.Messages.OperationRepository1CreationTool_desc,
		...
		entry.setSmallIcon(
				org.muml.pim.operationrepository.diagram.providers.MumlElementTypes.getImageDescriptor(
						org.muml.pim.operationrepository.diagram.providers.MumlElementTypes.OperationRepository_2001));
	...
	private ToolEntry createOperation2CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				org.muml.pim.operationrepository.diagram.part.Messages.Operation2CreationTool_title,
				org.muml.pim.operationrepository.diagram.part.Messages.Operation2CreationTool_desc,
				Collections.singletonList(
	...
	private ToolEntry createParameter3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				org.muml.pim.operationrepository.diagram.part.Messages.Parameter3CreationTool_title,
				org.muml.pim.operationrepository.diagram.part.Messages.Parameter3CreationTool_desc,
				Collections.singletonList(
