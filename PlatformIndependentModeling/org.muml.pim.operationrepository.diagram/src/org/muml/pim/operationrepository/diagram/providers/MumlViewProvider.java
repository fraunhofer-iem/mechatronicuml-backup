...
public class MumlViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return OperationRepositoryEditPart.VISUAL_ID == visualID || OperationEditPart.VISUAL_ID == visualID
	...
	public Node createOperationRepository_2001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(MumlVisualIDRegistry.getType(OperationRepositoryEditPart.VISUAL_ID));
		...
		Node label5003 = createLabel(node, MumlVisualIDRegistry.getType(OperationRepositoryNameEditPart.VISUAL_ID));
		createCompartment(node, MumlVisualIDRegistry.getType(OperationRepositoryOperationCompartmentEditPart.VISUAL_ID),
	...
	public Node createOperation_3001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MumlVisualIDRegistry.getType(OperationEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5002 = createLabel(node, MumlVisualIDRegistry.getType(OperationNameEditPart.VISUAL_ID));
		Node label5005 = createLabel(node, MumlVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
		createCompartment(node, MumlVisualIDRegistry.getType(OperationParametersCompartmentEditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	...
	public Node createParameter_3002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5001 = createLabel(node, MumlVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
		return node;
	}
