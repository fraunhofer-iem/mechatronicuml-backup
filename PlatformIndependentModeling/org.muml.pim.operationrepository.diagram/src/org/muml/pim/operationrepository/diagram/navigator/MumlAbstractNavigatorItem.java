	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof org.muml.pim.operationrepository.diagram.navigator.MumlAbstractNavigatorItem
		...
		}, org.muml.pim.operationrepository.diagram.navigator.MumlAbstractNavigatorItem.class);
	}
