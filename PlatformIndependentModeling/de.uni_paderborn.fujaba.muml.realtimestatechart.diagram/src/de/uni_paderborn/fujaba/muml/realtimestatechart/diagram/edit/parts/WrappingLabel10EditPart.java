...
public class WrappingLabel10EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.providers.MumlParserProvider.getParser(
					...
					de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.part.MumlVisualIDRegistry.getType(
							de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID));
		}
		return parser;
	}
