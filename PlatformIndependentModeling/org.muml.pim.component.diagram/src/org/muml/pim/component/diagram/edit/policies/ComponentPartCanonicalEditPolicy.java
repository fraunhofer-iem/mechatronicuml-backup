...
public class ComponentPartCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return org.muml.pim.component.ComponentPackage.eINSTANCE.getComponentPart_PortParts();
	}
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] {
						org.muml.pim.component.diagram.edit.parts.PortPartEditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return org.muml.pim.component.diagram.edit.parts.PortPartEditPart.VISUAL_ID == org.muml.pim.component.diagram.part.MumlVisualIDRegistry
				.getVisualID(view);
	}
