...
public class ModelElementCategoryEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.component.diagram.edit.policies.ModelElementCategoryItemSemanticEditPolicy());
		...
		installEditPolicy("CustomCanonical",
				new org.muml.pim.component.diagram.edit.policies.ModelElementCategoryCanonicalEditPolicy(
						false));
