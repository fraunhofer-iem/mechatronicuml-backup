...
import org.muml.pim.component.diagram.edit.policies.PortPartItemSemanticEditPolicy;
import org.muml.pim.component.diagram.part.MumlVisualIDRegistry;

/**
 * @generated
 */
public class PortPartEditPart extends BorderedBorderItemEditPart {
	...
	*/
	 ...
	 * @generated
	 */
	public PortPartEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PortPartItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof PortPartNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(PortPartNameEditPart.VISUAL_ID));
	}
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (event.getFeature() == ComponentPackage.eINSTANCE.getPortPart_CoordinationProtocolPart()) {
			update = true;
		}
