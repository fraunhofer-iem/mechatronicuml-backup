	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.component.diagram.edit.policies.PortPartItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());

		installEditPolicy(org.muml.pim.common.edit.policies.EditPolicyRoles.PORT_VISUALIZATION_ROLE,
				new org.muml.pim.common.edit.policies.ports.PortPartEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof org.muml.pim.component.diagram.edit.parts.PortPartNameEditPart) {
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (event.getFeature() == org.muml.pim.component.ComponentPackage.eINSTANCE
