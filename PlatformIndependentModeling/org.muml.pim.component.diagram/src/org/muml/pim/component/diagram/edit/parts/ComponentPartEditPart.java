	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.component.diagram.edit.policies.ComponentPartItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.muml.pim.component.diagram.edit.policies.ComponentPartCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pim.component.diagram.edit.parts.WrappingLabel3EditPart) {
			((org.muml.pim.component.diagram.edit.parts.WrappingLabel3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureComponentNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pim.component.diagram.edit.parts.PortPartEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer()
					.add(((org.muml.pim.component.diagram.edit.parts.PortPartEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.pim.component.diagram.edit.parts.PortPartEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((org.muml.pim.component.diagram.edit.parts.PortPartEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
