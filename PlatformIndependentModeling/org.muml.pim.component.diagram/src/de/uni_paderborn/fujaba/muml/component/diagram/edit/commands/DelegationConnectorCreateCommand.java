...
public class DelegationConnectorCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (!de.uni_paderborn.fujaba.muml.component.diagram.edit.policies.MumlBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateDelegationConnector_4002(getContainer(), getSource(), getTarget(), sourceView, targetView)) {
	 ...
	 * @generated
	 */
	protected void doConfigure(de.uni_paderborn.fujaba.muml.component.DelegationConnector newElement,
