...
public class AbstractCoordinationSpecificationRolesCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof de.uni_paderborn.fujaba.muml.protocol.Role) {
			return false;
		}
		if (getSource() == null) {
		...
		if (!de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.policies.MumlBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateAbstractCoordinationSpecificationRoles_4007(getSource(), getTarget(),
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.policies.MumlBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorAbstractCoordinationSpecificationRoles_4007(getSource(), getTarget(),
							sourceView, targetView);
