...
import org.muml.pim.coordinationprotocol.diagram.edit.policies.MessageTypeItemSemanticEditPolicy;
...
public class MessageTypeEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MessageTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageTypeNameEditPart) {
			((MessageTypeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureMessageTypeNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof MessageTypeMessageTypesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParametersCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((MessageTypeMessageTypesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof MessageTypeMessageTypesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParametersCompartmentFigure();
			pane.remove(((MessageTypeMessageTypesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof MessageTypeMessageTypesCompartmentEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(MessageTypeNameEditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == MumlElementTypes.Parameter_3016) {
				return getChildBySemanticHint(
						MumlVisualIDRegistry.getType(MessageTypeMessageTypesCompartmentEditPart.VISUAL_ID));
			}
		}
