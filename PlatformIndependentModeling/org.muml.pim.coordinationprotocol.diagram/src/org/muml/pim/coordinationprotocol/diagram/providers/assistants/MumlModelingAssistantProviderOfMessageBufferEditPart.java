...
public class MumlModelingAssistantProviderOfMessageBufferEditPart
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(
				org.muml.pim.coordinationprotocol.diagram.providers.MumlElementTypes.MessageType_3009);
		return types;
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget(
				(org.muml.pim.coordinationprotocol.diagram.edit.parts.MessageBufferEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			org.muml.pim.coordinationprotocol.diagram.edit.parts.MessageBufferEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(
	...
	public List<IElementType> doGetTypesForSource(
		...
		if (relationshipType == org.muml.pim.coordinationprotocol.diagram.providers.MumlElementTypes.DiscreteInteractionEndpointReceiverMessageBuffer_4008) {
