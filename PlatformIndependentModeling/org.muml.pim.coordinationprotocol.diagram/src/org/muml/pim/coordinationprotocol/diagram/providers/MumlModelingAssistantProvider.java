...
public class MumlModelingAssistantProvider extends ModelingAssistantProvider {
	...
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(
				org.muml.pim.coordinationprotocol.diagram.part.Messages.MumlModelingAssistantProviderMessage);
		dialog.setTitle(
				org.muml.pim.coordinationprotocol.diagram.part.Messages.MumlModelingAssistantProviderTitle);
