...
import org.muml.pim.coordinationspecification.common.edit.policies.CustomConnectorOfServiceAssumptionsWrappedLabelUpdateEditPolicy;
import org.muml.pim.coordinationspecification.common.edit.policies.EditPolicyRoles;
...
public class WrappingLabel3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.QoSA_LABEL_UpdateEditPolicy,
				new CustomConnectorOfServiceAssumptionsWrappedLabelUpdateEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MumlParserProvider.getParser(MumlElementTypes.ConnectorQualityOfServiceAssumptions_3014,
