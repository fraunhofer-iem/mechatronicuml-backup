...
import org.muml.pim.coordinationprotocol.diagram.edit.policies.ParameterItemSemanticEditPolicy;
	...
	*/
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel5EditPart) {
			((WrappingLabel5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureParameterLabel());
			return true;
		}
		return false;
	}
