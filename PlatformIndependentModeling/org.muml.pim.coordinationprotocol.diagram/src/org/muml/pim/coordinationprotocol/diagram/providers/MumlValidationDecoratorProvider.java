...
import org.muml.pim.coordinationprotocol.diagram.part.CoordinationProtocolDiagramEditor;
...
public class MumlValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof CoordinationProtocolDiagramEditor) {
