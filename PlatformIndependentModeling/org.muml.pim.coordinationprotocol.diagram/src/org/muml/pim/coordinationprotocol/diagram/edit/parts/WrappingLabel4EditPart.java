...
public class WrappingLabel4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				org.muml.pim.coordinationspecification.common.edit.policies.EditPolicyRoles.QoSA_LABEL_UpdateEditPolicy,
				new org.muml.pim.coordinationspecification.common.edit.policies.CustomConnectorOfServiceAssumptionsWrappedLabelUpdateEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = org.muml.pim.coordinationprotocol.diagram.providers.MumlParserProvider.getParser(
					org.muml.pim.coordinationprotocol.diagram.providers.MumlElementTypes.ConnectorQualityOfServiceAssumptions_3014,
					getParserElement(),
					org.muml.pim.coordinationprotocol.diagram.part.MumlVisualIDRegistry.getType(
							org.muml.pim.coordinationprotocol.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID));
		}
		return parser;
	}
