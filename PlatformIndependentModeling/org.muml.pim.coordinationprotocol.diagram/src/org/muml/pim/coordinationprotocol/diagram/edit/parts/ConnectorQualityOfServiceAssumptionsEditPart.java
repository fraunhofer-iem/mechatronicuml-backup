	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.coordinationprotocol.diagram.edit.policies.ConnectorQualityOfServiceAssumptionsItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pim.coordinationprotocol.diagram.edit.parts.WrappingLabel2EditPart) {
			((org.muml.pim.coordinationprotocol.diagram.edit.parts.WrappingLabel2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMsgLossLabel());
			return true;
		}
		if (childEditPart instanceof org.muml.pim.coordinationprotocol.diagram.edit.parts.WrappingLabel3EditPart) {
			((org.muml.pim.coordinationprotocol.diagram.edit.parts.WrappingLabel3EditPart) childEditPart)
