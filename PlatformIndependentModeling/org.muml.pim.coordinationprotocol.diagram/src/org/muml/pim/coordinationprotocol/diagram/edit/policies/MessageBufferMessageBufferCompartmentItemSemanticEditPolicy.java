...
public class MessageBufferMessageBufferCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (org.muml.pim.coordinationprotocol.diagram.providers.MumlElementTypes.MessageType_3009 == req
				.getElementType()) {
			return getGEFWrapper(
					new org.muml.pim.coordinationprotocol.diagram.edit.commands.MessageTypeCreateCommand(
							req));
		}
