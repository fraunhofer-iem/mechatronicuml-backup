...
public class MumlOCLFactory {
	...
	protected MumlOCLFactory() {
		this.expressions = new de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlAbstractExpression[19];
	...
	private static MumlOCLFactory getInstance() {
		MumlOCLFactory instance = de.uni_paderborn.fujaba.muml.component.diagram.part.ComponentDiagramEditorPlugin
	...
	private static class Expression
			extends de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlAbstractExpression {
