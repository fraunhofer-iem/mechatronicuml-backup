...
public class MumlModelingAssistantProvider extends ModelingAssistantProvider {
	...
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(
				de.uni_paderborn.fujaba.muml.component.diagram.part.Messages.MumlModelingAssistantProviderMessage);
		dialog.setTitle(
				de.uni_paderborn.fujaba.muml.component.diagram.part.Messages.MumlModelingAssistantProviderTitle);
