...
public class MumlModelingAssistantProviderOfContinuousPortEditPart
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.ContinuousPortEditPart) sourceEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.ContinuousPortEditPart) targetEditPart);
	}
