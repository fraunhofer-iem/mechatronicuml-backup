...
public class DiscretePortLabelExpressionLabelParser5025 extends ExpressionLabelParserBase {
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory.getExpression(2,
				de.uni_paderborn.fujaba.muml.component.ComponentPackage.eINSTANCE.getDiscretePort(), null).body();
	}
