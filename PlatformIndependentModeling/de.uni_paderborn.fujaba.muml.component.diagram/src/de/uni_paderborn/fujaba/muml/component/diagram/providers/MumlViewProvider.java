...
public class MumlViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.ModelElementCategoryEditPart.MODEL_ID
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.StaticAtomicComponentEditPart.VISUAL_ID == visualID
				|| de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.StaticStructuredComponentEditPart.VISUAL_ID == visualID
				...
				|| de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.PortPartEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op.getSemanticAdapter());
		if (!de.uni_paderborn.fujaba.muml.component.diagram.providers.MumlElementTypes.isKnownElementType(elementType)
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createStaticAtomicComponent_2006(EObject domainElement, View containerView, int index,
		...
		node.setType(de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry.getType(
		...
		Node label5028 = createLabel(node,
				de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry.getType(
						de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.StaticAtomicComponentNameEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createDiscretePort_3010(EObject domainElement, View containerView, int index, boolean persisted,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5012 = createLabel(node, de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
		...
		location5012.setX(0);
		location5012.setY(5);
		Node label5025 = createLabel(node, de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
	...
	public Node createContinuousPort_3011(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
				.getType(de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.ContinuousPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	public Node createHybridPort_3013(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
				.getType(de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.HybridPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5024 = createLabel(node, de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
	...
	public Node createComponentPart_3012(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
				.getType(de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.ComponentPartEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5017 = createLabel(node, de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
	...
	public Node createPortPart_3022(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
				.getType(de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.PortPartEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5034 = createLabel(node, de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
	...
	public Node createCoordinationProtocolPart_3016(EObject domainElement, View containerView, int index,
		...
		Node label5026 = createLabel(node, de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry
				.getType(de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID));
		return node;
	}
	...
	public Edge createAssemblyConnector_4001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		edge.setType(de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry.getType(
	...
	private void stampShortcut(View containerView, Node target) {
		if (!de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.ModelElementCategoryEditPart.MODEL_ID.equals(
				de.uni_paderborn.fujaba.muml.component.diagram.part.MumlVisualIDRegistry.getModelID(containerView))) {
