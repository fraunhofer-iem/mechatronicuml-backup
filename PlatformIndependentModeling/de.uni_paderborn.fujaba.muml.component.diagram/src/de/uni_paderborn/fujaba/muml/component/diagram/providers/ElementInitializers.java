...
public class ElementInitializers {
	...
	* @generated
	*/
	public void init_StaticAtomicComponent_2006(de.uni_paderborn.fujaba.muml.component.StaticAtomicComponent instance) {
		try {
			Object value_0 = de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory.getExpression(13,
					de.uni_paderborn.fujaba.muml.component.ComponentPackage.eINSTANCE.getStaticAtomicComponent(), null)
					.evaluate(instance);
	...
	*/
	public void init_StaticStructuredComponent_2005(
		...
		try {
			Object value_0 = de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory.getExpression(14,
	...
	public void init_DiscretePort_3010(de.uni_paderborn.fujaba.muml.component.DiscretePort instance) {
		try {
			...
			Object value_1 = de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory
					.getExpression(15,
							de.uni_paderborn.fujaba.muml.component.ComponentPackage.eINSTANCE.getDiscretePort(), null)
					.evaluate(instance);
	...
	* @generated
	*/
	public void init_ContinuousPort_3011(de.uni_paderborn.fujaba.muml.component.ContinuousPort instance) {
		try {
			Object value_0 = de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory
					.getExpression(16,
							de.uni_paderborn.fujaba.muml.component.ComponentPackage.eINSTANCE.getContinuousPort(), null)
					.evaluate(instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			de.uni_paderborn.fujaba.muml.component.diagram.part.ComponentDiagramEditorPlugin.getInstance()
	...
	* @generated
	*/
	public void init_HybridPort_3013(de.uni_paderborn.fujaba.muml.component.HybridPort instance) {
		try {
			Object value_0 = de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory
					.getExpression(17,
	...
	public void init_ComponentPart_3012(de.uni_paderborn.fujaba.muml.component.ComponentPart instance) {
		try {
			...
			Object value_1 = de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory
					.getExpression(18,
							de.uni_paderborn.fujaba.muml.component.ComponentPackage.eINSTANCE.getComponentPart(), null)
					.evaluate(instance);
			instance.setName((String) value_1);
		} catch (RuntimeException e) {
			de.uni_paderborn.fujaba.muml.component.diagram.part.ComponentDiagramEditorPlugin.getInstance()
