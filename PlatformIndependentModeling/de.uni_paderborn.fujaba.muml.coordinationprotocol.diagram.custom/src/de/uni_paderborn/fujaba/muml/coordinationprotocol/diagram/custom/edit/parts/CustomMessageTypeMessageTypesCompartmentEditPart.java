...
public class CustomMessageTypeMessageTypesCompartmentEditPart extends
MessageTypeMessageTypesCompartmentEditPart {

	public CustomMessageTypeMessageTypesCompartmentEditPart(View view) {
		super(view);
	}
