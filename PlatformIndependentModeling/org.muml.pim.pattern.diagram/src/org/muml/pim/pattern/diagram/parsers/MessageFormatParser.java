...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(org.muml.pim.pattern.diagram.part.MumlDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(
							org.muml.pim.pattern.diagram.part.Messages.MessageFormatParser_InvalidInputError,
