	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.pattern.diagram.edit.policies.ModelElementCategoryItemSemanticEditPolicy());
		...
		installEditPolicy("CustomCanonical",
				new org.muml.pim.pattern.diagram.edit.policies.ModelElementCategoryCanonicalEditPolicy(
						false));
