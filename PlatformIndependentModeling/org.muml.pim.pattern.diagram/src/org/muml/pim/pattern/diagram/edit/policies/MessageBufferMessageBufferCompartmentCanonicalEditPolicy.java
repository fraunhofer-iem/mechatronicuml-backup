...
public class MessageBufferMessageBufferCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ConnectorPackage.eINSTANCE.getMessageBuffer_GmfMessageTypes();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return MumlDiagramUpdater.getMessageBufferMessageBufferCompartment_7002SemanticChildren(viewObject);
