...
public class MumlNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	*/
	static {
		org.muml.pim.pattern.diagram.part.MumlDiagramEditorPlugin.getInstance().getImageRegistry()
	...
	*/
	public void updateLabel(ViewerLabel label, TreePath elementPath) {
		...
		if (element instanceof org.muml.pim.pattern.diagram.navigator.MumlNavigatorItem && !isOwnView(
				((org.muml.pim.pattern.diagram.navigator.MumlNavigatorItem) element).getView())) {
			return;
		}
	...
	*/
	public Image getImage(Object element) {
		if (element instanceof org.muml.pim.pattern.diagram.navigator.MumlNavigatorGroup) {
			org.muml.pim.pattern.diagram.navigator.MumlNavigatorGroup group = (org.muml.pim.pattern.diagram.navigator.MumlNavigatorGroup) element;
		...
		if (element instanceof org.muml.pim.pattern.diagram.navigator.MumlNavigatorItem) {
			org.muml.pim.pattern.diagram.navigator.MumlNavigatorItem navigatorItem = (org.muml.pim.pattern.diagram.navigator.MumlNavigatorItem) element;
	...
	*/
	private Image getImage(String key, IElementType elementType) {
		ImageRegistry imageRegistry = org.muml.pim.pattern.diagram.part.MumlDiagramEditorPlugin
				.getInstance().getImageRegistry();
		Image image = imageRegistry.get(key);
		if (image == null && elementType != null
				&& org.muml.pim.pattern.diagram.providers.MumlElementTypes
						.isKnownElementType(elementType)) {
			image = org.muml.pim.pattern.diagram.providers.MumlElementTypes.getImage(elementType);
	...
	*/
	private String getCoordinationPattern_2001Text(View view) {
		org.muml.pim.pattern.CoordinationPattern domainModelElement = (org.muml.pim.pattern.CoordinationPattern) view
				.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getName();
		} else {
	...
	*/
	private String getCoordinationPatternVariant_2002Text(View view) {
		org.muml.pim.pattern.CoordinationPatternVariant domainModelElement = (org.muml.pim.pattern.CoordinationPatternVariant) view
				.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getName();
		} else {
	...
	*/
	private String getRole_3002Text(View view) {
		IParser parser = org.muml.pim.pattern.diagram.providers.CoordinationPatternParserProvider
				.getParser(org.muml.pim.pattern.diagram.providers.MumlElementTypes.Role_3002,
						view.getElement() != null ? view.getElement() : view,
						org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry.getType(
								org.muml.pim.pattern.diagram.edit.parts.RoleNameEditPart.VISUAL_ID));
		if (parser != null) {
	...
	*/
	private String getMessageBuffer_3004Text(View view) {
		IParser parser = org.muml.pim.pattern.diagram.providers.CoordinationPatternParserProvider
				.getParser(org.muml.pim.pattern.diagram.providers.MumlElementTypes.MessageBuffer_3004,
						view.getElement() != null ? view.getElement() : view,
						org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry.getType(
								org.muml.pim.pattern.diagram.edit.parts.MessageBufferNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	*/
	private String getMessageType_3005Text(View view) {
		IParser parser = org.muml.pim.pattern.diagram.providers.CoordinationPatternParserProvider
				.getParser(org.muml.pim.pattern.diagram.providers.MumlElementTypes.MessageType_3005,
						view.getElement() != null ? view.getElement() : view,
						org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry.getType(
								org.muml.pim.pattern.diagram.edit.parts.MessageTypeNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	*/
	private String getParameter_3006Text(View view) {
		IParser parser = org.muml.pim.pattern.diagram.providers.CoordinationPatternParserProvider
				.getParser(org.muml.pim.pattern.diagram.providers.MumlElementTypes.Parameter_3006,
						view.getElement() != null ? view.getElement() : view,
						org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry.getType(
	...
	private String getConnectorQualityOfServiceAssumptions_3007Text(View view) {
		IParser parser = org.muml.pim.pattern.diagram.providers.CoordinationPatternParserProvider
				.getParser(
						...
						view.getElement() != null ? view.getElement() : view,
						org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry.getType(
								org.muml.pim.pattern.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	*/
	private String getRoleConnector_4001Text(View view) {
		org.muml.pim.protocol.RoleConnector domainModelElement = (org.muml.pim.protocol.RoleConnector) view
				.getElement();
		if (domainModelElement != null) {
