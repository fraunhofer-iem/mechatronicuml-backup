	...
	*/
	public boolean canExecute() {
		...
		if (!MumlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRoleConnectorConnectorQualityOfServiceAssumptions_4004(getSource(), getTarget(), sourceView,
						targetView)) {
			String errorMessage = MumlBaseItemSemanticEditPolicy.getLinkConstraints()
					.getErrorRoleConnectorConnectorQualityOfServiceAssumptions_4004(getSource(), getTarget(),
