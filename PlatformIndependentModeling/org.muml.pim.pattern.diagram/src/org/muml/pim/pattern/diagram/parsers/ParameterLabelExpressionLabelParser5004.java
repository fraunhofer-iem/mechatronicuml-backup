...
public class ParameterLabelExpressionLabelParser5004 extends ExpressionLabelParserBase {
	...
	*/
	...
	protected String getExpressionBody() {
		return org.muml.pim.pattern.diagram.expressions.MumlOCLFactory
				.getExpression(12, org.muml.pim.behavior.BehaviorPackage.eINSTANCE.getParameter(), null)
				.body();
	}
	...
	*/
	public String getEditString(IAdaptable element, int flags) {
		...
		Object result = org.muml.pim.pattern.diagram.expressions.MumlOCLFactory
				.getExpression(13, org.muml.pim.behavior.BehaviorPackage.eINSTANCE.getParameter(), null)
				.evaluate(target);
