...
public class MumlBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = org.muml.pim.pattern.diagram.providers.MumlElementTypes
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = org.muml.pim.pattern.diagram.part.MumlDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateRoleConnectorConnectorQualityOfServiceAssumptions_4004(
		...
		public boolean canExistRoleConnector_4001(
			...
			try {
				if (target == null) {
					...
					org.muml.pim.pattern.diagram.expressions.MumlAbstractExpression expression = org.muml.pim.pattern.diagram.expressions.MumlOCLFactory
							.getExpression(32, org.muml.pim.connector.ConnectorPackage.eINSTANCE
		...
		*/
		 ...
		 * @generated
		 */
		public java.lang.String getErrorRoleConnectorConnectorQualityOfServiceAssumptions_4004(
				org.muml.pim.protocol.RoleConnector source,
				org.muml.pim.protocol.ConnectorQualityOfServiceAssumptions target, View sourceView,
				View targetView) {
			return null;
