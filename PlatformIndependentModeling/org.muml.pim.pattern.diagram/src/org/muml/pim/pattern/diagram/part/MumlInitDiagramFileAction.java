...
public class MumlInitDiagramFileAction
		...
		*/
		...
		public Object execute(ExecutionEvent event) throws ExecutionException {
			...
			if (selectedResource instanceof IContainer) {
				...
				String fileName = org.muml.pim.pattern.diagram.part.MumlDiagramEditorUtil
	...
	*/
	...
	public String getUniqueFilename(String hint, String extension, IPath filePath) {
		return org.muml.pim.pattern.diagram.part.MumlDiagramEditorUtil.getUniqueFileName(filePath, hint,
				extension);
	}
