...
public class CoordinationPatternParserProvider extends AbstractProvider implements IParserProvider {
	...
	*/
	private IParser getCoordinationPatternName_5003Parser() {
		if (coordinationPatternName_5003Parser == null) {
			...
			org.muml.pim.pattern.diagram.parsers.MessageFormatParser parser = new org.muml.pim.pattern.diagram.parsers.MessageFormatParser(
					features);
	...
	*/
	private IParser getMessageBufferLabel_5006Parser() {
		return new org.muml.pim.pattern.diagram.parsers.MessageBufferLabelExpressionLabelParser5006();
	}
	...
	*/
	private IParser getMessageBufferLabel_5007Parser() {
		return new org.muml.pim.pattern.diagram.parsers.MessageBufferLabelExpressionLabelParser5007();
	}
	...
	*/
	private IParser getMessageBufferLabel_5011Parser() {
		return new org.muml.pim.pattern.diagram.parsers.MessageBufferLabelExpressionLabelParser5011();
	}
	...
	*/
	private IParser getParameterLabel_5004Parser() {
		return new org.muml.pim.pattern.diagram.parsers.ParameterLabelExpressionLabelParser5004();
	}
	...
	*/
	private IParser getConnectorQualityOfServiceAssumptionsLabel_5008Parser() {
		return new org.muml.pim.pattern.diagram.parsers.ConnectorQualityOfServiceAssumptionsLabelExpressionLabelParser5008();
	}
	...
	*/
	private IParser getConnectorQualityOfServiceAssumptionsLabel_5009Parser() {
		return new org.muml.pim.pattern.diagram.parsers.ConnectorQualityOfServiceAssumptionsLabelExpressionLabelParser5009();
	}
	...
	*/
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(org.muml.pim.pattern.diagram.part.MumlVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	*/
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (org.muml.pim.pattern.diagram.providers.MumlElementTypes.getElement(hint) == null) {
				return false;
			}
