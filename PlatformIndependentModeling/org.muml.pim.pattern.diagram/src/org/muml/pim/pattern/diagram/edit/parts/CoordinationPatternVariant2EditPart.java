...
public class CoordinationPatternVariant2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.pattern.diagram.edit.policies.CoordinationPatternVariant2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pim.pattern.diagram.edit.parts.CoordinationPatternVariantNameEditPart) {
			((org.muml.pim.pattern.diagram.edit.parts.CoordinationPatternVariantNameEditPart) childEditPart)
