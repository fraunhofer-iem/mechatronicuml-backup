...
import org.muml.pim.pattern.diagram.edit.policies.CoordinationPatternVariant2ItemSemanticEditPolicy;
...
public class CoordinationPatternVariant2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CoordinationPatternVariant2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CoordinationPatternVariantNameEditPart) {
			((CoordinationPatternVariantNameEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(CoordinationPatternVariantNameEditPart.VISUAL_ID));
	}
