...
public class MessageBufferEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.pattern.diagram.edit.policies.MessageBufferItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pim.pattern.diagram.edit.parts.MessageBufferNameEditPart) {
			((org.muml.pim.pattern.diagram.edit.parts.MessageBufferNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMessageBufferSizeLabel());
			return true;
		}
		if (childEditPart instanceof org.muml.pim.pattern.diagram.edit.parts.WrappingLabelEditPart) {
			((org.muml.pim.pattern.diagram.edit.parts.WrappingLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMessageBufferOverFlowAvoidanceStrategyLabel());
			return true;
		}
		if (childEditPart instanceof org.muml.pim.pattern.diagram.edit.parts.WrappingLabel6EditPart) {
			((org.muml.pim.pattern.diagram.edit.parts.WrappingLabel6EditPart) childEditPart)
