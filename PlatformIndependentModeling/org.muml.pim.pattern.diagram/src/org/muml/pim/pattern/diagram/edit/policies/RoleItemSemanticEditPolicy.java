...
public class RoleItemSemanticEditPolicy
	...
	*/
	public RoleItemSemanticEditPolicy() {
		super(org.muml.pim.pattern.diagram.providers.MumlElementTypes.Role_3002);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (org.muml.pim.pattern.diagram.providers.MumlElementTypes.RoleConnector_4001 == req
				.getElementType()) {
			return getGEFWrapper(
					new org.muml.pim.pattern.diagram.edit.commands.RoleConnectorCreateCommand(req,
							req.getSource(), req.getTarget()));
		}
		if (org.muml.pim.pattern.diagram.providers.MumlElementTypes.DiscreteInteractionEndpointReceiverMessageBuffer_4003 == req
				.getElementType()) {
			return getGEFWrapper(
					new org.muml.pim.pattern.diagram.edit.commands.DiscreteInteractionEndpointReceiverMessageBufferCreateCommand(
	...
	protected Command getReorientRelationshipCommand(ReorientRelationshipRequest req) {
		...
		case org.muml.pim.pattern.diagram.edit.parts.RoleConnectorEditPart.VISUAL_ID:
			return getGEFWrapper(
					new org.muml.pim.pattern.diagram.edit.commands.RoleConnectorReorientCommand(req));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case org.muml.pim.pattern.diagram.edit.parts.DiscreteInteractionEndpointReceiverMessageBufferEditPart.VISUAL_ID:
			return getGEFWrapper(
					new org.muml.pim.pattern.diagram.edit.commands.DiscreteInteractionEndpointReceiverMessageBufferReorientCommand(
							req));
		}
