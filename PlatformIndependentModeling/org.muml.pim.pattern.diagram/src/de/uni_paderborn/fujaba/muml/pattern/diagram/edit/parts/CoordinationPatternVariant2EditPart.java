 ...
 * @generated
 */
public class CoordinationPatternVariant2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CoordinationPatternVariant2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new de.uni_paderborn.fujaba.muml.pattern.diagram.edit.policies.CoordinationPatternVariant2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());

		installEditPolicy(org.muml.common.edit.policies.EditPolicyRoles.CONNECTION_ANCHOR_CREATION_ROLE,
				new org.muml.common.edit.policies.anchor.EllipseConnectionAnchorCreationEditPolicy());

		removeEditPolicy(org.muml.common.edit.policies.EditPolicyRoles.NON_DELETABLE_ROLE);
		...
		installEditPolicy(org.muml.common.edit.policies.EditPolicyRoles.CANONICAL_REFRESH_ROLE,
				new org.muml.common.edit.policies.CanonicalRefreshEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.CoordinationPatternVariantNameEditPart) {
			((de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.CoordinationPatternVariantNameEditPart) childEditPart)
