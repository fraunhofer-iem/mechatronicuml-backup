package de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.custom.layout;
...
public class RealtimeStatechartLayoutProvider extends TopDownProvider {
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof ILayoutNodeOperation) {
			...
			if (nodes.hasNext()) {
				...
				if (container == null
						|| !(container.getType().equals("Real-Time Statechart"))) //$NON-NLS-1$
					return false;
			}
		} else {
			return false;
