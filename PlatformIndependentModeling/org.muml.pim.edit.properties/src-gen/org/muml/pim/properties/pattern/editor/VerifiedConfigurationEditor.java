 ...
 * @generated
 */
public class VerifiedConfigurationEditor extends org.muml.ape.runtime.editors.ClassPropertyEditor {
	...
	public VerifiedConfigurationEditor(String tab) {
		this(tab, org.muml.pim.properties.util.PropertiesUtil.INSTANCE.getAdapterFactory(),
				org.muml.pim.pattern.PatternPackage.eINSTANCE.getVerifiedConfiguration());
	}
