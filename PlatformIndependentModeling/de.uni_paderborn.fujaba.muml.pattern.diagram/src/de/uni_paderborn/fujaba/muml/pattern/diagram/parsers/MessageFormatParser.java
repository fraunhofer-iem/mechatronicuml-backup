...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(de.uni_paderborn.fujaba.muml.pattern.diagram.part.MumlDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(
							de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.MessageFormatParser_InvalidInputError,
