package de.uni_paderborn.fujaba.muml.pattern.diagram.parsers;
 ...
 * @generated
 */
public class ParameterLabelExpressionLabelParser5004 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ParameterLabelExpressionLabelParser5004() {
	}
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.pattern.diagram.expressions.MumlOCLFactory
				.getExpression(12, de.uni_paderborn.fujaba.muml.behavior.BehaviorPackage.eINSTANCE.getParameter(), null)
				.body();
	}
	...
	public String getEditString(IAdaptable element, int flags) {
		...
		Object result = de.uni_paderborn.fujaba.muml.pattern.diagram.expressions.MumlOCLFactory
				.getExpression(13, de.uni_paderborn.fujaba.muml.behavior.BehaviorPackage.eINSTANCE.getParameter(), null)
				.evaluate(target);
