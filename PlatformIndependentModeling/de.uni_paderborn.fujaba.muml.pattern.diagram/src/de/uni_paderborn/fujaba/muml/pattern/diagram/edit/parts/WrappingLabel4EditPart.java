...
public class WrappingLabel4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy("CustomLabelUpdateEditPolicy", //$NON-NLS-1$
				new de.uni_paderborn.fujaba.muml.pattern.diagram.edit.policies.CustomWrappedLabelUpdateEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.pattern.diagram.providers.CoordinationPatternParserProvider.getParser(
					...
					getParserElement(), de.uni_paderborn.fujaba.muml.pattern.diagram.part.MumlVisualIDRegistry.getType(
							de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID));
		}
		return parser;
	}
