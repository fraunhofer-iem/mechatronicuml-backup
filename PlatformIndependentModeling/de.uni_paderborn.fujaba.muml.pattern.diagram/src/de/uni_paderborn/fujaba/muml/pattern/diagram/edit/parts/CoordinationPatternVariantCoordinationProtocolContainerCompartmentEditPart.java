...
public class CoordinationPatternVariantCoordinationProtocolContainerCompartmentEditPart
	...
	*/
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.CoordinationPatternVariantCoordinationProtocolContainerCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new de.uni_paderborn.fujaba.muml.pattern.diagram.edit.policies.CoordinationPatternVariantCoordinationProtocolContainerCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new de.uni_paderborn.fujaba.muml.pattern.diagram.edit.policies.CoordinationPatternVariantCoordinationProtocolContainerCompartmentCanonicalEditPolicy());
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == de.uni_paderborn.fujaba.muml.pattern.diagram.providers.MumlElementTypes.CoordinationPatternVariant_3008) {
				return this;
			}
