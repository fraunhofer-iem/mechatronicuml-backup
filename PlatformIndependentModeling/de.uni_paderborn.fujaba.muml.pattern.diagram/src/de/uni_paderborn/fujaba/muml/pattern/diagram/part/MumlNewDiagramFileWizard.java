...
public class MumlNewDiagramFileWizard extends Wizard {
	...
	public MumlNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot,
		...
		myFileCreationPage
				.setTitle(de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.MumlNewDiagramFileWizard_CreationPageTitle);
		myFileCreationPage
				.setDescription(NLS
						.bind(de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.MumlNewDiagramFileWizard_CreationPageDescription,
		...
		diagramRootElementSelectionPage
				.setTitle(de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.MumlNewDiagramFileWizard_RootSelectionPageTitle);
		diagramRootElementSelectionPage
				.setDescription(de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.MumlNewDiagramFileWizard_RootSelectionPageDescription);
			...
			protected CommandResult doExecuteWithResult(
				...
				if (diagramVID != de.uni_paderborn.fujaba.muml.pattern.diagram.edit.parts.ModelElementCategoryEditPart.VISUAL_ID) {
					return CommandResult
							.newErrorCommandResult(de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.MumlNewDiagramFileWizard_IncorrectRootError);
				}
	...
	private static class DiagramRootElementSelectionPage
		...
		protected boolean validatePage() {
			if (getModelElement() == null) {
				setErrorMessage(de.uni_paderborn.fujaba.muml.pattern.diagram.part.Messages.MumlNewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
