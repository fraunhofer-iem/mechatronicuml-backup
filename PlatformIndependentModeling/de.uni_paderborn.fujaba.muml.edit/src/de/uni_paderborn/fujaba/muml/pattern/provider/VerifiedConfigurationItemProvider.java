...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.pattern.VerifiedConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VerifiedConfigurationItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VerifiedConfigurationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addParameterBindingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VerifiedConfiguration_parameterBindings_feature"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PatternPackage.Literals.VERIFIED_CONFIGURATION__PARAMETER_BINDINGS);
		}
	...
	/**
	 * This returns VerifiedConfiguration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VerifiedConfiguration"));
	}
	...
	public String getText(Object object) {
		String label = ((VerifiedConfiguration)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VerifiedConfiguration_type") :
			getString("_UI_VerifiedConfiguration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VerifiedConfiguration.class)) {
