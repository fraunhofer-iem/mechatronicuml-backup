 ...
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.PlainTextualDescriptionAspectsImpl#getProblem <em>Problem</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.PlainTextualDescriptionAspectsImpl#getSolution <em>Solution</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.PlainTextualDescriptionAspectsImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.PlainTextualDescriptionAspectsImpl#getBehavior <em>Behavior</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.PlainTextualDescriptionAspectsImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.PlainTextualDescriptionAspectsImpl#getConsequences <em>Consequences</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.PlainTextualDescriptionAspectsImpl#getCombineability <em>Combineability</em>}</li>
