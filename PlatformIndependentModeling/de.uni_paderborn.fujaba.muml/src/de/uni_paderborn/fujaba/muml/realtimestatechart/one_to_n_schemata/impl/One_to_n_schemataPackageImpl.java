	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (loadBalancingEClass, 
		   source, 
		   new String[] {
			 "constraints", "ResponseMessageOrWcetOfCommunication SchemaLoadbalancingMustBeSet ResponseMessageOfCommunication SchemaLoadbalancingMustBeTriggerMessage LoadbalancingEitherHasResponseMessageOrWcet"
		   });
	}
	...
	protected void createOCLAnnotations() {
		...
		addAnnotation
		  (loadBalancingEClass, 
		   source, 
		   new String[] {
			 "ResponseMessageOrWcetOfCommunication SchemaLoadbalancingMustBeSet", "-- LoadBalancing must define the responseMessage or the maxWorkingTime\r\nnot self.responseMessage.oclIsUndefined() or not self.maxWorkingTime.oclIsUndefined()",
