 ...
 *        annotation="http://www.muml.org/emf/OCLFilter filter='self.portInstances.portPart.connectors->select(c | c.connectorEndpoints.oclAsType(component::PortPart) = self.connectorEndpointInstances.oclAsType(PortInstance).portPart)->asSet()' feature='type'"
 * @generated
 */
