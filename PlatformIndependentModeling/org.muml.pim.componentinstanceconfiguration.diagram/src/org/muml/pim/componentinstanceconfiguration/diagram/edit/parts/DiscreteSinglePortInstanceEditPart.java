...
public class DiscreteSinglePortInstanceEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DiscreteSinglePortInstanceItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DiscreteSinglePortInstanceNameEditPart
				|| borderItemEditPart instanceof WrappingLabel7EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(DiscreteSinglePortInstanceNameEditPart.VISUAL_ID));
	}
