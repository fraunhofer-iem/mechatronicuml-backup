 ...
 * @generated
 */
public class DiscreteMultiPortInstanceLabelExpressionLabelParser5041 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public DiscreteMultiPortInstanceLabelExpressionLabelParser5041() {
	...
	protected String getExpressionBody() {
		return MumlOCLFactory.getExpression(5, InstancePackage.eINSTANCE.getDiscreteMultiPortInstance(), null).body();
	}
