...
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.HybridPortInstanceItemSemanticEditPolicy;
...
public class HybridPortInstanceEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HybridPortInstanceItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof HybridPortInstanceNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(HybridPortInstanceNameEditPart.VISUAL_ID));
	}
