...
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.AtomicComponentInstance2CanonicalEditPolicy;
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.AtomicComponentInstance2ItemSemanticEditPolicy;
...
public class AtomicComponentInstance2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AtomicComponentInstance2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new AtomicComponentInstance2CanonicalEditPolicy());
