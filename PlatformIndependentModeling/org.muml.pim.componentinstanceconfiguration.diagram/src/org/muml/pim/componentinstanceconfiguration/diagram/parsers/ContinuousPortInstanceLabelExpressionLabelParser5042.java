 ...
 * @generated
 */
public class ContinuousPortInstanceLabelExpressionLabelParser5042 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ContinuousPortInstanceLabelExpressionLabelParser5042() {
	...
	protected String getExpressionBody() {
		return MumlOCLFactory.getExpression(7, InstancePackage.eINSTANCE.getContinuousPortInstance(), null).body();
	}
