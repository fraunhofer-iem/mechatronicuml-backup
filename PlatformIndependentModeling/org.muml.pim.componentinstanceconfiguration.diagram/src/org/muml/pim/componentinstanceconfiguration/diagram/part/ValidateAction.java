...
import org.muml.pim.componentinstanceconfiguration.diagram.providers.ComponentinstanceconfigurationValidationProvider;
import org.muml.pim.componentinstanceconfiguration.diagram.providers.MumlMarkerNavigationProvider;
...
public class ValidateAction extends Action {
	...
	public void run() {
		...
		if (workbenchPart instanceof IDiagramWorkbenchPart) {
			...
			try {
				...
				ComponentinstanceconfigurationDiagramEditorPlugin.getInstance().logError("Validation action failed", e); //$NON-NLS-1$
			}
		}
	}
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		ComponentinstanceconfigurationValidationProvider.runWithConstraints(txDomain, new Runnable() {
