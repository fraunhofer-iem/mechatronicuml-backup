...
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.DiscreteMultiPortInstanceItemSemanticEditPolicy;
...
public class DiscreteMultiPortInstanceEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DiscreteMultiPortInstanceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DiscreteMultiPortInstanceDiscreteMultiPortInstanceCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureDiscreteSinglePortInstancesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((DiscreteMultiPortInstanceDiscreteMultiPortInstanceCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DiscreteMultiPortInstanceDiscreteMultiPortInstanceCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureDiscreteSinglePortInstancesCompartment();
			pane.remove(((DiscreteMultiPortInstanceDiscreteMultiPortInstanceCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof DiscreteMultiPortInstanceDiscreteMultiPortInstanceCompartmentEditPart) {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DiscreteMultiPortInstanceNameEditPart
				|| borderItemEditPart instanceof WrappingLabel9EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(DiscreteMultiPortInstanceNameEditPart.VISUAL_ID));
	}
