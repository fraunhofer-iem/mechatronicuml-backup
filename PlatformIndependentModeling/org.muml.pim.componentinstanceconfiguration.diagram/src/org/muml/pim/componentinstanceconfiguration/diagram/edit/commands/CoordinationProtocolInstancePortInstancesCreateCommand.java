...
public class CoordinationProtocolInstancePortInstancesCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null
				&& false == source instanceof org.muml.pim.instance.CoordinationProtocolInstance) {
			return false;
		}
		if (target != null && false == target instanceof org.muml.pim.instance.PortInstance) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getPortInstances().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected org.muml.pim.instance.CoordinationProtocolInstance getSource() {
		return (org.muml.pim.instance.CoordinationProtocolInstance) source;
	}

	/**
	 * @generated
	 */
	protected org.muml.pim.instance.PortInstance getTarget() {
		return (org.muml.pim.instance.PortInstance) target;
	}
}
