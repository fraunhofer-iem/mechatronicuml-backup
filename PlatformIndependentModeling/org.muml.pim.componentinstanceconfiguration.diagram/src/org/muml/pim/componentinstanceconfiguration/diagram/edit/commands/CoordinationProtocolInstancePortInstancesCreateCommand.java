...
public class CoordinationProtocolInstancePortInstancesCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof CoordinationProtocolInstance) {
			return false;
		}
		...
		if (!MumlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCoordinationProtocolInstancePortInstances_4003(getSource(), getTarget(), sourceView,
						targetView)) {
			String errorMessage = MumlBaseItemSemanticEditPolicy.getLinkConstraints()
					.getErrorCoordinationProtocolInstancePortInstances_4003(getSource(), getTarget(), sourceView,
							targetView);
	 ...
	 * @generated
	 */
	protected CoordinationProtocolInstance getSource() {
		return (CoordinationProtocolInstance) source;
	}
