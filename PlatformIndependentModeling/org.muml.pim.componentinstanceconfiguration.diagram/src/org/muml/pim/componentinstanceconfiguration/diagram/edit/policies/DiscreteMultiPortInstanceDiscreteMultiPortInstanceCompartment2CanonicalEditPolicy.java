...
public class DiscreteMultiPortInstanceDiscreteMultiPortInstanceCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return InstancePackage.eINSTANCE.getDiscreteMultiPortInstance_GmfSubPortInstances();
	}
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] { DiscreteSinglePortInstance2EditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return DiscreteSinglePortInstance2EditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
