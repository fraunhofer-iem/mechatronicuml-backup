 ...
 * @generated
 */
public class AtomicComponentInstanceCanonicalEditPolicy extends CanonicalEditPolicy {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public AtomicComponentInstanceCanonicalEditPolicy() {
	}

	/**
	 * @generated
	 */
	public AtomicComponentInstanceCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.part.MumlDiagramUpdater
				.getAtomicComponentInstance_2016SemanticChildren(viewObject);
