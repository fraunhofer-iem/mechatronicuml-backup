...
public class HybridPortEditor
	...
	protected void createProperties() {
		...
		addPropertyEditor(createInitializeExpression_GeneralTab_Editor(), false);
		...
		addEditorToCategory(
				...
				createOptional_GeneralTab_Editor(), false);

		addPropertyEditor(createSamplingInterval_GeneralTab_Editor(), false);

	}

	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorSamplingInterval_GeneralTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createSamplingInterval_GeneralTab_Editor() {
		if (this.editorSamplingInterval_GeneralTab == null) {
			...
			this.editorSamplingInterval_GeneralTab = editor;
		}
		return this.editorSamplingInterval_GeneralTab;
	}
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createOptional_GeneralTab_Editor() {
