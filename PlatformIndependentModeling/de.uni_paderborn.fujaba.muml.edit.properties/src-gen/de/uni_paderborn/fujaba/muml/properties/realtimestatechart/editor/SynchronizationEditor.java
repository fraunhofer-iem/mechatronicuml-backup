...
public class SynchronizationEditor
	...
	protected void createProperties() {
		...
		if (getTab() == null || "general".equals(getTab())) {
			addSyncChannel_GeneralTab_Editor(null, true);
		}
		...
		if (getTab() == null || "general".equals(getTab())) {
			addSelectorExpression_GeneralTab_Editor(null, true);
		}
	 ...
	 * @generated
	 */
	protected void addSyncChannel_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category, createSyncChannel_GeneralTab_Editor(),
				front);
	}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createSyncChannel_GeneralTab_Editor() {
	 ...
	 * @generated
	 */
	protected void addSelectorExpression_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category,
				createSelectorExpression_GeneralTab_Editor(), front);
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createSelectorExpression_GeneralTab_Editor() {
		final org.eclipse.emf.ecore.EStructuralFeature feature = de.uni_paderborn.fujaba.muml.realtimestatechart.RealtimestatechartPackage.eINSTANCE
