...
public class OperationEditor
	 ...
	 * @generated
	 */
	protected void addReturnType_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category, createReturnType_GeneralTab_Editor(),
				front);
	}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createReturnType_GeneralTab_Editor() {
	 ...
	 * @generated
	 */
	protected void addImplementations_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category,
				createImplementations_GeneralTab_Editor(), front);
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createImplementations_GeneralTab_Editor() {
		final org.eclipse.emf.ecore.EStructuralFeature feature = de.uni_paderborn.fujaba.muml.behavior.BehaviorPackage.eINSTANCE
