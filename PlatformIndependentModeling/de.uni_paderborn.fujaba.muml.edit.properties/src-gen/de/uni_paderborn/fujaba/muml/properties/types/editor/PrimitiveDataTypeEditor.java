...
public class PrimitiveDataTypeEditor extends de.uni_paderborn.fujaba.properties.runtime.editors.ClassPropertyEditor {
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorPrimitiveType_GeneralTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorPrimitiveType_GeneralTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorPrimitiveType_GeneralTab_Editor() {
		if (this.editorPrimitiveType_GeneralTab == null) {
			...
			this.editorPrimitiveType_GeneralTab = editor;
		}
		return this.editorPrimitiveType_GeneralTab;
	}
