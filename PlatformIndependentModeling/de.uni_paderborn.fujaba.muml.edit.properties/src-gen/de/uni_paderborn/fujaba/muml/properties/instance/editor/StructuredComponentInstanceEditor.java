...
public class StructuredComponentInstanceEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorEmbeddedCIC_GeneralTab_Editor(),
					false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorEmbeddedCIC_GeneralTab_Editor() {
