...
public class MessageTypeRepositoryEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addEditorToCategory("de.uni_paderborn.fujaba.properties.category.Lists",
					createEditorMessageTypes_GeneralTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorMessageTypes_GeneralTab_Editor() {
