...
public class MumlSheetLabelProvider extends BaseLabelProvider implements
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.part.MumlVisualIDRegistry
					.getVisualID(view);
			IElementType etype = de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.providers.MumlElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
