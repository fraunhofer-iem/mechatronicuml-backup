...
public class MumlOCLFactory {
	...
	protected MumlOCLFactory() {
		this.expressions = new de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.expressions.MumlAbstractExpression[29];
	...
	private static class Expression
			extends de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.expressions.MumlAbstractExpression {
