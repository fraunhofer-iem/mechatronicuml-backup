...
public class MumlModelingAssistantProvider extends ModelingAssistantProvider {
	...
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(
				de.uni_paderborn.fujaba.muml.messagetype.diagram.part.Messages.MumlModelingAssistantProviderMessage);
		dialog.setTitle(
				de.uni_paderborn.fujaba.muml.messagetype.diagram.part.Messages.MumlModelingAssistantProviderTitle);
