...
public class MumlDiagramActionBarContributor extends DiagramActionBarContributor {
	...
	protected Class getEditorClass() {
		return de.uni_paderborn.fujaba.muml.messagetype.diagram.part.MumlDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new de.uni_paderborn.fujaba.muml.messagetype.diagram.part.ValidateAction(page);
