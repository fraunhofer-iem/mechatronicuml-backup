 ...
 * @generated
 */
public class MessageTypeRepositoryMessageTypesCompartmentEditPart extends ListCompartmentEditPart {
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.messagetype.diagram.part.Messages.MessageTypeRepositoryMessageTypesCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new de.uni_paderborn.fujaba.muml.messagetype.diagram.edit.policies.MessageTypeRepositoryMessageTypesCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new de.uni_paderborn.fujaba.muml.messagetype.diagram.edit.policies.MessageTypeRepositoryMessageTypesCompartmentCanonicalEditPolicy());
	}
