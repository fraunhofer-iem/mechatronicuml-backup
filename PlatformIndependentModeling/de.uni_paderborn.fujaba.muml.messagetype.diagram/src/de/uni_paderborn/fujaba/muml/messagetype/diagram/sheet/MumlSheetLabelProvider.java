...
public class MumlSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	public Image getImage(Object element) {
		...
		return etype == null ? null
				: de.uni_paderborn.fujaba.muml.messagetype.diagram.providers.MumlElementTypes.getImage(etype);
	}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = de.uni_paderborn.fujaba.muml.messagetype.diagram.part.MumlVisualIDRegistry.getVisualID(view);
			IElementType etype = de.uni_paderborn.fujaba.muml.messagetype.diagram.providers.MumlElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
