...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>instance</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.instance"));
				AssemblyConnectorInstance root = InstanceFactory.eINSTANCE.createAssemblyConnectorInstance();
