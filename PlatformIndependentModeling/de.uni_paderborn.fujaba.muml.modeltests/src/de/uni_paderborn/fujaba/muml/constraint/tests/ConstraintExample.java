...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>constraint</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.constraint"));
				TextualConstraint root = ConstraintFactory.eINSTANCE.createTextualConstraint();
