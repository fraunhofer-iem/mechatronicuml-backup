...
public class TransitionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof de.uni_paderborn.fujaba.muml.realtimestatechart.Vertex) {
			return false;
		}
		if (target != null && false == target instanceof de.uni_paderborn.fujaba.muml.realtimestatechart.Vertex) {
			return false;
		}
		if (getSource() == null) {
	 ...
	 * @generated
	 */
	protected void doConfigure(de.uni_paderborn.fujaba.muml.realtimestatechart.Transition newElement,
	 ...
	 * @generated
	 */
	private static de.uni_paderborn.fujaba.muml.realtimestatechart.RealtimeStatechart deduceContainer(EObject source,
			EObject target) {
	...
	private static de.uni_paderborn.fujaba.muml.realtimestatechart.RealtimeStatechart deduceContainerUsingViews(
		...
		for (View view = sourceView; view != null; view = (View) view.eContainer()) {
			if (view.getElement() instanceof de.uni_paderborn.fujaba.muml.realtimestatechart.RealtimeStatechart) {
				return (de.uni_paderborn.fujaba.muml.realtimestatechart.RealtimeStatechart) view.getElement();
			}
		}
		return null;
	}
