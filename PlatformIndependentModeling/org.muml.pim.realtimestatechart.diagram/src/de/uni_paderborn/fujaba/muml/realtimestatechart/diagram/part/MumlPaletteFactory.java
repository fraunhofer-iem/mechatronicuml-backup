...
public class MumlPaletteFactory {
	...
	private PaletteContainer createRealTimeStatechart1Group() {
		...
		paletteContainer.setDescription(
				de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.part.Messages.RealTimeStatechart1Group_desc);
	...
	private PaletteContainer createRealTimeState2Group() {
		...
		paletteContainer.setDescription(
				de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.part.Messages.RealTimeState2Group_desc);
