 ...
 * @generated
 */
public class SynchronizationChannelLabelExpressionLabelParser5054 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public SynchronizationChannelLabelExpressionLabelParser5054() {
	...
	protected String getExpressionBody() {
		return MumlOCLFactory.getExpression(5, RealtimestatechartPackage.eINSTANCE.getSynchronizationChannel(), null)
				.body();
	}
