...
public class RealtimeStatechartStatechartContentsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RealtimestatechartPackage.eINSTANCE.getRealtimeStatechart_States();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { StateEditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getRealtimeStatechartStatechartContentsCompartment_7038SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return StateEditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
