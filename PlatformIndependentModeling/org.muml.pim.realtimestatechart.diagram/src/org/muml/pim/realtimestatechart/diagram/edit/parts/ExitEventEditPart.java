...
import org.muml.pim.realtimestatechart.diagram.edit.policies.ExitEventItemSemanticEditPolicy;
...
public class ExitEventEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExitEventItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel4EditPart) {
			((WrappingLabel4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStateItemLabel());
			return true;
		}
		return false;
	}
