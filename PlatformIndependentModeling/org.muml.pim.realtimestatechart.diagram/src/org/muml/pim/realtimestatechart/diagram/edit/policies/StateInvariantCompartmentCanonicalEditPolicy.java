...
public class StateInvariantCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { ClockConstraintEditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getStateInvariantCompartment_7034SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ClockConstraintEditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
