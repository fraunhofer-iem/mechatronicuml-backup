...
import org.muml.pim.realtimestatechart.diagram.edit.policies.ExitPointItemSemanticEditPolicy;
...
public class ExitPointEditPart extends AbstractBorderItemEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExitPointItemSemanticEditPolicy());
	...
	public class ExitPointFigure extends Ellipse {
		...
		private void createContents() {
			...
			polyline0.addPoint(new Point(getMapMode().DPtoLP(2), getMapMode().DPtoLP(2)));
			polyline0.addPoint(new Point(getMapMode().DPtoLP(1), getMapMode().DPtoLP(1)));
			polyline0.addPoint(new Point(getMapMode().DPtoLP(0), getMapMode().DPtoLP(2)));
			polyline0.addPoint(new Point(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0)));
			polyline0.addPoint(new Point(getMapMode().DPtoLP(1), getMapMode().DPtoLP(1)));
