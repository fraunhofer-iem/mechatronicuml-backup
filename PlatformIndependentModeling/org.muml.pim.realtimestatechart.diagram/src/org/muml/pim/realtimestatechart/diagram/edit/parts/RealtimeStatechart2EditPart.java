...
import org.muml.pim.realtimestatechart.diagram.edit.policies.RealtimeStatechart2ItemSemanticEditPolicy;

/**
 * @generated
 */
public class RealtimeStatechart2EditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RealtimeStatechart2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RealtimeStatechartStatechartContentsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureStatechartContentsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((RealtimeStatechartStatechartContentsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RealtimeStatechartStatechartContentsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureStatechartContentsCompartment();
			pane.remove(((RealtimeStatechartStatechartContentsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof RealtimeStatechartStatechartContentsCompartment2EditPart) {
