...
public class RealtimeStatechartItemSemanticEditPolicy
	...
	public RealtimeStatechartItemSemanticEditPolicy() {
		super(org.muml.pim.realtimestatechart.diagram.providers.MumlElementTypes.RealtimeStatechart_2007);
	}
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case org.muml.pim.realtimestatechart.diagram.edit.parts.StateEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (org.muml.pim.realtimestatechart.diagram.part.MumlVisualIDRegistry
									.getVisualID(
