...
public class MumlCreationWizardPage extends WizardNewFileCreationPage {
	...
	public void createControl(Composite parent) {
		...
		setFileName(org.muml.pim.messagetype.diagram.part.MumlDiagramEditorUtil
	...
	protected boolean validatePage() {
		...
		if (extension != null && !getFilePath().toString().endsWith("." + extension)) {
			setErrorMessage(NLS.bind(
					org.muml.pim.messagetype.diagram.part.Messages.MumlCreationWizardPageExtensionError,
					extension));
			return false;
		}
		return true;
