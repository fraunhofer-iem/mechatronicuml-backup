...
public class MumlMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
	 ...
	 * @generated
	 */
	public static final String MARKER_TYPE = org.muml.pim.messagetype.diagram.part.MessageTypeDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			org.muml.pim.messagetype.diagram.part.MumlDiagramEditorUtil.selectElementsInDiagram(editor,
