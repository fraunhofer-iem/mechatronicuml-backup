...
import org.muml.pim.messagetype.diagram.providers.MessageinterfaceValidationProvider;
import org.muml.pim.messagetype.diagram.providers.MumlMarkerNavigationProvider;
...
public class ValidateAction extends Action {
	...
	public void run() {
		...
		if (workbenchPart instanceof IDiagramWorkbenchPart) {
			...
			try {
				...
				MessageTypeDiagramEditorPlugin.getInstance().logError("Validation action failed", e); //$NON-NLS-1$
			}
		}
	}
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		MessageinterfaceValidationProvider.runWithConstraints(txDomain, new Runnable() {
