	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.messagetype.diagram.edit.policies.MessageTypeRepositoryItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pim.messagetype.diagram.edit.parts.MessageTypeRepositoryNameEditPart) {
			((org.muml.pim.messagetype.diagram.edit.parts.MessageTypeRepositoryNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMessageInterfaceNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pim.messagetype.diagram.edit.parts.MessageTypeRepositoryMessageTypesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureMessageTypesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((org.muml.pim.messagetype.diagram.edit.parts.MessageTypeRepositoryMessageTypesCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof org.muml.pim.messagetype.diagram.edit.parts.MessageTypeRepositoryMessageTypesCompartmentEditPart) {
