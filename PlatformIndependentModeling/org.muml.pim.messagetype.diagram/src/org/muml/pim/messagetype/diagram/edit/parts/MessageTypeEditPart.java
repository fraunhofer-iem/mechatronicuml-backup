	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pim.messagetype.diagram.edit.policies.MessageTypeItemSemanticEditPolicy());
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null) {
					if (child instanceof ITextAwareEditPart) {
						return new org.muml.pim.messagetype.diagram.edit.policies.MumlTextSelectionEditPolicy();
					}
				}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pim.messagetype.diagram.edit.parts.MessageTypeNameEditPart) {
			((org.muml.pim.messagetype.diagram.edit.parts.MessageTypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMessageTypeNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pim.messagetype.diagram.edit.parts.MessageTypeParametersCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParametersCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((org.muml.pim.messagetype.diagram.edit.parts.MessageTypeParametersCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof org.muml.pim.messagetype.diagram.edit.parts.MessageTypeParametersCompartmentEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == org.muml.pim.messagetype.diagram.providers.MumlElementTypes.Parameter_3009) {
				return getChildBySemanticHint(
						org.muml.pim.messagetype.diagram.part.MumlVisualIDRegistry.getType(
