...
import org.muml.pim.messagetype.diagram.edit.policies.MessageTypeItemSemanticEditPolicy;
import org.muml.pim.messagetype.diagram.edit.policies.MumlTextSelectionEditPolicy;
...
public class MessageTypeEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof MessageTypeParametersCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParametersCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((MessageTypeParametersCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof MessageTypeParametersCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParametersCompartmentFigure();
			pane.remove(((MessageTypeParametersCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof MessageTypeParametersCompartmentEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == MumlElementTypes.Parameter_3009) {
