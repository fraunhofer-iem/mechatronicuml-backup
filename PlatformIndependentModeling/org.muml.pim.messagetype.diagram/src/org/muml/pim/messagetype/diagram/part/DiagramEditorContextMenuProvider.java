...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	 ...
	 * @generated
	 */
	private org.muml.pim.messagetype.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new org.muml.pim.messagetype.diagram.part.DeleteElementAction(part);
		deleteAction.init();
	}
