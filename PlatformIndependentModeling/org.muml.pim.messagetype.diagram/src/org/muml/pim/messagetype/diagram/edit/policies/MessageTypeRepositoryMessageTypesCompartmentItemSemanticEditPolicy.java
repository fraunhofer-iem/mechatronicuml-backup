...
public class MessageTypeRepositoryMessageTypesCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (org.muml.pim.messagetype.diagram.providers.MumlElementTypes.MessageType_3007 == req
				.getElementType()) {
			return getGEFWrapper(
					new org.muml.pim.messagetype.diagram.edit.commands.MessageTypeCreateCommand(req));
		}
