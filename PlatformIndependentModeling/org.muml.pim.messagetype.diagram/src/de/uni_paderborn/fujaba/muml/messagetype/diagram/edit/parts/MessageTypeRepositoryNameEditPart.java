 ...
 * @generated
 */
public class MessageTypeRepositoryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.messagetype.diagram.providers.MumlParserProvider.getParser(
