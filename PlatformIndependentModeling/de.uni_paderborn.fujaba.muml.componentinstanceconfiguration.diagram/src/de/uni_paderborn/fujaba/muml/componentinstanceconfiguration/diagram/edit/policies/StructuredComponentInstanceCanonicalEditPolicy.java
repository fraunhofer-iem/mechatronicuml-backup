 ...
 * @generated
 */
public class StructuredComponentInstanceCanonicalEditPolicy extends CanonicalEditPolicy {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public StructuredComponentInstanceCanonicalEditPolicy() {
	}

	/**
	 * @generated
	 */
	public StructuredComponentInstanceCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.part.MumlDiagramUpdater
				.getStructuredComponentInstance_2015SemanticChildren(viewObject);
