 ...
 * @generated
 */
public class AtomicComponentInstance2CanonicalEditPolicy extends CanonicalEditPolicy {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public AtomicComponentInstance2CanonicalEditPolicy() {
	}

	/**
	 * @generated
	 */
	public AtomicComponentInstance2CanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.part.MumlDiagramUpdater
				.getAtomicComponentInstance_3024SemanticChildren(viewObject);
