...
public class MumlVisualIDRegistry {
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getComponentInstanceConfiguration()
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.ComponentInstanceConfigurationDiagramEditPart.VISUAL_ID:
			if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getHybridPortInstance()
					.isSuperTypeOf(domainElement.eClass())) {
			...
			if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getDiscreteSinglePortInstance()
					.isSuperTypeOf(domainElement.eClass())
			...
			if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getDiscreteMultiPortInstance()
					.isSuperTypeOf(domainElement.eClass())) {
			...
			if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getContinuousPortInstance()
					.isSuperTypeOf(domainElement.eClass())) {
			...
			if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getAtomicComponentInstance()
					.isSuperTypeOf(domainElement.eClass())) {
			...
			if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getStructuredComponentInstance()
					.isSuperTypeOf(domainElement.eClass())) {
			...
			if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getCoordinationProtocolInstance()
					.isSuperTypeOf(domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.DiscreteSinglePortInstanceEditPart.VISUAL_ID:
			...
			if (de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.WrappingLabel7EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.DiscreteMultiPortInstanceEditPart.VISUAL_ID:
			...
			if (de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.WrappingLabel9EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.DiscreteSinglePortInstance3EditPart.VISUAL_ID:
			...
			if (de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.WrappingLabel8EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.DiscreteMultiPortInstance2EditPart.VISUAL_ID:
			...
			if (de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getAssemblyConnectorInstance()
				.isSuperTypeOf(domainElement.eClass())
		...
		if (de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE.getDelegationConnectorInstance()
				.isSuperTypeOf(domainElement.eClass())
	 ...
	 * @generated
	 */
	private static boolean isDiagram(de.uni_paderborn.fujaba.muml.instance.ComponentInstanceConfiguration element) {
		return true;
	}
	...
	private static boolean isDelegationConnectorInstance_4002(
			de.uni_paderborn.fujaba.muml.instance.DelegationConnectorInstance domainElement) {
		Object result = de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.expressions.MumlOCLFactory
				.getExpression(13, de.uni_paderborn.fujaba.muml.instance.InstancePackage.eINSTANCE
