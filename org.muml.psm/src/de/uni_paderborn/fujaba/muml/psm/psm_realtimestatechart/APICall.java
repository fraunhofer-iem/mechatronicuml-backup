 ...
 * </p>
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.psm_realtimestatechart.APICall#getApiCallSignature <em>Api Call Signature</em>}</li>
 * </ul>
 *
 * @see de.uni_paderborn.fujaba.muml.psm.psm_realtimestatechart.Psm_realtimestatechartPackage#getAPICall()
 * @model
 * @generated
 */
public interface APICall extends OperationCall {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.psm_realtimestatechart.Psm_realtimestatechartPackage#getAPICall_ApiCallSignature()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.psm_realtimestatechart.APICall#getApiCallSignature <em>Api Call Signature</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
