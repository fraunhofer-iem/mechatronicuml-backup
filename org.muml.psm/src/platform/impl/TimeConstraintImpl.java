 ...
 * </p>
 * <ul>
 *   <li>{@link platform.impl.TimeConstraintImpl#getSamplingTime <em>Sampling Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeConstraintImpl extends ConstraintImpl implements TimeConstraint {
	...
	protected EClass eStaticClass() {
		return PlatformPackage.Literals.TIME_CONSTRAINT;
	}
	...
	public NotificationChain basicSetSamplingTime(TimeValue newSamplingTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PlatformPackage.TIME_CONSTRAINT__SAMPLING_TIME, oldSamplingTime, newSamplingTime);
	...
	public void setSamplingTime(TimeValue newSamplingTime) {
		if (newSamplingTime != samplingTime) {
			...
			if (samplingTime != null)
				msgs = ((InternalEObject)samplingTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PlatformPackage.TIME_CONSTRAINT__SAMPLING_TIME, null, msgs);
			if (newSamplingTime != null)
				msgs = ((InternalEObject)newSamplingTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PlatformPackage.TIME_CONSTRAINT__SAMPLING_TIME, null, msgs);
			msgs = basicSetSamplingTime(newSamplingTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.TIME_CONSTRAINT__SAMPLING_TIME, newSamplingTime, newSamplingTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlatformPackage.TIME_CONSTRAINT__SAMPLING_TIME:
