 ...
 * </p>
 * <ul>
 *   <li>{@link platform.TimeConstraint#getSamplingTime <em>Sampling Time</em>}</li>
 * </ul>
 *
 * @see platform.PlatformPackage#getTimeConstraint()
 * @model
 * @generated
 */
public interface TimeConstraint extends Constraint {
	 ...
	 * @see platform.PlatformPackage#getTimeConstraint_SamplingTime()
	...
	/**
	 * Sets the value of the '{@link platform.TimeConstraint#getSamplingTime <em>Sampling Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
