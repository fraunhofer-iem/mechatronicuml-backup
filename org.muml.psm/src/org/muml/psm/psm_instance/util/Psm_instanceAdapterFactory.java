...
public class Psm_instanceAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.psm.psm_instance.ParameterisableDiscreteSinglePortInstance <em>Parameterisable Discrete Single Port Instance</em>}'.
	 * <!-- begin-user-doc -->
