...
public class AllocationAdapterFactory extends AdapterFactoryImpl {
	...
	protected AllocationSwitch<Adapter> modelSwitch =
		new AllocationSwitch<Adapter>() {
			@Override
			public Adapter caseSystemAllocation(SystemAllocation object) {
				return createSystemAllocationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.psm.allocation.SystemAllocation <em>System Allocation</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSystemAllocationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.muml.psm.allocation.Allocation <em>Allocation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.psm.allocation.AssemblyConnectorInstanceAllocation <em>Assembly Connector Instance Allocation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
