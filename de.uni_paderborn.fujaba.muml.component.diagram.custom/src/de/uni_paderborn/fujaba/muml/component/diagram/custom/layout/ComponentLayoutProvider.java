package de.uni_paderborn.fujaba.muml.component.diagram.custom.layout;
...
public class ComponentLayoutProvider extends TopDownProvider {
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof ILayoutNodeOperation) {
			...
			if (nodes.hasNext()) {
				...
				if (container == null
						|| !(container.getType().equals("Component"))) //$NON-NLS-1$
					return false;
			}
		} else {
			return false;
