...
public class GeneratedTest {
	 ...
	 */
	private static final String ECORE_MODEL_PROJECT = "de.uni_paderborn.fujaba.muml.hardware";

	/**
	 * The project-relative path to the muml.ecore file.
	 */
	private static final String ECORE_MODEL_PATH = "/model/hardware.ecore";

	/**
	 * The loaded resource of the hardware.ecore file.
	 */
	...
	public static void setUpBeforeClass() throws Exception {
		...
		TestUtilities
		.registerWorkspaceProject("de.uni_paderborn.fujaba.muml");
	...
	public void generatedTest() {
		...
		EPackage hardwarePackage = (EPackage) ecoreModel.getContents().get(0);
		...
		boolean equals = comparer.compare(hardwarePackage, HardwarePackage.eINSTANCE);
		if (!equals) {
