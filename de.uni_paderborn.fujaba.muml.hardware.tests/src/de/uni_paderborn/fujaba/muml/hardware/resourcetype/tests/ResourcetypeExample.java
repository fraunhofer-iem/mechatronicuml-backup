...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>resourcetype</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				MemoryResource root = ResourcetypeFactory.eINSTANCE.createMemoryResource();
