 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.expressions.impl.LogicalExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogicalExpressionImpl extends BinaryExpressionImpl implements LogicalExpression {
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.Literals.LOGICAL_EXPRESSION;
	}
	...
	public void setOperator(LogicalOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.LOGICAL_EXPRESSION__OPERATOR, oldOperator, operator));
	}
