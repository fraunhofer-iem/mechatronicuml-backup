 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.core.impl.TypedElementImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link de.uni_paderborn.uppaal.core.impl.TypedElementImpl#getTypeDefinition <em>Type Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypedElementImpl extends EObjectImpl implements TypedElement {
	...
	public TypedElementContainer getContainer() {
		if (eContainerFeatureID() != CorePackage.TYPED_ELEMENT__CONTAINER) return null;
	...
	public NotificationChain basicSetContainer(TypedElementContainer newContainer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainer, CorePackage.TYPED_ELEMENT__CONTAINER, msgs);
		return msgs;
	}
	...
	public void setContainer(TypedElementContainer newContainer) {
		if (newContainer != eInternalContainer() || (eContainerFeatureID() != CorePackage.TYPED_ELEMENT__CONTAINER && newContainer != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TYPED_ELEMENT__CONTAINER, newContainer, newContainer));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.TYPED_ELEMENT__CONTAINER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.TYPED_ELEMENT__CONTAINER:
				return getContainer();
			case CorePackage.TYPED_ELEMENT__TYPE_DEFINITION:
