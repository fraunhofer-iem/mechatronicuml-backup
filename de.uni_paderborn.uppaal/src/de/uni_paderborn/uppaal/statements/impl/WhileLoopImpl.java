 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.statements.impl.WhileLoopImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link de.uni_paderborn.uppaal.statements.impl.WhileLoopImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WhileLoopImpl extends StatementImpl implements WhileLoop {
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StatementsPackage.WHILE_LOOP__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StatementsPackage.WHILE_LOOP__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StatementsPackage.WHILE_LOOP__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.WHILE_LOOP__EXPRESSION, newExpression, newExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatementsPackage.WHILE_LOOP__EXPRESSION:
