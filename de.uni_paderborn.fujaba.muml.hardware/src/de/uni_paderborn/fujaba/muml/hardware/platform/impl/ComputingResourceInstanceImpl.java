 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.platform.impl.ComputingResourceInstanceImpl#getFrequency <em>Frequency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ComputingResourceInstanceImpl extends AtomicResourceInstanceImpl implements ComputingResourceInstance {
	...
	protected EClass eStaticClass() {
		return PlatformPackage.Literals.COMPUTING_RESOURCE_INSTANCE;
	}
	...
	public NotificationChain basicSetFrequency(Frequency newFrequency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PlatformPackage.COMPUTING_RESOURCE_INSTANCE__FREQUENCY, oldFrequency, newFrequency);
	...
	public void setFrequency(Frequency newFrequency) {
		if (newFrequency != frequency) {
			...
			if (frequency != null)
				msgs = ((InternalEObject)frequency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PlatformPackage.COMPUTING_RESOURCE_INSTANCE__FREQUENCY, null, msgs);
			if (newFrequency != null)
				msgs = ((InternalEObject)newFrequency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PlatformPackage.COMPUTING_RESOURCE_INSTANCE__FREQUENCY, null, msgs);
			msgs = basicSetFrequency(newFrequency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.COMPUTING_RESOURCE_INSTANCE__FREQUENCY, newFrequency, newFrequency));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlatformPackage.COMPUTING_RESOURCE_INSTANCE__FREQUENCY:
