 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.platform.impl.ProcessorInstanceImpl#getMIPS <em>MIPS</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.platform.impl.ProcessorInstanceImpl#getCPI <em>CPI</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.platform.impl.ProcessorInstanceImpl#getOwnedCacheInstance <em>Owned Cache Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessorInstanceImpl extends ComputingResourceInstanceImpl implements ProcessorInstance {
	...
	protected EClass eStaticClass() {
		return PlatformPackage.Literals.PROCESSOR_INSTANCE;
	}
	...
	public void setMIPS(float newMIPS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.PROCESSOR_INSTANCE__MIPS, oldMIPS, mips));
	}
	...
	public void setCPI(float newCPI) {
		...
		cpi = newCPI;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.PROCESSOR_INSTANCE__CPI, oldCPI, cpi));
	}
	...
	public CacheInstance getOwnedCacheInstance() {
		if (ownedCacheInstance != null && ownedCacheInstance.eIsProxy()) {
			...
			if (ownedCacheInstance != oldOwnedCacheInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PlatformPackage.PROCESSOR_INSTANCE__OWNED_CACHE_INSTANCE, oldOwnedCacheInstance, ownedCacheInstance));
			}
		}
	...
	public void setOwnedCacheInstance(CacheInstance newOwnedCacheInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.PROCESSOR_INSTANCE__OWNED_CACHE_INSTANCE, oldOwnedCacheInstance, ownedCacheInstance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PlatformPackage.PROCESSOR_INSTANCE__MIPS:
				return getMIPS();
			case PlatformPackage.PROCESSOR_INSTANCE__CPI:
				return getCPI();
			case PlatformPackage.PROCESSOR_INSTANCE__OWNED_CACHE_INSTANCE:
