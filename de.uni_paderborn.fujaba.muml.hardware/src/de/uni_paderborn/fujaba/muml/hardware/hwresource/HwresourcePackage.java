...
public interface HwresourcePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int COMMUNICATION_PROTOCOL_REPOSITORY__COMMUNICATION_PROTOCOLS = 0;
	 ...
	 * @ordered
	 */
	int COMMUNICATION_PROTOCOL_REPOSITORY_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int COMMUNICATION_PROTOCOL_REPOSITORY_OPERATION_COUNT = 0;
