 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.AtomicResource#getParentStructuredResource <em>Parent Structured Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.hardware.resourcetype.ResourcetypePackage#getAtomicResource()
 * @model abstract="true"
 * @generated
 */
public interface AtomicResource extends ResourceType {
	/**
	 * Returns the value of the '<em><b>Parent Structured Resource</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.StructuredResource#getEmbeddedAtomicResources <em>Embedded Atomic Resources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.hardware.resourcetype.ResourcetypePackage#getAtomicResource_ParentStructuredResource()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.AtomicResource#getParentStructuredResource <em>Parent Structured Resource</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
