 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CommunicationProtocolImpl#isIsTimeTriggered <em>Is Time Triggered</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CommunicationProtocolImpl#isIsEventTriggered <em>Is Event Triggered</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CommunicationProtocolImpl#getFurtherInformation <em>Further Information</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CommunicationProtocolImpl extends NamedElementImpl implements CommunicationProtocol {
	...
	protected EClass eStaticClass() {
		return ResourcetypePackage.Literals.COMMUNICATION_PROTOCOL;
	}
	...
	public void setIsTimeTriggered(boolean newIsTimeTriggered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcetypePackage.COMMUNICATION_PROTOCOL__IS_TIME_TRIGGERED, oldIsTimeTriggered, isTimeTriggered));
	}
	...
	public void setIsEventTriggered(boolean newIsEventTriggered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcetypePackage.COMMUNICATION_PROTOCOL__IS_EVENT_TRIGGERED, oldIsEventTriggered, isEventTriggered));
	}
	...
	public void setFurtherInformation(String newFurtherInformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcetypePackage.COMMUNICATION_PROTOCOL__FURTHER_INFORMATION, oldFurtherInformation, furtherInformation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcetypePackage.COMMUNICATION_PROTOCOL__IS_TIME_TRIGGERED:
				return isIsTimeTriggered();
			case ResourcetypePackage.COMMUNICATION_PROTOCOL__IS_EVENT_TRIGGERED:
				return isIsEventTriggered();
			case ResourcetypePackage.COMMUNICATION_PROTOCOL__FURTHER_INFORMATION:
