 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CacheImpl#getWritePolicy <em>Write Policy</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CacheImpl#getReplacementPolicy <em>Replacement Policy</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CacheImpl#getNbSets <em>Nb Sets</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CacheImpl#getAssociativity <em>Associativity</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.impl.CacheImpl#getUsedByProcessor <em>Used By Processor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CacheImpl extends MemoryResourceImpl implements Cache {
	...
	protected EClass eStaticClass() {
		return ResourcetypePackage.Literals.CACHE;
	}
	...
	public void setWritePolicy(WritePolicy newWritePolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcetypePackage.CACHE__WRITE_POLICY, oldWritePolicy, writePolicy));
	}
	...
	public void setReplacementPolicy(ReplacementPolicy newReplacementPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcetypePackage.CACHE__REPLACEMENT_POLICY, oldReplacementPolicy, replacementPolicy));
	}
	...
	public void setNbSets(int newNbSets) {
		...
		nbSets = newNbSets;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcetypePackage.CACHE__NB_SETS, oldNbSets, nbSets));
	}
	...
	public void setAssociativity(int newAssociativity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcetypePackage.CACHE__ASSOCIATIVITY, oldAssociativity, associativity));
	}
	...
	public EList<Processor> getUsedByProcessor() {
		if (usedByProcessor == null) {
			usedByProcessor = new EObjectWithInverseResolvingEList<Processor>(Processor.class, this, ResourcetypePackage.CACHE__USED_BY_PROCESSOR, ResourcetypePackage.PROCESSOR__OWNED_CACHE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResourcetypePackage.CACHE__USED_BY_PROCESSOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcetypePackage.CACHE__WRITE_POLICY:
				return getWritePolicy();
			case ResourcetypePackage.CACHE__REPLACEMENT_POLICY:
				return getReplacementPolicy();
			case ResourcetypePackage.CACHE__NB_SETS:
				return getNbSets();
			case ResourcetypePackage.CACHE__ASSOCIATIVITY:
