 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.hwvaluetype.impl.TimeIntervalImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimeIntervalImpl extends RangeImpl implements TimeInterval {
	/**
	...
	protected EClass eStaticClass() {
		return HwvaluetypePackage.Literals.TIME_INTERVAL;
	}
	...
	public void setUnit(TimeUnit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HwvaluetypePackage.TIME_INTERVAL__UNIT, oldUnit, unit));
	}
