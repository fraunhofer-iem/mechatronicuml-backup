 ...
 * @generated
 */
public class PlatforminstanceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PlatforminstancePackage.HW_PLATFORM_INSTANCE: {
			...
			case PlatforminstancePackage.HW_PLATFORM_INSTANCE_CONFIGURATION: {
