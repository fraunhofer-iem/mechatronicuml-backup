 ...
 *
 */
public class ClockConstraintBoundPropertyDescriptor extends
		ItemPropertyDescriptor {

	public ClockConstraintBoundPropertyDescriptor(AdapterFactory adapterFactory,
	...
	protected Object getObjectValue(EObject navigatedObject,
		...
		if (feature.getContainerClass() == NaturalNumber.class) {
			...
			switch (featureID) {
			case CorePackage.NATURAL_NUMBER__VALUE:
				 Long value = ((NaturalNumber) navigatedObject)
						.getValue();
				if (value != null) {
