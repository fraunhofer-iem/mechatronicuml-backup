...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.UMLClock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UMLClockItemProvider
	 ...
	 * @generated
	 */
	public UMLClockItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UMLClock_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UMLClock_id_feature", "_UI_UMLClock_type"),
				 RealtimestatechartPackage.Literals.UML_CLOCK__ID,
				 true,
				 false,
				 false,
	...
	protected void addAbsoluteDeadlinesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UMLClock_absoluteDeadlines_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UMLClock_absoluteDeadlines_feature", "_UI_UMLClock_type"),
				 RealtimestatechartPackage.Literals.UML_CLOCK__ABSOLUTE_DEADLINES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUMLRealtimeStatechartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UMLClock_uMLRealtimeStatechart_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UMLClock_uMLRealtimeStatechart_feature", "_UI_UMLClock_type"),
				 RealtimestatechartPackage.Literals.UML_CLOCK__UML_REALTIME_STATECHART,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UMLClock"));
	}
	...
	public String getText(Object object) {
		String label = ((UMLClock)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_UMLClock_type") :
			getString("_UI_UMLClock_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UMLClock.class)) {
