...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.DoAction} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DoActionItemProvider extends ItemProviderAdapter implements
	 ...
	 * @generated
	 */
	public DoActionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DoAction_periodLower_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DoAction_periodLower_feature", "_UI_DoAction_type"),
				 RealtimestatechartPackage.Literals.DO_ACTION__PERIOD_LOWER,
				 true,
				 false,
				 false,
	...
	protected void addPeriodUpperPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DoAction_periodUpper_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DoAction_periodUpper_feature", "_UI_DoAction_type"),
				 RealtimestatechartPackage.Literals.DO_ACTION__PERIOD_UPPER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addActionExprPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DoAction_actionExpr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DoAction_actionExpr_feature", "_UI_DoAction_type"),
				 RealtimestatechartPackage.Literals.DO_ACTION__ACTION_EXPR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RealtimestatechartPackage.Literals.DO_ACTION__ACTION);
		}
	...
	/**
	 * This returns DoAction.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DoAction"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DoAction.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add
			(createChildParameter
				(RealtimestatechartPackage.Literals.DO_ACTION__ACTION,
