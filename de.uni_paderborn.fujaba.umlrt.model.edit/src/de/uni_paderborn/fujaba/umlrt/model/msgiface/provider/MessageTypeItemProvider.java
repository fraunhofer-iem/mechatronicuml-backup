 ...
 * {@link de.uni_paderborn.fujaba.umlrt.model.msgiface.MessageType} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MessageTypeItemProvider extends CallableItemProvider implements
	...
	/**
	 * This adds a property descriptor for the Message Interface feature. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addMessageInterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageType_messageInterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageType_messageInterface_feature", "_UI_MessageType_type"),
				 MsgifacePackage.Literals.MESSAGE_TYPE__MESSAGE_INTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns MessageType.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
