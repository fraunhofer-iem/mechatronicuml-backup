...
public class ProtocolStatechartItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProtocolStatechart_port_feature", "_UI_ProtocolStatechart_type"),
				 BehaviorPackage.Literals.PROTOCOL_STATECHART__PORT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ProtocolStatechart.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProtocolStatechart"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProtocolStatechart_type") :
