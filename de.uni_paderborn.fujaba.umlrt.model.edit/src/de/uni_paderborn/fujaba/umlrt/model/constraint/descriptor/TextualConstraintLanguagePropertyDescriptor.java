...
public class TextualConstraintLanguagePropertyDescriptor extends ItemPropertyDescriptor {

	public TextualConstraintLanguagePropertyDescriptor(AdapterFactory adapterFactory,
	...
	public void setPropertyValue(Object object, Object value) {
		...
		newExpression.setLanguage((String) value);
	...
	protected Object getValue(EObject object, EStructuralFeature feature) {
		...
		if (c.getTextualExpression() != null) {
			return c.getTextualExpression().getLanguage();
		}
