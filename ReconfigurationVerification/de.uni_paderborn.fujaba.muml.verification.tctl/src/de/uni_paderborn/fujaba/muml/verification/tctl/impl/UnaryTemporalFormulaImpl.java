...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Unary Temporal Formula</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.verification.tctl.impl.UnaryTemporalFormulaImpl#getComparisonOperator <em>Comparison Operator</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.verification.tctl.impl.UnaryTemporalFormulaImpl#getTemporalOperator <em>Temporal Operator</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.verification.tctl.impl.UnaryTemporalFormulaImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UnaryTemporalFormulaImpl extends UnaryFormulaImpl implements UnaryTemporalFormula {
	/**
	 ...
	 * @generated
	 */
	protected UnaryTemporalFormulaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TctlPackage.Literals.UNARY_TEMPORAL_FORMULA;
	}
	...
	public void setComparisonOperator(ComparisonOperator newComparisonOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TctlPackage.UNARY_TEMPORAL_FORMULA__COMPARISON_OPERATOR, oldComparisonOperator, comparisonOperator));
	}
	...
	public void setTemporalOperator(TemporalOperator newTemporalOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TctlPackage.UNARY_TEMPORAL_FORMULA__TEMPORAL_OPERATOR, oldTemporalOperator, temporalOperator));
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TctlPackage.UNARY_TEMPORAL_FORMULA__VALUE, oldValue, value));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TemporalFormula.class) {
			switch (derivedFeatureID) {
				case TctlPackage.UNARY_TEMPORAL_FORMULA__COMPARISON_OPERATOR: return TctlPackage.TEMPORAL_FORMULA__COMPARISON_OPERATOR;
				case TctlPackage.UNARY_TEMPORAL_FORMULA__TEMPORAL_OPERATOR: return TctlPackage.TEMPORAL_FORMULA__TEMPORAL_OPERATOR;
				case TctlPackage.UNARY_TEMPORAL_FORMULA__VALUE: return TctlPackage.TEMPORAL_FORMULA__VALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TemporalFormula.class) {
			switch (baseFeatureID) {
				case TctlPackage.TEMPORAL_FORMULA__COMPARISON_OPERATOR: return TctlPackage.UNARY_TEMPORAL_FORMULA__COMPARISON_OPERATOR;
				case TctlPackage.TEMPORAL_FORMULA__TEMPORAL_OPERATOR: return TctlPackage.UNARY_TEMPORAL_FORMULA__TEMPORAL_OPERATOR;
				case TctlPackage.TEMPORAL_FORMULA__VALUE: return TctlPackage.UNARY_TEMPORAL_FORMULA__VALUE;
				default: return -1;
			}
		}
