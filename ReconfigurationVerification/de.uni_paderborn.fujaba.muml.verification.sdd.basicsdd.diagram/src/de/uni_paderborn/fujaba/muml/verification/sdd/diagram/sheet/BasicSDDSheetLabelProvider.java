package de.uni_paderborn.fujaba.muml.verification.sdd.diagram.sheet;
...
public class BasicSDDSheetLabelProvider extends BaseLabelProvider implements
	...
	public String getText(Object element) {
		...
		if (element instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.navigator.BasicSDDNavigatorGroup) {
			return ((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.navigator.BasicSDDNavigatorGroup) element)
					.getGroupName();
		}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
					.getVisualID(view);
			IElementType etype = de.uni_paderborn.fujaba.muml.verification.sdd.diagram.providers.BasicSDDElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
