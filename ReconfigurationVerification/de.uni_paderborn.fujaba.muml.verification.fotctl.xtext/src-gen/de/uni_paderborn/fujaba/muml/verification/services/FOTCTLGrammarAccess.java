...
public class FOTCTLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class FoTCTLSpecElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cRightCurlyBracketLineFeedLfKeyword_2_3 = (Keyword)cGroup_2.eContents().get(3);
		...
		private final Keyword cRightCurlyBracketLineFeedLfKeyword_3_3 = (Keyword)cGroup_3.eContents().get(3);
		...
		private final Keyword cRightCurlyBracketLineFeedLfKeyword_4_3 = (Keyword)cGroup_4.eContents().get(3);
		...
		//"}\n"
		public Keyword getRightCurlyBracketLineFeedLfKeyword_2_3() { return cRightCurlyBracketLineFeedLfKeyword_2_3; }
		...
		//"}\n"
		public Keyword getRightCurlyBracketLineFeedLfKeyword_3_3() { return cRightCurlyBracketLineFeedLfKeyword_3_3; }
		...
		//"}\n"
		public Keyword getRightCurlyBracketLineFeedLfKeyword_4_3() { return cRightCurlyBracketLineFeedLfKeyword_4_3; }
	...
	public class FoTCTLFormulaElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cSemicolonLineFeedLfKeyword_2 = (Keyword)cGroup.eContents().get(2);
		...
		//";\n"
		public Keyword getSemicolonLineFeedLfKeyword_2() { return cSemicolonLineFeedLfKeyword_2; }
	}
	...
	private FoTCTLSpecElements pFoTCTLSpec;
	private FoTCTLFormulaElements pFoTCTLFormula;
	private FormulaDefinitionElements pFormulaDefinition;
	private NodeLabelPredicateDeclElements pNodeLabelPredicateDecl;
	private EdgeLabelPredicateDeclElements pEdgeLabelPredicateDecl;
	private ConstantSymbolDeclElements pConstantSymbolDecl;
	private ConstantElements pConstant;
	private VariableElements pVariable;
	private UnaryFormulaElements pUnaryFormula;
	private BinaryFormulaElements pBinaryFormula;
	private AtomicFormulaElements pAtomicFormula;
	private NodeLabelPredicateElements pNodeLabelPredicate;
	private EdgeLabelPredicateElements pEdgeLabelPredicate;
	private QuantifiedFormulaElements pQuantifiedFormula;
	private QuantifierElements unknownRuleQuantifier;
	private TCTLFormulaElements pTCTLFormula;
	private NotFormulaElements pNotFormula;
	private TemporalFormulaElements pTemporalFormula;
	private UnaryTemporalFormulaElements pUnaryTemporalFormula;
	private BinaryTemporalFormulaElements pBinaryTemporalFormula;
	private BinaryLogicFormulaElements pBinaryLogicFormula;
	private BinaryLogicOperatorElements unknownRuleBinaryLogicOperator;
	...
	private TerminalRule tNode_predicate_name;
	private TerminalRule tEdge_predicate_name;
	private TerminalRule tVariable_name;
	private TerminalRule tConstant_name;
	...
	public FoTCTLSpecElements getFoTCTLSpecAccess() {
		return (pFoTCTLSpec != null) ? pFoTCTLSpec : (pFoTCTLSpec = new FoTCTLSpecElements());
	}
	...
	public FoTCTLFormulaElements getFoTCTLFormulaAccess() {
		return (pFoTCTLFormula != null) ? pFoTCTLFormula : (pFoTCTLFormula = new FoTCTLFormulaElements());
	}
	...
	public FormulaDefinitionElements getFormulaDefinitionAccess() {
		return (pFormulaDefinition != null) ? pFormulaDefinition : (pFormulaDefinition = new FormulaDefinitionElements());
	}
	...
	public NodeLabelPredicateDeclElements getNodeLabelPredicateDeclAccess() {
		return (pNodeLabelPredicateDecl != null) ? pNodeLabelPredicateDecl : (pNodeLabelPredicateDecl = new NodeLabelPredicateDeclElements());
	}
	...
	public EdgeLabelPredicateDeclElements getEdgeLabelPredicateDeclAccess() {
		return (pEdgeLabelPredicateDecl != null) ? pEdgeLabelPredicateDecl : (pEdgeLabelPredicateDecl = new EdgeLabelPredicateDeclElements());
	}
	...
	public ConstantSymbolDeclElements getConstantSymbolDeclAccess() {
		return (pConstantSymbolDecl != null) ? pConstantSymbolDecl : (pConstantSymbolDecl = new ConstantSymbolDeclElements());
	}
	...
	public UnaryFormulaElements getUnaryFormulaAccess() {
		return (pUnaryFormula != null) ? pUnaryFormula : (pUnaryFormula = new UnaryFormulaElements());
	}
	...
	public BinaryFormulaElements getBinaryFormulaAccess() {
		return (pBinaryFormula != null) ? pBinaryFormula : (pBinaryFormula = new BinaryFormulaElements());
	}
	...
	public AtomicFormulaElements getAtomicFormulaAccess() {
		return (pAtomicFormula != null) ? pAtomicFormula : (pAtomicFormula = new AtomicFormulaElements());
	}
	...
	public NodeLabelPredicateElements getNodeLabelPredicateAccess() {
		return (pNodeLabelPredicate != null) ? pNodeLabelPredicate : (pNodeLabelPredicate = new NodeLabelPredicateElements());
	}
	...
	public EdgeLabelPredicateElements getEdgeLabelPredicateAccess() {
		return (pEdgeLabelPredicate != null) ? pEdgeLabelPredicate : (pEdgeLabelPredicate = new EdgeLabelPredicateElements());
	}
	...
	public QuantifiedFormulaElements getQuantifiedFormulaAccess() {
		return (pQuantifiedFormula != null) ? pQuantifiedFormula : (pQuantifiedFormula = new QuantifiedFormulaElements());
	}
	...
	public QuantifierElements getQuantifierAccess() {
		return (unknownRuleQuantifier != null) ? unknownRuleQuantifier : (unknownRuleQuantifier = new QuantifierElements());
	}
	...
	public TCTLFormulaElements getTCTLFormulaAccess() {
		return (pTCTLFormula != null) ? pTCTLFormula : (pTCTLFormula = new TCTLFormulaElements());
	}
	...
	public NotFormulaElements getNotFormulaAccess() {
		return (pNotFormula != null) ? pNotFormula : (pNotFormula = new NotFormulaElements());
	}
	...
	public TemporalFormulaElements getTemporalFormulaAccess() {
		return (pTemporalFormula != null) ? pTemporalFormula : (pTemporalFormula = new TemporalFormulaElements());
	}
	...
	public UnaryTemporalFormulaElements getUnaryTemporalFormulaAccess() {
		return (pUnaryTemporalFormula != null) ? pUnaryTemporalFormula : (pUnaryTemporalFormula = new UnaryTemporalFormulaElements());
	}
	...
	public BinaryTemporalFormulaElements getBinaryTemporalFormulaAccess() {
		return (pBinaryTemporalFormula != null) ? pBinaryTemporalFormula : (pBinaryTemporalFormula = new BinaryTemporalFormulaElements());
	}
	...
	public BinaryLogicFormulaElements getBinaryLogicFormulaAccess() {
		return (pBinaryLogicFormula != null) ? pBinaryLogicFormula : (pBinaryLogicFormula = new BinaryLogicFormulaElements());
	}
	...
	public BinaryLogicOperatorElements getBinaryLogicOperatorAccess() {
		return (unknownRuleBinaryLogicOperator != null) ? unknownRuleBinaryLogicOperator : (unknownRuleBinaryLogicOperator = new BinaryLogicOperatorElements());
	}
	...
	public TerminalRule getNode_predicate_nameRule() {
		return (tNode_predicate_name != null) ? tNode_predicate_name : (tNode_predicate_name = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "node_predicate_name"));
	} 
	...
	public TerminalRule getEdge_predicate_nameRule() {
		return (tEdge_predicate_name != null) ? tEdge_predicate_name : (tEdge_predicate_name = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "edge_predicate_name"));
	} 
	...
	public TerminalRule getVariable_nameRule() {
		return (tVariable_name != null) ? tVariable_name : (tVariable_name = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "variable_name"));
	} 
	...
	public TerminalRule getConstant_nameRule() {
		return (tConstant_name != null) ? tConstant_name : (tConstant_name = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "constant_name"));
	} 
