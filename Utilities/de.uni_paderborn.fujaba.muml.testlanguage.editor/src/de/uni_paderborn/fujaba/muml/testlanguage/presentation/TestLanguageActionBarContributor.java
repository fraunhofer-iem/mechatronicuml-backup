...
/**
 * This is the action bar contributor for the TestLanguage model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TestLanguageActionBarContributor extends
	 ...
	 * @generated
	 */
	public TestLanguageActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("testlanguage-settings"));
		toolBarManager.add(new Separator("testlanguage-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				TestLanguageEditorPlugin.INSTANCE
						.getString("_UI_TestLanguageEditor_menu"),
				"de.uni_paderborn.fujaba.muml.testlanguageMenuID");
