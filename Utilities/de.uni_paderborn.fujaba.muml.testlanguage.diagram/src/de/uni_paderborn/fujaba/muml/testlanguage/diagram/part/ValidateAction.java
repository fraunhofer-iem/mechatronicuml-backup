...
import de.uni_paderborn.fujaba.muml.testlanguage.custom.validation.ValidationRunnable;
...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(de.uni_paderborn.fujaba.muml.testlanguage.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
