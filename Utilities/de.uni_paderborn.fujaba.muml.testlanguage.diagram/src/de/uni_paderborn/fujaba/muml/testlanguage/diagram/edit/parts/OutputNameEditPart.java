 ...
 * @generated
 */
public class OutputNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.policies.TestLanguageTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.testlanguage.diagram.providers.TestLanguageParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.TestLanguageEditPartFactory
