...
public class NodeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.testlanguage.Node newElement = de.uni_paderborn.fujaba.muml.testlanguage.TestLanguageFactory.eINSTANCE
				.createNode();

		de.uni_paderborn.fujaba.muml.testlanguage.TestCase owner = (de.uni_paderborn.fujaba.muml.testlanguage.TestCase) getElementToEdit();
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.testlanguage.Node newElement,
