 ...
 * @generated
 */
public class TestLanguageCreationWizardPage extends WizardNewFileCreationPage {
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(NLS
					.bind(de.uni_paderborn.fujaba.muml.testlanguage.diagram.part.Messages.TestLanguageCreationWizardPageExtensionError,
							extension));
			return false;
		}
		return true;
