...
public interface Input extends Port {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.testlanguage.TestLanguagePackage#getInput_Source()
	 ...
	 * @see #setNode(Node)
	 * @see de.uni_paderborn.fujaba.muml.testlanguage.TestLanguagePackage#getInput_Node()
	 ...
	 * @see de.uni_paderborn.fujaba.muml.testlanguage.TestLanguagePackage#getInput_Optional()
	 ...
	 * @see de.uni_paderborn.fujaba.muml.testlanguage.TestLanguagePackage#getInput_DataType()
	 * @model
	 * @generated
	 */
	Class<?> getDataType();
