...
«««				«IF eClass.name != 'StaticStructuredComponent' && i.name == 'connectors' || i.name == 'connectorInstances'» 
...
«««    			«ELSEIF i.name == 'references'»
«««    				_«i.name» := self._«i.name».map «i.EType.name»2«i.EType.name»();
«««   			«ENDIF»
«««
«««             another option is to use late resolve in these cases like in the code below
«««
