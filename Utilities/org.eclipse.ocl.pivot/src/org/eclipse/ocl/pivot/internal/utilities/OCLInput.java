 ...
 * 
 * @deprecated This class is provided for Ecore-binding compatibility. It provides
 * services for the LPG parser that are not relevant to the Xtext resource loader.
 */
@Deprecated
