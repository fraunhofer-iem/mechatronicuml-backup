 ...
 * <ul>
 * <li>
 * {@link de.uni_paderborn.fujaba.muml.testlanguage.specification.impl.PrimitiveStringImpl#getValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 *
...
public class PrimitiveStringImpl extends NodeSpecificationImpl implements
	...
	protected EClass eStaticClass() {
		return SpecificationPackage.Literals.PRIMITIVE_STRING;
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NodeSpecification.class) {
			...
			case SpecificationPackage.NODE_SPECIFICATION___INITIALIZE:
				return SpecificationPackage.PRIMITIVE_STRING___INITIALIZE;
			case SpecificationPackage.NODE_SPECIFICATION___EXECUTE__MAP_MAP:
				return SpecificationPackage.PRIMITIVE_STRING___EXECUTE__MAP_MAP;
			default:
