...
public class NodeSpecificationItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public NodeSpecificationItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns NodeSpecification.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((NodeSpecification) object).getLabel();
		return label == null || label.length() == 0 ? getString("_UI_NodeSpecification_type")
				: getString("_UI_NodeSpecification_type") + " " + label;
	}
