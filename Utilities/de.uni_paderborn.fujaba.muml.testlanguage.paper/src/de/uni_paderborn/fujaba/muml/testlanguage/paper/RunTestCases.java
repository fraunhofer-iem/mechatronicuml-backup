package de.uni_paderborn.fujaba.muml.testlanguage.paper;
...
public class RunTestCases {
	...
	public static Collection<Object[]> getTestCases() {
		...
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/bebot_correct.testlanguage");
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/bebots_incorrect.testlanguage");
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/overtaking-cars_correct.testlanguage");
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/overtaking-cars_incorrect.testlanguage");
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/overtaking-cars-w-contraflow_correct.testlanguage");
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/overtaking-cars-w-contraflow_incorrect.testlanguage");
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/railcab_correct.testlanguage");
		addCase("platform:/plugin/de.uni_paderborn.fujaba.muml.testlanguage.paper/tests/railcab_incorrect.testlanguage");
