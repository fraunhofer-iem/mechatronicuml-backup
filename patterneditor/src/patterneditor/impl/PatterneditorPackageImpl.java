...
public class PatterneditorPackageImpl extends EPackageImpl implements PatterneditorPackage {
	 ...
	 * @see patterneditor.PatterneditorPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		ModelstructurePackage theModelstructurePackage = (ModelstructurePackage)EPackage.Registry.INSTANCE.getEPackage(ModelstructurePackage.eNS_URI);
		...
		patternDiagramEClass.getESuperTypes().add(theModelstructurePackage.getDiagram());
