...
public class MultiPortVariableMultiPortVariablesCompartmentEditPart extends
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.part.Messages.MultiPortVariableMultiPortVariablesCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartmentCanonicalEditPolicy());
	}
