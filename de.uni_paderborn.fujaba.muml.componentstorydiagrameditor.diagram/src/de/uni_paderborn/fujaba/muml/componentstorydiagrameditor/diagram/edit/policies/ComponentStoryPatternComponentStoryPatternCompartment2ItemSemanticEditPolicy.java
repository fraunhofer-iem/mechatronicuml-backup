...
public class ComponentStoryPatternComponentStoryPatternCompartment2ItemSemanticEditPolicy
	...
	public ComponentStoryPatternComponentStoryPatternCompartment2ItemSemanticEditPolicy() {
		super(
				de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.providers.ComponentStoryDiagramElementTypes.ComponentStoryPattern_3022);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.providers.ComponentStoryDiagramElementTypes.ComponentVariable_3012 == req
				.getElementType()) {
