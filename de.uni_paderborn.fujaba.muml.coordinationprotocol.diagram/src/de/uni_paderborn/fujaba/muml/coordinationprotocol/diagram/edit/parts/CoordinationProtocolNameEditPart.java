...
public class CoordinationProtocolNameEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.policies.MumlTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.parts.ModelElementCategoryEditPart.NodeLabelDragPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.policies.MumlTextSelectionEditPolicy) {
			((de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.policies.MumlTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.policies.MumlTextSelectionEditPolicy) {
			((de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.policies.MumlTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.providers.MumlParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					...
					de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.edit.parts.MumlEditPartFactory
