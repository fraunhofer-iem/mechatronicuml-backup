...
public class MumlDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.part.CoordinationProtocolDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new de.uni_paderborn.fujaba.muml.coordinationprotocol.diagram.part.ValidateAction(
				page);
