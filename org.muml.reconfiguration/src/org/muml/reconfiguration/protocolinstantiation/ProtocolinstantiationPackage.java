...
public interface ProtocolinstantiationPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__CONTAINED_BEHAVIOR = ComponentPackage.PORT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__SENDER_MESSAGE_TYPES = ComponentPackage.PORT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__RECEIVER_MESSAGE_TYPES = ComponentPackage.PORT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__COORDINATOR_BEHAVIOR = ComponentPackage.PORT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__SUBROLE_BEHAVIOR = ComponentPackage.PORT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__CARDINALITY = ComponentPackage.PORT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__RECEIVER_MESSAGE_BUFFER = ComponentPackage.PORT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__MULTI = ComponentPackage.PORT_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__SPECIFICATION = ComponentPackage.PORT_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT__KIND = ComponentPackage.PORT_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int BROADCAST_PORT_FEATURE_COUNT = ComponentPackage.PORT_FEATURE_COUNT + 11;
