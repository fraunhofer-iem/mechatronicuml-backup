 ...
 *   <li>{@link org.muml.reconfiguration.protocolinstantiation.impl.BroadcastPortImpl#getContainedBehavior <em>Contained Behavior</em>}</li>
...
public class BroadcastPortImpl extends PortImpl implements BroadcastPort {
	...
	public NotificationChain basicSetContainedBehavior(Behavior newContainedBehavior, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProtocolinstantiationPackage.BROADCAST_PORT__CONTAINED_BEHAVIOR, oldContainedBehavior, newContainedBehavior);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContainedBehavior(Behavior newContainedBehavior) {
		if (newContainedBehavior != containedBehavior) {
			...
			if (containedBehavior != null)
				msgs = ((InternalEObject)containedBehavior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProtocolinstantiationPackage.BROADCAST_PORT__CONTAINED_BEHAVIOR, null, msgs);
			if (newContainedBehavior != null)
				msgs = ((InternalEObject)newContainedBehavior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProtocolinstantiationPackage.BROADCAST_PORT__CONTAINED_BEHAVIOR, null, msgs);
			msgs = basicSetContainedBehavior(newContainedBehavior, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProtocolinstantiationPackage.BROADCAST_PORT__CONTAINED_BEHAVIOR, newContainedBehavior, newContainedBehavior));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ProtocolinstantiationPackage.BROADCAST_PORT__CONTAINED_BEHAVIOR:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BehavioralElement.class) {
			switch (derivedFeatureID) {
				...
				case ProtocolinstantiationPackage.BROADCAST_PORT__CONTAINED_BEHAVIOR: return BehaviorPackage.BEHAVIORAL_ELEMENT__CONTAINED_BEHAVIOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BehavioralElement.class) {
			switch (baseFeatureID) {
				...
				case BehaviorPackage.BEHAVIORAL_ELEMENT__CONTAINED_BEHAVIOR: return ProtocolinstantiationPackage.BROADCAST_PORT__CONTAINED_BEHAVIOR;
				default: return -1;
			}
		}
		if (baseClass == DiscreteInteractionEndpoint.class) {
