 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getBehavior <em>Behavior</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getContainedBehavior <em>Contained Behavior</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getSenderMessageTypes <em>Sender Message Types</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getReceiverMessageTypes <em>Receiver Message Types</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getCoordinatorBehavior <em>Coordinator Behavior</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getSubroleBehavior <em>Subrole Behavior</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#getReceiverMessageBuffer <em>Receiver Message Buffer</em>}</li>
 *   <li>{@link org.muml.reconfiguration.impl.ReconfigurationPortImpl#isMulti <em>Multi</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ReconfigurationPortImpl extends PortImpl implements ReconfigurationPort {
	...
	public NotificationChain basicSetContainedBehavior(Behavior newContainedBehavior, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReconfigurationPackage.RECONFIGURATION_PORT__CONTAINED_BEHAVIOR, oldContainedBehavior, newContainedBehavior);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContainedBehavior(Behavior newContainedBehavior) {
		if (newContainedBehavior != containedBehavior) {
			...
			if (containedBehavior != null)
				msgs = ((InternalEObject)containedBehavior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReconfigurationPackage.RECONFIGURATION_PORT__CONTAINED_BEHAVIOR, null, msgs);
			if (newContainedBehavior != null)
				msgs = ((InternalEObject)newContainedBehavior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReconfigurationPackage.RECONFIGURATION_PORT__CONTAINED_BEHAVIOR, null, msgs);
			msgs = basicSetContainedBehavior(newContainedBehavior, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReconfigurationPackage.RECONFIGURATION_PORT__CONTAINED_BEHAVIOR, newContainedBehavior, newContainedBehavior));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ReconfigurationPackage.RECONFIGURATION_PORT__CONTAINED_BEHAVIOR:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BehavioralElement.class) {
			switch (derivedFeatureID) {
				...
				case ReconfigurationPackage.RECONFIGURATION_PORT__CONTAINED_BEHAVIOR: return BehaviorPackage.BEHAVIORAL_ELEMENT__CONTAINED_BEHAVIOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BehavioralElement.class) {
			switch (baseFeatureID) {
				...
				case BehaviorPackage.BEHAVIORAL_ELEMENT__CONTAINED_BEHAVIOR: return ReconfigurationPackage.RECONFIGURATION_PORT__CONTAINED_BEHAVIOR;
				default: return -1;
			}
		}
		if (baseClass == DiscreteInteractionEndpoint.class) {
