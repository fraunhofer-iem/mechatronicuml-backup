...
public class SystemAdapterFactory extends AdapterFactoryImpl {
	...
	protected SystemSwitch<Adapter> modelSwitch =
		new SystemSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSystem(org.muml.uppaal.declarations.system.System object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.uppaal.declarations.system.TemplateDeclaration <em>Template Declaration</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.uppaal.declarations.system.System <em>System</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.uppaal.declarations.system.InstantiationList <em>Instantiation List</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.uppaal.declarations.system.ProgressMeasure <em>Progress Measure</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
