/**
 */
package org.muml.uppaal.visuals.util;
 ...
 * <!-- end-user-doc -->
 * @see org.muml.uppaal.visuals.VisualsPackage
 * @generated
 */
public class VisualsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VisualsPackage.COLORED_ELEMENT: {
				ColoredElement coloredElement = (ColoredElement)theEObject;
				T result = caseColoredElement(coloredElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VisualsPackage.PLANAR_ELEMENT: {
				PlanarElement planarElement = (PlanarElement)theEObject;
				T result = casePlanarElement(planarElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VisualsPackage.LINEAR_ELEMENT: {
