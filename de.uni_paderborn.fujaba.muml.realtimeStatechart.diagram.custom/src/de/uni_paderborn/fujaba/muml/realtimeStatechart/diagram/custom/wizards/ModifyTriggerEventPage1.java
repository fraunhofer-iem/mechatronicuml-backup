...
public class ModifyTriggerEventPage1 extends CommonModifyPage {
	...
	public void createControl(Composite parent) {
		...
		messageTypeLViewer.setInput(((ModifyTriggerEventWizard) getWizard())
		...
		existingTriggerEvent
				.setContentProvider(new TriggerEventContentProvider());
		existingTriggerEvent.setInput(((ModifyTriggerEventWizard) getWizard())
		...
		if (selection instanceof IStructuredSelection) {
			...
			for (Object obj : sel.toList()) {
				...
				if (obj != null) {
					...
					AsynchronousMessageEvent tmp = ((ModifyTriggerEventWizard) getWizard())
							.getSelectedTransition().getTriggerMessageEvent();
	...
	public Object[] getMessageTypes(Object object) {
		if (object instanceof FujabaRealtimeStatechart) {
			...
			FujabaRealtimeStatechart statechart = ((ModifyTriggerEventWizard) getWizard())
					.getRealtimeStatechart();
				...
				if (messageInterface != null) {
					...
					while (iter.hasNext()) {
						...
						if (toMyString(messageTypeTmp).equals(obj.toString())) {
							((ModifyTriggerEventWizard) getWizard())
