...
public class CustomFujabaRealtimeStatechartStatechartContentsCompartmentEditPart
		extends FujabaRealtimeStatechartStatechartContentsCompartmentEditPart {

	public CustomFujabaRealtimeStatechartStatechartContentsCompartmentEditPart(
			View view) {
		super(view);
	}
