...
//		return RealtimestatechartPackage.eINSTANCE.getRegion_EmbeddedStatechart();
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { RealtimeStatechart2EditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getRegionRegionContentsCompartment_7037SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return RealtimeStatechart2EditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
