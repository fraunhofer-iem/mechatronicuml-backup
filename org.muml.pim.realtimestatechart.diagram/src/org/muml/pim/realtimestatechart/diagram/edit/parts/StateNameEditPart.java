 ...
 * @generated
 */
public class StateNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MumlParserProvider.getParser(MumlElementTypes.State_3032, getParserElement(), MumlVisualIDRegistry
					.getType(org.muml.pim.realtimestatechart.diagram.edit.parts.StateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
