	...
	static {
		registerSnapBackPosition(
				MumlVisualIDRegistry
						.getType(org.muml.pim.realtimestatechart.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID),
				new Point(-10, 20));
	}
		...
		if (parser == null) {
			parser = MumlParserProvider.getParser(MumlElementTypes.Transition_4003, getParserElement(),
					MumlVisualIDRegistry.getType(
							org.muml.pim.realtimestatechart.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID));
		}
		return parser;
	}
