 ...
 * @generated
 */
public class EntryEventLabelExpressionLabelParser5050 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public EntryEventLabelExpressionLabelParser5050() {
	...
	protected String getExpressionBody() {
		return MumlOCLFactory.getExpression(0, RealtimestatechartPackage.eINSTANCE.getEntryEvent(), null).body();
	}
