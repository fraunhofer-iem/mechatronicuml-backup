 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.result.SRPParameters#getPreassigned <em>Preassigned</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.result.SRPParameters#getPreemptionLevel <em>Preemption Level</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.result.ResultPackage#getSRPParameters()
...
public interface SRPParameters extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.result.ResultPackage#getSRPParameters_Preassigned()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.result.SRPParameters#getPreassigned <em>Preassigned</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link es.unican.mast.xmlmast.result.SRPParameters#getPreassigned <em>Preassigned</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetPreassigned()
	 * @see #getPreassigned()
	...
	/**
	 * Returns whether the value of the '{@link es.unican.mast.xmlmast.result.SRPParameters#getPreassigned <em>Preassigned</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.result.ResultPackage#getSRPParameters_PreemptionLevel()
	 * @model dataType="es.unican.mast.xmlmast.result.PreemptionLevelType" required="true"
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.result.SRPParameters#getPreemptionLevel <em>Preemption Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
