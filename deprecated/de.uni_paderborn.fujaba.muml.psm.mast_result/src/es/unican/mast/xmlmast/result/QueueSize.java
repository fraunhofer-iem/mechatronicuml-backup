 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.result.QueueSize#getMaxNum <em>Max Num</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.result.ResultPackage#getQueueSize()
 * @model extendedMetaData="name='Queue_Size' kind='empty'"
 * @generated
 */
public interface QueueSize extends EObject {
	/**
	 ...
	 * @see es.unican.mast.xmlmast.result.ResultPackage#getQueueSize_MaxNum()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.result.QueueSize#getMaxNum <em>Max Num</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
