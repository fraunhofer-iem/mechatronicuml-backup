...
public class CommunicationLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final de.uni_paderborn.fujaba.muml.psm.deployment.Deployment container;
	...
	public boolean canExecute() {
		...
		View targetView = de.uni_paderborn.fujaba.muml.common.edit.policies.node.ConnectionConfigureHelperGraphicalNodeEditPolicy
				.getTargetView(getRequest());
		if (!de.uni_paderborn.fujaba.muml.deployment.diagram.edit.policies.AllocationBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateCommunicationLink_4003(
						getContainer(), getSource(), getTarget(), sourceView,
						targetView)) {
			String errorMessage = de.uni_paderborn.fujaba.muml.deployment.diagram.edit.policies.AllocationBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorCommunicationLink_4003(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.psm.deployment.CommunicationLink newElement = de.uni_paderborn.fujaba.muml.psm.deployment.DeploymentFactory.eINSTANCE
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.psm.deployment.CommunicationLink newElement,
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.psm.deployment.Deployment getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static de.uni_paderborn.fujaba.muml.psm.deployment.Deployment deduceContainer(
			EObject source, EObject target) {
		...
		for (EObject element = source; element != null; element = element
			...
			if (element instanceof de.uni_paderborn.fujaba.muml.psm.deployment.Deployment) {
				return (de.uni_paderborn.fujaba.muml.psm.deployment.Deployment) element;
			}
		}
		return null;
	}
	 ...
	 * @generated
	 */
	private static de.uni_paderborn.fujaba.muml.psm.deployment.Deployment deduceContainerUsingViews(
			View sourceView, View targetView) {
		for (View view = sourceView; view != null; view = (View) view
				.eContainer()) {
			if (view.getElement() instanceof de.uni_paderborn.fujaba.muml.psm.deployment.Deployment) {
				return (de.uni_paderborn.fujaba.muml.psm.deployment.Deployment) view
						.getElement();
			}
		}
		return null;
