 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.mumlcore.expressions.common.impl.UnaryExpressionImpl#getEnclosedExpression <em>Enclosed Expression</em>}</li>
 *   <li>{@link org.muml.mumlcore.expressions.common.impl.UnaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnaryExpressionImpl extends ExpressionImpl implements UnaryExpression {
	...
	public NotificationChain basicSetEnclosedExpression(Expression newEnclosedExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonExpressionsPackage.UNARY_EXPRESSION__ENCLOSED_EXPRESSION, oldEnclosedExpression, newEnclosedExpression);
	...
	public void setEnclosedExpression(Expression newEnclosedExpression) {
		if (newEnclosedExpression != enclosedExpression) {
			...
			if (enclosedExpression != null)
				msgs = ((InternalEObject)enclosedExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommonExpressionsPackage.UNARY_EXPRESSION__ENCLOSED_EXPRESSION, null, msgs);
			if (newEnclosedExpression != null)
				msgs = ((InternalEObject)newEnclosedExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonExpressionsPackage.UNARY_EXPRESSION__ENCLOSED_EXPRESSION, null, msgs);
			msgs = basicSetEnclosedExpression(newEnclosedExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonExpressionsPackage.UNARY_EXPRESSION__ENCLOSED_EXPRESSION, newEnclosedExpression, newEnclosedExpression));
	}
	...
	public void setOperator(UnaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonExpressionsPackage.UNARY_EXPRESSION__OPERATOR, oldOperator, operator));
	}
