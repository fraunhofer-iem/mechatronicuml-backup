...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>modelinstance</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelinstanceExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ModelinstancePackage.eNS_URI, 
			 ModelinstancePackage.eINSTANCE);
