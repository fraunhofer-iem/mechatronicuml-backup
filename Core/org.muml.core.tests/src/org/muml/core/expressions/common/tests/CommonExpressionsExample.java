 ...
 * @generated
 */
public class CommonExpressionsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(CommonExpressionsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.commonexpressions"));
				UnaryExpression root = CommonExpressionsFactory.eINSTANCE.createUnaryExpression();
