		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperationCallAccess().getGroup_1_3(), "rule__OperationCall__Group_1_3__0");
					put(grammarAccess.getOperationCallAccess().getGroup_1_3_1(), "rule__OperationCall__Group_1_3_1__0");
					...
					put(grammarAccess.getOperationCallAccess().getParameterBindingAssignment_1_3_0(), "rule__OperationCall__ParameterBindingAssignment_1_3_0");
					put(grammarAccess.getOperationCallAccess().getParameterBindingAssignment_1_3_1_1(), "rule__OperationCall__ParameterBindingAssignment_1_3_1_1");
