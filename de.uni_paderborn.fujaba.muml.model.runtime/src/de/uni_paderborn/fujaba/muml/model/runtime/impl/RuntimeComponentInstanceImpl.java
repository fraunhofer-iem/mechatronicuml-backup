 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.runtime.impl.RuntimeComponentInstanceImpl#getStatechartInstance <em>Statechart Instance</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.runtime.impl.RuntimeComponentInstanceImpl#getMessageQueue <em>Message Queue</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuntimeComponentInstanceImpl extends ComponentInstanceImpl implements RuntimeComponentInstance {
	...
	public NotificationChain basicSetMessageQueue(MessageQueue newMessageQueue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RuntimePackage.RUNTIME_COMPONENT_INSTANCE__MESSAGE_QUEUE, oldMessageQueue, newMessageQueue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMessageQueue(MessageQueue newMessageQueue) {
		if (newMessageQueue != messageQueue) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RuntimePackage.RUNTIME_COMPONENT_INSTANCE__MESSAGE_QUEUE, newMessageQueue, newMessageQueue));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RuntimePackage.RUNTIME_COMPONENT_INSTANCE__STATECHART_INSTANCE:
				if (statechartInstance != null)
					msgs = ((InternalEObject)statechartInstance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RuntimePackage.RUNTIME_COMPONENT_INSTANCE__STATECHART_INSTANCE, null, msgs);
				return basicSetStatechartInstance((RealtimeStatechartInstance)otherEnd, msgs);
			case RuntimePackage.RUNTIME_COMPONENT_INSTANCE__MESSAGE_QUEUE:
				if (messageQueue != null)
					msgs = ((InternalEObject)messageQueue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RuntimePackage.RUNTIME_COMPONENT_INSTANCE__MESSAGE_QUEUE, null, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RuntimeBehavioralElement.class) {
			switch (derivedFeatureID) {
				...
				case RuntimePackage.RUNTIME_COMPONENT_INSTANCE__MESSAGE_QUEUE: return RuntimePackage.RUNTIME_BEHAVIORAL_ELEMENT__MESSAGE_QUEUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == RuntimeBehavioralElement.class) {
			switch (baseFeatureID) {
				...
				case RuntimePackage.RUNTIME_BEHAVIORAL_ELEMENT__MESSAGE_QUEUE: return RuntimePackage.RUNTIME_COMPONENT_INSTANCE__MESSAGE_QUEUE;
				default: return -1;
			}
		}
