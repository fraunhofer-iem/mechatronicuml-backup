...
public class AtomicComponentNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.component.diagram.edit.parts.ModelElementCategoryEditPart.NodeLabelDragPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof de.uni_paderborn.fujaba.muml.component.diagram.edit.policies.MumlTextSelectionEditPolicy) {
			((de.uni_paderborn.fujaba.muml.component.diagram.edit.policies.MumlTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof de.uni_paderborn.fujaba.muml.component.diagram.edit.policies.MumlTextSelectionEditPolicy) {
			((de.uni_paderborn.fujaba.muml.component.diagram.edit.policies.MumlTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.component.diagram.providers.MumlParserProvider
					.getParser(
							de.uni_paderborn.fujaba.muml.component.diagram.providers.MumlElementTypes.AtomicComponent_2006,
							getParserElement(),
