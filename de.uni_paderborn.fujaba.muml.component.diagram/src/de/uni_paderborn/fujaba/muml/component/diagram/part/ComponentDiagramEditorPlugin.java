...
public class ComponentDiagramEditorPlugin extends AbstractUIPlugin {
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.muml.component.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	...
	public void setMumlOCLFactory(
			de.uni_paderborn.fujaba.muml.component.diagram.expressions.MumlOCLFactory f) {
		this.oclFactory = f;
	}
