 ...
 * @generated
 */
public class StaticAtomicComponentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StaticAtomicComponentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.component.diagram.providers.MumlParserProvider.getParser(
