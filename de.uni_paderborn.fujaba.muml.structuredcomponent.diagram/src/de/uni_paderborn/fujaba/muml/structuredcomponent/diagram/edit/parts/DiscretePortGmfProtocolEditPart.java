...
public class DiscretePortGmfProtocolEditPart extends ConnectionNodeEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.policies.DiscretePortGmfProtocolItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.parts.WrappingLabel3EditPart) {
			((de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.parts.WrappingLabel3EditPart) childEditPart)
