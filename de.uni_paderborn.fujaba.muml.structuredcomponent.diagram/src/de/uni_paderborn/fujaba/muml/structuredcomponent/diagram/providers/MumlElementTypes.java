...
public class MumlElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType ModelElementCategory_1000 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.ModelElementCategory_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType StaticStructuredComponent_2005 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.StaticStructuredComponent_2005"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType AtomicComponent_2006 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.AtomicComponent_2006"); //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final IElementType DiscretePort_3010 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.DiscretePort_3010"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ContinuousPort_3011 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.ContinuousPort_3011"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ComponentPart_3012 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.ComponentPart_3012"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType HybridPort_3013 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.HybridPort_3013"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType DiscretePort_3014 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.DiscretePort_3014"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ContinuousPort_3015 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.ContinuousPort_3015"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType CoordinationProtocol_3016 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.CoordinationProtocol_3016"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType HybridPort_3017 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.HybridPort_3017"); //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final IElementType AssemblyConnector_4001 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.AssemblyConnector_4001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType DelegationConnector_4002 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.DelegationConnector_4002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType DiscretePortGmfProtocol_4005 = getElementType("de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.DiscretePortGmfProtocol_4005"); //$NON-NLS-1$
	...
	private static ImageDescriptor getProvidedImageDescriptor(
		...
		if (element instanceof EClass) {
			...
			if (!eClass.isAbstract()) {
				return de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.StructuredcomponentDiagramEditorPlugin
