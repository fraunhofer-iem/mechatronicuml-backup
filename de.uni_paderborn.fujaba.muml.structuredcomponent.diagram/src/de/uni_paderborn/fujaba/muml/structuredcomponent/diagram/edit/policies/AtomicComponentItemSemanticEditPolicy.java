...
public class AtomicComponentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.DiscretePort_3010 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.commands.DiscretePortCreateCommand(
					req));
		}
		if (de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.ContinuousPort_3011 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.commands.ContinuousPortCreateCommand(
					req));
		}
		if (de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.HybridPort_3017 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.commands.HybridPort2CreateCommand(
					req));
		}
