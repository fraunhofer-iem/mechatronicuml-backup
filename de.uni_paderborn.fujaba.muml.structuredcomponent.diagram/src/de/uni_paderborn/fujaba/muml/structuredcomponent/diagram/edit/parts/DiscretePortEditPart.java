...
public class DiscretePortEditPart extends BorderedBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.policies.DiscretePortItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.parts.DiscretePortNameEditPart
				|| borderItemEditPart instanceof de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.parts.WrappingLabelEditPart) {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.DiscretePortGmfProtocol_4005);
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.AssemblyConnector_4001) {
