...
public class MumlPaletteFactory {
	...
	private PaletteContainer createPorts2Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.Ports2Group_title);
	...
	private PaletteContainer createConnectors3Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.Connectors3Group_title);
		paletteContainer.setId("createConnectors3Group"); //$NON-NLS-1$
		paletteContainer
				.setDescription(de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.Connectors3Group_desc);
	...
	private ToolEntry createDiscretePort1CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.DiscretePort1CreationTool_title,
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.DiscretePort1CreationTool_desc,
				types);
	...
	private ToolEntry createContinuousPort2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.ContinuousPort2CreationTool_title,
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.ContinuousPort2CreationTool_desc,
				types);
	...
	private ToolEntry createAssembly1CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.Assembly1CreationTool_title,
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.Assembly1CreationTool_desc,
				Collections
						.singletonList(de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.AssemblyConnector_4001));
	...
	private ToolEntry createDelegation2CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.Delegation2CreationTool_title,
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.Messages.Delegation2CreationTool_desc,
				Collections
						.singletonList(de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes.DelegationConnector_4002));
