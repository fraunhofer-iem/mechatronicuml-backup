...
public class ModelElementCategoryEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.policies.ModelElementCategoryItemSemanticEditPolicy());
		...
		installEditPolicy(
				"CustomCanonical",
				new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.policies.ModelElementCategoryCanonicalEditPolicy(
						false));
