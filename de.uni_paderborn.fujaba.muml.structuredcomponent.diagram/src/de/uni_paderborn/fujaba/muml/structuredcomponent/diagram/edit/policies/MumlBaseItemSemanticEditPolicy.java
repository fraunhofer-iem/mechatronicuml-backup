...
public class MumlBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(
					de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.helpers.MumlBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(
				de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.edit.helpers.MumlBaseEditHelper.CONTEXT_ELEMENT_TYPE,
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.providers.MumlElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.StructuredcomponentDiagramEditorPlugin
