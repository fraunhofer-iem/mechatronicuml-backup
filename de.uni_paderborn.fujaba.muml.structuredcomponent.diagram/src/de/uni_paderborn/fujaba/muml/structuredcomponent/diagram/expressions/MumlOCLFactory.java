package de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions;
...
public class MumlOCLFactory {
	 ...
	 * @generated
	 */
	private final de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions.MumlAbstractExpression[] expressions;

	/**
	 * @generated
	 */
	protected MumlOCLFactory() {
		this.expressions = new de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions.MumlAbstractExpression[16];
	}

	/**
	 * @generated
	 */
	public static de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions.MumlAbstractExpression getExpression(
			int index, EClassifier context, Map<String, EClassifier> environment) {
		MumlOCLFactory cached = de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.part.StructuredcomponentDiagramEditorPlugin
	...
	private static class Expression
			extends
			de.uni_paderborn.fujaba.muml.structuredcomponent.diagram.expressions.MumlAbstractExpression {
