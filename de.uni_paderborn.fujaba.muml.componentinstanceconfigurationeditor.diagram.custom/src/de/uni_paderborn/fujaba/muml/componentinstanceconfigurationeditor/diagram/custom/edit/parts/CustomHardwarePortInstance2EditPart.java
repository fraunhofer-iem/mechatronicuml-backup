...
import de.uni_paderborn.fujaba.muml.common.edit.parts.HardwarePortInstanceBehavior;
 ...
 * 
 */
public class CustomHardwarePortInstance2EditPart extends HardwarePortInstance2EditPart {

	/**
	 * All behavior is delegated, to reduce duplicate code.
	 */
	private HardwarePortInstanceBehavior delegation;
	 ...
	 *            The graphical model.
	 */
	public CustomHardwarePortInstance2EditPart(View view) {
		super(view);
	 ...
	 */
	private HardwarePortInstanceBehavior getDelegation() {
		if (delegation == null) {
			delegation = new HardwarePortInstanceBehavior(this);
		}
		return delegation;
	}
