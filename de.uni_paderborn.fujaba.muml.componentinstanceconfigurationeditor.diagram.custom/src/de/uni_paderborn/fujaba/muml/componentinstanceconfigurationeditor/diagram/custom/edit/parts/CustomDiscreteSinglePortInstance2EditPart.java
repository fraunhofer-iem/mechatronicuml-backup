 ...
 * 
 */
public class CustomDiscreteSinglePortInstance2EditPart extends DiscreteSinglePortInstance2EditPart {

	/**
	 * All behavior is delegated, to reduce duplicate code.
	 */
	private DiscretePortInstanceBehavior delegation;
	 ...
	 *            The graphical model.
	 */
	public CustomDiscreteSinglePortInstance2EditPart(View view) {
		super(view);
