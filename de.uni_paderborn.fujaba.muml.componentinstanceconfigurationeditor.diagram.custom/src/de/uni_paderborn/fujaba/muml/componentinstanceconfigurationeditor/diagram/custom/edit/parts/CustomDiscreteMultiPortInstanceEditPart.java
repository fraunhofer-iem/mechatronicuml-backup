 ...
 * 
 */
public class CustomDiscreteMultiPortInstanceEditPart extends DiscreteMultiPortInstanceEditPart {
	 ...
	 *            The graphical model.
	 */
	public CustomDiscreteMultiPortInstanceEditPart(View view) {
		super(view);
