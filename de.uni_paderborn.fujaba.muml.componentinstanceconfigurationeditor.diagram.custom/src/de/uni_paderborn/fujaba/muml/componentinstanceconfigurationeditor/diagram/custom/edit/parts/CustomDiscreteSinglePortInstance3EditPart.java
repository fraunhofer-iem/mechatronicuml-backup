 ...
 * 
 */
public class CustomDiscreteSinglePortInstance3EditPart extends DiscreteSinglePortInstance3EditPart {
	 ...
	 *            The graphical model.
	 */
	public CustomDiscreteSinglePortInstance3EditPart(View view) {
		super(view);
