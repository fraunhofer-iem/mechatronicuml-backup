...
public class EDataTypePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (eDataType.getName() != null && isAccessible(EcoreViewsRepository.EDataType.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eDataType.getName()));
			
			if (eDataType.getInstanceClassName() != null && isAccessible(EcoreViewsRepository.EDataType.Properties.instanceClassName))
				basePart.setInstanceClassName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eDataType.getInstanceClassName()));
			
			if (eDataType.getInstanceTypeName() != null && isAccessible(EcoreViewsRepository.EDataType.Properties.instanceTypeName))
				basePart.setInstanceTypeName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eDataType.getInstanceTypeName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EDataType.Properties.name == event.getAffectedEditor()) {
			eDataType.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EDataType.Properties.instanceClassName == event.getAffectedEditor()) {
			eDataType.setInstanceClassName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EDataType.Properties.instanceTypeName == event.getAffectedEditor()) {
			eDataType.setInstanceTypeName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EcoreViewsRepository.EDataType.Properties.serializable == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEDataType_Serializable().getEAttributeType(), (String)newValue);
					}
