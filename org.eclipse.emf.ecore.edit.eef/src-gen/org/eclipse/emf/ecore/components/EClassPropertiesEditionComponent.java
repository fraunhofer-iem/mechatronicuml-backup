...
public class EClassPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (eClass.getName() != null && isAccessible(EcoreViewsRepository.EClass.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eClass.getName()));
			
			if (eClass.getInstanceClassName() != null && isAccessible(EcoreViewsRepository.EClass.Properties.instanceClassName))
				basePart.setInstanceClassName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eClass.getInstanceClassName()));
			
			if (eClass.getInstanceTypeName() != null && isAccessible(EcoreViewsRepository.EClass.Properties.instanceTypeName))
				basePart.setInstanceTypeName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eClass.getInstanceTypeName()));
			...
			basePart.addFilterToESuperTypes(new EObjectFilter(EcorePackage.eINSTANCE.getEClass()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EClass.Properties.name == event.getAffectedEditor()) {
			eClass.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EClass.Properties.instanceClassName == event.getAffectedEditor()) {
			eClass.setInstanceClassName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EClass.Properties.instanceTypeName == event.getAffectedEditor()) {
			eClass.setInstanceTypeName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (EcorePackage.eINSTANCE.getEClassifier_InstanceClassName().equals(msg.getFeature()) && basePart != null && isAccessible(EcoreViewsRepository.EClass.Properties.instanceClassName)) {
				if (msg.getNewValue() != null) {
					basePart.setInstanceClassName(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
			...
			if (EcorePackage.eINSTANCE.getEClassifier_InstanceTypeName().equals(msg.getFeature()) && basePart != null && isAccessible(EcoreViewsRepository.EClass.Properties.instanceTypeName)) {
				if (msg.getNewValue() != null) {
					basePart.setInstanceTypeName(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EcoreViewsRepository.EClass.Properties.instanceClassName == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEClassifier_InstanceClassName().getEAttributeType(), (String)newValue);
					}
				...
				if (EcoreViewsRepository.EClass.Properties.instanceTypeName == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEClassifier_InstanceTypeName().getEAttributeType(), (String)newValue);
					}
				...
				if (EcoreViewsRepository.EClass.Properties.abstract_ == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEClass_Abstract().getEAttributeType(), (String)newValue);
					}
				...
				if (EcoreViewsRepository.EClass.Properties.interface_ == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEClass_Interface().getEAttributeType(), (String)newValue);
					}
