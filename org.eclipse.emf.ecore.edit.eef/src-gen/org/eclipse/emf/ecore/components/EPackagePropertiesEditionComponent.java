...
public class EPackagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (ePackage.getName() != null && isAccessible(EcoreViewsRepository.EPackage.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), ePackage.getName()));
			
			if (ePackage.getNsURI() != null && isAccessible(EcoreViewsRepository.EPackage.Properties.nsURI))
				basePart.setNsURI(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), ePackage.getNsURI()));
			
			if (ePackage.getNsPrefix() != null && isAccessible(EcoreViewsRepository.EPackage.Properties.nsPrefix))
				basePart.setNsPrefix(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), ePackage.getNsPrefix()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EPackage.Properties.name == event.getAffectedEditor()) {
			ePackage.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EPackage.Properties.nsURI == event.getAffectedEditor()) {
			ePackage.setNsURI((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EPackage.Properties.nsPrefix == event.getAffectedEditor()) {
			ePackage.setNsPrefix((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (EcorePackage.eINSTANCE.getEPackage_NsURI().equals(msg.getFeature()) && basePart != null && isAccessible(EcoreViewsRepository.EPackage.Properties.nsURI)) {
				if (msg.getNewValue() != null) {
					basePart.setNsURI(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
					basePart.setNsURI("");
				}
			}
			if (EcorePackage.eINSTANCE.getEPackage_NsPrefix().equals(msg.getFeature()) && basePart != null && isAccessible(EcoreViewsRepository.EPackage.Properties.nsPrefix)) {
				if (msg.getNewValue() != null) {
					basePart.setNsPrefix(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EcoreViewsRepository.EPackage.Properties.nsURI == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEPackage_NsURI().getEAttributeType(), (String)newValue);
					}
				...
				if (EcoreViewsRepository.EPackage.Properties.nsPrefix == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEPackage_NsPrefix().getEAttributeType(), (String)newValue);
					}
