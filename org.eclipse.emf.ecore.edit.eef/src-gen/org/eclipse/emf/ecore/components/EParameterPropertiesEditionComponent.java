...
public class EParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (eParameter.getName() != null && isAccessible(EcoreViewsRepository.EParameter.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eParameter.getName()));
			...
			if (isAccessible(EcoreViewsRepository.EParameter.Properties.lowerBound)) {
				basePart.setLowerBound(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEInt(), eParameter.getLowerBound()));
			}
			
			if (isAccessible(EcoreViewsRepository.EParameter.Properties.upperBound)) {
				basePart.setUpperBound(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEInt(), eParameter.getUpperBound()));
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EParameter.Properties.name == event.getAffectedEditor()) {
			eParameter.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (EcoreViewsRepository.EParameter.Properties.lowerBound == event.getAffectedEditor()) {
			eParameter.setLowerBound((EEFConverterUtil.createIntFromString(EcorePackage.eINSTANCE.getEInt(), (String)event.getNewValue())));
		}
		if (EcoreViewsRepository.EParameter.Properties.upperBound == event.getAffectedEditor()) {
			eParameter.setUpperBound((EEFConverterUtil.createIntFromString(EcorePackage.eINSTANCE.getEInt(), (String)event.getNewValue())));
		}
