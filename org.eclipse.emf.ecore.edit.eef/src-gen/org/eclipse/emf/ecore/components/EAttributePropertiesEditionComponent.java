...
public class EAttributePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (eAttribute.getName() != null && isAccessible(EcoreViewsRepository.EAttribute.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eAttribute.getName()));
			...
			if (isAccessible(EcoreViewsRepository.EAttribute.Properties.lowerBound)) {
				basePart.setLowerBound(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEInt(), eAttribute.getLowerBound()));
			}
			
			if (isAccessible(EcoreViewsRepository.EAttribute.Properties.upperBound)) {
				basePart.setUpperBound(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEInt(), eAttribute.getUpperBound()));
			}
			...
			if (eAttribute.getDefaultValueLiteral() != null && isAccessible(EcoreViewsRepository.EAttribute.Properties.defaultValueLiteral))
				basePart.setDefaultValueLiteral(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eAttribute.getDefaultValueLiteral()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EAttribute.Properties.name == event.getAffectedEditor()) {
			eAttribute.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (EcoreViewsRepository.EAttribute.Properties.lowerBound == event.getAffectedEditor()) {
			eAttribute.setLowerBound((EEFConverterUtil.createIntFromString(EcorePackage.eINSTANCE.getEInt(), (String)event.getNewValue())));
		}
		if (EcoreViewsRepository.EAttribute.Properties.upperBound == event.getAffectedEditor()) {
			eAttribute.setUpperBound((EEFConverterUtil.createIntFromString(EcorePackage.eINSTANCE.getEInt(), (String)event.getNewValue())));
		}
		...
		if (EcoreViewsRepository.EAttribute.Properties.defaultValueLiteral == event.getAffectedEditor()) {
			eAttribute.setDefaultValueLiteral((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EcoreViewsRepository.EAttribute.Properties.iD == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEAttribute_ID().getEAttributeType(), (String)newValue);
					}
