...
public class EEnumPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (eEnum.getName() != null && isAccessible(EcoreViewsRepository.EEnum.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eEnum.getName()));
			
			if (eEnum.getInstanceClassName() != null && isAccessible(EcoreViewsRepository.EEnum.Properties.instanceClassName))
				basePart.setInstanceClassName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eEnum.getInstanceClassName()));
			
			if (eEnum.getInstanceTypeName() != null && isAccessible(EcoreViewsRepository.EEnum.Properties.instanceTypeName))
				basePart.setInstanceTypeName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eEnum.getInstanceTypeName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EEnum.Properties.name == event.getAffectedEditor()) {
			eEnum.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EEnum.Properties.instanceClassName == event.getAffectedEditor()) {
			eEnum.setInstanceClassName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EEnum.Properties.instanceTypeName == event.getAffectedEditor()) {
			eEnum.setInstanceTypeName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
