...
public class EEnumLiteralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (eEnumLiteral.getName() != null && isAccessible(EcoreViewsRepository.EEnumLiteral.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eEnumLiteral.getName()));
			
			if (isAccessible(EcoreViewsRepository.EEnumLiteral.Properties.value)) {
				basePart.setValue(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEInt(), eEnumLiteral.getValue()));
			}
			
			if (eEnumLiteral.getInstance() != null && isAccessible(EcoreViewsRepository.EEnumLiteral.Properties.instance))
				basePart.setInstance(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEEnumerator(), eEnumLiteral.getInstance()));
			
			if (eEnumLiteral.getLiteral() != null && isAccessible(EcoreViewsRepository.EEnumLiteral.Properties.literal))
				basePart.setLiteral(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eEnumLiteral.getLiteral()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EEnumLiteral.Properties.name == event.getAffectedEditor()) {
			eEnumLiteral.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EEnumLiteral.Properties.value == event.getAffectedEditor()) {
			eEnumLiteral.setValue((EEFConverterUtil.createIntFromString(EcorePackage.eINSTANCE.getEInt(), (String)event.getNewValue())));
		}
		if (EcoreViewsRepository.EEnumLiteral.Properties.instance == event.getAffectedEditor()) {
			eEnumLiteral.setInstance((org.eclipse.emf.common.util.Enumerator)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEEnumerator(), (String)event.getNewValue()));
		}
		if (EcoreViewsRepository.EEnumLiteral.Properties.literal == event.getAffectedEditor()) {
			eEnumLiteral.setLiteral((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (EcorePackage.eINSTANCE.getEEnumLiteral_Instance().equals(msg.getFeature()) && basePart != null && isAccessible(EcoreViewsRepository.EEnumLiteral.Properties.instance)) {
				if (msg.getNewValue() != null) {
					basePart.setInstance(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEEnumerator(), msg.getNewValue()));
				} else {
			...
			if (EcorePackage.eINSTANCE.getEEnumLiteral_Literal().equals(msg.getFeature()) && basePart != null && isAccessible(EcoreViewsRepository.EEnumLiteral.Properties.literal)) {
				if (msg.getNewValue() != null) {
					basePart.setLiteral(EcoreUtil.convertToString(EcorePackage.eINSTANCE.getEString(), msg.getNewValue()));
				} else {
					basePart.setLiteral("");
				}
			}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EcoreViewsRepository.EEnumLiteral.Properties.value == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEEnumLiteral_Value().getEAttributeType(), (String)newValue);
					}
				...
				if (EcoreViewsRepository.EEnumLiteral.Properties.instance == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEEnumLiteral_Instance().getEAttributeType(), (String)newValue);
					}
				...
				if (EcoreViewsRepository.EEnumLiteral.Properties.literal == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EcoreUtil.createFromString(EcorePackage.eINSTANCE.getEEnumLiteral_Literal().getEAttributeType(), (String)newValue);
					}
