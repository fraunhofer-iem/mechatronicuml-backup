...
public class EOperationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (eOperation.getName() != null && isAccessible(EcoreViewsRepository.EOperation.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), eOperation.getName()));
			...
			if (isAccessible(EcoreViewsRepository.EOperation.Properties.lowerBound)) {
				basePart.setLowerBound(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEInt(), eOperation.getLowerBound()));
			}
			
			if (isAccessible(EcoreViewsRepository.EOperation.Properties.upperBound)) {
				basePart.setUpperBound(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEInt(), eOperation.getUpperBound()));
			}
			...
			basePart.addFilterToEExceptions(new EObjectFilter(EcorePackage.eINSTANCE.getEClassifier()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EcoreViewsRepository.EOperation.Properties.name == event.getAffectedEditor()) {
			eOperation.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		...
		if (EcoreViewsRepository.EOperation.Properties.lowerBound == event.getAffectedEditor()) {
			eOperation.setLowerBound((EEFConverterUtil.createIntFromString(EcorePackage.eINSTANCE.getEInt(), (String)event.getNewValue())));
		}
		if (EcoreViewsRepository.EOperation.Properties.upperBound == event.getAffectedEditor()) {
			eOperation.setUpperBound((EEFConverterUtil.createIntFromString(EcorePackage.eINSTANCE.getEInt(), (String)event.getNewValue())));
		}
