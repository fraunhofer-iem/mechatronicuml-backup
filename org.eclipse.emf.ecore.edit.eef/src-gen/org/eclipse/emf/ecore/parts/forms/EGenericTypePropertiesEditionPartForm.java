 ...
 * 
 */
public class EGenericTypePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EGenericTypePropertiesEditionPart {
	...
	protected Composite createETypeArgumentsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.eTypeArguments = new ReferencesTable(EcoreMessages.EGenericTypePropertiesEditionPart_ETypeArgumentsLabel, new ReferencesTableListener() {
	...
	protected Composite createETypeParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EGenericTypePropertiesEditionPart_ETypeParameterLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EGenericType.Properties.eTypeParameter, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEClassifierFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EGenericTypePropertiesEditionPart_EClassifierLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EGenericType.Properties.eClassifier, EcoreViewsRepository.FORM_KIND));
