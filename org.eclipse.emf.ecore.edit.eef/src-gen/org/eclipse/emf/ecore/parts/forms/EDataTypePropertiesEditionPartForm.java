 ...
 * 
 */
public class EDataTypePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EDataTypePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EDataTypePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createInstanceClassNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EDataTypePropertiesEditionPart_InstanceClassNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.instanceClassName, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createInstanceTypeNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EDataTypePropertiesEditionPart_InstanceTypeNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.instanceTypeName, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEPackageFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EDataTypePropertiesEditionPart_EPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.ePackage, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createSerializableCheckbox(FormToolkit widgetFactory, Composite parent) {
		serializable = widgetFactory.createButton(parent, EcoreMessages.EDataTypePropertiesEditionPart_SerializableLabel, SWT.CHECK);
