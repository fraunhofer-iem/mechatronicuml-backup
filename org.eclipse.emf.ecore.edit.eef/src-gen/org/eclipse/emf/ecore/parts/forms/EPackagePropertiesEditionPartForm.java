 ...
 * 
 */
public class EPackagePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EPackagePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EPackagePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createNsURIText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EPackagePropertiesEditionPart_NsURILabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.nsURI, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createNsPrefixText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EPackagePropertiesEditionPart_NsPrefixLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.nsPrefix, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEFactoryInstanceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EPackagePropertiesEditionPart_EFactoryInstanceLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.eFactoryInstance, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createESuperPackageFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EPackagePropertiesEditionPart_ESuperPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.eSuperPackage, EcoreViewsRepository.FORM_KIND));
