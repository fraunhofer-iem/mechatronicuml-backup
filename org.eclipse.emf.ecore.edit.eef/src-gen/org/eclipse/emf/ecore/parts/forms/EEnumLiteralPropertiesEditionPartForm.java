 ...
 * 
 */
public class EEnumLiteralPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EEnumLiteralPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_ValueLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.value, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createInstanceText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_InstanceLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.instance, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createLiteralText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_LiteralLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.literal, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEEnumFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_EEnumLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.eEnum, EcoreViewsRepository.FORM_KIND));
