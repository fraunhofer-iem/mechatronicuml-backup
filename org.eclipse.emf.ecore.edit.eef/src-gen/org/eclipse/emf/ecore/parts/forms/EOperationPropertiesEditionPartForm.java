 ...
 * 
 */
public class EOperationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EOperationPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EOperationPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createOrderedCheckbox(FormToolkit widgetFactory, Composite parent) {
		ordered = widgetFactory.createButton(parent, EcoreMessages.EOperationPropertiesEditionPart_OrderedLabel, SWT.CHECK);
	...
	protected Composite createUniqueCheckbox(FormToolkit widgetFactory, Composite parent) {
		unique = widgetFactory.createButton(parent, EcoreMessages.EOperationPropertiesEditionPart_UniqueLabel, SWT.CHECK);
	...
	protected Composite createLowerBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EOperationPropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.lowerBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createUpperBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EOperationPropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.upperBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createETypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EOperationPropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.eType, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEContainingClassFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EOperationPropertiesEditionPart_EContainingClassLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.eContainingClass, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEExceptionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.eExceptions = new ReferencesTable(EcoreMessages.EOperationPropertiesEditionPart_EExceptionsLabel, new ReferencesTableListener	() {
	...
	protected Composite createEGenericExceptionsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.eGenericExceptions = new ReferencesTable(EcoreMessages.EOperationPropertiesEditionPart_EGenericExceptionsLabel, new ReferencesTableListener() {
