 ...
 * 
 */
public class EAttributePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EAttributePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EAttributePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createOrderedCheckbox(FormToolkit widgetFactory, Composite parent) {
		ordered = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_OrderedLabel, SWT.CHECK);
	...
	protected Composite createUniqueCheckbox(FormToolkit widgetFactory, Composite parent) {
		unique = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_UniqueLabel, SWT.CHECK);
	...
	protected Composite createLowerBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EAttributePropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.lowerBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createUpperBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EAttributePropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.upperBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createETypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EAttributePropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.eType, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createChangeableCheckbox(FormToolkit widgetFactory, Composite parent) {
		changeable = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_ChangeableLabel, SWT.CHECK);
	...
	protected Composite createVolatile_Checkbox(FormToolkit widgetFactory, Composite parent) {
		volatile_ = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_Volatile_Label, SWT.CHECK);
	...
	protected Composite createTransient_Checkbox(FormToolkit widgetFactory, Composite parent) {
		transient_ = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_Transient_Label, SWT.CHECK);
	...
	protected Composite createDefaultValueLiteralText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EAttributePropertiesEditionPart_DefaultValueLiteralLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.defaultValueLiteral, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createUnsettableCheckbox(FormToolkit widgetFactory, Composite parent) {
		unsettable = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_UnsettableLabel, SWT.CHECK);
	...
	protected Composite createDerivedCheckbox(FormToolkit widgetFactory, Composite parent) {
		derived = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_DerivedLabel, SWT.CHECK);
	...
	protected Composite createEContainingClassFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EAttributePropertiesEditionPart_EContainingClassLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.eContainingClass, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createIDCheckbox(FormToolkit widgetFactory, Composite parent) {
		iD = widgetFactory.createButton(parent, EcoreMessages.EAttributePropertiesEditionPart_IDLabel, SWT.CHECK);
