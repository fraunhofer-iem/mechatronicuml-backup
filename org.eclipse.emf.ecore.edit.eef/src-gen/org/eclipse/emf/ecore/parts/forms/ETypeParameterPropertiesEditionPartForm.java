 ...
 * 
 */
public class ETypeParameterPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ETypeParameterPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.ETypeParameterPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.ETypeParameter.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEBoundsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.eBounds = new ReferencesTable(EcoreMessages.ETypeParameterPropertiesEditionPart_EBoundsLabel, new ReferencesTableListener() {
