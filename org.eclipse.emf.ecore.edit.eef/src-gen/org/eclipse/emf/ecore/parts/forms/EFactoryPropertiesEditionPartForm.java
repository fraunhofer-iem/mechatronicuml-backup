 ...
 * 
 */
public class EFactoryPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EFactoryPropertiesEditionPart {
	...
	protected Composite createEPackageFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EFactoryPropertiesEditionPart_EPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EFactory.Properties.ePackage, EcoreViewsRepository.FORM_KIND));
