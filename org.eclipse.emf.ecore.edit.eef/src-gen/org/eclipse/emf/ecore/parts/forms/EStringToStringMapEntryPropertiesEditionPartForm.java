 ...
 * 
 */
public class EStringToStringMapEntryPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EStringToStringMapEntryPropertiesEditionPart {
	...
	protected Composite createKeyText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EStringToStringMapEntryPropertiesEditionPart_KeyLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EStringToStringMapEntry.Properties.key, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EStringToStringMapEntryPropertiesEditionPart_ValueLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EStringToStringMapEntry.Properties.value, EcoreViewsRepository.FORM_KIND));
