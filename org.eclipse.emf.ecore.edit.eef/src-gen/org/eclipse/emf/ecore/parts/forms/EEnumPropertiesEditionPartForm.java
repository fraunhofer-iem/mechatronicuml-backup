 ...
 * 
 */
public class EEnumPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EEnumPropertiesEditionPart {
	 ...
	 * 
	 */
	public EEnumPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EcoreMessages.EEnumPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.name, EcoreViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EEnumPropertiesEditionPartForm.this, EcoreViewsRepository.EEnum.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EEnum.Properties.name, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createInstanceClassNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumPropertiesEditionPart_InstanceClassNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.instanceClassName, EcoreViewsRepository.FORM_KIND));
		...
		instanceClassName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EEnumPropertiesEditionPartForm.this, EcoreViewsRepository.EEnum.Properties.instanceClassName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, instanceClassName.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EEnum.Properties.instanceClassName, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createInstanceTypeNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumPropertiesEditionPart_InstanceTypeNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.instanceTypeName, EcoreViewsRepository.FORM_KIND));
		...
		instanceTypeName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EEnumPropertiesEditionPartForm.this, EcoreViewsRepository.EEnum.Properties.instanceTypeName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, instanceTypeName.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EEnum.Properties.instanceTypeName, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createEPackageFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EEnumPropertiesEditionPart_EPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.ePackage, EcoreViewsRepository.FORM_KIND));
		ePackage = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.ePackage, EcoreViewsRepository.FORM_KIND));
		...
		ePackage.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EEnumPropertiesEditionPartForm.this, EcoreViewsRepository.EEnum.Properties.ePackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getEPackage()));
			}

		});
		ePackage.setID(EcoreViewsRepository.EEnum.Properties.ePackage);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EEnum.Properties.ePackage, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSerializableCheckbox(FormToolkit widgetFactory, Composite parent) {
		serializable = widgetFactory.createButton(parent, EcoreMessages.EEnumPropertiesEditionPart_SerializableLabel, SWT.CHECK);
		serializable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EEnumPropertiesEditionPartForm.this, EcoreViewsRepository.EEnum.Properties.serializable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(serializable.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EEnum.Properties.serializable, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
