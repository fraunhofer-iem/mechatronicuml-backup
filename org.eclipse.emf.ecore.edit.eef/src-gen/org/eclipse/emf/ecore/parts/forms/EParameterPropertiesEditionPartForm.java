 ...
 * 
 */
public class EParameterPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EParameterPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EParameterPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createOrderedCheckbox(FormToolkit widgetFactory, Composite parent) {
		ordered = widgetFactory.createButton(parent, EcoreMessages.EParameterPropertiesEditionPart_OrderedLabel, SWT.CHECK);
	...
	protected Composite createUniqueCheckbox(FormToolkit widgetFactory, Composite parent) {
		unique = widgetFactory.createButton(parent, EcoreMessages.EParameterPropertiesEditionPart_UniqueLabel, SWT.CHECK);
	...
	protected Composite createLowerBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EParameterPropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.lowerBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createUpperBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EParameterPropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.upperBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createETypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EParameterPropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.eType, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEOperationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EParameterPropertiesEditionPart_EOperationLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.eOperation, EcoreViewsRepository.FORM_KIND));
