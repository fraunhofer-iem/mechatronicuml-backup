 ...
 * 
 */
public class EReferencePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, EReferencePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EReferencePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.name, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createOrderedCheckbox(FormToolkit widgetFactory, Composite parent) {
		ordered = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_OrderedLabel, SWT.CHECK);
	...
	protected Composite createUniqueCheckbox(FormToolkit widgetFactory, Composite parent) {
		unique = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_UniqueLabel, SWT.CHECK);
	...
	protected Composite createLowerBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EReferencePropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.lowerBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createUpperBoundText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EReferencePropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.upperBound, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createETypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EReferencePropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.eType, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createChangeableCheckbox(FormToolkit widgetFactory, Composite parent) {
		changeable = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_ChangeableLabel, SWT.CHECK);
	...
	protected Composite createVolatile_Checkbox(FormToolkit widgetFactory, Composite parent) {
		volatile_ = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_Volatile_Label, SWT.CHECK);
	...
	protected Composite createTransient_Checkbox(FormToolkit widgetFactory, Composite parent) {
		transient_ = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_Transient_Label, SWT.CHECK);
	...
	protected Composite createDefaultValueLiteralText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EReferencePropertiesEditionPart_DefaultValueLiteralLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.defaultValueLiteral, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createUnsettableCheckbox(FormToolkit widgetFactory, Composite parent) {
		unsettable = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_UnsettableLabel, SWT.CHECK);
	...
	protected Composite createDerivedCheckbox(FormToolkit widgetFactory, Composite parent) {
		derived = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_DerivedLabel, SWT.CHECK);
	...
	protected Composite createEContainingClassFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EReferencePropertiesEditionPart_EContainingClassLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.eContainingClass, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createContainmentCheckbox(FormToolkit widgetFactory, Composite parent) {
		containment = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_ContainmentLabel, SWT.CHECK);
	...
	protected Composite createResolveProxiesCheckbox(FormToolkit widgetFactory, Composite parent) {
		resolveProxies = widgetFactory.createButton(parent, EcoreMessages.EReferencePropertiesEditionPart_ResolveProxiesLabel, SWT.CHECK);
	...
	protected Composite createEOppositeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, EcoreMessages.EReferencePropertiesEditionPart_EOppositeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.eOpposite, EcoreViewsRepository.FORM_KIND));
	...
	protected Composite createEKeysReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.eKeys = new ReferencesTable(EcoreMessages.EReferencePropertiesEditionPart_EKeysLabel, new ReferencesTableListener	() {
