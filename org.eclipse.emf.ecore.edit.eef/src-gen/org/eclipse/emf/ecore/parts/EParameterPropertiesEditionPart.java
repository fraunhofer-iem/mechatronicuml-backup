 ...
 * 
 */
public interface EParameterPropertiesEditionPart {
	...
	/**
	 * Defines a new eOperation
	 * @param newValue the new eOperation to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the eOperation edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
