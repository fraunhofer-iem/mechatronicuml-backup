...
protected List<ViewerFilter> eBoundsFilters = new ArrayList<ViewerFilter>();
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.ETypeParameterPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.ETypeParameter.Properties.name, EcoreViewsRepository.SWT_KIND));
