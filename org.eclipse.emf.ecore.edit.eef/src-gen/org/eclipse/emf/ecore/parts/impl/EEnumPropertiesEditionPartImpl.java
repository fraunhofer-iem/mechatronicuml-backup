...
public class EEnumPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EEnumPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createInstanceClassNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumPropertiesEditionPart_InstanceClassNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.instanceClassName, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createInstanceTypeNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumPropertiesEditionPart_InstanceTypeNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.instanceTypeName, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createEPackageFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumPropertiesEditionPart_EPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnum.Properties.ePackage, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createSerializableCheckbox(Composite parent) {
		...
		serializable.setText(EcoreMessages.EEnumPropertiesEditionPart_SerializableLabel);
