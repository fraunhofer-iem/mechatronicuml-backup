...
public class EReferencePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EReferencePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EReferencePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createOrderedCheckbox(Composite parent) {
		...
		ordered.setText(EcoreMessages.EReferencePropertiesEditionPart_OrderedLabel);
	...
	protected Composite createUniqueCheckbox(Composite parent) {
		...
		unique.setText(EcoreMessages.EReferencePropertiesEditionPart_UniqueLabel);
	...
	protected Composite createLowerBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EReferencePropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.lowerBound, EcoreViewsRepository.SWT_KIND));
		lowerBound = new Text(parent, SWT.BORDER);
	...
	protected Composite createUpperBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EReferencePropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.upperBound, EcoreViewsRepository.SWT_KIND));
		upperBound = new Text(parent, SWT.BORDER);
	...
	protected Composite createETypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EReferencePropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.eType, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createChangeableCheckbox(Composite parent) {
		...
		changeable.setText(EcoreMessages.EReferencePropertiesEditionPart_ChangeableLabel);
	...
	protected Composite createVolatile_Checkbox(Composite parent) {
		...
		volatile_.setText(EcoreMessages.EReferencePropertiesEditionPart_Volatile_Label);
	...
	protected Composite createTransient_Checkbox(Composite parent) {
		...
		transient_.setText(EcoreMessages.EReferencePropertiesEditionPart_Transient_Label);
	...
	protected Composite createDefaultValueLiteralText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EReferencePropertiesEditionPart_DefaultValueLiteralLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.defaultValueLiteral, EcoreViewsRepository.SWT_KIND));
		defaultValueLiteral = new Text(parent, SWT.BORDER);
	...
	protected Composite createUnsettableCheckbox(Composite parent) {
		...
		unsettable.setText(EcoreMessages.EReferencePropertiesEditionPart_UnsettableLabel);
	...
	protected Composite createDerivedCheckbox(Composite parent) {
		...
		derived.setText(EcoreMessages.EReferencePropertiesEditionPart_DerivedLabel);
	...
	protected Composite createEContainingClassFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EReferencePropertiesEditionPart_EContainingClassLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.eContainingClass, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createContainmentCheckbox(Composite parent) {
		...
		containment.setText(EcoreMessages.EReferencePropertiesEditionPart_ContainmentLabel);
	...
	protected Composite createResolveProxiesCheckbox(Composite parent) {
		...
		resolveProxies.setText(EcoreMessages.EReferencePropertiesEditionPart_ResolveProxiesLabel);
	...
	protected Composite createEOppositeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EReferencePropertiesEditionPart_EOppositeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EReference.Properties.eOpposite, EcoreViewsRepository.SWT_KIND));
