...
protected List<ViewerFilter> contentsFilters = new ArrayList<ViewerFilter>();
	...
	protected Composite createSourceText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAnnotationPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAnnotation.Properties.source, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createEModelElementFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAnnotationPropertiesEditionPart_EModelElementLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAnnotation.Properties.eModelElement, EcoreViewsRepository.SWT_KIND));
