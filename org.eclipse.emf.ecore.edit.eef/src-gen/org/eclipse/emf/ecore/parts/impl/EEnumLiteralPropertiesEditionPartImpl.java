...
public class EEnumLiteralPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EEnumLiteralPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createValueText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_ValueLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.value, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createInstanceText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_InstanceLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.instance, EcoreViewsRepository.SWT_KIND));
		instance = new Text(parent, SWT.BORDER);
	...
	protected Composite createLiteralText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_LiteralLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.literal, EcoreViewsRepository.SWT_KIND));
		literal = new Text(parent, SWT.BORDER);
	...
	protected Composite createEEnumFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EEnumLiteralPropertiesEditionPart_EEnumLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EEnumLiteral.Properties.eEnum, EcoreViewsRepository.SWT_KIND));
