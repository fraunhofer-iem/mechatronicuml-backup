...
protected List<ViewerFilter> eGenericSuperTypesFilters = new ArrayList<ViewerFilter>();
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EClassPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EClass.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createInstanceClassNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EClassPropertiesEditionPart_InstanceClassNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EClass.Properties.instanceClassName, EcoreViewsRepository.SWT_KIND));
		instanceClassName = new Text(parent, SWT.BORDER);
	...
	protected Composite createInstanceTypeNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EClassPropertiesEditionPart_InstanceTypeNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EClass.Properties.instanceTypeName, EcoreViewsRepository.SWT_KIND));
		instanceTypeName = new Text(parent, SWT.BORDER);
	...
	protected Composite createEPackageFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EClassPropertiesEditionPart_EPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EClass.Properties.ePackage, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createAbstract_Checkbox(Composite parent) {
		...
		abstract_.setText(EcoreMessages.EClassPropertiesEditionPart_Abstract_Label);
	...
	protected Composite createInterface_Checkbox(Composite parent) {
		...
		interface_.setText(EcoreMessages.EClassPropertiesEditionPart_Interface_Label);
