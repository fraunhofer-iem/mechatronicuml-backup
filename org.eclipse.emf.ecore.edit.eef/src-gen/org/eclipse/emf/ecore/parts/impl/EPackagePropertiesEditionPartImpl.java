...
public class EPackagePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EPackagePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EPackagePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createNsURIText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EPackagePropertiesEditionPart_NsURILabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.nsURI, EcoreViewsRepository.SWT_KIND));
		nsURI = new Text(parent, SWT.BORDER);
	...
	protected Composite createNsPrefixText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EPackagePropertiesEditionPart_NsPrefixLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.nsPrefix, EcoreViewsRepository.SWT_KIND));
		nsPrefix = new Text(parent, SWT.BORDER);
	...
	protected Composite createEFactoryInstanceFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EPackagePropertiesEditionPart_EFactoryInstanceLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.eFactoryInstance, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createESuperPackageFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EPackagePropertiesEditionPart_ESuperPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EPackage.Properties.eSuperPackage, EcoreViewsRepository.SWT_KIND));
