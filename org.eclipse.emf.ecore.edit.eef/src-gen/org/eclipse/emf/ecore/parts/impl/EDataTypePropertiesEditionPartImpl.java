...
public class EDataTypePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EDataTypePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EDataTypePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createInstanceClassNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EDataTypePropertiesEditionPart_InstanceClassNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.instanceClassName, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createInstanceTypeNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EDataTypePropertiesEditionPart_InstanceTypeNameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.instanceTypeName, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createEPackageFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EDataTypePropertiesEditionPart_EPackageLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EDataType.Properties.ePackage, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createSerializableCheckbox(Composite parent) {
		...
		serializable.setText(EcoreMessages.EDataTypePropertiesEditionPart_SerializableLabel);
