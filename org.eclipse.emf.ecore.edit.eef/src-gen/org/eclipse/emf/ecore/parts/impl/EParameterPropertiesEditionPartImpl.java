...
public class EParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EParameterPropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EParameterPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createOrderedCheckbox(Composite parent) {
		...
		ordered.setText(EcoreMessages.EParameterPropertiesEditionPart_OrderedLabel);
	...
	protected Composite createUniqueCheckbox(Composite parent) {
		...
		unique.setText(EcoreMessages.EParameterPropertiesEditionPart_UniqueLabel);
	...
	protected Composite createLowerBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EParameterPropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.lowerBound, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createUpperBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EParameterPropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.upperBound, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createETypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EParameterPropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.eType, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createEOperationFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EParameterPropertiesEditionPart_EOperationLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EParameter.Properties.eOperation, EcoreViewsRepository.SWT_KIND));
