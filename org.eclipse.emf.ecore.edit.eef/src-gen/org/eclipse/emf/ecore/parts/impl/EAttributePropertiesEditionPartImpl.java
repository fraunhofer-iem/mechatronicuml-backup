...
public class EAttributePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EAttributePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAttributePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createOrderedCheckbox(Composite parent) {
		...
		ordered.setText(EcoreMessages.EAttributePropertiesEditionPart_OrderedLabel);
	...
	protected Composite createUniqueCheckbox(Composite parent) {
		...
		unique.setText(EcoreMessages.EAttributePropertiesEditionPart_UniqueLabel);
	...
	protected Composite createLowerBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAttributePropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.lowerBound, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createUpperBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAttributePropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.upperBound, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createETypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAttributePropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.eType, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createChangeableCheckbox(Composite parent) {
		...
		changeable.setText(EcoreMessages.EAttributePropertiesEditionPart_ChangeableLabel);
	...
	protected Composite createVolatile_Checkbox(Composite parent) {
		...
		volatile_.setText(EcoreMessages.EAttributePropertiesEditionPart_Volatile_Label);
	...
	protected Composite createTransient_Checkbox(Composite parent) {
		...
		transient_.setText(EcoreMessages.EAttributePropertiesEditionPart_Transient_Label);
	...
	protected Composite createDefaultValueLiteralText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAttributePropertiesEditionPart_DefaultValueLiteralLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.defaultValueLiteral, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createUnsettableCheckbox(Composite parent) {
		...
		unsettable.setText(EcoreMessages.EAttributePropertiesEditionPart_UnsettableLabel);
	...
	protected Composite createDerivedCheckbox(Composite parent) {
		...
		derived.setText(EcoreMessages.EAttributePropertiesEditionPart_DerivedLabel);
	...
	protected Composite createEContainingClassFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EAttributePropertiesEditionPart_EContainingClassLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EAttribute.Properties.eContainingClass, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createIDCheckbox(Composite parent) {
		...
		iD.setText(EcoreMessages.EAttributePropertiesEditionPart_IDLabel);
