...
protected List<ViewerFilter> eGenericExceptionsFilters = new ArrayList<ViewerFilter>();
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EOperationPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.name, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createOrderedCheckbox(Composite parent) {
		...
		ordered.setText(EcoreMessages.EOperationPropertiesEditionPart_OrderedLabel);
	...
	protected Composite createUniqueCheckbox(Composite parent) {
		...
		unique.setText(EcoreMessages.EOperationPropertiesEditionPart_UniqueLabel);
	...
	protected Composite createLowerBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EOperationPropertiesEditionPart_LowerBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.lowerBound, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createUpperBoundText(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EOperationPropertiesEditionPart_UpperBoundLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.upperBound, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createETypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EOperationPropertiesEditionPart_ETypeLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.eType, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createEContainingClassFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EOperationPropertiesEditionPart_EContainingClassLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EOperation.Properties.eContainingClass, EcoreViewsRepository.SWT_KIND));
