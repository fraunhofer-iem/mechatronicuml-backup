...
protected List<ViewerFilter> eTypeArgumentsFilters = new ArrayList<ViewerFilter>();
	...
	protected Composite createETypeParameterFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EGenericTypePropertiesEditionPart_ETypeParameterLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EGenericType.Properties.eTypeParameter, EcoreViewsRepository.SWT_KIND));
	...
	protected Composite createEClassifierFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, EcoreMessages.EGenericTypePropertiesEditionPart_EClassifierLabel, propertiesEditionComponent.isRequired(EcoreViewsRepository.EGenericType.Properties.eClassifier, EcoreViewsRepository.SWT_KIND));
