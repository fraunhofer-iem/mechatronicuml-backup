...
public class ContinuousPortInstanceNameEditPart extends LabelEditPart implements
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.policies.MumlTextSelectionEditPolicy) {
			((de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.policies.MumlTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.policies.MumlTextSelectionEditPolicy) {
			((de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.edit.policies.MumlTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.providers.MumlParserProvider
					.getParser(
