...
public class MumlDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.part.ComponentinstanceconfigurationDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new de.uni_paderborn.fujaba.muml.componentinstanceconfiguration.diagram.part.ValidateAction(
				page);
