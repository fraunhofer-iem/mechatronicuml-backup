 ...
 * generated by Xtext
 */
package de.uni_paderborn.fujaba.graphviz.dot.xtext.formatting;
...
public class DotLanguageFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  ...
  protected void configureFormatting(final FormattingConfig c) {
    ...
    List<Keyword> _findKeywords = this._dotLanguageGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._dotLanguageGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._dotLanguageGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._dotLanguageGrammarAccess.getML_COMMENTRule();
