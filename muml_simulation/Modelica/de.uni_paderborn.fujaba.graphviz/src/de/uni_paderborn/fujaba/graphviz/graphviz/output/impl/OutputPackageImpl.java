...
public class OutputPackageImpl extends EPackageImpl implements OutputPackage {
	 ...
	 * @see de.uni_paderborn.fujaba.graphviz.graphviz.output.OutputPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getGraph_Scale() {
	 ...
	 * @generated
	 */
	public EAttribute getGraph_Width() {
	 ...
	 * @generated
	 */
	public EAttribute getGraph_Height() {
	 ...
	 * @generated
	 */
	public EReference getNode_Position() {
	 ...
	 * @generated
	 */
	public EReference getEdge_SplinePoints() {
	...
	public void createPackageContents() {
		...
		createEAttribute(graphEClass, GRAPH__SCALE);
		createEAttribute(graphEClass, GRAPH__WIDTH);
		createEAttribute(graphEClass, GRAPH__HEIGHT);
		...
		createEReference(nodeEClass, NODE__POSITION);

		edgeEClass = createEClass(EDGE);
		createEReference(edgeEClass, EDGE__SOURCE);
		createEReference(edgeEClass, EDGE__TARGET);
		createEReference(edgeEClass, EDGE__SPLINE_POINTS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGraph_Scale(), ecorePackage.getEDouble(), "scale", null, 1, 1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGraph_Width(), ecorePackage.getEDouble(), "width", null, 1, 1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGraph_Height(), ecorePackage.getEDouble(), "height", null, 1, 1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNode_Width(), ecorePackage.getEDouble(), "width", null, 1, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNode_Height(), ecorePackage.getEDouble(), "height", null, 1, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNode_Position(), this.getPoint(), null, "position", null, 1, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEdge_SplinePoints(), this.getPoint(), null, "splinePoints", null, 0, -1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
