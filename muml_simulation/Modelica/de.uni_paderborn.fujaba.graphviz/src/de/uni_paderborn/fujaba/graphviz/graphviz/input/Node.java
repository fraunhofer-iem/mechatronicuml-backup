 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.graphviz.graphviz.input.Node#getSettings <em>Settings</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.graphviz.graphviz.input.InputPackage#getNode()
 * @model
 * @generated
 */
public interface Node extends NamedElement {
	 ...
	 * @see de.uni_paderborn.fujaba.graphviz.graphviz.input.InputPackage#getNode_Settings()
