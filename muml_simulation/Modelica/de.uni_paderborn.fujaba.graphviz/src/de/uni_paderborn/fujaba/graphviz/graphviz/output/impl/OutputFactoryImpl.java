...
public class OutputFactoryImpl extends EFactoryImpl implements OutputFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case OutputPackage.GRAPH: return createGraph();
			case OutputPackage.NODE: return createNode();
			case OutputPackage.EDGE: return createEdge();
			case OutputPackage.POINT: return createPoint();
			default:
