 ...
 *******************************************************************************/
package de.uni_paderborn.fujaba.muml.gen.model.modelica.realtimecoordination.main;
...
public class Main extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/de/uni_paderborn/fujaba/muml/gen/model/modelica/realtimecoordination/main/main";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(de.fujaba.modelinstance.ModelinstancePackage.class)) {
            resourceSet.getPackageRegistry().put(de.fujaba.modelinstance.ModelinstancePackage.eINSTANCE.getNsURI(), de.fujaba.modelinstance.ModelinstancePackage.eINSTANCE);
        }
        if (!isInWorkspace(de.uni_paderborn.fujaba.muml.model.instance.InstancePackage.class)) {
            resourceSet.getPackageRegistry().put(de.uni_paderborn.fujaba.muml.model.instance.InstancePackage.eINSTANCE.getNsURI(), de.uni_paderborn.fujaba.muml.model.instance.InstancePackage.eINSTANCE);
        }
