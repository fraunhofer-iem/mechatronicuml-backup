...
* generated by Xtext
*/
package de.uni_paderborn.fujaba.graphviz.xtext.services;
...
@Singleton
public class PlainGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class EdgeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSourceNodeIdentifierParserRuleCall_1_0_1 = (RuleCall)cSourceNodeCrossReference_1_0.eContents().get(1);
		...
		private final RuleCall cTargetNodeIdentifierParserRuleCall_2_0_1 = (RuleCall)cTargetNodeCrossReference_2_0.eContents().get(1);
		...
		//Edge returns output::Edge:
		//	"edge" source=[output::Node|Identifier] target=[output::Node|Identifier] INT splinePoints+=Point* (Identifier Number
		//	Number)? ID ID;
		public ParserRule getRule() { return rule; }
		...
		//Identifier
		public RuleCall getSourceNodeIdentifierParserRuleCall_1_0_1() { return cSourceNodeIdentifierParserRuleCall_1_0_1; }

		//target=[output::Node|Identifier]
		...
		//Identifier
		public RuleCall getTargetNodeIdentifierParserRuleCall_2_0_1() { return cTargetNodeIdentifierParserRuleCall_2_0_1; }
	...
	@Inject
	public PlainGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.uni_paderborn.fujaba.graphviz.xtext.Plain".equals(grammar.getName())) {
				return grammar;
			}
