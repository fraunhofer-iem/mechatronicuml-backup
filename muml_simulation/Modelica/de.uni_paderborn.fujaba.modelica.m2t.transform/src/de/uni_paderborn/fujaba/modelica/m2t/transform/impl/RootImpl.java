 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.modelica.m2t.transform.impl.RootImpl#getMaps <em>Maps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RootImpl extends EObjectImpl implements Root {
	...
	protected EClass eStaticClass() {
		return TransformPackage.Literals.ROOT;
	}
	...
	public EList<Map> getMaps() {
		if (maps == null) {
			maps = new EObjectContainmentEList<Map>(Map.class, this, TransformPackage.ROOT__MAPS);
		}
		return maps;
	}
