 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.modelica.m2t.transform.RegionInstance#getInstanceOf <em>Instance Of</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.modelica.m2t.transform.RegionInstance#isEmbedsSinglePortStatechart <em>Embeds Single Port Statechart</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.modelica.m2t.transform.RegionInstance#isEmbedsMultiPortStatechart <em>Embeds Multi Port Statechart</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.modelica.m2t.transform.TransformPackage#getRegionInstance()
 * @model
 * @generated
 */
public interface RegionInstance extends Region {
	 ...
	 * @see de.uni_paderborn.fujaba.modelica.m2t.transform.TransformPackage#getRegionInstance_InstanceOf()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.modelica.m2t.transform.RegionInstance#getInstanceOf <em>Instance Of</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.modelica.m2t.transform.TransformPackage#getRegionInstance_EmbedsSinglePortStatechart()
	 * @model derived="true"
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.modelica.m2t.transform.RegionInstance#isEmbedsSinglePortStatechart <em>Embeds Single Port Statechart</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.modelica.m2t.transform.TransformPackage#getRegionInstance_EmbedsMultiPortStatechart()
	 * @model derived="true"
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.modelica.m2t.transform.RegionInstance#isEmbedsMultiPortStatechart <em>Embeds Multi Port Statechart</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
