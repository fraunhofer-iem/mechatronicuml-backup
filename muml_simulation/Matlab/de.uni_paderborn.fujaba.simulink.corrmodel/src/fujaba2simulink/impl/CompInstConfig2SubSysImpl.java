 ...
 * <ul>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getInstConfig <em>Inst Config</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getSubSys <em>Sub Sys</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCommunicationSwitch <em>Communication Switch</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusCreator <em>Bus Creator</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusSelector <em>Bus Selector</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusCreatorOutPort <em>Bus Creator Out Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusSelectorInPort <em>Bus Selector In Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusOfBusses <em>Bus Of Busses</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCS_inPort <em>CS in Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCS_outPort <em>CS out Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCompInstName <em>Comp Inst Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
