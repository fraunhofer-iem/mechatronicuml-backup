 ...
 * <ul>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getInstConfig <em>Inst Config</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getSubSys <em>Sub Sys</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getCommunicationSwitch <em>Communication Switch</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getBusCreator <em>Bus Creator</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getBusSelector <em>Bus Selector</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getBusCreatorOutPort <em>Bus Creator Out Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getBusSelectorInPort <em>Bus Selector In Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getBusOfBusses <em>Bus Of Busses</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getCS_inPort <em>CS in Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getCS_outPort <em>CS out Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getCompInstName <em>Comp Inst Name</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getComponentInstance <em>Component Instance</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getLibraryReference <em>Library Reference</em>}</li>
 *   <li>{@link fujaba2simulink.impl.StructComp2SubSysImpl#getComp <em>Comp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
