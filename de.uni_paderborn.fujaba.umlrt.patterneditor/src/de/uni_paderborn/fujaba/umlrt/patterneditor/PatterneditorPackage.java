 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.PatterneditorFactory
 * @model kind="package"
 * @generated
 */
public interface PatterneditorPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http:///de/uni_paderborn/fujaba/umlrt/patterneditor";
	 ...
	 * @generated
	 */
	PatterneditorPackage eINSTANCE = de.uni_paderborn.fujaba.umlrt.patterneditor.impl.PatterneditorPackageImpl.init();

	/**
	 * The meta object id for the '{@link de.uni_paderborn.fujaba.umlrt.patterneditor.impl.PatternDiagramImpl <em>Pattern Diagram</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.impl.PatternDiagramImpl
	 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.impl.PatterneditorPackageImpl#getPatternDiagram()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram <em>Pattern Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Pattern Diagram</em>'.
	 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram
	 * @generated
	 */
	EClass getPatternDiagram();

	/**
	 * Returns the meta object for the containment reference '{@link de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getCoordinationPattern <em>Coordination Pattern</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Coordination Pattern</em>'.
	 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getCoordinationPattern()
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getRoles <em>Roles</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Roles</em>'.
	 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getRoles()
	 * @see #getPatternDiagram()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getRoleConnectors <em>Role Connectors</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Role Connectors</em>'.
	 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getRoleConnectors()
	 * @see #getPatternDiagram()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getTextualConstraints <em>Textual Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Textual Constraints</em>'.
	 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.PatternDiagram#getTextualConstraints()
	 * @see #getPatternDiagram()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.uni_paderborn.fujaba.umlrt.patterneditor.impl.PatternDiagramImpl <em>Pattern Diagram</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.impl.PatternDiagramImpl
		 * @see de.uni_paderborn.fujaba.umlrt.patterneditor.impl.PatterneditorPackageImpl#getPatternDiagram()
