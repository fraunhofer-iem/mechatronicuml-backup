...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.model.behavior.TypedNamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypedNamedElementItemProvider
	 ...
	 * @generated
	 */
	public TypedNamedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((TypedNamedElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TypedNamedElement_type") :
			getString("_UI_TypedNamedElement_type") + " " + label;
	}
