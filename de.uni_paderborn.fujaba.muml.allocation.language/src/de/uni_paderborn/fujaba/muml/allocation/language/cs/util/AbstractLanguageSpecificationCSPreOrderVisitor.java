...
import org.eclipse.ocl.examples.xtext.completeocl.cs2as.CompleteOCLCSPreOrderVisitor;
	...
	implements LanguageSpecificationCSVisitor<Continuation<?>>
{
	 ...
	 */
	protected AbstractLanguageSpecificationCSPreOrderVisitor(@NonNull CS2PivotConversion context) {
		super(context);
	}
