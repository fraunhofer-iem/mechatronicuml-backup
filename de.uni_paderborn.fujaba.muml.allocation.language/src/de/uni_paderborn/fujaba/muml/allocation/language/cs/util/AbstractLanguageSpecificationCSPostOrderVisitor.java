...
/**
 * An AbstractLanguageSpecificationCSPostOrderVisitor provides a default implementation for each
	...
	implements LanguageSpecificationCSVisitor<Continuation<?>>
{
	 ...
	 */
	protected AbstractLanguageSpecificationCSPostOrderVisitor(@NonNull CS2PivotConversion context) {
		super(context);
	}
