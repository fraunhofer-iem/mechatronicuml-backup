	...
	implements LanguageSpecificationCSVisitor<Element>
{
	...
	@Override
	public @Nullable Element visitCoherenceConstraintCS(org.muml.psm.allocation.language.cs.@NonNull CoherenceConstraintCS csElement) {
	...
	@Override
	public @Nullable Element visitRelationCS(org.muml.psm.allocation.language.cs.@NonNull RelationCS csElement) {
		return visitNamedElementCS(csElement);
	}
