...
public class RangedPrimitiveDataTypeRangeSection
	...
	public RangedPrimitiveDataTypeRangeSection() {
		addSection(new de.uni_paderborn.fujaba.muml.properties.valuetype.section.RangeLowerBoundSection());
		addSection(new de.uni_paderborn.fujaba.muml.properties.valuetype.section.RangeUpperBoundSection());
	}
}