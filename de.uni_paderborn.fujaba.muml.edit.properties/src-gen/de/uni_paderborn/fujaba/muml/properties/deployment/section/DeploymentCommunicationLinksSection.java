...
public class DeploymentCommunicationLinksSection
		extends
	...
	public org.eclipse.emf.ecore.EStructuralFeature getFeature() {
		return de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage.eINSTANCE
				.getDeployment_CommunicationLinks();
	}
	...
	protected java.util.List<Object> getItems() {
		...
		while (it.hasNext()) {
			...
			if (element instanceof de.uni_paderborn.fujaba.muml.deployment.CommunicationLink) {
				nodes.add(element);
			}
		}
