...
public class ComponentInstanceConfigurationPortConnectorInstancesSection
		extends
	...
	protected java.util.List<Object> getItems() {
		...
		while (it.hasNext()) {
			...
			if (element instanceof de.uni_paderborn.fujaba.muml.instance.PortConnectorInstance) {
				nodes.add(element);
			}
		}
