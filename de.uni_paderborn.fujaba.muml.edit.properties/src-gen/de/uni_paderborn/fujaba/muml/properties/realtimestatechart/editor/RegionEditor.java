...
public class RegionEditor
	...
	protected void createProperties() {
		...
		if (getTab() == null || "property.tab.general".equals(getTab())) {
			addParentState_GeneralTab_Editor(null, true);
		}
	 ...
	 * @generated
	 */
	protected void addParentState_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category, createParentState_GeneralTab_Editor(),
				front);
	}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createParentState_GeneralTab_Editor() {
