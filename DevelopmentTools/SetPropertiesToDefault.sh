...
wget https://svn-serv.cs.upb.de/mechatronicuml/trunk/DevelopmentTools/SetPropertiesToDefault.java
javac  SetPropertiesToDefault.java
...
do
	echo $fname
    java -cp . SetPropertiesToDefault $fname
done