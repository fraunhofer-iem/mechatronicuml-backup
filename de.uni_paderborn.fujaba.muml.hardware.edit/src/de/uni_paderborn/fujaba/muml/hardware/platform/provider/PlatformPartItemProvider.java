...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.platform.PlatformPart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlatformPartItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlatformPackage.Literals.PLATFORM_PART__PARENT_HW_PLATFORM,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlatformPackage.Literals.PLATFORM_PART__CARDINALITY,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addCardinalityPropertyDescriptor(Object object) {
		IChainedPropertyDescriptor rootPropertyDescriptor = new DefaultChainedPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_PlatformPart_cardinality_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PlatformPart_cardinality_feature",
						"_UI_PlatformPart_type"),
				PlatformPackage.Literals.PLATFORM_PART__CARDINALITY,
				true,
				false,
				false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatformPackage.Literals.PLATFORM_PART__CARDINALITY);
		}
