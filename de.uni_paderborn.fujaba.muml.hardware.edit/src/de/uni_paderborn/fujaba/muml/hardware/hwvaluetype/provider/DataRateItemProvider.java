...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.hwvaluetype.DataRate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataRateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HwvaluetypePackage.Literals.DATA_RATE__VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HwvaluetypePackage.Literals.DATA_RATE__UNIT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		DataRate dataRate = (DataRate)object;
		return getString("_UI_DataRate_type") + " " + dataRate.getValue();
	}
