...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.CommunicationProtocol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ResourcetypePackage.Literals.COMMUNICATION_PROTOCOL__IS_TIME_TRIGGERED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ResourcetypePackage.Literals.COMMUNICATION_PROTOCOL__IS_EVENT_TRIGGERED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ResourcetypePackage.Literals.COMMUNICATION_PROTOCOL__FURTHER_INFORMATION,
				 true,
				 false,
				 false,
