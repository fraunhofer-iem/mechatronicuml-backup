...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.resourcetype.ResourceTypeRepository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceTypeRepositoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceTypeRepository_protocols_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceTypeRepository_protocols_feature", "_UI_ResourceTypeRepository_type"),
				 ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__PROTOCOLS,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__PROTOCOLS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__RESOURCE_TYPES,
				 ResourcetypeFactory.eINSTANCE.createMemoryResource()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__RESOURCE_TYPES,
				 ResourcetypeFactory.eINSTANCE.createDevice()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__RESOURCE_TYPES,
				 ResourcetypeFactory.eINSTANCE.createCache()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__RESOURCE_TYPES,
				 ResourcetypeFactory.eINSTANCE.createProgrammableLogicDevice()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__RESOURCE_TYPES,
				 ResourcetypeFactory.eINSTANCE.createProcessor()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__RESOURCE_TYPES,
				 ResourcetypeFactory.eINSTANCE.createStructuredResource()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__PROTOCOLS,
				 ResourcetypeFactory.eINSTANCE.createBusProtocol()));

		newChildDescriptors.add
			(createChildParameter
				(ResourcetypePackage.Literals.RESOURCE_TYPE_REPOSITORY__PROTOCOLS,
				 ResourcetypeFactory.eINSTANCE.createLinkProtocol()));
	}
