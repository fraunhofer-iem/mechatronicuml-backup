...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.hwplatform.BusPart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusPartItemProvider
	 ...
	 * @generated
	 */
	public BusPartItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addConnectedHWPortPartsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusPart_connectedHWPortParts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusPart_connectedHWPortParts_feature", "_UI_BusPart_type"),
				 HwplatformPackage.Literals.BUS_PART__CONNECTED_HW_PORT_PARTS,
				 false,
				 false,
				 false,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BusPart"));
	}
	...
	public String getText(Object object) {
		String label = ((BusPart)object).getComment();
		return label == null || label.length() == 0 ?
			getString("_UI_BusPart_type") :
			getString("_UI_BusPart_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BusPart.class)) {
