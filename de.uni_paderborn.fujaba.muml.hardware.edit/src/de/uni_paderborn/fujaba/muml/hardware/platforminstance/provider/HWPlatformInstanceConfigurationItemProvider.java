...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.platforminstance.HWPlatformInstanceConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HWPlatformInstanceConfigurationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatforminstancePackage.Literals.HW_PLATFORM_INSTANCE_CONFIGURATION__HWPLATFORM_INSTANCES);
			childrenFeatures.add(PlatforminstancePackage.Literals.HW_PLATFORM_INSTANCE_CONFIGURATION__COMMUNICATION_MEDIA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatforminstancePackage.Literals.HW_PLATFORM_INSTANCE_CONFIGURATION__HWPLATFORM_INSTANCES,
				 PlatforminstanceFactory.eINSTANCE.createHWPlatformInstance()));

		newChildDescriptors.add
			(createChildParameter
				(PlatforminstancePackage.Literals.HW_PLATFORM_INSTANCE_CONFIGURATION__COMMUNICATION_MEDIA,
