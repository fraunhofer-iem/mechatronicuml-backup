...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.BridgeInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BridgeInstanceItemProvider
	 ...
	 * @generated
	 */
	public BridgeInstanceItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConnectedCommunicationMediaInstancePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Connected Communication Media Instance feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConnectedCommunicationMediaInstancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BridgeInstance_connectedCommunicationMediaInstance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BridgeInstance_connectedCommunicationMediaInstance_feature", "_UI_BridgeInstance_type"),
				 HwplatforminstancePackage.Literals.BRIDGE_INSTANCE__CONNECTED_COMMUNICATION_MEDIA_INSTANCE,
				 false,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns BridgeInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BridgeInstance"));
	}
	...
	public String getText(Object object) {
		String label = ((BridgeInstance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BridgeInstance_type") :
			getString("_UI_BridgeInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BridgeInstance.class)) {
