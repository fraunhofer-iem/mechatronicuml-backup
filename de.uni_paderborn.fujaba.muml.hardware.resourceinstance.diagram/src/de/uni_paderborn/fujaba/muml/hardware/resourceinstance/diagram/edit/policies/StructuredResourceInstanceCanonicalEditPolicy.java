...
public class StructuredResourceInstanceCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.part.HardwareDiagramUpdater
				.getStructuredResourceInstance_2003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.part.HardwareVisualIDRegistry
				.getVisualID(view);
		return visualID == de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.BusPortInstanceEditPart.VISUAL_ID
				|| visualID == de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.LinkPortInstanceEditPart.VISUAL_ID;
	}
