	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.BusPortInstanceEditPart.VISUAL_ID:
				return new de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.BusPortInstanceEditPart(
						view);
			...
			case de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.LinkPortInstanceEditPart.VISUAL_ID:
				return new de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.LinkPortInstanceEditPart(
						view);

			case de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.HWPortLabel2EditPart.VISUAL_ID:
				return new de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.parts.HWPortLabel2EditPart(
						view);
