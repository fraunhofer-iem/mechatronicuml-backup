...
public class ProcessorInstanceOwnedCacheInstanceCreateCommand extends
	...
	public boolean canExecute() {
		...
		if (source != null
				&& false == source instanceof de.uni_paderborn.fujaba.muml.hardware.platform.ProcessorInstance) {
			return false;
		}
		if (target != null
				&& false == target instanceof de.uni_paderborn.fujaba.muml.hardware.platform.CacheInstance) {
			return false;
		}
		if (getSource() == null) {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateProcessorInstanceOwnedCacheInstance_4001(getSource(),
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.platform.ProcessorInstance getSource() {
		return (de.uni_paderborn.fujaba.muml.hardware.platform.ProcessorInstance) source;
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.platform.CacheInstance getTarget() {
		return (de.uni_paderborn.fujaba.muml.hardware.platform.CacheInstance) target;
	}
}
