...
package org.muml.security.extension.properties.constraint;
...
public class CreationConstraintContributor
	...
	public CreationConstraintContributor() {
		...
		{
			final org.eclipse.emf.ecore.EClass myClass = org.muml.security.extension.ExtensionPackage.eINSTANCE
			...
			final org.eclipse.ocl.ecore.OCLExpression expression = org.muml.ape.runtime.RuntimePlugin
					.createOCLExpression("self.oclIsKindOf(msgtype::MessageType)", opposite, oppositeClass);
			if (expression != null) {
