 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.Deployment#getCommunicationLinks <em>Communication Links</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.Deployment#getHardwareNodes <em>Hardware Nodes</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.Deployment#getComponentInstanceConfiguration <em>Component Instance Configuration</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.Deployment#getQualityOfLinkServices <em>Quality Of Link Services</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.psm.deployment.DeploymentPackage#getDeployment()
 * @model
 * @generated
 */
public interface Deployment extends NamedElement, CommentableElement {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.psm.deployment.CommunicationLink#getDeployment <em>Deployment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.deployment.DeploymentPackage#getDeployment_CommunicationLinks()
	 ...
	 * The list contents are of type {@link de.uni_paderborn.fujaba.muml.psm.deployment.HardwareNode}.
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.psm.deployment.HardwareNode#getDeployment <em>Deployment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.deployment.DeploymentPackage#getDeployment_HardwareNodes()
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.deployment.DeploymentPackage#getDeployment_ComponentInstanceConfiguration()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.deployment.Deployment#getComponentInstanceConfiguration <em>Component Instance Configuration</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.psm.deployment.LinkQualityOfService#getDeployment <em>Deployment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.deployment.DeploymentPackage#getDeployment_QualityOfLinkServices()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.deployment.Deployment#getQualityOfLinkServices <em>Quality Of Link Services</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
