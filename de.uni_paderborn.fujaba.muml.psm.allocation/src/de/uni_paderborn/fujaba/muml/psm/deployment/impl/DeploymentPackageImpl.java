...
public class DeploymentPackageImpl extends EPackageImpl implements DeploymentPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getHardwarePort_Kind(), this.getHardwarePortDirectionKind(), "kind", "IN_OUT", 0, 1, HardwarePort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
