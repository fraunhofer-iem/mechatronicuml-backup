 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwareNodeImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwareNodeImpl#getDeployment <em>Deployment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwareNodeImpl#getHardwarePorts <em>Hardware Ports</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwareNodeImpl#getDeployedInstances <em>Deployed Instances</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwareNodeImpl#getHardwareNodeKind <em>Hardware Node Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
