	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CodegenPackage.COD_GEN: {
				...
				if (result == null) result = caseComponentInstanceConfiguration(codGen);
				if (result == null) result = caseNamedElement(codGen);
				if (result == null) result = caseCommentableElement(codGen);
				if (result == null) result = caseExtendableElement(codGen);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
