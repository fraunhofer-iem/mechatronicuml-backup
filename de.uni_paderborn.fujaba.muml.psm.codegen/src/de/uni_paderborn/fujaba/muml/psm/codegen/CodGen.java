 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.codegen.CodGen#getAllResourceInstances <em>All Resource Instances</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.codegen.CodGen#getCic <em>Cic</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.psm.codegen.CodegenPackage#getCodGen()
 * @model
 * @generated
 */
public interface CodGen extends EObject {
	/**
	 * Returns the value of the '<em><b>All Resource Instances</b></em>' containment reference list.
	 * The list contents are of type {@link de.uni_paderborn.fujaba.muml.psm.codegen.RefindedStructuredResourceInstance}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.codegen.CodegenPackage#getCodGen_AllResourceInstances()
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.codegen.CodegenPackage#getCodGen_Cic()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.codegen.CodGen#getCic <em>Cic</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
