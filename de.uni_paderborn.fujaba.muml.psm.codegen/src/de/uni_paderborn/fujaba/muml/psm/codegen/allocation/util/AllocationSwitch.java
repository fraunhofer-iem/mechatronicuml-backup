...
public class AllocationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AllocationPackage.REFINED_COMPONENT_INSTANCE: {
				...
				if (result == null) result = caseNamedElement(refinedComponentInstance);
				if (result == null) result = caseExtendableElement(refinedComponentInstance);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Refined Component Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Refined Component Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRefinedComponentInstance(RefinedComponentInstance object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Refinded Structured Resource Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Refinded Structured Resource Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRefindedStructuredResourceInstance(RefindedStructuredResourceInstance object) {
		return null;
	}
