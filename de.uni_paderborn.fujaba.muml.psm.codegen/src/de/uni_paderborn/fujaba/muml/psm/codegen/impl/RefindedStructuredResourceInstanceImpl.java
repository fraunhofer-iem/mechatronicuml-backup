 ...
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.codegen.impl.RefindedStructuredResourceInstanceImpl#getAllUsedMessageTypes <em>All Used Message Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefindedStructuredResourceInstanceImpl extends StructuredResourceInstanceImpl implements RefindedStructuredResourceInstance {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate ALL_USED_MESSAGE_TYPES__ESETTING_DELEGATE = ((EStructuralFeature.Internal)CodegenPackage.Literals.REFINDED_STRUCTURED_RESOURCE_INSTANCE__ALL_USED_MESSAGE_TYPES).getSettingDelegate();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CodegenPackage.REFINDED_STRUCTURED_RESOURCE_INSTANCE__ALL_USED_MESSAGE_TYPES:
