...
public class DelegationInstancePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DelegationInstancePropertiesEditionPart {
	 ...
	 * 
	 */
	public DelegationInstancePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(InstanceMessages.DelegationInstancePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createSourceFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, InstanceMessages.DelegationInstancePropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.DelegationInstance.Properties.source, InstanceViewsRepository.SWT_KIND));
		source = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(InstanceViewsRepository.DelegationInstance.Properties.source, InstanceViewsRepository.SWT_KIND));
		...
		source.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DelegationInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DelegationInstance.Properties.source, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSource()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DelegationInstance.Properties.source, InstanceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTargetFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, InstanceMessages.DelegationInstancePropertiesEditionPart_TargetLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.DelegationInstance.Properties.target, InstanceViewsRepository.SWT_KIND));
		target = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(InstanceViewsRepository.DelegationInstance.Properties.target, InstanceViewsRepository.SWT_KIND));
		target.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		target.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DelegationInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DelegationInstance.Properties.target, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTarget()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DelegationInstance.Properties.target, InstanceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createConnectorTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, InstanceMessages.DelegationInstancePropertiesEditionPart_ConnectorTypeLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.DelegationInstance.Properties.connectorType, InstanceViewsRepository.SWT_KIND));
		connectorType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(InstanceViewsRepository.DelegationInstance.Properties.connectorType, InstanceViewsRepository.SWT_KIND));
		...
		connectorType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DelegationInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DelegationInstance.Properties.connectorType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getConnectorType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DelegationInstance.Properties.connectorType, InstanceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
