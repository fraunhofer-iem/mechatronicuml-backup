 ...
 * 
 */
public class PatternInstancePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, PatternInstancePropertiesEditionPart {
	 ...
	 * 
	 */
	public PatternInstancePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(patternInstanceStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == InstanceViewsRepository.PatternInstance.Properties.portInstances) {
					return createPortInstancesReferencesTable(widgetFactory, parent);
				}
				if (key == InstanceViewsRepository.PatternInstance.Properties.patternOccurrence) {
					return createPatternOccurrenceFlatComboViewer(parent, widgetFactory);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(InstanceMessages.PatternInstancePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, InstanceMessages.PatternInstancePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.PatternInstance.Properties.name, InstanceViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PatternInstancePropertiesEditionPartForm.this, InstanceViewsRepository.PatternInstance.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.PatternInstance.Properties.name, InstanceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createPortInstancesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.portInstances.setHelpText(propertiesEditionComponent.getHelpContent(InstanceViewsRepository.PatternInstance.Properties.portInstances, InstanceViewsRepository.FORM_KIND));
		this.portInstances.createControls(parent, widgetFactory);
		this.portInstances.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PatternInstancePropertiesEditionPartForm.this, InstanceViewsRepository.PatternInstance.Properties.portInstances, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"portInstances", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PatternInstancePropertiesEditionPartForm.this, InstanceViewsRepository.PatternInstance.Properties.portInstances,
	...
	protected void movePortInstances(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PatternInstancePropertiesEditionPartForm.this, InstanceViewsRepository.PatternInstance.Properties.portInstances, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		portInstances.refresh();
	}
	...
	protected void removeFromPortInstances(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PatternInstancePropertiesEditionPartForm.this, InstanceViewsRepository.PatternInstance.Properties.portInstances, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		portInstances.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createPatternOccurrenceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, InstanceMessages.PatternInstancePropertiesEditionPart_PatternOccurrenceLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.PatternInstance.Properties.patternOccurrence, InstanceViewsRepository.FORM_KIND));
		patternOccurrence = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(InstanceViewsRepository.PatternInstance.Properties.patternOccurrence, InstanceViewsRepository.FORM_KIND));
		widgetFactory.adapt(patternOccurrence);
		...
		patternOccurrence.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PatternInstancePropertiesEditionPartForm.this, InstanceViewsRepository.PatternInstance.Properties.patternOccurrence, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPatternOccurrence()));
			}

		});
		patternOccurrence.setID(InstanceViewsRepository.PatternInstance.Properties.patternOccurrence);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.PatternInstance.Properties.patternOccurrence, InstanceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
