 ...
 * 
 */
public class ComponentInstancePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ComponentInstancePropertiesEditionPart {
	 ...
	 * 
	 */
	public ComponentInstancePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(InstanceMessages.ComponentInstancePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, InstanceMessages.ComponentInstancePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.ComponentInstance.Properties.name, InstanceViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComponentInstancePropertiesEditionPartForm.this, InstanceViewsRepository.ComponentInstance.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.ComponentInstance.Properties.name, InstanceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createComponentTypeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, InstanceMessages.ComponentInstancePropertiesEditionPart_ComponentTypeLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.ComponentInstance.Properties.componentType, InstanceViewsRepository.FORM_KIND));
		componentType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(InstanceViewsRepository.ComponentInstance.Properties.componentType, InstanceViewsRepository.FORM_KIND));
		...
		componentType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComponentInstancePropertiesEditionPartForm.this, InstanceViewsRepository.ComponentInstance.Properties.componentType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getComponentType()));
			}

		});
		componentType.setID(InstanceViewsRepository.ComponentInstance.Properties.componentType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.ComponentInstance.Properties.componentType, InstanceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
