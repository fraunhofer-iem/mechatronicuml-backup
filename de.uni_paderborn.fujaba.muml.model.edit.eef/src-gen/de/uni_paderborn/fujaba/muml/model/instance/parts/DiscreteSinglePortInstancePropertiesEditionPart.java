 ...
 * 
 */
public interface DiscreteSinglePortInstancePropertiesEditionPart {
	...
	/**
	 * @return the multiPortInstance
	 * 
	 */
	public EObject getMultiPortInstance();

	/**
	 * Init the multiPortInstance
	 * @param settings the combo setting
	 */
	public void initMultiPortInstance(EObjectFlatComboSettings settings);

	/**
	 * Defines a new multiPortInstance
	 * @param newValue the new multiPortInstance to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the multiPortInstance edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
