 ...
 * 
 */
public class CoordinationPatternPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public CoordinationPatternPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject coordinationPattern, String editing_mode) {
		super(editingContext, coordinationPattern, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = PatternViewsRepository.class;
		partKey = PatternViewsRepository.CoordinationPattern.class;
	}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (PatternViewsRepository.CoordinationPattern.Properties.name == event.getAffectedEditor()) {
			coordinationPattern.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	}
