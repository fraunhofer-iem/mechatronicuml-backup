 ...
 * 
 */
public class NaturalNumberPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, NaturalNumberPropertiesEditionPart {
	 ...
	 * 
	 */
	public NaturalNumberPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(naturalNumberStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == CoreViewsRepository.NaturalNumber.Properties.infinity) {
					return createInfinityCheckbox(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(CoreMessages.NaturalNumberPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, CoreMessages.NaturalNumberPropertiesEditionPart_ValueLabel, propertiesEditionComponent.isRequired(CoreViewsRepository.NaturalNumber.Properties.value, CoreViewsRepository.FORM_KIND));
		...
		value.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NaturalNumberPropertiesEditionPartForm.this, CoreViewsRepository.NaturalNumber.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, value.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CoreViewsRepository.NaturalNumber.Properties.value, CoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createInfinityCheckbox(FormToolkit widgetFactory, Composite parent) {
		infinity = widgetFactory.createButton(parent, CoreMessages.NaturalNumberPropertiesEditionPart_InfinityLabel, SWT.CHECK);
		infinity.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NaturalNumberPropertiesEditionPartForm.this, CoreViewsRepository.NaturalNumber.Properties.infinity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(infinity.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CoreViewsRepository.NaturalNumber.Properties.infinity, CoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
