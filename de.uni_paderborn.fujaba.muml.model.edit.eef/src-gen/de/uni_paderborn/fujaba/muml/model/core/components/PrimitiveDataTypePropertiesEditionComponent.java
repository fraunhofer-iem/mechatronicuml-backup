...
public class PrimitiveDataTypePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(CoreViewsRepository.PrimitiveDataType.Properties.name)) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(CoreViewsRepository.PrimitiveDataType.Properties.comment)) {
				if (msg.getNewValue() != null) {
			...
			if (de.uni_paderborn.fujaba.muml.model.core.CorePackage.eINSTANCE
					.getPrimitiveDataType_PrimitiveType().equals(
							msg.getFeature())
					&& isAccessible(CoreViewsRepository.PrimitiveDataType.Properties.primitiveType)) {
