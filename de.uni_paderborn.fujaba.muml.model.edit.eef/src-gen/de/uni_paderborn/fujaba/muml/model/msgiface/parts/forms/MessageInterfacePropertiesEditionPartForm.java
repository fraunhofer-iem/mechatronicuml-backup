 ...
 * 
 */
public class MessageInterfacePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, MessageInterfacePropertiesEditionPart {
	 ...
	 * 
	 */
	public MessageInterfacePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(MsgifaceMessages.MessageInterfacePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, MsgifaceMessages.MessageInterfacePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(MsgifaceViewsRepository.MessageInterface.Properties.name, MsgifaceViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageInterfacePropertiesEditionPartForm.this, MsgifaceViewsRepository.MessageInterface.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MsgifaceViewsRepository.MessageInterface.Properties.name, MsgifaceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, MsgifaceMessages.MessageInterfacePropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(MsgifaceViewsRepository.MessageInterface.Properties.comment, MsgifaceViewsRepository.FORM_KIND));
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageInterfacePropertiesEditionPartForm.this, MsgifaceViewsRepository.MessageInterface.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MsgifaceViewsRepository.MessageInterface.Properties.comment, MsgifaceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSuperTypeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.superType.setHelpText(propertiesEditionComponent.getHelpContent(MsgifaceViewsRepository.MessageInterface.Properties.superType, MsgifaceViewsRepository.FORM_KIND));
		...
		this.superType.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageInterfacePropertiesEditionPartForm.this, MsgifaceViewsRepository.MessageInterface.Properties.superType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"superType", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageInterfacePropertiesEditionPartForm.this, MsgifaceViewsRepository.MessageInterface.Properties.superType,
	...
	protected void moveSuperType(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageInterfacePropertiesEditionPartForm.this, MsgifaceViewsRepository.MessageInterface.Properties.superType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		superType.refresh();
	}
	...
	protected void removeFromSuperType(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageInterfacePropertiesEditionPartForm.this, MsgifaceViewsRepository.MessageInterface.Properties.superType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		superType.refresh();
	}
