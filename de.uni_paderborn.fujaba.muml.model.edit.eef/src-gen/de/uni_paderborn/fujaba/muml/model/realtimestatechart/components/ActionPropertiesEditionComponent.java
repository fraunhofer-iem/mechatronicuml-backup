 ...
 * 
 */
public class ActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ActionPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject action, String editing_mode) {
		super(editingContext, action, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = RealtimestatechartViewsRepository.class;
		partKey = RealtimestatechartViewsRepository.Action.class;
	}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (RealtimestatechartViewsRepository.Action.Properties.name == event.getAffectedEditor()) {
			action.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(RealtimestatechartViewsRepository.Action.Properties.name)) {
