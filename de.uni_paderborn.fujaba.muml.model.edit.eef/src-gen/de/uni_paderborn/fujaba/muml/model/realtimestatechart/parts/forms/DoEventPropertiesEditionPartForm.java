 ...
 * 
 */
public class DoEventPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DoEventPropertiesEditionPart {
	 ...
	 * 
	 */
	public DoEventPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(doEventStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RealtimestatechartViewsRepository.DoEvent.Properties.periodLower) {
					return 		createPeriodLowerText(widgetFactory, parent);
				}
				if (key == RealtimestatechartViewsRepository.DoEvent.Properties.periodUpper) {
					return 		createPeriodUpperText(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RealtimestatechartMessages.DoEventPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKindEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.DoEventPropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.DoEvent.Properties.kind, RealtimestatechartViewsRepository.FORM_KIND));
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DoEventPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.DoEvent.Properties.kind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKind()));
			}

		});
		kind.setID(RealtimestatechartViewsRepository.DoEvent.Properties.kind);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.DoEvent.Properties.kind, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createPeriodLowerText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.DoEventPropertiesEditionPart_PeriodLowerLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.DoEvent.Properties.periodLower, RealtimestatechartViewsRepository.FORM_KIND));
		periodLower = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		periodLower.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		...
		periodLower.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DoEventPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.DoEvent.Properties.periodLower, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, periodLower.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.DoEvent.Properties.periodLower, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createPeriodUpperText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.DoEventPropertiesEditionPart_PeriodUpperLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.DoEvent.Properties.periodUpper, RealtimestatechartViewsRepository.FORM_KIND));
		periodUpper = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		periodUpper.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		periodUpper.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DoEventPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.DoEvent.Properties.periodUpper, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, periodUpper.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.DoEvent.Properties.periodUpper, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
