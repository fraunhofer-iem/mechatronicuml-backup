...
public class TransitionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, TransitionPropertiesEditionPart {
		...
		composer = new PartComposer(transitionStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RealtimestatechartViewsRepository.Transition.Properties.clockConstraints) {
					return createClockConstraintsTableComposition(widgetFactory, parent);
				}
				if (key == RealtimestatechartViewsRepository.Transition.Properties.absoluteDeadlines) {
					return createAbsoluteDeadlinesTableComposition(widgetFactory, parent);
				}
				if (key == RealtimestatechartViewsRepository.Transition.Properties.blockable) {
					return createBlockableCheckbox(widgetFactory, parent);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RealtimestatechartMessages.TransitionPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPriorityText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.TransitionPropertiesEditionPart_PriorityLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Transition.Properties.priority, RealtimestatechartViewsRepository.FORM_KIND));
		...
		priority.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.priority, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, priority.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.priority, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTargetFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.TransitionPropertiesEditionPart_TargetLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Transition.Properties.target, RealtimestatechartViewsRepository.FORM_KIND));
		target = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Transition.Properties.target, RealtimestatechartViewsRepository.FORM_KIND));
		...
		target.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTarget()));
			}

		});
		target.setID(RealtimestatechartViewsRepository.Transition.Properties.target);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.target, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSourceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.TransitionPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Transition.Properties.source, RealtimestatechartViewsRepository.FORM_KIND));
		source = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Transition.Properties.source, RealtimestatechartViewsRepository.FORM_KIND));
		...
		source.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSource()));
			}

		});
		source.setID(RealtimestatechartViewsRepository.Transition.Properties.source);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.source, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createStatechartFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.TransitionPropertiesEditionPart_StatechartLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Transition.Properties.statechart, RealtimestatechartViewsRepository.FORM_KIND));
		statechart = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Transition.Properties.statechart, RealtimestatechartViewsRepository.FORM_KIND));
		...
		statechart.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.statechart, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStatechart()));
			}

		});
		statechart.setID(RealtimestatechartViewsRepository.Transition.Properties.statechart);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.statechart, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createClockResetsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clockResets.setHelpText(propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.clockResets, RealtimestatechartViewsRepository.FORM_KIND));
		...
		this.clockResets.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockResets, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"clockResets", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockResets,
	...
	protected void moveClockResets(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockResets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		clockResets.refresh();
	}
	...
	protected void removeFromClockResets(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockResets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		clockResets.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createClockConstraintsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.clockConstraints = new ReferencesTable(RealtimestatechartMessages.TransitionPropertiesEditionPart_ClockConstraintsLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockConstraints, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				clockConstraints.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockConstraints, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				clockConstraints.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockConstraints, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				clockConstraints.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockConstraints, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				clockConstraints.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.clockConstraints.setHelpText(propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.clockConstraints, RealtimestatechartViewsRepository.FORM_KIND));
		this.clockConstraints.createControls(parent, widgetFactory);
		this.clockConstraints.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.clockConstraints, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createAbsoluteDeadlinesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.absoluteDeadlines = new ReferencesTable(RealtimestatechartMessages.TransitionPropertiesEditionPart_AbsoluteDeadlinesLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.absoluteDeadlines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				absoluteDeadlines.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.absoluteDeadlines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				absoluteDeadlines.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.absoluteDeadlines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				absoluteDeadlines.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.absoluteDeadlines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				absoluteDeadlines.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.absoluteDeadlines.setHelpText(propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.absoluteDeadlines, RealtimestatechartViewsRepository.FORM_KIND));
		this.absoluteDeadlines.createControls(parent, widgetFactory);
		this.absoluteDeadlines.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.absoluteDeadlines, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createBlockableCheckbox(FormToolkit widgetFactory, Composite parent) {
		blockable = widgetFactory.createButton(parent, RealtimestatechartMessages.TransitionPropertiesEditionPart_BlockableLabel, SWT.CHECK);
		blockable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.blockable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(blockable.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.blockable, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createEventsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.events = new ReferencesTable(RealtimestatechartMessages.TransitionPropertiesEditionPart_EventsLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				events.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				events.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				events.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				events.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.events.setHelpText(propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Transition.Properties.events, RealtimestatechartViewsRepository.FORM_KIND));
		this.events.createControls(parent, widgetFactory);
		this.events.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransitionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Transition.Properties.events, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
