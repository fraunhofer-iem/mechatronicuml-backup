...
import de.uni_paderborn.fujaba.muml.model.realtimestatechart.components.TransitionPropertiesEditionComponent;
...
public class TransitionPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Transition) 
					&& (RealtimestatechartPackage.eINSTANCE.getTransition() == editingContext.getEObject().eClass());
	}
