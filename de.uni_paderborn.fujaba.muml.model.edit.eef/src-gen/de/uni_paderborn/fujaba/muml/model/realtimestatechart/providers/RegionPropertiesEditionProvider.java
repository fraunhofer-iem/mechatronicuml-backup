...
import de.uni_paderborn.fujaba.muml.model.realtimestatechart.components.RegionPropertiesEditionComponent;
...
public class RegionPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Region) 
					&& (RealtimestatechartPackage.eINSTANCE.getRegion() == editingContext.getEObject().eClass());
	}
