...
public class MessagePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MessagePropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		SWTUtils.createPartLabel(parent, RealtimestatechartMessages.MessagePropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Message.Properties.comment, RealtimestatechartViewsRepository.SWT_KIND));
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, RealtimestatechartViewsRepository.Message.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Message.Properties.comment, RealtimestatechartViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCalleeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, RealtimestatechartMessages.MessagePropertiesEditionPart_CalleeLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Message.Properties.callee, RealtimestatechartViewsRepository.SWT_KIND));
		callee = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Message.Properties.callee, RealtimestatechartViewsRepository.SWT_KIND));
		...
		callee.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, RealtimestatechartViewsRepository.Message.Properties.callee, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getCallee()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Message.Properties.callee, RealtimestatechartViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
