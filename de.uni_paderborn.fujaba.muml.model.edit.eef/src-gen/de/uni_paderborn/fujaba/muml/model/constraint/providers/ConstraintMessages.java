 ...
 * 
 */
public class ConstraintMessages extends NLS {
	
	private static final String BUNDLE_NAME = "de.uni_paderborn.fujaba.muml.model.constraint.providers.constraintMessages"; //$NON-NLS-1$

	
	public static String TextualConstraintPropertiesEditionPart_PropertiesGroupLabel;

	
	public static String TextualConstraint_ReadOnly;

	
	public static String TextualConstraint_Part_Title;

	
	public static String TextualConstraintPropertiesEditionPart_CorrectnessLabel;

	
	public static String TextualConstraintPropertiesEditionPart_BackgroundLabel;

	
	public static String TextualConstraintPropertiesEditionPart_ConstrainableElementLabel;
...
// End of user code
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, ConstraintMessages.class);
	}
