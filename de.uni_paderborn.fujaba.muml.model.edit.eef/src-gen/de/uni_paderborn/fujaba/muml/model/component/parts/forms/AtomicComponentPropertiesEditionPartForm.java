 ...
 * 
 */
public class AtomicComponentPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, AtomicComponentPropertiesEditionPart {
	 ...
	 * 
	 */
	public AtomicComponentPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(atomicComponentStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ComponentViewsRepository.AtomicComponent.Properties.referencingComponentParts) {
					return createReferencingComponentPartsReferencesTable(widgetFactory, parent);
				}
				if (key == ComponentViewsRepository.AtomicComponent.Properties.componentType) {
					return createComponentTypeEMFComboViewer(widgetFactory, parent);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.AtomicComponentPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ComponentMessages.AtomicComponentPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.AtomicComponent.Properties.name, ComponentViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.AtomicComponent.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ComponentMessages.AtomicComponentPropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.AtomicComponent.Properties.comment, ComponentViewsRepository.FORM_KIND));
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.AtomicComponent.Properties.comment, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createReferencingComponentPartsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.referencingComponentParts.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.AtomicComponent.Properties.referencingComponentParts, ComponentViewsRepository.FORM_KIND));
		this.referencingComponentParts.createControls(parent, widgetFactory);
		this.referencingComponentParts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.referencingComponentParts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"referencingComponentParts", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.referencingComponentParts,
	...
	protected void moveReferencingComponentParts(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.referencingComponentParts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		referencingComponentParts.refresh();
	}
	...
	protected void removeFromReferencingComponentParts(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.referencingComponentParts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		referencingComponentParts.refresh();
	}
	...
	protected Composite createComponentTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ComponentMessages.AtomicComponentPropertiesEditionPart_ComponentTypeLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.AtomicComponent.Properties.componentType, ComponentViewsRepository.FORM_KIND));
		...
		componentType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.componentType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getComponentType()));
			}

		});
		componentType.setID(ComponentViewsRepository.AtomicComponent.Properties.componentType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.AtomicComponent.Properties.componentType, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createBehaviorFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ComponentMessages.AtomicComponentPropertiesEditionPart_BehaviorLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.AtomicComponent.Properties.behavior, ComponentViewsRepository.FORM_KIND));
		behavior = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.AtomicComponent.Properties.behavior, ComponentViewsRepository.FORM_KIND));
		...
		behavior.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AtomicComponentPropertiesEditionPartForm.this, ComponentViewsRepository.AtomicComponent.Properties.behavior, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getBehavior()));
			}

		});
		behavior.setID(ComponentViewsRepository.AtomicComponent.Properties.behavior);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.AtomicComponent.Properties.behavior, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.component.parts.AtomicComponentPropertiesEditionPart#initComponentType(Object input, Enumerator current)
	 */
