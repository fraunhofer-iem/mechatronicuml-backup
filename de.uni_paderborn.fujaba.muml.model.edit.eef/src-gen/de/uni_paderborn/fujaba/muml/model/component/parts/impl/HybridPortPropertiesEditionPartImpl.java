 ...
 * 
 */
public class HybridPortPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, HybridPortPropertiesEditionPart {
	 ...
	 * 
	 */
	public HybridPortPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ComponentMessages.HybridPortPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.name, ComponentViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.name, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCommentText(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.comment, ComponentViewsRepository.SWT_KIND));
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.comment, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createIncomingConnectorsAdvancedReferencesTable(Composite parent) {
		...
		this.incomingConnectors.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.incomingConnectors, ComponentViewsRepository.SWT_KIND));
		...
		this.incomingConnectors.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.incomingConnectors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"incomingConnectors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.incomingConnectors,
	...
	protected void moveIncomingConnectors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.incomingConnectors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incomingConnectors.refresh();
	}
	...
	protected void removeFromIncomingConnectors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.incomingConnectors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incomingConnectors.refresh();
	}
	...
	protected Composite createOutgoingConnectorsAdvancedReferencesTable(Composite parent) {
		...
		this.outgoingConnectors.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.outgoingConnectors, ComponentViewsRepository.SWT_KIND));
		this.outgoingConnectors.createControls(parent);
		this.outgoingConnectors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.outgoingConnectors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutgoingConnectors() {
		...
		"outgoingConnectors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.outgoingConnectors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutgoingConnectors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.outgoingConnectors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outgoingConnectors.refresh();
	}
	...
	protected void removeFromOutgoingConnectors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.outgoingConnectors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outgoingConnectors.refresh();
	}
	...
	protected Composite createComponentFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_ComponentLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.component_, ComponentViewsRepository.SWT_KIND));
		component = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.component_, ComponentViewsRepository.SWT_KIND));
		...
		component.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.component_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getComponent()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.component_, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createBehaviorFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_BehaviorLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.behavior, ComponentViewsRepository.SWT_KIND));
		behavior = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.behavior, ComponentViewsRepository.SWT_KIND));
		...
		behavior.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.behavior, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getBehavior()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.behavior, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRefinesFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_RefinesLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.refines, ComponentViewsRepository.SWT_KIND));
		refines = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.refines, ComponentViewsRepository.SWT_KIND));
		...
		refines.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.refines, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRefines()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.refines, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSenderMessageInterfaceFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_SenderMessageInterfaceLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.senderMessageInterface, ComponentViewsRepository.SWT_KIND));
		senderMessageInterface = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.senderMessageInterface, ComponentViewsRepository.SWT_KIND));
		...
		senderMessageInterface.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.senderMessageInterface, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSenderMessageInterface()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.senderMessageInterface, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createReceiverMessageInterfaceFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_ReceiverMessageInterfaceLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.receiverMessageInterface, ComponentViewsRepository.SWT_KIND));
		receiverMessageInterface = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.receiverMessageInterface, ComponentViewsRepository.SWT_KIND));
		...
		receiverMessageInterface.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.receiverMessageInterface, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getReceiverMessageInterface()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.receiverMessageInterface, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createAdaptationBehaviorFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_AdaptationBehaviorLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.adaptationBehavior, ComponentViewsRepository.SWT_KIND));
		adaptationBehavior = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.adaptationBehavior, ComponentViewsRepository.SWT_KIND));
		...
		adaptationBehavior.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.adaptationBehavior, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getAdaptationBehavior()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.adaptationBehavior, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRoleAndAdaptationBehaviorFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_RoleAndAdaptationBehaviorLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.roleAndAdaptationBehavior, ComponentViewsRepository.SWT_KIND));
		roleAndAdaptationBehavior = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.roleAndAdaptationBehavior, ComponentViewsRepository.SWT_KIND));
		...
		roleAndAdaptationBehavior.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.roleAndAdaptationBehavior, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRoleAndAdaptationBehavior()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.roleAndAdaptationBehavior, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createKindEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_KindLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.kind, ComponentViewsRepository.SWT_KIND));
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.kind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKind()));
			}

		});
		kind.setID(ComponentViewsRepository.HybridPort.Properties.kind);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.kind, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ComponentMessages.HybridPortPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.type, ComponentViewsRepository.SWT_KIND));
		type = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.HybridPort.Properties.type, ComponentViewsRepository.SWT_KIND));
		type.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		type.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HybridPortPropertiesEditionPartImpl.this, ComponentViewsRepository.HybridPort.Properties.type, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.HybridPort.Properties.type, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.component.parts.HybridPortPropertiesEditionPart#initKind(EEnum eenum, Enumerator current)
	 */
