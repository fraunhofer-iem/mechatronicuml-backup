 ...
 * 
 */
public class StructuredComponentPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, StructuredComponentPropertiesEditionPart {
	 ...
	 * 
	 */
	public StructuredComponentPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.StructuredComponentPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ComponentMessages.StructuredComponentPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.StructuredComponent.Properties.name, ComponentViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StructuredComponentPropertiesEditionPartForm.this, ComponentViewsRepository.StructuredComponent.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.StructuredComponent.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ComponentMessages.StructuredComponentPropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(ComponentViewsRepository.StructuredComponent.Properties.comment, ComponentViewsRepository.FORM_KIND));
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StructuredComponentPropertiesEditionPartForm.this, ComponentViewsRepository.StructuredComponent.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.StructuredComponent.Properties.comment, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createReferencingComponentPartsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.referencingComponentParts.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.StructuredComponent.Properties.referencingComponentParts, ComponentViewsRepository.FORM_KIND));
		...
		this.referencingComponentParts.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StructuredComponentPropertiesEditionPartForm.this, ComponentViewsRepository.StructuredComponent.Properties.referencingComponentParts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"referencingComponentParts", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StructuredComponentPropertiesEditionPartForm.this, ComponentViewsRepository.StructuredComponent.Properties.referencingComponentParts,
	...
	protected void moveReferencingComponentParts(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StructuredComponentPropertiesEditionPartForm.this, ComponentViewsRepository.StructuredComponent.Properties.referencingComponentParts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		referencingComponentParts.refresh();
	}
	...
	protected void removeFromReferencingComponentParts(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StructuredComponentPropertiesEditionPartForm.this, ComponentViewsRepository.StructuredComponent.Properties.referencingComponentParts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		referencingComponentParts.refresh();
	}
	...
	protected Composite createComponentTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		componentType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StructuredComponentPropertiesEditionPartForm.this, ComponentViewsRepository.StructuredComponent.Properties.componentType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getComponentType()));
			}

		});
		componentType.setID(ComponentViewsRepository.StructuredComponent.Properties.componentType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.StructuredComponent.Properties.componentType, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
