...
public class ModifyTriggerEventPage2 extends WizardPage{
	...
	public ModifyTriggerEventPage2(String pageName)
	{
		super(pageName);
	}
	...
	public void setVisible(boolean visible) {
		...
		if (visible)
    	{
			...
			parameterLViewer.setInput(((ModifyTriggerEventWizard)getWizard()).getSelectedMessageType());
    	}
		...
		CreateElementRequest request = new CreateElementRequest(((ModifyTriggerEventWizard)getWizard()).getSelectedTransition(),
				RealtimeStatechartElementTypes.Action_3024);
					...
					TriggerEventCreateCommand command = new TriggerEventCreateCommand(request, 
							...
							((ModifyTriggerEventWizard)getWizard()).getSelectedMessageType());
