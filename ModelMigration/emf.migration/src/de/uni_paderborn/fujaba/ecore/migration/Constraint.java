 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.ecore.migration.Constraint#getEmbeddingCreateClass <em>Embedding Create Class</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.ecore.migration.MigrationPackage#getConstraint()
 * @model
 * @generated
 */
public interface Constraint extends OclExpression {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.ecore.migration.CreateClass#getConstraints <em>Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.ecore.migration.MigrationPackage#getConstraint_EmbeddingCreateClass()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.ecore.migration.Constraint#getEmbeddingCreateClass <em>Embedding Create Class</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
