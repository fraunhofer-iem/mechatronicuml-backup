 ...
 * <ul>
 *   <li>{@link migration.CreateClass#getTargetClass <em>Target Class</em>}</li>
 *   <li>{@link migration.CreateClass#getFeatureInitializers <em>Feature Initializers</em>}</li>
 *   <li>{@link migration.CreateClass#getConstraints <em>Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @see migration.MigrationPackage#getCreateClass()
 * @model abstract="true"
...
public interface CreateClass extends EObject {
	 ...
	 * @see migration.MigrationPackage#getCreateClass_TargetClass()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link migration.CreateClass#getTargetClass <em>Target Class</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link migration.FeatureInitializer}.
	 * It is bidirectional and its opposite is '{@link migration.FeatureInitializer#getEmbeddingCreateClass <em>Embedding Create Class</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see migration.MigrationPackage#getCreateClass_FeatureInitializers()
	 ...
	 * The list contents are of type {@link migration.Constraint}.
	 * It is bidirectional and its opposite is '{@link migration.Constraint#getEmbeddingCreateClass <em>Embedding Create Class</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see migration.MigrationPackage#getCreateClass_Constraints()
