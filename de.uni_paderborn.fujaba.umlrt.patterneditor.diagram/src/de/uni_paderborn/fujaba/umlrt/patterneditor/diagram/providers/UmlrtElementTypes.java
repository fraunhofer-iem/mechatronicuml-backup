...
public class UmlrtElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType ModelElementCategory_1000 = getElementType("de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.ModelElementCategory_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType CoordinationPattern_2004 = getElementType("de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.CoordinationPattern_2004"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Role_2005 = getElementType("de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.Role_2005"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType TextualConstraint_2006 = getElementType("de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.TextualConstraint_2006"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType RoleConnector_4004 = getElementType("de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.RoleConnector_4004"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType RolePattern_4005 = getElementType("de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.RolePattern_4005"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ConstrainableElementConstraint_4006 = getElementType("de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.ConstrainableElementConstraint_4006"); //$NON-NLS-1$
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(TextualConstraint_2006);
			KNOWN_ELEMENT_TYPES.add(RoleConnector_4004);
			KNOWN_ELEMENT_TYPES.add(RolePattern_4005);
