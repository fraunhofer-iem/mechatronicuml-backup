...
public class PatternBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(
					de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.helpers.PatternBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(
				de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.helpers.PatternBaseEditHelper.CONTEXT_ELEMENT_TYPE,
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.providers.PatternElementTypes
