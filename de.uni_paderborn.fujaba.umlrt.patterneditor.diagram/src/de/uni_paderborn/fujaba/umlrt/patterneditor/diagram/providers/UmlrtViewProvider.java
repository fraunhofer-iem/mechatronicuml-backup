...
public class UmlrtViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.part.UmlrtVisualIDRegistry
		...
		return de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.parts.CoordinationPatternEditPart.VISUAL_ID == visualID
				|| de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.parts.RoleEditPart.VISUAL_ID == visualID
				|| de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.parts.TextualConstraintEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.parts.PatternDiagramEditPart.MODEL_ID);
	...
	public Node createCoordinationPattern_2004(EObject domainElement,
		...
		node.setType(de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.part.UmlrtVisualIDRegistry
	...
	public Edge createRoleConnector_4004(EObject domainElement,
		...
		edge.setType(de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.part.UmlrtVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.parts.PatternDiagramEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", de.uni_paderborn.fujaba.umlrt.patterneditor.diagram.edit.parts.PatternDiagramEditPart.MODEL_ID); //$NON-NLS-1$
