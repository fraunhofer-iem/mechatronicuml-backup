...
public class MumlinstanceVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
		...
		if (de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.MODEL_ID
				.equals(containerModelID)) {
			containerVisualID = de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
					.getVisualID(containerView);
		} else {
			if (containerView instanceof Diagram) {
				containerVisualID = de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.VISUAL_ID;
			} else {
				return -1;
			}
		}
		...
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.VISUAL_ID:
			...
			if (de.uni_paderborn.fujaba.muml.model.constraint.ConstraintPackage.eINSTANCE
					.getTextualConstraint().isSuperTypeOf(
							domainElement.eClass())) {
				return de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.TextualConstraintEditPart.VISUAL_ID;
			}
			break;
		}
		return -1;
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.VISUAL_ID:
			...
			if (de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.TextualConstraintEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
