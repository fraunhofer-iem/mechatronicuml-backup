 ...
 * @generated
 */
public class UmlrtDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	private static UmlrtDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.UmlrtDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.policies.UmlrtBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.patterneditor.diagram.expressions.UmlrtOCLFactory oclFactory;

	/**
	 * @generated
	 */
	public UmlrtDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static UmlrtDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.UmlrtDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.UmlrtDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.policies.UmlrtBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.policies.UmlrtBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.patterneditor.diagram.expressions.UmlrtOCLFactory getUmlrtOCLFactory() {
		return oclFactory;
	}
	...
	public void setUmlrtOCLFactory(
			de.uni_paderborn.fujaba.muml.patterneditor.diagram.expressions.UmlrtOCLFactory f) {
		this.oclFactory = f;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, UmlrtDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, UmlrtDiagramEditorPlugin.ID,
