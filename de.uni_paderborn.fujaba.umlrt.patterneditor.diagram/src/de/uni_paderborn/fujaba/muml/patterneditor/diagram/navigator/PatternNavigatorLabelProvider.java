...
public class PatternNavigatorLabelProvider extends LabelProvider implements
	...
	public void updateLabel(ViewerLabel label, TreePath elementPath) {
		...
		if (element instanceof de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorItem
				&& !isOwnView(((de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorItem) element)
						.getView())) {
			return;
		}
	...
	public Image getImage(Object element) {
		if (element instanceof de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorGroup) {
			de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorGroup group = (de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorGroup) element;
			return de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.PatternDiagramEditorPlugin
					.getInstance().getBundledImage(group.getIcon());
		}

		if (element instanceof de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorItem) {
			de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorItem navigatorItem = (de.uni_paderborn.fujaba.muml.patterneditor.diagram.navigator.PatternNavigatorItem) element;
	...
	public Image getImage(View view) {
		...
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.TextualConstraintEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///de/uni_paderborn/fujaba/muml/model/constraint?TextualConstraint", de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.TextualConstraint_2006); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.RolePatternEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http:///de/uni_paderborn/fujaba/muml/model/pattern?Role?pattern", de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.RolePattern_4005); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.ConstrainableElementConstraintEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http:///de/uni_paderborn/fujaba/muml/model/core?ConstrainableElement?constraint", de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.ConstrainableElementConstraint_4006); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.RoleConnectorEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http:///de/uni_paderborn/fujaba/muml/model/pattern?RoleConnector", de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.RoleConnector_4004); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.CoordinationPatternEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///de/uni_paderborn/fujaba/muml/model/pattern?CoordinationPattern", de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.CoordinationPattern_2004); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.RoleEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///de/uni_paderborn/fujaba/muml/model/pattern?Role", de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.Role_2005); //$NON-NLS-1$
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Diagram?http:///de/uni_paderborn/fujaba/umlrt/modelinstance?ModelElementCategory", de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.ModelElementCategory_1000); //$NON-NLS-1$
		}
	...
	private Image getImage(String key, IElementType elementType) {
		ImageRegistry imageRegistry = de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.PatternDiagramEditorPlugin
				.getInstance().getImageRegistry();
		Image image = imageRegistry.get(key);
		if (image == null
				&& elementType != null
				&& de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes
						.isKnownElementType(elementType)) {
			image = de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes
	...
	private String getCoordinationPattern_2004Text(View view) {
		IParser parser = de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.PatternParserProvider
				.getParser(
						de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.CoordinationPattern_2004,
	...
	private String getRole_2005Text(View view) {
		IParser parser = de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.PatternParserProvider
				.getParser(
						de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes.Role_2005,
						view.getElement() != null ? view.getElement() : view,
						de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
