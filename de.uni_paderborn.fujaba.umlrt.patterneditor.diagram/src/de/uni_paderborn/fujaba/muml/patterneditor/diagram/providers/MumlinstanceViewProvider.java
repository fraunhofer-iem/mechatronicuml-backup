...
public class MumlinstanceViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
					.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.MumlinstanceElementTypes
		...
		return de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.CoordinationPatternEditPart.VISUAL_ID == visualID
				|| de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.RoleEditPart.VISUAL_ID == visualID
				|| de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.TextualConstraintEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.TextualConstraintEditPart.VISUAL_ID:
			return createTextualConstraint_2006(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.RolePatternEditPart.VISUAL_ID:
			return createRolePattern_4005(containerView, index, persisted,
					preferencesHint);
	...
	public Node createCoordinationPattern_2004(EObject domainElement,
		...
		node.setType(de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createTextualConstraint_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	public Edge createRoleConnector_4004(EObject domainElement,
		...
		edge.setType(de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createRolePattern_4005(View containerView, int index,
	...
	private void stampShortcut(View containerView, Node target) {
		if (!de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.parts.PatternDiagramEditPart.MODEL_ID); //$NON-NLS-1$
