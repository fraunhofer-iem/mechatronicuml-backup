 ...
 * @generated
 */
public class PatternDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "de.uni_paderborn.fujaba.muml.patterneditor.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static PatternDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.policies.MumlinstanceBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.patterneditor.diagram.expressions.MumlinstanceOCLFactory oclFactory;
	 ...
	 * @generated
	 */
	public static PatternDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.MumlinstanceDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.policies.MumlinstanceBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.policies.MumlinstanceBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.patterneditor.diagram.expressions.MumlinstanceOCLFactory getMumlinstanceOCLFactory() {
		return oclFactory;
	}
	...
	public void setMumlinstanceOCLFactory(
			de.uni_paderborn.fujaba.muml.patterneditor.diagram.expressions.MumlinstanceOCLFactory f) {
		this.oclFactory = f;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, PatternDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, PatternDiagramEditorPlugin.ID,
