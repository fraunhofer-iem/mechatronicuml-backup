 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.psm.allocation.ilp.impl.ExpressionImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression {
	...
	protected EClass eStaticClass() {
		return IlpPackage.Literals.EXPRESSION;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IlpPackage.EXPRESSION__COMMENT, oldComment, comment));
	}
