 ...
 * </copyright>
 */
package de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.sheet;
...
public class ComponentSDDSheetLabelProvider extends BaseLabelProvider implements
	...
	public String getText(Object element) {
		...
		if (element instanceof de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.navigator.ComponentSDDNavigatorGroup) {
			return ((de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.navigator.ComponentSDDNavigatorGroup) element)
					.getGroupName();
		}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.part.ComponentSDDVisualIDRegistry
					.getVisualID(view);
			IElementType etype = de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.providers.ComponentSDDElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
