...
public class InitialNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.edit.policies.InitialNodeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CSDDInitialNodeFigure();
	}

	/**
	 * @generated
	 */
	public CSDDInitialNodeFigure getPrimaryShape() {
		return (CSDDInitialNodeFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.edit.parts.WrappingLabel9EditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.edit.parts.WrappingLabel9EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureInitialNodeCSDDNameLabel());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.edit.parts.WrappingLabel10EditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.edit.parts.WrappingLabel10EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.part.ComponentSDDVisualIDRegistry
				.getType(de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.edit.parts.WrappingLabel9EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class CSDDInitialNodeFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureInitialNodeInvariantLabel;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureInitialNodeCSDDNameLabel;

		/**
		 * @generated
		 */
		public CSDDInitialNodeFigure() {
		...
		private void createContents() {
			...
			fFigureInitialNodeInvariantLabel = new WrappingLabel();

			fFigureInitialNodeInvariantLabel.setText("");

			GridData constraintFFigureInitialNodeInvariantLabel = new GridData();
			constraintFFigureInitialNodeInvariantLabel.verticalAlignment = GridData.BEGINNING;
			constraintFFigureInitialNodeInvariantLabel.horizontalAlignment = GridData.CENTER;
			constraintFFigureInitialNodeInvariantLabel.horizontalIndent = 0;
			constraintFFigureInitialNodeInvariantLabel.horizontalSpan = 1;
			...
			fFigureInitialNodeCSDDNameLabel.setText("");

			GridData constraintFFigureInitialNodeCSDDNameLabel = new GridData();
			constraintFFigureInitialNodeCSDDNameLabel.verticalAlignment = GridData.CENTER;
			constraintFFigureInitialNodeCSDDNameLabel.horizontalAlignment = GridData.CENTER;
			constraintFFigureInitialNodeCSDDNameLabel.horizontalIndent = 0;
			constraintFFigureInitialNodeCSDDNameLabel.horizontalSpan = 1;
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureInitialNodeInvariantLabel() {
			return fFigureInitialNodeInvariantLabel;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureInitialNodeCSDDNameLabel() {
			return fFigureInitialNodeCSDDNameLabel;
		}
