...
public class ComponentSDDDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.part.ComponentSDDDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.part.ValidateAction(
				page);
