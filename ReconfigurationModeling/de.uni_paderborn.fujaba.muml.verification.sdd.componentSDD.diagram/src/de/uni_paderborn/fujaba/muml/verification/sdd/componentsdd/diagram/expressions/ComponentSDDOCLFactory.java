...
public class ComponentSDDOCLFactory {
	...
	protected ComponentSDDOCLFactory() {
		this.expressions = new de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.expressions.ComponentSDDAbstractExpression[22];
		this.expressionBodies = new String[] {
				...
				"if\r\n\tself.bindingState = storydiagrams::patterns::BindingState::BOUND\r\nthen\r\n\t\'\'\r\nelse\r\n\t\':\'+self.dataType.name\r\nendif", //$NON-NLS-1$
				"let\r\n\texpressions : Collection(componentstorypattern::TriggerEmbeddedComponentExpression) = self.triggerEmbeddedComponentExpressions->select(oclIsTypeOf(componentsdd::EvaluateComponentSDDExpression))\r\nin\r\n\tif\r\n\t\texpressions->isEmpty()\r\n\tthen\r\n\t\t\'\'\r\n\telse\r\n\t\texpressions->iterate(t : componentstorypattern::TriggerEmbeddedComponentExpression; s : String = \'[\' | s+t.oclAsType(componentsdd::EvaluateComponentSDDExpression).componentSDD.name+\' \')+\']\'\r\n\tendif", //$NON-NLS-1$
