...
public class ReconfigurableStructuredComponentItemSemanticEditPolicy
	...
	public ReconfigurableStructuredComponentItemSemanticEditPolicy() {
		super(
				org.muml.reconfiguration.ui.providers.ReconfigurationElementTypes.ReconfigurableStructuredComponent_2076);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (org.muml.reconfiguration.ui.providers.ReconfigurationElementTypes.DiscretePort_3010 == req
				.getElementType()) {
			return getGEFWrapper(new org.muml.pim.component.diagram.edit.commands.DiscretePortCreateCommand(
					req));
		}
		...
		if (org.muml.reconfiguration.ui.providers.ReconfigurationElementTypes.ReconfigurationExecutionPort_3077== req
				.getElementType()) {
			return getGEFWrapper(new org.muml.reconfiguration.ui.edit.commands.ReconfigurationExecutionPortCreateCommand(
					req));
		}
		if (org.muml.reconfiguration.ui.providers.ReconfigurationElementTypes.ReconfigurationMessagePort_3076 == req
				.getElementType()) {
			return getGEFWrapper(new org.muml.reconfiguration.ui.edit.commands.ReconfigurationMessagePortCreateCommand(
					req));
		}
		if (org.muml.reconfiguration.ui.providers.ReconfigurationElementTypes.BroadcastPort_3078 == req
				.getElementType()) {
			return getGEFWrapper(new org.muml.reconfiguration.ui.edit.commands.BroadcastPortCreateCommand(
					req));
		}
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case org.muml.pim.component.diagram.edit.parts.CoordinationProtocolPartEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							Edge incomingLink = (Edge) it.next();
							if (org.muml.pim.component.diagram.part.MumlVisualIDRegistry
									.getVisualID(incomingLink) == org.muml.pim.component.diagram.edit.parts.PortPartCoordinationProtocolPartEditPart.VISUAL_ID) {
