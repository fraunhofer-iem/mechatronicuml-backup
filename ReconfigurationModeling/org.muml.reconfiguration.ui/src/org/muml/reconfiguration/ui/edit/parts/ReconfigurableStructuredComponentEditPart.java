...
public class ReconfigurableStructuredComponentEditPart extends
	...
	protected void createDefaultEditPolicies() {
		installEditPolicy(
				...
				new CreationEditPolicyWithCustomReparent(
						org.muml.reconfiguration.ui.part.ReconfigurationVisualIDRegistry.TYPED_INSTANCE));
		super.createDefaultEditPolicies();
		installEditPolicy(
				EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.reconfiguration.ui.edit.policies.ReconfigurableStructuredComponentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new org.muml.reconfiguration.ui.edit.policies.ReconfigurableStructuredComponentCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.ReconfigurableStructuredComponentCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureChildren();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((org.muml.reconfiguration.ui.edit.parts.ReconfigurableStructuredComponentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.RuleBasedReconfigurationControllerEditPart) {
			IFigure pane = getPrimaryShape().getFigureChildren();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((org.muml.reconfiguration.ui.edit.parts.RuleBasedReconfigurationControllerEditPart) childEditPart)
					.getFigure(), 0);
			return true;
		}
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.ReconfigurationMessagePortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((org.muml.reconfiguration.ui.edit.parts.ReconfigurationMessagePortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.ReconfigurationExecutionPortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((org.muml.reconfiguration.ui.edit.parts.ReconfigurationExecutionPortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.BroadcastPortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((org.muml.reconfiguration.ui.edit.parts.BroadcastPortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.ReconfigurableStructuredComponentCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureChildren();
			pane.remove(((org.muml.reconfiguration.ui.edit.parts.ReconfigurableStructuredComponentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.ReconfigurationMessagePortEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((org.muml.reconfiguration.ui.edit.parts.ReconfigurationMessagePortEditPart) childEditPart)
							.getFigure());
			return true;
		}
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.ReconfigurationExecutionPortEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((org.muml.reconfiguration.ui.edit.parts.ReconfigurationExecutionPortEditPart) childEditPart)
							.getFigure());
			return true;
		}
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.BroadcastPortEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((org.muml.reconfiguration.ui.edit.parts.BroadcastPortEditPart) childEditPart)
							.getFigure());
			return true;
		}
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.RuleBasedReconfigurationControllerEditPart) {
			IFigure pane = getPrimaryShape().getFigureChildren();
			pane.remove(((org.muml.reconfiguration.ui.edit.parts.RuleBasedReconfigurationControllerEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof org.muml.reconfiguration.ui.edit.parts.ReconfigurableStructuredComponentCompartmentEditPart) {
			return getPrimaryShape().getFigureChildren();
		}
		if (editPart instanceof org.muml.reconfiguration.ui.edit.parts.RuleBasedReconfigurationControllerEditPart) {
			return getPrimaryShape().getFigureChildren();
		}
