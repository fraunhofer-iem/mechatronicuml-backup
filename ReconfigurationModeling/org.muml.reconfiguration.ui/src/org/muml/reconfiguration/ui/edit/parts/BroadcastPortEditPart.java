 ...
 * @generated
 */
public class BroadcastPortEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public BroadcastPortEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.muml.pim.component.diagram.edit.policies.DiscretePortItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(
				org.muml.pim.common.edit.policies.EditPolicyRoles.PORT_VISUALIZATION_ROLE,
				new org.muml.reconfiguration.ui.edit.policies.CustomPortTypeEditPolicy());
		installEditPolicy(
...
//		primaryShape.add(label);
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		if (relationshipType == org.muml.pim.component.diagram.providers.MumlElementTypes.AssemblyConnector_4001) {
			...
			types.add(org.muml.pim.component.diagram.providers.MumlElementTypes.PortPart_3022);
			types.add(org.muml.reconfiguration.ui.providers.ReconfigurationElementTypes.BroadcastPort_3078);
