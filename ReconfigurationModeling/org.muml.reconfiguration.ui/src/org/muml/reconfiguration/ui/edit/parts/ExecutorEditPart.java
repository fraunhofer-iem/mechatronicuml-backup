...
public class ExecutorEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ExecutorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		// super.createDefaultEditPolicies();
		 ...
		 new
		 org.muml.reconfiguration.ui.edit.policies.ExecutorItemSemanticEditPolicy());
		// installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
		// new DragDropEditPolicy());
		// //TODO
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new org.muml.reconfiguration.ui.edit.policies.ExecutorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.InternalReconfigurationCommunicationPortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((org.muml.reconfiguration.ui.edit.parts.InternalReconfigurationCommunicationPortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.reconfiguration.ui.edit.parts.InternalReconfigurationCommunicationPortEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((org.muml.reconfiguration.ui.edit.parts.InternalReconfigurationCommunicationPortEditPart) childEditPart)
							.getFigure());
			return true;
		}
	 ...
	 * @generated
	 */
	public class ExecutorFigure extends RectangleFigure {
