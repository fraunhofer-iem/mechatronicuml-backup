 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.reconfiguration.expression.impl.ActivityCallExpressionImpl#getOwnedParameterBindings <em>Owned Parameter Bindings</em>}</li>
 *   <li>{@link org.muml.reconfiguration.expression.impl.ActivityCallExpressionImpl#getCallee <em>Callee</em>}</li>
 *   <li>{@link org.muml.reconfiguration.expression.impl.ActivityCallExpressionImpl#getActivity <em>Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityCallExpressionImpl extends ExpressionImpl implements ActivityCallExpression {
	...
	public EList<ParameterBinding> getOwnedParameterBindings() {
		if (ownedParameterBindings == null) {
			ownedParameterBindings = new EObjectContainmentWithInverseEList<ParameterBinding>(ParameterBinding.class, this, ExpressionPackage.ACTIVITY_CALL_EXPRESSION__OWNED_PARAMETER_BINDINGS, CallsPackage.PARAMETER_BINDING__INVOCATION);
		}
