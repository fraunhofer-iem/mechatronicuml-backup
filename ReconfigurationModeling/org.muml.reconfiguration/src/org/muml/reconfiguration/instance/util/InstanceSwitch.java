...
public class InstanceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InstancePackage.RECONFIGURABLE_COMPONENT_INSTANCE: {
			...
			case InstancePackage.RECONFIGURATION_PORT_INSTANCE: {
			...
			case InstancePackage.RECONFIGURATION_MESSAGE_PORT_INSTANCE: {
			...
			case InstancePackage.RECONFIGURATION_EXECUTION_PORT_INSTANCE: {
			...
			case InstancePackage.INTERNAL_RECONFIGURATION_COMMUNICATION_PORT_INSTANCE: {
			...
			case InstancePackage.RECONFIGURATION_CONTROLLER_INSTANCE: {
			...
			case InstancePackage.CONTROLLER_INSTANCE: {
			...
			case InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE: {
			...
			case InstancePackage.MANAGER_INSTANCE: {
			...
			case InstancePackage.EXECUTOR_INSTANCE: {
			...
			case InstancePackage.RECONFIGURABLE_ATOMIC_COMPONENT_INSTANCE: {
			...
			case InstancePackage.RECONFIGURABLE_STRUCTURED_COMPONENT_INSTANCE: {
