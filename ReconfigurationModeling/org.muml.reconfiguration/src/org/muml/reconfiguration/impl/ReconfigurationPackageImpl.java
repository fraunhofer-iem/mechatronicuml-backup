		...
		addAnnotation
		  (reconfigurationPortEClass, 
		   ...
		   new String[] {
			 ...
			 "ReconfigurationPortAtStructuredComponentHasNoBehavior", "(not self.component.oclIsUndefined() and self.component.oclIsTypeOf(pim::component::StructuredComponent))\r\n\timplies self.behavior.oclIsUndefined()"
		   });	
		addAnnotation
		  (reconfigurationMessagePortInterfaceEntryEClass, 
		   source, 
