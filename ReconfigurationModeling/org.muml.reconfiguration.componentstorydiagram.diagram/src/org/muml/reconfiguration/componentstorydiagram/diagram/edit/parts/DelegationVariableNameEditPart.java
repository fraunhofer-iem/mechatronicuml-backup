 ...
 * @generated
 */
public class DelegationVariableNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ComponentStoryDiagramVisualIDRegistry.getType(
						org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.DelegationVariableNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentStoryDiagramParserProvider.getParser(
					ComponentStoryDiagramElementTypes.DelegationVariable_4005, getParserElement(),
					ComponentStoryDiagramVisualIDRegistry.getType(
							org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.DelegationVariableNameEditPart.VISUAL_ID));
		}
		return parser;
