 ...
 * @generated
 */
public class MultiPortVariableName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				ComponentStoryDiagramVisualIDRegistry.getType(
						org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.MultiPortVariableName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentStoryDiagramParserProvider.getParser(
					ComponentStoryDiagramElementTypes.MultiPortVariable_3019, getParserElement(),
					ComponentStoryDiagramVisualIDRegistry.getType(
							org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.MultiPortVariableName2EditPart.VISUAL_ID));
		}
		return parser;
