...
public class ControllerExchangeNodeControllerExchangeNodeFadingFunctionsCompartmentCanonicalEditPolicy
	...
	*/
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentstorydiagramPackage.eINSTANCE.getControllerExchangeNode_ComponentStoryPattern();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { ComponentStoryPattern2EditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return ComponentStoryPattern2EditPart.VISUAL_ID == ComponentStoryDiagramVisualIDRegistry.getVisualID(view);
	}
