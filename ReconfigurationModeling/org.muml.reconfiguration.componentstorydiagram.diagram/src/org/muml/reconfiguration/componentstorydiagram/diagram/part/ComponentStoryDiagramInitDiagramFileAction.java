 ...
 * @generated
 */
public class ComponentStoryDiagramInitDiagramFileAction extends AbstractCreateDiagramFileCommand {
	...
	*/
		...
		*/
		...
		public Object execute(ExecutionEvent event) throws ExecutionException {
			...
			if (selectedResource instanceof IContainer) {
				...
				String fileName = ComponentStoryDiagramDiagramEditorUtil.getUniqueFileName(filePath,
				...
				EObject model = ComponentstorydiagramFactory.eINSTANCE.createComponentStoryRule();
				resource.getContents().add(model);
				try {
					resource.save(Collections.emptyMap());
				} catch (IOException e) {
					ComponentStoryDiagramDiagramEditorPlugin.getInstance().logError("Could not create child element",
							e);
				}
			}
			return null;
	...
	public String getUniqueFilename(String hint, String extension, IPath filePath) {
		return ComponentStoryDiagramDiagramEditorUtil.getUniqueFileName(filePath, hint, extension);
	}
