 ...
 * @generated
 */
public class ActivityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentStoryDiagramParserProvider.getParser(ComponentStoryDiagramElementTypes.Activity_2003,
					getParserElement(), ComponentStoryDiagramVisualIDRegistry.getType(
							org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.ActivityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
