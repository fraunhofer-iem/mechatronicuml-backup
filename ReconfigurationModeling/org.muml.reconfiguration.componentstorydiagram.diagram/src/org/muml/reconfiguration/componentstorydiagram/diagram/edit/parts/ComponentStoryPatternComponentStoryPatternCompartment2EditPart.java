...
import org.muml.reconfiguration.componentstorydiagram.diagram.edit.policies.ComponentStoryPatternComponentStoryPatternCompartment2CanonicalEditPolicy;
import org.muml.reconfiguration.componentstorydiagram.diagram.edit.policies.ComponentStoryPatternComponentStoryPatternCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComponentStoryPatternComponentStoryPatternCompartment2EditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public ComponentStoryPatternComponentStoryPatternCompartment2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.ComponentStoryPatternComponentStoryPatternCompartment2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ComponentStoryPatternComponentStoryPatternCompartment2CanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ComponentStoryDiagramElementTypes.ComponentVariable_3023) {
				return this;
			}
