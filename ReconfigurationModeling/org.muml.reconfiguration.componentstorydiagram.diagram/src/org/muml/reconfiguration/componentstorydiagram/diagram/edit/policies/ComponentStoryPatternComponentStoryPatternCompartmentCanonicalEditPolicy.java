...
public class ComponentStoryPatternComponentStoryPatternCompartmentCanonicalEditPolicy
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] { org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.ComponentVariableEditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.ComponentVariableEditPart.VISUAL_ID == org.muml.reconfiguration.componentstorydiagram.diagram.part.ComponentStoryDiagramVisualIDRegistry
				.getVisualID(view);
	}
