...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private org.muml.reconfiguration.componentstorydiagram.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new org.muml.reconfiguration.componentstorydiagram.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
