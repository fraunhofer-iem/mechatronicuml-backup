...
public class AssemblyVariableCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (!ComponentStoryDiagramBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateAssemblyVariable_4004(getContainer(), getSource(), getTarget(), sourceView, targetView)) {
			String errorMessage = ComponentStoryDiagramBaseItemSemanticEditPolicy.getLinkConstraints()
					.getErrorAssemblyVariable_4004(getContainer(), getSource(), getTarget(), sourceView, targetView);
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_AssemblyVariable_4004(newElement);
