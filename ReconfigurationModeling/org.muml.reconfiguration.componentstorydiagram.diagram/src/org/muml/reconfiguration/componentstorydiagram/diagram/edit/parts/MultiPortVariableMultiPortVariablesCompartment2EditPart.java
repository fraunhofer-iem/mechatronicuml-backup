...
public class MultiPortVariableMultiPortVariablesCompartment2EditPart extends
	...
	public String getCompartmentName() {
		return org.muml.reconfiguration.componentstorydiagram.diagram.part.Messages.MultiPortVariableMultiPortVariablesCompartment2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.muml.reconfiguration.componentstorydiagram.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartment2ItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new org.muml.reconfiguration.componentstorydiagram.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartment2CanonicalEditPolicy());
		installEditPolicy(
			...
			if (RequestConstants.REQ_CONNECTION_END.equals(request.getType())) {
				for (Object type : ((CreateUnspecifiedTypeConnectionRequest) request)
					...
					if (type instanceof IElementType) {
						...
						if (elementType
								.equals(org.muml.reconfiguration.componentstorydiagram.diagram.providers.ComponentStoryDiagramElementTypes.AssemblyVariable_4004)
								|| elementType
										.equals(org.muml.reconfiguration.componentstorydiagram.diagram.providers.ComponentStoryDiagramElementTypes.DelegationVariable_4005)
								|| elementType
										.equals(org.muml.reconfiguration.componentstorydiagram.diagram.providers.ComponentStoryDiagramElementTypes.MultiPortOrderConstraint_4006))
