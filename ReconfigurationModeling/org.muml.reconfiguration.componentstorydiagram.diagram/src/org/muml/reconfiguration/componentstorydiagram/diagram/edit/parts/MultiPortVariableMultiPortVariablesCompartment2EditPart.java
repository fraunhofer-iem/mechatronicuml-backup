...
import org.muml.reconfiguration.componentstorydiagram.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartment2CanonicalEditPolicy;
import org.muml.reconfiguration.componentstorydiagram.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartment2ItemSemanticEditPolicy;
			...
			if (RequestConstants.REQ_CONNECTION_END.equals(request.getType())) {
				for (Object type : ((CreateUnspecifiedTypeConnectionRequest) request).getElementTypes()) {
					if (type instanceof IElementType) {
						...
						if (elementType.equals(ComponentStoryDiagramElementTypes.AssemblyVariable_4004)
								|| elementType.equals(ComponentStoryDiagramElementTypes.DelegationVariable_4005)
								|| elementType.equals(ComponentStoryDiagramElementTypes.MultiPortOrderConstraint_4006))
