...
public class ComponentStoryPatternComponentStoryPatternCompartmentEditPart
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.part.Messages.ComponentStoryPatternComponentStoryPatternCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.edit.policies.ComponentStoryPatternComponentStoryPatternCompartmentItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.edit.policies.ComponentStoryPatternComponentStoryPatternCompartmentCanonicalEditPolicy());
		installEditPolicy(
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.providers.ComponentStoryDiagramElementTypes.ComponentVariable_3012) {
				return this;
			}
