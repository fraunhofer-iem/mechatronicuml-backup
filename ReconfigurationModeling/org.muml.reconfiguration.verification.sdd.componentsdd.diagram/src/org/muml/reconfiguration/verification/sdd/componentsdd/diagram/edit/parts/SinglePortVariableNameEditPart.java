...
public class SinglePortVariableNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				ComponentSDDVisualIDRegistry.getType(
						org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.parts.SinglePortVariableNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentSDDParserProvider.getParser(ComponentSDDElementTypes.SinglePortVariable_3006,
