...
import org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.SinglePortVariable2ItemSemanticEditPolicy;
...
public class SinglePortVariable2EditPart extends BorderedBorderItemEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SinglePortVariable2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof PortVariableOperator2EditPart
				|| borderItemEditPart instanceof SinglePortVariableNameEditPart
				|| borderItemEditPart instanceof UnderlinedLabel2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ComponentSDDVisualIDRegistry.getType(PortVariableOperator2EditPart.VISUAL_ID));
	}
