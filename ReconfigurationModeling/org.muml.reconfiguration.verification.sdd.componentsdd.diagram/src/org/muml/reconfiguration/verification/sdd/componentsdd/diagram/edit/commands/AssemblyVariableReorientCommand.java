...
public class AssemblyVariableReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		*/
		...
		if (!ComponentSDDBaseItemSemanticEditPolicy.getLinkConstraints().canExistAssemblyVariable_4002(container,
			...
			String errorMessage = ComponentSDDBaseItemSemanticEditPolicy.getLinkConstraints()
					.getErrorAssemblyVariable_4002(container, getNewSource(), target, sourceView, targetView);
	...
	protected boolean canReorientTarget() {
		...
		*/
		...
		if (!ComponentSDDBaseItemSemanticEditPolicy.getLinkConstraints().canExistAssemblyVariable_4002(container,
			...
			String errorMessage = ComponentSDDBaseItemSemanticEditPolicy.getLinkConstraints()
					.getErrorAssemblyVariable_4002(container, source, getNewTarget(), sourceView, targetView);
			ErrorFeedbackEditPolicy.showMessage(sourceView, errorMessage);
			return false;
		}
		return true;
