 ...
 * @generated
 */
public class ComponentSDDModelingAssistantProvider extends ModelingAssistantProvider {
	...
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(Messages.ComponentSDDModelingAssistantProviderMessage);
		dialog.setTitle(Messages.ComponentSDDModelingAssistantProviderTitle);
