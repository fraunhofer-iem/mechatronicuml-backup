 ...
 * @generated
 */
public class ComponentStoryPatternNodeTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponentStoryPatternNodeTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ComponentSDDParserProvider.getParser(ComponentSDDElementTypes.ComponentStoryPatternNode_2003,
					getParserElement(), ComponentSDDVisualIDRegistry.getType(
							org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.parts.ComponentStoryPatternNodeTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
