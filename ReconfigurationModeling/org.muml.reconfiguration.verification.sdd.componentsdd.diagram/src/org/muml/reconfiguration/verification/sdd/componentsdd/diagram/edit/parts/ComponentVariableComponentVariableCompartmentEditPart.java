...
import org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.ComponentVariableComponentVariableCompartmentCanonicalEditPolicy;
 ...
 * @generated
 */
public class ComponentVariableComponentVariableCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	public String getCompartmentName() {
		return Messages.ComponentVariableComponentVariableCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ComponentVariableComponentVariableCompartmentCanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ComponentSDDElementTypes.ComponentPartVariable_3003) {
				return this;
			}
			if (type == ComponentSDDElementTypes.FadingComponentPartVariable_3009) {
				return this;
			}
