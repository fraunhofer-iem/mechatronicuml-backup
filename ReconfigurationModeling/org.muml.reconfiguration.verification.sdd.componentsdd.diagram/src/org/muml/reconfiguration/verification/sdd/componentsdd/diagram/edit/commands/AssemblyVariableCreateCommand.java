...
public class AssemblyVariableCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AssemblyVariableCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		View sourceView = ConnectionConfigureHelperGraphicalNodeEditPolicy.getSourceView(getRequest());
		View targetView = ConnectionConfigureHelperGraphicalNodeEditPolicy.getTargetView(getRequest());
		if (!ComponentSDDBaseItemSemanticEditPolicy.getLinkConstraints().canCreateAssemblyVariable_4002(getContainer(),
				getSource(), getTarget(), sourceView, targetView)) {
			String errorMessage = ComponentSDDBaseItemSemanticEditPolicy.getLinkConstraints()
					.getErrorAssemblyVariable_4002(getContainer(), getSource(), getTarget(), sourceView, targetView);
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		AssemblyVariable newElement = ComponentstorypatternFactory.eINSTANCE.createAssemblyVariable();
		...
		ElementInitializers.getInstance().init_AssemblyVariable_4002(newElement);
	...
	* @generated
	*/
	protected void doConfigure(AssemblyVariable newElement, IProgressMonitor monitor, IAdaptable info)
