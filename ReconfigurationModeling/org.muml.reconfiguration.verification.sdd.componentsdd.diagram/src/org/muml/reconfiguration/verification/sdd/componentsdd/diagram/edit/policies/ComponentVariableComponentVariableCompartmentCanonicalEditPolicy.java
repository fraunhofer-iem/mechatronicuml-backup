 ...
 * @generated
 */
public class ComponentVariableComponentVariableCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public ComponentVariableComponentVariableCompartmentCanonicalEditPolicy() {
	}

	public ComponentVariableComponentVariableCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	*/
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentstorypatternPackage.eINSTANCE.getComponentVariable_PartVariables();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { ComponentPartVariableEditPart.VISUAL_ID,
						FadingComponentPartVariableEditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ComponentPartVariableEditPart.VISUAL_ID
				|| visualID == FadingComponentPartVariableEditPart.VISUAL_ID;
	}
