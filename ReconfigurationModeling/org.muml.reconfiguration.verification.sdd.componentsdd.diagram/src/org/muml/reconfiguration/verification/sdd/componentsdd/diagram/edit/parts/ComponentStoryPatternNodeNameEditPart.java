 ...
 * @generated
 */
public class ComponentStoryPatternNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponentStoryPatternNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentSDDParserProvider.getParser(ComponentSDDElementTypes.ComponentStoryPatternNode_2003,
					getParserElement(), ComponentSDDVisualIDRegistry.getType(
							org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.parts.ComponentStoryPatternNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
