 ...
 * @generated
 */
public class ComponentStoryPatternComponentStoryPatternCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public ComponentStoryPatternComponentStoryPatternCompartmentCanonicalEditPolicy() {
	}

	public ComponentStoryPatternComponentStoryPatternCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	*/
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { ComponentVariableEditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return ComponentVariableEditPart.VISUAL_ID == ComponentSDDVisualIDRegistry.getVisualID(view);
	}
