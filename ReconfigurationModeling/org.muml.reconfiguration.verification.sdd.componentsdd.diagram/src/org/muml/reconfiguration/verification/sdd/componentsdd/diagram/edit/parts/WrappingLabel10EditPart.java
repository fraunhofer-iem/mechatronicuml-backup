 ...
 * @generated
 */
public class WrappingLabel10EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentSDDParserProvider.getParser(ComponentSDDElementTypes.InitialNode_2004, getParserElement(),
					ComponentSDDVisualIDRegistry.getType(
							org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID));
		}
		return parser;
	}
