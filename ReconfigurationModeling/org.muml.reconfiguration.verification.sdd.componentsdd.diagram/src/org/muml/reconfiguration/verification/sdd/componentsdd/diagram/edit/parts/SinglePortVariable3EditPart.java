...
import org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.SinglePortVariable3ItemSemanticEditPolicy;
...
public class SinglePortVariable3EditPart extends BorderedBorderItemEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SinglePortVariable3ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof PortVariableOperator4EditPart
				|| borderItemEditPart instanceof SinglePortVariableName2EditPart
				|| borderItemEditPart instanceof UnderlinedLabel4EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ComponentSDDVisualIDRegistry.getType(PortVariableOperator4EditPart.VISUAL_ID));
	}
