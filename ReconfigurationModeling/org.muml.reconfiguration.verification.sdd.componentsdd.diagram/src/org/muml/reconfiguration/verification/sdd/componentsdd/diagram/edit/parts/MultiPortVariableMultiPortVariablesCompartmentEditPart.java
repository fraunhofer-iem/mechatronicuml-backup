...
import org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartmentCanonicalEditPolicy;
import org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.MultiPortVariableMultiPortVariablesCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MultiPortVariableMultiPortVariablesCompartmentEditPart extends ListCompartmentEditPart {
	...
	public String getCompartmentName() {
		return Messages.MultiPortVariableMultiPortVariablesCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MultiPortVariableMultiPortVariablesCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ComponentSDDVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MultiPortVariableMultiPortVariablesCompartmentCanonicalEditPolicy());
