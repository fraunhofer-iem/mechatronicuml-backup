...
public class SinglePortVariableName2EditPart extends LabelEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.ComponentSDDTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = org.muml.reconfiguration.verification.sdd.componentsdd.diagram.providers.ComponentSDDParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.parts.ComponentSDDEditPartFactory
