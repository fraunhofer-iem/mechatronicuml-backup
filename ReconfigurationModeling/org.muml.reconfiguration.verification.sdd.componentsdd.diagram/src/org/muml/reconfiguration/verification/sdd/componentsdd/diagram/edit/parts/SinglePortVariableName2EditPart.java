...
import org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.ComponentSDDTextSelectionEditPolicy;
...
public class SinglePortVariableName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				ComponentSDDVisualIDRegistry.getType(
						org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.parts.SinglePortVariableName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ComponentSDDTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentSDDParserProvider.getParser(ComponentSDDElementTypes.SinglePortVariable_3008,
					getParserElement(), ComponentSDDVisualIDRegistry.getType(
							org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.parts.SinglePortVariableName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, ComponentSDDEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
