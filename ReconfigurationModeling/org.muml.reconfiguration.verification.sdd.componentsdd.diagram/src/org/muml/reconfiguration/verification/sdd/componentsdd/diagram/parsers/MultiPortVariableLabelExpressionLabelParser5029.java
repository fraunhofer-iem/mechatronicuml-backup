 ...
 * @generated
 */
public class MultiPortVariableLabelExpressionLabelParser5029 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public MultiPortVariableLabelExpressionLabelParser5029() {
	...
	protected String getExpressionBody() {
		return ComponentSDDOCLFactory
				.getExpression(6, ComponentstorypatternPackage.eINSTANCE.getMultiPortVariable(), null).body();
	}
