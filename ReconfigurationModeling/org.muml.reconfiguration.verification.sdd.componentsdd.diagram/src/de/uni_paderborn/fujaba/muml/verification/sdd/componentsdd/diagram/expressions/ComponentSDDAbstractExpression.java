 ...
 * @generated
 */
public abstract class ComponentSDDAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.part.ComponentSDDDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ComponentSDDAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
