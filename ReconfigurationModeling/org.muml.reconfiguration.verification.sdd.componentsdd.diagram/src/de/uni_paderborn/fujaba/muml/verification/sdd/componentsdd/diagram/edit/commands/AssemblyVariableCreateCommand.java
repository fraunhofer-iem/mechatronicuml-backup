...
public class AssemblyVariableCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentstorypattern.AssemblyVariable newElement = de.uni_paderborn.fujaba.muml.componentstorypattern.ComponentstorypatternFactory.eINSTANCE
		...
		de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.providers.ElementInitializers
				.getInstance().init_AssemblyVariable_4002(newElement);
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.componentstorypattern.AssemblyVariable newElement,
