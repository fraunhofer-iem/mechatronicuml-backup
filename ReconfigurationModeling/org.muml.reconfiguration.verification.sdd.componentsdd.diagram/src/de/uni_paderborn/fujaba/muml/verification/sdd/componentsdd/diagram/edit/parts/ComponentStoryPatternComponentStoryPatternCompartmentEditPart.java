...
public class ComponentStoryPatternComponentStoryPatternCompartmentEditPart
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.part.Messages.ComponentStoryPatternComponentStoryPatternCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.edit.policies.ComponentStoryPatternComponentStoryPatternCompartmentItemSemanticEditPolicy());
		installEditPolicy(
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == de.uni_paderborn.fujaba.muml.verification.sdd.componentsdd.diagram.providers.ComponentSDDElementTypes.ComponentVariable_3002) {
				return this;
			}
