...
public class MultiPortVariableEditor
	...
	protected void createProperties() {
		...
		if (getTab() == null || "property.tab.general".equals(getTab())) {
			addMultiPortVariableSubPortVariables_GeneralTab_Editor(
	 ...
	 * @generated
	 */
	protected void addMultiPortVariableSubPortVariables_GeneralTab_Editor(
			String category, boolean front) {
		addEditorToCategory(category,
				createMultiPortVariableSubPortVariables_GeneralTab_Editor(),
				front);
	}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createMultiPortVariableSubPortVariables_GeneralTab_Editor() {
