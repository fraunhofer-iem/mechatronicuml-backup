 ...
 * @generated
 */
public class DelegationVariableEditor
		extends
	...
	protected void createProperties() {
		...
		if (getTab() == null || "property.tab.general".equals(getTab())) {
			addDelegationVariableType_GeneralTab_Editor(null, true);
		}
	 ...
	 * @generated
	 */
	protected void addDelegationVariableType_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category,
				createDelegationVariableType_GeneralTab_Editor(), front);
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createDelegationVariableType_GeneralTab_Editor() {
