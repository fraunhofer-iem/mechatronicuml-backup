...
public class AssemblyVariableEditor
	...
	protected void createProperties() {
		...
		if (getTab() == null || "property.tab.general".equals(getTab())) {
			addAssemblyVariableType_GeneralTab_Editor(null, true);
		}
	 ...
	 * @generated
	 */
	protected void addAssemblyVariableType_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category,
				createAssemblyVariableType_GeneralTab_Editor(), front);
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createAssemblyVariableType_GeneralTab_Editor() {
