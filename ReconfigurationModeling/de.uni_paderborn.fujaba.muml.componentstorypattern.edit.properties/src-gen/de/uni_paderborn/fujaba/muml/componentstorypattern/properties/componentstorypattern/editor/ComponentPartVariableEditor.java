...
public class ComponentPartVariableEditor
	...
	protected void createProperties() {
		...
		if (getTab() == null || "property.tab.general".equals(getTab())) {
			addComponentPartVariableTriggerEmbeddedComponentExpressions_GeneralTab_Editor(
					null, false);
		}
	 ...
	 * @generated
	 */
	protected void addComponentPartVariableTriggerEmbeddedComponentExpressions_GeneralTab_Editor(
			String category, boolean front) {
		addEditorToCategory(
				category,
				createComponentPartVariableTriggerEmbeddedComponentExpressions_GeneralTab_Editor(),
				front);
	}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createComponentPartVariableTriggerEmbeddedComponentExpressions_GeneralTab_Editor() {
