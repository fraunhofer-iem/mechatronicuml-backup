...
public abstract class PortVariableEditor
	...
	protected void createProperties() {
		...
		if (getTab() == null || "property.tab.general".equals(getTab())) {
			addPortVariableType_GeneralTab_Editor(null, true);
		}
	 ...
	 * @generated
	 */
	protected void addPortVariableType_GeneralTab_Editor(String category,
			boolean front) {
		addEditorToCategory(category,
				createPortVariableType_GeneralTab_Editor(), front);
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.properties.runtime.editors.IPropertyEditor createPortVariableType_GeneralTab_Editor() {
