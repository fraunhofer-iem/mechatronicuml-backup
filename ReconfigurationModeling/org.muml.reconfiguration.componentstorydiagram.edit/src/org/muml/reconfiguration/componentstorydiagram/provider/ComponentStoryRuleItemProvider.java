...
public class ComponentStoryRuleItemProvider
	 ...
	 * @generated
	 */
	public ComponentStoryRuleItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentStoryRule_constructor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentStoryRule_constructor_feature", "_UI_ComponentStoryRule_type"),
				 ComponentstorydiagramPackage.Literals.COMPONENT_STORY_RULE__CONSTRUCTOR,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns ComponentStoryRule.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComponentStoryRule"));
	}
	...
	public String getText(Object object) {
		String label = ((ComponentStoryRule)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ComponentStoryRule_type") :
			getString("_UI_ComponentStoryRule_type") + " " + label;
	}
