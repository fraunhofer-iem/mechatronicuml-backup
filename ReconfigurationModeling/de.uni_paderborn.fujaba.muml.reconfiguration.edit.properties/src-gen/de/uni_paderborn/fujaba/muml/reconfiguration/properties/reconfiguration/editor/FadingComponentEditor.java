...
public class FadingComponentEditor
	...
	protected void createProperties() {
		...
		addPropertyEditor(createPorts_GeneralTab_Editor(), false);

		addPropertyEditor(createComponentKind_GeneralTab_Editor(), false);

		addPropertyEditor(createFadingFunction_GeneralTab_Editor(), false);

	}

	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorFadingFunction_GeneralTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createFadingFunction_GeneralTab_Editor() {
		if (this.editorFadingFunction_GeneralTab == null) {
			...
			this.editorFadingFunction_GeneralTab = editor;
		}
		return this.editorFadingFunction_GeneralTab;
	}
