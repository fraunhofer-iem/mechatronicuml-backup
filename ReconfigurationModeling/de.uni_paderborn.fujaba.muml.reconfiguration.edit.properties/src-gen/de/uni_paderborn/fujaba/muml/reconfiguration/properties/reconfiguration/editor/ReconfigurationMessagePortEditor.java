...
public class ReconfigurationMessagePortEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createInterfaceEntries_GeneralTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorInterfaceEntries_GeneralTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createInterfaceEntries_GeneralTab_Editor() {
		if (this.editorInterfaceEntries_GeneralTab == null) {
			...
			this.editorInterfaceEntries_GeneralTab = editor;
		}
		return this.editorInterfaceEntries_GeneralTab;
	}
