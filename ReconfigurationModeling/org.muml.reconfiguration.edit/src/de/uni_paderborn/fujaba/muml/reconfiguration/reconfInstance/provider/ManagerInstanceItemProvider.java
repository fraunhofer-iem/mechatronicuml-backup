...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.reconfiguration.reconfInstance.ManagerInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReconfInstancePackage.Literals.MANAGER_INSTANCE__MANAGER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReconfInstancePackage.Literals.MANAGER_INSTANCE__PORT_INSTANCES,
				 true,
				 false,
				 true,
				 null,
