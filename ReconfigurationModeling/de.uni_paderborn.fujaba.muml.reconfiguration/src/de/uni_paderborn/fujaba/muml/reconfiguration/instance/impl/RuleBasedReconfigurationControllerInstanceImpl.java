 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reconfiguration.instance.impl.RuleBasedReconfigurationControllerInstanceImpl#getManagerInstance <em>Manager Instance</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reconfiguration.instance.impl.RuleBasedReconfigurationControllerInstanceImpl#getExecutorInstance <em>Executor Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleBasedReconfigurationControllerInstanceImpl extends ReconfigurationControllerInstanceImpl implements RuleBasedReconfigurationControllerInstance {
	...
	protected EClass eStaticClass() {
		return InstancePackage.Literals.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE;
	}
	...
	public NotificationChain basicSetManagerInstance(ManagerInstance newManagerInstance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__MANAGER_INSTANCE, oldManagerInstance, newManagerInstance);
	...
	public void setManagerInstance(ManagerInstance newManagerInstance) {
		if (newManagerInstance != managerInstance) {
			...
			if (managerInstance != null)
				msgs = ((InternalEObject)managerInstance).eInverseRemove(this, InstancePackage.MANAGER_INSTANCE__RECONFIGURATION_CONTROLLER_INSTANCE, ManagerInstance.class, msgs);
			if (newManagerInstance != null)
				msgs = ((InternalEObject)newManagerInstance).eInverseAdd(this, InstancePackage.MANAGER_INSTANCE__RECONFIGURATION_CONTROLLER_INSTANCE, ManagerInstance.class, msgs);
			msgs = basicSetManagerInstance(newManagerInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__MANAGER_INSTANCE, newManagerInstance, newManagerInstance));
	}
	...
	public NotificationChain basicSetExecutorInstance(ExecutorInstance newExecutorInstance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__EXECUTOR_INSTANCE, oldExecutorInstance, newExecutorInstance);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExecutorInstance(ExecutorInstance newExecutorInstance) {
		if (newExecutorInstance != executorInstance) {
			...
			if (executorInstance != null)
				msgs = ((InternalEObject)executorInstance).eInverseRemove(this, InstancePackage.EXECUTOR_INSTANCE__RECONFIGURATION_CONTROLLER_INSTANCE, ExecutorInstance.class, msgs);
			if (newExecutorInstance != null)
				msgs = ((InternalEObject)newExecutorInstance).eInverseAdd(this, InstancePackage.EXECUTOR_INSTANCE__RECONFIGURATION_CONTROLLER_INSTANCE, ExecutorInstance.class, msgs);
			msgs = basicSetExecutorInstance(newExecutorInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__EXECUTOR_INSTANCE, newExecutorInstance, newExecutorInstance));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__MANAGER_INSTANCE:
				if (managerInstance != null)
					msgs = ((InternalEObject)managerInstance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__MANAGER_INSTANCE, null, msgs);
				return basicSetManagerInstance((ManagerInstance)otherEnd, msgs);
			case InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__EXECUTOR_INSTANCE:
				if (executorInstance != null)
					msgs = ((InternalEObject)executorInstance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - InstancePackage.RULE_BASED_RECONFIGURATION_CONTROLLER_INSTANCE__EXECUTOR_INSTANCE, null, msgs);
