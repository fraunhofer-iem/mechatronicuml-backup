...
public class InstancePackageImpl extends EPackageImpl implements InstancePackage {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.reconfiguration.instance.InstancePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		reconfigurableComponentInstanceEClass.getESuperTypes().add(theInstancePackage_1.getComponentInstance());
		reconfigurationPortInstanceEClass.getESuperTypes().add(theInstancePackage_1.getPortInstance());
		...
		reconfigurableAtomicComponentInstanceEClass.getESuperTypes().add(theInstancePackage_1.getAtomicComponentInstance());
		reconfigurableStructuredComponentInstanceEClass.getESuperTypes().add(theInstancePackage_1.getStructuredComponentInstance());
