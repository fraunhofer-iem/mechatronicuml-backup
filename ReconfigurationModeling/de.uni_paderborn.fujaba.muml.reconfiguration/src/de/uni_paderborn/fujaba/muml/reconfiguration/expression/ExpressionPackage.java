...
public interface ExpressionPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ACTIVITY_CALL_EXPRESSION___PROVIDE_EXTENSION__ECLASS = ExpressionsPackage.EXPRESSION___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int ACTIVITY_CALL_EXPRESSION___GET_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int ACTIVITY_CALL_EXPRESSION___PROVIDE_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___PROVIDE_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int RECONFIGURATION_RULE_CALL_EXPRESSION___PROVIDE_EXTENSION__ECLASS = ExpressionsPackage.EXPRESSION___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int RECONFIGURATION_RULE_CALL_EXPRESSION___GET_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int RECONFIGURATION_RULE_CALL_EXPRESSION___PROVIDE_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___PROVIDE_ANNOTATION__STRING;
	...
	/**
	 * The meta object id for the '{@link de.uni_paderborn.fujaba.muml.reconfiguration.expression.impl.EvaluateStructuralConditionExpressionImpl <em>Evaluate Structural Condition Expression</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uni_paderborn.fujaba.muml.reconfiguration.expression.impl.EvaluateStructuralConditionExpressionImpl
	 * @see de.uni_paderborn.fujaba.muml.reconfiguration.expression.impl.ExpressionPackageImpl#getEvaluateStructuralConditionExpression()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int EVALUATE_STRUCTURAL_CONDITION_EXPRESSION__ANNOTATION = ExpressionsPackage.EXPRESSION__ANNOTATION;
	 ...
	 * @ordered
	 */
	int EVALUATE_STRUCTURAL_CONDITION_EXPRESSION__EXTENSION = ExpressionsPackage.EXPRESSION__EXTENSION;
	 ...
	 * @ordered
	 */
	int EVALUATE_STRUCTURAL_CONDITION_EXPRESSION___PROVIDE_EXTENSION__ECLASS = ExpressionsPackage.EXPRESSION___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int EVALUATE_STRUCTURAL_CONDITION_EXPRESSION___GET_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int EVALUATE_STRUCTURAL_CONDITION_EXPRESSION___PROVIDE_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___PROVIDE_ANNOTATION__STRING;
	...
	/**
	 * Returns the meta object for class '{@link de.uni_paderborn.fujaba.muml.reconfiguration.expression.EvaluateStructuralConditionExpression <em>Evaluate Structural Condition Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uni_paderborn.fujaba.muml.reconfiguration.expression.EvaluateStructuralConditionExpression#getParameterBindings <em>Parameter Bindings</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Parameter Bindings</em>'.
	 * @see de.uni_paderborn.fujaba.muml.reconfiguration.expression.EvaluateStructuralConditionExpression#getParameterBindings()
	...
	/**
	 * Returns the meta object for the reference '{@link de.uni_paderborn.fujaba.muml.reconfiguration.expression.EvaluateStructuralConditionExpression#getStructuralCondition <em>Structural Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Structural Condition</em>'.
	 * @see de.uni_paderborn.fujaba.muml.reconfiguration.expression.EvaluateStructuralConditionExpression#getStructuralCondition()
	 * @see #getEvaluateStructuralConditionExpression()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link de.uni_paderborn.fujaba.muml.reconfiguration.expression.impl.EvaluateStructuralConditionExpressionImpl <em>Evaluate Structural Condition Expression</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uni_paderborn.fujaba.muml.reconfiguration.expression.impl.EvaluateStructuralConditionExpressionImpl
		 * @see de.uni_paderborn.fujaba.muml.reconfiguration.expression.impl.ExpressionPackageImpl#getEvaluateStructuralConditionExpression()
