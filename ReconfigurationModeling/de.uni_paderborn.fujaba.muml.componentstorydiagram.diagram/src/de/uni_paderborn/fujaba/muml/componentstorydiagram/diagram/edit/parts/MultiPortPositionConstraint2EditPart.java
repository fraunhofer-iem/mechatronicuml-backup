 ...
 * @generated
 */
public class MultiPortPositionConstraint2EditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.part.ComponentStoryDiagramVisualIDRegistry
						.getType(de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.edit.parts.MultiPortPositionConstraint2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public MultiPortPositionConstraint2EditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new MultiPortPositionConstraintFigure();
	}

	/**
	 * @generated
	 */
	public class MultiPortPositionConstraintFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMultiPortPositionConstraint;

		/**
		 * @generated
		 */
		public MultiPortPositionConstraintFigure() {
			this.setText("test");
		}
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMultiPortPositionConstraint() {
			return fFigureMultiPortPositionConstraint;
		}
