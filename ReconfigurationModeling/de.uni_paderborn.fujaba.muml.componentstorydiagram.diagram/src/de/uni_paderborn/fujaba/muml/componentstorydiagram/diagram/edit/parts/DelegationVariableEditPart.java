...
public class DelegationVariableEditPart extends ConnectionNodeEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.edit.policies.DelegationVariableItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.edit.parts.DelegationVariableNameEditPart) {
			((de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.edit.parts.DelegationVariableNameEditPart) childEditPart)
