 ...
 * @generated
 */
public class ProgrammableLogicDeviceEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ProgrammableLogicDeviceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.policies.ProgrammableLogicDeviceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.ProgrammableLogicDeviceNameEditPart) {
			((de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.ProgrammableLogicDeviceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.WrappingLabel10EditPart) {
			((de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.WrappingLabel10EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.WrappingLabel11EditPart) {
			((de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.WrappingLabel11EditPart) childEditPart)
