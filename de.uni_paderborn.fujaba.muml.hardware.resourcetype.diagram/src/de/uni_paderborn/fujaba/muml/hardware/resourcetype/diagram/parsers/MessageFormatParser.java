package de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.part.Messages.MessageFormatParser_InvalidInputError,
