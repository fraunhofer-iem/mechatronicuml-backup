 ...
 * @generated
 */
public class MemoryResourceIsVolatile2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MemoryResourceIsVolatile2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.policies.HardwareTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.providers.HardwareParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.HardwareEditPartFactory
