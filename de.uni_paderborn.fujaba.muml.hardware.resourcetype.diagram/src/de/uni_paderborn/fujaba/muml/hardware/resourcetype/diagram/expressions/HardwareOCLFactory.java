package de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.expressions;
...
public class HardwareOCLFactory {
	 ...
	 * @generated
	 */
	private final de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.expressions.HardwareAbstractExpression[] expressions;
	 ...
	 * @generated
	 */
	public static de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.expressions.HardwareAbstractExpression getExpression(
			int index, EClassifier context, Map<String, EClassifier> environment) {
		HardwareOCLFactory cached = de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.part.HardwareDiagramEditorPlugin
	...
	private static class Expression
			extends
			de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.expressions.HardwareAbstractExpression {
