...
public class HardwareBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.providers.HardwareElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.part.HardwareDiagramEditorPlugin
	...
	public static class LinkConstraints {
		...
		public boolean canCreateProcessorOwnedCache_4001(
			...
			if (target != null
					&& (target.getUsedByProcessor().contains(target))) {
				return false;
			}
		...
		public boolean canExistProcessorOwnedCache_4001(
			...
			try {
				if (source == null) {
					...
					envType.put(
							"oppositeEnd", de.uni_paderborn.fujaba.muml.hardware.resourcetype.ResourcetypePackage.eINSTANCE.getCache()); //$NON-NLS-1$
				...
				if (target == null) {
					...
					Map<String, Object> env = new HashMap<String, Object>();
					envType.put(
							"oppositeEnd", de.uni_paderborn.fujaba.muml.hardware.resourcetype.ResourcetypePackage.eINSTANCE.getProcessor()); //$NON-NLS-1$
