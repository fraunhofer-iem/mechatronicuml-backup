 ...
 * @generated
 */
public class ProcessorGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionCompleteCommand(
		...
		if (de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.providers.HardwareElementTypes.ProcessorOwnedCache_4001 == elementType) {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(
		...
		TransactionalEditingDomain editingDomain = ((IGraphicalEditPart) getHost())
				.getEditingDomain();
		de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.commands.HardwareReorientConnectionViewCommand rcvCommand = new de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.commands.HardwareReorientConnectionViewCommand(
				editingDomain, null);
