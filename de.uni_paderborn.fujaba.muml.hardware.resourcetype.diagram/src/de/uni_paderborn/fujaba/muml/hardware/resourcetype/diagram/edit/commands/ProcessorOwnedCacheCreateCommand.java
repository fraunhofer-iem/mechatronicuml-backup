...
public class ProcessorOwnedCacheCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null
				&& false == source instanceof de.uni_paderborn.fujaba.muml.hardware.resourcetype.Processor) {
			return false;
		}
		if (target != null
				&& false == target instanceof de.uni_paderborn.fujaba.muml.hardware.resourcetype.Cache) {
			return false;
		}
		if (getSource() == null) {
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.resourcetype.Processor getSource() {
		return (de.uni_paderborn.fujaba.muml.hardware.resourcetype.Processor) source;
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.resourcetype.Cache getTarget() {
		return (de.uni_paderborn.fujaba.muml.hardware.resourcetype.Cache) target;
	}
}
