 ...
 * @generated
 */
public class StructuredResourceItemSemanticEditPolicy
		extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.providers.HardwareElementTypes.HWPort_3001 == req
				.getElementType()) {
			return getGEFWrapper(new de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.commands.HWPortCreateCommand(
					req));
		}
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.ProcessorEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.part.HardwareVisualIDRegistry
									.getVisualID(outgoingLink) == de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.parts.ProcessorOwnedCacheEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
