 ...
 * @generated
 */
public class HardwareDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static HardwareDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.part.HardwareDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.providers.ElementInitializers initializers;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.expressions.HardwareOCLFactory oclFactory;

	/**
	 * @generated
	 */
	public HardwareDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static HardwareDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.part.HardwareDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.part.HardwareDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.expressions.HardwareOCLFactory getHardwareOCLFactory() {
		return oclFactory;
	}
	...
	public void setHardwareOCLFactory(
			de.uni_paderborn.fujaba.muml.hardware.resourcetype.diagram.expressions.HardwareOCLFactory f) {
		this.oclFactory = f;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, HardwareDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, HardwareDiagramEditorPlugin.ID,
