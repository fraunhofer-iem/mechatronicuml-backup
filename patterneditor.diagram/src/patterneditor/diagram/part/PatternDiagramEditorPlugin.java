...
import patterneditor.diagram.providers.ElementInitializers;
import patterneditor.provider.PatterneditorItemProviderAdapterFactory;
...
public class PatternDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "patterneditor.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private PatternDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private PatternBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories.add(new PatterneditorItemProviderAdapterFactory());
		...
		factories
				.add(new de.uni_paderborn.fujaba.umlrt.model.modelstructure.provider.ModelstructureItemProviderAdapterFactory());
	 ...
	 * @generated
	 */
	public PatternDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new PatternDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public PatternBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			PatternBaseItemSemanticEditPolicy.LinkConstraints lc) {
