...
import patterneditor.diagram.edit.helpers.PatternBaseEditHelper;
...
public class PatternBaseItemSemanticEditPolicy extends SemanticEditPolicy {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						PatternVisualIDRegistry.getVisualID((View) view));
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(PatternBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(PatternBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(PatternBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(PatternBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = PatternElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = PatternDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			PatternDiagramEditorPlugin.getInstance().setLinkConstraints(
