...
import patterneditor.diagram.edit.policies.PatternTextSelectionEditPolicy;
...
public class CoordinationPatternNameEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new PatternTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new PatternDiagramEditPart.NodeLabelDragPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof PatternTextSelectionEditPolicy) {
			((PatternTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof PatternTextSelectionEditPolicy) {
			((PatternTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					PatternEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
