...
import patterneditor.diagram.edit.policies.PatternDiagramCanonicalEditPolicy;
import patterneditor.diagram.edit.policies.PatternDiagramItemSemanticEditPolicy;
...
public class PatternDiagramEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PatternDiagramItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PatternDiagramCanonicalEditPolicy());
