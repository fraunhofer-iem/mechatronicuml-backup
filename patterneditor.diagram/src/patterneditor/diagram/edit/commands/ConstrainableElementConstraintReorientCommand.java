 ...
 * @generated
 */
public class ConstrainableElementConstraintReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ConstrainableElementConstraintReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return PatternBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConstrainableElementConstraint_4005(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return PatternBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConstrainableElementConstraint_4005(getOldSource(),
						getNewTarget());
	}
