...
public class PatternViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return PatternDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PatternVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = PatternVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!PatternElementTypes.isKnownElementType(elementType)
				...
				if (!PatternDiagramEditPart.MODEL_ID
						.equals(PatternVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return CoordinationPatternEditPart.VISUAL_ID == visualID
				...
				|| TextualConstraintEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = PatternVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != PatternVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(PatternDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = PatternVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = PatternVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case CoordinationPatternEditPart.VISUAL_ID:
	...
	public Node createCoordinationPattern_2001(EObject domainElement,
		...
		node.setType(PatternVisualIDRegistry
	...
	public Node createRole_2002(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PatternVisualIDRegistry.getType(RoleEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Edge createRoleConnector_4001(EObject domainElement,
		...
		edge.setType(PatternVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!PatternDiagramEditPart.MODEL_ID.equals(PatternVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", PatternDiagramEditPart.MODEL_ID); //$NON-NLS-1$
