...
class TypesUtil {
	...
	// requiredHardwareResourceInstance constraint
	 static def TupleType createReqHWResInstanceConstraintTupleType(RequiredHardwareResourceInstanceConstraintCS constraintCS) {
	 ...
	 static def Map<String, EClass>createNamedPartsFromComponentResourceTupleDescriptors(
	...
	// resource constraint
	 static def TupleType createResourceConstraintInnerTupleType(ResourceConstraintCS constraintCS) {
		val EnvironmentFactoryInternal envFactory = getEnvironmentFactory(constraintCS)
		createWeightingComponentResourceTupleElementCSTupleType(envFactory, constraintCS)
	}
	
	 static def TupleType createResourceConstraintOuterTupleType(EnvironmentFactoryInternal envFactory, ResourceConstraintCS constraintCS) {
	 ...
	 static def TupleType createResourceConstraintOuterTupleType(ResourceConstraintCS constraintCS) {
		val EnvironmentFactoryInternal envFactory = getEnvironmentFactory(constraintCS)
	...
	// QoS dimension
	 static def TupleType createQoSDimensionTupleType(QoSDimensionCS qosDimensionCS) {
	 ...
	 static def TupleType createWeightingComponentResourceTupleElementCSTupleType(EnvironmentFactoryInternal envFactory, WeightingComponentResourceTupleElementCS elementCS) {
