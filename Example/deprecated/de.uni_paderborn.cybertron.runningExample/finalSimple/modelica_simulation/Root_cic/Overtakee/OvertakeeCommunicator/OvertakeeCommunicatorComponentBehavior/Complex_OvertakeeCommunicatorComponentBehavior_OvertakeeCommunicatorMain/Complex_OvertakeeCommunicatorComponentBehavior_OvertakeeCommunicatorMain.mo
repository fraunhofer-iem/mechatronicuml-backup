...
model Complex_OvertakeeCommunicatorComponentBehavior_OvertakeeCommunicatorMain
                                                                               extends
    Modelica_StateGraph2.PartialParallel(                                                                                   nEntry=1);
 // no annotations will be generated for complex states
 // region declarations
 OvertakeeCommunicator_pOvertakee.OvertakeeCommunicator_pOvertakee region_1_overtakeeCommunicator_pOvertakee(nIn=1, use_outPort=false)
...
equation
  ...
  connect(entry[1],
    region_1_overtakeeCommunicator_pOvertakee.inPort[1])
