 ...
 */
		//Define MessageType IDs
			#define MESSAGE_DISTANCE_DISTANCE_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 1 /**< Global Identifier: For the Message-Type: Distance_distance_message */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 3 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 4 /**< Global Identifier: For the Message-Type: setSlow */
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: change */
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 7 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 8 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 9 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 13 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 15 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 17 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 19 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: initiate */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: unsave */
