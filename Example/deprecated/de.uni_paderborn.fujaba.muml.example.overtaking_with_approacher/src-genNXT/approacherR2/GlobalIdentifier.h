 ...
 */
		//Define MessageType IDs
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 1 /**< Global Identifier: For the Message-Type: overtake */
			...
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: freeVelocity */
			...
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 8 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 9 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: unsave */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: setSlow */
			...
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 19 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: execute */
