...
//Create components
	struct	SenderComponent* c1Component; /**< The ComponentInstance: C1 of Type: SenderComponent*/
	struct	ReceiverComponent* c2Component; /**< The ComponentInstance: C2 of Type: ReceiverComponent*/
