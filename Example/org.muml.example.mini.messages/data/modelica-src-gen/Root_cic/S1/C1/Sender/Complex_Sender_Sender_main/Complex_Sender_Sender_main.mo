	within Root_cic.S1.C1.Sender.Complex_Sender_Sender_main;
model Complex_Sender_Sender_main extends Modelica_StateGraph2.PartialParallel(nEntry=1);
	// no annotations will be generated for complex states
	// region declarations
	Out1.Out1 region_1_out1(nIn=1, use_outPort=false)
...
end Complex_Sender_Sender_main;
