...
DDS_TypeCode* DDS_MessagesgetOrder_Messages_get_typecode()
{
    ...
    static DDS_TypeCode_Member DDS_MessagesgetOrder_Messages_g_tc_members[2]=
    {
        ...
        {
            (char *)"producibleIngredients",/* Member name */
            {
                1,/* Representation ID */          
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
    ...
    DDS_MessagesgetOrder_Messages_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
    ...
    DDS_MessagesgetOrder_Messages* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
    ...
    if (!RTICdrType_initLong(&sample->producibleIngredients)) {
        return RTI_FALSE;
    }     
    ...
    const DDS_MessagesgetOrder_Messages* src)
{
    ...
    if (!RTICdrType_copyLong (
        &dst->producibleIngredients, &src->producibleIngredients)) { 
        return RTI_FALSE;
    }
...
/* ========================================================================= */
const char *DDS_Messagesheartbeat_MessagesTYPENAME = "DDS_Messagesheartbeat_Messages";

DDS_TypeCode* DDS_Messagesheartbeat_Messages_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;

    static DDS_TypeCode_Member DDS_Messagesheartbeat_Messages_g_tc_members[1]=
    {
    ...
    static DDS_TypeCode DDS_Messagesheartbeat_Messages_g_tc =
    {{
            DDS_TK_STRUCT,/* Kind */
            DDS_BOOLEAN_FALSE, /* Ignored */
            -1, /*Ignored*/
            (char *)"DDS_Messagesheartbeat_Messages", /* Name */
            NULL, /* Ignored */      
            0, /* Ignored */
            0, /* Ignored */
            NULL, /* Ignored */
            1, /* Number of members */
            DDS_Messagesheartbeat_Messages_g_tc_members, /* Members */
            DDS_VM_NONE  /* Ignored */         
        }}; /* Type code for DDS_Messagesheartbeat_Messages*/

    if (is_initialized) {
        return &DDS_Messagesheartbeat_Messages_g_tc;
    }

    DDS_Messagesheartbeat_Messages_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
...
RTIBool DDS_Messagesheartbeat_Messages_initialize(
    DDS_Messagesheartbeat_Messages* sample) {
    return DDS_Messagesheartbeat_Messages_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}

RTIBool DDS_Messagesheartbeat_Messages_initialize_ex(
    DDS_Messagesheartbeat_Messages* sample,RTIBool allocatePointers, RTIBool allocateMemory)
{
    ...
    return DDS_Messagesheartbeat_Messages_initialize_w_params(
        sample,&allocParams);

}

RTIBool DDS_Messagesheartbeat_Messages_initialize_w_params(
    DDS_Messagesheartbeat_Messages* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
...
void DDS_Messagesheartbeat_Messages_finalize(
    DDS_Messagesheartbeat_Messages* sample)
{

    DDS_Messagesheartbeat_Messages_finalize_ex(sample,RTI_TRUE);
}

void DDS_Messagesheartbeat_Messages_finalize_ex(
    DDS_Messagesheartbeat_Messages* sample,RTIBool deletePointers)
{
    struct DDS_TypeDeallocationParams_t deallocParams =
    DDS_TYPE_DEALLOCATION_PARAMS_DEFAULT;
    ...
    DDS_Messagesheartbeat_Messages_finalize_w_params(
        sample,&deallocParams);
}

void DDS_Messagesheartbeat_Messages_finalize_w_params(
    DDS_Messagesheartbeat_Messages* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
{
...
void DDS_Messagesheartbeat_Messages_finalize_optional_members(
    DDS_Messagesheartbeat_Messages* sample, RTIBool deletePointers)
{
    struct DDS_TypeDeallocationParams_t deallocParamsTmp =
    DDS_TYPE_DEALLOCATION_PARAMS_DEFAULT;
...
RTIBool DDS_Messagesheartbeat_Messages_copy(
...
* Defines:  TSeq, T
*
* Configure and implement 'DDS_Messagesheartbeat_Messages' sequence class.
*/
#define T DDS_Messagesheartbeat_Messages
#define TSeq DDS_Messagesheartbeat_MessagesSeq
#define T_initialize_w_params DDS_Messagesheartbeat_Messages_initialize_w_params
#define T_finalize_w_params   DDS_Messagesheartbeat_Messages_finalize_w_params
#define T_copy       DDS_Messagesheartbeat_Messages_copy
...
DDS_TypeCode* DDS_MessagessimpleOrder_Messages_get_typecode()
{
    ...
    static DDS_TypeCode_Member DDS_MessagessimpleOrder_Messages_g_tc_members[4]=
    {
    ...
    DDS_MessagessimpleOrder_Messages_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
