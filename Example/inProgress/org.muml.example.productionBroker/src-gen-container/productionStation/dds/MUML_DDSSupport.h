...
#ifndef MUML_DDSSupport_1362043863_h
#define MUML_DDSSupport_1362043863_h
...
DDS_TYPESUPPORT_C(DDS_Messagesheartbeat_MessagesTypeSupport, DDS_Messagesheartbeat_Messages);
DDS_DATAWRITER_C(DDS_Messagesheartbeat_MessagesDataWriter, DDS_Messagesheartbeat_Messages);
DDS_DATAREADER_C(DDS_Messagesheartbeat_MessagesDataReader, DDS_Messagesheartbeat_MessagesSeq, DDS_Messagesheartbeat_Messages);
...
#endif  /* MUML_DDSSupport_1362043863_h */
