		...
		#define ECU_IDENTIFIER_H
			...
			// code for ECU Config rpi.0.1_config
/**
*
*@brief Identifier for Messages used on rpi.0.1_config
...
/**
*
*@brief Identifier to distinguish Component Instance on ECU rpi.0.1_config
*@details Used by a component container to identify component instances of the same component type
*/
					#define CI_RECIPEGENERATORRECIPEGENERATOR 1 /**< Identifier for Component Instance RecipeGenerator */
