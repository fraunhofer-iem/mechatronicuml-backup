		...
		//#include "../RTSCs/mainRootRTSCStateChart.h"
			/*****
 			 ...
 			 */		
						...
						void MCC_MainComponent_LED_voltage_send_value(Port* p, int8_T* value);
			 ...
			 */
						...
						*/
						...
						//Manual written code
							void setterOf_LED_voltage(Port* port, int8_T* value);/**< A the setter function of the hybrid port: LED_voltage */
