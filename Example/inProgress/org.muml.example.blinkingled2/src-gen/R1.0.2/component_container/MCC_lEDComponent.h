		#ifndef MCC_MCC_LEDCOMPONENT_H_
		#define MCC_MCC_LEDCOMPONENT_H_
  ...
  extern "C" {
			 ...
			 * @file 
			 * @author generated
			 * @brief Specification of Component Container for Component of Type: Atomic_Component_LED
			 * @details This files contains an implementation of the container interfaces of a components
			 */
				
									/**
									 * @brief Forward Declaration of the method MCC_create_LEDComponent
									 * @details The method for initializing and creating a component instance oc type: Atomic_Component_LED
									 */
				LEDComponent* MCC_create_LEDComponent(uint8_T id);
#ifdef __cplusplus
  }
#endif
		#endif /* MCC_MCC_LEDCOMPONENT_H_ */
