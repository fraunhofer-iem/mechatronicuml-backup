		...
		//#include "../RTSCs/launchDelegatorLaunchDelegatorStateChart.h"
			/*****
 			 ...
 			 */		
					...
					void MCC_LaunchDelegatorComponent_verifier_send_M1Ready_M1_Message(Port* p, M1Ready_M1_Message* msg);
					bool_t MCC_LaunchDelegatorComponent_verifier_recv_M1AccessGranted_M1_Message(Port* p, M1AccessGranted_M1_Message* msg);
					bool_t MCC_LaunchDelegatorComponent_verifier_exists_M1AccessGranted_M1_Message(Port* p);
					bool_t MCC_LaunchDelegatorComponent_verifier_recv_M1AccessDenied_M1_Message(Port* p, M1AccessDenied_M1_Message* msg);
					bool_t MCC_LaunchDelegatorComponent_verifier_exists_M1AccessDenied_M1_Message(Port* p);
					bool_t MCC_LaunchDelegatorComponent_verifier_recv_M1OtherReady_M1_Message(Port* p, M1OtherReady_M1_Message* msg);
					bool_t MCC_LaunchDelegatorComponent_verifier_exists_M1OtherReady_M1_Message(Port* p);
					bool_t MCC_LaunchDelegatorComponent_verifier_recv_M1CompleteDeny_M1_Message(Port* p, M1CompleteDeny_M1_Message* msg);
					bool_t MCC_LaunchDelegatorComponent_verifier_exists_M1CompleteDeny_M1_Message(Port* p);
			...
			//ENUM
				 ...
				 */
					typedef enum {
						...
						,
								STATE_LAUNCHDELEGATORVERIFIERINPUTSTATE /**< Represents the State: STATE_LAUNCHDELEGATORVERIFIERINPUTSTATE of the Realtime-StateChart: LaunchDelegatorVerifierPeer_verifier */
						,		STATE_LAUNCHDELEGATORVERIFIERSTART /**< Represents the State: STATE_LAUNCHDELEGATORVERIFIERSTART of the Realtime-StateChart: LaunchDelegatorVerifierPeer_verifier */
						,		STATE_LAUNCHDELEGATORVERIFIERREADY /**< Represents the State: STATE_LAUNCHDELEGATORVERIFIERREADY of the Realtime-StateChart: LaunchDelegatorVerifierPeer_verifier */
