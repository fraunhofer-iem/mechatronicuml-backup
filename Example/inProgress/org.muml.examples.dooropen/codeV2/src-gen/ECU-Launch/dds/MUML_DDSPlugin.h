...
#ifndef MUML_DDSPlugin_1362043476_h
#define MUML_DDSPlugin_1362043476_h
...
#define DDS_M1completeDeny_M1Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define DDS_M1completeDeny_M1Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define DDS_M1completeDeny_M1Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define DDS_M1completeDeny_M1Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define DDS_M1completeDeny_M1Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern DDS_M1completeDeny_M1*
...
DDS_M1completeDeny_M1PluginSupport_copy_data(
    DDS_M1completeDeny_M1 *out,
    const DDS_M1completeDeny_M1 *in);
...
NDDSUSERDllExport extern RTIBool
DDS_M1completeDeny_M1Plugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
...
NDDSUSERDllExport extern RTIBool 
DDS_M1completeDeny_M1Plugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1completeDeny_M1 * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
DDS_M1completeDeny_M1Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1completeDeny_M1 ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
DDS_M1completeDeny_M1Plugin_new(void);

NDDSUSERDllExport extern void
DDS_M1completeDeny_M1Plugin_delete(struct PRESTypePlugin *);

#define DDS_M1accessGranted_M1Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define DDS_M1accessGranted_M1Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define DDS_M1accessGranted_M1Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define DDS_M1accessGranted_M1Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define DDS_M1accessGranted_M1Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern DDS_M1accessGranted_M1*
...
DDS_M1accessGranted_M1PluginSupport_copy_data(
    DDS_M1accessGranted_M1 *out,
    const DDS_M1accessGranted_M1 *in);
...
NDDSUSERDllExport extern RTIBool
DDS_M1accessGranted_M1Plugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
DDS_M1accessGranted_M1Plugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1accessGranted_M1 * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
DDS_M1accessGranted_M1Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1accessGranted_M1 ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
DDS_M1accessGranted_M1Plugin_new(void);

NDDSUSERDllExport extern void
DDS_M1accessGranted_M1Plugin_delete(struct PRESTypePlugin *);

#define DDS_M1launchCode_M1Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define DDS_M1launchCode_M1Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define DDS_M1launchCode_M1Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define DDS_M1launchCode_M1Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define DDS_M1launchCode_M1Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern DDS_M1launchCode_M1*
...
DDS_M1launchCode_M1PluginSupport_copy_data(
    DDS_M1launchCode_M1 *out,
    const DDS_M1launchCode_M1 *in);
...
NDDSUSERDllExport extern RTIBool
DDS_M1launchCode_M1Plugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
DDS_M1launchCode_M1Plugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1launchCode_M1 * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
DDS_M1launchCode_M1Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1launchCode_M1 ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
DDS_M1launchCode_M1Plugin_new(void);

NDDSUSERDllExport extern void
DDS_M1launchCode_M1Plugin_delete(struct PRESTypePlugin *);

#define DDS_M1ready_M1Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define DDS_M1ready_M1Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define DDS_M1ready_M1Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define DDS_M1ready_M1Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define DDS_M1ready_M1Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern DDS_M1ready_M1*
...
NDDSUSERDllExport extern RTIBool 
DDS_M1ready_M1Plugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1ready_M1 * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
DDS_M1ready_M1Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1ready_M1 ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
DDS_M1ready_M1Plugin_new(void);

NDDSUSERDllExport extern void
DDS_M1ready_M1Plugin_delete(struct PRESTypePlugin *);

#define DDS_M1accessDenied_M1Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define DDS_M1accessDenied_M1Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define DDS_M1accessDenied_M1Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define DDS_M1accessDenied_M1Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define DDS_M1accessDenied_M1Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern DDS_M1accessDenied_M1*
...
DDS_M1accessDenied_M1PluginSupport_copy_data(
    DDS_M1accessDenied_M1 *out,
    const DDS_M1accessDenied_M1 *in);
...
NDDSUSERDllExport extern RTIBool
DDS_M1accessDenied_M1Plugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
DDS_M1accessDenied_M1Plugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1accessDenied_M1 * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
DDS_M1accessDenied_M1Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1accessDenied_M1 ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
DDS_M1accessDenied_M1Plugin_new(void);

NDDSUSERDllExport extern void
DDS_M1accessDenied_M1Plugin_delete(struct PRESTypePlugin *);

#define DDS_M1otherReady_M1Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define DDS_M1otherReady_M1Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define DDS_M1otherReady_M1Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define DDS_M1otherReady_M1Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define DDS_M1otherReady_M1Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern DDS_M1otherReady_M1*
...
DDS_M1otherReady_M1PluginSupport_copy_data(
    DDS_M1otherReady_M1 *out,
    const DDS_M1otherReady_M1 *in);
...
NDDSUSERDllExport extern RTIBool
DDS_M1otherReady_M1Plugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
DDS_M1otherReady_M1Plugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1otherReady_M1 * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
DDS_M1otherReady_M1Plugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    DDS_M1otherReady_M1 ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
DDS_M1otherReady_M1Plugin_new(void);

NDDSUSERDllExport extern void
DDS_M1otherReady_M1Plugin_delete(struct PRESTypePlugin *);
...
#endif /* MUML_DDSPlugin_1362043476_h */
