...
*/
					#define CI_PEER2LAUNCHDELEGATOR 1 /**< Identifier for Component Instance peer2 */
					#define CI_PEER2INPUTIDENTIFICATIONINPUT 2 /**< Identifier for Component Instance peer2Input */
