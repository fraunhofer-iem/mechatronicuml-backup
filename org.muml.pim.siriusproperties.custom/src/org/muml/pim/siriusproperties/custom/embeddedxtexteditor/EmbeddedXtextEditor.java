...
//			XtextResource asStringResource = (XtextResource) fResourceSetProvider.get(null).createResource(URI.createURI("asStringResource." + fFileExtension));
			...
			XtextResource asStringResource = fXtextResourceProvider.get();
			resourceSet.getResources().add(asStringResource);
//			XtextResource asStringResource = new XtextResource();
...
//					XtextResource copyResource = (XtextResource) fResourceSetProvider.get(null).createResource(URI.createURI("copyResource." + fFileExtension));
					XtextResource copyResource = fXtextResourceProvider.get();
//					XtextResource copyResource = new XtextResource();
