...
public class HybridPortBehavior extends AbstractPortBehavior {
	...
	public void handleNotificationEvent(Notification notification) {
		...
		if (feature instanceof EStructuralFeature) {
			...
			if (structuralFeature.getContainerClass() == HybridPort.class) {
				int featureID = notification.getFeatureID(HybridPort.class);
