...
public class MultiPortLayoutListener extends LayoutListener.Stub {
		...
		private AbstractPortBehavior portBehavior;
		
		public MultiPortLayoutListener(AbstractPortBehavior portBehavior) {
		...
		public void postLayout(IFigure container) {
			...
			if (portBehavior.getEditPart().getParent() instanceof AbstractGraphicalEditPart) {
				parentFigure = ((AbstractGraphicalEditPart) portBehavior.getEditPart()
			...
			IBorderItemLocator locator = ((AbstractBorderItemEditPart) portBehavior.getEditPart())
			...
			locator.relocate(portBehavior.getEditPart().getFigure());
			...
			for (Object child : portBehavior.getEditPart().getChildren()) {
			...
			if (toolbarLayout != null) {
				...
				if (toolbarLayout.isHorizontal() != horizontal) {
					...
					portBehavior.updateBorderItemLocator();
