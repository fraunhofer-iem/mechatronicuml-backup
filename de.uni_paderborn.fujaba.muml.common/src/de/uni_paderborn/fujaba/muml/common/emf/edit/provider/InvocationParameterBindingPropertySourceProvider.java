	...
	public class InvocationParameterBindingPropertyDescriptor extends
		...
		public void setPropertyValue(Object object, Object value) {
			...
			if (parameterBinding == null) {
				...
				List<ParameterBinding> newValue = new ArrayList<ParameterBinding>(invocation.getOwnedParameterBindings());
				newValue.add(parameterBinding);
				setFeature(CallsPackage.Literals.INVOCATION__OWNED_PARAMETER_BINDINGS, invocation, newValue);
			}
			...
			setFeature(CallsPackage.Literals.PARAMETER_BINDING__VALUE_EXPRESSION, parameterBinding, valueExpression);
		}
