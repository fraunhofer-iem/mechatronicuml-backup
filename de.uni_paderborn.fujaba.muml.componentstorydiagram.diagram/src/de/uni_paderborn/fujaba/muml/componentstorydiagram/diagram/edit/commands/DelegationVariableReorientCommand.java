...
public class DelegationVariableReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.DelegationVariable) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.DelegationVariable getLink() {
		return (de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.DelegationVariable) getElementToEdit();
	}
