	...
	public static de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.expressions.ComponentStoryDiagramAbstractExpression getExpression(
		...
		if (cached.expressions[index] == null) {
			final String[] exprBodies = new String[] {
					...
					"----Create AssemblyVariable between PortVariables of PartVariables\r\n--not self.eContainer().eContainer().eContainer().eContainer().eContainer().eContainer().eContainer().eContainer().oclIsUndefined()".substring(2).replaceAll("\n--", "\n"), //$NON-NLS-1$
					"----Create AssemblyVariable between PortVariables of different PartVariables\r\n--self.eContainer().eContainer() = oppositeEnd.eContainer().eContainer() and self.eContainer() <> oppositeEnd.eContainer()".substring(2).replaceAll("\n--", "\n"), //$NON-NLS-1$
					"----Start creation of DelegationVariable at PortVariable of ComponentVariable\r\n--self.eContainer().eContainer().eContainer().eContainer().eContainer().eContainer().eContainer().eContainer().oclIsUndefined()".substring(2).replaceAll("\n--", "\n"), //$NON-NLS-1$
					"----End creation of DelegationVariable at PortVariable of PartVariable\r\n--self.eContainer().eContainer().eContainer() = oppositeEnd.eContainer().eContainer()".substring(2).replaceAll("\n--", "\n"), //$NON-NLS-1$
			};
