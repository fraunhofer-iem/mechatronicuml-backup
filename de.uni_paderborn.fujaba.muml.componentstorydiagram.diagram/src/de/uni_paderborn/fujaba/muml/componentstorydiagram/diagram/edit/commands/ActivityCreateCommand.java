...
public class ActivityCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		de.uni_paderborn.fujaba.muml.componentstorydiagram.ComponentStoryRule container = (de.uni_paderborn.fujaba.muml.componentstorydiagram.ComponentStoryRule) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentstorydiagram.ComponentStoryRule owner = (de.uni_paderborn.fujaba.muml.componentstorydiagram.ComponentStoryRule) getElementToEdit();
