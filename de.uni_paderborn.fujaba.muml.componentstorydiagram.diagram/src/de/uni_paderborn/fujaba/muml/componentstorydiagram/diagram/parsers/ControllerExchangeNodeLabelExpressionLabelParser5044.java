 ...
 * @generated
 */
public class ControllerExchangeNodeLabelExpressionLabelParser5044 implements
		IParser, ISemanticParser {
	/**
	 * @generated
	 */
	public ControllerExchangeNodeLabelExpressionLabelParser5044() {
	}
		...
		Object result = de.uni_paderborn.fujaba.muml.componentstorydiagram.diagram.expressions.ComponentStoryDiagramOCLFactory
				.getExpression(
						...
						de.uni_paderborn.fujaba.muml.componentstorydiagram.controlflow.ControlflowPackage.eINSTANCE
								.getControllerExchangeNode(), typeEnv)
				.evaluate(target, env);
