...
public class ElementInitializers {
	...
	public void init_ControllerExchangeNode_3021(
			de.uni_paderborn.fujaba.muml.model.componentstorydiagram.controlflow.ControllerExchangeNode instance) {
		try {
			de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.ComponentStoryPattern newInstance_0_0 = de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.ComponentstorypatternFactory.eINSTANCE
					.createComponentStoryPattern();
			instance.setComponentStoryPattern(newInstance_0_0);
			...
			newInstance_0_0_1_0
					.setBindingSemantics((BindingSemantics) value_0_0_1_0_2);
			de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.PartVariable newInstance_0_0_1_0_3_0 = de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.ComponentstorypatternFactory.eINSTANCE
					.createPartVariable();
			newInstance_0_0_1_0.getPartVariables().add(newInstance_0_0_1_0_3_0);
			Object value_0_0_1_0_3_0_0 = de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.expressions.ComponentStoryDiagramOCLFactory
					.getExpression(
							12,
							de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.ComponentstorypatternPackage.eINSTANCE
			...
			value_0_0_1_0_3_0_0 = de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.expressions.ComponentStoryDiagramAbstractExpression
			...
			de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.PartVariable newInstance_0_0_1_0_3_1 = de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.ComponentstorypatternFactory.eINSTANCE
					.createPartVariable();
			newInstance_0_0_1_0.getPartVariables().add(newInstance_0_0_1_0_3_1);
			Object value_0_0_1_0_3_1_0 = de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.expressions.ComponentStoryDiagramOCLFactory
					.getExpression(
							13,
							de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.ComponentstorypatternPackage.eINSTANCE
									.getPartVariable(), null).evaluate(
			...
			value_0_0_1_0_3_1_0 = de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.expressions.ComponentStoryDiagramAbstractExpression
