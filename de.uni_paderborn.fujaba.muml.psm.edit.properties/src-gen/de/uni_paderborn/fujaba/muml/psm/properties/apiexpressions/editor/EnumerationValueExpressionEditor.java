...
public class EnumerationValueExpressionEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorEnumValue_PSMTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorEnumValue_PSMTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorEnumValue_PSMTab_Editor() {
		if (this.editorEnumValue_PSMTab == null) {
			...
			this.editorEnumValue_PSMTab = editor;
		}
		return this.editorEnumValue_PSMTab;
	}
