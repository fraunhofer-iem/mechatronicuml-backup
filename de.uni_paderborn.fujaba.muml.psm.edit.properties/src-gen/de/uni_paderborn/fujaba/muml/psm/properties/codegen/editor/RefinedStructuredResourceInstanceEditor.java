...
public class RefinedStructuredResourceInstanceEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorAllocatedAtomicComponentInstances_PSMTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorAllocatedAtomicComponentInstances_PSMTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorAllocatedAtomicComponentInstances_PSMTab_Editor() {
		if (this.editorAllocatedAtomicComponentInstances_PSMTab == null) {
			...
			this.editorAllocatedAtomicComponentInstances_PSMTab = editor;
		}
		return this.editorAllocatedAtomicComponentInstances_PSMTab;
	}
	...
	public RefinedStructuredResourceInstanceEditor(String tab) {
		this(tab, de.uni_paderborn.fujaba.muml.psm.properties.util.PropertiesUtil.INSTANCE.getAdapterFactory(),
				de.uni_paderborn.fujaba.muml.psm.codegen.CodegenPackage.eINSTANCE
