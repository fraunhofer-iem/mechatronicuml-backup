 ...
 * @generated
 */
public class MessageTypeDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	private static MessageTypeDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.messagetype.diagram.part.MumlDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.messagetype.diagram.providers.ElementInitializers initializers;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.messagetype.diagram.expressions.MumlOCLFactory oclFactory;

	/**
	 * @generated
	 */
	public MessageTypeDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static MessageTypeDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.messagetype.diagram.part.MumlDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.muml.messagetype.diagram.part.MumlDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.messagetype.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.muml.messagetype.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.messagetype.diagram.expressions.MumlOCLFactory getMumlOCLFactory() {
		return oclFactory;
	}
	...
	public void setMumlOCLFactory(
			de.uni_paderborn.fujaba.muml.messagetype.diagram.expressions.MumlOCLFactory f) {
		this.oclFactory = f;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, MessageTypeDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, MessageTypeDiagramEditorPlugin.ID,
