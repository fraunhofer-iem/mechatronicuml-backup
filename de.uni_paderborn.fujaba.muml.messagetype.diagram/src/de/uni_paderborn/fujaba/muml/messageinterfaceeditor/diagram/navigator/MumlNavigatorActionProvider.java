	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof de.uni_paderborn.fujaba.muml.messageinterfaceeditor.diagram.navigator.MumlNavigatorItem) {
					selectedElement = ((de.uni_paderborn.fujaba.muml.messageinterfaceeditor.diagram.navigator.MumlNavigatorItem) selectedElement)
							.getView();
