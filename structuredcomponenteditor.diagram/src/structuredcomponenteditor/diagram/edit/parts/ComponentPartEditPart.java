...
import structuredcomponenteditor.diagram.edit.policies.ComponentPartCanonicalEditPolicy;
import structuredcomponenteditor.diagram.edit.policies.ComponentPartItemSemanticEditPolicy;
...
public class ComponentPartEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComponentPartItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ComponentPartCanonicalEditPolicy());
