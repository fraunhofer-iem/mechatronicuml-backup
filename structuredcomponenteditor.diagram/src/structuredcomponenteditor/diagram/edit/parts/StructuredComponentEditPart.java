...
import structuredcomponenteditor.diagram.edit.policies.StructuredComponentCanonicalEditPolicy;
import structuredcomponenteditor.diagram.edit.policies.StructuredComponentItemSemanticEditPolicy;
...
public class StructuredComponentEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StructuredComponentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new StructuredComponentCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StructuredComponentNameEditPart) {
			((StructuredComponentNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(StructuredcomponentVisualIDRegistry
