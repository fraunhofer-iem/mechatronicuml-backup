	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case StructuredComponentDiagramEditPart.VISUAL_ID:
				return new StructuredComponentDiagramEditPart(view);

			case StructuredComponentEditPart.VISUAL_ID:
				return new StructuredComponentEditPart(view);

			case StructuredComponentNameEditPart.VISUAL_ID:
				return new StructuredComponentNameEditPart(view);
