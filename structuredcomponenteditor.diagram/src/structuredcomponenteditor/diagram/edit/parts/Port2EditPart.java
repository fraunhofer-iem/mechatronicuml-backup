...
import structuredcomponenteditor.diagram.edit.policies.Port2ItemSemanticEditPolicy;
...
public class Port2EditPart extends AbstractBorderItemEditPart {
	...
	public void activate() {
		...
		if (parentEditPart instanceof ComponentPartEditPart) {
			IFigure figure = ((ComponentPartEditPart) parentEditPart).getFigure();
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Port2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof structuredcomponenteditor.diagram.edit.parts.Port2EditPart) {
			types.add(StructuredcomponentElementTypes.Delegation_4001);
		}
		if (targetEditPart instanceof PortEditPart) {
			types.add(StructuredcomponentElementTypes.Assembly_4002);
