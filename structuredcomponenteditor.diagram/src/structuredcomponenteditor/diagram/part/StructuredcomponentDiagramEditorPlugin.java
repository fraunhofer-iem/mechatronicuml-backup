...
import structuredcomponenteditor.diagram.providers.ElementInitializers;
import structuredcomponenteditor.provider.ComponenteditorItemProviderAdapterFactory;
...
public class StructuredcomponentDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "structuredcomponenteditor.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private StructuredcomponentDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private StructuredcomponentBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories.add(new ComponenteditorItemProviderAdapterFactory());
	 ...
	 * @generated
	 */
	public StructuredcomponentDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new StructuredcomponentDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public StructuredcomponentBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			StructuredcomponentBaseItemSemanticEditPolicy.LinkConstraints lc) {
