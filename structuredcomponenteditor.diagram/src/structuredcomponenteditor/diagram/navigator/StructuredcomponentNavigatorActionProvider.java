...
import structuredcomponenteditor.diagram.part.StructuredcomponentDiagramEditor;
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof StructuredcomponentNavigatorItem) {
					selectedElement = ((StructuredcomponentNavigatorItem) selectedElement)
							.getView();
