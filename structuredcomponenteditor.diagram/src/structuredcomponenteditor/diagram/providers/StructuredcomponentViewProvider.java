...
public class StructuredcomponentViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return StructuredComponentDiagramEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = StructuredcomponentVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = StructuredcomponentVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!StructuredcomponentElementTypes
				...
				if (domainElement != null
						&& visualID != StructuredcomponentVisualIDRegistry
				...
				if (!StructuredComponentDiagramEditPart.MODEL_ID
						.equals(StructuredcomponentVisualIDRegistry
		...
		return StructuredComponentEditPart.VISUAL_ID == visualID
				|| PortEditPart.VISUAL_ID == visualID
				|| ComponentPartEditPart.VISUAL_ID == visualID
				|| Port2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op
				.getSemanticAdapter());
		if (!StructuredcomponentElementTypes.isKnownElementType(elementType)
				|| (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		...
		int visualID = StructuredcomponentVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(StructuredComponentDiagramEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (StructuredcomponentVisualIDRegistry
				.getVisualID(elementTypeHint)) {
	...
	public Node createStructuredComponent_2001(EObject domainElement,
		...
		node.setType(StructuredcomponentVisualIDRegistry
	...
	public Edge createDelegation_4001(EObject domainElement,
		...
		edge.setType(StructuredcomponentVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!StructuredComponentDiagramEditPart.MODEL_ID
			...
			shortcutAnnotation.getDetails().put(
					"modelID", StructuredComponentDiagramEditPart.MODEL_ID); //$NON-NLS-1$
