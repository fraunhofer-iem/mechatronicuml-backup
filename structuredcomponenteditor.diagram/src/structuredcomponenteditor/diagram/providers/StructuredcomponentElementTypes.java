...
public class StructuredcomponentElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType StructuredComponentDiagram_1000 = getElementType("structuredcomponenteditor.diagram.StructuredComponentDiagram_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType StructuredComponent_2001 = getElementType("structuredcomponenteditor.diagram.StructuredComponent_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Port_3001 = getElementType("structuredcomponenteditor.diagram.Port_3001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ComponentPart_3002 = getElementType("structuredcomponenteditor.diagram.ComponentPart_3002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Port_3003 = getElementType("structuredcomponenteditor.diagram.Port_3003"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Delegation_4001 = getElementType("structuredcomponenteditor.diagram.Delegation_4001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Assembly_4002 = getElementType("structuredcomponenteditor.diagram.Assembly_4002"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(StructuredComponentDiagram_1000,
					ComponenteditorPackage.eINSTANCE
