...
import structuredcomponenteditor.diagram.parsers.MessageFormatParser;
...
public class StructuredcomponentParserProvider extends AbstractProvider
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(StructuredcomponentVisualIDRegistry
					.getVisualID(vid));
		}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (StructuredcomponentElementTypes.getElement(hint) == null) {
				return false;
			}
