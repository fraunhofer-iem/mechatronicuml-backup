...
public class ModelinstanceFactoryImpl extends EFactoryImpl implements ModelinstanceFactory {
	...
	public static ModelinstanceFactory init() {
		try {
			ModelinstanceFactory theModelinstanceFactory = (ModelinstanceFactory)EPackage.Registry.INSTANCE.getEFactory("http:///de/uni_paderborn/fujaba/umlrt/modelinstance"); 
