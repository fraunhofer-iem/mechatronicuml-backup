...
import de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.custom.commands.HWPlatformInstanceCreateCommand;
...
public class CustomHWPlatformInstanceConfigurationSemanticEditPolicy extends HWPlatformInstanceConfigurationItemSemanticEditPolicy{
	...
	if (de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.providers.HardwareElementTypes.HWPlatformInstance_2001 == req
				.getElementType()) {
