...
public class ExpressionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExpressionPackage.ACTIVITY_CALL_EXPRESSION: {
			...
			case ExpressionPackage.RECONFIGURATION_RULE_CALL_EXPRESSION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Reconfiguration Rule Call Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reconfiguration Rule Call Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
