 ...
 * <ul>
 *   <li>{@link de.fujaba.properties.Reconciler#isEnabled <em>Enabled</em>}</li>
 *   <li>{@link de.fujaba.properties.Reconciler#isReconcilePackages <em>Reconcile Packages</em>}</li>
 *   <li>{@link de.fujaba.properties.Reconciler#isReconcileClasses <em>Reconcile Classes</em>}</li>
 *   <li>{@link de.fujaba.properties.Reconciler#isReconcileProperties <em>Reconcile Properties</em>}</li>
 *   <li>{@link de.fujaba.properties.Reconciler#getCustomTransformations <em>Custom Transformations</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.fujaba.properties.PropertiesPackage#getReconciler()
 * @model
 * @generated
 */
public interface Reconciler extends EObject {
	 ...
	 * @see de.fujaba.properties.PropertiesPackage#getReconciler_Enabled()
	...
	/**
	 * Sets the value of the '{@link de.fujaba.properties.Reconciler#isEnabled <em>Enabled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.fujaba.properties.PropertiesPackage#getReconciler_ReconcilePackages()
	 * @model default="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.fujaba.properties.Reconciler#isReconcilePackages <em>Reconcile Packages</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.fujaba.properties.PropertiesPackage#getReconciler_ReconcileClasses()
	 * @model default="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.fujaba.properties.Reconciler#isReconcileClasses <em>Reconcile Classes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.fujaba.properties.PropertiesPackage#getReconciler_ReconcileProperties()
	 * @model default="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.fujaba.properties.Reconciler#isReconcileProperties <em>Reconcile Properties</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.fujaba.properties.CustomTransformation}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.fujaba.properties.PropertiesPackage#getReconciler_CustomTransformations()
