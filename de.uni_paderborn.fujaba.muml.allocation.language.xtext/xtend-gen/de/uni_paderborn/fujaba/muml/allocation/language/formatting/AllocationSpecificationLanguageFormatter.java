 ...
 * generated by Xtext
 */
package de.uni_paderborn.fujaba.muml.allocation.language.formatting;
...
public class AllocationSpecificationLanguageFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private AllocationSpecificationLanguageGrammarAccess _allocationSpecificationLanguageGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._allocationSpecificationLanguageGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._allocationSpecificationLanguageGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._allocationSpecificationLanguageGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._allocationSpecificationLanguageGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._allocationSpecificationLanguageGrammarAccess.getML_COMMENTRule();
