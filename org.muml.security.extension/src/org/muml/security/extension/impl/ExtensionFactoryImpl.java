...
import org.muml.security.extension.*;
...
public class ExtensionFactoryImpl extends EFactoryImpl implements ExtensionFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExtensionPackage.SECURITY_EXTENSION: return createSecurityExtension();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ExtensionPackage.SENSITIVITY:
				return createsensitivityFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case ExtensionPackage.SENSITIVITY:
				return convertsensitivityToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public sensitivity createsensitivityFromString(EDataType eDataType, String initialValue) {
		sensitivity result = sensitivity.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertsensitivityToString(EDataType eDataType, Object instanceValue) {
