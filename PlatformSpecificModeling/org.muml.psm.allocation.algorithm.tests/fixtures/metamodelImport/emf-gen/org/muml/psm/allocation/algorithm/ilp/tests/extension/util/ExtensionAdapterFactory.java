...
public class ExtensionAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExtensionSwitch<Adapter> modelSwitch =
		new ExtensionSwitch<Adapter>() {
			@Override
			public Adapter caseMemoryExtension(MemoryExtension object) {
				return createMemoryExtensionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.psm.allocation.algorithm.ilp.tests.extension.MemoryExtension <em>Memory Extension</em>}'.
	 * <!-- begin-user-doc -->
