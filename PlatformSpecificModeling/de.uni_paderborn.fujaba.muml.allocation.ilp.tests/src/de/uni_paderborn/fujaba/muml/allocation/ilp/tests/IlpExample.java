...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ilp</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class IlpExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ilp"));
				IntegerLinearProgram root = IlpFactory.eINSTANCE.createIntegerLinearProgram();
