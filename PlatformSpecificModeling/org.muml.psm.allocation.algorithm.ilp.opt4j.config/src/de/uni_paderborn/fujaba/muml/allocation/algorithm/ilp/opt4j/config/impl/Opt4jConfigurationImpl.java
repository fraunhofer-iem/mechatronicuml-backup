/**
 */
package de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.impl;

import de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.ConfigPackage;
import de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.Opt4jConfiguration;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.impl.Opt4jConfigurationImpl#getPopulationSize <em>Population Size</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.impl.Opt4jConfigurationImpl#getGenerations <em>Generations</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.impl.Opt4jConfigurationImpl#getParents <em>Parents</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.impl.Opt4jConfigurationImpl#getOffspring <em>Offspring</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.algorithm.ilp.opt4j.config.impl.Opt4jConfigurationImpl#isNoDominatedSolutions <em>No Dominated Solutions</em>}</li>
 * </ul>
 *
 * @generated
 */
