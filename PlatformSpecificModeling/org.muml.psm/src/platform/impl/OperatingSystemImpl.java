 ...
 * </p>
 * <ul>
 *   <li>{@link platform.impl.OperatingSystemImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link platform.impl.OperatingSystemImpl#getApirepositories <em>Apirepositories</em>}</li>
 *   <li>{@link platform.impl.OperatingSystemImpl#getEnumerationDataTypes <em>Enumeration Data Types</em>}</li>
 *   <li>{@link platform.impl.OperatingSystemImpl#getImports <em>Imports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperatingSystemImpl extends NamedElementImpl implements OperatingSystem {
	...
	protected EClass eStaticClass() {
		return PlatformPackage.Literals.OPERATING_SYSTEM;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.OPERATING_SYSTEM__COMMENT, oldComment, comment));
	}
	...
	public EList<APIRepository> getApirepositories() {
		if (apirepositories == null) {
			apirepositories = new EObjectContainmentWithInverseEList<APIRepository>(APIRepository.class, this, PlatformPackage.OPERATING_SYSTEM__APIREPOSITORIES, PlatformPackage.API_REPOSITORY__SW_PLATFORM);
		}
	...
	public EList<EnumerationDataType> getEnumerationDataTypes() {
		if (enumerationDataTypes == null) {
			enumerationDataTypes = new EObjectContainmentEList<EnumerationDataType>(EnumerationDataType.class, this, PlatformPackage.OPERATING_SYSTEM__ENUMERATION_DATA_TYPES);
		}
	...
	public EList<Import> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<Import>(Import.class, this, PlatformPackage.OPERATING_SYSTEM__IMPORTS);
		}
		return imports;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlatformPackage.OPERATING_SYSTEM__APIREPOSITORIES:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case PlatformPackage.OPERATING_SYSTEM__ENUMERATION_DATA_TYPES:
				return ((InternalEList<?>)getEnumerationDataTypes()).basicRemove(otherEnd, msgs);
			case PlatformPackage.OPERATING_SYSTEM__IMPORTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PlatformPackage.OPERATING_SYSTEM__COMMENT:
				return getComment();
			case PlatformPackage.OPERATING_SYSTEM__APIREPOSITORIES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CommentableElement.class) {
			switch (derivedFeatureID) {
				case PlatformPackage.OPERATING_SYSTEM__COMMENT: return CorePackage.COMMENTABLE_ELEMENT__COMMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CommentableElement.class) {
			switch (baseFeatureID) {
				case CorePackage.COMMENTABLE_ELEMENT__COMMENT: return PlatformPackage.OPERATING_SYSTEM__COMMENT;
				default: return -1;
			}
		}
