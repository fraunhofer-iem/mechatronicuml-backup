 ...
 * @generated
 */
public class AllocationNavigatorContentProvider implements
	...
	public AllocationNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem> result = new ArrayList<de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem>();
		...
		if (parentElement instanceof de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorGroup) {
			de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorGroup group = (de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem) {
			de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem navigatorItem = (de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case de.uni_paderborn.fujaba.muml.deployment.diagram.edit.parts.DeploymentEditPart.VISUAL_ID: {
			...
			de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorGroup links = new de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorGroup(
	 ...
	 * @generated
	 */
	private Collection<de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem> result = new ArrayList<de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationNavigatorItem(
	...
	public Object getParent(Object element) {
		if (element instanceof de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationAbstractNavigatorItem) {
			de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationAbstractNavigatorItem abstractNavigatorItem = (de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.AllocationAbstractNavigatorItem) element;
