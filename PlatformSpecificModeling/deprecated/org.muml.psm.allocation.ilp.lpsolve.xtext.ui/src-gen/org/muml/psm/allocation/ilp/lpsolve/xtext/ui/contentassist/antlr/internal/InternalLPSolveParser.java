...
public class InternalLPSolveParser extends AbstractInternalContentAssistParser {
    ...
    // InternalLPSolve.g:472:1: ruleComparingOperator : ( ( rule__ComparingOperator__Alternatives ) ) ;
    public final void ruleComparingOperator() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:476:1: ( ( ( rule__ComparingOperator__Alternatives ) ) )
            // InternalLPSolve.g:477:1: ( ( rule__ComparingOperator__Alternatives ) )
            {
            // InternalLPSolve.g:477:1: ( ( rule__ComparingOperator__Alternatives ) )
            // InternalLPSolve.g:478:1: ( rule__ComparingOperator__Alternatives )
            {
             before(grammarAccess.getComparingOperatorAccess().getAlternatives()); 
            // InternalLPSolve.g:479:1: ( rule__ComparingOperator__Alternatives )
            // InternalLPSolve.g:479:2: rule__ComparingOperator__Alternatives
            {
            pushFollow(FollowSets000.FOLLOW_2);
        ...
        try {
            ...
            if ( (LA1_0==12) ) {
                ...
                if ( (LA1_1==24) ) {
                    ...
                    if ( ((LA1_3>=RULE_ID && LA1_3<=RULE_INT)||LA1_3==23) ) {
                        alt1=2;
                    }
                    else if ( (LA1_3==25) ) {
                        alt1=1;
    ...
    // InternalLPSolve.g:686:1: rule__ComparingOperator__Alternatives : ( ( ( '=' ) ) | ( ( '>' ) ) | ( ( '>=' ) ) | ( ( '<' ) ) | ( ( '<=' ) ) );
        ...
        try {
            ...
            switch (alt7) {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalLPSolve.g:712:6: ( ( '<' ) )
                    {
                    // InternalLPSolve.g:712:6: ( ( '<' ) )
                    // InternalLPSolve.g:713:1: ( '<' )
                    {
                     before(grammarAccess.getComparingOperatorAccess().getLESSEnumLiteralDeclaration_3()); 
                    // InternalLPSolve.g:714:1: ( '<' )
                    // InternalLPSolve.g:714:3: '<'
                    {
                    ...
                    break;
                case 5 :
                    // InternalLPSolve.g:719:6: ( ( '<=' ) )
                    {
                    // InternalLPSolve.g:719:6: ( ( '<=' ) )
                    // InternalLPSolve.g:720:1: ( '<=' )
                    {
                     before(grammarAccess.getComparingOperatorAccess().getLESS_OR_EQUALEnumLiteralDeclaration_4()); 
                    // InternalLPSolve.g:721:1: ( '<=' )
                    // InternalLPSolve.g:721:3: '<='
                    {
    ...
    // InternalLPSolve.g:731:1: rule__ILPDataType__Alternatives : ( ( ( 'bin' ) ) | ( ( 'int' ) ) | ( ( 'real' ) ) );
    public final void rule__ILPDataType__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:735:1: ( ( ( 'bin' ) ) | ( ( 'int' ) ) | ( ( 'real' ) ) )
            int alt8=3;
            switch ( input.LA(1) ) {
            case 19:
                {
            ...
            switch (alt8) {
                case 1 :
                    // InternalLPSolve.g:736:1: ( ( 'bin' ) )
                    {
                    // InternalLPSolve.g:736:1: ( ( 'bin' ) )
                    // InternalLPSolve.g:737:1: ( 'bin' )
                    {
                     before(grammarAccess.getILPDataTypeAccess().getBINARYEnumLiteralDeclaration_0()); 
                    // InternalLPSolve.g:738:1: ( 'bin' )
                    // InternalLPSolve.g:738:3: 'bin'
                    {
                    ...
                    break;
                case 2 :
                    // InternalLPSolve.g:743:6: ( ( 'int' ) )
                    {
                    // InternalLPSolve.g:743:6: ( ( 'int' ) )
                    // InternalLPSolve.g:744:1: ( 'int' )
                    {
                     before(grammarAccess.getILPDataTypeAccess().getINTEGEREnumLiteralDeclaration_1()); 
                    // InternalLPSolve.g:745:1: ( 'int' )
                    // InternalLPSolve.g:745:3: 'int'
                    {
                    ...
                    break;
                case 3 :
                    // InternalLPSolve.g:750:6: ( ( 'real' ) )
                    {
                    // InternalLPSolve.g:750:6: ( ( 'real' ) )
                    // InternalLPSolve.g:751:1: ( 'real' )
                    {
                     before(grammarAccess.getILPDataTypeAccess().getREALEnumLiteralDeclaration_2()); 
                    // InternalLPSolve.g:752:1: ( 'real' )
                    // InternalLPSolve.g:752:3: 'real'
                    {
    ...
    // InternalLPSolve.g:762:1: rule__AdditionOperator__Alternatives : ( ( ( '+' ) ) | ( ( '-' ) ) );
    public final void rule__AdditionOperator__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:766:1: ( ( ( '+' ) ) | ( ( '-' ) ) )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalLPSolve.g:767:1: ( ( '+' ) )
                    {
                    // InternalLPSolve.g:767:1: ( ( '+' ) )
                    // InternalLPSolve.g:768:1: ( '+' )
                    {
                     before(grammarAccess.getAdditionOperatorAccess().getPLUSEnumLiteralDeclaration_0()); 
                    // InternalLPSolve.g:769:1: ( '+' )
                    // InternalLPSolve.g:769:3: '+'
                    {
                    ...
                    break;
                case 2 :
                    // InternalLPSolve.g:774:6: ( ( '-' ) )
                    {
                    // InternalLPSolve.g:774:6: ( ( '-' ) )
                    // InternalLPSolve.g:775:1: ( '-' )
                    {
                     before(grammarAccess.getAdditionOperatorAccess().getMINUSEnumLiteralDeclaration_1()); 
                    // InternalLPSolve.g:776:1: ( '-' )
                    // InternalLPSolve.g:776:3: '-'
                    {
    ...
    // InternalLPSolve.g:788:1: rule__IntegerLinearProgram__Group__0 : rule__IntegerLinearProgram__Group__0__Impl rule__IntegerLinearProgram__Group__1 ;
    public final void rule__IntegerLinearProgram__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:792:1: ( rule__IntegerLinearProgram__Group__0__Impl rule__IntegerLinearProgram__Group__1 )
            // InternalLPSolve.g:793:2: rule__IntegerLinearProgram__Group__0__Impl rule__IntegerLinearProgram__Group__1
            {
    ...
    // InternalLPSolve.g:800:1: rule__IntegerLinearProgram__Group__0__Impl : ( ( rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0 ) ) ;
    public final void rule__IntegerLinearProgram__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:804:1: ( ( ( rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0 ) ) )
            // InternalLPSolve.g:805:1: ( ( rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0 ) )
            {
            // InternalLPSolve.g:805:1: ( ( rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0 ) )
            // InternalLPSolve.g:806:1: ( rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0 )
            {
             before(grammarAccess.getIntegerLinearProgramAccess().getObjectiveFunctionAssignment_0()); 
            // InternalLPSolve.g:807:1: ( rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0 )
            // InternalLPSolve.g:807:2: rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:817:1: rule__IntegerLinearProgram__Group__1 : rule__IntegerLinearProgram__Group__1__Impl rule__IntegerLinearProgram__Group__2 ;
    public final void rule__IntegerLinearProgram__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:821:1: ( rule__IntegerLinearProgram__Group__1__Impl rule__IntegerLinearProgram__Group__2 )
            // InternalLPSolve.g:822:2: rule__IntegerLinearProgram__Group__1__Impl rule__IntegerLinearProgram__Group__2
            {
            pushFollow(FollowSets000.FOLLOW_3);
    ...
    // InternalLPSolve.g:829:1: rule__IntegerLinearProgram__Group__1__Impl : ( ( rule__IntegerLinearProgram__ConstraintsAssignment_1 )* ) ;
    public final void rule__IntegerLinearProgram__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:833:1: ( ( ( rule__IntegerLinearProgram__ConstraintsAssignment_1 )* ) )
            // InternalLPSolve.g:834:1: ( ( rule__IntegerLinearProgram__ConstraintsAssignment_1 )* )
            {
            // InternalLPSolve.g:834:1: ( ( rule__IntegerLinearProgram__ConstraintsAssignment_1 )* )
            // InternalLPSolve.g:835:1: ( rule__IntegerLinearProgram__ConstraintsAssignment_1 )*
            {
             before(grammarAccess.getIntegerLinearProgramAccess().getConstraintsAssignment_1()); 
            // InternalLPSolve.g:836:1: ( rule__IntegerLinearProgram__ConstraintsAssignment_1 )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalLPSolve.g:836:2: rule__IntegerLinearProgram__ConstraintsAssignment_1
            	    {
    ...
    // InternalLPSolve.g:846:1: rule__IntegerLinearProgram__Group__2 : rule__IntegerLinearProgram__Group__2__Impl ;
    public final void rule__IntegerLinearProgram__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:850:1: ( rule__IntegerLinearProgram__Group__2__Impl )
            // InternalLPSolve.g:851:2: rule__IntegerLinearProgram__Group__2__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:857:1: rule__IntegerLinearProgram__Group__2__Impl : ( ( rule__IntegerLinearProgram__VariablesAssignment_2 )* ) ;
    public final void rule__IntegerLinearProgram__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:861:1: ( ( ( rule__IntegerLinearProgram__VariablesAssignment_2 )* ) )
            // InternalLPSolve.g:862:1: ( ( rule__IntegerLinearProgram__VariablesAssignment_2 )* )
            {
            // InternalLPSolve.g:862:1: ( ( rule__IntegerLinearProgram__VariablesAssignment_2 )* )
            // InternalLPSolve.g:863:1: ( rule__IntegerLinearProgram__VariablesAssignment_2 )*
            {
             before(grammarAccess.getIntegerLinearProgramAccess().getVariablesAssignment_2()); 
            // InternalLPSolve.g:864:1: ( rule__IntegerLinearProgram__VariablesAssignment_2 )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // InternalLPSolve.g:864:2: rule__IntegerLinearProgram__VariablesAssignment_2
            	    {
    ...
    // InternalLPSolve.g:880:1: rule__ObjectiveFunctionExpression__Group_0__0 : rule__ObjectiveFunctionExpression__Group_0__0__Impl rule__ObjectiveFunctionExpression__Group_0__1 ;
    public final void rule__ObjectiveFunctionExpression__Group_0__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:884:1: ( rule__ObjectiveFunctionExpression__Group_0__0__Impl rule__ObjectiveFunctionExpression__Group_0__1 )
            // InternalLPSolve.g:885:2: rule__ObjectiveFunctionExpression__Group_0__0__Impl rule__ObjectiveFunctionExpression__Group_0__1
            {
    ...
    // InternalLPSolve.g:892:1: rule__ObjectiveFunctionExpression__Group_0__0__Impl : ( ( rule__ObjectiveFunctionExpression__Alternatives_0_0 ) ) ;
    public final void rule__ObjectiveFunctionExpression__Group_0__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:896:1: ( ( ( rule__ObjectiveFunctionExpression__Alternatives_0_0 ) ) )
            // InternalLPSolve.g:897:1: ( ( rule__ObjectiveFunctionExpression__Alternatives_0_0 ) )
            {
            // InternalLPSolve.g:897:1: ( ( rule__ObjectiveFunctionExpression__Alternatives_0_0 ) )
            // InternalLPSolve.g:898:1: ( rule__ObjectiveFunctionExpression__Alternatives_0_0 )
            {
             before(grammarAccess.getObjectiveFunctionExpressionAccess().getAlternatives_0_0()); 
            // InternalLPSolve.g:899:1: ( rule__ObjectiveFunctionExpression__Alternatives_0_0 )
            // InternalLPSolve.g:899:2: rule__ObjectiveFunctionExpression__Alternatives_0_0
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:909:1: rule__ObjectiveFunctionExpression__Group_0__1 : rule__ObjectiveFunctionExpression__Group_0__1__Impl rule__ObjectiveFunctionExpression__Group_0__2 ;
    public final void rule__ObjectiveFunctionExpression__Group_0__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:913:1: ( rule__ObjectiveFunctionExpression__Group_0__1__Impl rule__ObjectiveFunctionExpression__Group_0__2 )
            // InternalLPSolve.g:914:2: rule__ObjectiveFunctionExpression__Group_0__1__Impl rule__ObjectiveFunctionExpression__Group_0__2
            {
    ...
    // InternalLPSolve.g:921:1: rule__ObjectiveFunctionExpression__Group_0__1__Impl : ( ':' ) ;
    public final void rule__ObjectiveFunctionExpression__Group_0__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:925:1: ( ( ':' ) )
            // InternalLPSolve.g:926:1: ( ':' )
            {
            // InternalLPSolve.g:926:1: ( ':' )
            // InternalLPSolve.g:927:1: ':'
            {
    ...
    // InternalLPSolve.g:940:1: rule__ObjectiveFunctionExpression__Group_0__2 : rule__ObjectiveFunctionExpression__Group_0__2__Impl ;
    public final void rule__ObjectiveFunctionExpression__Group_0__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:944:1: ( rule__ObjectiveFunctionExpression__Group_0__2__Impl )
            // InternalLPSolve.g:945:2: rule__ObjectiveFunctionExpression__Group_0__2__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:951:1: rule__ObjectiveFunctionExpression__Group_0__2__Impl : ( ';' ) ;
    public final void rule__ObjectiveFunctionExpression__Group_0__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:955:1: ( ( ';' ) )
            // InternalLPSolve.g:956:1: ( ';' )
            {
            // InternalLPSolve.g:956:1: ( ';' )
            // InternalLPSolve.g:957:1: ';'
            {
    ...
    // InternalLPSolve.g:976:1: rule__ObjectiveFunctionExpression__Group_1__0 : rule__ObjectiveFunctionExpression__Group_1__0__Impl rule__ObjectiveFunctionExpression__Group_1__1 ;
    public final void rule__ObjectiveFunctionExpression__Group_1__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:980:1: ( rule__ObjectiveFunctionExpression__Group_1__0__Impl rule__ObjectiveFunctionExpression__Group_1__1 )
            // InternalLPSolve.g:981:2: rule__ObjectiveFunctionExpression__Group_1__0__Impl rule__ObjectiveFunctionExpression__Group_1__1
            {
            pushFollow(FollowSets000.FOLLOW_6);
    ...
    // InternalLPSolve.g:988:1: rule__ObjectiveFunctionExpression__Group_1__0__Impl : ( ( rule__ObjectiveFunctionExpression__GoalAssignment_1_0 ) ) ;
    public final void rule__ObjectiveFunctionExpression__Group_1__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:992:1: ( ( ( rule__ObjectiveFunctionExpression__GoalAssignment_1_0 ) ) )
            // InternalLPSolve.g:993:1: ( ( rule__ObjectiveFunctionExpression__GoalAssignment_1_0 ) )
            {
            // InternalLPSolve.g:993:1: ( ( rule__ObjectiveFunctionExpression__GoalAssignment_1_0 ) )
            // InternalLPSolve.g:994:1: ( rule__ObjectiveFunctionExpression__GoalAssignment_1_0 )
            {
             before(grammarAccess.getObjectiveFunctionExpressionAccess().getGoalAssignment_1_0()); 
            // InternalLPSolve.g:995:1: ( rule__ObjectiveFunctionExpression__GoalAssignment_1_0 )
            // InternalLPSolve.g:995:2: rule__ObjectiveFunctionExpression__GoalAssignment_1_0
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1005:1: rule__ObjectiveFunctionExpression__Group_1__1 : rule__ObjectiveFunctionExpression__Group_1__1__Impl rule__ObjectiveFunctionExpression__Group_1__2 ;
    public final void rule__ObjectiveFunctionExpression__Group_1__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1009:1: ( rule__ObjectiveFunctionExpression__Group_1__1__Impl rule__ObjectiveFunctionExpression__Group_1__2 )
            // InternalLPSolve.g:1010:2: rule__ObjectiveFunctionExpression__Group_1__1__Impl rule__ObjectiveFunctionExpression__Group_1__2
            {
    ...
    // InternalLPSolve.g:1017:1: rule__ObjectiveFunctionExpression__Group_1__1__Impl : ( ':' ) ;
    public final void rule__ObjectiveFunctionExpression__Group_1__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1021:1: ( ( ':' ) )
            // InternalLPSolve.g:1022:1: ( ':' )
            {
            // InternalLPSolve.g:1022:1: ( ':' )
            // InternalLPSolve.g:1023:1: ':'
            {
    ...
    // InternalLPSolve.g:1036:1: rule__ObjectiveFunctionExpression__Group_1__2 : rule__ObjectiveFunctionExpression__Group_1__2__Impl rule__ObjectiveFunctionExpression__Group_1__3 ;
    public final void rule__ObjectiveFunctionExpression__Group_1__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1040:1: ( rule__ObjectiveFunctionExpression__Group_1__2__Impl rule__ObjectiveFunctionExpression__Group_1__3 )
            // InternalLPSolve.g:1041:2: rule__ObjectiveFunctionExpression__Group_1__2__Impl rule__ObjectiveFunctionExpression__Group_1__3
            {
            pushFollow(FollowSets000.FOLLOW_7);
    ...
    // InternalLPSolve.g:1048:1: rule__ObjectiveFunctionExpression__Group_1__2__Impl : ( ( rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2 ) ) ;
    public final void rule__ObjectiveFunctionExpression__Group_1__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1052:1: ( ( ( rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2 ) ) )
            // InternalLPSolve.g:1053:1: ( ( rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2 ) )
            {
            // InternalLPSolve.g:1053:1: ( ( rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2 ) )
            // InternalLPSolve.g:1054:1: ( rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2 )
            {
             before(grammarAccess.getObjectiveFunctionExpressionAccess().getObjectiveFunctionAssignment_1_2()); 
            // InternalLPSolve.g:1055:1: ( rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2 )
            // InternalLPSolve.g:1055:2: rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1065:1: rule__ObjectiveFunctionExpression__Group_1__3 : rule__ObjectiveFunctionExpression__Group_1__3__Impl ;
    public final void rule__ObjectiveFunctionExpression__Group_1__3() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1069:1: ( rule__ObjectiveFunctionExpression__Group_1__3__Impl )
            // InternalLPSolve.g:1070:2: rule__ObjectiveFunctionExpression__Group_1__3__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1076:1: rule__ObjectiveFunctionExpression__Group_1__3__Impl : ( ';' ) ;
    public final void rule__ObjectiveFunctionExpression__Group_1__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1080:1: ( ( ';' ) )
            // InternalLPSolve.g:1081:1: ( ';' )
            {
            // InternalLPSolve.g:1081:1: ( ';' )
            // InternalLPSolve.g:1082:1: ';'
            {
    ...
    // InternalLPSolve.g:1103:1: rule__ConstraintExpression__Group__0 : rule__ConstraintExpression__Group__0__Impl rule__ConstraintExpression__Group__1 ;
    public final void rule__ConstraintExpression__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1107:1: ( rule__ConstraintExpression__Group__0__Impl rule__ConstraintExpression__Group__1 )
            // InternalLPSolve.g:1108:2: rule__ConstraintExpression__Group__0__Impl rule__ConstraintExpression__Group__1
            {
            pushFollow(FollowSets000.FOLLOW_8);
    ...
    // InternalLPSolve.g:1115:1: rule__ConstraintExpression__Group__0__Impl : ( ( rule__ConstraintExpression__Group_0__0 )? ) ;
    public final void rule__ConstraintExpression__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1119:1: ( ( ( rule__ConstraintExpression__Group_0__0 )? ) )
            // InternalLPSolve.g:1120:1: ( ( rule__ConstraintExpression__Group_0__0 )? )
            {
            // InternalLPSolve.g:1120:1: ( ( rule__ConstraintExpression__Group_0__0 )? )
            // InternalLPSolve.g:1121:1: ( rule__ConstraintExpression__Group_0__0 )?
            {
             before(grammarAccess.getConstraintExpressionAccess().getGroup_0()); 
            // InternalLPSolve.g:1122:1: ( rule__ConstraintExpression__Group_0__0 )?
            int alt12=2;
            alt12 = dfa12.predict(input);
            switch (alt12) {
                case 1 :
                    // InternalLPSolve.g:1122:2: rule__ConstraintExpression__Group_0__0
                    {
                    pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1132:1: rule__ConstraintExpression__Group__1 : rule__ConstraintExpression__Group__1__Impl rule__ConstraintExpression__Group__2 ;
    public final void rule__ConstraintExpression__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1136:1: ( rule__ConstraintExpression__Group__1__Impl rule__ConstraintExpression__Group__2 )
            // InternalLPSolve.g:1137:2: rule__ConstraintExpression__Group__1__Impl rule__ConstraintExpression__Group__2
            {
    ...
    // InternalLPSolve.g:1144:1: rule__ConstraintExpression__Group__1__Impl : ( ( rule__ConstraintExpression__LeftExpressionAssignment_1 ) ) ;
    public final void rule__ConstraintExpression__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1148:1: ( ( ( rule__ConstraintExpression__LeftExpressionAssignment_1 ) ) )
            // InternalLPSolve.g:1149:1: ( ( rule__ConstraintExpression__LeftExpressionAssignment_1 ) )
            {
            // InternalLPSolve.g:1149:1: ( ( rule__ConstraintExpression__LeftExpressionAssignment_1 ) )
            // InternalLPSolve.g:1150:1: ( rule__ConstraintExpression__LeftExpressionAssignment_1 )
            {
             before(grammarAccess.getConstraintExpressionAccess().getLeftExpressionAssignment_1()); 
            // InternalLPSolve.g:1151:1: ( rule__ConstraintExpression__LeftExpressionAssignment_1 )
            // InternalLPSolve.g:1151:2: rule__ConstraintExpression__LeftExpressionAssignment_1
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1161:1: rule__ConstraintExpression__Group__2 : rule__ConstraintExpression__Group__2__Impl rule__ConstraintExpression__Group__3 ;
    public final void rule__ConstraintExpression__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1165:1: ( rule__ConstraintExpression__Group__2__Impl rule__ConstraintExpression__Group__3 )
            // InternalLPSolve.g:1166:2: rule__ConstraintExpression__Group__2__Impl rule__ConstraintExpression__Group__3
            {
            pushFollow(FollowSets000.FOLLOW_8);
    ...
    // InternalLPSolve.g:1173:1: rule__ConstraintExpression__Group__2__Impl : ( ( rule__ConstraintExpression__OperatorAssignment_2 ) ) ;
    public final void rule__ConstraintExpression__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1177:1: ( ( ( rule__ConstraintExpression__OperatorAssignment_2 ) ) )
            // InternalLPSolve.g:1178:1: ( ( rule__ConstraintExpression__OperatorAssignment_2 ) )
            {
            // InternalLPSolve.g:1178:1: ( ( rule__ConstraintExpression__OperatorAssignment_2 ) )
            // InternalLPSolve.g:1179:1: ( rule__ConstraintExpression__OperatorAssignment_2 )
            {
             before(grammarAccess.getConstraintExpressionAccess().getOperatorAssignment_2()); 
            // InternalLPSolve.g:1180:1: ( rule__ConstraintExpression__OperatorAssignment_2 )
            // InternalLPSolve.g:1180:2: rule__ConstraintExpression__OperatorAssignment_2
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1190:1: rule__ConstraintExpression__Group__3 : rule__ConstraintExpression__Group__3__Impl rule__ConstraintExpression__Group__4 ;
    public final void rule__ConstraintExpression__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1194:1: ( rule__ConstraintExpression__Group__3__Impl rule__ConstraintExpression__Group__4 )
            // InternalLPSolve.g:1195:2: rule__ConstraintExpression__Group__3__Impl rule__ConstraintExpression__Group__4
            {
            pushFollow(FollowSets000.FOLLOW_7);
    ...
    // InternalLPSolve.g:1202:1: rule__ConstraintExpression__Group__3__Impl : ( ( rule__ConstraintExpression__RightExpressionAssignment_3 ) ) ;
    public final void rule__ConstraintExpression__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1206:1: ( ( ( rule__ConstraintExpression__RightExpressionAssignment_3 ) ) )
            // InternalLPSolve.g:1207:1: ( ( rule__ConstraintExpression__RightExpressionAssignment_3 ) )
            {
            // InternalLPSolve.g:1207:1: ( ( rule__ConstraintExpression__RightExpressionAssignment_3 ) )
            // InternalLPSolve.g:1208:1: ( rule__ConstraintExpression__RightExpressionAssignment_3 )
            {
             before(grammarAccess.getConstraintExpressionAccess().getRightExpressionAssignment_3()); 
            // InternalLPSolve.g:1209:1: ( rule__ConstraintExpression__RightExpressionAssignment_3 )
            // InternalLPSolve.g:1209:2: rule__ConstraintExpression__RightExpressionAssignment_3
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1219:1: rule__ConstraintExpression__Group__4 : rule__ConstraintExpression__Group__4__Impl ;
    public final void rule__ConstraintExpression__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1223:1: ( rule__ConstraintExpression__Group__4__Impl )
            // InternalLPSolve.g:1224:2: rule__ConstraintExpression__Group__4__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1230:1: rule__ConstraintExpression__Group__4__Impl : ( ';' ) ;
    public final void rule__ConstraintExpression__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1234:1: ( ( ';' ) )
            // InternalLPSolve.g:1235:1: ( ';' )
            {
            // InternalLPSolve.g:1235:1: ( ';' )
            // InternalLPSolve.g:1236:1: ';'
            {
    ...
    // InternalLPSolve.g:1259:1: rule__ConstraintExpression__Group_0__0 : rule__ConstraintExpression__Group_0__0__Impl rule__ConstraintExpression__Group_0__1 ;
    public final void rule__ConstraintExpression__Group_0__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1263:1: ( rule__ConstraintExpression__Group_0__0__Impl rule__ConstraintExpression__Group_0__1 )
            // InternalLPSolve.g:1264:2: rule__ConstraintExpression__Group_0__0__Impl rule__ConstraintExpression__Group_0__1
            {
            pushFollow(FollowSets000.FOLLOW_6);
    ...
    // InternalLPSolve.g:1271:1: rule__ConstraintExpression__Group_0__0__Impl : ( ( rule__ConstraintExpression__CommentAssignment_0_0 ) ) ;
    public final void rule__ConstraintExpression__Group_0__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1275:1: ( ( ( rule__ConstraintExpression__CommentAssignment_0_0 ) ) )
            // InternalLPSolve.g:1276:1: ( ( rule__ConstraintExpression__CommentAssignment_0_0 ) )
            {
            // InternalLPSolve.g:1276:1: ( ( rule__ConstraintExpression__CommentAssignment_0_0 ) )
            // InternalLPSolve.g:1277:1: ( rule__ConstraintExpression__CommentAssignment_0_0 )
            {
             before(grammarAccess.getConstraintExpressionAccess().getCommentAssignment_0_0()); 
            // InternalLPSolve.g:1278:1: ( rule__ConstraintExpression__CommentAssignment_0_0 )
            // InternalLPSolve.g:1278:2: rule__ConstraintExpression__CommentAssignment_0_0
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1288:1: rule__ConstraintExpression__Group_0__1 : rule__ConstraintExpression__Group_0__1__Impl ;
    public final void rule__ConstraintExpression__Group_0__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1292:1: ( rule__ConstraintExpression__Group_0__1__Impl )
            // InternalLPSolve.g:1293:2: rule__ConstraintExpression__Group_0__1__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1299:1: rule__ConstraintExpression__Group_0__1__Impl : ( ':' ) ;
    public final void rule__ConstraintExpression__Group_0__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1303:1: ( ( ':' ) )
            // InternalLPSolve.g:1304:1: ( ':' )
            {
            // InternalLPSolve.g:1304:1: ( ':' )
            // InternalLPSolve.g:1305:1: ':'
            {
    ...
    // InternalLPSolve.g:1322:1: rule__Variable__Group__0 : rule__Variable__Group__0__Impl rule__Variable__Group__1 ;
    public final void rule__Variable__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1326:1: ( rule__Variable__Group__0__Impl rule__Variable__Group__1 )
            // InternalLPSolve.g:1327:2: rule__Variable__Group__0__Impl rule__Variable__Group__1
            {
    ...
    // InternalLPSolve.g:1334:1: rule__Variable__Group__0__Impl : ( ( rule__Variable__DataTypeAssignment_0 ) ) ;
    public final void rule__Variable__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1338:1: ( ( ( rule__Variable__DataTypeAssignment_0 ) ) )
            // InternalLPSolve.g:1339:1: ( ( rule__Variable__DataTypeAssignment_0 ) )
            {
            // InternalLPSolve.g:1339:1: ( ( rule__Variable__DataTypeAssignment_0 ) )
            // InternalLPSolve.g:1340:1: ( rule__Variable__DataTypeAssignment_0 )
            {
             before(grammarAccess.getVariableAccess().getDataTypeAssignment_0()); 
            // InternalLPSolve.g:1341:1: ( rule__Variable__DataTypeAssignment_0 )
            // InternalLPSolve.g:1341:2: rule__Variable__DataTypeAssignment_0
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1351:1: rule__Variable__Group__1 : rule__Variable__Group__1__Impl rule__Variable__Group__2 ;
    public final void rule__Variable__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1355:1: ( rule__Variable__Group__1__Impl rule__Variable__Group__2 )
            // InternalLPSolve.g:1356:2: rule__Variable__Group__1__Impl rule__Variable__Group__2
            {
            pushFollow(FollowSets000.FOLLOW_7);
    ...
    // InternalLPSolve.g:1363:1: rule__Variable__Group__1__Impl : ( ( rule__Variable__NameAssignment_1 ) ) ;
    public final void rule__Variable__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1367:1: ( ( ( rule__Variable__NameAssignment_1 ) ) )
            // InternalLPSolve.g:1368:1: ( ( rule__Variable__NameAssignment_1 ) )
            {
            // InternalLPSolve.g:1368:1: ( ( rule__Variable__NameAssignment_1 ) )
            // InternalLPSolve.g:1369:1: ( rule__Variable__NameAssignment_1 )
            {
             before(grammarAccess.getVariableAccess().getNameAssignment_1()); 
            // InternalLPSolve.g:1370:1: ( rule__Variable__NameAssignment_1 )
            // InternalLPSolve.g:1370:2: rule__Variable__NameAssignment_1
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1380:1: rule__Variable__Group__2 : rule__Variable__Group__2__Impl ;
    public final void rule__Variable__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1384:1: ( rule__Variable__Group__2__Impl )
            // InternalLPSolve.g:1385:2: rule__Variable__Group__2__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1391:1: rule__Variable__Group__2__Impl : ( ';' ) ;
    public final void rule__Variable__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1395:1: ( ( ';' ) )
            // InternalLPSolve.g:1396:1: ( ';' )
            {
            // InternalLPSolve.g:1396:1: ( ';' )
            // InternalLPSolve.g:1397:1: ';'
            {
    ...
    // InternalLPSolve.g:1416:1: rule__VariableID__Group__0 : rule__VariableID__Group__0__Impl rule__VariableID__Group__1 ;
    public final void rule__VariableID__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1420:1: ( rule__VariableID__Group__0__Impl rule__VariableID__Group__1 )
            // InternalLPSolve.g:1421:2: rule__VariableID__Group__0__Impl rule__VariableID__Group__1
            {
    ...
    // InternalLPSolve.g:1428:1: rule__VariableID__Group__0__Impl : ( RULE_ID ) ;
    public final void rule__VariableID__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1432:1: ( ( RULE_ID ) )
            // InternalLPSolve.g:1433:1: ( RULE_ID )
            {
            // InternalLPSolve.g:1433:1: ( RULE_ID )
            // InternalLPSolve.g:1434:1: RULE_ID
            {
    ...
    // InternalLPSolve.g:1445:1: rule__VariableID__Group__1 : rule__VariableID__Group__1__Impl ;
    public final void rule__VariableID__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1449:1: ( rule__VariableID__Group__1__Impl )
            // InternalLPSolve.g:1450:2: rule__VariableID__Group__1__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1456:1: rule__VariableID__Group__1__Impl : ( ( rule__VariableID__Group_1__0 )* ) ;
    public final void rule__VariableID__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1460:1: ( ( ( rule__VariableID__Group_1__0 )* ) )
            // InternalLPSolve.g:1461:1: ( ( rule__VariableID__Group_1__0 )* )
            {
            // InternalLPSolve.g:1461:1: ( ( rule__VariableID__Group_1__0 )* )
            // InternalLPSolve.g:1462:1: ( rule__VariableID__Group_1__0 )*
            {
             before(grammarAccess.getVariableIDAccess().getGroup_1()); 
            // InternalLPSolve.g:1463:1: ( rule__VariableID__Group_1__0 )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // InternalLPSolve.g:1463:2: rule__VariableID__Group_1__0
            	    {
    ...
    // InternalLPSolve.g:1477:1: rule__VariableID__Group_1__0 : rule__VariableID__Group_1__0__Impl rule__VariableID__Group_1__1 ;
    public final void rule__VariableID__Group_1__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1481:1: ( rule__VariableID__Group_1__0__Impl rule__VariableID__Group_1__1 )
            // InternalLPSolve.g:1482:2: rule__VariableID__Group_1__0__Impl rule__VariableID__Group_1__1
            {
    ...
    // InternalLPSolve.g:1489:1: rule__VariableID__Group_1__0__Impl : ( '.' ) ;
    public final void rule__VariableID__Group_1__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1493:1: ( ( '.' ) )
            // InternalLPSolve.g:1494:1: ( '.' )
            {
            // InternalLPSolve.g:1494:1: ( '.' )
            // InternalLPSolve.g:1495:1: '.'
            {
    ...
    // InternalLPSolve.g:1508:1: rule__VariableID__Group_1__1 : rule__VariableID__Group_1__1__Impl ;
    public final void rule__VariableID__Group_1__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1512:1: ( rule__VariableID__Group_1__1__Impl )
            // InternalLPSolve.g:1513:2: rule__VariableID__Group_1__1__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1519:1: rule__VariableID__Group_1__1__Impl : ( ( rule__VariableID__Alternatives_1_1 ) ) ;
    public final void rule__VariableID__Group_1__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1523:1: ( ( ( rule__VariableID__Alternatives_1_1 ) ) )
            // InternalLPSolve.g:1524:1: ( ( rule__VariableID__Alternatives_1_1 ) )
            {
            // InternalLPSolve.g:1524:1: ( ( rule__VariableID__Alternatives_1_1 ) )
            // InternalLPSolve.g:1525:1: ( rule__VariableID__Alternatives_1_1 )
            {
             before(grammarAccess.getVariableIDAccess().getAlternatives_1_1()); 
            // InternalLPSolve.g:1526:1: ( rule__VariableID__Alternatives_1_1 )
            // InternalLPSolve.g:1526:2: rule__VariableID__Alternatives_1_1
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1540:1: rule__VariableID__Group_1_1_1__0 : rule__VariableID__Group_1_1_1__0__Impl rule__VariableID__Group_1_1_1__1 ;
    public final void rule__VariableID__Group_1_1_1__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1544:1: ( rule__VariableID__Group_1_1_1__0__Impl rule__VariableID__Group_1_1_1__1 )
            // InternalLPSolve.g:1545:2: rule__VariableID__Group_1_1_1__0__Impl rule__VariableID__Group_1_1_1__1
            {
            pushFollow(FollowSets000.FOLLOW_10);
    ...
    // InternalLPSolve.g:1552:1: rule__VariableID__Group_1_1_1__0__Impl : ( RULE_INT ) ;
    public final void rule__VariableID__Group_1_1_1__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1556:1: ( ( RULE_INT ) )
            // InternalLPSolve.g:1557:1: ( RULE_INT )
            {
            // InternalLPSolve.g:1557:1: ( RULE_INT )
            // InternalLPSolve.g:1558:1: RULE_INT
            {
    ...
    // InternalLPSolve.g:1569:1: rule__VariableID__Group_1_1_1__1 : rule__VariableID__Group_1_1_1__1__Impl ;
    public final void rule__VariableID__Group_1_1_1__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1573:1: ( rule__VariableID__Group_1_1_1__1__Impl )
            // InternalLPSolve.g:1574:2: rule__VariableID__Group_1_1_1__1__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1580:1: rule__VariableID__Group_1_1_1__1__Impl : ( ( RULE_ID )? ) ;
    public final void rule__VariableID__Group_1_1_1__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1584:1: ( ( ( RULE_ID )? ) )
            // InternalLPSolve.g:1585:1: ( ( RULE_ID )? )
            {
            // InternalLPSolve.g:1585:1: ( ( RULE_ID )? )
            // InternalLPSolve.g:1586:1: ( RULE_ID )?
            {
             before(grammarAccess.getVariableIDAccess().getIDTerminalRuleCall_1_1_1_1()); 
            // InternalLPSolve.g:1587:1: ( RULE_ID )?
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalLPSolve.g:1587:3: RULE_ID
                    {
                    match(input,RULE_ID,FollowSets000.FOLLOW_2); 
    ...
    // InternalLPSolve.g:1601:1: rule__AdditionExpression__Group__0 : rule__AdditionExpression__Group__0__Impl rule__AdditionExpression__Group__1 ;
    public final void rule__AdditionExpression__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1605:1: ( rule__AdditionExpression__Group__0__Impl rule__AdditionExpression__Group__1 )
            // InternalLPSolve.g:1606:2: rule__AdditionExpression__Group__0__Impl rule__AdditionExpression__Group__1
            {
    ...
    // InternalLPSolve.g:1613:1: rule__AdditionExpression__Group__0__Impl : ( ruleMultiplicationExpression ) ;
    public final void rule__AdditionExpression__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1617:1: ( ( ruleMultiplicationExpression ) )
            // InternalLPSolve.g:1618:1: ( ruleMultiplicationExpression )
            {
            // InternalLPSolve.g:1618:1: ( ruleMultiplicationExpression )
            // InternalLPSolve.g:1619:1: ruleMultiplicationExpression
            {
    ...
    // InternalLPSolve.g:1630:1: rule__AdditionExpression__Group__1 : rule__AdditionExpression__Group__1__Impl ;
    public final void rule__AdditionExpression__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1634:1: ( rule__AdditionExpression__Group__1__Impl )
            // InternalLPSolve.g:1635:2: rule__AdditionExpression__Group__1__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1641:1: rule__AdditionExpression__Group__1__Impl : ( ( rule__AdditionExpression__Group_1__0 )? ) ;
    public final void rule__AdditionExpression__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1645:1: ( ( ( rule__AdditionExpression__Group_1__0 )? ) )
            // InternalLPSolve.g:1646:1: ( ( rule__AdditionExpression__Group_1__0 )? )
            {
            // InternalLPSolve.g:1646:1: ( ( rule__AdditionExpression__Group_1__0 )? )
            // InternalLPSolve.g:1647:1: ( rule__AdditionExpression__Group_1__0 )?
            {
             before(grammarAccess.getAdditionExpressionAccess().getGroup_1()); 
            // InternalLPSolve.g:1648:1: ( rule__AdditionExpression__Group_1__0 )?
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalLPSolve.g:1648:2: rule__AdditionExpression__Group_1__0
                    {
                    pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1662:1: rule__AdditionExpression__Group_1__0 : rule__AdditionExpression__Group_1__0__Impl rule__AdditionExpression__Group_1__1 ;
    public final void rule__AdditionExpression__Group_1__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1666:1: ( rule__AdditionExpression__Group_1__0__Impl rule__AdditionExpression__Group_1__1 )
            // InternalLPSolve.g:1667:2: rule__AdditionExpression__Group_1__0__Impl rule__AdditionExpression__Group_1__1
            {
            pushFollow(FollowSets000.FOLLOW_14);
    ...
    // InternalLPSolve.g:1674:1: rule__AdditionExpression__Group_1__0__Impl : ( () ) ;
    public final void rule__AdditionExpression__Group_1__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1678:1: ( ( () ) )
            // InternalLPSolve.g:1679:1: ( () )
            {
            // InternalLPSolve.g:1679:1: ( () )
            // InternalLPSolve.g:1680:1: ()
            {
             before(grammarAccess.getAdditionExpressionAccess().getArithmeticExpressionLeftExpressionAction_1_0()); 
            // InternalLPSolve.g:1681:1: ()
            // InternalLPSolve.g:1683:1: 
            {
            }
    ...
    // InternalLPSolve.g:1693:1: rule__AdditionExpression__Group_1__1 : rule__AdditionExpression__Group_1__1__Impl rule__AdditionExpression__Group_1__2 ;
    public final void rule__AdditionExpression__Group_1__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1697:1: ( rule__AdditionExpression__Group_1__1__Impl rule__AdditionExpression__Group_1__2 )
            // InternalLPSolve.g:1698:2: rule__AdditionExpression__Group_1__1__Impl rule__AdditionExpression__Group_1__2
            {
            pushFollow(FollowSets000.FOLLOW_8);
    ...
    // InternalLPSolve.g:1705:1: rule__AdditionExpression__Group_1__1__Impl : ( ( rule__AdditionExpression__OperatorAssignment_1_1 ) ) ;
    public final void rule__AdditionExpression__Group_1__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1709:1: ( ( ( rule__AdditionExpression__OperatorAssignment_1_1 ) ) )
            // InternalLPSolve.g:1710:1: ( ( rule__AdditionExpression__OperatorAssignment_1_1 ) )
            {
            // InternalLPSolve.g:1710:1: ( ( rule__AdditionExpression__OperatorAssignment_1_1 ) )
            // InternalLPSolve.g:1711:1: ( rule__AdditionExpression__OperatorAssignment_1_1 )
            {
             before(grammarAccess.getAdditionExpressionAccess().getOperatorAssignment_1_1()); 
            // InternalLPSolve.g:1712:1: ( rule__AdditionExpression__OperatorAssignment_1_1 )
            // InternalLPSolve.g:1712:2: rule__AdditionExpression__OperatorAssignment_1_1
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1722:1: rule__AdditionExpression__Group_1__2 : rule__AdditionExpression__Group_1__2__Impl ;
    public final void rule__AdditionExpression__Group_1__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1726:1: ( rule__AdditionExpression__Group_1__2__Impl )
            // InternalLPSolve.g:1727:2: rule__AdditionExpression__Group_1__2__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1733:1: rule__AdditionExpression__Group_1__2__Impl : ( ( rule__AdditionExpression__RightExpressionAssignment_1_2 ) ) ;
    public final void rule__AdditionExpression__Group_1__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1737:1: ( ( ( rule__AdditionExpression__RightExpressionAssignment_1_2 ) ) )
            // InternalLPSolve.g:1738:1: ( ( rule__AdditionExpression__RightExpressionAssignment_1_2 ) )
            {
            // InternalLPSolve.g:1738:1: ( ( rule__AdditionExpression__RightExpressionAssignment_1_2 ) )
            // InternalLPSolve.g:1739:1: ( rule__AdditionExpression__RightExpressionAssignment_1_2 )
            {
             before(grammarAccess.getAdditionExpressionAccess().getRightExpressionAssignment_1_2()); 
            // InternalLPSolve.g:1740:1: ( rule__AdditionExpression__RightExpressionAssignment_1_2 )
            // InternalLPSolve.g:1740:2: rule__AdditionExpression__RightExpressionAssignment_1_2
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1756:1: rule__MultiplicationExpression__Group__0 : rule__MultiplicationExpression__Group__0__Impl rule__MultiplicationExpression__Group__1 ;
    public final void rule__MultiplicationExpression__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1760:1: ( rule__MultiplicationExpression__Group__0__Impl rule__MultiplicationExpression__Group__1 )
            // InternalLPSolve.g:1761:2: rule__MultiplicationExpression__Group__0__Impl rule__MultiplicationExpression__Group__1
            {
    ...
    // InternalLPSolve.g:1768:1: rule__MultiplicationExpression__Group__0__Impl : ( ruleOperand ) ;
    public final void rule__MultiplicationExpression__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1772:1: ( ( ruleOperand ) )
            // InternalLPSolve.g:1773:1: ( ruleOperand )
            {
            // InternalLPSolve.g:1773:1: ( ruleOperand )
            // InternalLPSolve.g:1774:1: ruleOperand
            {
    ...
    // InternalLPSolve.g:1785:1: rule__MultiplicationExpression__Group__1 : rule__MultiplicationExpression__Group__1__Impl ;
    public final void rule__MultiplicationExpression__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1789:1: ( rule__MultiplicationExpression__Group__1__Impl )
            // InternalLPSolve.g:1790:2: rule__MultiplicationExpression__Group__1__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1796:1: rule__MultiplicationExpression__Group__1__Impl : ( ( rule__MultiplicationExpression__Group_1__0 )? ) ;
    public final void rule__MultiplicationExpression__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1800:1: ( ( ( rule__MultiplicationExpression__Group_1__0 )? ) )
            // InternalLPSolve.g:1801:1: ( ( rule__MultiplicationExpression__Group_1__0 )? )
            {
            // InternalLPSolve.g:1801:1: ( ( rule__MultiplicationExpression__Group_1__0 )? )
            // InternalLPSolve.g:1802:1: ( rule__MultiplicationExpression__Group_1__0 )?
            {
             before(grammarAccess.getMultiplicationExpressionAccess().getGroup_1()); 
            // InternalLPSolve.g:1803:1: ( rule__MultiplicationExpression__Group_1__0 )?
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalLPSolve.g:1803:2: rule__MultiplicationExpression__Group_1__0
                    {
                    pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1817:1: rule__MultiplicationExpression__Group_1__0 : rule__MultiplicationExpression__Group_1__0__Impl rule__MultiplicationExpression__Group_1__1 ;
    public final void rule__MultiplicationExpression__Group_1__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1821:1: ( rule__MultiplicationExpression__Group_1__0__Impl rule__MultiplicationExpression__Group_1__1 )
            // InternalLPSolve.g:1822:2: rule__MultiplicationExpression__Group_1__0__Impl rule__MultiplicationExpression__Group_1__1
            {
            pushFollow(FollowSets000.FOLLOW_15);
    ...
    // InternalLPSolve.g:1848:1: rule__MultiplicationExpression__Group_1__1 : rule__MultiplicationExpression__Group_1__1__Impl rule__MultiplicationExpression__Group_1__2 ;
    public final void rule__MultiplicationExpression__Group_1__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1852:1: ( rule__MultiplicationExpression__Group_1__1__Impl rule__MultiplicationExpression__Group_1__2 )
            // InternalLPSolve.g:1853:2: rule__MultiplicationExpression__Group_1__1__Impl rule__MultiplicationExpression__Group_1__2
            {
            pushFollow(FollowSets000.FOLLOW_8);
    ...
    // InternalLPSolve.g:1860:1: rule__MultiplicationExpression__Group_1__1__Impl : ( ( rule__MultiplicationExpression__OperatorAssignment_1_1 ) ) ;
    public final void rule__MultiplicationExpression__Group_1__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1864:1: ( ( ( rule__MultiplicationExpression__OperatorAssignment_1_1 ) ) )
            // InternalLPSolve.g:1865:1: ( ( rule__MultiplicationExpression__OperatorAssignment_1_1 ) )
            {
            // InternalLPSolve.g:1865:1: ( ( rule__MultiplicationExpression__OperatorAssignment_1_1 ) )
            // InternalLPSolve.g:1866:1: ( rule__MultiplicationExpression__OperatorAssignment_1_1 )
            {
             before(grammarAccess.getMultiplicationExpressionAccess().getOperatorAssignment_1_1()); 
            // InternalLPSolve.g:1867:1: ( rule__MultiplicationExpression__OperatorAssignment_1_1 )
            // InternalLPSolve.g:1867:2: rule__MultiplicationExpression__OperatorAssignment_1_1
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1877:1: rule__MultiplicationExpression__Group_1__2 : rule__MultiplicationExpression__Group_1__2__Impl ;
    public final void rule__MultiplicationExpression__Group_1__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1881:1: ( rule__MultiplicationExpression__Group_1__2__Impl )
            // InternalLPSolve.g:1882:2: rule__MultiplicationExpression__Group_1__2__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1888:1: rule__MultiplicationExpression__Group_1__2__Impl : ( ( rule__MultiplicationExpression__RightExpressionAssignment_1_2 ) ) ;
    public final void rule__MultiplicationExpression__Group_1__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1892:1: ( ( ( rule__MultiplicationExpression__RightExpressionAssignment_1_2 ) ) )
            // InternalLPSolve.g:1893:1: ( ( rule__MultiplicationExpression__RightExpressionAssignment_1_2 ) )
            {
            // InternalLPSolve.g:1893:1: ( ( rule__MultiplicationExpression__RightExpressionAssignment_1_2 ) )
            // InternalLPSolve.g:1894:1: ( rule__MultiplicationExpression__RightExpressionAssignment_1_2 )
            {
             before(grammarAccess.getMultiplicationExpressionAccess().getRightExpressionAssignment_1_2()); 
            // InternalLPSolve.g:1895:1: ( rule__MultiplicationExpression__RightExpressionAssignment_1_2 )
            // InternalLPSolve.g:1895:2: rule__MultiplicationExpression__RightExpressionAssignment_1_2
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1911:1: rule__Number__Group__0 : rule__Number__Group__0__Impl rule__Number__Group__1 ;
    public final void rule__Number__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1915:1: ( rule__Number__Group__0__Impl rule__Number__Group__1 )
            // InternalLPSolve.g:1916:2: rule__Number__Group__0__Impl rule__Number__Group__1
            {
    ...
    // InternalLPSolve.g:1923:1: rule__Number__Group__0__Impl : ( ( '-' )? ) ;
    public final void rule__Number__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1927:1: ( ( ( '-' )? ) )
            // InternalLPSolve.g:1928:1: ( ( '-' )? )
            {
            // InternalLPSolve.g:1928:1: ( ( '-' )? )
            // InternalLPSolve.g:1929:1: ( '-' )?
            {
             before(grammarAccess.getNumberAccess().getHyphenMinusKeyword_0()); 
            // InternalLPSolve.g:1930:1: ( '-' )?
            int alt17=2;
    ...
    // InternalLPSolve.g:1942:1: rule__Number__Group__1 : rule__Number__Group__1__Impl ;
    public final void rule__Number__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1946:1: ( rule__Number__Group__1__Impl )
            // InternalLPSolve.g:1947:2: rule__Number__Group__1__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1953:1: rule__Number__Group__1__Impl : ( ( rule__Number__Alternatives_1 ) ) ;
    public final void rule__Number__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1957:1: ( ( ( rule__Number__Alternatives_1 ) ) )
            // InternalLPSolve.g:1958:1: ( ( rule__Number__Alternatives_1 ) )
            {
            // InternalLPSolve.g:1958:1: ( ( rule__Number__Alternatives_1 ) )
            // InternalLPSolve.g:1959:1: ( rule__Number__Alternatives_1 )
            {
             before(grammarAccess.getNumberAccess().getAlternatives_1()); 
            // InternalLPSolve.g:1960:1: ( rule__Number__Alternatives_1 )
            // InternalLPSolve.g:1960:2: rule__Number__Alternatives_1
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:1974:1: rule__Decimal__Group__0 : rule__Decimal__Group__0__Impl rule__Decimal__Group__1 ;
    public final void rule__Decimal__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1978:1: ( rule__Decimal__Group__0__Impl rule__Decimal__Group__1 )
            // InternalLPSolve.g:1979:2: rule__Decimal__Group__0__Impl rule__Decimal__Group__1
            {
            pushFollow(FollowSets000.FOLLOW_11);
    ...
    // InternalLPSolve.g:1986:1: rule__Decimal__Group__0__Impl : ( RULE_INT ) ;
    public final void rule__Decimal__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:1990:1: ( ( RULE_INT ) )
            // InternalLPSolve.g:1991:1: ( RULE_INT )
            {
            // InternalLPSolve.g:1991:1: ( RULE_INT )
            // InternalLPSolve.g:1992:1: RULE_INT
            {
    ...
    // InternalLPSolve.g:2003:1: rule__Decimal__Group__1 : rule__Decimal__Group__1__Impl rule__Decimal__Group__2 ;
    public final void rule__Decimal__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2007:1: ( rule__Decimal__Group__1__Impl rule__Decimal__Group__2 )
            // InternalLPSolve.g:2008:2: rule__Decimal__Group__1__Impl rule__Decimal__Group__2
            {
    ...
    // InternalLPSolve.g:2015:1: rule__Decimal__Group__1__Impl : ( '.' ) ;
    public final void rule__Decimal__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2019:1: ( ( '.' ) )
            // InternalLPSolve.g:2020:1: ( '.' )
            {
            // InternalLPSolve.g:2020:1: ( '.' )
            // InternalLPSolve.g:2021:1: '.'
            {
    ...
    // InternalLPSolve.g:2034:1: rule__Decimal__Group__2 : rule__Decimal__Group__2__Impl ;
    public final void rule__Decimal__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2038:1: ( rule__Decimal__Group__2__Impl )
            // InternalLPSolve.g:2039:2: rule__Decimal__Group__2__Impl
            {
            pushFollow(FollowSets000.FOLLOW_2);
    ...
    // InternalLPSolve.g:2045:1: rule__Decimal__Group__2__Impl : ( RULE_INT ) ;
    public final void rule__Decimal__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2049:1: ( ( RULE_INT ) )
            // InternalLPSolve.g:2050:1: ( RULE_INT )
            {
            // InternalLPSolve.g:2050:1: ( RULE_INT )
            // InternalLPSolve.g:2051:1: RULE_INT
            {
    ...
    // InternalLPSolve.g:2069:1: rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0 : ( ruleObjectiveFunctionExpression ) ;
    public final void rule__IntegerLinearProgram__ObjectiveFunctionAssignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2073:1: ( ( ruleObjectiveFunctionExpression ) )
            // InternalLPSolve.g:2074:1: ( ruleObjectiveFunctionExpression )
            {
            // InternalLPSolve.g:2074:1: ( ruleObjectiveFunctionExpression )
            // InternalLPSolve.g:2075:1: ruleObjectiveFunctionExpression
            {
    ...
    // InternalLPSolve.g:2084:1: rule__IntegerLinearProgram__ConstraintsAssignment_1 : ( ruleConstraintExpression ) ;
    public final void rule__IntegerLinearProgram__ConstraintsAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2088:1: ( ( ruleConstraintExpression ) )
            // InternalLPSolve.g:2089:1: ( ruleConstraintExpression )
            {
            // InternalLPSolve.g:2089:1: ( ruleConstraintExpression )
            // InternalLPSolve.g:2090:1: ruleConstraintExpression
            {
    ...
    // InternalLPSolve.g:2099:1: rule__IntegerLinearProgram__VariablesAssignment_2 : ( ruleVariable ) ;
    public final void rule__IntegerLinearProgram__VariablesAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2103:1: ( ( ruleVariable ) )
            // InternalLPSolve.g:2104:1: ( ruleVariable )
            {
            // InternalLPSolve.g:2104:1: ( ruleVariable )
            // InternalLPSolve.g:2105:1: ruleVariable
            {
    ...
    // InternalLPSolve.g:2114:1: rule__ObjectiveFunctionExpression__GoalAssignment_1_0 : ( ruleObjectiveGoal ) ;
    public final void rule__ObjectiveFunctionExpression__GoalAssignment_1_0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2118:1: ( ( ruleObjectiveGoal ) )
            // InternalLPSolve.g:2119:1: ( ruleObjectiveGoal )
            {
            // InternalLPSolve.g:2119:1: ( ruleObjectiveGoal )
            // InternalLPSolve.g:2120:1: ruleObjectiveGoal
            {
    ...
    // InternalLPSolve.g:2129:1: rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2 : ( ruleLinearExpression ) ;
    public final void rule__ObjectiveFunctionExpression__ObjectiveFunctionAssignment_1_2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2133:1: ( ( ruleLinearExpression ) )
            // InternalLPSolve.g:2134:1: ( ruleLinearExpression )
            {
            // InternalLPSolve.g:2134:1: ( ruleLinearExpression )
            // InternalLPSolve.g:2135:1: ruleLinearExpression
            {
    ...
    // InternalLPSolve.g:2144:1: rule__ConstraintExpression__CommentAssignment_0_0 : ( ruleVariableID ) ;
    public final void rule__ConstraintExpression__CommentAssignment_0_0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2148:1: ( ( ruleVariableID ) )
            // InternalLPSolve.g:2149:1: ( ruleVariableID )
            {
            // InternalLPSolve.g:2149:1: ( ruleVariableID )
            // InternalLPSolve.g:2150:1: ruleVariableID
            {
    ...
    // InternalLPSolve.g:2159:1: rule__ConstraintExpression__LeftExpressionAssignment_1 : ( ruleSimpleLinearExpression ) ;
    public final void rule__ConstraintExpression__LeftExpressionAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2163:1: ( ( ruleSimpleLinearExpression ) )
            // InternalLPSolve.g:2164:1: ( ruleSimpleLinearExpression )
            {
            // InternalLPSolve.g:2164:1: ( ruleSimpleLinearExpression )
            // InternalLPSolve.g:2165:1: ruleSimpleLinearExpression
            {
    ...
    // InternalLPSolve.g:2174:1: rule__ConstraintExpression__OperatorAssignment_2 : ( ruleComparingOperator ) ;
    public final void rule__ConstraintExpression__OperatorAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2178:1: ( ( ruleComparingOperator ) )
            // InternalLPSolve.g:2179:1: ( ruleComparingOperator )
            {
            // InternalLPSolve.g:2179:1: ( ruleComparingOperator )
            // InternalLPSolve.g:2180:1: ruleComparingOperator
            {
    ...
    // InternalLPSolve.g:2189:1: rule__ConstraintExpression__RightExpressionAssignment_3 : ( ruleSimpleLinearExpression ) ;
    public final void rule__ConstraintExpression__RightExpressionAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2193:1: ( ( ruleSimpleLinearExpression ) )
            // InternalLPSolve.g:2194:1: ( ruleSimpleLinearExpression )
            {
            // InternalLPSolve.g:2194:1: ( ruleSimpleLinearExpression )
            // InternalLPSolve.g:2195:1: ruleSimpleLinearExpression
            {
    ...
    // InternalLPSolve.g:2204:1: rule__Variable__DataTypeAssignment_0 : ( ruleILPDataType ) ;
    public final void rule__Variable__DataTypeAssignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2208:1: ( ( ruleILPDataType ) )
            // InternalLPSolve.g:2209:1: ( ruleILPDataType )
            {
            // InternalLPSolve.g:2209:1: ( ruleILPDataType )
            // InternalLPSolve.g:2210:1: ruleILPDataType
            {
    ...
    // InternalLPSolve.g:2219:1: rule__Variable__NameAssignment_1 : ( ruleVariableID ) ;
    public final void rule__Variable__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2223:1: ( ( ruleVariableID ) )
            // InternalLPSolve.g:2224:1: ( ruleVariableID )
            {
            // InternalLPSolve.g:2224:1: ( ruleVariableID )
            // InternalLPSolve.g:2225:1: ruleVariableID
            {
    ...
    // InternalLPSolve.g:2234:1: rule__AdditionExpression__OperatorAssignment_1_1 : ( ruleAdditionOperator ) ;
    public final void rule__AdditionExpression__OperatorAssignment_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2238:1: ( ( ruleAdditionOperator ) )
            // InternalLPSolve.g:2239:1: ( ruleAdditionOperator )
            {
            // InternalLPSolve.g:2239:1: ( ruleAdditionOperator )
            // InternalLPSolve.g:2240:1: ruleAdditionOperator
            {
    ...
    // InternalLPSolve.g:2249:1: rule__AdditionExpression__RightExpressionAssignment_1_2 : ( ruleLinearExpression ) ;
    public final void rule__AdditionExpression__RightExpressionAssignment_1_2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2253:1: ( ( ruleLinearExpression ) )
            // InternalLPSolve.g:2254:1: ( ruleLinearExpression )
            {
            // InternalLPSolve.g:2254:1: ( ruleLinearExpression )
            // InternalLPSolve.g:2255:1: ruleLinearExpression
            {
    ...
    // InternalLPSolve.g:2264:1: rule__MultiplicationExpression__OperatorAssignment_1_1 : ( ruleMultiplicationOperator ) ;
    public final void rule__MultiplicationExpression__OperatorAssignment_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2268:1: ( ( ruleMultiplicationOperator ) )
            // InternalLPSolve.g:2269:1: ( ruleMultiplicationOperator )
            {
            // InternalLPSolve.g:2269:1: ( ruleMultiplicationOperator )
            // InternalLPSolve.g:2270:1: ruleMultiplicationOperator
            {
    ...
    // InternalLPSolve.g:2279:1: rule__MultiplicationExpression__RightExpressionAssignment_1_2 : ( ruleOperand ) ;
    public final void rule__MultiplicationExpression__RightExpressionAssignment_1_2() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2283:1: ( ( ruleOperand ) )
            // InternalLPSolve.g:2284:1: ( ruleOperand )
            {
            // InternalLPSolve.g:2284:1: ( ruleOperand )
            // InternalLPSolve.g:2285:1: ruleOperand
            {
    ...
    // InternalLPSolve.g:2294:1: rule__NumberLiteralExpression__ValueAssignment : ( ruleNumber ) ;
    public final void rule__NumberLiteralExpression__ValueAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2298:1: ( ( ruleNumber ) )
            // InternalLPSolve.g:2299:1: ( ruleNumber )
            {
            // InternalLPSolve.g:2299:1: ( ruleNumber )
            // InternalLPSolve.g:2300:1: ruleNumber
            {
    ...
    // InternalLPSolve.g:2309:1: rule__VariableExpression__VariableAssignment : ( ( ruleVariableID ) ) ;
    public final void rule__VariableExpression__VariableAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
            
        try {
            // InternalLPSolve.g:2313:1: ( ( ( ruleVariableID ) ) )
            // InternalLPSolve.g:2314:1: ( ( ruleVariableID ) )
            {
            // InternalLPSolve.g:2314:1: ( ( ruleVariableID ) )
            // InternalLPSolve.g:2315:1: ( ruleVariableID )
            {
             before(grammarAccess.getVariableExpressionAccess().getVariableVariableCrossReference_0()); 
            // InternalLPSolve.g:2316:1: ( ruleVariableID )
            // InternalLPSolve.g:2317:1: ruleVariableID
            {
    ...
    static final String dfa_3s = "\1\27\1\32\1\uffff\1\5\1\uffff\3\32";
    ...
    private static class FollowSets000 {
        ...
        public static final BitSet FOLLOW_3 = new BitSet(new long[]{0x0000000000B80030L});
        public static final BitSet FOLLOW_4 = new BitSet(new long[]{0x0000000000800032L});
