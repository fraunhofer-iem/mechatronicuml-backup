 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.QueryServerImpl#getInputEvent <em>Input Event</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.QueryServerImpl#getOutputEventsList <em>Output Events List</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.QueryServerImpl#getRequestPolicy <em>Request Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class QueryServerImpl extends MinimalEObjectImpl.Container implements QueryServer {
	/**
