...
public class RefinedAtomicComponentInstanceEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorAllocatedResourceInstance_PSMTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorAllocatedResourceInstance_PSMTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorAllocatedResourceInstance_PSMTab_Editor() {
		if (this.editorAllocatedResourceInstance_PSMTab == null) {
			...
			this.editorAllocatedResourceInstance_PSMTab = editor;
		}
		return this.editorAllocatedResourceInstance_PSMTab;
	}
	...
	public RefinedAtomicComponentInstanceEditor(String tab) {
		this(tab, de.uni_paderborn.fujaba.muml.psm.properties.util.PropertiesUtil.INSTANCE.getAdapterFactory(),
				de.uni_paderborn.fujaba.muml.psm.codegen.CodegenPackage.eINSTANCE.getRefinedAtomicComponentInstance());
	}
