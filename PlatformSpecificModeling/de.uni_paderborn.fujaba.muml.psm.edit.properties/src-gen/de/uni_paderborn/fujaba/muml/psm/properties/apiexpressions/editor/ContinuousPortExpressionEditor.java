...
public class ContinuousPortExpressionEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorContinuousPort_PSMTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor editorContinuousPort_PSMTab;
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorContinuousPort_PSMTab_Editor() {
		if (this.editorContinuousPort_PSMTab == null) {
			...
			this.editorContinuousPort_PSMTab = editor;
		}
		return this.editorContinuousPort_PSMTab;
	}
