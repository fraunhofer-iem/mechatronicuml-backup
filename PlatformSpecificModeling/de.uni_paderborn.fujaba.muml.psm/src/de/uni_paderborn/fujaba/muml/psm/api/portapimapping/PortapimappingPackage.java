 ...
 * <!-- end-model-doc -->
 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortapimappingFactory
 * @model kind="package"
 * @generated
 */
public interface PortapimappingPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.fujaba.de/muml/psm/api/portapimapping/0.4.0/";
	 ...
	 * @generated
	 */
	PortapimappingPackage eINSTANCE = de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortapimappingPackageImpl.init();

	/**
	 * The meta object id for the '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortApiMappingImpl <em>Port Api Mapping</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortApiMappingImpl
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortapimappingPackageImpl#getPortApiMapping()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int PORT_API_MAPPING___PROVIDE_EXTENSION__ECLASS = CorePackage.COMMENTABLE_ELEMENT___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int PORT_API_MAPPING___GET_ANNOTATION__STRING = CorePackage.COMMENTABLE_ELEMENT___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int PORT_API_MAPPING___PROVIDE_ANNOTATION__STRING = CorePackage.COMMENTABLE_ELEMENT___PROVIDE_ANNOTATION__STRING;
	...
	/**
	 * The meta object id for the '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.MappingRepositoryImpl <em>Mapping Repository</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.MappingRepositoryImpl
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortapimappingPackageImpl#getMappingRepository()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int MAPPING_REPOSITORY___PROVIDE_EXTENSION__ECLASS = CorePackage.NAMED_ELEMENT___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int MAPPING_REPOSITORY___GET_ANNOTATION__STRING = CorePackage.NAMED_ELEMENT___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int MAPPING_REPOSITORY___PROVIDE_ANNOTATION__STRING = CorePackage.NAMED_ELEMENT___PROVIDE_ANNOTATION__STRING;
	...
	/**
	 * Returns the meta object for class '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping <em>Port Api Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Port Api Mapping</em>'.
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping
	 * @generated
	 */
	EClass getPortApiMapping();

	/**
	 * Returns the meta object for the reference '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping#getPort <em>Port</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Port</em>'.
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping#getPort()
	...
	/**
	 * Returns the meta object for the containment reference '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping#getExecCommand <em>Exec Command</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Exec Command</em>'.
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping#getExecCommand()
	 * @see #getPortApiMapping()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the container reference '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping#getRepository <em>Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping#getInitCommand <em>Init Command</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Init Command</em>'.
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.PortApiMapping#getInitCommand()
	 * @see #getPortApiMapping()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.MappingRepository <em>Mapping Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Mapping Repository</em>'.
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.MappingRepository
	 * @generated
	 */
	EClass getMappingRepository();

	/**
	 * Returns the meta object for the containment reference list '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.MappingRepository#getPortApiMappings <em>Port Api Mappings</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.MappingRepository#getImports <em>Imports</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Imports</em>'.
	 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.MappingRepository#getImports()
	 * @see #getMappingRepository()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortApiMappingImpl <em>Port Api Mapping</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortApiMappingImpl
		 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortapimappingPackageImpl#getPortApiMapping()
		...
		/**
		 * The meta object literal for the '{@link de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.MappingRepositoryImpl <em>Mapping Repository</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.MappingRepositoryImpl
		 * @see de.uni_paderborn.fujaba.muml.psm.api.portapimapping.impl.PortapimappingPackageImpl#getMappingRepository()
