 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.result.impl.SRPParametersImpl#getPreassigned <em>Preassigned</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.result.impl.SRPParametersImpl#getPreemptionLevel <em>Preemption Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SRPParametersImpl extends MinimalEObjectImpl.Container implements SRPParameters {
	...
	protected EClass eStaticClass() {
		return ResultPackage.Literals.SRP_PARAMETERS;
	}
	...
	public void setPreassigned(Assertion newPreassigned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.SRP_PARAMETERS__PREASSIGNED, oldPreassigned, preassigned, !oldPreassignedESet));
	}
	...
	public void unsetPreassigned() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ResultPackage.SRP_PARAMETERS__PREASSIGNED, oldPreassigned, PREASSIGNED_EDEFAULT, oldPreassignedESet));
	}
	...
	public void setPreemptionLevel(BigInteger newPreemptionLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.SRP_PARAMETERS__PREEMPTION_LEVEL, oldPreemptionLevel, preemptionLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResultPackage.SRP_PARAMETERS__PREASSIGNED:
				return getPreassigned();
			case ResultPackage.SRP_PARAMETERS__PREEMPTION_LEVEL:
