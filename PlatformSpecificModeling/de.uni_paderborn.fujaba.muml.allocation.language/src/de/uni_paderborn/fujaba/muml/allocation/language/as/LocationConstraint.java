 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.as.LocationConstraint#getTupleDescriptor <em>Tuple Descriptor</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.as.LocationConstraint#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.allocation.language.as.AsPackage#getLocationConstraint()
 * @model
 * @generated
 */
public interface LocationConstraint extends Constraint {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.allocation.language.as.AsPackage#getLocationConstraint_TupleDescriptor()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.allocation.language.as.LocationConstraint#getTupleDescriptor <em>Tuple Descriptor</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.uni_paderborn.fujaba.muml.allocation.language.as.LocationConstraintTypes}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.allocation.language.as.AsPackage#getLocationConstraint_Type()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.allocation.language.as.LocationConstraint#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
