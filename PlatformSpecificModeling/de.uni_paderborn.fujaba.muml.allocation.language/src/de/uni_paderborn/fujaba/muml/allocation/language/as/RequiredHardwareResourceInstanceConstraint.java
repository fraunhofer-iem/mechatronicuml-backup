 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.language.as.RequiredHardwareResourceInstanceConstraint#getTupleDescriptors <em>Tuple Descriptors</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.allocation.language.as.AsPackage#getRequiredHardwareResourceInstanceConstraint()
 * @model
 * @generated
 */
public interface RequiredHardwareResourceInstanceConstraint extends Constraint {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.allocation.language.as.AsPackage#getRequiredHardwareResourceInstanceConstraint_TupleDescriptors()
