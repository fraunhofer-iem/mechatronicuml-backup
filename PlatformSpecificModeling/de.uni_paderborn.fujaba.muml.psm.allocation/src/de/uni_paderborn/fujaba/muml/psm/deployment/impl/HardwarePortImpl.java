 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwarePortImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwarePortImpl#getConnectors <em>Connectors</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwarePortImpl#getHardwareNode <em>Hardware Node</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwarePortImpl#getDeployedPortInstance <em>Deployed Port Instance</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwarePortImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.deployment.impl.HardwarePortImpl#getCommunicationLinks <em>Communication Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
