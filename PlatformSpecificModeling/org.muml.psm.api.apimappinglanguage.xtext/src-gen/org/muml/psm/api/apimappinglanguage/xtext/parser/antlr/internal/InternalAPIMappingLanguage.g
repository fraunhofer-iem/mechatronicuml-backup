...
entryRuleMappingRepository returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMappingRepositoryRule()); }
	 iv_ruleMappingRepository=ruleMappingRepository 
	 { $current=$iv_ruleMappingRepository.current; } 
	 EOF 
;

// Rule MappingRepository
ruleMappingRepository returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRulePortApiMapping returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPortApiMappingRule()); }
	 iv_rulePortApiMapping=rulePortApiMapping 
	 { $current=$iv_rulePortApiMapping.current; } 
	 EOF 
;

// Rule PortApiMapping
rulePortApiMapping returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='PortInstance:' 
    {
...
entryRuleEnumerationValueExpression returns [EObject current=null] 
	...
	{ newCompositeNode(grammarAccess.getEnumerationValueExpressionRule()); }
	 ...
	 { $current=$iv_ruleEnumerationValueExpression.current; } 
	 EOF 
;

// Rule EnumerationValueExpression
ruleEnumerationValueExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='enum:' 
...
entryRuleAPICallExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAPICallExpressionRule()); }
	 iv_ruleAPICallExpression=ruleAPICallExpression 
	 { $current=$iv_ruleAPICallExpression.current; } 
	 EOF 
;

// Rule APICallExpression
ruleAPICallExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='API_Call:' 
