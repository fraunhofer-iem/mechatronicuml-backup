 ...
 * @generated
 */
public class StaticAtomicComponentCanonicalEditPolicy extends CanonicalEditPolicy {
	/**
	* @generated
	*/
	 ...
	 * @generated
	 */
	public StaticAtomicComponentCanonicalEditPolicy() {
	}

	/**
	 * @generated
	 */
	public StaticAtomicComponentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentPackage.eINSTANCE.getComponent_Ports();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { DiscretePortEditPart.VISUAL_ID,
						ContinuousPortEditPart.VISUAL_ID, HybridPortEditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getStaticAtomicComponent_2006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DiscretePortEditPart.VISUAL_ID || visualID == ContinuousPortEditPart.VISUAL_ID
				|| visualID == HybridPortEditPart.VISUAL_ID;
	}
