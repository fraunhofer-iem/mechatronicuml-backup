...
public class ComponentPartCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentPackage.eINSTANCE.getComponentPart_PortParts();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { PortPartEditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getComponentPart_3012SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return PortPartEditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
