...
public class StateRegionCompartmentCanonicalEditPolicy extends
	...
	public StateRegionCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] { de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.edit.parts.RegionEditPart.VISUAL_ID });
		...
		return de.uni_paderborn.fujaba.muml.realtimestatechart.diagram.part.MumlDiagramUpdater
				.getStateRegionCompartment_7032SemanticChildren(viewObject);
