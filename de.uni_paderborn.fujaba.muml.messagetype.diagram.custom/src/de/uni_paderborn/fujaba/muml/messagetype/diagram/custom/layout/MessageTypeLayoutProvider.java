package de.uni_paderborn.fujaba.muml.messagetype.diagram.custom.layout;
...
public class MessageTypeLayoutProvider extends TopDownProvider {
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof ILayoutNodeOperation) {
			...
			if (nodes.hasNext()) {
				...
				if (container == null
						|| !(container.getType().equals("Message Type"))) //$NON-NLS-1$
					return false;
			}
		} else {
			return false;
