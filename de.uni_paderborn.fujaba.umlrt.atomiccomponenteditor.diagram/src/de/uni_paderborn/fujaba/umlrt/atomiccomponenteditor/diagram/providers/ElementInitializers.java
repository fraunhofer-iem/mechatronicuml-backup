...
public class ElementInitializers {
	...
	public void init_Port_3002(
		...
		try {
			...
			Object value_0_0_0_0_0 = de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram.expressions.MumlinstanceOCLFactory
					.getExpression(
							0,
			...
			value_0_0_0_0_0 = de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram.expressions.MumlinstanceAbstractExpression
			...
			Object value_0_0_1_0_0 = de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram.expressions.MumlinstanceOCLFactory
					.getExpression(
							1,
							de.uni_paderborn.fujaba.muml.model.core.CorePackage.eINSTANCE
									.getNaturalNumber(), null).evaluate(
			...
			value_0_0_1_0_0 = de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram.expressions.MumlinstanceAbstractExpression
