 ...
 * @generated
 */
public abstract class AtomiccomponentAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram.part.AtomiccomponentDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected AtomiccomponentAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
