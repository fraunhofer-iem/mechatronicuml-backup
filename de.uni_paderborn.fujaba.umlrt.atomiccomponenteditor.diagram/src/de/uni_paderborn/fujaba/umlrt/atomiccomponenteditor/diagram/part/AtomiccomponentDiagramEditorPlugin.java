 ...
 * @generated
 */
public class AtomiccomponentDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static AtomiccomponentDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram.providers.ElementInitializers initializers;
	 ...
	 * @generated
	 */
	public static AtomiccomponentDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.umlrt.atomiccomponenteditor.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR,
						AtomiccomponentDiagramEditorPlugin.ID, IStatus.OK,
						error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, AtomiccomponentDiagramEditorPlugin.ID,
