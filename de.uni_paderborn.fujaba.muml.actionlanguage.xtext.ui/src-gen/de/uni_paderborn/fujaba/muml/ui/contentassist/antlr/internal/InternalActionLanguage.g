...
ruleLocalVariableDeclarationStatement
	...
	:
(
{ before(grammarAccess.getLocalVariableDeclarationStatementAccess().getVariableAssignment()); }
(rule__LocalVariableDeclarationStatement__VariableAssignment)
{ after(grammarAccess.getLocalVariableDeclarationStatementAccess().getVariableAssignment()); }
)
...
{ after(grammarAccess.getInitializeExpressionAccess().getArrayInitializeExpressionParserRuleCall_0()); }
    ...
    |(
{ before(grammarAccess.getInitializeExpressionAccess().getExpressionParserRuleCall_1()); }
	ruleExpression
{ after(grammarAccess.getInitializeExpressionAccess().getExpressionParserRuleCall_1()); }
)
...
:
(
{ before(grammarAccess.getArrayInitializeExpressionAccess().getLeftCurlyBracketKeyword_0()); }

	'{' 

{ after(grammarAccess.getArrayInitializeExpressionAccess().getLeftCurlyBracketKeyword_0()); }
)
...
:
(
{ before(grammarAccess.getArrayInitializeExpressionAccess().getRightCurlyBracketKeyword_3()); }

	'}' 

{ after(grammarAccess.getArrayInitializeExpressionAccess().getRightCurlyBracketKeyword_3()); }
)
...
:
(
{ before(grammarAccess.getAssignmentAccess().getRhs_assignExpressionInitializeExpressionParserRuleCall_2_0()); }
	ruleInitializeExpression{ after(grammarAccess.getAssignmentAccess().getRhs_assignExpressionInitializeExpressionParserRuleCall_2_0()); }
)
...
:
(
{ before(grammarAccess.getLocalVariableDeclarationStatementAccess().getVariableLocalVariableDeclarationParserRuleCall_0()); }
	ruleLocalVariableDeclaration{ after(grammarAccess.getLocalVariableDeclarationStatementAccess().getVariableLocalVariableDeclarationParserRuleCall_0()); }
)
...
{ before(grammarAccess.getLocalVariableDeclarationAccess().getDataTypeDataTypeIDTerminalRuleCall_0_0_1()); }
	RULE_ID{ after(grammarAccess.getLocalVariableDeclarationAccess().getDataTypeDataTypeIDTerminalRuleCall_0_0_1()); }
)
...
{ before(grammarAccess.getExtendedTypedNamedElementExpressionAccess().getPositionPositionSelectorExpressionParserRuleCall_1_2_0()); }
	rulePositionSelectorExpression{ after(grammarAccess.getExtendedTypedNamedElementExpressionAccess().getPositionPositionSelectorExpressionParserRuleCall_1_2_0()); }
)
