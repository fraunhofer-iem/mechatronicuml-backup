...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	 ...
	 * @generated
	 */
	private org.muml.pm.hardware.platforminstance.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new org.muml.pm.hardware.platforminstance.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
