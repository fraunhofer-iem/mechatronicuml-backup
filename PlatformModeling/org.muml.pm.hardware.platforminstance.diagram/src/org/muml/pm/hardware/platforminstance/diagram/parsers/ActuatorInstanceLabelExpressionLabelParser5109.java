 ...
 * @generated
 */
public class ActuatorInstanceLabelExpressionLabelParser5109 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ActuatorInstanceLabelExpressionLabelParser5109() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(6, HwresourceinstancePackage.eINSTANCE.getActuatorInstance(), null)
				.body();
	}
