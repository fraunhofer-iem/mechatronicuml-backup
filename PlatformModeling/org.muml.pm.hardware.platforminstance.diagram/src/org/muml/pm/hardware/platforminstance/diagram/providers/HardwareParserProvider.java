...
public class HardwareParserProvider extends AbstractProvider implements IParserProvider {
	...
	*/
	private IParser getHWPlatformInstanceName_5118Parser() {
		if (hWPlatformInstanceName_5118Parser == null) {
			...
			org.muml.pm.hardware.platforminstance.diagram.parsers.MessageFormatParser parser = new org.muml.pm.hardware.platforminstance.diagram.parsers.MessageFormatParser(
	...
	*/
	...
	private IParser getDelegationHWPortInstanceLabel_5100Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.DelegationHWPortInstanceLabelExpressionLabelParser5100();
	}
	...
	private IParser getStructuredResourceInstanceLabel_5104Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.StructuredResourceInstanceLabelExpressionLabelParser5104();
	}
	...
	private IParser getStructuredResourceInstanceLabel_5105Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.StructuredResourceInstanceLabelExpressionLabelParser5105();
	}
	...
	private IParser getStructuredResourceInstanceLabel_5106Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.StructuredResourceInstanceLabelExpressionLabelParser5106();
	}
	...
	private IParser getStructuredResourceInstanceLabel_5107Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.StructuredResourceInstanceLabelExpressionLabelParser5107();
	}
	...
	private IParser getHWPortInstanceLabel_5102Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.HWPortInstanceLabelExpressionLabelParser5102();
	}
	...
	private IParser getActuatorInstanceLabel_5109Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.ActuatorInstanceLabelExpressionLabelParser5109();
	}
	...
	private IParser getActuatorInstanceLabel_5110Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.ActuatorInstanceLabelExpressionLabelParser5110();
	}
	...
	private IParser getSensorInstanceLabel_5112Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.SensorInstanceLabelExpressionLabelParser5112();
	}
	...
	private IParser getSensorInstanceLabel_5113Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.SensorInstanceLabelExpressionLabelParser5113();
	}
	...
	private IParser getBusInstanceLabel_5114Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.BusInstanceLabelExpressionLabelParser5114();
	}
	...
	private IParser getBusInstanceLabel_5115Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.BusInstanceLabelExpressionLabelParser5115();
	}
	...
	private IParser getNetworkBridgeInstanceLabel_5116Parser() {
		return new org.muml.pm.hardware.platforminstance.diagram.parsers.NetworkBridgeInstanceLabelExpressionLabelParser5116();
	}
