...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(org.muml.pm.hardware.platforminstance.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (org.muml.pm.hardware.platforminstance.diagram.part.HardwareDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		org.muml.pm.hardware.platforminstance.diagram.providers.HardwareValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			org.muml.pm.hardware.platforminstance.diagram.providers.HardwareMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		org.muml.pm.hardware.platforminstance.diagram.part.HardwareDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new org.muml.pm.hardware.platforminstance.diagram.part.HardwareDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = org.muml.pm.hardware.platforminstance.diagram.part.HardwareDiagramEditorUtil
