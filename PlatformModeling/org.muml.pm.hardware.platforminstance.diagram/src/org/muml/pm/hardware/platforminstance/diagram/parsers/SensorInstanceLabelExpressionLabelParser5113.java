 ...
 * @generated
 */
public class SensorInstanceLabelExpressionLabelParser5113 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public SensorInstanceLabelExpressionLabelParser5113() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(9, HwresourceinstancePackage.eINSTANCE.getSensorInstance(), null)
				.body();
	}
