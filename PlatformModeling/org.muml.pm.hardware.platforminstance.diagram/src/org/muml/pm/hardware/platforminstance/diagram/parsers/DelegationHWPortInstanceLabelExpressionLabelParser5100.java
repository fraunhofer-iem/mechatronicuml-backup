 ...
 * @generated
 */
public class DelegationHWPortInstanceLabelExpressionLabelParser5100 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public DelegationHWPortInstanceLabelExpressionLabelParser5100() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory
				.getExpression(0, HwplatforminstancePackage.eINSTANCE.getDelegationHWPortInstance(), null).body();
	}
