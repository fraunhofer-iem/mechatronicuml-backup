	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof org.muml.pm.hardware.platforminstance.diagram.navigator.HardwareNavigatorItem
						&& (adapterType == View.class || adapterType == EObject.class)) {
					return ((org.muml.pm.hardware.platforminstance.diagram.navigator.HardwareNavigatorItem) adaptableObject)
							.getView();
				}
				return null;
			}
		...
		}, org.muml.pm.hardware.platforminstance.diagram.navigator.HardwareNavigatorItem.class);
	}
