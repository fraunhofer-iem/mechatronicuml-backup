 ...
 * @generated
 */
public class HWPortInstanceLabelExpressionLabelParser5102 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public HWPortInstanceLabelExpressionLabelParser5102() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(1, HwplatforminstancePackage.eINSTANCE.getHWPortInstance(), null)
				.body();
	}
