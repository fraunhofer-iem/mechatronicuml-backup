 ...
 * @generated
 */
public class StructuredResourceInstanceLabelExpressionLabelParser5106 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public StructuredResourceInstanceLabelExpressionLabelParser5106() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory
				.getExpression(4, HwresourceinstancePackage.eINSTANCE.getStructuredResourceInstance(), null).body();
	}
