 ...
 * @generated
 */
public class StructuredResourceInstanceLabelExpressionLabelParser5105 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public StructuredResourceInstanceLabelExpressionLabelParser5105() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory
				.getExpression(3, HwresourceinstancePackage.eINSTANCE.getStructuredResourceInstance(), null).body();
	}
