...
public class HardwarePaletteFactory {
	...
	private PaletteContainer createPlatforminstance1Group() {
		PaletteGroup paletteContainer = new PaletteGroup(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.Platforminstance1Group_title);
	...
	private PaletteContainer createMisreferencedtools2Group() {
		PaletteGroup paletteContainer = new PaletteGroup(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.Misreferencedtools2Group_title);
		paletteContainer.setId("createMisreferencedtools2Group"); //$NON-NLS-1$
		paletteContainer.setDescription(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.Misreferencedtools2Group_desc);
	...
	private ToolEntry createHWPlatformInstance1CreationTool() {
		...
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.HWPlatformInstance1CreationTool_title,
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.HWPlatformInstance1CreationTool_desc,
				types);
		...
		entry.setSmallIcon(
				org.muml.pm.hardware.platforminstance.diagram.part.PlatformInstanceDiagramEditorPlugin
						.findImageDescriptor(
								"/de.uni_paderborn.fujaba.muml.hardware.common/icons/platforminstance_small.gif")); //$NON-NLS-1$
		entry.setLargeIcon(
				org.muml.pm.hardware.platforminstance.diagram.part.PlatformInstanceDiagramEditorPlugin
						.findImageDescriptor(
								"/de.uni_paderborn.fujaba.muml.hardware.common/icons/platforminstance_large.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createStructuredResourceInstance1CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.StructuredResourceInstance1CreationTool_title,
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.StructuredResourceInstance1CreationTool_desc,
	...
	private ToolEntry createActuatorInstance2CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.ActuatorInstance2CreationTool_title,
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.ActuatorInstance2CreationTool_desc,
				Collections.singletonList(
	...
	private ToolEntry createSensorInstance3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.SensorInstance3CreationTool_title,
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.SensorInstance3CreationTool_desc,
				Collections.singletonList(
	...
	private ToolEntry createNetworkConnectorInstance4CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				org.muml.pm.hardware.platforminstance.diagram.part.Messages.NetworkConnectorInstance4CreationTool_title,
		...
		entry.setSmallIcon(org.muml.pm.hardware.platforminstance.diagram.providers.HardwareElementTypes
				.getImageDescriptor(
						org.muml.pm.hardware.platforminstance.diagram.providers.HardwareElementTypes.NetworkConnectorInstance_4012));
