...
public class HWPlatformInstance2CreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		HWPlatformInstance newElement = HwplatforminstanceFactory.eINSTANCE.createHWPlatformInstance();
		...
		ElementInitializers.getInstance().init_HWPlatformInstance_3040(newElement);
	...
	* @generated
	*/
	protected void doConfigure(HWPlatformInstance newElement, IProgressMonitor monitor, IAdaptable info)
