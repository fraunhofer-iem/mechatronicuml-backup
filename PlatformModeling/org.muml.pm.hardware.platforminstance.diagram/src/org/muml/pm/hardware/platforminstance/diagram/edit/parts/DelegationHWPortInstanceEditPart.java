...
import org.muml.pm.hardware.common.edit.policies.hwport.HWDelegationPortInstanceEditPolicy;
import org.muml.pm.hardware.common.figures.CustomHWPortFigure;
import org.muml.pm.hardware.platforminstance.diagram.edit.policies.DelegationHWPortInstanceItemSemanticEditPolicy;
import org.muml.pm.hardware.platforminstance.diagram.part.HardwareVisualIDRegistry;

/**
 * @generated
 */
public class DelegationHWPortInstanceEditPart extends BorderedBorderItemEditPart {
	...
	*/
	 ...
	 * @generated
	 */
	public DelegationHWPortInstanceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DelegationHWPortInstanceItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());

		installEditPolicy(org.muml.pm.hardware.common.edit.policies.EditPolicyRoles.HWPORT_VISUALIZATION_ROLE,
				new HWDelegationPortInstanceEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CustomHWPortFigure();
	}

	/**
	 * @generated
	 */
	public CustomHWPortFigure getPrimaryShape() {
		return (CustomHWPortFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof HWPortLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(HardwareVisualIDRegistry.getType(HWPortLabelEditPart.VISUAL_ID));
	}
