	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.platforminstance.diagram.edit.policies.DelegationHWPortInstanceItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());

		installEditPolicy(
				org.muml.pm.hardware.common.edit.policies.EditPolicyRoles.HWPORT_VISUALIZATION_ROLE,
				new org.muml.pm.hardware.common.edit.policies.hwport.HWDelegationPortInstanceEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new org.muml.pm.hardware.common.figures.CustomHWPortFigure();
	}

	/**
	 * @generated
	 */
	public org.muml.pm.hardware.common.figures.CustomHWPortFigure getPrimaryShape() {
		return (org.muml.pm.hardware.common.figures.CustomHWPortFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.HWPortLabelEditPart) {
