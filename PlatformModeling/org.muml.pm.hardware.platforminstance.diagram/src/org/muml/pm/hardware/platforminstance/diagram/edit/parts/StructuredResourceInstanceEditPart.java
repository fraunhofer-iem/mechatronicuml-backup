	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.platforminstance.diagram.edit.policies.StructuredResourceInstanceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.muml.pm.hardware.platforminstance.diagram.edit.policies.StructuredResourceInstanceCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.StructuredResourceInstanceNameEditPart) {
			((org.muml.pm.hardware.platforminstance.diagram.edit.parts.StructuredResourceInstanceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel3EditPart) {
			((org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel4EditPart) {
			((org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceCardinalityFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel5EditPart) {
			((org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel5EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceInfo1());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel6EditPart) {
			((org.muml.pm.hardware.platforminstance.diagram.edit.parts.WrappingLabel6EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceInfo2());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.HWPortInstanceEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.EAST);
			getBorderedFigure().getBorderItemContainer()
					.add(((org.muml.pm.hardware.platforminstance.diagram.edit.parts.HWPortInstanceEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.pm.hardware.platforminstance.diagram.edit.parts.HWPortInstanceEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((org.muml.pm.hardware.platforminstance.diagram.edit.parts.HWPortInstanceEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
