...
* generated by Xtext
*/
package de.uni_paderborn.fujaba.muml.swplatform.oslanguage.services;
...
public class OperatingSystemLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class OperatingSystemElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "OperatingSystem");
	...
	public class APIRepositoryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "APIRepository");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class APICommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "APICommand");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class INTExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "INTExpression");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cValueEStringParserRuleCall_0 = (RuleCall)cValueAssignment.eContents().get(0);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.uni_paderborn.fujaba.muml.swplatform.oslanguage.OperatingSystemLanguage".equals(grammar.getName())) {
				return grammar;
			}
