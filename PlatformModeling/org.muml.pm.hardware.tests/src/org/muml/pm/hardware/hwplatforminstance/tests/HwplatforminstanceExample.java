...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>hwplatforminstance</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class HwplatforminstanceExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(HwplatforminstancePackage.eNS_URI, 
			 HwplatforminstancePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.hwplatforminstance"));
				HWPlatformInstance root = HwplatforminstanceFactory.eINSTANCE.createHWPlatformInstance();
