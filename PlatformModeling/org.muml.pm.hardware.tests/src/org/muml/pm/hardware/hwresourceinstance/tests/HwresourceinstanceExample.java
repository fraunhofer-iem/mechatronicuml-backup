...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>hwresourceinstance</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class HwresourceinstanceExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(HwresourceinstancePackage.eNS_URI, 
			 HwresourceinstancePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.hwresourceinstance"));
				StorageMemoryInstance root = HwresourceinstanceFactory.eINSTANCE.createStorageMemoryInstance();
