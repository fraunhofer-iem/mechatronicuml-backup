...
public class NetworkBridgeTest extends NetworkingHardwareTest {
	...
	/**
	 * Tests the '{@link de.uni_paderborn.fujaba.muml.hardware.hwplatform.NetworkBridge#getConnectedNetworkConnector() <em>Connected Network Connector</em>}' feature getter.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
