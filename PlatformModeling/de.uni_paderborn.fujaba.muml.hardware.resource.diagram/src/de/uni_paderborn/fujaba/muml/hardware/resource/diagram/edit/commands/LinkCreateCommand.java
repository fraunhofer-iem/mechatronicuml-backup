...
public class LinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LinkCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.hardware.hwresource.Link newElement = de.uni_paderborn.fujaba.muml.hardware.hwresource.HwresourceFactory.eINSTANCE
				.createLink();
		...
		de.uni_paderborn.fujaba.muml.hardware.resource.diagram.providers.ElementInitializers
				.getInstance().init_Link_2004(newElement);
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.hardware.hwresource.Link newElement,
