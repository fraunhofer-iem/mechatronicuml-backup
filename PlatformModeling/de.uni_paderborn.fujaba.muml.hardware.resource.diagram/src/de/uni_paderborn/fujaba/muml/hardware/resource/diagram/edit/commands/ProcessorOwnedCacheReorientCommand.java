...
public class ProcessorOwnedCacheReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof de.uni_paderborn.fujaba.muml.hardware.hwresource.Processor) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.hwresource.Processor getOldSource() {
		return (de.uni_paderborn.fujaba.muml.hardware.hwresource.Processor) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.hwresource.Processor getNewSource() {
		return (de.uni_paderborn.fujaba.muml.hardware.hwresource.Processor) newEnd;
	}

	/**
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.hwresource.Cache getOldTarget() {
		return (de.uni_paderborn.fujaba.muml.hardware.hwresource.Cache) oldEnd;
	}
