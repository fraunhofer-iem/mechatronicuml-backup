package de.uni_paderborn.fujaba.muml.hardware.resource.diagram.parsers;
 ...
 * @generated
 */
public class CommunicationResourceLabelExpressionLabelParser5046 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public CommunicationResourceLabelExpressionLabelParser5046() {
	}
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.hardware.resource.diagram.expressions.HardwareOCLFactory.getExpression(9,
				de.uni_paderborn.fujaba.muml.hardware.hwresource.HwresourcePackage.eINSTANCE.getCommunicationResource(),
				null).body();
	}
