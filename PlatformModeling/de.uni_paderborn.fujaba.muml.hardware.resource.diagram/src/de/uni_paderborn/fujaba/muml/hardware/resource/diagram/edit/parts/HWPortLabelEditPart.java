 ...
 * @generated
 */
public class HWPortLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 * @generated
	 */
	public HWPortLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new de.uni_paderborn.fujaba.muml.hardware.resource.diagram.edit.policies.HardwareTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.hardware.resource.diagram.providers.HardwareParserProvider.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					de.uni_paderborn.fujaba.muml.hardware.resource.diagram.edit.parts.HardwareEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new HWPortLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HWPortLabelFigure extends WrappingLabel {
