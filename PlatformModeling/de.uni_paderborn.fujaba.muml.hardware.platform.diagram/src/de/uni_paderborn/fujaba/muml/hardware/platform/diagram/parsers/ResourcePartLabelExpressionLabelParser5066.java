...
public class ResourcePartLabelExpressionLabelParser5066 extends ExpressionLabelParserBase {
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory.getExpression(12,
				de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage.eINSTANCE.getResourcePart(), null)
				.body();
	}
	...
	public String getEditString(IAdaptable element, int flags) {
		...
		Object result = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory
				.getExpression(13,
						de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage.eINSTANCE.getResourcePart(),
						null)
				.evaluate(target);
