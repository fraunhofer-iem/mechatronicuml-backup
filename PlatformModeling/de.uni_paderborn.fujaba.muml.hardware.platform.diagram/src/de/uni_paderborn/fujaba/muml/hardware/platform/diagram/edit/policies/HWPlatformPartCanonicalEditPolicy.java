 ...
 * @generated
 */
public class HWPlatformPartCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public HWPlatformPartCanonicalEditPolicy() {
	}

	public HWPlatformPartCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenList() {
		...
		List<de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareNodeDescriptor> childDescriptors = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramUpdater
				.getHWPlatformPart_3016SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.parts.HWPortPartEditPart.VISUAL_ID == de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareNodeDescriptor> childDescriptors = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramUpdater
				.getHWPlatformPart_3016SemanticChildren((View) getHost()
						.getModel());
