...
public class DelegationReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.muml.hardware.hwplatform.Delegation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistDelegation_4028(container,
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorDelegation_4028(container,
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.hwplatform.Delegation getLink() {
		return (de.uni_paderborn.fujaba.muml.hardware.hwplatform.Delegation) getElementToEdit();
	}
