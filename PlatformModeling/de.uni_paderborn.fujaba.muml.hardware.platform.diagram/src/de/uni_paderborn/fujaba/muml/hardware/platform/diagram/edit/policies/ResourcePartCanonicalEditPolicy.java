 ...
 * @generated
 */
public class ResourcePartCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public ResourcePartCanonicalEditPolicy() {
	}

	public ResourcePartCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenList() {
		...
		List<de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareNodeDescriptor> childDescriptors = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramUpdater
				.getResourcePart_3019SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareNodeDescriptor> childDescriptors = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramUpdater
				.getResourcePart_3019SemanticChildren((View) getHost()
						.getModel());
