 ...
 * @generated
 */
public class BusConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BusConnectorCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateBusConnector_4030(
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorBusConnector_4030(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.hardware.hwplatform.BusConnector newElement = de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformFactory.eINSTANCE
				.createBusConnector();
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.hardware.hwplatform.BusConnector newElement,
