...
public class HWPlatformCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.hardware.hwplatform.HWPlatform newElement = de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformFactory.eINSTANCE
				.createHWPlatform();

		resource.getContents().add(newElement);

		de.uni_paderborn.fujaba.muml.hardware.platform.diagram.providers.ElementInitializers
				.getInstance().init_HWPlatform_2008(newElement);
