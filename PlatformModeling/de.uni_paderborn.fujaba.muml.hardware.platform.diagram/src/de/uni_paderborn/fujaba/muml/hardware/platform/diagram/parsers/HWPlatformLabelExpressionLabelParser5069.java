...
public class HWPlatformLabelExpressionLabelParser5069 extends ExpressionLabelParserBase {
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory.getExpression(16,
				de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage.eINSTANCE.getHWPlatform(), null)
				.body();
	}
