 ...
 * @generated
 */
public class BusLabelExpressionLabelParser5057 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public BusLabelExpressionLabelParser5057() {
	}
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory.getExpression(0,
				de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage.eINSTANCE.getBus(), null).body();
	}
