 ...
 * @generated
 */
public class LinkPartCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LinkPartCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateLinkPart_4029(getContainer(),
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorLinkPart_4029(getContainer(),
							getSource(), getTarget(), sourceView, targetView);
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.hardware.hwplatform.LinkPart newElement = de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformFactory.eINSTANCE
				.createLinkPart();
		getContainer().getNetworkingHardwareParts().add(newElement);
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.hardware.hwplatform.LinkPart newElement,
