 ...
 * @generated
 */
public class DataRateEditor extends org.muml.ape.runtime.editors.ClassPropertyEditor {
	...
	public DataRateEditor(String tab) {
		this(tab, org.muml.pm.hardware.properties.util.PropertiesUtil.INSTANCE.getAdapterFactory(),
				org.muml.pm.hardware.hwvaluetype.HwvaluetypePackage.eINSTANCE.getDataRate());
	}
