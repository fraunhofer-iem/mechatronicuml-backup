 ...
 * @generated
 */
public class StructuredResourceEditor extends org.muml.ape.runtime.editors.ClassPropertyEditor {
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorEmbeddedAtomicResources_property_tab_generalTab_Editor(), false);
	...
	private org.muml.ape.runtime.editors.AbstractStructuralFeaturePropertyEditor editorEmbeddedAtomicResources_property_tab_generalTab;
	private org.muml.ape.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorEmbeddedAtomicResources_property_tab_generalTab_Editor() {
		if (this.editorEmbeddedAtomicResources_property_tab_generalTab == null) {
			...
			editor.setTooltipMessage("All AtomicResources which are contained in this StructuredResource.");

			this.editorEmbeddedAtomicResources_property_tab_generalTab = editor;
		}
		return this.editorEmbeddedAtomicResources_property_tab_generalTab;
	}
