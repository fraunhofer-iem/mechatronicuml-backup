...
public class NetworkConnectorInstanceReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.NetworkConnectorInstance) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.NetworkConnectorInstance getLink() {
		return (de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.NetworkConnectorInstance) getElementToEdit();
	}
