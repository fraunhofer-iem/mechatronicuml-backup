...
public class HardwareDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.navigator.HardwareDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.navigator.HardwareDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.navigator.HardwareDomainNavigatorItem(
