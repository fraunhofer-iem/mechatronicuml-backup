...
public class HardwareSheetLabelProvider extends BaseLabelProvider implements
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.part.HardwareVisualIDRegistry
					.getVisualID(view);
			IElementType etype = de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.providers.HardwareElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
