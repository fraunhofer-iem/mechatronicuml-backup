 ...
 * @generated
 */
public class HWPlatformInstanceHWPlatformCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.part.Messages.HWPlatformInstanceHWPlatformCompartment2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HWPlatformInstanceHWPlatformCompartment2ItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HWPlatformInstanceHWPlatformCompartment2CanonicalEditPolicy());
	}
