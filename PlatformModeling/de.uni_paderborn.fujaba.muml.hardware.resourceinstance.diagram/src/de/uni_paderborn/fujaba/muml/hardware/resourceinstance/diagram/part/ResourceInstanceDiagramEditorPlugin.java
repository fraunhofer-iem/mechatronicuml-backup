...
public class ResourceInstanceDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.part.HardwareDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.providers.ElementInitializers initializers;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.expressions.HardwareOCLFactory oclFactory;
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.part.HardwareDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.part.HardwareDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.expressions.HardwareOCLFactory getHardwareOCLFactory() {
		return oclFactory;
	}
	...
	public void setHardwareOCLFactory(
			de.uni_paderborn.fujaba.muml.hardware.resourceinstance.diagram.expressions.HardwareOCLFactory f) {
		this.oclFactory = f;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR,
						ResourceInstanceDiagramEditorPlugin.ID, IStatus.OK,
						error, throwable));
