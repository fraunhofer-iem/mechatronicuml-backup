		...
		*/
		...
		public Object execute(ExecutionEvent event) throws ExecutionException {
			...
			if (selectedResource instanceof IContainer) {
				...
				String fileName = de.uni_paderborn.fujaba.muml.hardware.resource.diagram.part.HardwareDiagramEditorUtil
				...
				EObject model = de.uni_paderborn.fujaba.muml.hardware.hwresource.HwresourceFactory.eINSTANCE
