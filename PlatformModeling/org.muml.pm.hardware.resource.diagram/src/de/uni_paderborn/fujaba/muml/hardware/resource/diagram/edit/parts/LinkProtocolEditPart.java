 ...
 * @generated
 */
public class LinkProtocolEditPart extends ShapeNodeEditPart {
	...
	*/
	 ...
	 * @generated
	 */
	public LinkProtocolEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new de.uni_paderborn.fujaba.muml.hardware.resource.diagram.edit.policies.LinkProtocolItemSemanticEditPolicy());
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null) {
					if (child instanceof ITextAwareEditPart) {
						return new de.uni_paderborn.fujaba.muml.hardware.resource.diagram.edit.policies.HardwareTextSelectionEditPolicy();
					}
				}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.hardware.resource.diagram.edit.parts.LinkProtocolNameEditPart) {
			((de.uni_paderborn.fujaba.muml.hardware.resource.diagram.edit.parts.LinkProtocolNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureProtocolNameLabelFigure());
			return true;
		}
		return false;
	}
