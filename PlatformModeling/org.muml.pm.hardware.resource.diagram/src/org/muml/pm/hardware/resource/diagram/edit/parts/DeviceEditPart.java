	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resource.diagram.edit.policies.DeviceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.muml.pm.hardware.resource.diagram.edit.policies.DeviceCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.DeviceNameEditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.DeviceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabelEditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceCardinalityFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel2EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.CommunicationResourceEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.EAST);
			getBorderedFigure().getBorderItemContainer()
					.add(((org.muml.pm.hardware.resource.diagram.edit.parts.CommunicationResourceEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.CommunicationResourceEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((org.muml.pm.hardware.resource.diagram.edit.parts.CommunicationResourceEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
