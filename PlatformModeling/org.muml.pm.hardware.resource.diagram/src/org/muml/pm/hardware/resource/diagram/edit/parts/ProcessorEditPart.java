	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resource.diagram.edit.policies.ProcessorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel11EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel11EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.ProcessorNameEditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.ProcessorNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel12EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel12EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceCardinalityFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel13EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel13EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceInfo1());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel14EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel14EditPart) childEditPart)
