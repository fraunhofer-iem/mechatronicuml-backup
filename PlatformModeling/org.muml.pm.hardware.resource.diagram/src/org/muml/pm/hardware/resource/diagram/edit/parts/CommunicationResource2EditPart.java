...
import org.muml.pm.hardware.resource.diagram.edit.policies.CommunicationResource2ItemSemanticEditPolicy;
...
public class CommunicationResource2EditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CommunicationResource2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CommunicationResourceNameEditPart) {
			((CommunicationResourceNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(HardwareVisualIDRegistry.getType(CommunicationResourceNameEditPart.VISUAL_ID));
	}
