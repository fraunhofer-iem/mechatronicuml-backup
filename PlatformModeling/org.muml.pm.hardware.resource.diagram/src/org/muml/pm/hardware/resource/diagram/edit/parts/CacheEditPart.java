...
import org.muml.pm.hardware.resource.diagram.edit.policies.CacheItemSemanticEditPolicy;
...
public class CacheEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CacheItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CacheNameEditPart) {
			((CacheNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(HardwareVisualIDRegistry.getType(CacheNameEditPart.VISUAL_ID));
	}
