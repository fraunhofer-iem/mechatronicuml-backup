	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resource.diagram.edit.policies.CacheItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.CacheNameEditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.CacheNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel7EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel7EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel8EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel8EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceCardinalityFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel9EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel9EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceInfo1());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel10EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel10EditPart) childEditPart)
