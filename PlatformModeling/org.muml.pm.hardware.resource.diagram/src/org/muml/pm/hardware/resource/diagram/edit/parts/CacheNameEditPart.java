...
public class CacheNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = HardwareParserProvider.getParser(HardwareElementTypes.Cache_3013, getParserElement(),
					HardwareVisualIDRegistry
							.getType(org.muml.pm.hardware.resource.diagram.edit.parts.CacheNameEditPart.VISUAL_ID));
		}
		return parser;
	}
