...
public class WrappingLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = HardwareParserProvider.getParser(HardwareElementTypes.Device_2006, getParserElement(),
					HardwareVisualIDRegistry
							.getType(org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
