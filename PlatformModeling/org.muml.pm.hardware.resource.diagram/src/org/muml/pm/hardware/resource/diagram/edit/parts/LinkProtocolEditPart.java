...
import org.muml.pm.hardware.resource.diagram.edit.policies.LinkProtocolItemSemanticEditPolicy;
...
public class LinkProtocolEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LinkProtocolItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LinkProtocolNameEditPart) {
			((LinkProtocolNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureProtocolNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(HardwareVisualIDRegistry.getType(LinkProtocolNameEditPart.VISUAL_ID));
	}
