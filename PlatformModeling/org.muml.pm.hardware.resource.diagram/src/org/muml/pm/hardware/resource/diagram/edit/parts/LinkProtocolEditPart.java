	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resource.diagram.edit.policies.LinkProtocolItemSemanticEditPolicy());
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null) {
					if (child instanceof ITextAwareEditPart) {
						return new org.muml.pm.hardware.resource.diagram.edit.policies.HardwareTextSelectionEditPolicy();
					}
				}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.LinkProtocolNameEditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.LinkProtocolNameEditPart) childEditPart)
