	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resource.diagram.edit.policies.ProgrammableLogicDeviceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.ProgrammableLogicDeviceNameEditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.ProgrammableLogicDeviceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel15EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel15EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel16EditPart) {
			((org.muml.pm.hardware.resource.diagram.edit.parts.WrappingLabel16EditPart) childEditPart)
