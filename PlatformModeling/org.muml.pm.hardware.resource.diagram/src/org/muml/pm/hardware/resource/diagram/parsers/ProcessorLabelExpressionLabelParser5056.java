...
public class ProcessorLabelExpressionLabelParser5056 extends ExpressionLabelParserBase {
	...
	protected String getExpressionBody() {
		return org.muml.pm.hardware.resource.diagram.expressions.HardwareOCLFactory.getExpression(18,
				org.muml.pm.hardware.hwresource.HwresourcePackage.eINSTANCE.getProcessor(), null)
				.body();
	}
