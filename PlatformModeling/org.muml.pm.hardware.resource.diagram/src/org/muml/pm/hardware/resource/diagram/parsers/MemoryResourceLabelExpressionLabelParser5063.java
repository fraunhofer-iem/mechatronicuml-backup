...
public class MemoryResourceLabelExpressionLabelParser5063 extends ExpressionLabelParserBase {
	...
	protected String getExpressionBody() {
		return org.muml.pm.hardware.resource.diagram.expressions.HardwareOCLFactory.getExpression(23,
				org.muml.pm.hardware.hwresource.HwresourcePackage.eINSTANCE.getMemoryResource(), null)
				.body();
	}
