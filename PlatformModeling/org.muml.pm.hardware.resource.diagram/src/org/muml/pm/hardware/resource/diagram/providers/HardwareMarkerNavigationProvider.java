...
import org.muml.pm.hardware.resource.diagram.part.HardwareDiagramEditorUtil;
...
public class HardwareMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
	 ...
	 * @generated
	 */
	public static final String MARKER_TYPE = HardwareDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	public static void deleteMarkers(IResource resource) {
		try {
			...
			HardwareDiagramEditorPlugin.getInstance().logError("Failed to delete validation markers", e); //$NON-NLS-1$
		}
	}
	...
	public static IMarker addMarker(IFile file, String elementId, String location, String message, int statusSeverity) {
		...
		try {
			...
			HardwareDiagramEditorPlugin.getInstance().logError("Failed to create validation marker", e); //$NON-NLS-1$
		}
		return marker;
	}
}
