...
public class StructuredResourceCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		StructuredResource newElement = HwresourceFactory.eINSTANCE.createStructuredResource();

		ResourceRepository owner = (ResourceRepository) getElementToEdit();
		owner.getResources().add(newElement);

		ElementInitializers.getInstance().init_StructuredResource_2007(newElement);
	...
	* @generated
	*/
	protected void doConfigure(StructuredResource newElement, IProgressMonitor monitor, IAdaptable info)
