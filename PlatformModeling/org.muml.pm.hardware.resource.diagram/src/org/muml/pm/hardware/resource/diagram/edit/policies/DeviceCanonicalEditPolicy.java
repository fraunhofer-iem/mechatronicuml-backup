...
public class DeviceCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return org.muml.pm.hardware.resource.diagram.edit.parts.CommunicationResourceEditPart.VISUAL_ID == org.muml.pm.hardware.resource.diagram.part.HardwareVisualIDRegistry
				.getVisualID(view);
	}
