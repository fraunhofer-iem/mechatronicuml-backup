 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.swplatform.TimeConstraint#getSamplingTime <em>Sampling Time</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.swplatform.SwplatformPackage#getTimeConstraint()
 * @model
 * @generated
 */
public interface TimeConstraint extends Constraint {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.swplatform.SwplatformPackage#getTimeConstraint_SamplingTime()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.swplatform.TimeConstraint#getSamplingTime <em>Sampling Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
