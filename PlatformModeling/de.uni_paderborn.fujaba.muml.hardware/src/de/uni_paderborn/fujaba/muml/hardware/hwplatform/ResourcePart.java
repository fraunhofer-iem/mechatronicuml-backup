 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.hardware.hwplatform.ResourcePart#getResourceType <em>Resource Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage#getResourcePart()
 * @model
 * @generated
 */
public interface ResourcePart extends PlatformPart {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage#getResourcePart_ResourceType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.hardware.hwplatform.ResourcePart#getResourceType <em>Resource Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
