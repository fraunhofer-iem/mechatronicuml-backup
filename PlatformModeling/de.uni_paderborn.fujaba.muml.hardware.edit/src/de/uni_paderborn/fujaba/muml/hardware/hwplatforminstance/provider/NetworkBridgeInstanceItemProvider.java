...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.NetworkBridgeInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkBridgeInstanceItemProvider extends NetworkingHardwareInstanceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public NetworkBridgeInstanceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns NetworkBridgeInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NetworkBridgeInstance"));
	}
	...
	public String getText(Object object) {
		String label = ((NetworkBridgeInstance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NetworkBridgeInstance_type") :
			getString("_UI_NetworkBridgeInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NetworkBridgeInstance.class)) {
