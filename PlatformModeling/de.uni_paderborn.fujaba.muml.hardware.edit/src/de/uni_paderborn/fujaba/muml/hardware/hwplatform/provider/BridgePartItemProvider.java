...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.hwplatform.BridgePart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BridgePartItemProvider
	 ...
	 * @generated
	 */
	public BridgePartItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwplatformPackage.Literals.BRIDGE_PART__DELAY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BridgePart"));
	}
	...
	public String getText(Object object) {
		String label = ((BridgePart)object).getComment();
		return label == null || label.length() == 0 ?
			getString("_UI_BridgePart_type") :
			getString("_UI_BridgePart_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BridgePart.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HwplatformPackage.Literals.BRIDGE_PART__DELAY,
