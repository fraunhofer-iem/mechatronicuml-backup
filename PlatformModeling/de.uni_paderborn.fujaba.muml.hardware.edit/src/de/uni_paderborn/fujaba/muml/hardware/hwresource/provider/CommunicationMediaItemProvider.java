...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.hwresource.CommunicationMedia} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommunicationMediaItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HwresourcePackage.Literals.COMMUNICATION_MEDIA__PROTOCOL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HwresourcePackage.Literals.COMMUNICATION_MEDIA__IS_SERIAL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwresourcePackage.Literals.COMMUNICATION_MEDIA__DATA_FRAME_SIZE);
			childrenFeatures.add(HwresourcePackage.Literals.COMMUNICATION_MEDIA__BANDWIDTH);
		}
