 ...
 * @generated
 */
public class SensorInstanceLabelExpressionLabelParser5073 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public SensorInstanceLabelExpressionLabelParser5073() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(1, HwresourceinstancePackage.eINSTANCE.getSensorInstance(), null)
				.body();
	}
