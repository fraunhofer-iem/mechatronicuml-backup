 ...
 * @generated
 */
public class CacheInstanceLabelExpressionLabelParser5080 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public CacheInstanceLabelExpressionLabelParser5080() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(6, HwresourceinstancePackage.eINSTANCE.getCacheInstance(), null).body();
	}
