 ...
 * @generated
 */
public class CacheInstanceLabelExpressionLabelParser5079 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public CacheInstanceLabelExpressionLabelParser5079() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(5, HwresourceinstancePackage.eINSTANCE.getCacheInstance(), null).body();
	}
