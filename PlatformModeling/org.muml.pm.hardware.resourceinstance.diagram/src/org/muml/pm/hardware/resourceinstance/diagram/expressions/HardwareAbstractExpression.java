...
public abstract class HardwareAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ResourceInstanceDiagramEditorPlugin.ID;
	...
	public Object evaluate(Object context, Map env) {
		if (context().isInstance(context)) {
			try {
				...
				ResourceInstanceDiagramEditorPlugin.getInstance().logError("Expression evaluation failure: " + body(), //$NON-NLS-1$
						e);
			}
		}
		return null;
