...
public class ProcessorInstanceEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resourceinstance.diagram.edit.policies.ProcessorInstanceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.ProcessorInstanceNameEditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.ProcessorInstanceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel13EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel13EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceCardinalityFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel14EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel14EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel15EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel15EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceInfo1());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel16EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel16EditPart) childEditPart)
	...
	*/
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (event
				.getFeature() == org.muml.pm.hardware.hwresourceinstance.HwresourceinstancePackage.eINSTANCE
