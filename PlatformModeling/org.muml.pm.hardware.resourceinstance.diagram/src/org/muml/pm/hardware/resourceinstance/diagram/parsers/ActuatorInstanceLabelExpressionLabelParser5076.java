 ...
 * @generated
 */
public class ActuatorInstanceLabelExpressionLabelParser5076 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ActuatorInstanceLabelExpressionLabelParser5076() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(3, HwresourceinstancePackage.eINSTANCE.getActuatorInstance(), null)
				.body();
	}
