...
public class HardwareNavigatorSorter extends ViewerSorter {
	...
	public int category(Object element) {
		if (element instanceof org.muml.pm.hardware.resourceinstance.diagram.navigator.HardwareNavigatorItem) {
			org.muml.pm.hardware.resourceinstance.diagram.navigator.HardwareNavigatorItem item = (org.muml.pm.hardware.resourceinstance.diagram.navigator.HardwareNavigatorItem) element;
