	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resourceinstance.diagram.edit.policies.ActuatorInstanceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.muml.pm.hardware.resourceinstance.diagram.edit.policies.ActuatorInstanceCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.ActuatorInstanceNameEditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.ActuatorInstanceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel3EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel4EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel4EditPart) childEditPart)
