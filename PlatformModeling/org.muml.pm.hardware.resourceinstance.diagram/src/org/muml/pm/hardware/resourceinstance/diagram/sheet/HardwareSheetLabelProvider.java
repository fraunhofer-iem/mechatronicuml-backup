package org.muml.pm.hardware.resourceinstance.diagram.sheet;
...
public class HardwareSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	public String getText(Object element) {
		...
		if (element instanceof org.muml.pm.hardware.resourceinstance.diagram.navigator.HardwareNavigatorGroup) {
			return ((org.muml.pm.hardware.resourceinstance.diagram.navigator.HardwareNavigatorGroup) element)
					.getGroupName();
		}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = org.muml.pm.hardware.resourceinstance.diagram.part.HardwareVisualIDRegistry
					.getVisualID(view);
			IElementType etype = org.muml.pm.hardware.resourceinstance.diagram.providers.HardwareElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
