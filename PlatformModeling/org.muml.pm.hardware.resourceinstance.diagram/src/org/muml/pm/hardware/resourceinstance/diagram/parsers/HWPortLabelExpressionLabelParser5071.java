 ...
 * @generated
 */
public class HWPortLabelExpressionLabelParser5071 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public HWPortLabelExpressionLabelParser5071() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(0, HwresourceinstancePackage.eINSTANCE.getHWPort(), null).body();
	}
