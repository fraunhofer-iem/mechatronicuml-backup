...
import org.muml.pm.hardware.resourceinstance.diagram.edit.policies.ProgrammableLogicDeviceInstanceItemSemanticEditPolicy;
...
public class ProgrammableLogicDeviceInstanceEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ProgrammableLogicDeviceInstanceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProgrammableLogicDeviceInstanceNameEditPart) {
			((ProgrammableLogicDeviceInstanceNameEditPart) childEditPart)
		...
		if (childEditPart instanceof WrappingLabel12EditPart) {
			((WrappingLabel12EditPart) childEditPart).setLabel(getPrimaryShape().getFigureResourceInfo1());
			return true;
		}
		return false;
	}
