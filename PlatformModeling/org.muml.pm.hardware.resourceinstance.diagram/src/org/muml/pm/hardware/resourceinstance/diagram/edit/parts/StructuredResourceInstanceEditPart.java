...
import org.muml.pm.hardware.resourceinstance.diagram.edit.policies.StructuredResourceInstanceCanonicalEditPolicy;
import org.muml.pm.hardware.resourceinstance.diagram.edit.policies.StructuredResourceInstanceItemSemanticEditPolicy;
...
public class StructuredResourceInstanceEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StructuredResourceInstanceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StructuredResourceInstanceCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StructuredResourceInstanceNameEditPart) {
			((StructuredResourceInstanceNameEditPart) childEditPart)
		...
		if (childEditPart instanceof StructuredResourceInstanceStructuredResourceCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureEmbeddedAtomicResources();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((StructuredResourceInstanceStructuredResourceCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StructuredResourceInstanceStructuredResourceCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureEmbeddedAtomicResources();
			pane.remove(((StructuredResourceInstanceStructuredResourceCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof HWPortEditPart) {
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof StructuredResourceInstanceStructuredResourceCompartmentEditPart) {
