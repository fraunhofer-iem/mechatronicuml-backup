	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.resourceinstance.diagram.edit.policies.StructuredResourceInstanceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.muml.pm.hardware.resourceinstance.diagram.edit.policies.StructuredResourceInstanceCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.StructuredResourceInstanceNameEditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.StructuredResourceInstanceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureStructuredResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel5EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel5EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureStructuredResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel6EditPart) {
			((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.WrappingLabel6EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureStructuredResourceCardinalityFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.StructuredResourceInstanceStructuredResourceCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureEmbeddedAtomicResources();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.StructuredResourceInstanceStructuredResourceCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.HWPortEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.EAST);
			getBorderedFigure().getBorderItemContainer()
					.add(((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.HWPortEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.HWPortEditPart) {
			getBorderedFigure().getBorderItemContainer()
					.remove(((org.muml.pm.hardware.resourceinstance.diagram.edit.parts.HWPortEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof org.muml.pm.hardware.resourceinstance.diagram.edit.parts.StructuredResourceInstanceStructuredResourceCompartmentEditPart) {
	...
	public class StructuredResourceFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private org.muml.pm.hardware.common.figures.CustomIconFigure fFigureCustomStructuredIconFigure;

		/**
		 * @generated
		 */
		private org.muml.pm.hardware.common.figures.CustomIconFigure myCustomStructuredIconFigure;
		...
		private void createContents() {
			...
			myCustomStructuredIconFigure = new org.muml.pm.hardware.common.figures.CustomIconFigure();
		 ...
		 * @generated
		 */
		public org.muml.pm.hardware.common.figures.CustomIconFigure getFigureCustomStructuredIconFigure() {
