...
public class HWPlatformPartCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return HwplatformPackage.eINSTANCE.getPlatformPart_HwPortParts();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { HWPortPartEditPart.VISUAL_ID });
		...
		return HardwareDiagramUpdater.getHWPlatformPart_3027SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return HWPortPartEditPart.VISUAL_ID == HardwareVisualIDRegistry.getVisualID(view);
	}
