	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.muml.pm.hardware.platform.diagram.edit.policies.BusItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.muml.pm.hardware.platform.diagram.edit.parts.WrappingLabel2EditPart) {
			((org.muml.pm.hardware.platform.diagram.edit.parts.WrappingLabel2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureBusBandwidthFigure());
			return true;
		}
		if (childEditPart instanceof org.muml.pm.hardware.platform.diagram.edit.parts.WrappingLabel3EditPart) {
			((org.muml.pm.hardware.platform.diagram.edit.parts.WrappingLabel3EditPart) childEditPart)
