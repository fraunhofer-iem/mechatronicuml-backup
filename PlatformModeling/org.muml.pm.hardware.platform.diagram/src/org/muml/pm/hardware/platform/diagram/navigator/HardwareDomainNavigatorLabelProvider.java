...
public class HardwareDomainNavigatorLabelProvider implements ICommonLabelProvider {
	...
	public Image getImage(Object element) {
		if (element instanceof org.muml.pm.hardware.platform.diagram.navigator.HardwareDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider.getImage(
					((org.muml.pm.hardware.platform.diagram.navigator.HardwareDomainNavigatorItem) element)
							.getEObject());
		}
		return null;
	}
