...
public class HWPlatform2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return HwplatformPackage.eINSTANCE.getHWPlatform_DelegationPorts();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { DelegationHWPortEditPart.VISUAL_ID });
		...
		return HardwareDiagramUpdater.getHWPlatform_2009SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return DelegationHWPortEditPart.VISUAL_ID == HardwareVisualIDRegistry.getVisualID(view);
	}
