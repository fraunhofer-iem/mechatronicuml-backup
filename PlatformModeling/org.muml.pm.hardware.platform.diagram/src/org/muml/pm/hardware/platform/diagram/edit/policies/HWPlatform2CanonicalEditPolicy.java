...
public class HWPlatform2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return org.muml.pm.hardware.platform.diagram.edit.parts.DelegationHWPortEditPart.VISUAL_ID == org.muml.pm.hardware.platform.diagram.part.HardwareVisualIDRegistry
				.getVisualID(view);
	}
