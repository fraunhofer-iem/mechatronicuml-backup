...
public class HardwareInitDiagramFileAction
	...
	*/
		...
		*/
		...
		public Object execute(ExecutionEvent event) throws ExecutionException {
			...
			if (selectedResource instanceof IContainer) {
				...
				String fileName = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramEditorUtil
				...
				EObject model = de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformFactory.eINSTANCE
						.createHWPlatform();
	...
	public String getUniqueFilename(String hint, String extension, IPath filePath) {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramEditorUtil
	...
	public String getEditorId() {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramEditor.ID;
