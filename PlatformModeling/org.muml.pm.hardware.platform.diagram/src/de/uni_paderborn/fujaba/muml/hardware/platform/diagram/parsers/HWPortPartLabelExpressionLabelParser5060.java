...
public class HWPortPartLabelExpressionLabelParser5060 extends ExpressionLabelParserBase {
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory.getExpression(5,
				de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage.eINSTANCE.getHWPortPart(), null)
				.body();
	}
