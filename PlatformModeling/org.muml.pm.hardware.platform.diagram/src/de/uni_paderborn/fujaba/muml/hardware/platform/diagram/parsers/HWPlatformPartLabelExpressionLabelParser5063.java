...
public class HWPlatformPartLabelExpressionLabelParser5063 extends ExpressionLabelParserBase {
	...
	protected String getExpressionBody() {
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory.getExpression(7,
				de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage.eINSTANCE.getHWPlatformPart(), null)
				.body();
	}
	...
	public String getEditString(IAdaptable element, int flags) {
		...
		Object result = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory
				.getExpression(8, de.uni_paderborn.fujaba.muml.hardware.hwplatform.HwplatformPackage.eINSTANCE
