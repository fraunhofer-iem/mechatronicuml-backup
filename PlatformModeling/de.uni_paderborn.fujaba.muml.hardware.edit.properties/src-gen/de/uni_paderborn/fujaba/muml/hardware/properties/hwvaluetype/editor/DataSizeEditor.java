 ...
 * @generated
 */
public class DataSizeEditor extends de.uni_paderborn.fujaba.properties.runtime.editors.ClassPropertyEditor {

	/**
	 * @generated
	 */
	public DataSizeEditor(String tab, org.eclipse.emf.common.notify.AdapterFactory adapterFactory,
	...
	public DataSizeEditor(String tab) {
		this(tab, de.uni_paderborn.fujaba.muml.hardware.properties.util.PropertiesUtil.INSTANCE.getAdapterFactory(),
				de.uni_paderborn.fujaba.muml.hardware.hwvaluetype.HwvaluetypePackage.eINSTANCE.getDataSize());
	}
