...
public class LinkProtocolEditor extends de.uni_paderborn.fujaba.properties.runtime.editors.ClassPropertyEditor {
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addPropertyEditor(createEditorLinkProtocol_GeneralTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorLinkProtocol_GeneralTab_Editor() {
		if (this.editorLinkProtocol_GeneralTab == null) {
			...
			this.editorLinkProtocol_GeneralTab = editor;
		}
		return this.editorLinkProtocol_GeneralTab;
	}
