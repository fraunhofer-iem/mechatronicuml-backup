...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.hardware.hwplatform.NetworkBridge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkBridgeItemProvider extends NetworkingHardwareItemProvider {
	/**
	 ...
	 * @generated
	 */
	public NetworkBridgeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwplatformPackage.Literals.NETWORK_BRIDGE__DELAY);
		}
	...
	/**
	 * This returns NetworkBridge.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NetworkBridge"));
	}
	...
	public String getText(Object object) {
		String label = ((NetworkBridge)object).getComment();
		return label == null || label.length() == 0 ?
			getString("_UI_NetworkBridge_type") :
			getString("_UI_NetworkBridge_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NetworkBridge.class)) {
