...
import org.muml.pm.hardware.hwresource.ProcessorOwnedCacheItemProvider;

/**
 * This is the item provider adapter for a {@link org.muml.pm.hardware.hwresource.Processor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessorItemProvider
		...
		itemPropertyDescriptors.add
			(new ProcessorOwnedCacheItemProvider
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HwresourcePackage.Literals.PROCESSOR__OWNED_CACHE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HwresourcePackage.Literals.PROCESSOR__ARCHITECTURE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HwresourcePackage.Literals.PROCESSOR__FAMILY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwresourcePackage.Literals.PROCESSOR__NB_CORES);
			childrenFeatures.add(HwresourcePackage.Literals.PROCESSOR__NB_PIPELINE_STAGES);
		}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == HwresourcePackage.Literals.PROCESSOR__NB_CORES ||
			childFeature == HwresourcePackage.Literals.PROCESSOR__NB_PIPELINE_STAGES;
