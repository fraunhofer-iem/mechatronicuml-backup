...
/**
 * This is the item provider adapter for a {@link org.muml.pm.software.OperatingSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperatingSystemItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoftwarePackage.Literals.OPERATING_SYSTEM__APIREPOSITORIES);
			childrenFeatures.add(SoftwarePackage.Literals.OPERATING_SYSTEM__ENUMERATION_DATA_TYPES);
			childrenFeatures.add(SoftwarePackage.Literals.OPERATING_SYSTEM__IMPORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SoftwarePackage.Literals.OPERATING_SYSTEM__APIREPOSITORIES,
				 SoftwareFactory.eINSTANCE.createAPIRepository()));

		newChildDescriptors.add
			(createChildParameter
				(SoftwarePackage.Literals.OPERATING_SYSTEM__ENUMERATION_DATA_TYPES,
				 SoftwareFactory.eINSTANCE.createEnumerationDataType()));

		newChildDescriptors.add
			(createChildParameter
				(SoftwarePackage.Literals.OPERATING_SYSTEM__IMPORTS,
				 SoftwareFactory.eINSTANCE.createImport()));
	}
