package de.uni_paderborn.fujaba.muml.componentstorydiagrameditor.diagram.custom.ocl;
...
public class OCLSourceViewerConfiguration extends SourceViewerConfiguration {
	...
	protected OCLCommentScanner getOCLCommentScanner() {
		if (oclCommentScanner == null) {
			...
			oclCommentScanner.setDefaultReturnToken(new Token(new TextAttribute(colorManager
	...
	public String[] getConfiguredContentTypes(ISourceViewer sourceViewer) {
		return new String[] { IDocument.DEFAULT_CONTENT_TYPE, OCLPartitionScanner.OCL_COMMENT };
	}
