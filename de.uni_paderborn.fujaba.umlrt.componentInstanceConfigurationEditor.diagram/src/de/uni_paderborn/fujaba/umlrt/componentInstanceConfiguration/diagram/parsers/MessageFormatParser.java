...
public class MessageFormatParser
		extends
		de.uni_paderborn.fujaba.umlrt.componentInstanceConfiguration.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							de.uni_paderborn.fujaba.umlrt.componentInstanceConfiguration.diagram.part.Messages.MessageFormatParser_InvalidInputError,
