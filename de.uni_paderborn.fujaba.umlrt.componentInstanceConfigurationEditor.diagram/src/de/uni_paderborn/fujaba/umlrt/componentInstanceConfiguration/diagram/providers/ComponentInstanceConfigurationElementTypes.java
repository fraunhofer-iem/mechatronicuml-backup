...
public class ComponentInstanceConfigurationElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Port_3004 = getElementType("de.uni_paderborn.fujaba.umlrt.componentInstanceConfigurationEditor.diagram.Port_3004"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ConnectorInstance_4001 = getElementType("de.uni_paderborn.fujaba.umlrt.componentInstanceConfigurationEditor.diagram.ConnectorInstance_4001"); //$NON-NLS-1$
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(ConnectorInstance_4001);
		}
