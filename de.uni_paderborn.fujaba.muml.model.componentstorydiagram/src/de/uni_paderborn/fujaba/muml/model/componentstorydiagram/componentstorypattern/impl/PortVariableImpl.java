 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.impl.PortVariableImpl#getConnectors <em>Connectors</em>}</li>
 ...
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.componentstorydiagram.componentstorypattern.impl.PortVariableImpl#getConnectorVariables <em>Connector Variables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortVariableImpl extends ComponentStoryPatternVariableImpl implements PortVariable {
	...
	public EList<Connector> getConnectors() {
		if (connectors == null) {
			connectors = new EObjectResolvingEList<Connector>(Connector.class, this, ComponentstorypatternPackage.PORT_VARIABLE__CONNECTORS);
		}
		return connectors;
	}
