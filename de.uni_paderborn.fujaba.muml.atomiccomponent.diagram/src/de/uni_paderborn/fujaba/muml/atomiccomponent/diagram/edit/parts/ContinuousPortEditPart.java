...
public class ContinuousPortEditPart extends BorderedBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.atomiccomponent.diagram.edit.policies.ContinuousPortItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof de.uni_paderborn.fujaba.muml.atomiccomponent.diagram.edit.parts.ContinuousPortNameEditPart) {
