 ...
 * </p>
 * <ul>
 *   <li>{@link org.storydriven.core.impl.TypedElementImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.storydriven.core.impl.TypedElementImpl#getGenericType <em>Generic Type</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		if (genericType != null && genericType.eIsProxy()) {
			...
			if (genericType != oldGenericType) {
				...
				NotificationChain msgs = oldGenericType.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.TYPED_ELEMENT__GENERIC_TYPE, null, null);
				if (newGenericType.eInternalContainer() == null) {
					msgs = newGenericType.eInverseAdd(this,
							EOPPOSITE_FEATURE_BASE - CorePackage.TYPED_ELEMENT__GENERIC_TYPE, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
	...
	protected NotificationChain internalSetGenericType(EGenericType newGenericType, NotificationChain msgs) {
		if (newGenericType != this.genericType) {
			...
			if (this.genericType != null) {
				msgs = ((InternalEObject) this.genericType).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CorePackage.TYPED_ELEMENT__GENERIC_TYPE, null, msgs);
			}
			if (newGenericType != null) {
