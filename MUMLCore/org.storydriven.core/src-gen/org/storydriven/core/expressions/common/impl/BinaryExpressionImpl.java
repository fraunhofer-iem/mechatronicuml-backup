	...
	public Expression getLeftExpression() {
		if (leftExpression != null && leftExpression.eIsProxy()) {
			...
			if (leftExpression != oldLeftExpression) {
				...
				NotificationChain msgs = oldLeftExpression.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CommonExpressionsPackage.BINARY_EXPRESSION__LEFT_EXPRESSION, null,
						null);
				if (newLeftExpression.eInternalContainer() == null) {
					msgs = newLeftExpression.eInverseAdd(this,
							EOPPOSITE_FEATURE_BASE - CommonExpressionsPackage.BINARY_EXPRESSION__LEFT_EXPRESSION, null,
							msgs);
				}
				if (msgs != null)
	...
	public Expression getRightExpression() {
		if (rightExpression != null && rightExpression.eIsProxy()) {
			...
			if (rightExpression != oldRightExpression) {
				...
				NotificationChain msgs = oldRightExpression.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CommonExpressionsPackage.BINARY_EXPRESSION__RIGHT_EXPRESSION, null,
						null);
				if (newRightExpression.eInternalContainer() == null) {
					msgs = newRightExpression.eInverseAdd(this,
							EOPPOSITE_FEATURE_BASE - CommonExpressionsPackage.BINARY_EXPRESSION__RIGHT_EXPRESSION, null,
							msgs);
				}
				if (msgs != null)
