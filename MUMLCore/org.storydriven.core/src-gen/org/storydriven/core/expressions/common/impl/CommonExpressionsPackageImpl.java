...
public class CommonExpressionsPackageImpl extends EPackageImpl implements CommonExpressionsPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getUnaryExpression_Operator(), this.getUnaryOperator(), "operator", null, 1, 1,
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation(logicOperatorEEnum, source,
				new String[] { "documentation", "Defines the operators for binary logic expressions." });
		...
		addAnnotation(comparingOperatorEEnum.getELiterals().get(6), source,
				new String[] { "documentation", "For comparison of a String with a regular expression." });
		addAnnotation(arithmeticOperatorEEnum, source,
				new String[] { "documentation", "Defines the operators for arithmetic expressions." });
		addAnnotation(unaryOperatorEEnum, source,
				new String[] { "documentation", "The operator type used to specify unary logic expressions." });
		...
		addAnnotation(getUnaryExpression_Operator(), source,
				new String[] { "documentation", "Represents the operator of the expression." });
		addAnnotation(binaryExpressionEClass, source,
				new String[] { "documentation", "Represents any binary expression like v < 5 or x + 7." });
		...
		addAnnotation(comparisonExpressionEClass, source,
				new String[] { "documentation", "Represents comparing expressions like a < 5 or a >= 7." });
		addAnnotation(getComparisonExpression_Operator(), source,
				new String[] { "documentation", "Specifies the expression\'s comparing operator, e.g. <, >=, !=." });
		addAnnotation(arithmeticExpressionEClass, source,
				new String[] { "documentation", "Represents arithmetic expressions like a + 5 or a * 7." });
		...
		addAnnotation(logicalExpressionEClass, source,
				new String[] { "documentation", "Represents binary, logic expressions like a AND b and a OR b." });
		addAnnotation(getLogicalExpression_Operator(), source,
				new String[] { "documentation", "Specifies the expression\'s logic operator, e.g. AND, OR, or XOR." });
		addAnnotation(literalExpressionEClass, source, new String[] { "documentation",
