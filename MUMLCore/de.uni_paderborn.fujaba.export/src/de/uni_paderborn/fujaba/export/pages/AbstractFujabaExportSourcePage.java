...
public abstract class AbstractFujabaExportSourcePage extends ExtensibleModelSelectionPage implements IWizardPage {
	 ...
	 *            selected.
	 */
	public AbstractFujabaExportSourcePage(String pageId, FormToolkit toolkit, ResourceSet resourceSet,
	...
	protected void resourceChanged() {
		...
		for (ResourceChangeListener listener : resourceChangedListeners) {
			listener.handleResourceChange(getResource());
		}
	}
	...
	protected IStructuredSelection filterSelection(ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			for (Object element : ((IStructuredSelection) selection).toArray()) {
				...
				if (eObject != null && eObject.eResource() != null && eObject.eResource() == this.getResource()) {
	...
	public void validatePage() {
		ElementSelectionMode elementSelectionMode = wizardPageGetSupportedSelectionMode();
		Assert.isNotNull(elementSelectionMode,
		...
		if (elementSelectionMode != ElementSelectionMode.ELEMENT_SELECTION_MODE_NONE
			...
			if (errorMessage == null && elementSelectionMode != ElementSelectionMode.ELEMENT_SELECTION_MODE_MULTI
	...
	public void addResourceChangeListener(ResourceChangeListener listener) {
		// TODO Auto-generated method stub
		resourceChangedListeners.add(listener);
	}

	public void removeResourceChangeListener(ResourceChangeListener listener) {
		// TODO Auto-generated method stub
		resourceChangedListeners.remove(listener);
	}
