...
public class CreateInstanceFileCommand extends AbstractCreateFileCommand {
	...
	protected void createContents(URI selectedURI, IFile newFile) {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				category.setKey("de.uni_paderborn.fujaba.muml.instance.category");
				category.setName("instance");
