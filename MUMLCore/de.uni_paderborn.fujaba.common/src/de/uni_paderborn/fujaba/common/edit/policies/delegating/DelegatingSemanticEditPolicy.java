...
public class DelegatingSemanticEditPolicy extends SemanticEditPolicy {

	protected SemanticEditPolicy target;

	public void setTarget(SemanticEditPolicy target) {
		this.target = target;
	}
