...
public class MumlBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(
					de.uni_paderborn.fujaba.muml.deployment.diagram.edit.helpers.MumlBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(
				de.uni_paderborn.fujaba.muml.deployment.diagram.edit.helpers.MumlBaseEditHelper.CONTEXT_ELEMENT_TYPE,
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = de.uni_paderborn.fujaba.muml.deployment.diagram.providers.MumlElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = de.uni_paderborn.fujaba.muml.deployment.diagram.part.MumlDiagramEditorPlugin
	...
	public static class LinkConstraints {
		...
		public boolean canExistCommunicationLink_4001(
				de.uni_paderborn.fujaba.muml.deployment.Deployment container,
				de.uni_paderborn.fujaba.muml.deployment.CommunicationLink linkInstance,
				de.uni_paderborn.fujaba.muml.connector.ConnectorEndpoint source,
				de.uni_paderborn.fujaba.muml.connector.ConnectorEndpoint target,
				View sourceView, View targetView) {
			try {
				if (source == null) {
					...
					de.uni_paderborn.fujaba.muml.deployment.diagram.expressions.MumlAbstractExpression expression = de.uni_paderborn.fujaba.muml.deployment.diagram.expressions.MumlOCLFactory
							.getExpression(
									2,
		 ...
		 * @generated
		 */
		public java.lang.String getErrorCommunicationLink_4001(
				de.uni_paderborn.fujaba.muml.deployment.Deployment container,
				de.uni_paderborn.fujaba.muml.connector.ConnectorEndpoint source,
				de.uni_paderborn.fujaba.muml.connector.ConnectorEndpoint target,
				View sourceView, View targetView) {
