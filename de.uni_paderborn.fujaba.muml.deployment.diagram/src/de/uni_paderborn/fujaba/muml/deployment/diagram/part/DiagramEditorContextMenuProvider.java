...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.deployment.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new de.uni_paderborn.fujaba.muml.deployment.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
