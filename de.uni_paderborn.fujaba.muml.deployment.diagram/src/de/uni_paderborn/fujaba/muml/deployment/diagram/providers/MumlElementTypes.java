...
public class MumlElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType HardwareNode_2001 = getElementType("de.uni_paderborn.fujaba.muml.deployment.diagram.HardwareNode_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType HardwarePort_3001 = getElementType("de.uni_paderborn.fujaba.muml.deployment.diagram.HardwarePort_3001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType CommunicationLink_4001 = getElementType("de.uni_paderborn.fujaba.muml.deployment.diagram.CommunicationLink_4001"); //$NON-NLS-1$
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(HardwareNode_2001);
			KNOWN_ELEMENT_TYPES.add(HardwarePort_3001);
			KNOWN_ELEMENT_TYPES.add(CommunicationLink_4001);
		}
