 ...
 * @generated
 */
public class DeploymentEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.deployment.diagram.edit.policies.DeploymentItemSemanticEditPolicy());

		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new de.uni_paderborn.fujaba.muml.deployment.diagram.edit.policies.DeploymentCanonicalEditPolicy(
						true));
