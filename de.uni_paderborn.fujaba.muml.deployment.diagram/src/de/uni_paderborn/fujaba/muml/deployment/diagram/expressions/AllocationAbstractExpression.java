 ...
 * @generated
 */
public abstract class AllocationAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = de.uni_paderborn.fujaba.muml.deployment.diagram.part.AllocationDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected AllocationAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
