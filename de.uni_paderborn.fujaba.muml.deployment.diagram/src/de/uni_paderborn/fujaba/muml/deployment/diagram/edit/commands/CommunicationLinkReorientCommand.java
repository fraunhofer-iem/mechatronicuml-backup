...
public class CommunicationLinkReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.muml.psm.deployment.CommunicationLink) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof de.uni_paderborn.fujaba.muml.psm.deployment.Deployment)) {
			return false;
		}
		de.uni_paderborn.fujaba.muml.psm.deployment.Deployment container = (de.uni_paderborn.fujaba.muml.psm.deployment.Deployment) getLink()
				.eContainer();
		...
		if (!de.uni_paderborn.fujaba.muml.deployment.diagram.edit.policies.AllocationBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistCommunicationLink_4003(container,
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.psm.deployment.CommunicationLink getLink() {
		return (de.uni_paderborn.fujaba.muml.psm.deployment.CommunicationLink) getElementToEdit();
	}
