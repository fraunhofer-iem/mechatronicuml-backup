...
public class HardwareNodeNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.deployment.diagram.edit.policies.AllocationTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.deployment.diagram.providers.AllocationParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					de.uni_paderborn.fujaba.muml.deployment.diagram.edit.parts.AllocationEditPartFactory
