 ...
 * @generated
 */
public class AllocationEditPartProvider extends AbstractEditPartProvider {
	...
	public AllocationEditPartProvider() {
		setFactory(new de.uni_paderborn.fujaba.muml.deployment.diagram.edit.parts.AllocationEditPartFactory());
