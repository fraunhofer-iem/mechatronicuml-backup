...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.Call} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Call_callee_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Call_callee_feature", "_UI_Call_type"),
				 ComponentstorypatternPackage.Literals.CALL__CALLEE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentstorypatternPackage.Literals.CALL__PARAMETER_BINDING);
		}
