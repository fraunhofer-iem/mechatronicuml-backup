...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.verification.uppaal.mtctl.Predicates.TransitionFiringExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionFiringExprItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TransitionFiringExpr_transition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TransitionFiringExpr_transition_feature", "_UI_TransitionFiringExpr_type"),
	...
	public String getText(Object object) {
		String label = ((TransitionFiringExpr)object).getComment();
		return label == null || label.length() == 0 ?
			getString("_UI_TransitionFiringExpr_type") :
			getString("_UI_TransitionFiringExpr_type") + " " + label;
	}
