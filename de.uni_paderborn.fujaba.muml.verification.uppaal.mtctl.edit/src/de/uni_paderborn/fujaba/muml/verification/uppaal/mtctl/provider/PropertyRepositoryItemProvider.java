...
public class PropertyRepositoryItemProvider
	extends VerificationConstraintRepositoryItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyRepository_properties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyRepository_properties_feature", "_UI_PropertyRepository_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MtctlPackage.Literals.PROPERTY_REPOSITORY__PROPERTIES);
		}
