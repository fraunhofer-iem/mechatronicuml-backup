 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.swplatform.EnumerationValue#getValue <em>Value</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.swplatform.EnumerationValue#getEnumerationDataType <em>Enumeration Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.psm.swplatform.SwplatformPackage#getEnumerationValue()
 * @model
 * @generated
 */
public interface EnumerationValue extends ExtendableElement {
	 ...
	 * @see #setValue(String)
	 * @see de.uni_paderborn.fujaba.muml.psm.swplatform.SwplatformPackage#getEnumerationValue_Value()
	 * @model required="true"
	 * @generated
	 */
	String getValue();
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.swplatform.EnumerationValue#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.psm.swplatform.EnumerationDataType#getEnumerationValues <em>Enumeration Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.swplatform.SwplatformPackage#getEnumerationValue_EnumerationDataType()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.swplatform.EnumerationValue#getEnumerationDataType <em>Enumeration Data Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
