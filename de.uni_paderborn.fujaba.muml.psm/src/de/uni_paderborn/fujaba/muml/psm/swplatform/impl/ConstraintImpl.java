 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.swplatform.impl.ConstraintImpl#getApiCommand <em>Api Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint {
	...
	protected EClass eStaticClass() {
		return SwplatformPackage.Literals.CONSTRAINT;
	}
	...
	public APICommand getApiCommand() {
		if (eContainerFeatureID() != SwplatformPackage.CONSTRAINT__API_COMMAND) return null;
	...
	public NotificationChain basicSetApiCommand(APICommand newApiCommand, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newApiCommand, SwplatformPackage.CONSTRAINT__API_COMMAND, msgs);
		return msgs;
	}
	...
	public void setApiCommand(APICommand newApiCommand) {
		if (newApiCommand != eInternalContainer() || (eContainerFeatureID() != SwplatformPackage.CONSTRAINT__API_COMMAND && newApiCommand != null)) {
			...
			if (newApiCommand != null)
				msgs = ((InternalEObject)newApiCommand).eInverseAdd(this, SwplatformPackage.API_COMMAND__CONSTRAINTS, APICommand.class, msgs);
			msgs = basicSetApiCommand(newApiCommand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwplatformPackage.CONSTRAINT__API_COMMAND, newApiCommand, newApiCommand));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SwplatformPackage.CONSTRAINT__API_COMMAND:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SwplatformPackage.CONSTRAINT__API_COMMAND:
				return eInternalContainer().eInverseRemove(this, SwplatformPackage.API_COMMAND__CONSTRAINTS, APICommand.class, msgs);
		}
