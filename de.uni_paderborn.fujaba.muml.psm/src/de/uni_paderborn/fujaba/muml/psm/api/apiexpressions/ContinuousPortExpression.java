 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.api.apiexpressions.ContinuousPortExpression#getContinuousPort <em>Continuous Port</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.psm.api.apiexpressions.ApiexpressionsPackage#getContinuousPortExpression()
...
public interface ContinuousPortExpression extends Expression {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.api.apiexpressions.ApiexpressionsPackage#getContinuousPortExpression_ContinuousPort()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.api.apiexpressions.ContinuousPortExpression#getContinuousPort <em>Continuous Port</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
