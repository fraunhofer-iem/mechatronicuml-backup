 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.realtimestatechart.realtimestatechartparameterbinding.impl.RealtimeStatechartParameterBindingImpl#getPortInstance <em>Port Instance</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.realtimestatechart.realtimestatechartparameterbinding.impl.RealtimeStatechartParameterBindingImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RealtimeStatechartParameterBindingImpl extends MinimalEObjectImpl.Container implements RealtimeStatechartParameterBinding {
	...
	public void setPortInstance(ParameterisableDiscreteSinglePortInstance newPortInstance) {
		if (newPortInstance != eInternalContainer() || (eContainerFeatureID() != RealtimestatechartparameterbindingPackage.REALTIME_STATECHART_PARAMETER_BINDING__PORT_INSTANCE && newPortInstance != null)) {
			...
			if (newPortInstance != null)
				msgs = ((InternalEObject)newPortInstance).eInverseAdd(this, InstancePackage.PARAMETERISABLE_DISCRETE_SINGLE_PORT_INSTANCE__BINDINGS, ParameterisableDiscreteSinglePortInstance.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RealtimestatechartparameterbindingPackage.REALTIME_STATECHART_PARAMETER_BINDING__PORT_INSTANCE:
				return eInternalContainer().eInverseRemove(this, InstancePackage.PARAMETERISABLE_DISCRETE_SINGLE_PORT_INSTANCE__BINDINGS, ParameterisableDiscreteSinglePortInstance.class, msgs);
		}
