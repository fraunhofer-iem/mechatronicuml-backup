 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.apiexpressions.APICallExpression#getApiCommand <em>Api Command</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.psm.apiexpressions.APICallExpression#getParameterBindings <em>Parameter Bindings</em>}</li>
 * </ul>
 * </p>
 *
...
public interface APICallExpression extends Expression {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.apiexpressions.ApiexpressionsPackage#getAPICallExpression_ApiCommand()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.apiexpressions.APICallExpression#getApiCommand <em>Api Command</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.apiexpressions.ApiexpressionsPackage#getAPICallExpression_ParameterBindings()
