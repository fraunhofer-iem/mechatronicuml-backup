...
public interface EnumerationValueExpression extends Expression {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.psm.apiexpressions.ApiexpressionsPackage#getEnumerationValueExpression_EnumValue()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.psm.apiexpressions.EnumerationValueExpression#getEnumValue <em>Enum Value</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
