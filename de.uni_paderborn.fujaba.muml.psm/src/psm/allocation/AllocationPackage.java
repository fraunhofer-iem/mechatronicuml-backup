 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see psm.allocation.AllocationFactory
 * @model kind="package"
 * @generated
 */
public interface AllocationPackage extends EPackage {
	 ...
	 * @generated
	 */
	AllocationPackage eINSTANCE = psm.allocation.impl.AllocationPackageImpl.init();

	/**
	 * The meta object id for the '{@link psm.allocation.impl.SystemAllocationImpl <em>System Allocation</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see psm.allocation.impl.SystemAllocationImpl
	 * @see psm.allocation.impl.AllocationPackageImpl#getSystemAllocation()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link psm.allocation.impl.AllocationImpl <em>Allocation</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see psm.allocation.impl.AllocationImpl
	 * @see psm.allocation.impl.AllocationPackageImpl#getAllocation()
	 * @generated
	 */
	int ALLOCATION = 1;
	...
	/**
	 * Returns the meta object for class '{@link psm.allocation.SystemAllocation <em>System Allocation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>System Allocation</em>'.
	 * @see psm.allocation.SystemAllocation
	 * @generated
	 */
	EClass getSystemAllocation();

	/**
	 * Returns the meta object for the containment reference list '{@link psm.allocation.SystemAllocation#getAllocations <em>Allocations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Allocations</em>'.
	 * @see psm.allocation.SystemAllocation#getAllocations()
	...
	/**
	 * Returns the meta object for class '{@link psm.allocation.Allocation <em>Allocation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Allocation</em>'.
	 * @see psm.allocation.Allocation
	 * @generated
	 */
	EClass getAllocation();

	/**
	 * Returns the meta object for the reference '{@link psm.allocation.Allocation#getComponentInstance <em>Component Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Component Instance</em>'.
	 * @see psm.allocation.Allocation#getComponentInstance()
	 * @see #getAllocation()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link psm.allocation.Allocation#getResourceInstance <em>Resource Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Resource Instance</em>'.
	 * @see psm.allocation.Allocation#getResourceInstance()
	 * @see #getAllocation()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link psm.allocation.impl.SystemAllocationImpl <em>System Allocation</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see psm.allocation.impl.SystemAllocationImpl
		 * @see psm.allocation.impl.AllocationPackageImpl#getSystemAllocation()
		...
		/**
		 * The meta object literal for the '{@link psm.allocation.impl.AllocationImpl <em>Allocation</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see psm.allocation.impl.AllocationImpl
		 * @see psm.allocation.impl.AllocationPackageImpl#getAllocation()
