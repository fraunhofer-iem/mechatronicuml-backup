 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.model.Barrier#getInputEventsList <em>Input Events List</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.Barrier#getOutputEvent <em>Output Event</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.unican.mast.xmlmast.model.ModelPackage#getBarrier()
...
public interface Barrier extends EObject {
	 ...
	 * @see es.unican.mast.xmlmast.model.ModelPackage#getBarrier_InputEventsList()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.model.Barrier#getInputEventsList <em>Input Events List</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.mast.xmlmast.model.ModelPackage#getBarrier_OutputEvent()
	...
	/**
	 * Sets the value of the '{@link es.unican.mast.xmlmast.model.Barrier#getOutputEvent <em>Output Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
