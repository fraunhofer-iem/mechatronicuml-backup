...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Enclosing Operation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EnclosingOperationImpl#getOverriddenFixedPriority <em>Overridden Fixed Priority</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EnclosingOperationImpl#getOverriddenPermanentFP <em>Overridden Permanent FP</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EnclosingOperationImpl#getOperationList <em>Operation List</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EnclosingOperationImpl#getAverageCaseExecutionTime <em>Average Case Execution Time</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EnclosingOperationImpl#getBestCaseExecutionTime <em>Best Case Execution Time</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EnclosingOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EnclosingOperationImpl#getWorstCaseExecutionTime <em>Worst Case Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnclosingOperationImpl extends MinimalEObjectImpl.Container implements EnclosingOperation {
	/**
	 ...
	 * @generated
	 */
	protected EnclosingOperationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.ENCLOSING_OPERATION;
	}
	...
	public NotificationChain basicSetOverriddenFixedPriority(OverriddenFixedPriority newOverriddenFixedPriority, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_FIXED_PRIORITY, oldOverriddenFixedPriority, newOverriddenFixedPriority);
	...
	public void setOverriddenFixedPriority(OverriddenFixedPriority newOverriddenFixedPriority) {
		if (newOverriddenFixedPriority != overriddenFixedPriority) {
			...
			if (overriddenFixedPriority != null)
				msgs = ((InternalEObject)overriddenFixedPriority).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_FIXED_PRIORITY, null, msgs);
			if (newOverriddenFixedPriority != null)
				msgs = ((InternalEObject)newOverriddenFixedPriority).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_FIXED_PRIORITY, null, msgs);
			msgs = basicSetOverriddenFixedPriority(newOverriddenFixedPriority, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_FIXED_PRIORITY, newOverriddenFixedPriority, newOverriddenFixedPriority));
	}
	...
	public NotificationChain basicSetOverriddenPermanentFP(OverriddenPermanentFP newOverriddenPermanentFP, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_PERMANENT_FP, oldOverriddenPermanentFP, newOverriddenPermanentFP);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOverriddenPermanentFP(OverriddenPermanentFP newOverriddenPermanentFP) {
		if (newOverriddenPermanentFP != overriddenPermanentFP) {
			...
			if (overriddenPermanentFP != null)
				msgs = ((InternalEObject)overriddenPermanentFP).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_PERMANENT_FP, null, msgs);
			if (newOverriddenPermanentFP != null)
				msgs = ((InternalEObject)newOverriddenPermanentFP).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_PERMANENT_FP, null, msgs);
			msgs = basicSetOverriddenPermanentFP(newOverriddenPermanentFP, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_PERMANENT_FP, newOverriddenPermanentFP, newOverriddenPermanentFP));
	}
	...
	public void setOperationList(List<String> newOperationList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__OPERATION_LIST, oldOperationList, operationList));
	}
	...
	public void setAverageCaseExecutionTime(float newAverageCaseExecutionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__AVERAGE_CASE_EXECUTION_TIME, oldAverageCaseExecutionTime, averageCaseExecutionTime, !oldAverageCaseExecutionTimeESet));
	}
	...
	public void unsetAverageCaseExecutionTime() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.ENCLOSING_OPERATION__AVERAGE_CASE_EXECUTION_TIME, oldAverageCaseExecutionTime, AVERAGE_CASE_EXECUTION_TIME_EDEFAULT, oldAverageCaseExecutionTimeESet));
	}
	...
	public void setBestCaseExecutionTime(float newBestCaseExecutionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__BEST_CASE_EXECUTION_TIME, oldBestCaseExecutionTime, bestCaseExecutionTime, !oldBestCaseExecutionTimeESet));
	}
	...
	public void unsetBestCaseExecutionTime() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.ENCLOSING_OPERATION__BEST_CASE_EXECUTION_TIME, oldBestCaseExecutionTime, BEST_CASE_EXECUTION_TIME_EDEFAULT, oldBestCaseExecutionTimeESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__NAME, oldName, name));
	}
	...
	public void setWorstCaseExecutionTime(float newWorstCaseExecutionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ENCLOSING_OPERATION__WORST_CASE_EXECUTION_TIME, oldWorstCaseExecutionTime, worstCaseExecutionTime, !oldWorstCaseExecutionTimeESet));
	}
	...
	public void unsetWorstCaseExecutionTime() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.ENCLOSING_OPERATION__WORST_CASE_EXECUTION_TIME, oldWorstCaseExecutionTime, WORST_CASE_EXECUTION_TIME_EDEFAULT, oldWorstCaseExecutionTimeESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_FIXED_PRIORITY:
				return basicSetOverriddenFixedPriority(null, msgs);
			case ModelPackage.ENCLOSING_OPERATION__OVERRIDDEN_PERMANENT_FP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.ENCLOSING_OPERATION__OPERATION_LIST:
				return getOperationList();
			case ModelPackage.ENCLOSING_OPERATION__AVERAGE_CASE_EXECUTION_TIME:
				return getAverageCaseExecutionTime();
			case ModelPackage.ENCLOSING_OPERATION__BEST_CASE_EXECUTION_TIME:
				return getBestCaseExecutionTime();
			case ModelPackage.ENCLOSING_OPERATION__NAME:
				return getName();
			case ModelPackage.ENCLOSING_OPERATION__WORST_CASE_EXECUTION_TIME:
