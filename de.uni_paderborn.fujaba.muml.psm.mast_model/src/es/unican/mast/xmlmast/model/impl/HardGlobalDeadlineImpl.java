...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hard Global Deadline</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.HardGlobalDeadlineImpl#getDeadline <em>Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.HardGlobalDeadlineImpl#getReferencedEvent <em>Referenced Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HardGlobalDeadlineImpl extends MinimalEObjectImpl.Container implements HardGlobalDeadline {
	/**
	 ...
	 * @generated
	 */
	protected HardGlobalDeadlineImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.HARD_GLOBAL_DEADLINE;
	}
	...
	public void setDeadline(float newDeadline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.HARD_GLOBAL_DEADLINE__DEADLINE, oldDeadline, deadline, !oldDeadlineESet));
	}
	...
	public void unsetDeadline() {
		...
		deadlineESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.HARD_GLOBAL_DEADLINE__DEADLINE, oldDeadline, DEADLINE_EDEFAULT, oldDeadlineESet));
	}
	...
	public void setReferencedEvent(String newReferencedEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.HARD_GLOBAL_DEADLINE__REFERENCED_EVENT, oldReferencedEvent, referencedEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.HARD_GLOBAL_DEADLINE__DEADLINE:
				return getDeadline();
			case ModelPackage.HARD_GLOBAL_DEADLINE__REFERENCED_EVENT:
