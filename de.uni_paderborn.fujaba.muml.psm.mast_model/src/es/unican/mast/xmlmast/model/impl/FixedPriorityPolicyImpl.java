 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.FixedPriorityPolicyImpl#getPreassigned <em>Preassigned</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.FixedPriorityPolicyImpl#getThePriority <em>The Priority</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FixedPriorityPolicyImpl extends MinimalEObjectImpl.Container implements FixedPriorityPolicy {
	...
	public void setThePriority(BigInteger newThePriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FIXED_PRIORITY_POLICY__THE_PRIORITY, oldThePriority, thePriority));
	}
