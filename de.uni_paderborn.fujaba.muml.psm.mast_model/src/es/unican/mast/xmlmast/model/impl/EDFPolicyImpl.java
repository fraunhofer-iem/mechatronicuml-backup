 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EDFPolicyImpl#getDeadline <em>Deadline</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.model.impl.EDFPolicyImpl#getPreassigned <em>Preassigned</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EDFPolicyImpl extends MinimalEObjectImpl.Container implements EDFPolicy {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.EDF_POLICY;
	}
	...
	public void setDeadline(float newDeadline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EDF_POLICY__DEADLINE, oldDeadline, deadline, !oldDeadlineESet));
	}
	...
	public void unsetDeadline() {
		...
		deadlineESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.EDF_POLICY__DEADLINE, oldDeadline, DEADLINE_EDEFAULT, oldDeadlineESet));
	}
	...
	public void setPreassigned(Assertion newPreassigned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EDF_POLICY__PREASSIGNED, oldPreassigned, preassigned, !oldPreassignedESet));
	}
	...
	public void unsetPreassigned() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.EDF_POLICY__PREASSIGNED, oldPreassigned, PREASSIGNED_EDEFAULT, oldPreassignedESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.EDF_POLICY__DEADLINE:
				return getDeadline();
			case ModelPackage.EDF_POLICY__PREASSIGNED:
