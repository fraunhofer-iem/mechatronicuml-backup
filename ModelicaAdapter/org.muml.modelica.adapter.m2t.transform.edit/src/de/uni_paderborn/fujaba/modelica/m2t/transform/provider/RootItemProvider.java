...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.modelica.m2t.transform.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TransformPackage.Literals.ROOT__MAPS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Root.class)) {
			case TransformPackage.ROOT__MAPS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TransformPackage.Literals.ROOT__MAPS,
				 TransformFactory.eINSTANCE.createMap()));
	}
