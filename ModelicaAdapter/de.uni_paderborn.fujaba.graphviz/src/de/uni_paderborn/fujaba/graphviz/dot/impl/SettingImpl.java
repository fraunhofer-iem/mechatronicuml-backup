...
public class SettingImpl extends MinimalEObjectImpl.Container implements Setting {
	...
	protected EClass eStaticClass() {
		return DotPackage.Literals.SETTING;
	}
	...
	public void setAttribute(String newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DotPackage.SETTING__ATTRIBUTE, oldAttribute, attribute));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DotPackage.SETTING__VALUE, oldValue, value));
	}
