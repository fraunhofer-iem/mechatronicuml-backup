/**
 */
package de.uni_paderborn.fujaba.muml.psm.realtimestatechart.provider;
 ...
 * @generated
 */
public class ParameterizedRealtimeStatechartItemProvider
	extends RealtimeStatechartItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RealtimestatechartPackage.Literals.PARAMETERIZED_REALTIME_STATECHART__ALL_PARAMETERS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RealtimestatechartPackage.Literals.PARAMETERIZED_REALTIME_STATECHART__PARAMETERS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.BEHAVIOR__OPERATIONS,
				 RealtimestatechartparameterFactory.eINSTANCE.createAPICallSignature()));
