...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.uppaal.expressions.LogicalExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogicalExpressionItemProvider extends BinaryExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExpressionsPackage.Literals.LOGICAL_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		LogicalOperator labelValue = ((LogicalExpression)object).getOperator();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LogicalExpression.class)) {
			case ExpressionsPackage.LOGICAL_EXPRESSION__OPERATOR:
