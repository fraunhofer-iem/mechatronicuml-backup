...
public class LiteralExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LiteralExpression_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LiteralExpression_text_feature", "_UI_LiteralExpression_type"),
				 ExpressionsPackage.Literals.LITERAL_EXPRESSION__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((LiteralExpression)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LiteralExpression.class)) {
			case ExpressionsPackage.LITERAL_EXPRESSION__TEXT:
