...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.uppaal.expressions.CompareExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompareExpressionItemProvider extends BinaryExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompareExpression_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompareExpression_operator_feature", "_UI_CompareExpression_type"),
				 ExpressionsPackage.Literals.COMPARE_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		CompareOperator labelValue = ((CompareExpression)object).getOperator();
