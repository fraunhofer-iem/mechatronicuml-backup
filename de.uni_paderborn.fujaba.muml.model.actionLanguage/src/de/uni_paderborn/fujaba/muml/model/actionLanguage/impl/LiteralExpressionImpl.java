...
public class LiteralExpressionImpl extends ExpressionImpl implements LiteralExpression {
	...
	protected EClass eStaticClass() {
		return ActionLanguagePackage.Literals.LITERAL_EXPRESSION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionLanguagePackage.LITERAL_EXPRESSION__VALUE, oldValue, value));
	}
