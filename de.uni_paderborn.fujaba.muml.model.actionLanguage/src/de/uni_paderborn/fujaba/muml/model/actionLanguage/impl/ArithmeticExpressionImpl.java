 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.actionLanguage.impl.ArithmeticExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArithmeticExpressionImpl extends BinaryExpressionImpl implements ArithmeticExpression {
	...
	protected EClass eStaticClass() {
		return ActionLanguagePackage.Literals.ARITHMETIC_EXPRESSION;
	}
	...
	public void setOperator(ArithmeticOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionLanguagePackage.ARITHMETIC_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionLanguagePackage.ARITHMETIC_EXPRESSION__OPERATOR:
				return getOperator();
		}
