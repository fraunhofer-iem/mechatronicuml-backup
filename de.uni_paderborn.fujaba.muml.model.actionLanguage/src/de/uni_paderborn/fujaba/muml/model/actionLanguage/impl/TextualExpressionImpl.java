 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.actionLanguage.impl.TextualExpressionImpl#getExpressionText <em>Expression Text</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.actionLanguage.impl.TextualExpressionImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.actionLanguage.impl.TextualExpressionImpl#getLanguageVersion <em>Language Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextualExpressionImpl extends ExpressionImpl implements TextualExpression {
	...
	protected EClass eStaticClass() {
		return ActionLanguagePackage.Literals.TEXTUAL_EXPRESSION;
	}
	...
	public void setExpressionText(String newExpressionText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionLanguagePackage.TEXTUAL_EXPRESSION__EXPRESSION_TEXT, oldExpressionText, expressionText));
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionLanguagePackage.TEXTUAL_EXPRESSION__LANGUAGE, oldLanguage, language));
	}
	...
	public void setLanguageVersion(String newLanguageVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionLanguagePackage.TEXTUAL_EXPRESSION__LANGUAGE_VERSION, oldLanguageVersion, languageVersion));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionLanguagePackage.TEXTUAL_EXPRESSION__EXPRESSION_TEXT:
				return getExpressionText();
			case ActionLanguagePackage.TEXTUAL_EXPRESSION__LANGUAGE:
				return getLanguage();
			case ActionLanguagePackage.TEXTUAL_EXPRESSION__LANGUAGE_VERSION:
