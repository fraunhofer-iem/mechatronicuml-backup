 ...
 * @generated
 */
public class CoordinationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CoordinationPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoordinationPackage.COORDINATION_SPECIFICATION: {
				CoordinationSpecification coordinationSpecification = (CoordinationSpecification)theEObject;
				T result = caseCoordinationSpecification(coordinationSpecification);
				if (result == null) result = caseNamedElement(coordinationSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CoordinationPackage.ROLE_CONNECTOR: {
				RoleConnector roleConnector = (RoleConnector)theEObject;
				T result = caseRoleConnector(roleConnector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoordinationPackage.CONNECTOR_QUALITY_OF_SERVICE_ASSUMPTIONS: {
			...
			case CoordinationPackage.COORDINATION_PATTERN: {
				...
				if (result == null) result = caseCoordinationSpecification(coordinationPattern);
				if (result == null) result = caseNamedElement(coordinationPattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoordinationPackage.COORDINATION_PROTOCOL: {
				...
				if (result == null) result = caseCoordinationSpecification(coordinationProtocol);
	 ...
	 * @generated
	 */
	public T caseCoordinationSpecification(CoordinationSpecification object) {
		return null;
	}
