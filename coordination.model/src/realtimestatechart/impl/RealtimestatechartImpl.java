 ...
 * </p>
 * <ul>
 *   <li>{@link realtimestatechart.impl.RealtimestatechartImpl#getName <em>Name</em>}</li>
...
public class RealtimestatechartImpl extends BehaviorImpl implements Realtimestatechart {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.REALTIMESTATECHART__NAME, oldName, name));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case RealtimestatechartPackage.REALTIMESTATECHART__NAME: return RealtimestatechartPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case RealtimestatechartPackage.NAMED_ELEMENT__NAME: return RealtimestatechartPackage.REALTIMESTATECHART__NAME;
				default: return -1;
			}
		}
