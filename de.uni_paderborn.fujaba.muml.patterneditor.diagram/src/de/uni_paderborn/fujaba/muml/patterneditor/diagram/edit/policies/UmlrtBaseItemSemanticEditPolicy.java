 ...
 * @generated
 */
public class UmlrtBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected UmlrtBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(
					de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.helpers.UmlrtBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(
				de.uni_paderborn.fujaba.muml.patterneditor.diagram.edit.helpers.UmlrtBaseEditHelper.CONTEXT_ELEMENT_TYPE,
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = de.uni_paderborn.fujaba.muml.patterneditor.diagram.providers.UmlrtElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = de.uni_paderborn.fujaba.muml.patterneditor.diagram.part.UmlrtDiagramEditorPlugin
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateConstrainableElementConstraint_4002(
			...
			if (source != null) {
				if (source.getConstraint().contains(target)) {
					return false;
				}
				if (source == target) {
					return false;
			...
			if (target != null && (target.getConstrainableElement() != null)) {
				return false;
			}

			return canExistConstrainableElementConstraint_4002(source, target);
		}
		 ...
		 * @generated
		 */
		public boolean canExistConstrainableElementConstraint_4002(
				de.uni_paderborn.fujaba.muml.model.core.ConstrainableElement source,
				de.uni_paderborn.fujaba.muml.model.constraint.Constraint target) {
			return true;
		}
