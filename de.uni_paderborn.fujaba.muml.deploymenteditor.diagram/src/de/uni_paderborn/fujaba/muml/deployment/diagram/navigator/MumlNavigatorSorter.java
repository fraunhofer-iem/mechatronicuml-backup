...
public class MumlNavigatorSorter extends ViewerSorter {
	...
	public int category(Object element) {
		if (element instanceof de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.MumlNavigatorItem) {
			de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.MumlNavigatorItem item = (de.uni_paderborn.fujaba.muml.deployment.diagram.navigator.MumlNavigatorItem) element;
