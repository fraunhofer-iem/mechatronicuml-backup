...
public class MumlOCLFactory {
	 ...
	 * @generated
	 */
	private final de.uni_paderborn.fujaba.muml.deployment.diagram.expressions.MumlAbstractExpression[] expressions;
	 ...
	 * @generated
	 */
	public static de.uni_paderborn.fujaba.muml.deployment.diagram.expressions.MumlAbstractExpression getExpression(
			int index, EClassifier context, Map<String, EClassifier> environment) {
		MumlOCLFactory cached = de.uni_paderborn.fujaba.muml.deployment.diagram.part.MumlDiagramEditorPlugin
	...
	private static class Expression
			extends
			de.uni_paderborn.fujaba.muml.deployment.diagram.expressions.MumlAbstractExpression {
