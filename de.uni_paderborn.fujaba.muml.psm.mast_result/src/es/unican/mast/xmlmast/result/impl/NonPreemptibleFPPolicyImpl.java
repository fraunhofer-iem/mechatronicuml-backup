 ...
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.result.impl.NonPreemptibleFPPolicyImpl#getPreassigned <em>Preassigned</em>}</li>
 *   <li>{@link es.unican.mast.xmlmast.result.impl.NonPreemptibleFPPolicyImpl#getThePriority <em>The Priority</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NonPreemptibleFPPolicyImpl extends MinimalEObjectImpl.Container implements NonPreemptibleFPPolicy {
	/**
	...
	protected EClass eStaticClass() {
		return ResultPackage.Literals.NON_PREEMPTIBLE_FP_POLICY;
	}
	...
	public void setPreassigned(Assertion newPreassigned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.NON_PREEMPTIBLE_FP_POLICY__PREASSIGNED, oldPreassigned, preassigned, !oldPreassignedESet));
	}
	...
	public void unsetPreassigned() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ResultPackage.NON_PREEMPTIBLE_FP_POLICY__PREASSIGNED, oldPreassigned, PREASSIGNED_EDEFAULT, oldPreassignedESet));
	}
	...
	public void setThePriority(int newThePriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.NON_PREEMPTIBLE_FP_POLICY__THE_PRIORITY, oldThePriority, thePriority, !oldThePriorityESet));
	}
	...
	public void unsetThePriority() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ResultPackage.NON_PREEMPTIBLE_FP_POLICY__THE_PRIORITY, oldThePriority, THE_PRIORITY_EDEFAULT, oldThePriorityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResultPackage.NON_PREEMPTIBLE_FP_POLICY__PREASSIGNED:
				return getPreassigned();
			case ResultPackage.NON_PREEMPTIBLE_FP_POLICY__THE_PRIORITY:
