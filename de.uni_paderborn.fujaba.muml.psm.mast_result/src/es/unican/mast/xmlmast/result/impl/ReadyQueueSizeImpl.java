...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ready Queue Size</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.unican.mast.xmlmast.result.impl.ReadyQueueSizeImpl#getMaxNum <em>Max Num</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReadyQueueSizeImpl extends MinimalEObjectImpl.Container implements ReadyQueueSize {
	/**
	...
	protected EClass eStaticClass() {
		return ResultPackage.Literals.READY_QUEUE_SIZE;
	}
	...
	public void setMaxNum(BigInteger newMaxNum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResultPackage.READY_QUEUE_SIZE__MAX_NUM, oldMaxNum, maxNum));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResultPackage.READY_QUEUE_SIZE__MAX_NUM:
				return getMaxNum();
		}
