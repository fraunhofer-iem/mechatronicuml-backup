...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 7: return new OperationCallStatement_Group(this, this, 7, inst);
			case 8: return new ExpressionStartRule_Alternatives(this, this, 8, inst);
			case 9: return new Assignment_Group(this, this, 9, inst);
			case 10: return new InitializeExpression_Alternatives(this, this, 10, inst);
			case 11: return new ArrayInitializeExpression_Group(this, this, 11, inst);
			case 12: return new LocalVariableDeclarationStatement_Group(this, this, 12, inst);
			case 13: return new LocalVariableDeclaration_Group(this, this, 13, inst);
			case 14: return new Expression_LogicalExpressionParserRuleCall(this, this, 14, inst);
			case 15: return new LogicalExpression_LogicalOrExpressionParserRuleCall(this, this, 15, inst);
			case 16: return new LogicalOrExpression_Group(this, this, 16, inst);
			case 17: return new LogicalAndExpression_Group(this, this, 17, inst);
			case 18: return new ComparisonExpression_Group(this, this, 18, inst);
			case 19: return new ComparisonHigherOpExpression_Group(this, this, 19, inst);
			case 20: return new ArithmeticExpression_AdditionExpressionParserRuleCall(this, this, 20, inst);
			case 21: return new AdditionExpression_Group(this, this, 21, inst);
			case 22: return new MultiplicationExpression_Alternatives(this, this, 22, inst);
			case 23: return new UnaryPreExpression_Group(this, this, 23, inst);
			case 24: return new UnaryPostExpression_Group(this, this, 24, inst);
			case 25: return new Operand_Alternatives(this, this, 25, inst);
			case 26: return new LiteralExpression_Group(this, this, 26, inst);
			case 27: return new ExtendedTypedNamedElementExpression_Group(this, this, 27, inst);
			case 28: return new TypedNamedElementExpression_Group(this, this, 28, inst);
			case 29: return new NoAttributeSelectorExpression_PositionAssignment(this, this, 29, inst);
			case 30: return new PositionSelectorExpression_Group(this, this, 30, inst);
			case 31: return new OperationCall_Group(this, this, 31, inst);
			case 32: return new ParamaterBinding_Group(this, this, 32, inst);
			case 33: return new TriggerMessageExpression_Group(this, this, 33, inst);
			default: return null;
		}	
	}	
}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getInitializeExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getAssignmentAccess().getRhs_assignExpressionInitializeExpressionParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class LocalVariableDeclarationStatement_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new LocalVariableDeclarationStatement_SemicolonKeyword_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class LocalVariableDeclarationStatement_VariableAssignment_0 extends AssignmentToken  {
	
	public LocalVariableDeclarationStatement_VariableAssignment_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getLocalVariableDeclarationStatementAccess().getVariableAssignment_0();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getLocalVariableDeclarationRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getLocalVariableDeclarationStatementAccess().getVariableLocalVariableDeclarationParserRuleCall_0_0(); 
				consumed = obj;
				return param;
			}
		}
...
protected class LocalVariableDeclarationStatement_Group_1 extends GroupToken {
	
	public LocalVariableDeclarationStatement_Group_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getLocalVariableDeclarationStatementAccess().getGroup_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new LocalVariableDeclarationStatement_InitializeExpressionAssignment_1_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// ":="
protected class LocalVariableDeclarationStatement_ColonEqualsSignKeyword_1_0 extends KeywordToken  {
	
	public LocalVariableDeclarationStatement_ColonEqualsSignKeyword_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getLocalVariableDeclarationStatementAccess().getColonEqualsSignKeyword_1_0();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new LocalVariableDeclarationStatement_VariableAssignment_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// initializeExpression=InitializeExpression
protected class LocalVariableDeclarationStatement_InitializeExpressionAssignment_1_1 extends AssignmentToken  {
	
	public LocalVariableDeclarationStatement_InitializeExpressionAssignment_1_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getLocalVariableDeclarationStatementAccess().getInitializeExpressionAssignment_1_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getInitializeExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getLocalVariableDeclarationStatementAccess().getInitializeExpressionInitializeExpressionParserRuleCall_1_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new LocalVariableDeclarationStatement_ColonEqualsSignKeyword_1_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ";"
protected class LocalVariableDeclarationStatement_SemicolonKeyword_2 extends KeywordToken  {
	
	public LocalVariableDeclarationStatement_SemicolonKeyword_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getLocalVariableDeclarationStatementAccess().getSemicolonKeyword_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new LocalVariableDeclarationStatement_Group_1(lastRuleCallOrigin, this, 0, inst);
			case 1: return new LocalVariableDeclarationStatement_VariableAssignment_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
protected class Operand_ExtendedTypedNamedElementExpressionParserRuleCall_2 extends RuleCallToken {
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getExtendedTypedNamedElementExpressionAccess().getDiscreteInteractionEndpointReferenceTypedNamedElementExpressionAction_1_0().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getTypedNamedElementExpressionRule().getType().getClassifier())
			return null;
...
protected class ExtendedTypedNamedElementExpression_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ExtendedTypedNamedElementExpression_Group_1(lastRuleCallOrigin, this, 0, inst);
...
protected class ExtendedTypedNamedElementExpression_Group_1 extends GroupToken {
	...
	public ExtendedTypedNamedElementExpression_Group_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getExtendedTypedNamedElementExpressionAccess().getGroup_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ExtendedTypedNamedElementExpression_PositionAssignment_1_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class ExtendedTypedNamedElementExpression_DiscreteInteractionEndpointReferenceTypedNamedElementExpressionAction_1_0 extends ActionToken  {
	...
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getExtendedTypedNamedElementExpressionAccess().getDiscreteInteractionEndpointReferenceTypedNamedElementExpressionAction_1_0();
	}
...
// "."
protected class ExtendedTypedNamedElementExpression_FullStopKeyword_1_1 extends KeywordToken  {
	
	public ExtendedTypedNamedElementExpression_FullStopKeyword_1_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getExtendedTypedNamedElementExpressionAccess().getFullStopKeyword_1_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ExtendedTypedNamedElementExpression_DiscreteInteractionEndpointReferenceTypedNamedElementExpressionAction_1_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// position=PositionSelectorExpression
protected class ExtendedTypedNamedElementExpression_PositionAssignment_1_2 extends AssignmentToken  {
	
	public ExtendedTypedNamedElementExpression_PositionAssignment_1_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getExtendedTypedNamedElementExpressionAccess().getPositionAssignment_1_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getPositionSelectorExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getExtendedTypedNamedElementExpressionAccess().getPositionPositionSelectorExpressionParserRuleCall_1_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new ExtendedTypedNamedElementExpression_FullStopKeyword_1_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
