...
public class ActionLanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new de.uni_paderborn.fujaba.muml.ActionLanguageRuntimeModule());
	}
