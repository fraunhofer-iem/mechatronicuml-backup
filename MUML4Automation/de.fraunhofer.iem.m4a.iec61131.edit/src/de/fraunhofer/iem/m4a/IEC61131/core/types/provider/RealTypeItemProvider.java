...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.core.types.RealType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RealTypeItemProvider extends SimpleSpecificationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RealType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RealType_name_feature", "_UI_RealType_type"),
				 TypesPackage.Literals.REAL_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ERealType labelValue = ((RealType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RealType.class)) {
			case TypesPackage.REAL_TYPE__NAME:
