...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.st.CaseStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CaseStatementItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StPackage.Literals.CASE_STATEMENT__ELSE);
			childrenFeatures.add(StPackage.Literals.CASE_STATEMENT__CONDITION);
			childrenFeatures.add(StPackage.Literals.CASE_STATEMENT__CASE_ELEMENTS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_CaseStatement_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.CASE_STATEMENT__ELSE,
				 StFactory.eINSTANCE.createElse()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.CASE_STATEMENT__CONDITION,
				 StFactory.eINSTANCE.createPrimaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.CASE_STATEMENT__CASE_ELEMENTS,
				 StFactory.eINSTANCE.createCaseElement()));
	}
