...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.core.types.SimpleTypeReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleTypeReferenceItemProvider 
	extends SimpleSpecificationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimpleTypeReference_simpleType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimpleTypeReference_simpleType_feature", "_UI_SimpleTypeReference_type"),
				 TypesPackage.Literals.SIMPLE_TYPE_REFERENCE__SIMPLE_TYPE,
				 true,
				 false,
				 true,
				 null,
