...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.core.declarations.EdgeDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeDeclarationItemProvider 
	 ...
	 * @generated
	 */
	public EdgeDeclarationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EdgeDeclaration_edgeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EdgeDeclaration_edgeType_feature", "_UI_EdgeDeclaration_type"),
				 DeclarationsPackage.Literals.EDGE_DECLARATION__EDGE_TYPE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns EdgeDeclaration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EdgeDeclaration"));
	}
	...
	public String getText(Object object) {
		EdgeType labelValue = ((EdgeDeclaration)object).getEdgeType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_EdgeDeclaration_type") :
			getString("_UI_EdgeDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EdgeDeclaration.class)) {
