...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.core.types.Subrange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubrangeItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypesPackage.Literals.SUBRANGE__LOWER_BOUND);
			childrenFeatures.add(TypesPackage.Literals.SUBRANGE__UPPER_BOUND);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Subrange_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Subrange.class)) {
			case TypesPackage.SUBRANGE__LOWER_BOUND:
			case TypesPackage.SUBRANGE__UPPER_BOUND:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.SUBRANGE__LOWER_BOUND,
				 LiteralsFactory.eINSTANCE.createSignedInteger()));

		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.SUBRANGE__UPPER_BOUND,
				 LiteralsFactory.eINSTANCE.createSignedInteger()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == TypesPackage.Literals.SUBRANGE__LOWER_BOUND ||
			childFeature == TypesPackage.Literals.SUBRANGE__UPPER_BOUND;
