...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.il.InstructionList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstructionListItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IlPackage.Literals.INSTRUCTION_LIST__INSTRUCTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IlPackage.Literals.INSTRUCTION_LIST__INSTRUCTION,
				 IlFactory.eINSTANCE.createJumpOperation()));
		...
		newChildDescriptors.add
			(createChildParameter
				(IlPackage.Literals.INSTRUCTION_LIST__INSTRUCTION,
				 IlFactory.eINSTANCE.createIlFBCall()));
		...
		newChildDescriptors.add
			(createChildParameter
				(IlPackage.Literals.INSTRUCTION_LIST__INSTRUCTION,
				 IlFactory.eINSTANCE.createReturnOperatorPlaceHolder()));
