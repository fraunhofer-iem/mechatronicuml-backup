...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.st.IfStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfStatementItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StPackage.Literals.IF_STATEMENT__CONDITION);
			childrenFeatures.add(StPackage.Literals.IF_STATEMENT__ELSIF);
			childrenFeatures.add(StPackage.Literals.IF_STATEMENT__THEN);
			childrenFeatures.add(StPackage.Literals.IF_STATEMENT__ELSE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.IF_STATEMENT__CONDITION,
				 StFactory.eINSTANCE.createPrimaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.IF_STATEMENT__ELSIF,
				 StFactory.eINSTANCE.createIfStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.IF_STATEMENT__THEN,
				 StFactory.eINSTANCE.createStatementList()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.IF_STATEMENT__ELSE,
				 StFactory.eINSTANCE.createElse()));
	}
