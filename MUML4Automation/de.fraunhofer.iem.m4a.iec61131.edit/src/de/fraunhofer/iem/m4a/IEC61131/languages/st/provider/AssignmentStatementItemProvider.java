...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.st.AssignmentStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StPackage.Literals.ASSIGNMENT_STATEMENT__VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AssignmentStatement_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AssignmentStatement_value_feature", "_UI_AssignmentStatement_type"),
				 StPackage.Literals.ASSIGNMENT_STATEMENT__VALUE,
				 true,
				 false,
				 true,
				 null,
