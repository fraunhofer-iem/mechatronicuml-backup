...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.core.pous.AbstractFunctionBlockDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractFunctionBlockDeclarationItemProvider extends LibraryElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AbstractFunctionBlockDeclarationItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractFunctionBlockDeclaration)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractFunctionBlockDeclaration_type") :
			getString("_UI_AbstractFunctionBlockDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractFunctionBlockDeclaration.class)) {
