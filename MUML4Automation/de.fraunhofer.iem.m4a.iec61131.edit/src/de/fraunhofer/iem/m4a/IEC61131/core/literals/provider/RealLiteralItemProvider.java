...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.core.literals.RealLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RealLiteralItemProvider extends NumericLiteralItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RealLiteral_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RealLiteral_typeName_feature", "_UI_RealLiteral_type"),
				 LiteralsPackage.Literals.REAL_LITERAL__TYPE_NAME,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((RealLiteral)object).getValue();
