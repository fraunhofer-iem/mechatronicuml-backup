...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.st.StatementList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StatementListItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StPackage.Literals.STATEMENT_LIST__STATMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createAssignmentStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createNILStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createFBInvocation()));
		...
		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createIfStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createCaseStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createForStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createWhileStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createRepeatStatement()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.STATEMENT_LIST__STATMENTS,
				 StFactory.eINSTANCE.createExitStatement()));
	}
