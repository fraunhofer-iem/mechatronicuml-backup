...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.st.ForStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForStatementItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StPackage.Literals.FOR_STATEMENT__FROM);
			childrenFeatures.add(StPackage.Literals.FOR_STATEMENT__TO);
			childrenFeatures.add(StPackage.Literals.FOR_STATEMENT__BY);
			childrenFeatures.add(StPackage.Literals.FOR_STATEMENT__DO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.FOR_STATEMENT__FROM,
				 StFactory.eINSTANCE.createPrimaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.FOR_STATEMENT__TO,
				 StFactory.eINSTANCE.createPrimaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.FOR_STATEMENT__BY,
				 StFactory.eINSTANCE.createPrimaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.FOR_STATEMENT__DO,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == StPackage.Literals.FOR_STATEMENT__FROM ||
			childFeature == StPackage.Literals.FOR_STATEMENT__TO ||
			childFeature == StPackage.Literals.FOR_STATEMENT__BY;
