...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.st.Else} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Else_then_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Else_then_feature", "_UI_Else_type"),
				 StPackage.Literals.ELSE__THEN,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Else"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Else_type");
	}
