...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.m4a.IEC61131.languages.st.WhileStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileStatementItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StPackage.Literals.WHILE_STATEMENT__CONDITION);
			childrenFeatures.add(StPackage.Literals.WHILE_STATEMENT__DO);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WhileStatement.class)) {
			case StPackage.WHILE_STATEMENT__CONDITION:
			case StPackage.WHILE_STATEMENT__DO:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.WHILE_STATEMENT__CONDITION,
				 StFactory.eINSTANCE.createPrimaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(StPackage.Literals.WHILE_STATEMENT__DO,
