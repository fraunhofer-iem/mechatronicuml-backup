 ...
 * <ul>
 *   <li>{@link de.fraunhofer.iem.m4a.IEC61131.languages.st.impl.UnaryOperatorImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnaryOperatorImpl extends MinimalEObjectImpl.Container implements UnaryOperator {
	...
	protected EClass eStaticClass() {
		return StPackage.Literals.UNARY_OPERATOR;
	}
	...
	public void setOperation(String newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StPackage.UNARY_OPERATOR__OPERATION, oldOperation, operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StPackage.UNARY_OPERATOR__OPERATION:
				return getOperation();
		}
