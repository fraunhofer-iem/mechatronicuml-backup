 ...
 * <ul>
 *   <li>{@link de.fraunhofer.iem.m4a.IEC61131.core.literals.impl.CommentableElementImpl#getComment <em>Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CommentableElementImpl extends MinimalEObjectImpl.Container implements CommentableElement {
	...
	protected EClass eStaticClass() {
		return LiteralsPackage.Literals.COMMENTABLE_ELEMENT;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LiteralsPackage.COMMENTABLE_ELEMENT__COMMENT, oldComment, comment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LiteralsPackage.COMMENTABLE_ELEMENT__COMMENT:
				return getComment();
		}
