...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorePackage.LIBRARY_ELEMENT: {
			...
			case CorePackage.LIBRARY_ELEMENT_REFERENCE: {
				LibraryElementReference libraryElementReference = (LibraryElementReference)theEObject;
				T result = caseLibraryElementReference(libraryElementReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
