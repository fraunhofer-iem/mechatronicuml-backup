 ...
 * <ul>
 *   <li>{@link de.fraunhofer.iem.m4a.IEC61131.core.literals.impl.LiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralImpl extends MinimalEObjectImpl.Container implements Literal {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LiteralsPackage.LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LiteralsPackage.LITERAL__VALUE:
				return getValue();
		}
