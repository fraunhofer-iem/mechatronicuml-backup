...
import de.uni_paderborn.fujaba.umlrt.model.instance.ContinuousPortInstance;
 ...
 * 
 * @author $Author: mtt $
 * @version $Revision: 2492 $ $Date: 2007-04-16 16:14:50 +0200 (Mo, 16 Apr 2007) $
 * @model
 * @generated
 */
public class ContinuousPortInstanceImpl implements ContinuousPortInstance
...
//   {
//      return "ContinuousPortInstance Name: " + this.getName() + "; Port: "
//            + this.getPort();
//   }
...
/*
 * $Log$
 * Revision 1.5  2007/04/16 14:14:50  mtt
 * organize imports
 *
 * Revision 1.4  2007/04/16 07:53:57  sluzar
 * Alle ASGElements umgestellt
 * Revision 1.3 2007/03/10 00:32:07 burmi Generation of tree
 * to calculate evaluation order -- not without bugs, but without exceptions and without errors
 * 
 * Revision 1.2 2007/02/11 18:57:47 burmi more work on evaluation order
 * 
 * Revision 1.1 2006/11/09 13:44:03 shenkler hybrid modeling plugins
 * 
 * Revision 1.16 2005/08/02 13:46:06 kudak Interface Visual removed
 * 
 */
