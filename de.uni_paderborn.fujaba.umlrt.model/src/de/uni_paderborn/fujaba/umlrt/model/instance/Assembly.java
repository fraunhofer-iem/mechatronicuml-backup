 ...
 * @model
 */
public interface Assembly extends DeploymentElement

{
   ...
   public UMLRealtimeStatechart getStatechart();
	 ...
	 * @model
	 */
   public ProvidedInterfaceInstance getProvidedInterfaceInstance();
   ...
   public java.util.List<ComponentInstanceDiagram> getComponentInstanceDiagrams();
	 ...
	 * @model
	 */
   public RequiredInterfaceInstance getRequiredInterfaceInstance();
