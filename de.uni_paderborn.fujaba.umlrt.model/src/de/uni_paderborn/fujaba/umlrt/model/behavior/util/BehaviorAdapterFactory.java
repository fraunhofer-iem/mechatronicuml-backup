...
public class BehaviorAdapterFactory extends AdapterFactoryImpl {
	...
	protected BehaviorSwitch<Adapter> modelSwitch =
		new BehaviorSwitch<Adapter>() {
			@Override
			public Adapter caseProtocolStatechart(ProtocolStatechart object) {
				return createProtocolStatechartAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uni_paderborn.fujaba.umlrt.model.behavior.ProtocolStatechart <em>Protocol Statechart</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createProtocolStatechartAdapter() {
		return null;
	}
