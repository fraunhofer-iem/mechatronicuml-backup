 ...
 * $Id$
 */
package de.uni_paderborn.fujaba.umlrt.model.behavior.util;
...
public class BehaviorSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BehaviorPackage.PROTOCOL_STATECHART: {
				...
				if (result == null) result = caseUMLRealtimeStatechart(protocolStatechart);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Protocol Statechart</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Protocol Statechart</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProtocolStatechart(ProtocolStatechart object) {
		return null;
	}
