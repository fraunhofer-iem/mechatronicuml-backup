...
public class BehaviorFactoryImpl extends EFactoryImpl implements BehaviorFactory {
	...
	public static BehaviorFactory init() {
		try {
			BehaviorFactory theBehaviorFactory = (BehaviorFactory)EPackage.Registry.INSTANCE.getEFactory("http:///de/uni_paderborn/fujaba/umlrt/model/behavior"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case BehaviorPackage.PROTOCOL_STATECHART: return createProtocolStatechart();
			default:
	 ...
	 * @generated
	 */
	public ProtocolStatechart createProtocolStatechart() {
		ProtocolStatechartImpl protocolStatechart = new ProtocolStatechartImpl();
		return protocolStatechart;
	}
