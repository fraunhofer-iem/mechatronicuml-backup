 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.component.impl.ComponentImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.component.impl.ComponentImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.component.impl.ComponentImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.component.impl.ComponentImpl#getEClass <em>EClass</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.component.impl.ComponentImpl#getReferencingComponentParts <em>Referencing Component Parts</em>}</li>
...
public abstract class ComponentImpl extends NamedElementImpl implements Component {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ComponentPackage.COMPONENT___CREATE_INSTANCE:
