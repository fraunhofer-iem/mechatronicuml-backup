 ...
 * @generated
 */
public class ComponentDiagramImpl implements ComponentDiagram
{
   ...
   public java.util.List<Delegation> getDelegations(){return null;}
	 ...
	 * @generated
	 */
   public java.util.List<Component> getComponents(){return null;}
...
//   {
//      for (Iterator<? extends FElement> it = iteratorOfElements(); it.hasNext();)
//      {
//         FElement elem = it.next();
...
//
//   /**
//    * This method is called when the diagram is deleted.
//    */
//   public void delete()
//   {
//      for (Iterator<? extends FElement> it = iteratorOfElements(); it.hasNext();)
...
//         //System.out.println (comp.getUMLRealtimeStatechart());
//         this.getProject().removeFromDiagrams (comp.getUMLRealtimeStatechart());
//      }
//      // removeYou();
