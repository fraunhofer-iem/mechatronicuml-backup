...
public class ReconfDiagramImpl extends EObjectImpl implements ReconfDiagram {
	...
	public UMLRealtimeComplexState getUMLComplexRealtimeState() {
		if (uMLComplexRealtimeState != null && uMLComplexRealtimeState.eIsProxy()) {
			...
			uMLComplexRealtimeState = (UMLRealtimeComplexState)eResolveProxy(oldUMLComplexRealtimeState);
	 ...
	 * @generated
	 */
	public UMLRealtimeComplexState basicGetUMLComplexRealtimeState() {
		return uMLComplexRealtimeState;
	}
