 ...
 * @model
 */
public interface UMLSynchronizationChannel // extends ASGElement
{
	/**
	 * @model
	 */
   ...
   public java.util.List<UMLRealtimeTransition> getUMLRealtimeTransitions();
	 ...
	 * @model
	 */
   public java.util.List<UMLRealtimeTransition> getSenderTransitions();

	/**
	 * @model
	 */
   public java.util.List<UMLRealtimeTransition> getReceiverTransitions();
