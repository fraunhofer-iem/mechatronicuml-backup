...
public class RealtimestatechartPackageImpl extends EPackageImpl implements RealtimestatechartPackage {
	 ...
	 * @generated
	 */
	public EOperation getTransition__ComputeClockResetsExpr() {
	 ...
	 * @generated
	 */
	public EOperation getTransition__ComputeSynchroExpr() {
	 ...
	 * @generated
	 */
	public EOperation getTransition__ComputeEventsExpr() {
	 ...
	 * @generated
	 */
	public EOperation getTransition__ComputeTimeGuardExpr() {
	...
	public void createPackageContents() {
		...
		createEOperation(transitionEClass, TRANSITION___COMPUTE_TIME_GUARD_EXPR);
	...
	public void initializePackageContents() {
		...
		initEReference(getVertex_Statechart(), theCorePackage.getAbstractRealtimeStatechart(), theCorePackage.getAbstractRealtimeStatechart_Vertices(), "statechart", null, 0, 1, Vertex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTransition_EventsExpr(), theEcorePackage.getEString(), "eventsExpr", "", 0, 1, Transition.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTransition_SynchroExpr(), theEcorePackage.getEString(), "synchroExpr", "", 0, 1, Transition.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getTransition__ComputeSynchroExpr(), theEcorePackage.getEString(), "computeSynchroExpr", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getTransition__ComputeEventsExpr(), theEcorePackage.getEString(), "computeEventsExpr", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getTransition__ComputeTimeGuardExpr(), theEcorePackage.getEString(), "computeTimeGuardExpr", 0, 1, IS_UNIQUE, IS_ORDERED);
