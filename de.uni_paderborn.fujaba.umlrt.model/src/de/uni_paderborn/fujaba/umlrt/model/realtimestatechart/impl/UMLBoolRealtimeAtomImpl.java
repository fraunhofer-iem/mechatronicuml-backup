 ...
 * @generated
 */
public abstract class UMLBoolRealtimeAtomImpl implements UMLBoolRealtimeAtom // extends UMLDiagramItem
{
	/**
	 * @generated
	 */
   public boolean getFinal(){return false;}

	/**
	 * @generated
	 */
   public NaturalNumber getUpperBound(){return null;}
   ...
   public boolean getDisplayValuation(){return false;}
	 ...
	 * @generated
	 */
   public String getUpperBoundName(){return null;}
   ...
   /**
    * UMLAttr: 'INFINITY : LongInteger = Long.MAX_VALUE'.
    */
   public final static transient long INFINITY = Long.MAX_VALUE;
   
   /**
    * Compatibility function. Method getUpperBound was originally of type long
    * @return
    */
   public NaturalNumber getUpperBoundAsNaturalNumber(){
	   return getUpperBound();
   }
   
   /**
    * Sets the upperBound attribute of the UMLBoolRealtimeAtom object
    *
    * @param newUpperBound  The new upperBound value
    */
   public void setUpperBound (long newUpperBound) {
//      if (upperBound == null || upperBound.longValue() != newUpperBound)
//      {
//         NaturalNumber newNumber = getProject().getFromFactories(NaturalNumber.class).create();
//         newNumber.setValue(newUpperBound);
//         setUpperBound(newNumber);
//      } // if
   }
...
//      if (displayValuation())
//      {
//         return  (getUMLClock() + " <= " + getUpperBound());
//      }
//      return  (getUMLClock() + " <= " + getUpperBound());
     return null;
   }
