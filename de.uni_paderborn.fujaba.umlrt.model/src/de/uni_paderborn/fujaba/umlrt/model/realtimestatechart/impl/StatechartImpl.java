 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getEventQueueSize <em>Event Queue Size</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getWcetDocument <em>Wcet Document</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getSecurityLevel <em>Security Level</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getSystemWcetMap <em>System Wcet Map</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getUtilisation <em>Utilisation</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getScheduleDocument <em>Schedule Document</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getUMLRealtimeStartState <em>UML Realtime Start State</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getUMLComplexRealtimeState <em>UML Complex Realtime State</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getVertices <em>Vertices</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getEClass <em>EClass</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getUMLInterfaceStatechart <em>UML Interface Statechart</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getBehavioralElement <em>Behavioral Element</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getProvidedMsgIFace <em>Provided Msg IFace</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getRequiredMsgIFace <em>Required Msg IFace</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#isIsEmbedded <em>Is Embedded</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getClocks <em>Clocks</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.StatechartImpl#getEmbeddingRegion <em>Embedding Region</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatechartImpl extends NamedElementImpl implements Statechart {
	...
	protected EClass eStaticClass() {
		return RealtimestatechartPackage.Literals.STATECHART;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__COMMENT, oldComment, comment));
	}
	...
	public void setEventQueueSize(int newEventQueueSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__EVENT_QUEUE_SIZE, oldEventQueueSize, eventQueueSize));
	}
	...
	public void setWcetDocument(String newWcetDocument) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__WCET_DOCUMENT, oldWcetDocument, wcetDocument));
	}
	...
	public void setSecurityLevel(int newSecurityLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__SECURITY_LEVEL, oldSecurityLevel, securityLevel));
	}
	...
	public void setSystemWcetMap(Map newSystemWcetMap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__SYSTEM_WCET_MAP, oldSystemWcetMap, systemWcetMap));
	}
	...
	public void setUtilisation(double newUtilisation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__UTILISATION, oldUtilisation, utilisation));
	}
	...
	public void setScheduleDocument(String newScheduleDocument) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__SCHEDULE_DOCUMENT, oldScheduleDocument, scheduleDocument));
	}
	...
	public NotificationChain basicSetUMLRealtimeStartState(InitialState newUMLRealtimeStartState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__UML_REALTIME_START_STATE, oldUMLRealtimeStartState, newUMLRealtimeStartState);
	...
	public void setUMLRealtimeStartState(InitialState newUMLRealtimeStartState) {
		if (newUMLRealtimeStartState != uMLRealtimeStartState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__UML_REALTIME_START_STATE, newUMLRealtimeStartState, newUMLRealtimeStartState));
	}
	...
	public NotificationChain basicSetUMLComplexRealtimeState(State newUMLComplexRealtimeState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__UML_COMPLEX_REALTIME_STATE, oldUMLComplexRealtimeState, newUMLComplexRealtimeState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUMLComplexRealtimeState(State newUMLComplexRealtimeState) {
		if (newUMLComplexRealtimeState != uMLComplexRealtimeState) {
			...
			if (uMLComplexRealtimeState != null)
				msgs = ((InternalEObject)uMLComplexRealtimeState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__UML_COMPLEX_REALTIME_STATE, null, msgs);
			if (newUMLComplexRealtimeState != null)
				msgs = ((InternalEObject)newUMLComplexRealtimeState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__UML_COMPLEX_REALTIME_STATE, null, msgs);
			msgs = basicSetUMLComplexRealtimeState(newUMLComplexRealtimeState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__UML_COMPLEX_REALTIME_STATE, newUMLComplexRealtimeState, newUMLComplexRealtimeState));
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, RealtimestatechartPackage.STATECHART__TRANSITIONS);
		}
		return transitions;
	}
	...
	public EList<Vertex> getVertices() {
		if (vertices == null) {
			vertices = new EObjectContainmentEList<Vertex>(Vertex.class, this, RealtimestatechartPackage.STATECHART__VERTICES);
		}
		return vertices;
	}
	...
	public NotificationChain basicSetEClass(EClass newEClass, NotificationChain msgs) {
		...
		eClass = newEClass;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__ECLASS, oldEClass, newEClass);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEClass(EClass newEClass) {
		if (newEClass != eClass) {
			NotificationChain msgs = null;
			if (eClass != null)
				msgs = ((InternalEObject)eClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__ECLASS, null, msgs);
			if (newEClass != null)
				msgs = ((InternalEObject)newEClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__ECLASS, null, msgs);
			msgs = basicSetEClass(newEClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__ECLASS, newEClass, newEClass));
	}
	...
	public NotificationChain basicSetUMLInterfaceStatechart(UMLInterfaceStatechart newUMLInterfaceStatechart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__UML_INTERFACE_STATECHART, oldUMLInterfaceStatechart, newUMLInterfaceStatechart);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUMLInterfaceStatechart(UMLInterfaceStatechart newUMLInterfaceStatechart) {
		if (newUMLInterfaceStatechart != uMLInterfaceStatechart) {
			...
			if (uMLInterfaceStatechart != null)
				msgs = ((InternalEObject)uMLInterfaceStatechart).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__UML_INTERFACE_STATECHART, null, msgs);
			if (newUMLInterfaceStatechart != null)
				msgs = ((InternalEObject)newUMLInterfaceStatechart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__UML_INTERFACE_STATECHART, null, msgs);
			msgs = basicSetUMLInterfaceStatechart(newUMLInterfaceStatechart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__UML_INTERFACE_STATECHART, newUMLInterfaceStatechart, newUMLInterfaceStatechart));
	}
	...
	public BehavioralElement getBehavioralElement() {
		if (behavioralElement != null && behavioralElement.eIsProxy()) {
			...
			if (behavioralElement != oldBehavioralElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RealtimestatechartPackage.STATECHART__BEHAVIORAL_ELEMENT, oldBehavioralElement, behavioralElement));
			}
		}
	...
	public void setBehavioralElement(BehavioralElement newBehavioralElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__BEHAVIORAL_ELEMENT, oldBehavioralElement, behavioralElement));
	}
	...
	public NotificationChain basicSetProvidedMsgIFace(Map.Entry<String, EClass> newProvidedMsgIFace, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__PROVIDED_MSG_IFACE, oldProvidedMsgIFace, newProvidedMsgIFace);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProvidedMsgIFace(Map.Entry<String, EClass> newProvidedMsgIFace) {
		if (newProvidedMsgIFace != providedMsgIFace) {
			...
			if (providedMsgIFace != null)
				msgs = ((InternalEObject)providedMsgIFace).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__PROVIDED_MSG_IFACE, null, msgs);
			if (newProvidedMsgIFace != null)
				msgs = ((InternalEObject)newProvidedMsgIFace).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__PROVIDED_MSG_IFACE, null, msgs);
			msgs = basicSetProvidedMsgIFace(newProvidedMsgIFace, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__PROVIDED_MSG_IFACE, newProvidedMsgIFace, newProvidedMsgIFace));
	}
	...
	public NotificationChain basicSetRequiredMsgIFace(Map.Entry<String, EClass> newRequiredMsgIFace, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__REQUIRED_MSG_IFACE, oldRequiredMsgIFace, newRequiredMsgIFace);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRequiredMsgIFace(Map.Entry<String, EClass> newRequiredMsgIFace) {
		if (newRequiredMsgIFace != requiredMsgIFace) {
			...
			if (requiredMsgIFace != null)
				msgs = ((InternalEObject)requiredMsgIFace).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__REQUIRED_MSG_IFACE, null, msgs);
			if (newRequiredMsgIFace != null)
				msgs = ((InternalEObject)newRequiredMsgIFace).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__REQUIRED_MSG_IFACE, null, msgs);
			msgs = basicSetRequiredMsgIFace(newRequiredMsgIFace, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__REQUIRED_MSG_IFACE, newRequiredMsgIFace, newRequiredMsgIFace));
	}
	...
	public void setIsEmbedded(boolean newIsEmbedded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__IS_EMBEDDED, oldIsEmbedded, isEmbedded));
	}
	...
	public EList<Clock> getClocks() {
		if (clocks == null) {
			clocks = new EObjectContainmentWithInverseEList<Clock>(Clock.class, this, RealtimestatechartPackage.STATECHART__CLOCKS, RealtimestatechartPackage.CLOCK__STATECHART);
		}
		return clocks;
	}
	...
	public Region getEmbeddingRegion() {
		if (embeddingRegion != null && embeddingRegion.eIsProxy()) {
			...
			if (embeddingRegion != oldEmbeddingRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RealtimestatechartPackage.STATECHART__EMBEDDING_REGION, oldEmbeddingRegion, embeddingRegion));
			}
		}
	...
	public NotificationChain basicSetEmbeddingRegion(Region newEmbeddingRegion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__EMBEDDING_REGION, oldEmbeddingRegion, newEmbeddingRegion);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEmbeddingRegion(Region newEmbeddingRegion) {
		if (newEmbeddingRegion != embeddingRegion) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATECHART__EMBEDDING_REGION, newEmbeddingRegion, newEmbeddingRegion));
	}
	 ...
	 * @generated
	 */
	public Statechart getHighestParentStatechart() {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RealtimestatechartPackage.STATECHART__UML_REALTIME_START_STATE:
				if (uMLRealtimeStartState != null)
					msgs = ((InternalEObject)uMLRealtimeStartState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealtimestatechartPackage.STATECHART__UML_REALTIME_START_STATE, null, msgs);
			...
			case RealtimestatechartPackage.STATECHART__EMBEDDING_REGION:
				if (embeddingRegion != null)
					msgs = ((InternalEObject)embeddingRegion).eInverseRemove(this, RealtimestatechartPackage.REGION__STATECHART, Region.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RealtimestatechartPackage.STATECHART__BEHAVIORAL_ELEMENT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CommentableElement.class) {
			switch (derivedFeatureID) {
				case RealtimestatechartPackage.STATECHART__COMMENT: return SDMPackage.COMMENTABLE_ELEMENT__COMMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CommentableElement.class) {
			switch (baseFeatureID) {
				case SDMPackage.COMMENTABLE_ELEMENT__COMMENT: return RealtimestatechartPackage.STATECHART__COMMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RealtimestatechartPackage.STATECHART___GET_HIGHEST_PARENT_STATECHART:
				return getHighestParentStatechart();
			case RealtimestatechartPackage.STATECHART___ADD_ALL_UML_REALTIME_STATES__SET_BOOLEAN:
				addAllUMLRealtimeStates((Set<Vertex>)arguments.get(0), (Boolean)arguments.get(1));
				return null;
			case RealtimestatechartPackage.STATECHART___ADD_COMPLEX_UML_REALTIME_STATES__SET:
				addComplexUMLRealtimeStates((Set<State>)arguments.get(0));
				return null;
			case RealtimestatechartPackage.STATECHART___ADD_ALL_UML_REALTIME_TRANSITIONS__SET:
				addAllUMLRealtimeTransitions((Set<Transition>)arguments.get(0));
				return null;
			case RealtimestatechartPackage.STATECHART___ITERATOR_OF_ALL_UML_CLOCKS__BOOLEAN:
				return iteratorOfAllUMLClocks((Boolean)arguments.get(0));
			case RealtimestatechartPackage.STATECHART___ADD_ALL_UML_CLOCKS__SET_BOOLEAN:
				addAllUMLClocks((Set<Clock>)arguments.get(0), (Boolean)arguments.get(1));
				return null;
			case RealtimestatechartPackage.STATECHART___TO_STRING:
				return toString();
			case RealtimestatechartPackage.STATECHART___CLONE:
				return clone();
		}
