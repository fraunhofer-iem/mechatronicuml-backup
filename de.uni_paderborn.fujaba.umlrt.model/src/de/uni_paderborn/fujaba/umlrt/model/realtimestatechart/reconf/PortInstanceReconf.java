...
/**
 * This class references a {@link PortInstance} which should be activated when the state
 ...
 * @model
 */
public interface PortInstanceReconf // extends UMLIncrement
{
	/**
	 * @model
	 */
 ...
 *
 * Revision 1.2  2005/08/05 10:35:22  kudak
 * Portnames are visible in states
 *
 */
