 ...
 * @model
 */
public interface UMLClock // extends UMLRealtimeStatechartVisitorElement // extends ASGElement

{
   ...
   public java.util.List<UMLRealtimeTransition> getUMLRealtimeTransitions();
	 ...
	 * @model
	 */
   public java.util.List<UMLBoolRealtimeAtom> getUMLBoolRealtimeAtoms();
