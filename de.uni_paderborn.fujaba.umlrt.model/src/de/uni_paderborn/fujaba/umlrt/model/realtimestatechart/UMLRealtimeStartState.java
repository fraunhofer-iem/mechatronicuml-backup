...
public interface UMLRealtimeStartState extends UMLRealtimeState {
	...
	/**
	 * Default value should be "UMLRealtimeStartState.HISTORY_NONE"
	 * 
	 * @model default="0"
	 */
	 ...
	 * @model
	 */
	public UMLRealtimeStatechart getUMLRealtimeStatechart1();
	
	public final static int HISTORY_NONE = 0;
	public final static int HISTORY_SHALLOW = 1;
	public final static int HISTORY_DEEP = 2;
}
