...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Flat Switching</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.FlatSwitchingImpl#getUMLRealtimeTransitions <em>UML Realtime Transitions</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.FlatSwitchingImpl#getMinDuration <em>Min Duration</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.FlatSwitchingImpl#getMaxDuration <em>Max Duration</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.FlatSwitchingImpl#getSpline1 <em>Spline1</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.FlatSwitchingImpl#getSpline2 <em>Spline2</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.FlatSwitchingImpl#getPolynomDegree <em>Polynom Degree</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.model.realtimestatechart.impl.FlatSwitchingImpl#getPortInstToPortInstMapEntry <em>Port Inst To Port Inst Map Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FlatSwitchingImpl extends EObjectImpl implements FlatSwitching {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Transition> uMLRealtimeTransitions;
	...
	protected EClass eStaticClass() {
		return RealtimestatechartPackage.Literals.FLAT_SWITCHING;
	}
	 ...
	 * @generated
	 */
	public EList<Transition> getUMLRealtimeTransitions() {
		if (uMLRealtimeTransitions == null) {
			uMLRealtimeTransitions = new EObjectResolvingEList<Transition>(Transition.class, this, RealtimestatechartPackage.FLAT_SWITCHING__UML_REALTIME_TRANSITIONS);
		}
	...
	public void setMinDuration(float newMinDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.FLAT_SWITCHING__MIN_DURATION, oldMinDuration, minDuration));
	}
	...
	public void setMaxDuration(float newMaxDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.FLAT_SWITCHING__MAX_DURATION, oldMaxDuration, maxDuration));
	}
	...
	public void setSpline1(String newSpline1) {
		...
		spline1 = newSpline1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.FLAT_SWITCHING__SPLINE1, oldSpline1, spline1));
	}
	...
	public void setSpline2(String newSpline2) {
		...
		spline2 = newSpline2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.FLAT_SWITCHING__SPLINE2, oldSpline2, spline2));
	}
	...
	public void setPolynomDegree(int newPolynomDegree) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.FLAT_SWITCHING__POLYNOM_DEGREE, oldPolynomDegree, polynomDegree));
	}
	...
	public void setPortInstToPortInstMapEntry(HashMap<?, ?> newPortInstToPortInstMapEntry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.FLAT_SWITCHING__PORT_INST_TO_PORT_INST_MAP_ENTRY, oldPortInstToPortInstMapEntry, portInstToPortInstMapEntry));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RealtimestatechartPackage.FLAT_SWITCHING__UML_REALTIME_TRANSITIONS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RealtimestatechartPackage.FLAT_SWITCHING__UML_REALTIME_TRANSITIONS:
				...
				getUMLRealtimeTransitions().addAll((Collection<? extends Transition>)newValue);
				return;
			case RealtimestatechartPackage.FLAT_SWITCHING__MIN_DURATION:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RealtimestatechartPackage.FLAT_SWITCHING___GET_BREAKPOINT:
