...
public class PortInstanceReconfImpl extends EObjectImpl implements PortInstanceReconf {
	 ...
	 * @ordered
	 */
	protected PortInstance portByComponentInstance;
	 ...
	 * @generated
	 */
	public PortInstance getPortByComponentInstance() {
		if (portByComponentInstance != null && portByComponentInstance.eIsProxy()) {
			InternalEObject oldPortByComponentInstance = (InternalEObject)portByComponentInstance;
			portByComponentInstance = (PortInstance)eResolveProxy(oldPortByComponentInstance);
	 ...
	 * @generated
	 */
	public PortInstance basicGetPortByComponentInstance() {
		return portByComponentInstance;
	}
	 ...
	 * @generated
	 */
	public void setPortByComponentInstance(PortInstance newPortByComponentInstance) {
		PortInstance oldPortByComponentInstance = portByComponentInstance;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ReconfPackage.PORT_INSTANCE_RECONF__COMPONENT_INSTANCE_RECONF:
				...
				return;
			case ReconfPackage.PORT_INSTANCE_RECONF__PORT_BY_COMPONENT_INSTANCE:
				setPortByComponentInstance((PortInstance)newValue);
				return;
			case ReconfPackage.PORT_INSTANCE_RECONF__RECONF_DIAGRAM:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ReconfPackage.PORT_INSTANCE_RECONF__COMPONENT_INSTANCE_RECONF:
				...
				return;
			case ReconfPackage.PORT_INSTANCE_RECONF__PORT_BY_COMPONENT_INSTANCE:
				setPortByComponentInstance((PortInstance)null);
				return;
			case ReconfPackage.PORT_INSTANCE_RECONF__RECONF_DIAGRAM:
