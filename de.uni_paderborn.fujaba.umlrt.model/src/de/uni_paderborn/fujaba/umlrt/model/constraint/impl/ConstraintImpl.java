...
//also this makes it possible to use one Constraint to many UMLIncrements (does this cause trouble?)
{
	 ...
	 * @generated
	 */
   public boolean getBackground(){return false;}

	/**
	 * @generated
	 */
   public boolean getIsInternalConstraint(){return false;}

	/**
	 * @generated
	 */
   public boolean getExtendAutomatically(){return false;}

	/**
	 * @generated
	 */
   public Correctness getCorrectness(){return null;}
...
//   /**
//    * Returns a commented version of the constraint text.
//    * @return a commented version of the constraint text
//    */
...
//   }
   ...
   public static final String[] CORRECTNESS_AS_STRING = {"unknown correctness", "correct", "unsafe", "false"};
   /**
    * @return Returns if correctness is correct.
    */
...
//   {
//      return getCorrectnessAsString(correctness);
//   }
//   
//   
//   public static String getCorrectnessAsString(Correctness correctness)
//   {
//      int i = correctness == null ? 0 : 
//         correctness.ordinal() >= CORRECTNESS_AS_STRING.length ? 0 :
//            correctness.ordinal() < 0 ? 0 :
//               correctness.ordinal();
//      return CORRECTNESS_AS_STRING[i];
//   }  
}
