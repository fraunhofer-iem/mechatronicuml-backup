...
public class ChannelImpl implements Channel
{
	 ...
	 * @generated
	 */
   public EClass getInterfaceClass(){return null;}// UMLClass getInterfaceClass(){return null;}
   ...
   public UMLRealtimeStatechart getStatechart(){return null;}
	 ...
	 * @generated
	 */
   public ProvidedInterface getProvidedInterface(){return null;}

	/**
	 * @generated
	 */
   public PatternDiagram getDiagram(){return null;}

	/**
	 * @generated
	 */
   public RequiredInterface getRequiredInterface(){return null;}
    ...
    * No comment provided by developer, please add a comment to improve documentation.
    *
    * @param channel  No description provided
    * @return         No description provided
    */
//   public boolean equals (ChannelImpl channel)
//   {
//      return  ( (this.direction == channel.getDirection()) &&  (this.interfaceClass.getName().equals (channel.getInterfaceClass().getName())) &&  (this.requiredInterface.getPortRole() == channel.getRequiredInterface().getPortRole()) &&  (this.providedInterface.getPortRole() == channel.getProvidedInterface().getPortRole()));
//   }
