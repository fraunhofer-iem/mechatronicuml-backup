...
public class APIMappingLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.muml.psm.api.apimappinglanguage.parser.antlr.internal.InternalAPIMappingLanguageParser createParser(XtextTokenStream stream) {
		return new org.muml.psm.api.apimappinglanguage.parser.antlr.internal.InternalAPIMappingLanguageParser(stream, getGrammarAccess());
	}
