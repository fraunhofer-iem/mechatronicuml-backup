 ...
 * @generated
 */
public class OperationRepositoryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperationRepositoryNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new de.uni_paderborn.fujaba.muml.operationrepository.diagram.edit.policies.MumlTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.operationrepository.diagram.providers.MumlParserProvider.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					de.uni_paderborn.fujaba.muml.operationrepository.diagram.edit.parts.MumlEditPartFactory
