...
public class ModifyMessageTypeWizardAction extends AbstractMessageinterfaceEditorAction implements IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action) {
      ...
      ModifyParameterWizard wizard = new ModifyParameterWizard(diag,selectedMessageType);
		...
		if ((selection instanceof IStructuredSelection))
	  	{
			...
			Object obj = structured.getFirstElement();
	         ...
	         if (obj instanceof MessageTypeEditPart
	               && ((MessageTypeEditPart) obj).getNotationView().getElement() instanceof MessageType){
	        	 
	        	 selectedMessageType =(MessageType) ((MessageTypeEditPart) obj).getNotationView().getElement();
	         }
	  	}
