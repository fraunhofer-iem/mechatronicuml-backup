...
import de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.providers.MumlinstanceElementTypes;

public class ModifyParameterPage extends WizardPage{
	
	protected EDataType d = null;
...
//					MumlinstanceElementTypes.MessageInterface_2002);
//							  
...
//		
//		MumlinstanceDiagram messageTypeDiagram = ((ModifyParameterWizard)getWizard()).getMessageTypeDiagram();
//
//		RootNode root = (RootNode)messageTypeDiagram.eContainer();
//		
//		return root.getEcoreDataTypes();
		return new ArrayList<EDataType>();
	}
