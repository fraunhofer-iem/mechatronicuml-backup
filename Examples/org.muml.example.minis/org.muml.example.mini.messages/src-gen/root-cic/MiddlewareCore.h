...
//Create components
	SenderComponent* c1Component; /**< The ComponentInstance: C1 of Type: SenderComponent*/
	ReceiverComponent* c2Component; /**< The ComponentInstance: C2 of Type: ReceiverComponent*/
