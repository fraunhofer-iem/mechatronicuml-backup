...
/* Maximum size of a serialized M1MyMessageM1Message-message, useful for buffer allocation. */
#define MAX_M1MyMessageM1Message_SIZE 12

/* Structure that holds a deserialized M1MyMessageM1Message-message. */
struct M1MyMessageM1Message {
    double _lightValue;
};
