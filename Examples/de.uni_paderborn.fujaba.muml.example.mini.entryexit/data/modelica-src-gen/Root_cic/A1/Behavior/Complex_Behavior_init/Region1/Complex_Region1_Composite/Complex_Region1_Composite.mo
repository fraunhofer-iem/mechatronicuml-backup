	within Root_cic.A1.Behavior.Complex_Behavior_init.Region1.Complex_Region1_Composite;
model Complex_Region1_Composite extends Modelica_StateGraph2.PartialParallel(nEntry=1);
	// no annotations will be generated for complex states
	// region declarations
	InnerRegion.InnerRegion region_1_innerRegion(nIn=1, use_outPort=false)
