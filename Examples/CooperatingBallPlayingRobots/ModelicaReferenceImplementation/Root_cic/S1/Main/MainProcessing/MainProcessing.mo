within Root_cic.S1.Main.MainProcessing;
model MainProcessing
 ...
 Boolean isMaster_sampled;
  ...
  RealTimeCoordinationLibrary.RealTimeCoordination.MessageInterface.OutputDelegationPort
   ...
   redeclare Real reals[0])
   annotation(Placement(transformation(extent={{0,0},{18,18}})));
  // end raise message event delegation port declarations for region BAT_Info_To_OtherRobot1
  ...
  RealTimeCoordinationLibrary.RealTimeCoordination.MessageInterface.OutputDelegationPort
   ...
   redeclare Real reals[5])
   annotation(Placement(transformation(extent={{0,0},{18,18}})));
  // end raise message event delegation port declarations for region BAT_Info_ToStrikeProcessing1        // trigger message event delegation port declarations for region BAT_Info_From_SensorProcessing1
   RealTimeCoordinationLibrary.RealTimeCoordination.MessageInterface.InputDelegationPort
...
algorithm
   ...
   when init.region_3_BAT_Info_From_SensorProcessing1.transition_Receiving_1_Receiving.fire then
    init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_posX := pre(init.region_3_BAT_Info_From_SensorProcessing1.transition_Receiving_1_Receiving.transition_input_port[1].reals[1]);
    init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_posY := pre(init.region_3_BAT_Info_From_SensorProcessing1.transition_Receiving_1_Receiving.transition_input_port[1].reals[2]);
    init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_posZ := pre(init.region_3_BAT_Info_From_SensorProcessing1.transition_Receiving_1_Receiving.transition_input_port[1].reals[3]);
    init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_timeOfArrival := pre(init.region_3_BAT_Info_From_SensorProcessing1.transition_Receiving_1_Receiving.transition_input_port[1].reals[4]);
    init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_velocity := pre(init.region_3_BAT_Info_From_SensorProcessing1.transition_Receiving_1_Receiving.transition_input_port[1].reals[5]);
   end when;
   when init.region_1_BAT_Info_To_OtherRobot1.transition_YourTurn_1_MyTurn.fire then
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_posX := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_YourTurn_1_MyTurn.transition_input_port[1].reals[1]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_posY := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_YourTurn_1_MyTurn.transition_input_port[1].reals[2]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_posZ := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_YourTurn_1_MyTurn.transition_input_port[1].reals[3]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_timeOfArrival := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_YourTurn_1_MyTurn.transition_input_port[1].reals[4]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_velocity := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_YourTurn_1_MyTurn.transition_input_port[1].reals[5]);

   end when;
   when init.region_1_BAT_Info_To_OtherRobot1.transition_Init_2_MyTurn.fire then
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_posX := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_Init_2_MyTurn.transition_input_port[1].reals[1]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_posY := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_Init_2_MyTurn.transition_input_port[1].reals[2]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_posZ := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_Init_2_MyTurn.transition_input_port[1].reals[3]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_timeOfArrival := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_Init_2_MyTurn.transition_input_port[1].reals[4]);
    init.region_1_BAT_Info_To_OtherRobot1.mailbox_turn_velocity := pre(init.region_1_BAT_Info_To_OtherRobot1.transition_Init_2_MyTurn.transition_input_port[1].reals[5]);
   end when;
   ...
   when pre(init.region_3_BAT_Info_From_SensorProcessing1.transition_Receiving_1_Receiving.fire) then
    posXReceivedBySP := pre(init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_posX);
    posYReceivedBySP := pre(init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_posY);
    posZReceivedBySP := pre(init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_posZ);
    timeOfArrivalReceivedBySP := pre(init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_timeOfArrival);
    velocityReceivedBySP := pre(init.region_3_BAT_Info_From_SensorProcessing1.mailbox_transferBATInfo_velocity);
