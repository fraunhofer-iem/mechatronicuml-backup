...
model Complex_innerRegion_inner1 extends Modelica_StateGraph2.PartialParallel(nEntry=1);
	// no annotations will be generated for complex states
	// region declarations
	Composite2.Composite2 region_1_composite2(nIn=1, use_outPort=false)
