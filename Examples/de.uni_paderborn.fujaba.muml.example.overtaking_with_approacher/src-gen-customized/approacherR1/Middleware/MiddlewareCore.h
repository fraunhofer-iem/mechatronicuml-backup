...
/**
 * 
 * @brief Description of the Middleware for the ECU: approacherR1
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: approacherR1
 */
typedef struct Middleware {

//Create components?
	MotorComponent* approacherMotorRComponent; /**< The ComponentInstance: approacherMotorR of Type: MotorComponent , which is allocated on the ECU: approacherR1 */

	MotorComponent* approacherMotorLComponent; /**< The ComponentInstance: approacherMotorL of Type: MotorComponent , which is allocated on the ECU: approacherR1 */

	ApproacherDriverComponent* approacherDriverComponent; /**< The ComponentInstance: approacherDriver of Type: ApproacherDriverComponent , which is allocated on the ECU: approacherR1 */

	LineComponent* approacherLineComponent; /**< The ComponentInstance: approacherLine of Type: LineComponent , which is allocated on the ECU: approacherR1 */

	DistanceComponent* approacherDistanceComponent; /**< The ComponentInstance: approacherDistance of Type: DistanceComponent , which is allocated on the ECU: approacherR1 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: approacherR1  */
//Create Networkinterfaces
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: approacherR1 */
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: approacherR1 */
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: approacherR1 */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: approacherR1 */
...
ECUID idOfECU; /**< The ECUID of the ECU: approacherR1 on which the Middleware is executed */
