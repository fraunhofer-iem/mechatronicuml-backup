...
MessageID * messageIDsOfbuffer;
		//create instance approacherMotorR of type MotorComponent
		 mw->approacherMotorRComponent = MotorComponent_create();
				...
				mw->approacherMotorRComponent->velocityPort = Port_create(PORT_APPROACHERMOTORRMOTORVELOCITY, 1, allBuffersOfvelocityvelocity);
		...
		mw->approacherMotorRComponent->stateChart->initApi = approacherMotorR_velocity_InitApi;
		mw->approacherMotorRComponent->stateChart->execApi = approacherMotorR_velocity_ExecApi;
		//create instance approacherMotorL of type MotorComponent
		 mw->approacherMotorLComponent = MotorComponent_create();
				...
				mw->approacherMotorLComponent->velocityPort = Port_create(PORT_APPROACHERMOTORLMOTORVELOCITY, 1, allBuffersOfvelocityvelocity);
		...
		mw->approacherMotorLComponent->stateChart->initApi = approacherMotorL_velocity_InitApi;
		mw->approacherMotorLComponent->stateChart->execApi = approacherMotorL_velocity_ExecApi;
