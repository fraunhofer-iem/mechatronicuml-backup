...
//ENUM
	 ...
	 */
		typedef enum {
				...
				,		ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPRACHERSAVEBREAKRTSC_APPRACHERSAVEBREAKRTSC_BREAK_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPRACHERSAVEBREAKRTSC_APPRACHERSAVEBREAKRTSC_BREAK_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_appracherSaveBreakRTSC_appracherSaveBreakRTSC */ 
