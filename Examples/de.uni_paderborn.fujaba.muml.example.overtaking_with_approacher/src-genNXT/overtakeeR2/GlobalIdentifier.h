 ...
 */
		//Define MessageType IDs
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 1 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 3 /**< Global Identifier: For the Message-Type: change */
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 4 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 7 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 8 /**< Global Identifier: For the Message-Type: declineOvertaking */
			...
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: unsave */
			...
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 15 /**< Global Identifier: For the Message-Type: setSlow */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 17 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 19 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 20 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: initiate */
