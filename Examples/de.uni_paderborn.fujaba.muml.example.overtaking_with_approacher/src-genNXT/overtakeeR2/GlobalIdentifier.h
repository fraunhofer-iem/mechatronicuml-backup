 ...
 */
		//Define MessageType IDs
			...
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: change */
			...
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 7 /**< Global Identifier: For the Message-Type: unsave */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 8 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 9 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: setSlow */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_DISTANCE_DISTANCE_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 12 /**< Global Identifier: For the Message-Type: Distance_distance_message */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			...
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 16 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 17 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 19 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: save */
