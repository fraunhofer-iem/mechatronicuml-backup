...
//Create Networkinterfaces
	...
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: serverBrick */
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: serverBrick */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: serverBrick */
