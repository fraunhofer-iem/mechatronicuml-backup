 ...
 */
		//Define MessageType IDs
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 1 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: setSlow */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 3 /**< Global Identifier: For the Message-Type: unsave */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 4 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: fixVelocity */
			...
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 9 /**< Global Identifier: For the Message-Type: declineOvertaking */
			...
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 15 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 17 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			...
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: finishedO */
