...
/**
 * 
 * @brief Description of the Middleware for the ECU: overtakerR2
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: overtakerR2
 */
typedef struct Middleware {

//Create components?
	OvertakerCommunicatorComponent* overtakerCommunicatorComponent; /**< The ComponentInstance: overtakerCommunicator of Type: OvertakerCommunicatorComponent , which is allocated on the ECU: overtakerR2 */

	ColorComponent* overtakerColorComponent; /**< The ComponentInstance: overtakerColor of Type: ColorComponent , which is allocated on the ECU: overtakerR2 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: overtakerR2  */
//Create Networkinterfaces
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: overtakerR2 */
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: overtakerR2 */
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: overtakerR2 */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: overtakerR2 */
...
ECUID idOfECU; /**< The ECUID of the ECU: overtakerR2 on which the Middleware is executed */
