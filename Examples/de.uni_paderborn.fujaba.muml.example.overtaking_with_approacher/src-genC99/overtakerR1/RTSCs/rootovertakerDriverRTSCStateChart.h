...
//ENUM
	 ...
	 */
		typedef enum {
				...
				,
						ROOTOVERTAKERDRIVERRTSC_INIT_STATE_INITIATORPORTRTSC_INITIATORPORTRTSC_INIT_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_INITIATORPORTRTSC_INITIATORPORTRTSC_INIT_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_initiatorPortRTSC_initiatorPortRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_INITIATORPORTRTSC_INITIATORPORTRTSC_INITIATE_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_INITIATORPORTRTSC_INITIATORPORTRTSC_INITIATE_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_initiatorPortRTSC_initiatorPortRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_INITIATORPORTRTSC_INITIATORPORTRTSC_EXECUTING_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_INITIATORPORTRTSC_INITIATORPORTRTSC_EXECUTING_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_initiatorPortRTSC_initiatorPortRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_DRIVE_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_DRIVE_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerDrivingRTSC_overtakerDrivingRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerDrivingRTSC_overtakerDrivingRTSC */
				,
						ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_TURNLEFT_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_TURNLEFT_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_DRIVETOOPPOSITELINE_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_DRIVETOOPPOSITELINE_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_FOLLOWOPPOSITELINE_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_FOLLOWOPPOSITELINE_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_TURNRIGHT_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_TURNRIGHT_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_DRIVETOMAINLINE_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_DRIVEOVERTAKINGRTSC_DRIVEOVERTAKINGRTSC_DRIVETOMAINLINE_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERSAVEBRAKERTSC_OVERTAKERSAVEBRAKERTSC_CHECKDISTANCE_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERSAVEBRAKERTSC_OVERTAKERSAVEBRAKERTSC_CHECKDISTANCE_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSC_overtakerSaveBrakeRTSC */ 
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERSAVEBRAKERTSC_OVERTAKERSAVEBRAKERTSC_BREAK_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERSAVEBRAKERTSC_OVERTAKERSAVEBRAKERTSC_BREAK_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSC_overtakerSaveBrakeRTSC */ 
	...
	struct RootovertakerDriverRTSCStateChart {	
			...
			RootovertakerDriverRTSCState currentStateOfRootovertakerDriverRTSC; /**< The current State of the Realtime-StateChart: RootovertakerDriverRTSC */
				...
				RootovertakerDriverRTSCState currentStateOfROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSC; /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC of the Realtime-StateChart: RootovertakerDriverRTSC */
				RootovertakerDriverRTSCState currentStateOfROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSC_overtakerSaveBrakeRTSC; /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSC of the Realtime-StateChart: RootovertakerDriverRTSC */
...
//METHOD STUBS
	...
	/**
	 * @brief Initializes the Region: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC of the Realtime-StateChart: RootovertakerDriverRTSC
	 * @details The Member RootovertakerDriverRTSCStateChart::currentStateOfROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSC is initialized
	 * 
	 * @param stateChart The specific RootovertakerDriverRTSCStateChart whose Region shall be initialized
	 */
		void initializeROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSCRegion(RootovertakerDriverRTSCStateChart* stateChart);
	/**
	 * @brief Initializes the Region: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSC of the Realtime-StateChart: RootovertakerDriverRTSC
	 * @details The Member RootovertakerDriverRTSCStateChart::currentStateOfROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSC_overtakerSaveBrakeRTSC is initialized
	 * 
	 * @param stateChart The specific RootovertakerDriverRTSCStateChart whose Region shall be initialized
	 */
		void initializeROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSCRegion(RootovertakerDriverRTSCStateChart* stateChart);
	/**
	 ...
	 */
		void ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_OVERTAKE_STATE_driveOvertakingRTSC_driveOvertakingRTSCStateChart_exit(RootovertakerDriverRTSCStateChart* rtsc);
	/**
	...
	/**
	 * @brief Leaves the Region: overtakerSaveBrakeRTSC of the Realtime-StateChart: RootovertakerDriverRTSC
	 * @details This method is called, whenever a the Region: overtakerSaveBrakeRTSC is left.
	 * 			The correct State is set and all Exit-Events are executed.
	 *
	 * @param rtsc The specific RootovertakerDriverRTSCStateChart whose Region: overtakerSaveBrakeRTSC shall be exit
	 */
		void ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerSaveBrakeRTSC_overtakerSaveBrakeRTSCStateChart_exit(RootovertakerDriverRTSCStateChart* rtsc);
