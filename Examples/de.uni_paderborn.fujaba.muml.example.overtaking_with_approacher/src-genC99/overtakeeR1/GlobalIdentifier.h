 ...
 */
		//Define MessageType IDs
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 1 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 2 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 3 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 4 /**< Global Identifier: For the Message-Type: unsave */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 6 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 7 /**< Global Identifier: For the Message-Type: overtake */
			...
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: setSlow */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 15 /**< Global Identifier: For the Message-Type: initiate */
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 17 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 19 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: change */
