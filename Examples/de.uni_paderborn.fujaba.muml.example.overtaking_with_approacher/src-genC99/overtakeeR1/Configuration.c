...
MessageID * messageIDsOfbuffer;
		//create instance overtakeeDriver of type OvertakeeDriverComponent
		 mw->overtakeeDriverComponent = OvertakeeDriverComponent_create();
					...
					MessageBuffer* buffer1ofvelocityGetterP1velocityGetterP = MessageBuffer_create(5,false,2,messageIDsOfbuffer);
		...
		//create instance overtakeeMotorL of type MotorComponent
		 mw->overtakeeMotorLComponent = MotorComponent_create();
				...
				mw->overtakeeMotorLComponent->velocityPort = Port_create(PORT_OVERTAKEEMOTORLMOTORVELOCITY, 1, allBuffersOfvelocityvelocity);
		...
		mw->overtakeeMotorLComponent->stateChart->initApi = overtakeeMotorL_velocity_InitApi;
		mw->overtakeeMotorLComponent->stateChart->execApi = overtakeeMotorL_velocity_ExecApi;
		//create instance overtakeeMotorR of type MotorComponent
		 mw->overtakeeMotorRComponent = MotorComponent_create();
				...
				mw->overtakeeMotorRComponent->velocityPort = Port_create(PORT_OVERTAKEEMOTORRMOTORVELOCITY, 1, allBuffersOfvelocityvelocity);
		...
		mw->overtakeeMotorRComponent->stateChart->initApi = overtakeeMotorR_velocity_InitApi;
		mw->overtakeeMotorRComponent->stateChart->execApi = overtakeeMotorR_velocity_ExecApi;
