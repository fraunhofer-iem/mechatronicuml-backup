 ...
 */
		//Define MessageType IDs
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 1 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: save */
			...
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 7 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 8 /**< Global Identifier: For the Message-Type: executed */
			...
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: change */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 15 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 17 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			...
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: setSlow */
