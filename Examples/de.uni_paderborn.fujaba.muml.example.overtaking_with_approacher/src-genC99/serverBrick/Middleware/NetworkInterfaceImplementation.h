...
/**
 * @brief INIT method for NetworkInterface: inputPort4 of ECU:serverBrick
...
/**
 * @brief SEND method for the NetworkInterface: inputPort4 of ECU:serverBrick
...
/**
 * @brief RECEIVE method for the NetworkInterface: inputPort4 of ECU:serverBrick
...
/**
 * @brief INIT method for NetworkInterface: usbPort of ECU:serverBrick
...
/**
 * @brief SEND method for the NetworkInterface: usbPort of ECU:serverBrick
...
/**
 * @brief RECEIVE method for the NetworkInterface: usbPort of ECU:serverBrick
