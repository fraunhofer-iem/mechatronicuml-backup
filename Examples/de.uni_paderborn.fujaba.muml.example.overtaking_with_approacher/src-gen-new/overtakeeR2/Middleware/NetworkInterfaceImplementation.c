 ...
 */
 ...
 int myPortIds[15] = {PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERVELOCITYGETTERP1, PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERVELOCITYR, PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERLINEOVERTAKEE, PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERVELOCITYL, 
 						PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERDISTANCEOVERTAKEE, PORT_OVERTAKEECOMMUNICATOROVERTAKEECOMMUNICATOROVERTAKEEP1, PORT_OVERTAKEECOMMUNICATOROVERTAKEECOMMUNICATORVELOCITYSETTERP1,
 						PORT_OVERTAKEECOMMUNICATOROVERTAKEECOMMUNICATORVEHICLEOVERTAKEEP1, PORT_OVERTAKEECOMMUNICATOROVERTAKEECOMMUNICATORINFORMOVERTAKEE1, PORT_OVERTAKEECOMMUNICATOROVERTAKEECOMMUNICATORCOLOROVERTAKEE,
 						PORT_OVERTAKEEMOTORLMOTORVELOCITYCONTR, PORT_OVERTAKEEMOTORRMOTORVELOCITYCONTL, PORT_OVERTAKEELINELINELINELIGHT, PORT_OVERTAKEECOLORCOLORCOLOR, PORT_OVERTAKEEDISTANCEDISTANCEDISTANCEOVERTAKEE};
