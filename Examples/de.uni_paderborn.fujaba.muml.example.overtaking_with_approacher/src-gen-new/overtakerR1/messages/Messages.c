...
/*******************************************************************
 * Message: Messages.proto, line 14
 *******************************************************************/
...
void Line_lineLight_messageapi_messageType_RepositoryMessage_clear(struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage) {
	_memset(_Line_lineLight_messageapi_messageType_RepositoryMessage, 0, sizeof(struct Line_lineLight_messageapi_messageType_RepositoryMessage));
}

void Line_lineLight_messageapi_messageType_RepositoryMessage_init_optional_attributes(struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage) {
	_Line_lineLight_messageapi_messageType_RepositoryMessage->_lineLight_value = 0;
	
}

int Line_lineLight_messageapi_messageType_RepositoryMessage_is_default_message(struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage) {
    return _Line_lineLight_messageapi_messageType_RepositoryMessage->_lineLight_value == 0
    ;
}

int Line_lineLight_messageapi_messageType_RepositoryMessage_write(struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage, void *_buffer, int offset) {
	/* Write content of each message element.*/
	/* Write the optional attribute only if it is different than the default value. */
	if(_Line_lineLight_messageapi_messageType_RepositoryMessage->_lineLight_value != 0) {
		offset = write_raw_varint32((1<<3)+0, _buffer, offset);
	    if (_Line_lineLight_messageapi_messageType_RepositoryMessage->_lineLight_value >= 0)
	        offset = write_raw_varint32(_Line_lineLight_messageapi_messageType_RepositoryMessage->_lineLight_value, _buffer, offset);
	    else
	        offset = write_raw_varint64(_Line_lineLight_messageapi_messageType_RepositoryMessage->_lineLight_value, _buffer, offset);	    
	}
...
int Line_lineLight_messageapi_messageType_RepositoryMessage_write_with_tag(struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage, void *_buffer, int offset, int tag) {
	...
	/* Write content.*/
	offset = Line_lineLight_messageapi_messageType_RepositoryMessage_write_delimited_to(_Line_lineLight_messageapi_messageType_RepositoryMessage, _buffer, offset);
...
int Line_lineLight_messageapi_messageType_RepositoryMessage_write_delimited_to(struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage, void *_buffer, int offset) {
	...
	new_offset = Line_lineLight_messageapi_messageType_RepositoryMessage_write(_Line_lineLight_messageapi_messageType_RepositoryMessage, _buffer, offset);
...
int Line_lineLight_messageapi_messageType_RepositoryMessage_read(void *_buffer, struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage, int offset, int limit) {
	unsigned int i = 0;
	unsigned long long value = i;
	unsigned long tag = value;
	
	/* Reset all attributes to 0 in advance. */
	Line_lineLight_messageapi_messageType_RepositoryMessage_clear(_Line_lineLight_messageapi_messageType_RepositoryMessage);
	/* Assign the optional attributes. */
	Line_lineLight_messageapi_messageType_RepositoryMessage_init_optional_attributes(_Line_lineLight_messageapi_messageType_RepositoryMessage);
	...
	while(offset < limit) {
		...
		tag = tag>>3;
	    switch(tag){
	        /* tag of: _Line_lineLight_messageapi_messageType_RepositoryMessage._lineLight_value */
	        case 1 :
	        	offset = read_raw_varint32(&tag, _buffer, offset);
	        	_Line_lineLight_messageapi_messageType_RepositoryMessage->_lineLight_value = (signed long)tag;
	        	break;
	    }
	}
...
int Line_lineLight_messageapi_messageType_RepositoryMessage_read_delimited_from(void *_buffer, struct Line_lineLight_messageapi_messageType_RepositoryMessage *_Line_lineLight_messageapi_messageType_RepositoryMessage, int offset) {
	...
	offset = read_raw_varint32(&size, _buffer, offset);
	Line_lineLight_messageapi_messageType_RepositoryMessage_read(_buffer, _Line_lineLight_messageapi_messageType_RepositoryMessage, offset, size + offset);
	
	return offset + size;
}
/*******************************************************************
 * Message: Messages.proto, line 18
 *******************************************************************/
...
/*******************************************************************
 * Message: Messages.proto, line 22
 *******************************************************************/
...
/*******************************************************************
 * Message: Messages.proto, line 34
 *******************************************************************/
