...
bool_t Middleware_destroy(void){
	...
	MotorComponent_destroy(mw->approacherMotorRComponent);
	MotorComponent_destroy(mw->approacherMotorLComponent);
	ApproacherDriverComponent_destroy(mw->approacherDriverComponent);
	LineComponent_destroy(mw->approacherLineComponent);
	DistanceComponent_destroy(mw->approacherDistanceComponent);
