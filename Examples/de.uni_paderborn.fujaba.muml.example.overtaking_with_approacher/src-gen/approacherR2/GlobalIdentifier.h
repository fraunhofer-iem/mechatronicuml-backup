 ...
 */
		//Define MessageType IDs
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 1 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 3 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 4 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 6 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 7 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 8 /**< Global Identifier: For the Message-Type: unsave */
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 9 /**< Global Identifier: For the Message-Type: change */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: initiate */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 15 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: fixVelocity */
			...
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 18 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 19 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: setSlow */
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: overtake */
