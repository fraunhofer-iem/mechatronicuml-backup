 ...
 */
		//Define MessageType IDs
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 1 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 3 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 4 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: initiate */
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: change */
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 7 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 8 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 9 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 11 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: unsave */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 15 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_DISTANCE_DISTANCE_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 17 /**< Global Identifier: For the Message-Type: Distance_distance_message */
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 19 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: setSlow */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: finishOvertaking */
		...
		//Define Port IDs
			...
			#define PORT_OVERTAKERMOTORRMOTORVELOCITY 5 /**< Global Identifier: For the Discrete-Port-Instance: velocity */
			#define PORT_OVERTAKERMOTORLMOTORVELOCITY 6 /**< Global Identifier: For the Discrete-Port-Instance: velocity */
			...
			#define PORT_OVERTAKEEMOTORLMOTORVELOCITY 30 /**< Global Identifier: For the Discrete-Port-Instance: velocity */
			#define PORT_OVERTAKEEMOTORRMOTORVELOCITY 31 /**< Global Identifier: For the Discrete-Port-Instance: velocity */
			...
			#define PORT_APPROACHERMOTORRMOTORVELOCITY 35 /**< Global Identifier: For the Discrete-Port-Instance: velocity */
			#define PORT_APPROACHERMOTORLMOTORVELOCITY 36 /**< Global Identifier: For the Discrete-Port-Instance: velocity */
