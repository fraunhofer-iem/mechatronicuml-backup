 ...
 */
		//Define MessageType IDs
			...
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 3 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 4 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 7 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 8 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 9 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: initiate */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 13 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_MOTOR_VELOCITY_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 14 /**< Global Identifier: For the Message-Type: Motor_velocity_message */
			#define MESSAGE_EXECUTEOVERTAKINGMESSAGESMESSAGE 15 /**< Global Identifier: For the Message-Type: execute */
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 16 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 17 /**< Global Identifier: For the Message-Type: unsave */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_DISTANCE_DISTANCE_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 19 /**< Global Identifier: For the Message-Type: Distance_distance_message */
			#define MESSAGE_CHANGEOVERTAKINGMESSAGESMESSAGE 20 /**< Global Identifier: For the Message-Type: change */
