...
//ENUM
	 ...
	 */
		typedef enum {
				...
				,		ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_BREAKNOW_STATE /**< Represents the State: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_OVERTAKERDRIVINGRTSC_OVERTAKERDRIVINGRTSC_BREAKNOW_STATE of the Realtime-StateChart: ROOTOVERTAKERDRIVERRTSC_INIT_STATE_overtakerDrivingRTSC_overtakerDrivingRTSC */ 
