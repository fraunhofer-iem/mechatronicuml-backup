 ...
 */
		//Define MessageType IDs
			...
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 4 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 6 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 7 /**< Global Identifier: For the Message-Type: startedO */
			#define MESSAGE_DISTANCE_DISTANCE_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 8 /**< Global Identifier: For the Message-Type: Distance_distance_message */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 9 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_FINISHOVERTAKINGOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: finishOvertaking */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: initiate */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: fixVelocity */
			#define MESSAGE_SAVEOVERTAKINGMESSAGESMESSAGE 13 /**< Global Identifier: For the Message-Type: save */
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: setFast */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 15 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 16 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_ACCEPTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 17 /**< Global Identifier: For the Message-Type: acceptOvertaking */
			#define MESSAGE_UNSAVEOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: unsave */
