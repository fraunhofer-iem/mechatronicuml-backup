 ...
 */
		//Define MessageType IDs
			...
			#define MESSAGE_EXECUTEDOVERTAKINGMESSAGESMESSAGE 2 /**< Global Identifier: For the Message-Type: executed */
			#define MESSAGE_FINISHEDOOVERTAKINGMESSAGESMESSAGE 3 /**< Global Identifier: For the Message-Type: finishedO */
			#define MESSAGE_LINE_LINELIGHT_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 4 /**< Global Identifier: For the Message-Type: Line_lineLight_message */
			#define MESSAGE_FIXVELOCITYOVERTAKINGMESSAGESMESSAGE 5 /**< Global Identifier: For the Message-Type: fixVelocity */
			...
			#define MESSAGE_OVERTAKEOVERTAKINGMESSAGESMESSAGE 8 /**< Global Identifier: For the Message-Type: overtake */
			#define MESSAGE_COLOR_COLOR_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 9 /**< Global Identifier: For the Message-Type: Color_color_message */
			#define MESSAGE_FREEVELOCITYOVERTAKINGMESSAGESMESSAGE 10 /**< Global Identifier: For the Message-Type: freeVelocity */
			#define MESSAGE_REQUESTOVERTAKINGOVERTAKINGMESSAGESMESSAGE 11 /**< Global Identifier: For the Message-Type: requestOvertaking */
			#define MESSAGE_DECLINEOVERTAKINGOVERTAKINGMESSAGESMESSAGE 12 /**< Global Identifier: For the Message-Type: declineOvertaking */
			#define MESSAGE_DISTANCE_DISTANCE_MESSAGEAPI_MESSAGETYPE_REPOSITORYMESSAGE 13 /**< Global Identifier: For the Message-Type: Distance_distance_message */
			#define MESSAGE_INITIATEOVERTAKINGMESSAGESMESSAGE 14 /**< Global Identifier: For the Message-Type: initiate */
			#define MESSAGE_STARTEDOOVERTAKINGMESSAGESMESSAGE 15 /**< Global Identifier: For the Message-Type: startedO */
			...
			#define MESSAGE_SETSLOWOVERTAKINGMESSAGESMESSAGE 18 /**< Global Identifier: For the Message-Type: setSlow */
			...
			#define MESSAGE_SETFASTOVERTAKINGMESSAGESMESSAGE 21 /**< Global Identifier: For the Message-Type: setFast */
