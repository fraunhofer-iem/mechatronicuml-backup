...
/**
 * 
 * @brief Description of the Middleware for the ECU: overtakeeR1
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: overtakeeR1
 */
typedef struct Middleware {

//Create components?
	OvertakeeDriverComponent* overtakeeDriverComponent; /**< The ComponentInstance: overtakeeDriver of Type: OvertakeeDriverComponent , which is allocated on the ECU: overtakeeR1 */

	MotorComponent* overtakeeMotorLComponent; /**< The ComponentInstance: overtakeeMotorL of Type: MotorComponent , which is allocated on the ECU: overtakeeR1 */

	MotorComponent* overtakeeMotorRComponent; /**< The ComponentInstance: overtakeeMotorR of Type: MotorComponent , which is allocated on the ECU: overtakeeR1 */

	LineComponent* overtakeeLineComponent; /**< The ComponentInstance: overtakeeLine of Type: LineComponent , which is allocated on the ECU: overtakeeR1 */

	DistanceComponent* overtakeeDistanceComponent; /**< The ComponentInstance: overtakeeDistance of Type: DistanceComponent , which is allocated on the ECU: overtakeeR1 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: overtakeeR1  */
//Create Networkinterfaces
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: overtakeeR1 */
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: overtakeeR1 */
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: overtakeeR1 */
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: overtakeeR1 */
...
ECUID idOfECU; /**< The ECUID of the ECU: overtakeeR1 on which the Middleware is executed */
