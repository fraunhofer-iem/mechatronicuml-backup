 ...
 * @details In this file Method-Stubs for the #NetworkInterface%s of the ECU serverBrick are genereated,
...
/**
 * @brief INIT method for NetworkInterface: VirtualWifiPort of ECU:serverBrick
...
/**
 * @brief SEND method for the NetworkInterface: VirtualWifiPort of ECU:serverBrick
...
/**
 * @brief RECEIVE method for the NetworkInterface: VirtualWifiPort of ECU:serverBrick
...
/**
 * @brief INIT method for NetworkInterface: virtualBluetoothPort of ECU:serverBrick
...
/**
 * @brief SEND method for the NetworkInterface: virtualBluetoothPort of ECU:serverBrick
...
/**
 * @brief RECEIVE method for the NetworkInterface: virtualBluetoothPort of ECU:serverBrick
...
/**
 * @brief INIT method for NetworkInterface: VirtualWifiPort2 of ECU:serverBrick
...
/**
 * @brief SEND method for the NetworkInterface: VirtualWifiPort2 of ECU:serverBrick
...
/**
 * @brief RECEIVE method for the NetworkInterface: VirtualWifiPort2 of ECU:serverBrick
...
/**
 * @brief INIT method for NetworkInterface: VirtualWifiPort1 of ECU:serverBrick
...
/**
 * @brief SEND method for the NetworkInterface: VirtualWifiPort1 of ECU:serverBrick
...
/**
 * @brief RECEIVE method for the NetworkInterface: VirtualWifiPort1 of ECU:serverBrick
...
MiddlewareMessage * networkInterface_VirtualWifiPort_receive(void);
/**
 * @brief INIT method for NetworkInterface: VirtualWifiPort3 of ECU:serverBrick
...
/**
 * @brief SEND method for the NetworkInterface: VirtualWifiPort3 of ECU:serverBrick
...
/**
 * @brief RECEIVE method for the NetworkInterface: VirtualWifiPort3 of ECU:serverBrick
