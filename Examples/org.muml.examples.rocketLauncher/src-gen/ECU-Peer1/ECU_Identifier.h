...
*/
					#define CI_PEER1LAUNCHDELEGATOR 1 /**< Identifier for Component Instance peer1 */
					#define CI_PEER1INPUTIDENTIFICATIONINPUT 2 /**< Identifier for Component Instance peer1Input */
