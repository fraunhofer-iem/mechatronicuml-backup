...
/**
 * 
 * @brief Description of the Middleware for the ECU: brick201
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: brick201
 */
typedef struct Middleware {

//Create components?
	CommunicatorComponent* communicatorComponent; /**< The ComponentInstance: Communicator of Type: CommunicatorComponent , which is allocated on the ECU: brick201 */

	LoadControllerComponent* loadControllerComponent; /**< The ComponentInstance: LoadController of Type: LoadControllerComponent , which is allocated on the ECU: brick201 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: brick201  */
//Create Networkinterfaces
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: brick201 */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: brick201 */
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: brick201 */
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: brick201 */
...
ECUID idOfECU; /**< The ECUID of the ECU: brick201 on which the Middleware is executed */
