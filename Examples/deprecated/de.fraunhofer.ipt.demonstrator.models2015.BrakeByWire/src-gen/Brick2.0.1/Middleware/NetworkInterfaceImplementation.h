 ...
 * @details In this file Method-Stubs for the #NetworkInterface%s of the ECU brick201 are genereated,
...
/**
 * @brief INIT method for NetworkInterface: inputPort4 of ECU:brick201
...
/**
 * @brief SEND method for the NetworkInterface: inputPort4 of ECU:brick201
...
/**
 * @brief RECEIVE method for the NetworkInterface: inputPort4 of ECU:brick201
...
/**
 * @brief INIT method for NetworkInterface: usbPort of ECU:brick201
...
/**
 * @brief SEND method for the NetworkInterface: usbPort of ECU:brick201
...
/**
 * @brief RECEIVE method for the NetworkInterface: usbPort of ECU:brick201
...
/**
 * @brief INIT method for NetworkInterface: virtualBluetoothPort of ECU:brick201
...
/**
 * @brief SEND method for the NetworkInterface: virtualBluetoothPort of ECU:brick201
...
/**
 * @brief RECEIVE method for the NetworkInterface: virtualBluetoothPort of ECU:brick201
...
/**
 * @brief INIT method for NetworkInterface: VirtualWifiPort of ECU:brick201
...
/**
 * @brief SEND method for the NetworkInterface: VirtualWifiPort of ECU:brick201
...
/**
 * @brief RECEIVE method for the NetworkInterface: VirtualWifiPort of ECU:brick201
