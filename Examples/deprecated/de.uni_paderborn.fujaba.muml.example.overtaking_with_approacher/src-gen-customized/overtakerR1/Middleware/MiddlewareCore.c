...
bool_t Middleware_destroy(void){
	...
	MotorComponent_destroy(mw->overtakerMotorRComponent);
	MotorComponent_destroy(mw->overtakerMotorLComponent);
	OvertakerDriverComponent_destroy(mw->overtakerDriverComponent);
	DistanceComponent_destroy(mw->overtakerDistanceComponent);
	LineComponent_destroy(mw->overtakerLineComponent);
