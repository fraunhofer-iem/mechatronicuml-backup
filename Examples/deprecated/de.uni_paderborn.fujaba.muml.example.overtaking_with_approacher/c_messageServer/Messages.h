...
/* Maximum size of a serialized Light_light_messageapi_messageType_RepositoryMessage-message, useful for buffer allocation. */
#define MAX_Light_light_messageapi_messageType_RepositoryMessage_SIZE 14

/* Structure that holds a deserialized Light_light_messageapi_messageType_RepositoryMessage-message. */
struct Light_light_messageapi_messageType_RepositoryMessage {
    signed long _light_value;
};
