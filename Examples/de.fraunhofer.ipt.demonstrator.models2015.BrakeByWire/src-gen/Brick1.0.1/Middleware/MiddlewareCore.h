...
/**
 * 
 * @brief Description of the Middleware for the ECU: brick101
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: brick101
 */
typedef struct Middleware {

//Create components?
	DriverComponent* driverComponent; /**< The ComponentInstance: Driver of Type: DriverComponent , which is allocated on the ECU: brick101 */

	MainControllerComponent* mainControllerComponent; /**< The ComponentInstance: MainController of Type: MainControllerComponent , which is allocated on the ECU: brick101 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: brick101  */
//Create Networkinterfaces
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: brick101 */
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: brick101 */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: brick101 */
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: brick101 */
...
ECUID idOfECU; /**< The ECUID of the ECU: brick101 on which the Middleware is executed */
