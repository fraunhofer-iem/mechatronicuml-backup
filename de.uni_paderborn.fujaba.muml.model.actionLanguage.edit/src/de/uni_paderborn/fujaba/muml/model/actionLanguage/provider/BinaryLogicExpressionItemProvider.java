...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.model.actionLanguage.BinaryLogicExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryLogicExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryLogicExpression_operator_feature", "_UI_BinaryLogicExpression_type"),
				 ActionLanguagePackage.Literals.BINARY_LOGIC_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BinaryLogicExpression_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BinaryLogicExpression.class)) {
			case ActionLanguagePackage.BINARY_LOGIC_EXPRESSION__OPERATOR:
