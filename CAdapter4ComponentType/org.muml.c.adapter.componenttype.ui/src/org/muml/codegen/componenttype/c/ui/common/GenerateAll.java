 ...
 *******************************************************************************/
package org.muml.c.adapter.componenttype.ui.common;
...
import org.muml.c.adapter.componenttype.ui.Activator;
...
/**
 * Main entry point of the 'ComponentType Code' generation module.
 */
public class GenerateAll {
	...
	public void doGenerate(IProgressMonitor monitor) throws IOException {
		...
		monitor.subTask("Loading...");
			URL resources = FileLocator.toFileURL(Platform
					.getBundle(org.muml.c.adapter.componenttype.Activator.PLUGIN_ID).getEntry("resources"));
				...
				for (ModelElementCategory mec : rootNode.getCategories()) {
					if (mec.getKey().matches("org.muml.pim.instance.category")) {
						...
						for (ExtendableElement me : mec.getModelElements()) {
							...
							org.muml.c.adapter.componenttype.main.Main gen0 = new org.muml.c.adapter.componenttype.main.Main(
							...
							String generationID = org.eclipse.acceleo.engine.utils.AcceleoLaunchingUtil
									.computeUIProjectID("org.muml.c.adapter.componenttype",
											"org.muml.c.adapter.componenttype.main.Main", modelURI.toString(),
	...
	public void generateCIC(IProgressMonitor monitor, ComponentInstanceConfiguration cic) throws IOException  {
		...
		String generationID = org.eclipse.acceleo.engine.utils.AcceleoLaunchingUtil.computeUIProjectID(
				"org.muml.c.adapter.componenttype", "org.muml.c.adapter.componenttype.main.Main",
