...
public class AbstractActionLanguageJavaValidator extends AbstractDeclarativeValidator {
	...
	protected List<EPackage> getEPackages() {
	    ...
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.fujaba.de/muml/actionlanguage/0.3.14"));
	    ...
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.fujaba.de/muml/model/behavior/0.3.14"));
		return result;
	}
