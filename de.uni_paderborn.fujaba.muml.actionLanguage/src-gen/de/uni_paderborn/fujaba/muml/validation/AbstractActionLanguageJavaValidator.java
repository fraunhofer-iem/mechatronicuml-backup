...
public class AbstractActionLanguageJavaValidator extends AbstractDeclarativeValidator {
	...
	protected List<EPackage> getEPackages() {
	    ...
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.fujaba.de/muml/actionlanguage/0.3.12"));
	    ...
	    result.add(EPackage.Registry.INSTANCE.getEPackage("http://www.fujaba.de/muml/model/behavior/0.3.10"));
		return result;
	}
