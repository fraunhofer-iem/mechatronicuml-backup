...
public class ActionLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ForLoopCountingExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cLhs_typedNamedElementExpressionVariableOrParameterOrPortExpressionParserRuleCall_0_0 = (RuleCall)cLhs_typedNamedElementExpressionAssignment_0.eContents().get(0);
		...
		public RuleCall getLhs_typedNamedElementExpressionVariableOrParameterOrPortExpressionParserRuleCall_0_0() { return cLhs_typedNamedElementExpressionVariableOrParameterOrPortExpressionParserRuleCall_0_0; }
	...
	public class OperandElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cExtendedVariableOrParameterExpressionParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		public RuleCall getExtendedVariableOrParameterExpressionParserRuleCall_2() { return cExtendedVariableOrParameterExpressionParserRuleCall_2; }
	...
	public class ExtendedVariableOrParameterExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ExtendedVariableOrParameterExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cVariableOrParameterOrPortExpressionParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Action cDiscreteInteractionEndpointReferenceVariableExpressionAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		//VariableOrParameterOrPortExpression
		public RuleCall getVariableOrParameterOrPortExpressionParserRuleCall_0() { return cVariableOrParameterOrPortExpressionParserRuleCall_0; }
		...
		//{actionLanguage::DiscreteInteractionEndpointReference.variableExpression=current}
		public Action getDiscreteInteractionEndpointReferenceVariableExpressionAction_1_0() { return cDiscreteInteractionEndpointReferenceVariableExpressionAction_1_0; }
	...
	public class VariableOrParameterOrPortExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "VariableOrParameterOrPortExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private ExtendedVariableOrParameterExpressionElements pExtendedVariableOrParameterExpression;
	private VariableOrParameterOrPortExpressionElements pVariableOrParameterOrPortExpression;
	...
	//	VariableOrParameterOrPortExpression ({actionLanguage::DiscreteInteractionEndpointReference.variableExpression=current}
	//	"." position=PositionSelectorExpression)?;
	public ExtendedVariableOrParameterExpressionElements getExtendedVariableOrParameterExpressionAccess() {
		return (pExtendedVariableOrParameterExpression != null) ? pExtendedVariableOrParameterExpression : (pExtendedVariableOrParameterExpression = new ExtendedVariableOrParameterExpressionElements());
	}
	
	public ParserRule getExtendedVariableOrParameterExpressionRule() {
		return getExtendedVariableOrParameterExpressionAccess().getRule();
	}

	//VariableOrParameterOrPortExpression returns actionLanguage::VariableOrParameterExpression:
	//	typedNamedElement=[behavior::TypedNamedElement] ("[" indices+=ArithmeticExpression "]")*;
	public VariableOrParameterOrPortExpressionElements getVariableOrParameterOrPortExpressionAccess() {
		return (pVariableOrParameterOrPortExpression != null) ? pVariableOrParameterOrPortExpression : (pVariableOrParameterOrPortExpression = new VariableOrParameterOrPortExpressionElements());
	}
	
	public ParserRule getVariableOrParameterOrPortExpressionRule() {
		return getVariableOrParameterOrPortExpressionAccess().getRule();
	}
