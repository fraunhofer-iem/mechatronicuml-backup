 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.trace.diagnosticTrace.NamedElementReference#getSingleNamedElementReference <em>Single Named Element Reference</em>}</li>
 *   <li>{@link de.uni_paderborn.uppaal.trace.diagnosticTrace.NamedElementReference#getNamedElementReference <em>Named Element Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.uppaal.trace.diagnosticTrace.DiagnosticTracePackage#getNamedElementReference()
 * @model
 * @generated
 */
public interface NamedElementReference extends EObject
{
   ...
   * @see de.uni_paderborn.uppaal.trace.diagnosticTrace.DiagnosticTracePackage#getNamedElementReference_SingleNamedElementReference()
  ...
  /**
   * Sets the value of the '{@link de.uni_paderborn.uppaal.trace.diagnosticTrace.NamedElementReference#getSingleNamedElementReference <em>Single Named Element Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uni_paderborn.uppaal.trace.diagnosticTrace.DiagnosticTracePackage#getNamedElementReference_NamedElementReference()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uni_paderborn.uppaal.trace.diagnosticTrace.NamedElementReference#getNamedElementReference <em>Named Element Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
