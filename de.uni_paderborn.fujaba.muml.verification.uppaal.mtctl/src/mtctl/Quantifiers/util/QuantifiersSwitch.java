...
public class QuantifiersSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QuantifiersPackage.AF_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(afExpr);
			...
			case QuantifiersPackage.AG_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(agExpr);
			...
			case QuantifiersPackage.EF_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(efExpr);
			...
			case QuantifiersPackage.EG_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(egExpr);
			...
			case QuantifiersPackage.EXISTENCE_QUANT_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(existenceQuantExpr);
			...
			case QuantifiersPackage.QUANTIFIER_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(quantifierExpr);
			...
			case QuantifiersPackage.BOUND_VARIABLE: {
				...
				if (result == null) result = caseTemporalLogicConstraint(boundVariable);
			...
			case QuantifiersPackage.TEMPORAL_QUANTIFIER_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(temporalQuantifierExpr);
			...
			case QuantifiersPackage.UNIVERSAL_QUANT_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(universalQuantExpr);
			...
			case QuantifiersPackage.LEADS_TO_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(leadsToExpr);
				if (result == null) result = caseExtendableElement(leadsToExpr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QuantifiersPackage.TIME_INTERVAL_EXPR: {
				TimeIntervalExpr timeIntervalExpr = (TimeIntervalExpr)theEObject;
				...
				if (result == null) result = caseTemporalLogicConstraint(timeIntervalExpr);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Time Interval Expr</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Time Interval Expr</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
