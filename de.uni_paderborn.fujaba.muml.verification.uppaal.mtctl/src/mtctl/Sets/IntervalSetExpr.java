 ...
 * <ul>
 *   <li>{@link mtctl.Sets.IntervalSetExpr#getLowerVal <em>Lower Val</em>}</li>
 *   <li>{@link mtctl.Sets.IntervalSetExpr#getUpperVal <em>Upper Val</em>}</li>
 * </ul>
 * </p>
 *
 * @see mtctl.Sets.SetsPackage#getIntervalSetExpr()
 * @model
 * @generated
 */
public interface IntervalSetExpr extends SetExpr {
	 ...
	 * @see #setLowerVal(int)
	 * @see mtctl.Sets.SetsPackage#getIntervalSetExpr_LowerVal()
	 * @model
	 * @generated
	 */
	int getLowerVal();
	...
	/**
	 * Sets the value of the '{@link mtctl.Sets.IntervalSetExpr#getLowerVal <em>Lower Val</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setUpperVal(int)
	 * @see mtctl.Sets.SetsPackage#getIntervalSetExpr_UpperVal()
	 * @model
	 * @generated
	 */
	int getUpperVal();
	...
	/**
	 * Sets the value of the '{@link mtctl.Sets.IntervalSetExpr#getUpperVal <em>Upper Val</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
