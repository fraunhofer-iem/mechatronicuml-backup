	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SetsPackage.SET_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(setExpr);
			...
			case SetsPackage.CLOCK_SET_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(clockSetExpr);
			...
			case SetsPackage.INTERVAL_SET_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(intervalSetExpr);
			...
			case SetsPackage.MESSAGE_SET_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(messageSetExpr);
			...
			case SetsPackage.STATE_SET_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(stateSetExpr);
			...
			case SetsPackage.TRANSITION_SET_EXPR: {
				...
				if (result == null) result = caseTemporalLogicConstraint(transitionSetExpr);
