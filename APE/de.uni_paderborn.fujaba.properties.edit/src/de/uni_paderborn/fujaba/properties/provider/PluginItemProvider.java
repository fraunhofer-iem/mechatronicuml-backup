...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.properties.Plugin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PropertiesPackage.Literals.PLUGIN__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRequiredBundlesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Plugin_requiredBundles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Plugin_requiredBundles_feature", "_UI_Plugin_type"),
				 PropertiesPackage.Literals.PLUGIN__REQUIRED_BUNDLES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
