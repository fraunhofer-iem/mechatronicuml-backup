...
public class EFactoryEditor
	...
	protected void createProperties() {
		...
		if (tab == null || "tab.default".equals(getTab())) { // Tab Default
			...
			addPropertyEditor(createEPackage_DefaultTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createEPackage_DefaultTab_Editor() {
