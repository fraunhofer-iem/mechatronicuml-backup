...
public class PropertiesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PropertiesPackage.PACKAGE: {
				org.muml.ape.Package package_ = (org.muml.ape.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PropertiesPackage.CLASS: {
				org.muml.ape.Class class_ = (org.muml.ape.Class)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(org.muml.ape.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(org.muml.ape.Class object) {
		return null;
	}
