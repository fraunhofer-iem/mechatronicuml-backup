 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getReconciler <em>Reconciler</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getGenModel <em>Gen Model</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getReferencedGenerators <em>Referenced Generators</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getPlugin <em>Plugin</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getDefaultTab <em>Default Tab</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getTabs <em>Tabs</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getPackages <em>Packages</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getContributorId <em>Contributor Id</em>}</li>
 *   <li>{@link org.muml.ape.impl.PropertyGeneratorImpl#getSourceFolder <em>Source Folder</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyGeneratorImpl extends EObjectImpl implements PropertyGenerator {
	 ...
	 * @ordered
	 */
	protected EList<org.muml.ape.Package> packages;
	 ...
	 * @generated
	 */
	public EList<org.muml.ape.Package> getPackages() {
		if (packages == null) {
			packages = new EObjectContainmentWithInverseEList<org.muml.ape.Package>(org.muml.ape.Package.class, this, PropertiesPackage.PROPERTY_GENERATOR__PACKAGES, PropertiesPackage.PACKAGE__GENERATOR);
		}
		return packages;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PropertiesPackage.PROPERTY_GENERATOR__PACKAGES:
				getPackages().clear();
				getPackages().addAll((Collection<? extends org.muml.ape.Package>)newValue);
				return;
			case PropertiesPackage.PROPERTY_GENERATOR__CONTRIBUTOR_ID:
