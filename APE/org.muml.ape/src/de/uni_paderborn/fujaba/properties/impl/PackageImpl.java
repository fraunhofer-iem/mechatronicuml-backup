 ...
 * @generated
 */
public class PackageImpl extends EObjectImpl implements de.uni_paderborn.fujaba.properties.Package {
	/**
	 ...
	 * @ordered
	 */
	protected EList<de.uni_paderborn.fujaba.properties.Class> classes;
	 ...
	 * @generated
	 */
	public EList<de.uni_paderborn.fujaba.properties.Class> getClasses() {
		if (classes == null) {
			classes = new EObjectContainmentWithInverseEList<de.uni_paderborn.fujaba.properties.Class>(de.uni_paderborn.fujaba.properties.Class.class, this, PropertiesPackage.PACKAGE__CLASSES, PropertiesPackage.CLASS__PACKAGE);
		}
		return classes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PropertiesPackage.PACKAGE__CLASSES:
				getClasses().clear();
				getClasses().addAll((Collection<? extends de.uni_paderborn.fujaba.properties.Class>)newValue);
				return;
			case PropertiesPackage.PACKAGE__GENERATOR:
