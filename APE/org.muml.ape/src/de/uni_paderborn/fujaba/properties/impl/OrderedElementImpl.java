 ...
 * </p>
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.properties.impl.OrderedElementImpl#getClazz <em>Clazz</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OrderedElementImpl extends EObjectImpl implements OrderedElement {
	...
	public void setClazz(de.uni_paderborn.fujaba.properties.Class newClazz) {
		if (newClazz != eInternalContainer() || (eContainerFeatureID() != PropertiesPackage.ORDERED_ELEMENT__CLAZZ && newClazz != null)) {
			...
			if (newClazz != null)
				msgs = ((InternalEObject)newClazz).eInverseAdd(this, PropertiesPackage.CLASS__ORDERED_ELEMENTS, de.uni_paderborn.fujaba.properties.Class.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case PropertiesPackage.ORDERED_ELEMENT__CLAZZ:
				return eInternalContainer().eInverseRemove(this, PropertiesPackage.CLASS__ORDERED_ELEMENTS, de.uni_paderborn.fujaba.properties.Class.class, msgs);
		}
