...
import de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.custom.edit.commands.CustomAssemblyCreateCommand;
import de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.custom.edit.commands.CustomAssemblyReorientCommand;
...
public class CustomPortItemSemanticEditPolicy extends
	...
	public Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.providers.UmlrtElementTypes.Delegation_4003 == req
				.getElementType()) {
