...
package org.muml.uppaal.adapter.extension.verificationextension.properties.metamodel;
...
public class MetamodelContributor
	...
	protected void fillItemProviderFactories(java.util.List<org.eclipse.emf.common.notify.AdapterFactory> factories) {
		...
		factories.add(
				new org.muml.uppaal.adapter.extension.verificationextension.provider.VerificationExtensionItemProviderAdapterFactory());
