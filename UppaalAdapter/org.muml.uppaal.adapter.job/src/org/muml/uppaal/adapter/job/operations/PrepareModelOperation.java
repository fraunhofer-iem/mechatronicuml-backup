...
//			role.behavior l�schen
//			structured components alle l�schen
//			atomic continuous components l�schen
//			atomic software component referenziert statechart, statechart l�schen, dann komponente l�schen
			
			// Component Type referenziert statechart -> st l�schen (komponenten
			// komponent types l�schen
			// alle protokolle l�schen au�er mit clonedVerifiableElement l�schen, und alle referenzierten Statecharts l�schen (rollen statecharts)
			// alle cics l�schen
