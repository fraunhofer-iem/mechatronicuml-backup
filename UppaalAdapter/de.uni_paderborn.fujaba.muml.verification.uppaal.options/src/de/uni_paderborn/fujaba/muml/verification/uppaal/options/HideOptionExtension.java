...
public interface HideOptionExtension extends Extension {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.verification.uppaal.options.OptionsPackage#getHideOptionExtension_Option()
	 * @model default=""
	 * @generated
	 */
	String getOption();
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.verification.uppaal.options.HideOptionExtension#getOption <em>Option</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
