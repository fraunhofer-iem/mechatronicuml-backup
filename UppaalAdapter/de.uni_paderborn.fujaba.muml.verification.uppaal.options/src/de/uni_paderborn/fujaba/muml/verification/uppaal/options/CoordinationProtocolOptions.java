...
public interface CoordinationProtocolOptions extends Options {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.verification.uppaal.options.OptionsPackage#getCoordinationProtocolOptions_RoleMultiplicity()
	 * @model default="1"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.verification.uppaal.options.CoordinationProtocolOptions#getRoleMultiplicity <em>Role Multiplicity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
