...
package de.uni_paderborn.fujaba.muml.verification.extension.properties.metamodel;
...
public class MetamodelContributor
	...
	protected void fillItemProviderFactories(java.util.List<org.eclipse.emf.common.notify.AdapterFactory> factories) {
		...
		factories.add(
				new de.uni_paderborn.fujaba.muml.verification.verificationExtension.provider.VerificationExtensionItemProviderAdapterFactory());
