 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.verification.uppaal.mtctl.BooleanLogic.impl.AndExprImpl#getLeftOpd <em>Left Opd</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.verification.uppaal.mtctl.BooleanLogic.impl.AndExprImpl#getRightOpd <em>Right Opd</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AndExprImpl extends ExpressionImpl implements AndExpr {
	/**
	...
	protected EClass eStaticClass() {
		return BooleanLogicPackage.Literals.AND_EXPR;
	}
	...
	public NotificationChain basicSetLeftOpd(Expression newLeftOpd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BooleanLogicPackage.AND_EXPR__LEFT_OPD, oldLeftOpd, newLeftOpd);
	...
	public void setLeftOpd(Expression newLeftOpd) {
		if (newLeftOpd != leftOpd) {
			...
			if (leftOpd != null)
				msgs = ((InternalEObject)leftOpd).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BooleanLogicPackage.AND_EXPR__LEFT_OPD, null, msgs);
			if (newLeftOpd != null)
				msgs = ((InternalEObject)newLeftOpd).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BooleanLogicPackage.AND_EXPR__LEFT_OPD, null, msgs);
			msgs = basicSetLeftOpd(newLeftOpd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BooleanLogicPackage.AND_EXPR__LEFT_OPD, newLeftOpd, newLeftOpd));
	}
	...
	public NotificationChain basicSetRightOpd(Expression newRightOpd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BooleanLogicPackage.AND_EXPR__RIGHT_OPD, oldRightOpd, newRightOpd);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRightOpd(Expression newRightOpd) {
		if (newRightOpd != rightOpd) {
			NotificationChain msgs = null;
			if (rightOpd != null)
				msgs = ((InternalEObject)rightOpd).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BooleanLogicPackage.AND_EXPR__RIGHT_OPD, null, msgs);
			if (newRightOpd != null)
				msgs = ((InternalEObject)newRightOpd).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BooleanLogicPackage.AND_EXPR__RIGHT_OPD, null, msgs);
			msgs = basicSetRightOpd(newRightOpd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BooleanLogicPackage.AND_EXPR__RIGHT_OPD, newRightOpd, newRightOpd));
	}
