...
import de.uni_paderborn.fujaba.muml.verification.uppaal.mtctl.english.Mtctl2English;
...
public class PropertiesWizardPage extends WizardPage {
	...
	protected class PropertiesLabelProvider extends StyledCellLabelProvider {
		...
		Injector uiInjector = de.uni_paderborn.fujaba.muml.verification.uppaal.ui.internal.MtctlActivator.getInstance().getInjector("de.uni_paderborn.fujaba.muml.verification.uppaal.Mtctl");
