 ...
 * @generated
 */
public class MtctlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MtctlPackage.PROPERTY_REPOSITORY: {
				PropertyRepository propertyRepository = (PropertyRepository)theEObject;
				T result = casePropertyRepository(propertyRepository);
				if (result == null) result = caseVerificationConstraintRepository(propertyRepository);
				if (result == null) result = caseExtendableElement(propertyRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MtctlPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = caseCommentableElement(property);
				if (result == null) result = caseExtendableElement(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
