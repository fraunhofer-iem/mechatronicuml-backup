 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.uppaal.adapter.options.Options#getConnectorOutBufferSize <em>Connector Out Buffer Size</em>}</li>
 *   <li>{@link org.muml.uppaal.adapter.options.Options#getHashTableSize <em>Hash Table Size</em>}</li>
 *   <li>{@link org.muml.uppaal.adapter.options.Options#getStateSpaceReduction <em>State Space Reduction</em>}</li>
 *   <li>{@link org.muml.uppaal.adapter.options.Options#getTraceOptions <em>Trace Options</em>}</li>
 * </ul>
 *
 * @see org.muml.uppaal.adapter.options.OptionsPackage#getOptions()
 * @model
 * @generated
 */
public interface Options extends ExtendableElement {
	 ...
	 * @see org.muml.uppaal.adapter.options.OptionsPackage#getOptions_ConnectorOutBufferSize()
	 * @model default="5"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.muml.uppaal.adapter.options.Options#getConnectorOutBufferSize <em>Connector Out Buffer Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.muml.uppaal.adapter.options.OptionsPackage#getOptions_HashTableSize()
	...
	/**
	 * Sets the value of the '{@link org.muml.uppaal.adapter.options.Options#getHashTableSize <em>Hash Table Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link org.muml.uppaal.adapter.options.StateSpaceReduction}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see org.muml.uppaal.adapter.options.OptionsPackage#getOptions_StateSpaceReduction()
	...
	/**
	 * Sets the value of the '{@link org.muml.uppaal.adapter.options.Options#getStateSpaceReduction <em>State Space Reduction</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link org.muml.uppaal.adapter.options.TraceOptions}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see org.muml.uppaal.adapter.options.OptionsPackage#getOptions_TraceOptions()
	 * @model default="some"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.muml.uppaal.adapter.options.Options#getTraceOptions <em>Trace Options</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
