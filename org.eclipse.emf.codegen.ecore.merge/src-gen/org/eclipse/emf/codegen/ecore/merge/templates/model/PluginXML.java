package org.eclipse.emf.codegen.ecore.merge.templates.model;
...
public class PluginXML
{
  ...
  protected final String TEXT_25 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.generated_package\">" + NL + "      <?emfgen generated=\"true\"?>" + NL + "      <package" + NL + "            uri=\"";
  ...
  protected final String TEXT_33 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.content_parser\">" + NL + "      <?emfgen generated=\"true\"?>" + NL + "      <parser" + NL + "            contentTypeIdentifier=\"";
  protected final String TEXT_34 = "\"" + NL + "            class=\"";
  protected final String TEXT_35 = "\"/>" + NL + "   </extension>" + NL + "" + NL + "   <extension point=\"org.eclipse.core.contenttype.contentTypes\">" + NL + "      <?emfgen generated=\"true\"?>" + NL + "      <content-type" + NL + "            base-type=\"";
  ...
  protected final String TEXT_44 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.extension_parser\">" + NL + "      <?emfgen generated=\"true\"?>" + NL + "      <parser" + NL + "            type=\"";
