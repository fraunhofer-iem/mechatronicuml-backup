...
import de.fujaba.properties.codegen.Generator;
 ...
 * @generated NOT
 */
public class PropertiesActionBarContributor extends
	...
	protected ISelection getActiveEditorSelection() {
		return activeEditorPart == null ? null
				: ((PropertiesEditor) activeEditorPart).getSelection();
	}
	 ...
	 */
	protected IAction generateAction = new GenerateAction("Generate Properties");
	...
	protected void addGlobalActions(IMenuManager menuManager) {
		...
		menuManager.insertBefore("additions", generateAction);
	...
	protected class GenerateAction extends Action {
		...
		public GenerateAction(String text) {
			...
			ImageDescriptor descriptor = ImageDescriptor
					.createFromURL(PropertiesEditorPlugin.getPlugin()
							.getBundle()
							.getResource("icons/full/obj16/Generate.gif"));
		...
		public void run() {
			try {
				PropertyGenerator generator = getGenerator();
	...
	protected PropertyGenerator getGenerator() {
		...
		if (selection != null && !selection.isEmpty()) {
			...
			if (resource != null && !resource.getContents().isEmpty()) {
				...
				if (rootObject instanceof PropertyGenerator) {
					return (PropertyGenerator) rootObject;
				}
			}
		}
