...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.actionlanguage.DiscreteInteractionEndpointReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiscreteInteractionEndpointReferenceItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTypedNamedElementExpressionPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Typed Named Element Expression feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTypedNamedElementExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiscreteInteractionEndpointReference_typedNamedElementExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiscreteInteractionEndpointReference_typedNamedElementExpression_feature", "_UI_DiscreteInteractionEndpointReference_type"),
	...
	protected void addPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiscreteInteractionEndpointReference_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiscreteInteractionEndpointReference_position_feature", "_UI_DiscreteInteractionEndpointReference_type"),
