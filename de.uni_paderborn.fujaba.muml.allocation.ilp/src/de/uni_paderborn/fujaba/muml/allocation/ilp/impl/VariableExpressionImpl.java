 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.allocation.ilp.impl.VariableExpressionImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableExpressionImpl extends ExpressionImpl implements VariableExpression {
	...
	protected EClass eStaticClass() {
		return IlpPackage.Literals.VARIABLE_EXPRESSION;
	}
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IlpPackage.VARIABLE_EXPRESSION__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(Variable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IlpPackage.VARIABLE_EXPRESSION__VARIABLE, oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IlpPackage.VARIABLE_EXPRESSION__VARIABLE:
