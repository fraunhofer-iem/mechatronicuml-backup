	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTraceAccess().getAlternatives_5_0(), "rule__Trace__Alternatives_5_0");
					...
					put(grammarAccess.getTraceAccess().getGroup_5(), "rule__Trace__Group_5__0");
					...
					put(grammarAccess.getTraceAccess().getPropertyAssignment_1(), "rule__Trace__PropertyAssignment_1");
					put(grammarAccess.getTraceAccess().getLineAssignment_3(), "rule__Trace__LineAssignment_3");
					put(grammarAccess.getTraceAccess().getResultAssignment_4(), "rule__Trace__ResultAssignment_4");
					put(grammarAccess.getTraceAccess().getTraceItemsAssignment_5_1(), "rule__Trace__TraceItemsAssignment_5_1");
