...
import de.uni_paderborn.uppaal.cmd.options.misc.NoOptionSummaryOption;
import de.uni_paderborn.uppaal.cmd.options.misc.NoProgressIndicatorOption;
import de.uni_paderborn.uppaal.cmd.options.trace.DiagnosticInfoOption;
import de.uni_paderborn.uppaal.cmd.options.trace.DiagnosticInfoOption.TraceKind;
import de.uni_paderborn.uppaal.cmd.options.tuning.HashTableSizeOption;
import de.uni_paderborn.uppaal.cmd.options.tuning.ReuseStateSpaceOption;
import de.uni_paderborn.uppaal.cmd.options.tuning.SpaceConsumptionOption;
import de.uni_paderborn.uppaal.cmd.options.tuning.SpaceConsumptionOption.SpaceConsumptionOperator;
