...
* generated by Xtext
*/
package de.uni_paderborn.uppaal.trace.services;
...
public class DiagnosticTraceGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TraceRepositoryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TraceRepository");
	...
	public class TraceElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cVerifyingPropertyKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cPropertyAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cPropertyINTTerminalRuleCall_1_0 = (RuleCall)cPropertyAssignment_1.eContents().get(0);
		private final Keyword cAtLineKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cLineAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cLineINTTerminalRuleCall_3_0 = (RuleCall)cLineAssignment_3.eContents().get(0);
		private final Assignment cResultAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cResultResultEnumRuleCall_4_0 = (RuleCall)cResultAssignment_4.eContents().get(0);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Alternatives cAlternatives_5_0 = (Alternatives)cGroup_5.eContents().get(0);
		private final Keyword cShowingCounterExampleKeyword_5_0_0 = (Keyword)cAlternatives_5_0.eContents().get(0);
		private final Keyword cShowingExampleTraceKeyword_5_0_1 = (Keyword)cAlternatives_5_0.eContents().get(1);
		private final Assignment cTraceItemsAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final RuleCall cTraceItemsTraceItemParserRuleCall_5_1_0 = (RuleCall)cTraceItemsAssignment_5_1.eContents().get(0);
		...
		//"Verifying property"
		public Keyword getVerifyingPropertyKeyword_0() { return cVerifyingPropertyKeyword_0; }

		//property=INT
		public Assignment getPropertyAssignment_1() { return cPropertyAssignment_1; }

		//INT
		public RuleCall getPropertyINTTerminalRuleCall_1_0() { return cPropertyINTTerminalRuleCall_1_0; }

		//"at line"
		public Keyword getAtLineKeyword_2() { return cAtLineKeyword_2; }

		//line=INT
		public Assignment getLineAssignment_3() { return cLineAssignment_3; }

		//INT
		public RuleCall getLineINTTerminalRuleCall_3_0() { return cLineINTTerminalRuleCall_3_0; }

		//result=Result
		public Assignment getResultAssignment_4() { return cResultAssignment_4; }

		//Result
		public RuleCall getResultResultEnumRuleCall_4_0() { return cResultResultEnumRuleCall_4_0; }
		...
		public Keyword getShowingCounterExampleKeyword_5_0_0() { return cShowingCounterExampleKeyword_5_0_0; }

		//"Showing example trace."
		public Keyword getShowingExampleTraceKeyword_5_0_1() { return cShowingExampleTraceKeyword_5_0_1; }

		//traceItems+=TraceItem+
		public Assignment getTraceItemsAssignment_5_1() { return cTraceItemsAssignment_5_1; }

		//TraceItem
		public RuleCall getTraceItemsTraceItemParserRuleCall_5_1_0() { return cTraceItemsTraceItemParserRuleCall_5_1_0; }
	}

	public class ProcessIdentifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ProcessIdentifier");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LocationActivityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "LocationActivity");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SingleNamedElementReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "SingleNamedElementReference");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NamedElementReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "NamedElementReference");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TraceItemElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TraceItem");
	...
	public class EdgeActivityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "EdgeActivity");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ChannelSynchronizationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ChannelSynchronization");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TauSynchronizationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TauSynchronization");
	...
	public class DelayTransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DelayTransition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ActionTransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ActionTransition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ResultElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "Result");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
