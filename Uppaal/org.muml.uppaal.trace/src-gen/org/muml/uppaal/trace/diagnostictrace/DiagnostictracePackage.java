...
public interface DiagnostictracePackage extends EPackage
{
  ...
  /**
	 * The number of operations of the '<em>Trace Repository</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRACE_REPOSITORY_OPERATION_COUNT = 0;
  ...
  /**
	 ...
	 * @ordered
	 */
	int PROCESS_IDENTIFIER_OPERATION_COUNT = 0;
  ...
  /**
	 * The number of operations of the '<em>Location Activity</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int LOCATION_ACTIVITY_OPERATION_COUNT = 0;
  ...
  /**
	 * The number of operations of the '<em>Single Named Element Reference</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SINGLE_NAMED_ELEMENT_REFERENCE_OPERATION_COUNT = 0;
  ...
  /**
	 ...
	 * @ordered
	 */
	int NAMED_ELEMENT_REFERENCE_OPERATION_COUNT = 0;
  ...
  /**
	 * The number of operations of the '<em>Trace Item</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRACE_ITEM_OPERATION_COUNT = 0;
  ...
  /**
	 ...
	 * @ordered
	 */
	int STATE_OPERATION_COUNT = TRACE_ITEM_OPERATION_COUNT + 0;
  ...
  /**
	 * The number of operations of the '<em>Edge Activity</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EDGE_ACTIVITY_OPERATION_COUNT = 0;
  ...
  /**
	 * The number of operations of the '<em>Channel Synchronization</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CHANNEL_SYNCHRONIZATION_OPERATION_COUNT = SYNCHRONIZATION_OPERATION_COUNT + 0;
  ...
  /**
	 ...
	 * @ordered
	 */
	int TRANSITION_OPERATION_COUNT = TRACE_ITEM_OPERATION_COUNT + 0;
  ...
  /**
	 ...
	 * @ordered
	 */
	int DELAY_TRANSITION_OPERATION_COUNT = TRANSITION_OPERATION_COUNT + 0;
  ...
  /**
	 ...
	 * @ordered
	 */
	int ACTION_TRANSITION_OPERATION_COUNT = TRANSITION_OPERATION_COUNT + 0;
