...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.uppaal.types.TypeReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeReferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeReference_referredType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeReference_referredType_feature", "_UI_TypeReference_type"),
				 TypesPackage.Literals.TYPE_REFERENCE__REFERRED_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		BuiltInType labelValue = ((TypeReference)object).getBaseType();
