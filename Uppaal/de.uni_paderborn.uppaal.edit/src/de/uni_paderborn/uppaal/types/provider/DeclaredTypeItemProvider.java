		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeclaredType_typeDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeclaredType_typeDefinition_feature", "_UI_DeclaredType_type"),
				 TypesPackage.Literals.DECLARED_TYPE__TYPE_DEFINITION,
				 false,
				 false,
				 false,
				 null,
