...
public class TypeDeclarationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeclarationsPackage.Literals.TYPE_DECLARATION__TYPE);
			childrenFeatures.add(DeclarationsPackage.Literals.TYPE_DECLARATION__TYPE_DEFINITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeclarationsPackage.Literals.TYPE_DECLARATION__TYPE,
