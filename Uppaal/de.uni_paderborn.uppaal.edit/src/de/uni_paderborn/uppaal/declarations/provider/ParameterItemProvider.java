...
public class ParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_callType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_callType_feature", "_UI_Parameter_type"),
				 DeclarationsPackage.Literals.PARAMETER__CALL_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeclarationsPackage.Literals.PARAMETER__VARIABLE_DECLARATION);
		}
	...
	public String getText(Object object) {
		CallType labelValue = ((Parameter)object).getCallType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeclarationsPackage.Literals.PARAMETER__VARIABLE_DECLARATION,
