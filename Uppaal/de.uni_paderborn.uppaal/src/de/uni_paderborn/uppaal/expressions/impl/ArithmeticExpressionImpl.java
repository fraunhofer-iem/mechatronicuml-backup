 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.expressions.impl.ArithmeticExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArithmeticExpressionImpl extends BinaryExpressionImpl implements ArithmeticExpression {
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.Literals.ARITHMETIC_EXPRESSION;
	}
	...
	public void setOperator(ArithmeticOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.ARITHMETIC_EXPRESSION__OPERATOR, oldOperator, operator));
	}
