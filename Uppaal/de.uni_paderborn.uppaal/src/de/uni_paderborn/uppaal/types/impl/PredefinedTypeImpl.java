 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.types.impl.PredefinedTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PredefinedTypeImpl extends TypeImpl implements PredefinedType {
	 ...
	 * @ordered
	 */
	protected static final BuiltInType TYPE_EDEFAULT = BuiltInType.INT;
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.PREDEFINED_TYPE;
	}
	...
	public void setType(BuiltInType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.PREDEFINED_TYPE__TYPE, oldType, type));
	}
