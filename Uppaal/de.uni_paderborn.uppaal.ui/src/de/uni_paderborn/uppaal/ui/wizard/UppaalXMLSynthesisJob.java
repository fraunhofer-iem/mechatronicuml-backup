...
public class UppaalXMLSynthesisJob extends Job {
...
//		
//		SynchronousJob xmlSynthesis = resource == null ? new UppaalXMLSynthesisJob(args[0], m2m.getPropertyRepository(), targetPath, true) : new UppaalXMLSynthesisJob(m2m.getNTA(), m2m.getPropertyRepository(), resource, true);
//		IStatus status = xmlSynthesis.execute(monitor);
//		if(!status.isOK()) {
