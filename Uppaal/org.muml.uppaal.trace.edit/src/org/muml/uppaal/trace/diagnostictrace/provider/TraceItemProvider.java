...
/**
 * This is the item provider adapter for a {@link org.muml.uppaal.trace.diagnostictrace.Trace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TraceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagnostictracePackage.Literals.TRACE__PROPERTY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagnostictracePackage.Literals.TRACE__LINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagnostictracePackage.Literals.TRACE__RESULT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagnostictracePackage.Literals.TRACE__TRACE_ITEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagnostictracePackage.Literals.TRACE__TRACE_ITEMS,
				 DiagnostictraceFactory.eINSTANCE.createTraceItem()));

		newChildDescriptors.add
			(createChildParameter
				(DiagnostictracePackage.Literals.TRACE__TRACE_ITEMS,
				 DiagnostictraceFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(DiagnostictracePackage.Literals.TRACE__TRACE_ITEMS,
				 DiagnostictraceFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(DiagnostictracePackage.Literals.TRACE__TRACE_ITEMS,
				 DiagnostictraceFactory.eINSTANCE.createDelayTransition()));

		newChildDescriptors.add
			(createChildParameter
				(DiagnostictracePackage.Literals.TRACE__TRACE_ITEMS,
				 DiagnostictraceFactory.eINSTANCE.createActionTransition()));
	}
