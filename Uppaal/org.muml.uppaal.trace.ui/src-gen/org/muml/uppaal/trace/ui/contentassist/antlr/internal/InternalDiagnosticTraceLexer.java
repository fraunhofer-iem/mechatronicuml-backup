...
public class InternalDiagnosticTraceLexer extends Lexer {
    ...
    public final void mRULE_EDGE() throws RecognitionException {
        try {
            int _type = RULE_EDGE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:2988:11: ( '{' ( options {greedy=false; } : . )* '}' )
            // InternalDiagnosticTrace.g:2988:13: '{' ( options {greedy=false; } : . )* '}'
            {
            match('{'); 
            // InternalDiagnosticTrace.g:2988:17: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalDiagnosticTrace.g:2988:45: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:2990:10: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalDiagnosticTrace.g:2990:12: ( '-' )? ( '0' .. '9' )+
            {
            // InternalDiagnosticTrace.g:2990:12: ( '-' )?
            int alt2=2;
            ...
            // InternalDiagnosticTrace.g:2990:17: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalDiagnosticTrace.g:2990:18: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:2992:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalDiagnosticTrace.g:2992:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalDiagnosticTrace.g:2992:11: ( '^' )?
            int alt4=2;
            ...
            // InternalDiagnosticTrace.g:2992:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:2994:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalDiagnosticTrace.g:2994:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalDiagnosticTrace.g:2994:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalDiagnosticTrace.g:2994:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalDiagnosticTrace.g:2994:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // InternalDiagnosticTrace.g:2994:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalDiagnosticTrace.g:2994:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalDiagnosticTrace.g:2994:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalDiagnosticTrace.g:2994:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalDiagnosticTrace.g:2994:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalDiagnosticTrace.g:2994:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:2996:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalDiagnosticTrace.g:2996:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalDiagnosticTrace.g:2996:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
                ...
                switch (alt9) {
            	case 1 :
            	    // InternalDiagnosticTrace.g:2996:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:2998:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDiagnosticTrace.g:2998:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalDiagnosticTrace.g:2998:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
            ...
            // InternalDiagnosticTrace.g:2998:40: ( ( '\\r' )? '\\n' )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalDiagnosticTrace.g:2998:41: ( '\\r' )? '\\n'
                    {
                    // InternalDiagnosticTrace.g:2998:41: ( '\\r' )?
                    int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:3000:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalDiagnosticTrace.g:3000:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalDiagnosticTrace.g:3000:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDiagnosticTrace.g:3002:16: ( . )
            // InternalDiagnosticTrace.g:3002:18: .
            {
            matchAny(); 
