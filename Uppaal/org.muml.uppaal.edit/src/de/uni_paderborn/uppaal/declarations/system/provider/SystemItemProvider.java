...
public class SystemItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemPackage.Literals.SYSTEM__INSTANTIATION_LIST);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(de.uni_paderborn.uppaal.declarations.system.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SystemPackage.Literals.SYSTEM__INSTANTIATION_LIST,
				 SystemFactory.eINSTANCE.createInstantiationList()));
	}
