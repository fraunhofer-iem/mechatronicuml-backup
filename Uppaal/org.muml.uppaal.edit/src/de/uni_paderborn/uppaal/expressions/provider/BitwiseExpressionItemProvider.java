...
public class BitwiseExpressionItemProvider
	 ...
	 * @generated
	 */
	public BitwiseExpressionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BitwiseExpression_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BitwiseExpression_operator_feature", "_UI_BitwiseExpression_type"),
				 ExpressionsPackage.Literals.BITWISE_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns BitwiseExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BitwiseExpression"));
	}
	...
	public String getText(Object object) {
		BitwiseOperator labelValue = ((BitwiseExpression)object).getOperator();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BitwiseExpression.class)) {
