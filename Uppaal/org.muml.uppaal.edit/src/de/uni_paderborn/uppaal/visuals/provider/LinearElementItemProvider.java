...
public class LinearElementItemProvider
	 ...
	 * @generated
	 */
	public LinearElementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinearElement_bendPoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinearElement_bendPoint_feature", "_UI_LinearElement_type"),
				 VisualsPackage.Literals.LINEAR_ELEMENT__BEND_POINT,
				 true,
				 false,
				 false,
				 null,
	...
	/**
	 * This returns LinearElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinearElement"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LinearElement.class)) {
