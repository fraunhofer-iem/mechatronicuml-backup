/**
 */
package org.muml.uppaal.templates.util;
 ...
 * <!-- end-user-doc -->
 * @see org.muml.uppaal.templates.TemplatesPackage
 * @generated
 */
public class TemplatesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TemplatesPackage.REDEFINED_TEMPLATE: {
				RedefinedTemplate redefinedTemplate = (RedefinedTemplate)theEObject;
			...
			case TemplatesPackage.LOCATION: {
				...
				if (result == null) result = caseCommentableElement(location);
				if (result == null) result = casePlanarElement(location);
				if (result == null) result = caseColoredElement(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TemplatesPackage.EDGE: {
				...
				if (result == null) result = caseLinearElement(edge);
				if (result == null) result = caseCommentableElement(edge);
				if (result == null) result = caseColoredElement(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractTemplate(AbstractTemplate object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Redefined Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Redefined Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRedefinedTemplate(RedefinedTemplate object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Planar Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Planar Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePlanarElement(PlanarElement object) {
		return null;
	}
