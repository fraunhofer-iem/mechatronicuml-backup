 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.uppaal.declarations.impl.TypeDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.uni_paderborn.uppaal.declarations.impl.TypeDeclarationImpl#getTypeDefinition <em>Type Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeDeclarationImpl extends DeclarationImpl implements TypeDeclaration {
	 ...
	 * @ordered
	 */
	protected EList<DeclaredType> type;
	...
	protected EClass eStaticClass() {
		return DeclarationsPackage.Literals.TYPE_DECLARATION;
	}
	...
	public void setTypeDefinition(TypeDefinition newTypeDefinition) {
		if (newTypeDefinition != typeDefinition) {
			...
			if (typeDefinition != null)
				msgs = ((InternalEObject)typeDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DeclarationsPackage.TYPE_DECLARATION__TYPE_DEFINITION, null, msgs);
			if (newTypeDefinition != null)
				msgs = ((InternalEObject)newTypeDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DeclarationsPackage.TYPE_DECLARATION__TYPE_DEFINITION, null, msgs);
			msgs = basicSetTypeDefinition(newTypeDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarationsPackage.TYPE_DECLARATION__TYPE_DEFINITION, newTypeDefinition, newTypeDefinition));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DeclarationsPackage.TYPE_DECLARATION__TYPE:
