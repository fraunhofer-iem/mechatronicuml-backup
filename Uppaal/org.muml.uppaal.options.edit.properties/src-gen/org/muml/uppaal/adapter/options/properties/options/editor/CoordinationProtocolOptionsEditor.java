...
package org.muml.uppaal.adapter.options.properties.options.editor;
...
public class CoordinationProtocolOptionsEditor extends org.muml.ape.runtime.editors.ClassPropertyEditor {
	...
	private org.muml.ape.runtime.editors.AbstractStructuralFeaturePropertyEditor createEditorRoleMultiplicity_optionsTab_Editor() {
		if (this.editorRoleMultiplicity_optionsTab == null) {
			final org.eclipse.emf.ecore.EStructuralFeature feature = org.muml.uppaal.adapter.options.OptionsPackage.eINSTANCE
	...
	public CoordinationProtocolOptionsEditor(String tab) {
		this(tab, org.muml.uppaal.adapter.options.properties.util.PropertiesUtil.INSTANCE.getAdapterFactory(),
				org.muml.uppaal.adapter.options.OptionsPackage.eINSTANCE.getCoordinationProtocolOptions());
	}
