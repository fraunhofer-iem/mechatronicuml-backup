 ...
 * @generated
 */
public class DiscreteSinglePortInstance4CreateCommand extends
		EditElementCommand {

	/**
	 * @generated
	 */
	public DiscreteSinglePortInstance4CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_DiscreteSinglePortInstance_3025(newElement);
