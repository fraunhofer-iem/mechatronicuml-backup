 ...
 * @generated
 */
public class DiscreteMultiPortInstance3CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public DiscreteMultiPortInstance3CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_DiscreteMultiPortInstance_3030(newElement);
