 ...
 * @generated
 */
public class ContinuousPortInstanceCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ContinuousPortInstanceCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_ContinuousPortInstance_2020(newElement);
