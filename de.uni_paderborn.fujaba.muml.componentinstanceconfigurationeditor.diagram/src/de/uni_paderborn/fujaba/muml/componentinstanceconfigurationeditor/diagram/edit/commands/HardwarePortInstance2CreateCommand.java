 ...
 * @generated
 */
public class HardwarePortInstance2CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public HardwarePortInstance2CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_HardwarePortInstance_2006(newElement);
