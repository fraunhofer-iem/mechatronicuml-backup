...
public class MessageFormatParser
		extends
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.part.Messages.MessageFormatParser_InvalidInputError,
