 ...
 * @generated
 */
public class DiscreteMultiPortInstanceCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public DiscreteMultiPortInstanceCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_DiscreteMultiPortInstance_2019(newElement);
