 ...
 * @generated
 */
public class ComponentInstanceConfigurationComponentInstanceConfigurationCompartmentItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public ComponentInstanceConfigurationComponentInstanceConfigurationCompartmentItemSemanticEditPolicy() {
		super(
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.MumlElementTypes.ComponentInstance_3016 == req
				.getElementType()) {
