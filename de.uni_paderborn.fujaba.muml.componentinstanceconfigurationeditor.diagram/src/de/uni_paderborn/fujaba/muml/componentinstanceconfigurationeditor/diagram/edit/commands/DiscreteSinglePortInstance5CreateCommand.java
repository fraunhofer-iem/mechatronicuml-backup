 ...
 * @generated
 */
public class DiscreteSinglePortInstance5CreateCommand extends
		EditElementCommand {

	/**
	 * @generated
	 */
	public DiscreteSinglePortInstance5CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_DiscreteSinglePortInstance_3029(newElement);
