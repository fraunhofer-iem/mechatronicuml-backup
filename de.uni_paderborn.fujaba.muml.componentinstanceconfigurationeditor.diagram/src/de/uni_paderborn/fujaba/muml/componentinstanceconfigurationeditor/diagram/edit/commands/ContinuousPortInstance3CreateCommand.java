 ...
 * @generated
 */
public class ContinuousPortInstance3CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ContinuousPortInstance3CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_ContinuousPortInstance_3032(newElement);
