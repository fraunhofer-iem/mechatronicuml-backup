 ...
 * @generated
 */
public class HybridPortInstance3CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public HybridPortInstance3CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.providers.ElementInitializers
				.getInstance().init_HybridPortInstance_3028(newElement);
