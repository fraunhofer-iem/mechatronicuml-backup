...
public class GraphvizPlainGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class GraphElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.muml.graphviz.plain.xtext.GraphvizPlain.Graph");
	...
	public class NodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.muml.graphviz.plain.xtext.GraphvizPlain.Node");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EdgeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.muml.graphviz.plain.xtext.GraphvizPlain.Edge");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PointElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.muml.graphviz.plain.xtext.GraphvizPlain.Point");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NumberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.muml.graphviz.plain.xtext.GraphvizPlain.Number");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IdentifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.muml.graphviz.plain.xtext.GraphvizPlain.Identifier");
	...
	public GraphvizPlainGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tDOUBLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.muml.graphviz.plain.xtext.GraphvizPlain.DOUBLE");
