...
import org.muml.pm.hardware.platform.diagram.providers.HardwareMarkerNavigationProvider;
import org.muml.pm.hardware.platform.diagram.providers.HardwareValidationProvider;
	...
	public void run() {
		...
		if (workbenchPart instanceof IDiagramWorkbenchPart) {
			...
			try {
				...
				PlatformDiagramEditorPlugin.getInstance().logError("Validation action failed", e); //$NON-NLS-1$
			}
		}
	}
