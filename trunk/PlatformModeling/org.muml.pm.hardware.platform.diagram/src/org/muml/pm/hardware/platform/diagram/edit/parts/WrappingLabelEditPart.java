...
public class WrappingLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	public IParser getParser() {
		if (parser == null) {
			parser = HardwareParserProvider.getParser(HardwareElementTypes.HWPlatform_2009, getParserElement(),
					HardwareVisualIDRegistry
							.getType(org.muml.pm.hardware.platform.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
