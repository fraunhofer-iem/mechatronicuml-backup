 ...
 * @generated
 */
public class ActuatorInstanceLabelExpressionLabelParser5077 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ActuatorInstanceLabelExpressionLabelParser5077() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(4, HwresourceinstancePackage.eINSTANCE.getActuatorInstance(), null)
				.body();
	}
