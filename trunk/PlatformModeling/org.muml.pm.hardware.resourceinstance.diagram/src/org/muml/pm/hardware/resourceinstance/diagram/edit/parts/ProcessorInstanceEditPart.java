...
import org.muml.pm.hardware.resourceinstance.diagram.edit.policies.ProcessorInstanceItemSemanticEditPolicy;
...
public class ProcessorInstanceEditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ProcessorInstanceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProcessorInstanceNameEditPart) {
			((ProcessorInstanceNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel13EditPart) {
			((WrappingLabel13EditPart) childEditPart).setLabel(getPrimaryShape().getFigureResourceCardinalityFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel14EditPart) {
			((WrappingLabel14EditPart) childEditPart).setLabel(getPrimaryShape().getFigureResourceKindFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel15EditPart) {
			((WrappingLabel15EditPart) childEditPart).setLabel(getPrimaryShape().getFigureResourceInfo1());
			return true;
		}
		if (childEditPart instanceof WrappingLabel16EditPart) {
			((WrappingLabel16EditPart) childEditPart).setLabel(getPrimaryShape().getFigureResourceInfo2());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(HardwareVisualIDRegistry.getType(ProcessorInstanceNameEditPart.VISUAL_ID));
	}
	...
	*/
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (event.getFeature() == HwresourceinstancePackage.eINSTANCE.getProcessorInstance_OwnedCacheInstance()) {
			update = true;
		}
