...
public class StorageMemoryInstanceCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		StorageMemoryInstance newElement = HwresourceinstanceFactory.eINSTANCE.createStorageMemoryInstance();
		...
		ElementInitializers.getInstance().init_StorageMemoryInstance_3022(newElement);
	...
	* @generated
	*/
	protected void doConfigure(StorageMemoryInstance newElement, IProgressMonitor monitor, IAdaptable info)
