package org.muml.pm.hardware.resourceinstance.diagram.parsers;
 ...
 * @generated
 */
public class ProgrammableLogicDeviceInstanceLabelExpressionLabelParser5085 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ProgrammableLogicDeviceInstanceLabelExpressionLabelParser5085() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory
				.getExpression(11, HwresourceinstancePackage.eINSTANCE.getProgrammableLogicDeviceInstance(), null)
				.body();
	}
	...
	public String getEditString(IAdaptable element, int flags) {
		...
		Object result = HardwareOCLFactory
				.getExpression(12, HwresourceinstancePackage.eINSTANCE.getProgrammableLogicDeviceInstance(), null)
				.evaluate(target);
