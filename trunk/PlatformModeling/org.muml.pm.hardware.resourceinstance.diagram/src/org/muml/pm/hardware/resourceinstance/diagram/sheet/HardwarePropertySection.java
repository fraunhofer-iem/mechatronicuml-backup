	...
	protected AdapterFactory getAdapterFactory(Object object) {
		...
		if (editingDomain != null) {
			...
			List<AdapterFactory> positivePriorityFactories = FujabaCommonPlugin.getInstance()
					.getCustomItemProviderAdapterFactories(ResourceInstanceDiagramEditorPlugin.ID, true);
			List<AdapterFactory> negativePriorityFactories = FujabaCommonPlugin.getInstance()
					.getCustomItemProviderAdapterFactories(ResourceInstanceDiagramEditorPlugin.ID, false);
