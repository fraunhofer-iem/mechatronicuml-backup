 ...
 * @generated
 */
public class ProgrammableLogicDeviceInstanceLabelExpressionLabelParser5083 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ProgrammableLogicDeviceInstanceLabelExpressionLabelParser5083() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory
				.getExpression(9, HwresourceinstancePackage.eINSTANCE.getProgrammableLogicDeviceInstance(), null)
				.body();
	}
