 ...
 * @generated
 */
public class NetworkBridgeInstanceCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public NetworkBridgeInstanceCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		NetworkBridgeInstance newElement = HwplatforminstanceFactory.eINSTANCE.createNetworkBridgeInstance();
		...
		ElementInitializers.getInstance().init_NetworkBridgeInstance_3047(newElement);
	...
	* @generated
	*/
	protected void doConfigure(NetworkBridgeInstance newElement, IProgressMonitor monitor, IAdaptable info)
