...
import org.muml.pm.hardware.platforminstance.diagram.edit.policies.NetworkBridgeInstanceItemSemanticEditPolicy;
import org.muml.pm.hardware.platforminstance.diagram.part.HardwareVisualIDRegistry;

/**
 * @generated
 */
public class NetworkBridgeInstanceEditPart extends ShapeNodeEditPart {
	...
	*/
	 ...
	 * @generated
	 */
	public NetworkBridgeInstanceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new NetworkBridgeInstanceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel13EditPart) {
			((WrappingLabel13EditPart) childEditPart).setLabel(getPrimaryShape().getFigureBridgeCommentFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(HardwareVisualIDRegistry.getType(WrappingLabel13EditPart.VISUAL_ID));
	}
	...
	public class BridgeFigure extends ScalablePolygonShape {
		...
		public BridgeFigure() {
			...
			this.addPoint(new Point(getMapMode().DPtoLP(1), getMapMode().DPtoLP(2)));
			this.addPoint(new Point(getMapMode().DPtoLP(2), getMapMode().DPtoLP(1)));
		...
		private void createContents() {
			...
			this.add(fFigureBridgeCommentFigure, constraintFFigureBridgeCommentFigure);
