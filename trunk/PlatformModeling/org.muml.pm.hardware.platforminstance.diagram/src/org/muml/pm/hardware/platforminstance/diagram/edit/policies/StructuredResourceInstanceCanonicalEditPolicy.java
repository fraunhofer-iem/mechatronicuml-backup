...
public class StructuredResourceInstanceCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { HWPortInstanceEditPart.VISUAL_ID });
		...
		return HardwareDiagramUpdater.getStructuredResourceInstance_3042SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return HWPortInstanceEditPart.VISUAL_ID == HardwareVisualIDRegistry.getVisualID(view);
	}
