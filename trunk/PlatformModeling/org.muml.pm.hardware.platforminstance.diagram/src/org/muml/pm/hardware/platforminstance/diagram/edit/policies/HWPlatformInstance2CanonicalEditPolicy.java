...
public class HWPlatformInstance2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return HwplatforminstancePackage.eINSTANCE.getHWPlatformInstance_DelegationPorts();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { DelegationHWPortInstanceEditPart.VISUAL_ID });
		...
		return HardwareDiagramUpdater.getHWPlatformInstance_3040SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return DelegationHWPortInstanceEditPart.VISUAL_ID == HardwareVisualIDRegistry.getVisualID(view);
	}
