...
import org.muml.pm.hardware.platforminstance.diagram.providers.HardwareMarkerNavigationProvider;
import org.muml.pm.hardware.platforminstance.diagram.providers.HardwareValidationProvider;
	...
	public void run() {
		...
		if (workbenchPart instanceof IDiagramWorkbenchPart) {
			...
			try {
				...
				PlatformInstanceDiagramEditorPlugin.getInstance().logError("Validation action failed", e); //$NON-NLS-1$
			}
		}
	}
