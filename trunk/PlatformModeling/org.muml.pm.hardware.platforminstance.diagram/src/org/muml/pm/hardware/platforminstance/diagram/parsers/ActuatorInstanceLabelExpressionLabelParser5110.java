 ...
 * @generated
 */
public class ActuatorInstanceLabelExpressionLabelParser5110 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ActuatorInstanceLabelExpressionLabelParser5110() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory.getExpression(7, HwresourceinstancePackage.eINSTANCE.getActuatorInstance(), null)
				.body();
	}
