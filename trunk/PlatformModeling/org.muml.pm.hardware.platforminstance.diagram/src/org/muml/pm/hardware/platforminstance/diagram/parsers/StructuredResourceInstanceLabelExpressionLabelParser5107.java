 ...
 * @generated
 */
public class StructuredResourceInstanceLabelExpressionLabelParser5107 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public StructuredResourceInstanceLabelExpressionLabelParser5107() {
	...
	protected String getExpressionBody() {
		return HardwareOCLFactory
				.getExpression(5, HwresourceinstancePackage.eINSTANCE.getStructuredResourceInstance(), null).body();
	}
