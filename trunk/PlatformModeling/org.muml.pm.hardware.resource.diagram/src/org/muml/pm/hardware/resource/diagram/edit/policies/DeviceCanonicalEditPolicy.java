...
public class DeviceCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return HwresourcePackage.eINSTANCE.getResource_CommunicationResources();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { CommunicationResourceEditPart.VISUAL_ID });
		...
		return HardwareDiagramUpdater.getDevice_2006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return CommunicationResourceEditPart.VISUAL_ID == HardwareVisualIDRegistry.getVisualID(view);
	}
