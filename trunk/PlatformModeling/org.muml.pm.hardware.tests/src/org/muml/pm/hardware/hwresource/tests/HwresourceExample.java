...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>hwresource</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class HwresourceExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(HwresourcePackage.eNS_URI, 
			 HwresourcePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.hwresource"));
				MemoryResource root = HwresourceFactory.eINSTANCE.createMemoryResource();
