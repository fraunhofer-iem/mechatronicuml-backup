...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>hwvaluetype</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class HwvaluetypeExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(HwvaluetypePackage.eNS_URI, 
			 HwvaluetypePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.hwvaluetype"));
				DataSize root = HwvaluetypeFactory.eINSTANCE.createDataSize();
