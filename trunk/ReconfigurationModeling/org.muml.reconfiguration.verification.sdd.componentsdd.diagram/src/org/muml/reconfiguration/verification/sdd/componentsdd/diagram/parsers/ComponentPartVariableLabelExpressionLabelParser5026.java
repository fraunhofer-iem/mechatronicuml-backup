 ...
 * @generated
 */
public class ComponentPartVariableLabelExpressionLabelParser5026 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ComponentPartVariableLabelExpressionLabelParser5026() {
	...
	protected String getExpressionBody() {
		return ComponentSDDOCLFactory
				.getExpression(9, ComponentstorypatternPackage.eINSTANCE.getComponentPartVariable(), null).body();
	}
