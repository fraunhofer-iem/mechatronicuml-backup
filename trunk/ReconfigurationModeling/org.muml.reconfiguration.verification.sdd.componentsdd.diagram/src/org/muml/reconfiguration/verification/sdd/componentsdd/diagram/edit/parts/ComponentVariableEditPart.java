...
import org.muml.reconfiguration.verification.sdd.componentsdd.diagram.edit.policies.ComponentVariableCanonicalEditPolicy;
	...
	*/
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabelEditPart) {
			((WrappingLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureComponentVariableNameFigure());
			return true;
		}
