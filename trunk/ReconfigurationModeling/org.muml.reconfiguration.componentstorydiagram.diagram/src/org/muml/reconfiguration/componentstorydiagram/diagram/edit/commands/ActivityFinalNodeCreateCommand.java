...
public class ActivityFinalNodeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		ActivityFinalNode newElement = ActivitiesFactory.eINSTANCE.createActivityFinalNode();

		Activity owner = (Activity) getElementToEdit();
		owner.getOwnedActivityNodes().add(newElement);

		ElementInitializers.getInstance().init_ActivityFinalNode_3010(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ActivityFinalNode newElement, IProgressMonitor monitor, IAdaptable info)
