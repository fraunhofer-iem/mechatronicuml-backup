...
import org.muml.reconfiguration.componentstorydiagram.diagram.edit.policies.ComponentStoryPattern2ItemSemanticEditPolicy;
...
public class ComponentStoryPattern2EditPart extends ShapeNodeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComponentStoryPattern2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComponentStoryPatternComponentStoryPatternCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureComponentStoryPatternContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ComponentStoryPatternComponentStoryPatternCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComponentStoryPatternComponentStoryPatternCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureComponentStoryPatternContainer();
			pane.remove(((ComponentStoryPatternComponentStoryPatternCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ComponentStoryPatternComponentStoryPatternCompartment2EditPart) {
