 ...
 * @generated
 */
public class ActivityActivityCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { ComponentStoryNodeEditPart.VISUAL_ID,
						InitialNodeEditPart.VISUAL_ID, JunctionNodeEditPart.VISUAL_ID,
						ActivityFinalNodeEditPart.VISUAL_ID, ControllerExchangeNodeEditPart.VISUAL_ID });
		...
		return ComponentStoryDiagramDiagramUpdater.getActivityActivityCompartment_7001SemanticChildren(viewObject);
