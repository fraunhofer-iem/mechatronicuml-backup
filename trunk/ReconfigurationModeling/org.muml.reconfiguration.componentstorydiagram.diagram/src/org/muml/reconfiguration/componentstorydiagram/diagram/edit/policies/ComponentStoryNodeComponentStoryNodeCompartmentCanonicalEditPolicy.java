 ...
 * @generated
 */
public class ComponentStoryNodeComponentStoryNodeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public ComponentStoryNodeComponentStoryNodeCompartmentCanonicalEditPolicy() {
	}

	public ComponentStoryNodeComponentStoryNodeCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	*/
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentstorydiagramPackage.eINSTANCE.getComponentStoryNode_ComponentStoryPattern();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return ComponentStoryPatternEditPart.VISUAL_ID == ComponentStoryDiagramVisualIDRegistry.getVisualID(view);
	}
