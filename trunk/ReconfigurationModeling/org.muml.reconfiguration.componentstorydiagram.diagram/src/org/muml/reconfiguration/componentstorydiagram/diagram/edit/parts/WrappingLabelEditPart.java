 ...
 * @generated
 */
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				ComponentStoryDiagramVisualIDRegistry.getType(
						org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentStoryDiagramParserProvider.getParser(
					ComponentStoryDiagramElementTypes.ComponentPartVariable_3014, getParserElement(),
					ComponentStoryDiagramVisualIDRegistry.getType(
							org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
