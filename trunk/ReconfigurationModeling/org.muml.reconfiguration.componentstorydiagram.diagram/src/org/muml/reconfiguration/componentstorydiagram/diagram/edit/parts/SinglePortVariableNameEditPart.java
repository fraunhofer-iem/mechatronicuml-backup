 ...
 * @generated
 */
public class SinglePortVariableNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				ComponentStoryDiagramVisualIDRegistry.getType(
						org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.SinglePortVariableNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentStoryDiagramParserProvider.getParser(
					ComponentStoryDiagramElementTypes.SinglePortVariable_3018, getParserElement(),
					ComponentStoryDiagramVisualIDRegistry.getType(
							org.muml.reconfiguration.componentstorydiagram.diagram.edit.parts.SinglePortVariableNameEditPart.VISUAL_ID));
		}
		return parser;
