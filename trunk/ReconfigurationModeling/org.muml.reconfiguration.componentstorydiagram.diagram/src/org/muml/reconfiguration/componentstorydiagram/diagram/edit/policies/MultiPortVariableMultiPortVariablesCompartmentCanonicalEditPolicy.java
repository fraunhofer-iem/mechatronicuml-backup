 ...
 * @generated
 */
public class MultiPortVariableMultiPortVariablesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public MultiPortVariableMultiPortVariablesCompartmentCanonicalEditPolicy() {
	}

	public MultiPortVariableMultiPortVariablesCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	*/
	...
	private boolean isMyDiagramElement(View view) {
		return SinglePortVariableEditPart.VISUAL_ID == ComponentStoryDiagramVisualIDRegistry.getVisualID(view);
	}
