 ...
 * @generated
 */
public class SinglePortVariableLabelExpressionLabelParser5059 extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public SinglePortVariableLabelExpressionLabelParser5059() {
	...
	protected String getExpressionBody() {
		return ComponentStoryDiagramOCLFactory
				.getExpression(9, ComponentstorypatternPackage.eINSTANCE.getSinglePortVariable(), null).body();
	}
