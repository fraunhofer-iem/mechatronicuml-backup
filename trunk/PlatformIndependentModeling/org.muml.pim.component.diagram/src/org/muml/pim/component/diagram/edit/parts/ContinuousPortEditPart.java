...
import org.muml.pim.component.diagram.edit.policies.ContinuousPortItemSemanticEditPolicy;
...
public class ContinuousPortEditPart extends BorderedBorderItemEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ContinuousPortItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ContinuousPortNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(ContinuousPortNameEditPart.VISUAL_ID));
	}
