...
import org.muml.pim.component.diagram.edit.policies.ComponentPartCanonicalEditPolicy;
import org.muml.pim.component.diagram.edit.policies.ComponentPartItemSemanticEditPolicy;
...
public class ComponentPartEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ComponentPartItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ComponentPartCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel3EditPart) {
			((WrappingLabel3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureComponentNameFigure());
			return true;
		}
		if (childEditPart instanceof PortPartEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.SOUTH);
			getBorderedFigure().getBorderItemContainer().add(((PortPartEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PortPartEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(((PortPartEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
