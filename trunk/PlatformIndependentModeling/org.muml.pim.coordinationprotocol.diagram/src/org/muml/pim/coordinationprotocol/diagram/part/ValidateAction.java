...
import org.muml.pim.coordinationprotocol.diagram.providers.MumlMarkerNavigationProvider;
import org.muml.pim.coordinationprotocol.diagram.providers.MumlValidationProvider;
	...
	public void run() {
		...
		if (workbenchPart instanceof IDiagramWorkbenchPart) {
			...
			try {
				...
				MumlDiagramEditorPlugin.getInstance().logError("Validation action failed", e); //$NON-NLS-1$
			}
		}
	}
