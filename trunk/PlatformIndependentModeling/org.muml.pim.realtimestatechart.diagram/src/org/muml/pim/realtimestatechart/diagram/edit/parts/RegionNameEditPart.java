 ...
 * @generated
 */
public class RegionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MumlParserProvider.getParser(MumlElementTypes.Region_3042, getParserElement(), MumlVisualIDRegistry
					.getType(org.muml.pim.realtimestatechart.diagram.edit.parts.RegionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
