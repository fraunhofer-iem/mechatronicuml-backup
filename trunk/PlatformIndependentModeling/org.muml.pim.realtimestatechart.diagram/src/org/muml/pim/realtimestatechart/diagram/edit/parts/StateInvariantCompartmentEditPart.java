...
import org.muml.pim.realtimestatechart.diagram.edit.policies.StateInvariantCompartmentCanonicalEditPolicy;
import org.muml.pim.realtimestatechart.diagram.edit.policies.StateInvariantCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StateInvariantCompartmentEditPart extends ListCompartmentEditPart {
	 ...
	 * @generated
	 */
	public StateInvariantCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.StateInvariantCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StateInvariantCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(MumlVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StateInvariantCompartmentCanonicalEditPolicy());
	}
