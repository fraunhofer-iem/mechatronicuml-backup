...
import org.muml.pim.realtimestatechart.diagram.edit.policies.StateRegionCompartmentCanonicalEditPolicy;
import org.muml.pim.realtimestatechart.diagram.edit.policies.StateRegionCompartmentItemSemanticEditPolicy;
...
public class StateRegionCompartmentEditPart extends ListCompartmentEditPart {
	...
	public String getCompartmentName() {
		return Messages.StateRegionCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StateRegionCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(MumlVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StateRegionCompartmentCanonicalEditPolicy());
	}
