...
public class StateChannelCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RealtimestatechartPackage.eINSTANCE.getState_Channels();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { SynchronizationChannelEditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getStateChannelCompartment_7033SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SynchronizationChannelEditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
