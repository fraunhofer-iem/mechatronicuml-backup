...
import org.muml.pim.pattern.diagram.edit.commands.DiscreteInteractionEndpointReceiverMessageBufferCreateCommand;
import org.muml.pim.pattern.diagram.edit.commands.DiscreteInteractionEndpointReceiverMessageBufferReorientCommand;
import org.muml.pim.pattern.diagram.edit.commands.RoleConnectorCreateCommand;
import org.muml.pim.pattern.diagram.edit.commands.RoleConnectorReorientCommand;
...
public class RoleItemSemanticEditPolicy extends MumlBaseItemSemanticEditPolicy {
	...
	*/
	public RoleItemSemanticEditPolicy() {
		super(MumlElementTypes.Role_3002);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (MumlElementTypes.RoleConnector_4001 == req.getElementType()) {
			return getGEFWrapper(new RoleConnectorCreateCommand(req, req.getSource(), req.getTarget()));
		}
		if (MumlElementTypes.DiscreteInteractionEndpointReceiverMessageBuffer_4003 == req.getElementType()) {
