 ...
 * @generated
 */
public class OperationRepositoryLabelExpressionLabelParser extends
		ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public OperationRepositoryLabelExpressionLabelParser() {
	}
		...
		return org.muml.pim.operationrepository.diagram.expressions.MumlOCLFactory
				.getExpression(
						...
						org.muml.pim.behavior.BehaviorPackage.eINSTANCE
								.getOperationRepository(), null).body();
	}
