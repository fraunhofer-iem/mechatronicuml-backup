	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof org.muml.pim.operationrepository.diagram.navigator.MumlNavigatorItem
						&& (adapterType == View.class || adapterType == EObject.class)) {
					return ((org.muml.pim.operationrepository.diagram.navigator.MumlNavigatorItem) adaptableObject)
							.getView();
				}
				return null;
			}
		...
		}, org.muml.pim.operationrepository.diagram.navigator.MumlNavigatorItem.class);
	}
