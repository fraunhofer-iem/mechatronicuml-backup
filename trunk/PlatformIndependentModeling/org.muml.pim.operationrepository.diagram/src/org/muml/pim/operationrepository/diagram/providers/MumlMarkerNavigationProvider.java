...
import org.muml.pim.operationrepository.diagram.part.MumlDiagramEditorUtil;
...
public class MumlMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
	 ...
	 * @generated
	 */
	public static final String MARKER_TYPE = OperationRepositoryDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	public static void deleteMarkers(IResource resource) {
		try {
			...
			OperationRepositoryDiagramEditorPlugin.getInstance().logError("Failed to delete validation markers", e); //$NON-NLS-1$
		}
	}
	...
	public static IMarker addMarker(IFile file, String elementId, String location, String message, int statusSeverity) {
		...
		try {
			...
			OperationRepositoryDiagramEditorPlugin.getInstance().logError("Failed to create validation marker", e); //$NON-NLS-1$
		}
		return marker;
	}
}
