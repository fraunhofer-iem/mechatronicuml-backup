...
public class MumlNewDiagramFileWizard extends Wizard {
	...
	public MumlNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		...
		myFileCreationPage.setFileName(
				MumlDiagramEditorUtil.getUniqueFileName(filePath, fileName, "operationrepository_diagram")); //$NON-NLS-1$
	...
	public boolean performFinish() {
		...
		try {
			...
			OperationRepositoryDiagramEditorPlugin.getInstance().logError("Unable to open editor", ex); //$NON-NLS-1$
		}
		return true;
	}
