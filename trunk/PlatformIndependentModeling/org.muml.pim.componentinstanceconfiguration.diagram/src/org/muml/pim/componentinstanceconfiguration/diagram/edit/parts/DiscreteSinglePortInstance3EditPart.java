...
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.DiscreteSinglePortInstance3ItemSemanticEditPolicy;
...
public class DiscreteSinglePortInstance3EditPart extends BorderedBorderItemEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DiscreteSinglePortInstance3ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DiscreteSinglePortInstanceName3EditPart
				|| borderItemEditPart instanceof WrappingLabel8EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(DiscreteSinglePortInstanceName3EditPart.VISUAL_ID));
	}
