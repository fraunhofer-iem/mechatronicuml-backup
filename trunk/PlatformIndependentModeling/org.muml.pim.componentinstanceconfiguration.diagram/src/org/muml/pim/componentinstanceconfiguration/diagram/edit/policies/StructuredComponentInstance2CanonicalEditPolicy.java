...
public class StructuredComponentInstance2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return InstancePackage.eINSTANCE.getComponentInstance_PortInstances();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { HybridPortInstance2EditPart.VISUAL_ID,
						DiscreteSinglePortInstance3EditPart.VISUAL_ID, DiscreteMultiPortInstance2EditPart.VISUAL_ID,
						ContinuousPortInstance2EditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getStructuredComponentInstance_3025SemanticChildren(viewObject);
