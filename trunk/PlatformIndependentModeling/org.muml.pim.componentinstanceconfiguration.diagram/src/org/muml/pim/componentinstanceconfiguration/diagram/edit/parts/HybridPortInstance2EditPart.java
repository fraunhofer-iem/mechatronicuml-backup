...
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.HybridPortInstance2ItemSemanticEditPolicy;
...
public class HybridPortInstance2EditPart extends BorderedBorderItemEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HybridPortInstance2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof HybridPortInstanceName2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(HybridPortInstanceName2EditPart.VISUAL_ID));
	}
