...
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.ContinuousPortInstance2ItemSemanticEditPolicy;
...
public class ContinuousPortInstance2EditPart extends BorderedBorderItemEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ContinuousPortInstance2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ContinuousPortInstanceName2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MumlVisualIDRegistry.getType(ContinuousPortInstanceName2EditPart.VISUAL_ID));
	}
