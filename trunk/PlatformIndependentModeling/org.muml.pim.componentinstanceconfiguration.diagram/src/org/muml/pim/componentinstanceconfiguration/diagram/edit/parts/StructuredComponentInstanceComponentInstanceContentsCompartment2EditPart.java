...
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.StructuredComponentInstanceComponentInstanceContentsCompartment2CanonicalEditPolicy;
import org.muml.pim.componentinstanceconfiguration.diagram.edit.policies.StructuredComponentInstanceComponentInstanceContentsCompartment2ItemSemanticEditPolicy;
...
public class StructuredComponentInstanceComponentInstanceContentsCompartment2EditPart extends ListCompartmentEditPart {
	...
	public String getCompartmentName() {
		return Messages.StructuredComponentInstanceComponentInstanceContentsCompartment2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StructuredComponentInstanceComponentInstanceContentsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(MumlVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new StructuredComponentInstanceComponentInstanceContentsCompartment2CanonicalEditPolicy());
	}
