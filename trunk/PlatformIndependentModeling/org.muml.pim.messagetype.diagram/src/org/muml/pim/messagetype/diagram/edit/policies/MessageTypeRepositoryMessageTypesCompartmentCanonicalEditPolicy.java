...
import org.muml.pim.messagetype.diagram.part.MumlDiagramUpdater;
import org.muml.pim.messagetype.diagram.part.MumlNodeDescriptor;
...
public class MessageTypeRepositoryMessageTypesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return MsgtypePackage.eINSTANCE.getMessageTypeRepository_MessageTypes();
	}
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { MessageTypeEditPart.VISUAL_ID });
		...
		return MumlDiagramUpdater.getMessageTypeRepositoryMessageTypesCompartment_7010SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MessageTypeEditPart.VISUAL_ID == MumlVisualIDRegistry.getVisualID(view);
	}
