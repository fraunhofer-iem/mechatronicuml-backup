...
import org.muml.pim.messagetype.diagram.edit.policies.ParameterItemSemanticEditPolicy;
	...
	*/
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabelEditPart) {
			((WrappingLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureParameterLabel());
			return true;
		}
		return false;
	}
