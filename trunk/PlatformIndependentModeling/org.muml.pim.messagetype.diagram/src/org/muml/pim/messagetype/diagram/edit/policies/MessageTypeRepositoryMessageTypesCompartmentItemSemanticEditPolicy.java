...
import org.muml.pim.messagetype.diagram.edit.commands.MessageTypeCreateCommand;
import org.muml.pim.messagetype.diagram.providers.MumlElementTypes;

/**
 * @generated
 */
public class MessageTypeRepositoryMessageTypesCompartmentItemSemanticEditPolicy extends MumlBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (MumlElementTypes.MessageType_3007 == req.getElementType()) {
