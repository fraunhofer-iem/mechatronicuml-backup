...
model Complex_rearBehavior_init extends Modelica_StateGraph2.PartialParallel(nEntry=1);
	// no annotations will be generated for complex states
	// region declarations
	RearMessagePort1.RearMessagePort1 region_1_rearMessagePort1(nIn=1, use_outPort=false)
	...
	equation
		...
		connect(entry[1],
				region_1_rearMessagePort1.inPort[1])
