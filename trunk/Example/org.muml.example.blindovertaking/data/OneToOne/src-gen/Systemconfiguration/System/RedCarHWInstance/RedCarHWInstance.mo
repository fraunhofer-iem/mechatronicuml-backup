	within Systemconfiguration.System.RedCarHWInstance;
model RedCarHWInstance
...
equation
  ...
  connect(omegaL_desPort, dCMotorCtrl_V4L.DesSp)
                                             annotation (Line(
      points={{17.5,10},{-10,10},{-10,0},{-38,0}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(dCMotorCtrl_V4R.DesSp, omegaR_desPort)
                                             annotation (Line(
      points={{38,-9.79717e-016},{82,-9.79717e-016},{82,10},{17.5,10}},
      color={0,0,127},
      smooth=Smooth.None));
