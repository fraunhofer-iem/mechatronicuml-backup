...
model Complex_rearMessagePort1_noOvertaking extends Modelica_StateGraph2.PartialParallel(nEntry=1);
	// no annotations will be generated for complex states
	// region declarations
	Rear_noOvertaking.Rear_noOvertaking region_1_rear_noOvertaking(nIn=1, use_outPort=false)
	...
	equation
		...
		connect(entry[1],
				region_1_rear_noOvertaking.inPort[1])
