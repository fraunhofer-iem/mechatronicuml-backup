...
model Complex_frontMessagePort1_noAcceleration extends Modelica_StateGraph2.PartialParallel(nEntry=1);
	// no annotations will be generated for complex states
	// region declarations
	Front_noAcceleration.Front_noAcceleration region_1_front_noAcceleration(nIn=1, use_outPort=false)
	...
	equation
		...
		connect(entry[1],
				region_1_front_noAcceleration.inPort[1])
