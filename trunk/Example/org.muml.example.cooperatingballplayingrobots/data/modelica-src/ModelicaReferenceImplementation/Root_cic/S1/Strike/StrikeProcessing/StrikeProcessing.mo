within Root_cic.S1.Strike.StrikeProcessing;
model StrikeProcessing
  ...
  RealTimeCoordinationLibrary.RealTimeCoordination.MessageInterface.InputDelegationPort
   ...
   annotation(Placement(transformation(extent={{-16,10},{-6,14}})));
...
algorithm
   ...
   when pre(Init.region_1_BAT_Info1.transition_Receiving_1_Receiving.fire) then
    posX := pre(Init.region_1_BAT_Info1.mailbox_transferBATInfo_posX);
    posY := pre(Init.region_1_BAT_Info1.mailbox_transferBATInfo_posY);
    posZ := pre(Init.region_1_BAT_Info1.mailbox_transferBATInfo_posZ);
    timeOfArrival := pre(Init.region_1_BAT_Info1.mailbox_transferBATInfo_timeOfArrival);
    velocity := pre(Init.region_1_BAT_Info1.mailbox_transferBATInfo_velocity);
