	within Root_cic.A1.SimpleStatechart.Complex_simpleStatechart_init;
model Complex_simpleStatechart_init extends Modelica_StateGraph2.PartialParallel(nEntry=1);
