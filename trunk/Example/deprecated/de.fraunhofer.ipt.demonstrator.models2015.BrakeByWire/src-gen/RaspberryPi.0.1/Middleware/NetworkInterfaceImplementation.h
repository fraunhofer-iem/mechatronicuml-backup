 ...
 * @details In this file Method-Stubs for the #NetworkInterface%s of the ECU raspberryPi01 are genereated,
...
/**
 * @brief INIT method for NetworkInterface: inputPort4 of ECU:raspberryPi01
...
/**
 * @brief SEND method for the NetworkInterface: inputPort4 of ECU:raspberryPi01
...
/**
 * @brief RECEIVE method for the NetworkInterface: inputPort4 of ECU:raspberryPi01
...
/**
 * @brief INIT method for NetworkInterface: VirtualWifiPort of ECU:raspberryPi01
...
/**
 * @brief SEND method for the NetworkInterface: VirtualWifiPort of ECU:raspberryPi01
...
/**
 * @brief RECEIVE method for the NetworkInterface: VirtualWifiPort of ECU:raspberryPi01
...
/**
 * @brief INIT method for NetworkInterface: virtualBluetoothPort of ECU:raspberryPi01
...
/**
 * @brief SEND method for the NetworkInterface: virtualBluetoothPort of ECU:raspberryPi01
...
/**
 * @brief RECEIVE method for the NetworkInterface: virtualBluetoothPort of ECU:raspberryPi01
...
/**
 * @brief INIT method for NetworkInterface: usbPort of ECU:raspberryPi01
...
/**
 * @brief SEND method for the NetworkInterface: usbPort of ECU:raspberryPi01
...
/**
 * @brief RECEIVE method for the NetworkInterface: usbPort of ECU:raspberryPi01
