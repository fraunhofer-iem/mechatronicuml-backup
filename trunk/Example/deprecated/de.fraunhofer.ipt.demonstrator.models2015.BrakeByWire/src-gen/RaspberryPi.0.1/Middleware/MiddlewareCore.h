...
/**
 * 
 * @brief Description of the Middleware for the ECU: raspberryPi01
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: raspberryPi01
 */
typedef struct Middleware {

//Create components?
	PickUpBotComponent* pickUpBotInstanceComponent; /**< The ComponentInstance: PickUpBotInstance of Type: PickUpBotComponent , which is allocated on the ECU: raspberryPi01 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: raspberryPi01  */
//Create Networkinterfaces
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: raspberryPi01 */
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: raspberryPi01 */
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: raspberryPi01 */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: raspberryPi01 */
...
ECUID idOfECU; /**< The ECUID of the ECU: raspberryPi01 on which the Middleware is executed */
