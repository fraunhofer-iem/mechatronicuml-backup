 ...
 * @details This function returns a Pointer to a Port for a given PortID, thus this Port must belong to a Component which is allocated on this ECU: brick101
 ...
 * @details This function returns the PortID of every Port, no matter if its allocated on this ECU: brick101 or on any other ECU
 * 
