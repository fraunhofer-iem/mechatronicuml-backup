...
void TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_clear(struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage) {
	_memset(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, 0, sizeof(struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage));
}

void TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_init_optional_attributes(struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage) {
	_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage->_touchPort_value = 0;
	
}

int TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_is_default_message(struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage) {
    return _TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage->_touchPort_value == 0
    ;
}

int TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_write(struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, void *_buffer, int offset) {
	/* Write content of each message element.*/
	/* Write the optional attribute only if it is different than the default value. */
	if(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage->_touchPort_value != 0) {
		offset = write_raw_varint32((1<<3)+0, _buffer, offset);
	    if (_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage->_touchPort_value >= 0)
	        offset = write_raw_varint32(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage->_touchPort_value, _buffer, offset);
	    else
	        offset = write_raw_varint64(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage->_touchPort_value, _buffer, offset);	    
	}
	
	return offset;
}

int TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_write_with_tag(struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, void *_buffer, int offset, int tag) {
	/* Write tag.*/
	offset = write_raw_varint32((tag<<3)+2, _buffer, offset);
	/* Write content.*/
	offset = TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_write_delimited_to(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, _buffer, offset);
	
	return offset;
}

int TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_write_delimited_to(struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, void *_buffer, int offset) {
	int i, shift, new_offset, size;
	
	new_offset = TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_write(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, _buffer, offset);
...
int TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_read(void *_buffer, struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, int offset, int limit) {
	unsigned int i = 0;
	unsigned long long value = i;
	unsigned long tag = value;
	
	/* Reset all attributes to 0 in advance. */
	TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_clear(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage);
	/* Assign the optional attributes. */
	TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_init_optional_attributes(_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage);
	...
	while(offset < limit) {
		...
		tag = tag>>3;
	    switch(tag){
	        /* tag of: _TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage._touchPort_value */
	        case 1 :
	        	offset = read_raw_varint32(&tag, _buffer, offset);
	        	_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage->_touchPort_value = (signed long)tag;
	        	break;
	    }
	}
...
int TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_read_delimited_from(void *_buffer, struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage *_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, int offset) {
	unsigned long size;
	
	offset = read_raw_varint32(&size, _buffer, offset);
	TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_read(_buffer, _TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage, offset, size + offset);
