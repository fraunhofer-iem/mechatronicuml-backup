...
/* Maximum size of a serialized TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage-message, useful for buffer allocation. */
#define MAX_TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage_SIZE 14

/* Structure that holds a deserialized TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage-message. */
struct TouchSensor_TouchPort_messageapi_messageType_RepositoryMessage {
    signed long _touchPort_value;
};
