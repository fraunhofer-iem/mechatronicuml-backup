	within Root_cic.Temp.RobotTemerature.DataProcessing.Complex_DataProcessing_init;
model Complex_DataProcessing_init extends Modelica_StateGraph2.PartialParallel(nEntry=1);
	// no annotations will be generated for complex states
	// region declarations
	Sender1.Sender1 region_1_sender1(nIn=1, use_outPort=false)
