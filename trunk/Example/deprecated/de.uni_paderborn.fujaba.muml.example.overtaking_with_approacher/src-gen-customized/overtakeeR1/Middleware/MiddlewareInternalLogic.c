...
ECUID MW_getTargetECU(PortID targetPort) {
	switch(targetPort){
		...
		return ECU_SECTIONCONTROLBRICK;
		break;
...
Port* MW_getPortforIdentifier(PortID portID){
    switch (portID) {
case PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERVELOCITYGETTERP1:
	return mw->overtakeeDriverComponent->velocityGetterPPort;
	break;
case PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERVELOCITYR:
	return mw->overtakeeDriverComponent->velocityRPort;
	break;
case PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERLINEOVERTAKEE:
	return mw->overtakeeDriverComponent->lineOvertakeePort;
	break;
case PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERVELOCITYL:
	return mw->overtakeeDriverComponent->velocityLPort;
	break;
case PORT_OVERTAKEEDRIVEROVERTAKEEDRIVERDISTANCEOVERTAKEE:
	return mw->overtakeeDriverComponent->distanceOvertakeePort;
	break;
case PORT_OVERTAKEEMOTORLMOTORVELOCITYCONTR:
	return mw->overtakeeMotorLComponent->velocityPort;
	break;
case PORT_OVERTAKEEMOTORRMOTORVELOCITYCONTL:
	return mw->overtakeeMotorRComponent->velocityPort;
	break;
case PORT_OVERTAKEELINELINELINELIGHT:
	return mw->overtakeeLineComponent->lineLightPort;
	break;
case PORT_OVERTAKEEDISTANCEDISTANCEDISTANCEOVERTAKEE:
	return mw->overtakeeDistanceComponent->distancePort;
	break;
        default:
            return NULL;
    }
