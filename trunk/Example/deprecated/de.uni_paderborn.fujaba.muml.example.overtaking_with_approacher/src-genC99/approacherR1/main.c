...
while (1){
		//execute component instance approacherMotorRComponent
		 MotorComponent_processStep(mw->approacherMotorRComponent);
		//execute component instance approacherMotorLComponent
		 MotorComponent_processStep(mw->approacherMotorLComponent);
		//execute component instance approacherDriverComponent
		 ApproacherDriverComponent_processStep(mw->approacherDriverComponent);
		//execute component instance approacherLineComponent
		 LineComponent_processStep(mw->approacherLineComponent);
		//execute component instance approacherDistanceComponent
