...
//ENUM
	...
	struct RootapproacherCommunicatorRTSCStateChart {	
			...
			RootapproacherCommunicatorRTSCState currentStateOfRootapproacherCommunicatorRTSC; /**< The current State of the Realtime-StateChart: RootapproacherCommunicatorRTSC */
				...
				int constSecID1; /**< The Realtime-StateChart Variable: constSecID1 of Type: INT */
				int constSecID2; /**< The Realtime-StateChart Variable: constSecID2 of Type: INT */
				int constSecID3; /**< The Realtime-StateChart Variable: constSecID3 of Type: INT */
				int constSecID4; /**< The Realtime-StateChart Variable: constSecID4 of Type: INT */
				int constSecID6; /**< The Realtime-StateChart Variable: constSecID6 of Type: INT */
				int constSecID5; /**< The Realtime-StateChart Variable: constSecID5 of Type: INT */
				int constSecID7; /**< The Realtime-StateChart Variable: constSecID7 of Type: INT */
