...
/**
 * 
 * @brief Description of the Middleware for the ECU: approacherR2
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: approacherR2
 */
typedef struct Middleware {

//Create components?
	ApproacherCommunicatorComponent* approacherCommunicatorComponent; /**< The ComponentInstance: approacherCommunicator of Type: ApproacherCommunicatorComponent , which is allocated on the ECU: approacherR2 */

	ColorComponent* approacherColorComponent; /**< The ComponentInstance: approacherColor of Type: ColorComponent , which is allocated on the ECU: approacherR2 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: approacherR2  */
//Create Networkinterfaces
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: approacherR2 */
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: approacherR2 */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: approacherR2 */
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: approacherR2 */
	NetworkInterface* VirtualWifiPort2; /**< Pointer the the NetworkInterface: VirtualWifiPort2 of the ECU: approacherR2 */
...
ECUID idOfECU; /**< The ECUID of the ECU: approacherR2 on which the Middleware is executed */
