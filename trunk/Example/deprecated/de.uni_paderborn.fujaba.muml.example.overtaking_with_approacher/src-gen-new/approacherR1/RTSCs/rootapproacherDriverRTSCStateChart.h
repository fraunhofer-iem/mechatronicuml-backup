...
//ENUM
	 ...
	 */
		typedef enum {
				...
				,
						ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S1_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S1_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_limiterPortRTSC_limiterPortRTSC */ 
				,		ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_limiterPortRTSC_limiterPortRTSC */
				,
						ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_STATECHART_STATECHART_FIXED_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_STATECHART_STATECHART_FIXED_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechart_statechart */ 
				,		ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_STATECHART_STATECHART_FREE_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_STATECHART_STATECHART_FREE_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechart_statechart */ 
				,		ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_approacherDrivingRTSC_approacherDrivingRTSC */
				,
						ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_STATECHART_STATECHART_FIXEDSLOW_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_STATECHART_STATECHART_FIXEDSLOW_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart_statechart */ 
				,		ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_STATECHART_STATECHART_BREAKNOW_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_STATECHART_STATECHART_BREAKNOW_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart_statechart */ 
				,		ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_STATECHART_STATECHART_DRIVE_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_STATECHART_STATECHART_DRIVE_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart_statechart */ 
				,		ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S1_STATE /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S1_STATE of the Realtime-StateChart: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_approacherDrivingRTSC_approacherDrivingRTSC */ 
	...
	struct RootapproacherDriverRTSCStateChart {	
			...
			RootapproacherDriverRTSCState currentStateOfRootapproacherDriverRTSC; /**< The current State of the Realtime-StateChart: RootapproacherDriverRTSC */
				...
				RootapproacherDriverRTSCState currentStateOfROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechart_statechart; /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechart of the Realtime-StateChart: RootapproacherDriverRTSC */
				...
				RootapproacherDriverRTSCState currentStateOfROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart_statechart; /**< Represents the State: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart of the Realtime-StateChart: RootapproacherDriverRTSC */
				...
				bool fixedSlowFlag; /**< The Realtime-StateChart Variable: fixedSlowFlag of Type: BOOLEAN */
				...
				SyncChannel* startASyncChannel; /**< The Realtime-StateChart's Synchronization Channel: startA */
				SyncChannel* stopASyncChannel; /**< The Realtime-StateChart's Synchronization Channel: stopA */
...
//METHOD STUBS
	...
	/**
	 * @brief Initializes the Region: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechart of the Realtime-StateChart: RootapproacherDriverRTSC
	 * @details The Member RootapproacherDriverRTSCStateChart::currentStateOfROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechart_statechart is initialized
	 * 
	 * @param stateChart The specific RootapproacherDriverRTSCStateChart whose Region shall be initialized
	 */
		void initializeROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechartRegion(RootapproacherDriverRTSCStateChart* stateChart);
	/**
	...
	/**
	 * @brief Initializes the Region: ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart of the Realtime-StateChart: RootapproacherDriverRTSC
	 * @details The Member RootapproacherDriverRTSCStateChart::currentStateOfROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart_statechart is initialized
	 * 
	 * @param stateChart The specific RootapproacherDriverRTSCStateChart whose Region shall be initialized
	 */
		void initializeROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechartRegion(RootapproacherDriverRTSCStateChart* stateChart);
	/**
	...
	/**
	 * @brief Leaves the Region: statechart of the Realtime-StateChart: RootapproacherDriverRTSC
	 * @details This method is called, whenever a the Region: statechart is left.
	 * 			The correct State is set and all Exit-Events are executed.
	 *
	 * @param rtsc The specific RootapproacherDriverRTSCStateChart whose Region: statechart shall be exit
	 */
		void ROOTAPPROACHERDRIVERRTSC_INIT_STATE_LIMITERPORTRTSC_LIMITERPORTRTSC_S2_STATE_statechart_statechartStateChart_exit(RootapproacherDriverRTSCStateChart* rtsc);
	/**
	 ...
	 * @param rtsc The specific RootapproacherDriverRTSCStateChart whose Region: statechart shall be exit
	 */
		void ROOTAPPROACHERDRIVERRTSC_INIT_STATE_APPROACHERDRIVINGRTSC_APPROACHERDRIVINGRTSC_S2_STATE_statechart_statechartStateChart_exit(RootapproacherDriverRTSCStateChart* rtsc);
	/**
