...
Port* MW_getPortforIdentifier(PortID portID){
    switch (portID) {
case PORT_SECTIONSECTIONCONTROLSECTIONAPPROACHERP1:
	return mw->sectionComponent->sectionApproacherPPort;
	break;
case PORT_SECTIONSECTIONCONTROLSECTIONOVERTAKERP1:
	return mw->sectionComponent->sectionOvertakerPPort;
	break;
case PORT_SECTIONSECTIONCONTROLSECTIONOVERTAKEEP1:
	return mw->sectionComponent->sectionOvertakeePPort;
	break;
case PORT_SECTIONSECTIONCONTROLCONTROLLERP1:
	return mw->sectionComponent->controllerPPort;
	break;
        default:
            return NULL;
    }
