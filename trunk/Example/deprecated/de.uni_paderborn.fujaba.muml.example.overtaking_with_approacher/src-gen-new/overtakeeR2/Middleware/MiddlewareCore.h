...
/**
 * 
 * @brief Description of the Middleware for the ECU: overtakeeR2
 * @details It contains the Components, which are allocated on a ECU, the NetworkInterfaces of the ECU: overtakeeR2
 */
typedef struct Middleware {

//Create components?
	OvertakeeCommunicatorComponent* overtakeeCommunicatorComponent; /**< The ComponentInstance: overtakeeCommunicator of Type: OvertakeeCommunicatorComponent , which is allocated on the ECU: overtakeeR2 */

	ColorComponent* overtakeeColorComponent; /**< The ComponentInstance: overtakeeColor of Type: ColorComponent , which is allocated on the ECU: overtakeeR2 */


//intern NetworkInterface	
NetworkInterface* intern;  /**< Pointer to the internal NetworkInterface of the ECU: overtakeeR2  */
//Create Networkinterfaces
	NetworkInterface* virtualBluetoothPort; /**< Pointer the the NetworkInterface: virtualBluetoothPort of the ECU: overtakeeR2 */
	NetworkInterface* usbPort; /**< Pointer the the NetworkInterface: usbPort of the ECU: overtakeeR2 */
	NetworkInterface* inputPort4; /**< Pointer the the NetworkInterface: inputPort4 of the ECU: overtakeeR2 */
	NetworkInterface* VirtualWifiPort; /**< Pointer the the NetworkInterface: VirtualWifiPort of the ECU: overtakeeR2 */
	NetworkInterface* VirtualWifiPort2; /**< Pointer the the NetworkInterface: VirtualWifiPort2 of the ECU: overtakeeR2 */
...
ECUID idOfECU; /**< The ECUID of the ECU: overtakeeR2 on which the Middleware is executed */
