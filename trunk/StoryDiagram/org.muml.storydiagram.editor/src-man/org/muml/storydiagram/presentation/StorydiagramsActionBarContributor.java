...
public class StorydiagramsActionBarContributor extends EditingDomainActionBarContributor implements
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(StorydiagramsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(StorydiagramsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
