...
/**
 * This is the item provider adapter for a {@link org.muml.storydiagram.interpreter.core.executiontrace.StoryPatternObjectBindingRevoked} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class StoryPatternObjectBindingRevokedItemProvider extends StoryPatternObjectExecutionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StoryPatternObjectBindingRevoked_previousValue_feature", "_UI_StoryPatternObjectBindingRevoked_type"),
				 ExecutiontracePackage.Literals.STORY_PATTERN_OBJECT_BINDING_REVOKED__PREVIOUS_VALUE,
				 true,
				 false,
				 false,
		...
		if (storyPatternObjectBindingRevoked.getStoryPatternObject() != null) {
			if (storyPatternObjectBindingRevoked.getStoryPatternObject() instanceof EObject) {
				label += " " + ((IItemLabelProvider) factory
						.adapt(storyPatternObjectBindingRevoked.getStoryPatternObject(), IItemLabelProvider.class))
								.getText(storyPatternObjectBindingRevoked.getStoryPatternObject());
			} else {
