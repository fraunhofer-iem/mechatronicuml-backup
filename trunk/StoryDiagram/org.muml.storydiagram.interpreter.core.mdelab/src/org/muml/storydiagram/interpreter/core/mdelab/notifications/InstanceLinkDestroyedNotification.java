...
/**
 * An instance link was destroyed.
 * 
 ...
 * @param <Classifier>
 */
public class InstanceLinkDestroyedNotification<StoryPatternObject, StoryPatternLink, Classifier> extends
		InterpreterNotification<Classifier>
{
	...
	public InstanceLinkDestroyedNotification(
