 ...
 * @generated
 */
public class StoryPatternStoryPatternConstraintsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public StoryPatternStoryPatternConstraintsCompartmentCanonicalEditPolicy() {
	}

	public StoryPatternStoryPatternConstraintsCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	*/
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(new Integer[] { Constraint2EditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return Constraint2EditPart.VISUAL_ID == BasicSDDVisualIDRegistry.getVisualID(view);
	}
