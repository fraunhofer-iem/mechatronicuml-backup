...
import org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.policies.AttributeAssignmentItemSemanticEditPolicy;
...
public class AttributeAssignmentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new BasicSDDTextNonResizableEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BasicSDDParserProvider.getParser(BasicSDDElementTypes.AttributeAssignment_3007, getParserElement(),
					BasicSDDVisualIDRegistry.getType(
							org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.AttributeAssignmentEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, BasicSDDEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
