 ...
 * @generated
 */
public class StoryPatternStoryPatternContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public StoryPatternStoryPatternContentCompartmentCanonicalEditPolicy() {
	}

	public StoryPatternStoryPatternContentCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
	...
	*/
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays.asList(
						new Integer[] { CollectionVariableEditPart.VISUAL_ID, ObjectVariableEditPart.VISUAL_ID });
		...
		return BasicSDDDiagramUpdater.getStoryPatternStoryPatternContentCompartment_7013SemanticChildren(viewObject);
