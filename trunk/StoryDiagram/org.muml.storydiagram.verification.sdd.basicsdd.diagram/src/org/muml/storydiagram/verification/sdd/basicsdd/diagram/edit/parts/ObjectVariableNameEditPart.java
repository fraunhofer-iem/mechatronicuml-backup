 ...
 * @generated
 */
public class ObjectVariableNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ObjectVariableNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BasicSDDParserProvider.getParser(BasicSDDElementTypes.ObjectVariable_3009, getParserElement(),
					BasicSDDVisualIDRegistry.getType(
							org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.ObjectVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
