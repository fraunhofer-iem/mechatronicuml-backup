...
import org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.policies.StoryPatternStoryPatternConstraintsCompartmentCanonicalEditPolicy;
import org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.policies.StoryPatternStoryPatternConstraintsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StoryPatternStoryPatternConstraintsCompartmentEditPart extends ListCompartmentEditPart {
	...
	public String getCompartmentName() {
		return Messages.StoryPatternStoryPatternConstraintsCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StoryPatternStoryPatternConstraintsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(BasicSDDVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new StoryPatternStoryPatternConstraintsCompartmentCanonicalEditPolicy());
	}
