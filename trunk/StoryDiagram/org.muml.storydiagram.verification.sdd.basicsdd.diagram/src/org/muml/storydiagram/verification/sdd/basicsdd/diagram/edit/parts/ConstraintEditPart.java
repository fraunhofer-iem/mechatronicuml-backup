...
public class ConstraintEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BasicSDDParserProvider.getParser(BasicSDDElementTypes.Constraint_3008, getParserElement(),
					BasicSDDVisualIDRegistry.getType(
							org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.ConstraintEditPart.VISUAL_ID));
		}
		return parser;
	}
