 ...
 * @generated
 */
public class CollectionVariableTypeLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CollectionVariableTypeLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.CollectionVariable_3002,
					getParserElement(), StorydiagramsVisualIDRegistry.getType(
							org.muml.storydiagram.diagram.edit.parts.CollectionVariableTypeLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
