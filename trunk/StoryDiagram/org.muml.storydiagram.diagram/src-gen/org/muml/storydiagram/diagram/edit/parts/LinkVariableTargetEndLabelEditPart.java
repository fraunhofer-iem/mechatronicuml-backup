 ...
 * @generated
 */
public class LinkVariableTargetEndLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StorydiagramsVisualIDRegistry
						.getType(org.muml.storydiagram.diagram.edit.parts.LinkVariableTargetEndLabelEditPart.VISUAL_ID),
				new Point(10, 10));
	}
	 ...
	 * @generated
	 */
	public LinkVariableTargetEndLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.LinkVariable_4002,
					getParserElement(), StorydiagramsVisualIDRegistry.getType(
							org.muml.storydiagram.diagram.edit.parts.LinkVariableTargetEndLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
