...
import org.muml.storydiagram.diagram.edit.policies.AttributeAssignmentItemSemanticEditPolicy;
import org.muml.storydiagram.diagram.edit.policies.StorydiagramsTextNonResizableEditPolicy;
import org.muml.storydiagram.diagram.edit.policies.StorydiagramsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AttributeAssignmentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AttributeAssignmentEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AttributeAssignmentItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.AttributeAssignment_3003,
					getParserElement(), StorydiagramsVisualIDRegistry
							.getType(org.muml.storydiagram.diagram.edit.parts.AttributeAssignmentEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, StorydiagramsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
