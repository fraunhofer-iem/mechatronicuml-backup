...
import org.muml.storydiagram.diagram.edit.policies.MatchingStoryNodeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MatchingStoryNodeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MatchingStoryNodeEditPart(View view) {
		super(view);
	}
	...
	public class StoryNodeFigureDescriptor extends RoundedRectangle {
		...
		private void createContents() {
			...
			storyNodeShadeContainerRectangle0.setBorder(new MarginBorder(getMapMode().DPtoLP(10),
			...
			storyNodeContentContainerRectangle0.setBorder(new MarginBorder(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0), getMapMode().DPtoLP(10), getMapMode().DPtoLP(10)));
