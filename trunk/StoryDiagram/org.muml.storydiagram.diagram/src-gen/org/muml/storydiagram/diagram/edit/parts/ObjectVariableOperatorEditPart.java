 ...
 * @generated
 */
public class ObjectVariableOperatorEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ObjectVariableOperatorEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.ObjectVariable_3005,
					getParserElement(), StorydiagramsVisualIDRegistry.getType(
							org.muml.storydiagram.diagram.edit.parts.ObjectVariableOperatorEditPart.VISUAL_ID));
		}
		return parser;
	}
