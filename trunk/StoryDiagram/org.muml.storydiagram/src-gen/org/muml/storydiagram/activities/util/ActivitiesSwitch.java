	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ActivitiesPackage.INITIAL_NODE: {
				...
				if (result == null) result = caseCommentableElement(initialNode);
				if (result == null) result = caseExtendableElement(initialNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ActivitiesPackage.ACTIVITY_FINAL_NODE: {
				...
				if (result == null) result = caseCommentableElement(activityFinalNode);
				if (result == null) result = caseExtendableElement(activityFinalNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ActivitiesPackage.FLOW_FINAL_NODE: {
				...
				if (result == null) result = caseActivityFinalNode(flowFinalNode);
				if (result == null) result = caseActivityNode(flowFinalNode);
				if (result == null) result = caseNamedElement(flowFinalNode);
				if (result == null) result = caseCommentableElement(flowFinalNode);
				if (result == null) result = caseExtendableElement(flowFinalNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
