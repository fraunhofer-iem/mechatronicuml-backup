package org.muml.storydiagram.interpreter.core.debug.client;
...
import org.muml.storydiagram.interpreter.core.debug.client.protocol.SDDebugProtocolEventIndicationFactory;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.ConnectClientCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.GetExecutionStackCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.RemoveBreakpointRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.ResumeCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.SetBreakpointCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.SetVariableCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.StepBackOverRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.StepIntoCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.StepOutCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.StepOverCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.SuspendCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.protocol.requests.TerminateCommandRequest;
import org.muml.storydiagram.interpreter.core.debug.client.stack.DebugClientStackFrame;
import org.muml.storydiagram.interpreter.core.debug.protocol.SDDebugProtocolCommandIndicationFactory;
import org.muml.storydiagram.interpreter.core.mdelab.notifications.NotificationTypeEnum;
import org.muml.storydiagram.resourcesetsynchronizer.EObjectUuidCalculator;
