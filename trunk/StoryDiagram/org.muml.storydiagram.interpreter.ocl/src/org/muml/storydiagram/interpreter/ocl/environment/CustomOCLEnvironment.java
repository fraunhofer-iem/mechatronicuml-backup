package org.muml.storydiagram.interpreter.ocl.environment;
...
public class CustomOCLEnvironment extends EcoreEnvironment
{
	...
	public Variable<EClassifier, EParameter> lookupLocal(String name)
	{
		...
		org.muml.storydiagram.interpreter.core.mdelab.variables.Variable<EClassifier> variable = this.variablesScope.getVariable(name);
	...
	public EClassifier lookupClassifier(List<String> names)
	{
		...
		else
		{
			...
			for (org.muml.storydiagram.interpreter.core.mdelab.variables.Variable<EClassifier> var : this.variablesScope.getVariables())
			{
