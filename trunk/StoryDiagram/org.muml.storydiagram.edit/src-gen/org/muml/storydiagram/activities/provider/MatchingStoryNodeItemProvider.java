...
/**
 * This is the item provider adapter for a {@link org.muml.storydiagram.activities.MatchingStoryNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		if (object instanceof MatchingStoryNode) {
			if (((MatchingStoryNode) object).isForEach()) {
				return overlayImage(
						...
						getResourceLocator()
								.getImage(
										"elements/activities/MatchingStoryNode_loop.png"));
			}
		}
		return overlayImage(
				object,
				getResourceLocator().getImage(
						"elements/activities/MatchingStoryNode.png"));
	}
