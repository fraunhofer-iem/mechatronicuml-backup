...
public class BehaviorSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BehaviorPackage.RT_SC_CAT2_SF_M: {
			...
			case BehaviorPackage.FRT_SC2_CHART: {
			...
			case BehaviorPackage.SC_STATE2_SF_STATE: {
			...
			case BehaviorPackage.SC_TRANS2_SF_TRANS: {
			...
			case BehaviorPackage.SC_REGION2SF_PARALLEL: {
			...
			case BehaviorPackage.SC_ENTRY2SF_ENTRY: {
			...
			case BehaviorPackage.SC_EXIT2SF_EXIT: {
			...
			case BehaviorPackage.SC_ST_EN_POINT2SF_TRANS: {
			...
			case BehaviorPackage.SC_ST_EX_POINT2SF_TRANS: {
			...
			case BehaviorPackage.SC_SYNC_CHANNEL2SF_SIGNAL: {
			...
			case BehaviorPackage.SC_SYNC_RECEIVE_ACTION2SF_ACTION: {
			...
			case BehaviorPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE: {
			...
			case BehaviorPackage.SC_SYNC_SEND2SF_SYNC_SEND: {
			...
			case BehaviorPackage.SC_SYNC_PARA2SF_SYNC_PARA_DATA: {
			...
			case BehaviorPackage.MT_PAR2_MTD: {
			...
			case BehaviorPackage.SC_ATTRIBUTE2SF_DATA: {
			...
			case BehaviorPackage.SC_SEND_ASYNC2SF_TRANS_ACTION: {
			...
			case BehaviorPackage.SC_SEND_PARA_BIND2SF_ACTION: {
			...
			case BehaviorPackage.SC_ASYNC_SEND2SF_ACTION: {
			...
			case BehaviorPackage.SC_ASYNC_REC2SF_ASYNC_GUARD: {
			...
			case BehaviorPackage.SC_CLOCK2SF_DATA: {
			...
			case BehaviorPackage.SC_CLOCK_CONSTR2SF_GUARD: {
			...
			case BehaviorPackage.CLOCK2_CLOCK_RESET: {
			...
			case BehaviorPackage.SC_INVARIANT2SF_INV_ERROR: {
			...
			case BehaviorPackage.SC_GUARD2SF_GUARD: {
			...
			case BehaviorPackage.SC_ACTION2SF_ACTION: {
			...
			case BehaviorPackage.SC_OP2SF_EMB_FUNC: {
			...
			case BehaviorPackage.SC_OP_DATA2SF_EMB_FUNC_DATA: {
			...
			case BehaviorPackage.SC_ASYNC_REC2SF_DEQUEUE: {
			...
			case BehaviorPackage.SC_ACTION_SELF_TRANS2SF_ACTION: {
