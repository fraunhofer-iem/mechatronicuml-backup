...
/**
 * This is the item provider adapter for a {@link coordination.ConnectorQualityOfServiceAssumptions} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorQualityOfServiceAssumptionsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoordinationPackage.Literals.CONNECTOR_QUALITY_OF_SERVICE_ASSUMPTIONS__MESSAGE_LOSS_POSSIBLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoordinationPackage.Literals.CONNECTOR_QUALITY_OF_SERVICE_ASSUMPTIONS__PRESERVE_MESSAGE_ORDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		ConnectorQualityOfServiceAssumptions connectorQualityOfServiceAssumptions = (ConnectorQualityOfServiceAssumptions)object;
		return getString("_UI_ConnectorQualityOfServiceAssumptions_type") + " " + connectorQualityOfServiceAssumptions.isMessageLossPossible();
	}
