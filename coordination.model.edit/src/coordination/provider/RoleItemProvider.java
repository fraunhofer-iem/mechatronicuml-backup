...
import realtimestatechart.provider.BehavioralElementItemProvider;

/**
 * This is the item provider adapter for a {@link coordination.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider extends BehavioralElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoordinationPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
