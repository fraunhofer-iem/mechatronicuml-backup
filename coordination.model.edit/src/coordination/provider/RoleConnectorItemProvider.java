...
/**
 * This is the item provider adapter for a {@link coordination.RoleConnector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleConnectorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoordinationPackage.Literals.ROLE_CONNECTOR__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoordinationPackage.Literals.ROLE_CONNECTOR__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CoordinationPackage.Literals.ROLE_CONNECTOR__CONNECTOR_QOS_ASSUMPTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CoordinationPackage.Literals.ROLE_CONNECTOR__CONNECTOR_QOS_ASSUMPTIONS,
				 CoordinationFactory.eINSTANCE.createConnectorQualityOfServiceAssumptions()));
	}
