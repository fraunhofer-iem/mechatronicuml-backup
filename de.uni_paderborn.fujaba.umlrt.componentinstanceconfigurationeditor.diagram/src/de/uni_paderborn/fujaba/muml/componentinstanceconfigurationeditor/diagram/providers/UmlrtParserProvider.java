...
public class UmlrtParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.parsers.ComponentInstanceLabelExpressionLabelParser componentInstanceLabel_5001Parser;
	...
	private IParser getComponentInstanceLabel_5001Parser() {
		if (componentInstanceLabel_5001Parser == null) {
			componentInstanceLabel_5001Parser = new de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.parsers.ComponentInstanceLabelExpressionLabelParser();
		}
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.part.UmlrtVisualIDRegistry
					.getVisualID(vid));
		}
