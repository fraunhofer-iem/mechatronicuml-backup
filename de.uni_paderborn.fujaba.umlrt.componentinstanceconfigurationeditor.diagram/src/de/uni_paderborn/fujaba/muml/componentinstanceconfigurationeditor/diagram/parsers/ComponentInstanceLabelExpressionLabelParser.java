 ...
 * @generated
 */
public class ComponentInstanceLabelExpressionLabelParser implements IParser {
	/**
	 * @generated
	 */
	public ComponentInstanceLabelExpressionLabelParser() {
	}
	...
	public String getPrintString(IAdaptable element, int flags) {
		...
		Object result = de.uni_paderborn.fujaba.muml.componentinstanceconfigurationeditor.diagram.expressions.UmlrtOCLFactory
				.getExpression(
						1,
						de.uni_paderborn.fujaba.muml.model.instance.InstancePackage.eINSTANCE
								.getComponentInstance(), null).evaluate(target);
