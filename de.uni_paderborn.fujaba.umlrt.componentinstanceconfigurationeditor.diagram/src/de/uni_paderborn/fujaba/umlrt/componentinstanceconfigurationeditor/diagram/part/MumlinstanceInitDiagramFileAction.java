	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog
					.openError(
							getShell(),
							de.uni_paderborn.fujaba.umlrt.componentinstanceconfigurationeditor.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogTitle,
		...
		Wizard wizard = new de.uni_paderborn.fujaba.umlrt.componentinstanceconfigurationeditor.diagram.part.MumlinstanceNewDiagramFileWizard(
