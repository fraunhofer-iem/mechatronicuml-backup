...
public class ComponentinstanceconfigurationElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType ComponentInstance_2003 = getElementType("de.uni_paderborn.fujaba.umlrt.componentinstanceconfigurationeditor.diagram.ComponentInstance_2003"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(ComponentInstance_2003);
