...
public class ComponentinstanceconfigurationParserProvider extends
	...
	private IParser getComponentInstanceNameComponentNameDerived_5007Parser() {
		if (componentInstanceNameComponentNameDerived_5007Parser == null) {
			...
			de.uni_paderborn.fujaba.umlrt.componentinstanceconfigurationeditor.diagram.parsers.MessageFormatParser parser = new de.uni_paderborn.fujaba.umlrt.componentinstanceconfigurationeditor.diagram.parsers.MessageFormatParser(
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(de.uni_paderborn.fujaba.umlrt.componentinstanceconfigurationeditor.diagram.part.MumlinstanceVisualIDRegistry
					.getVisualID(vid));
		}
