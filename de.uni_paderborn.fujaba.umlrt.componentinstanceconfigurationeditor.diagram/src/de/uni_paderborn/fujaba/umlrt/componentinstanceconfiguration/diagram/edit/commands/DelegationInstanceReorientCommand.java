...
public class DelegationInstanceReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.umlrt.model.instance.DelegationInstance) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return de.uni_paderborn.fujaba.umlrt.componentinstanceconfiguration.diagram.edit.policies.ComponentinstanceconfigurationBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistDelegationInstance_4002(
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.umlrt.model.instance.DelegationInstance getLink() {
		return (de.uni_paderborn.fujaba.umlrt.model.instance.DelegationInstance) getElementToEdit();
	}
