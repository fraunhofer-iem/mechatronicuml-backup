...
public class HistoryStateEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.edit.policies.HistoryStateItemSemanticEditPolicy());
	...
	public class DeepHistoryFigure extends Ellipse {
		...
		private void createContents() {
			...
			WrappingLabel deepHistoryLabel0 = new WrappingLabel();
			deepHistoryLabel0.setText("H*");

			GridData constraintDeepHistoryLabel0 = new GridData();
			constraintDeepHistoryLabel0.verticalAlignment = GridData.CENTER;
			constraintDeepHistoryLabel0.horizontalAlignment = GridData.CENTER;
			constraintDeepHistoryLabel0.horizontalIndent = 0;
			constraintDeepHistoryLabel0.horizontalSpan = 1;
			constraintDeepHistoryLabel0.verticalSpan = 1;
			constraintDeepHistoryLabel0.grabExcessHorizontalSpace = true;
			constraintDeepHistoryLabel0.grabExcessVerticalSpace = true;
			this.add(deepHistoryLabel0, constraintDeepHistoryLabel0);
