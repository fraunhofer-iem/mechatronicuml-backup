...
public class RealtimeStatechartDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.part.RealtimeStatechartDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.edit.policies.RealtimeStatechartBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.providers.ElementInitializers initializers;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.expressions.RealtimeStatechartOCLFactory oclFactory;
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories
				.add(new de.uni_paderborn.fujaba.umlrt.realtimeStatechart.provider.RealtimeStatechartItemProviderAdapterFactory());
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.part.RealtimeStatechartDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.part.RealtimeStatechartDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.edit.policies.RealtimeStatechartBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.edit.policies.RealtimeStatechartBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.expressions.RealtimeStatechartOCLFactory getRealtimeStatechartOCLFactory() {
		return oclFactory;
	}
	 ...
	 * @generated
	 */
	public void setRealtimeStatechartOCLFactory(
			de.uni_paderborn.fujaba.umlrt.realtimeStatechart.diagram.expressions.RealtimeStatechartOCLFactory f) {
		this.oclFactory = f;
	}
