 ...
 * @generated
 */
public class ClockConstraintEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ClockConstraintEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.edit.policies.ClockConstraintItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.edit.parts.ClockConstraintClockConstraintExprEditPart) {
			((de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.edit.parts.ClockConstraintClockConstraintExprEditPart) childEditPart)
