	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog
					.openError(
							getShell(),
							de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogTitle,
							de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogMessage);
			return;
		}
		Wizard wizard = new de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.part.UmlrtNewDiagramFileWizard(
