 ...
 * @generated
 */
public class BusConnectorReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BusConnectorReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.muml.hardware.hwplatform.BusConnector) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistBusConnector_4030(container,
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorBusConnector_4030(container,
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.hwplatform.BusConnector getLink() {
		return (de.uni_paderborn.fujaba.muml.hardware.hwplatform.BusConnector) getElementToEdit();
	}
