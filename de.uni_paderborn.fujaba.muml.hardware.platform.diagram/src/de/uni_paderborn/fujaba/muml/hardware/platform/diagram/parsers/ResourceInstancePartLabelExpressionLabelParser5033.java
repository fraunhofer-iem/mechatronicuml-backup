 ...
 * @generated
 */
public class ResourceInstancePartLabelExpressionLabelParser5033 extends
		ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ResourceInstancePartLabelExpressionLabelParser5033() {
	}
		...
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory
				.getExpression(
						...
						de.uni_paderborn.fujaba.muml.hardware.platform.PlatformPackage.eINSTANCE
								.getResourceInstancePart(), null).body();
	}
