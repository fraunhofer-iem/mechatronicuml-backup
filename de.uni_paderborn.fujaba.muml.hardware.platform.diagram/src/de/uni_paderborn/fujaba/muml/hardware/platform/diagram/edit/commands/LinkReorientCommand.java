...
public class LinkReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		 ...
		 */
		de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart target = (de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart) getLink()
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLink_4002(container, getLink(),
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorLink_4002(container,
							getNewSource(), target, sourceView, targetView);
	...
	protected boolean canReorientTarget() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorLink_4002(container, source,
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		...
		// Enhancement for MUML-BUG #446
		if (getLink().getConnectedHWPortParts().size() > 1) {
			getLink().getConnectedHWPortParts().remove(getOldTarget());
		}
		getLink().getConnectedHWPortParts().add(getNewTarget());
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart getOldTarget() {
		return (de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart) oldEnd;
	}
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart getNewTarget() {
		return (de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart) newEnd;
	}
