 ...
 * @generated
 */
public class ResourceInstancePartCanonicalEditPolicy extends
		CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public ResourceInstancePartCanonicalEditPolicy() {
	}

	public ResourceInstancePartCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] { de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.parts.HWPortPartEditPart.VISUAL_ID });
		...
		return de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDiagramUpdater
				.getResourceInstancePart_3012SemanticChildren(viewObject);
