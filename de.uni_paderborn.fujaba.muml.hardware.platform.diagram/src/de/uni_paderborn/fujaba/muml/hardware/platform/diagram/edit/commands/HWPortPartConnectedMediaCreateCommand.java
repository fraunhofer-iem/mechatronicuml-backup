...
public class HWPortPartConnectedMediaCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (target != null
				&& false == target instanceof de.uni_paderborn.fujaba.muml.hardware.platform.CommunicationMedia) {
			return false;
		}
		if (getSource() == null) {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateHWPortPartConnectedMedia_4027(
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints()
					.getErrorHWPortPartConnectedMedia_4027(getSource(),
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.platform.CommunicationMedia getTarget() {
		return (de.uni_paderborn.fujaba.muml.hardware.platform.CommunicationMedia) target;
	}
}
