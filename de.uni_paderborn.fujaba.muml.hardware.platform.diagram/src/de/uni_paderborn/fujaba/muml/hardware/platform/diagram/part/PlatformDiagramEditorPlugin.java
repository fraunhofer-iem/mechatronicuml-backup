...
public class PlatformDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.platform.diagram.providers.ElementInitializers initializers;

	/**
	 * @generated
	 */
	private de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory oclFactory;
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.HardwareDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			de.uni_paderborn.fujaba.muml.hardware.platform.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy.LinkConstraints lc) {
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.platform.diagram.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	...
	public void setElementInitializers(
			de.uni_paderborn.fujaba.muml.hardware.platform.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
	 ...
	 * @generated
	 */
	public de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory getHardwareOCLFactory() {
		return oclFactory;
	}
	...
	public void setHardwareOCLFactory(
			de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory f) {
		this.oclFactory = f;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, PlatformDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, PlatformDiagramEditorPlugin.ID,
