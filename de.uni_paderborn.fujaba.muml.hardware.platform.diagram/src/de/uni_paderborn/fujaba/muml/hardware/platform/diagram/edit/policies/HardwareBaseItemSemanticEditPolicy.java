...
public class HardwareBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.providers.HardwareElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.part.PlatformDiagramEditorPlugin
	...
	public static class LinkConstraints {
		...
		public boolean canCreateDelegation_4001(
			...
			return canExistDelegation_4001(container, null, source, target,
		 ...
		 * @generated
		 */
		public boolean canCreateHWPortPartConnectedMedia_4027(
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart source,
			...
			return canExistHWPortPartConnectedMedia_4027(source, target,
					sourceView, targetView);
		}
		 ...
		 * @generated
		 */
		public boolean canCreateCommunicationMediaConnectedBridges_4023(
				...
				View sourceView, View targetView) {
			if (source != null) {
				if (source.getConnectedBridges().contains(target)) {
					return false;
				}
			}
			if (target != null
					&& (target.getConnectedCommunicationMedia()
							.contains(target))) {
				return false;
			}

			return canExistCommunicationMediaConnectedBridges_4023(source,
		 ...
		 * @generated
		 */
		public boolean canCreateLink_4011(
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPlatform container,
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart source,
				de.uni_paderborn.fujaba.muml.hardware.platform.Bridge target,
				View sourceView, View targetView) {
			return canExistLink_4011(container, null, source, target,
					sourceView, targetView);
		}
		...
		public boolean canExistDelegation_4001(
			...
			try {
				if (source == null) {
					...
					de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareAbstractExpression expression = de.uni_paderborn.fujaba.muml.hardware.platform.diagram.expressions.HardwareOCLFactory
							.getExpression(
									24,
		 ...
		 * @generated
		 */
		public boolean canExistHWPortPartConnectedMedia_4027(
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart source,
				de.uni_paderborn.fujaba.muml.hardware.platform.CommunicationMedia target,
				View sourceView, View targetView) {
			try {
				if (source == null) {
					...
					Map<String, Object> env = new HashMap<String, Object>();
					envType.put(
							"oppositeEnd", de.uni_paderborn.fujaba.muml.hardware.platform.PlatformPackage.eINSTANCE.getCommunicationMedia()); //$NON-NLS-1$
					env.put("oppositeEnd", target);
					envType.put("view", NotationPackage.Literals.VIEW);
					env.put("view", sourceView);
					envType.put("oppositeView", NotationPackage.Literals.VIEW);
		 ...
		 * @generated
		 */
		public java.lang.String getErrorHWPortPartConnectedMedia_4027(
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart source,
				de.uni_paderborn.fujaba.muml.hardware.platform.CommunicationMedia target,
				View sourceView, View targetView) {
			try {
		 ...
		 * @generated
		 */
		public boolean canExistCommunicationMediaConnectedBridges_4023(
				de.uni_paderborn.fujaba.muml.hardware.platform.CommunicationMedia source,
				de.uni_paderborn.fujaba.muml.hardware.platform.Bridge target,
				View sourceView, View targetView) {
			try {
				if (source == null) {
					...
					Map<String, Object> env = new HashMap<String, Object>();
					envType.put(
							"oppositeEnd", de.uni_paderborn.fujaba.muml.hardware.platform.PlatformPackage.eINSTANCE.getBridge()); //$NON-NLS-1$
					env.put("oppositeEnd", target);
					envType.put("view", NotationPackage.Literals.VIEW);
					env.put("view", sourceView);
					envType.put("oppositeView", NotationPackage.Literals.VIEW);
		 ...
		 * @generated
		 */
		public java.lang.String getErrorCommunicationMediaConnectedBridges_4023(
				de.uni_paderborn.fujaba.muml.hardware.platform.CommunicationMedia source,
				de.uni_paderborn.fujaba.muml.hardware.platform.Bridge target,
				View sourceView, View targetView) {
			try {
		 ...
		 * @generated
		 */
		public boolean canExistLink_4011(
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPlatform container,
				de.uni_paderborn.fujaba.muml.hardware.platform.Link linkInstance,
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart source,
				de.uni_paderborn.fujaba.muml.hardware.platform.Bridge target,
		 ...
		 * @generated
		 */
		public java.lang.String getErrorLink_4011(
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPlatform container,
				de.uni_paderborn.fujaba.muml.hardware.platform.HWPortPart source,
				de.uni_paderborn.fujaba.muml.hardware.platform.Bridge target,
				View sourceView, View targetView) {
