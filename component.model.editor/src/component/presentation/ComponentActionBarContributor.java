...
/**
 * This is the action bar contributor for the Component model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentActionBarContributor
	 ...
	 * @generated
	 */
	public ComponentActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("component-settings"));
		toolBarManager.add(new Separator("component-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ComponentEditorPlugin.INSTANCE.getString("_UI_ComponentEditor_menu"), "componentMenuID");
