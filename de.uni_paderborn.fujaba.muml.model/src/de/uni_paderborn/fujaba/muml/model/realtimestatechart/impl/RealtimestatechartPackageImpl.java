		...
		addAnnotation
		  (stateEClass, 
		   ...
		   new String[] {
			 ...
			 "InvalidClockConstraintOperator", "self.invariants->forAll(invariant | Set{core::expressions::ComparingOperator::LESS, core::expressions::ComparingOperator::LESS_OR_EQUAL }->includes(invariant.operator))"
		   });													
		addAnnotation
		  (getState_Events(), 
		   source, 
