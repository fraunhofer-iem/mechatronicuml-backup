...
public class StateEntryPointImpl extends VertexImpl implements StateEntryPoint {
	...
	public State getState() {
		if (eContainerFeatureID() != RealtimestatechartPackage.STATE_ENTRY_POINT__STATE) return null;
	...
	public NotificationChain basicSetState(State newState, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newState, RealtimestatechartPackage.STATE_ENTRY_POINT__STATE, msgs);
		return msgs;
	}
	...
	public void setState(State newState) {
		if (newState != eInternalContainer() || (eContainerFeatureID() != RealtimestatechartPackage.STATE_ENTRY_POINT__STATE && newState != null)) {
			...
			if (newState != null)
				msgs = ((InternalEObject)newState).eInverseAdd(this, RealtimestatechartPackage.STATE__STATE_ENTRY_POINTS, State.class, msgs);
			msgs = basicSetState(newState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.STATE_ENTRY_POINT__STATE, newState, newState));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RealtimestatechartPackage.STATE_ENTRY_POINT__STATE:
				return eInternalContainer().eInverseRemove(this, RealtimestatechartPackage.STATE__STATE_ENTRY_POINTS, State.class, msgs);
		}
