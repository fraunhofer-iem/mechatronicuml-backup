 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.pattern.DiscreteInteractionEndpoint#getSenderMessageTypes <em>Sender Message Types</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.pattern.DiscreteInteractionEndpoint#getReceiverMessageTypes <em>Receiver Message Types</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.pattern.DiscreteInteractionEndpoint#getAdaptationBehavior <em>Adaptation Behavior</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.pattern.DiscreteInteractionEndpoint#getRoleAndAdaptationBehavior <em>Role And Adaptation Behavior</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.model.pattern.PatternPackage#getDiscreteInteractionEndpoint()
 * @model abstract="true"
 * @generated
 */
public interface DiscreteInteractionEndpoint extends BehavioralElement, ConstrainableElement, NamedElement {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.pattern.PatternPackage#getDiscreteInteractionEndpoint_SenderMessageTypes()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.pattern.PatternPackage#getDiscreteInteractionEndpoint_ReceiverMessageTypes()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.pattern.PatternPackage#getDiscreteInteractionEndpoint_AdaptationBehavior()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.model.pattern.DiscreteInteractionEndpoint#getAdaptationBehavior <em>Adaptation Behavior</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.pattern.PatternPackage#getDiscreteInteractionEndpoint_RoleAndAdaptationBehavior()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.model.pattern.DiscreteInteractionEndpoint#getRoleAndAdaptationBehavior <em>Role And Adaptation Behavior</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
