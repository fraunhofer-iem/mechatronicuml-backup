...
public class PatternAdapterFactory extends AdapterFactoryImpl {
	...
	protected PatternSwitch<Adapter> modelSwitch =
		new PatternSwitch<Adapter>() {
			...
			@Override
			public Adapter casePatternEllipse(PatternEllipse object) {
				return createPatternEllipseAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uni_paderborn.fujaba.muml.model.pattern.CoordinationPattern <em>Coordination Pattern</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uni_paderborn.fujaba.muml.model.pattern.PatternEllipse <em>Ellipse</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
