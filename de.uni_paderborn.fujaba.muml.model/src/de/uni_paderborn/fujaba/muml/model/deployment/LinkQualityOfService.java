 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.deployment.LinkQualityOfService#getPacketDelayVariation <em>Packet Delay Variation</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.deployment.LinkQualityOfService#getLatency <em>Latency</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.deployment.LinkQualityOfService#getDeployment <em>Deployment</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.model.deployment.DeploymentPackage#getLinkQualityOfService()
 * @model
 * @generated
 */
public interface LinkQualityOfService extends CommentableElement, NamedElement {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.deployment.DeploymentPackage#getLinkQualityOfService_PacketDelayVariation()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.model.deployment.LinkQualityOfService#getPacketDelayVariation <em>Packet Delay Variation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.deployment.DeploymentPackage#getLinkQualityOfService_Latency()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.model.deployment.LinkQualityOfService#getLatency <em>Latency</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.deployment.DeploymentPackage#getLinkQualityOfService_Deployment()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.model.deployment.LinkQualityOfService#getDeployment <em>Deployment</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
