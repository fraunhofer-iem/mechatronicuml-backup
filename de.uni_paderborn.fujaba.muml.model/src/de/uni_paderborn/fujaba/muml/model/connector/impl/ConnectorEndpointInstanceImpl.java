 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.impl.ConnectorEndpointInstanceImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.impl.ConnectorEndpointInstanceImpl#getConnectorInstances <em>Connector Instances</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.impl.ConnectorEndpointInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConnectorEndpointInstanceImpl extends NamedElementImpl implements ConnectorEndpointInstance {
	...
	public EList<ConnectorInstance> getConnectorInstances() {
		if (connectorInstances == null) {
			connectorInstances = new EObjectResolvingEList<ConnectorInstance>(ConnectorInstance.class, this, ConnectorPackage.CONNECTOR_ENDPOINT_INSTANCE__CONNECTOR_INSTANCES);
		}
