 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.DiscreteInteractionEndpoint#getSenderMessageTypes <em>Sender Message Types</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.DiscreteInteractionEndpoint#getReceiverMessageTypes <em>Receiver Message Types</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.DiscreteInteractionEndpoint#getAdaptationBehavior <em>Adaptation Behavior</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.DiscreteInteractionEndpoint#getRoleAndAdaptationBehavior <em>Role And Adaptation Behavior</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.connector.DiscreteInteractionEndpoint#getCardinality <em>Cardinality</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.model.connector.ConnectorPackage#getDiscreteInteractionEndpoint()
 * @model abstract="true"
 * @generated
 */
public interface DiscreteInteractionEndpoint extends BehavioralElement, NamedElement, ConstrainableElement {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.connector.ConnectorPackage#getDiscreteInteractionEndpoint_SenderMessageTypes()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.connector.ConnectorPackage#getDiscreteInteractionEndpoint_ReceiverMessageTypes()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.connector.ConnectorPackage#getDiscreteInteractionEndpoint_AdaptationBehavior()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.model.connector.DiscreteInteractionEndpoint#getAdaptationBehavior <em>Adaptation Behavior</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.model.connector.ConnectorPackage#getDiscreteInteractionEndpoint_RoleAndAdaptationBehavior()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.model.connector.DiscreteInteractionEndpoint#getRoleAndAdaptationBehavior <em>Role And Adaptation Behavior</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
