 ...
 * <ul>
 *   <li>{@link structuredcomponenteditor.impl.StructuredComponentDiagramImpl#getStructuredComponent <em>Structured Component</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StructuredComponentDiagramImpl extends DiagramImpl implements StructuredComponentDiagram {
	/**
	...
	protected EClass eStaticClass() {
		return ComponenteditorPackage.Literals.STRUCTURED_COMPONENT_DIAGRAM;
	}
	...
	public NotificationChain basicSetStructuredComponent(StructuredComponent newStructuredComponent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponenteditorPackage.STRUCTURED_COMPONENT_DIAGRAM__STRUCTURED_COMPONENT, oldStructuredComponent, newStructuredComponent);
	...
	public void setStructuredComponent(StructuredComponent newStructuredComponent) {
		if (newStructuredComponent != structuredComponent) {
			...
			if (structuredComponent != null)
				msgs = ((InternalEObject)structuredComponent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponenteditorPackage.STRUCTURED_COMPONENT_DIAGRAM__STRUCTURED_COMPONENT, null, msgs);
			if (newStructuredComponent != null)
				msgs = ((InternalEObject)newStructuredComponent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponenteditorPackage.STRUCTURED_COMPONENT_DIAGRAM__STRUCTURED_COMPONENT, null, msgs);
			msgs = basicSetStructuredComponent(newStructuredComponent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponenteditorPackage.STRUCTURED_COMPONENT_DIAGRAM__STRUCTURED_COMPONENT, newStructuredComponent, newStructuredComponent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ComponenteditorPackage.STRUCTURED_COMPONENT_DIAGRAM__STRUCTURED_COMPONENT:
