 ...
 * @generated
 */
public class CicAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected CicSwitch<Adapter> modelSwitch =
		new CicSwitch<Adapter>() {
			@Override
			public Adapter caseCICZoneGraphState(CICZoneGraphState object) {
				return createCICZoneGraphStateAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.verification.core.reachanalysis.reachabilitygraph.cic.CICZoneGraphState <em>CIC Zone Graph State</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCICZoneGraphStateAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.verification.core.reachanalysis.reachabilitygraph.rtsc.ZoneGraphState <em>Zone Graph State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
