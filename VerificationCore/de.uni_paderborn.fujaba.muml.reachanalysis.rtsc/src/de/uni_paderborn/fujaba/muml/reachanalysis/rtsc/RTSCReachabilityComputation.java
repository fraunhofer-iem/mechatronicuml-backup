package de.uni_paderborn.fujaba.muml.reachanalysis.rtsc;
...
public class RTSCReachabilityComputation extends ReachabilityComputation {
	...
	protected ReachabilityGraphState createInitialState() {
		...
		// analysis
		HashSet<de.uni_paderborn.fujaba.muml.runtime.RealtimeStatechartInstance> startLocations = new HashSet<de.uni_paderborn.fujaba.muml.runtime.RealtimeStatechartInstance>();
