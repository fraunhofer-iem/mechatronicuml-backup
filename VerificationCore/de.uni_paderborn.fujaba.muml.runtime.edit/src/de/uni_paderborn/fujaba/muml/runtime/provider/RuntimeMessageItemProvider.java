...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.runtime.RuntimeMessage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuntimeMessageItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RuntimeMessage_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RuntimeMessage_type_feature", "_UI_RuntimeMessage_type"),
				 RuntimePackage.Literals.RUNTIME_MESSAGE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RuntimePackage.Literals.RUNTIME_MESSAGE__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((RuntimeMessage)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RuntimePackage.Literals.RUNTIME_MESSAGE__PARAMETERS,
				 RuntimeFactory.eINSTANCE.createRuntimeParameter()));
	}
