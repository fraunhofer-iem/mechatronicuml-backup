...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.runtime.RuntimeConnectorInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuntimeConnectorInstanceItemProvider extends ConnectorInstanceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RuntimeConnectorInstanceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((RuntimeConnectorInstance)object).getComment();
		return label == null || label.length() == 0 ?
			getString("_UI_RuntimeConnectorInstance_type") :
			getString("_UI_RuntimeConnectorInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RuntimeConnectorInstance.class)) {
