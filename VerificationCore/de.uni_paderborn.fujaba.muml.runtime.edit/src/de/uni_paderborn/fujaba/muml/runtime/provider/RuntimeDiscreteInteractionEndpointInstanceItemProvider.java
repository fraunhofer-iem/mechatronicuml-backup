...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.runtime.RuntimeDiscreteInteractionEndpointInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuntimeDiscreteInteractionEndpointInstanceItemProvider extends RuntimeBehavioralElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RuntimeDiscreteInteractionEndpointInstanceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((RuntimeDiscreteInteractionEndpointInstance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RuntimeDiscreteInteractionEndpointInstance_type") :
			getString("_UI_RuntimeDiscreteInteractionEndpointInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RuntimeDiscreteInteractionEndpointInstance.class)) {
