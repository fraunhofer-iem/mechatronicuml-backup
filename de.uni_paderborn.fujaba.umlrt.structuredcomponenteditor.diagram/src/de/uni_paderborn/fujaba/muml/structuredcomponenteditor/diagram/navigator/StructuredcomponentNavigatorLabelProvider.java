...
public class StructuredcomponentNavigatorLabelProvider extends LabelProvider
	...
	public void updateLabel(ViewerLabel label, TreePath elementPath) {
		...
		if (element instanceof de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorItem
				&& !isOwnView(((de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorItem) element)
						.getView())) {
			return;
		}
	...
	public Image getImage(Object element) {
		if (element instanceof de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorGroup) {
			de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorGroup group = (de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorGroup) element;
		...
		if (element instanceof de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorItem) {
			de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorItem navigatorItem = (de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.navigator.StructuredcomponentNavigatorItem) element;
	...
	private Image getImage(String key, IElementType elementType) {
		ImageRegistry imageRegistry = de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.part.StructuredcomponentDiagramEditorPlugin
				.getInstance().getImageRegistry();
		Image image = imageRegistry.get(key);
		if (image == null
				&& elementType != null
				&& de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.providers.UmlrtElementTypes
						.isKnownElementType(elementType)) {
			image = de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.providers.UmlrtElementTypes
	...
	private String getComponentPart_3005Text(View view) {
		IParser parser = de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.providers.StructuredcomponentParserProvider
				.getParser(
						de.uni_paderborn.fujaba.muml.structuredcomponenteditor.diagram.providers.UmlrtElementTypes.ComponentPart_3005,
