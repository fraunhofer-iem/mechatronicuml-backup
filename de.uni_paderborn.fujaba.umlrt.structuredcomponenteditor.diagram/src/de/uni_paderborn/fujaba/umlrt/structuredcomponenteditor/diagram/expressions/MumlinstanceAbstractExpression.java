 ...
 * @generated
 */
public abstract class MumlinstanceAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = de.uni_paderborn.fujaba.umlrt.structuredcomponenteditor.diagram.part.StructuredcomponentDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected MumlinstanceAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
