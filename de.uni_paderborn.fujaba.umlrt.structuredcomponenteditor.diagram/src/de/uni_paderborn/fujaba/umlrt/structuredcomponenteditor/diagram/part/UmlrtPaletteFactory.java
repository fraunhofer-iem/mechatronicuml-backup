...
public class UmlrtPaletteFactory {
	...
	private ToolEntry createStructuredComponent1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.structuredcomponenteditor.diagram.providers.UmlrtElementTypes.StructuredComponent_2002));
	...
	private ToolEntry createComponentPart2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.structuredcomponenteditor.diagram.providers.UmlrtElementTypes.ComponentPart_3005));
	...
	private ToolEntry createPort3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.structuredcomponenteditor.diagram.providers.UmlrtElementTypes.Port_3004));
	...
	private ToolEntry createDelegation4CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.structuredcomponenteditor.diagram.providers.UmlrtElementTypes.Delegation_4003));
	...
	private ToolEntry createAssembly5CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.structuredcomponenteditor.diagram.providers.UmlrtElementTypes.Assembly_4004));
