 ...
 * @generated
 */
public class DiscretePortCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public DiscretePortCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.atomiccomponenteditor.diagram.providers.ElementInitializers
				.getInstance().init_DiscretePort_3006(newElement);
