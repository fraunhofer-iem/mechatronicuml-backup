...
import de.fraunhofer.iem.web.SeminarOrgaWebSetup;
...
public class SeminarOrgaServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new SeminarOrgaWebSetup().createInjectorAndDoEMFRegistration();
