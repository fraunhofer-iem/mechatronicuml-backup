		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSeminarAccess().getSupervisesAssignment_4(), "rule__Seminar__SupervisesAssignment_4");
					put(grammarAccess.getSeminarAccess().getAssignmentsAssignment_5(), "rule__Seminar__AssignmentsAssignment_5");
					...
					put(grammarAccess.getPreferenceAccess().getTopicAssignment_2(), "rule__Preference__TopicAssignment_2");
