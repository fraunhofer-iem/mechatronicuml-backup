...
public class ProjectPlanningSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Assignment(ISerializationContext context, Assignment semanticObject) {
		...
		feeder.accept(grammarAccess.getAssignmentAccess().getProjectProjectIDTerminalRuleCall_0_0_1(), semanticObject.getProject());
		feeder.accept(grammarAccess.getAssignmentAccess().getEmployeeEmployeeIDTerminalRuleCall_4_0_1(), semanticObject.getEmployee());
		feeder.finish();
	}
	...
	protected void sequence_Rating(ISerializationContext context, Rating semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRatingAccess().getCapabilityCapabilityIDTerminalRuleCall_0_0_1(), semanticObject.getCapability());
