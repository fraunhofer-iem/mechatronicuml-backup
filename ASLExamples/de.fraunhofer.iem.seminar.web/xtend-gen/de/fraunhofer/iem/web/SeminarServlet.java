...
import de.fraunhofer.iem.web.SeminarWebSetup;
...
public class SeminarServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new SeminarWebSetup().createInjectorAndDoEMFRegistration();
