	...
	protected void addTopicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Preference_topic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Preference_topic_feature", "_UI_Preference_type"),
				 SeminarPackage.Literals.PREFERENCE__TOPIC,
				 true,
				 false,
				 true,
				 null,
