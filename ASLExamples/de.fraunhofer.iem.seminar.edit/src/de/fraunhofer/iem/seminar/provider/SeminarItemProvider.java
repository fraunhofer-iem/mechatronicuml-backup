...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.seminar.Seminar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SeminarItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SeminarPackage.Literals.SEMINAR__SUPERVISORS);
	...
	public String getText(Object object) {
		return getString("_UI_Seminar_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SeminarPackage.Literals.SEMINAR__SUPERVISORS,
				 SeminarFactory.eINSTANCE.createSupervisor()));

		newChildDescriptors.add
			(createChildParameter
				(SeminarPackage.Literals.SEMINAR__STUDENTS,
				 SeminarFactory.eINSTANCE.createStudent()));

		newChildDescriptors.add
			(createChildParameter
				(SeminarPackage.Literals.SEMINAR__TOPICS,
				 SeminarFactory.eINSTANCE.createTopic()));
		...
		newChildDescriptors.add
			(createChildParameter
				(SeminarPackage.Literals.SEMINAR__SUPERVISES,
				 SeminarFactory.eINSTANCE.createSupervise()));

		newChildDescriptors.add
			(createChildParameter
				(SeminarPackage.Literals.SEMINAR__ASSIGNMENTS,
				 SeminarFactory.eINSTANCE.createAssignment()));
	}
