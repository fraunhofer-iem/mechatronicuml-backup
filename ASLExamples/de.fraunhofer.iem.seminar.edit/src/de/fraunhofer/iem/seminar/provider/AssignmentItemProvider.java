...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.seminar.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_student_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_student_feature", "_UI_Assignment_type"),
				 SeminarPackage.Literals.ASSIGNMENT__STUDENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTopicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_topic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_topic_feature", "_UI_Assignment_type"),
				 SeminarPackage.Literals.ASSIGNMENT__TOPIC,
				 true,
				 false,
				 true,
				 null,
