...
import de.fraunhofer.iem.web.ProjectPlanningWebSetup;
...
public class ProjectPlanningServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new ProjectPlanningWebSetup().createInjectorAndDoEMFRegistration();
