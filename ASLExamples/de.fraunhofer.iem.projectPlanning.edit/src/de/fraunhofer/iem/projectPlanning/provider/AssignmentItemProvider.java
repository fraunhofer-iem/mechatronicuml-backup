...
/**
 * This is the item provider adapter for a {@link de.fraunhofer.iem.projectPlanning.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_employee_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_employee_feature", "_UI_Assignment_type"),
				 ProjectPlanningPackage.Literals.ASSIGNMENT__EMPLOYEE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addProjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_project_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_project_feature", "_UI_Assignment_type"),
				 ProjectPlanningPackage.Literals.ASSIGNMENT__PROJECT,
				 true,
				 false,
				 true,
				 null,
