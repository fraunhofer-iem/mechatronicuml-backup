 ...
 * </p>
 * <ul>
 *   <li>{@link de.fraunhofer.iem.seminarOrga.Preference#getStudent <em>Student</em>}</li>
 *   <li>{@link de.fraunhofer.iem.seminarOrga.Preference#getTopics <em>Topics</em>}</li>
 * </ul>
 *
 * @see de.fraunhofer.iem.seminarOrga.SeminarOrgaPackage#getPreference()
 * @model
 * @generated
 */
public interface Preference extends EObject
{
   ...
   * @see de.fraunhofer.iem.seminarOrga.SeminarOrgaPackage#getPreference_Student()
   * @model
   * @generated
   */
  Student getStudent();
  ...
  /**
   * Sets the value of the '{@link de.fraunhofer.iem.seminarOrga.Preference#getStudent <em>Student</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.fraunhofer.iem.seminarOrga.SeminarOrgaPackage#getPreference_Topics()
   * @model
   * @generated
   */
