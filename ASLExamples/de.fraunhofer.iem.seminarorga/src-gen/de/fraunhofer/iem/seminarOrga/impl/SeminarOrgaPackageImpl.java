 ...
 * @generated
 */
public class SeminarOrgaPackageImpl extends EPackageImpl implements SeminarOrgaPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.fraunhofer.iem.seminarOrga.SeminarOrgaPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private SeminarOrgaPackageImpl()
  {
    super(eNS_URI, SeminarOrgaFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link SeminarOrgaPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static SeminarOrgaPackage init()
  {
    if (isInited) return (SeminarOrgaPackage)EPackage.Registry.INSTANCE.getEPackage(SeminarOrgaPackage.eNS_URI);

    // Obtain or create and register package
    SeminarOrgaPackageImpl theSeminarOrgaPackage = (SeminarOrgaPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SeminarOrgaPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SeminarOrgaPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theSeminarOrgaPackage.createPackageContents();

    // Initialize created meta-data
    theSeminarOrgaPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theSeminarOrgaPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(SeminarOrgaPackage.eNS_URI, theSeminarOrgaPackage);
    return theSeminarOrgaPackage;
  }
   ...
   * @generated
   */
  public SeminarOrgaFactory getSeminarOrgaFactory()
  {
    return (SeminarOrgaFactory)getEFactoryInstance();
  }
