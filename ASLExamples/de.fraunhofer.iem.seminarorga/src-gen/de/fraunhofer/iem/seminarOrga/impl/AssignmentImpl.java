 ...
 * </p>
 * <ul>
 *   <li>{@link de.fraunhofer.iem.seminarOrga.impl.AssignmentImpl#getStudent <em>Student</em>}</li>
 *   <li>{@link de.fraunhofer.iem.seminarOrga.impl.AssignmentImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssignmentImpl extends MinimalEObjectImpl.Container implements Assignment
{
  ...
  {
    return SeminarOrgaPackage.Literals.ASSIGNMENT;
  }
    ...
    if (student != null && student.eIsProxy())
    {
      ...
      if (student != oldStudent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SeminarOrgaPackage.ASSIGNMENT__STUDENT, oldStudent, student));
      }
    }
    return student;
  }
  ...
  public void setStudent(Student newStudent)
  {
    ...
    student = newStudent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SeminarOrgaPackage.ASSIGNMENT__STUDENT, oldStudent, student));
  }
  ...
  public Topic getTopic()
  {
    if (topic != null && topic.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SeminarOrgaPackage.ASSIGNMENT__TOPIC, oldTopic, topic));
      }
    }
    return topic;
  }
  ...
  public void setTopic(Topic newTopic)
  {
    ...
    topic = newTopic;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SeminarOrgaPackage.ASSIGNMENT__TOPIC, oldTopic, topic));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SeminarOrgaPackage.ASSIGNMENT__STUDENT:
        if (resolve) return getStudent();
        return basicGetStudent();
      case SeminarOrgaPackage.ASSIGNMENT__TOPIC:
