 ...
 * </p>
 * <ul>
 *   <li>{@link de.fraunhofer.iem.seminar.impl.TopicImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TopicImpl extends MinimalEObjectImpl.Container implements Topic
{
  ...
  {
		return SeminarPackage.Literals.TOPIC;
	}
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SeminarPackage.TOPIC__NAME, oldName, name));
	}
  ...
  {
		switch (featureID) {
			case SeminarPackage.TOPIC__NAME:
				return getName();
		}
