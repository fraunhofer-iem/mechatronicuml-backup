...
public class SeminarSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Assignment(ISerializationContext context, Assignment semanticObject) {
		...
		feeder.accept(grammarAccess.getAssignmentAccess().getStudentStudentIDTerminalRuleCall_0_0_1(), semanticObject.getStudent());
		feeder.accept(grammarAccess.getAssignmentAccess().getTopicTopicIDTerminalRuleCall_4_0_1(), semanticObject.getTopic());
		feeder.finish();
	}
	...
	protected void sequence_Rating(ISerializationContext context, Rating semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRatingAccess().getStudentStudentIDTerminalRuleCall_0_0_1(), semanticObject.getStudent());
		feeder.accept(grammarAccess.getRatingAccess().getTopicTopicIDTerminalRuleCall_2_0_1(), semanticObject.getTopic());
	...
	protected void sequence_Supervise(ISerializationContext context, Supervise semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSuperviseAccess().getSupervisorSupervisorIDTerminalRuleCall_0_0_1(), semanticObject.getSupervisor());
		feeder.accept(grammarAccess.getSuperviseAccess().getTopicTopicIDTerminalRuleCall_2_0_1(), semanticObject.getTopic());
		feeder.finish();
	}
