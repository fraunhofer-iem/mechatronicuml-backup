 ...
 * @generated
 */
public class StorydiagramsViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = StorydiagramsVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = StorydiagramsVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				...
				if (domainElement != null
						&& visualID != StorydiagramsVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!ActivityEditPart.MODEL_ID
						.equals(StorydiagramsVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ActivityCallNodeEditPart.VISUAL_ID == visualID
				|| StatementNodeEditPart.VISUAL_ID == visualID
				|| ModifyingStoryNodeEditPart.VISUAL_ID == visualID
				|| MatchingStoryNodeEditPart.VISUAL_ID == visualID
				|| InitialNodeEditPart.VISUAL_ID == visualID
				|| JunctionNodeEditPart.VISUAL_ID == visualID
				|| FlowFinalNodeEditPart.VISUAL_ID == visualID
				|| ActivityFinalNodeEditPart.VISUAL_ID == visualID
				|| StoryPatternEditPart.VISUAL_ID == visualID
				|| CollectionVariableEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = StorydiagramsVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ActivityCallNodeEditPart.VISUAL_ID:
			return createActivityCallNode_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case StatementNodeEditPart.VISUAL_ID:
			return createStatementNode_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case ModifyingStoryNodeEditPart.VISUAL_ID:
			return createModifyingStoryNode_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case MatchingStoryNodeEditPart.VISUAL_ID:
			return createMatchingStoryNode_2004(domainElement, containerView,
					index, persisted, preferencesHint);
		case InitialNodeEditPart.VISUAL_ID:
			return createInitialNode_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case JunctionNodeEditPart.VISUAL_ID:
			return createJunctionNode_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case FlowFinalNodeEditPart.VISUAL_ID:
			return createFlowFinalNode_2007(domainElement, containerView,
					index, persisted, preferencesHint);
		case ActivityFinalNodeEditPart.VISUAL_ID:
			return createActivityFinalNode_2008(domainElement, containerView,
					index, persisted, preferencesHint);
		case StoryPatternEditPart.VISUAL_ID:
			return createStoryPattern_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case CollectionVariableEditPart.VISUAL_ID:
			return createCollectionVariable_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case AttributeAssignmentEditPart.VISUAL_ID:
			return createAttributeAssignment_3003(domainElement, containerView,
					index, persisted, preferencesHint);
		case ConstraintEditPart.VISUAL_ID:
			return createConstraint_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		case ObjectVariableEditPart.VISUAL_ID:
			return createObjectVariable_3005(domainElement, containerView,
					index, persisted, preferencesHint);
		case Constraint2EditPart.VISUAL_ID:
			return createConstraint_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		case MatchingPatternEditPart.VISUAL_ID:
			return createMatchingPattern_3007(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case InclusionLinkEditPart.VISUAL_ID:
			return createInclusionLink_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case MaybeLinkEditPart.VISUAL_ID:
			return createMaybeLink_4004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createActivityCallNode_2001(EObject domainElement,
		...
		node.setType(StorydiagramsVisualIDRegistry
		...
		Node label5002 = createLabel(node,
				StorydiagramsVisualIDRegistry
						.getType(ActivityCallNodeCalleeLabelEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createStatementNode_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label5004 = createLabel(
				node,
				StorydiagramsVisualIDRegistry
						.getType(StatementNodeExpressionLabelEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createModifyingStoryNode_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Node createMatchingStoryNode_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createInitialNode_2005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createJunctionNode_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createFlowFinalNode_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(StorydiagramsVisualIDRegistry
				.getType(FlowFinalNodeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createActivityFinalNode_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createStoryPattern_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createCollectionVariable_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5006 = createLabel(node,
				StorydiagramsVisualIDRegistry
						.getType(CollectionVariableNameLabelEditPart.VISUAL_ID));
		Node label5007 = createLabel(node,
				StorydiagramsVisualIDRegistry
						.getType(CollectionVariableTypeLabelEditPart.VISUAL_ID));
		createCompartment(
				node,
				StorydiagramsVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createAttributeAssignment_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
	 ...
	 * @generated
	 */
	public Node createConstraint_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
	 ...
	 * @generated
	 */
	public Node createObjectVariable_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5010 = createLabel(node,
				StorydiagramsVisualIDRegistry
						.getType(ObjectVariableTypeLabelEditPart.VISUAL_ID));
		createCompartment(
				node,
				StorydiagramsVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createConstraint_3006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
	 ...
	 * @generated
	 */
	public Node createMatchingPattern_3007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	public Edge createActivityEdge_4001(EObject domainElement,
		...
		edge.setType(StorydiagramsVisualIDRegistry
	...
	public Edge createLinkVariable_4002(EObject domainElement,
		...
		Node label6003 = createLabel(edge,
				StorydiagramsVisualIDRegistry
						.getType(LinkVariableOperatorLabelEditPart.VISUAL_ID));
		...
		Node label6004 = createLabel(edge,
				StorydiagramsVisualIDRegistry
						.getType(LinkVariableTargetEndLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createInclusionLink_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createMaybeLink_4004(EObject domainElement, View containerView,
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(StorydiagramsVisualIDRegistry
				.getType(MaybeLinkEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
