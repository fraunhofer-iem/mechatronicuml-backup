 ...
 * @generated
 */
public class MatchingPatternStoryPatternContentCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (StorydiagramsElementTypes.CollectionVariable_3002 == req
				.getElementType()) {
			return getGEFWrapper(new CollectionVariableCreateCommand(req));
		}
		if (StorydiagramsElementTypes.ObjectVariable_3005 == req
				.getElementType()) {
