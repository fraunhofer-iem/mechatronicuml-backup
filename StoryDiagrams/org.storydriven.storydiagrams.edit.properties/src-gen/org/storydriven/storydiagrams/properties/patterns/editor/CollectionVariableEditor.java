...
public class CollectionVariableEditor
	...
	protected void createProperties() {
		if (tab == null) {
			...
			addEditorToCategory(
					"de.uni_paderborn.fujaba.properties.category.Booleans",
					createAtLeastOne_GeneralTab_Editor(), false);

			addEditorToCategory(
					"de.uni_paderborn.fujaba.properties.category.Booleans",
					createUnique_GeneralTab_Editor(), false);
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createAtLeastOne_GeneralTab_Editor() {
	...
	private de.uni_paderborn.fujaba.properties.runtime.editors.AbstractStructuralFeaturePropertyEditor createUnique_GeneralTab_Editor() {
