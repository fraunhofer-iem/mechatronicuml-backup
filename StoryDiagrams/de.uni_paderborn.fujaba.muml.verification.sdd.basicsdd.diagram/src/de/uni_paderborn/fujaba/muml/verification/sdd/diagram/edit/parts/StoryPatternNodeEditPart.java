 ...
 * @generated
 */
public class StoryPatternNodeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StoryPatternNodeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.StoryPatternNodeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodeNameEditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePatternNodeNameFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodeTypeEditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodeTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePatternNodeTypeFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodePatternNodeContentCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigurePatternNodeElementsPolygon();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodePatternNodeContentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodePatternNodeContentCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigurePatternNodeElementsPolygon();
			pane.remove(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodePatternNodeContentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodePatternNodeContentCompartmentEditPart) {
