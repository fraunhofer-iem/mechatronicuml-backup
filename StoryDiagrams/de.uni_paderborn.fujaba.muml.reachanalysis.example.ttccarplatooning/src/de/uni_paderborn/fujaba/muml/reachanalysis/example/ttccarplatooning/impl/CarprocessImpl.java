...
import de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.ActiveState;
import de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.CarParameter;
 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getCurState <em>Cur State</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getQueue <em>Queue</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getStatechart <em>Statechart</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getFollower <em>Follower</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getLeader <em>Leader</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getAux <em>Aux</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getBldr <em>Bldr</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.reachanalysis.example.ttccarplatooning.impl.CarprocessImpl#getCarParameter <em>Car Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
