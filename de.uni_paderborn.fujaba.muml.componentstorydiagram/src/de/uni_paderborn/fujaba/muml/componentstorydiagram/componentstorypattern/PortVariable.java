 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.PortVariable#getType <em>Type</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.PortVariable#getConnectorVariables <em>Connector Variables</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.ComponentstorypatternPackage#getPortVariable()
 * @model abstract="true"
...
public interface PortVariable extends ComponentStoryPatternVariable, ConnectorEndpoint {
	 ...
	 * @see #setType(Port)
	 * @see de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.ComponentstorypatternPackage#getPortVariable_Type()
	 * @model required="true"
	 * @generated
	 */
	Port getType();
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.PortVariable#getType <em>Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.componentstorydiagram.componentstorypattern.ComponentstorypatternPackage#getPortVariable_ConnectorVariables()
