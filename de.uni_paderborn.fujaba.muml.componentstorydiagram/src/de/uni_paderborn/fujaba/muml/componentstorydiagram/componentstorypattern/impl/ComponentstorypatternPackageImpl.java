...
public class ComponentstorypatternPackageImpl extends EPackageImpl implements ComponentstorypatternPackage {
	...
	public static ComponentstorypatternPackage init() {
		...
		ComponentstorydiagramPackageImpl theComponentstorydiagramPackage = (ComponentstorydiagramPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(ComponentstorydiagramPackage.eNS_URI) instanceof ComponentstorydiagramPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(ComponentstorydiagramPackage.eNS_URI) : ComponentstorydiagramPackage.eINSTANCE);
