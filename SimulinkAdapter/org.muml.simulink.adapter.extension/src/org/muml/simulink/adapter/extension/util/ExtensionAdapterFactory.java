...
public class ExtensionAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExtensionSwitch<Adapter> modelSwitch =
		new ExtensionSwitch<Adapter>() {
			@Override
			public Adapter caseSimulinkAnnotationExtension(SimulinkAnnotationExtension object) {
				return createSimulinkAnnotationExtensionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.simulink.adapter.extension.SimulinkAnnotationExtension <em>Simulink Annotation Extension</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSimulinkAnnotationExtensionAdapter() {
		return null;
	}
