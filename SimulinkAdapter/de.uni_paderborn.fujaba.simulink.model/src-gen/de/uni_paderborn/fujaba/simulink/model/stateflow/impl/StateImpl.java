 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getSubStateType <em>Sub State Type</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#isInitial <em>Initial</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getEmbeddedFunctions <em>Embedded Functions</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getEntryAction <em>Entry Action</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getExitAction <em>Exit Action</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getDuringAction <em>During Action</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getLocal <em>Local</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getConstant <em>Constant</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.simulink.model.stateflow.impl.StateImpl#getInitial_guard <em>Initial guard</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
