 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScStEnPoint2sfTransImpl#getSfTrans <em>Sf Trans</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScStEnPoint2sfTransImpl#getScInTrans <em>Sc In Trans</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScStEnPoint2sfTransImpl#getScOutTrans <em>Sc Out Trans</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScStEnPoint2sfTransImpl#getScStateEntryP <em>Sc State Entry P</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScStEnPoint2sfTransImpl extends AbstractContainerCorrespondenceNodeImpl implements ScStEnPoint2sfTrans {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.SC_ST_EN_POINT2SF_TRANS;
	}
		...
		if (sfTrans != null && ((EObject)sfTrans).eIsProxy()) {
			...
			if (sfTrans != oldSfTrans) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SF_TRANS, oldSfTrans, sfTrans));
			}
		}
		return sfTrans;
	}
	...
	public void setSfTrans(Transition newSfTrans) {
		...
		sfTrans = newSfTrans;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SF_TRANS, oldSfTrans, sfTrans));
	}
	...
	public org.muml.pim.realtimestatechart.Transition getScInTrans() {
		if (scInTrans != null && scInTrans.eIsProxy()) {
			...
			if (scInTrans != oldScInTrans) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_IN_TRANS, oldScInTrans, scInTrans));
			}
		}
		return scInTrans;
	}
	...
	public void setScInTrans(org.muml.pim.realtimestatechart.Transition newScInTrans) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_IN_TRANS, oldScInTrans, scInTrans));
	}
	...
	public org.muml.pim.realtimestatechart.Transition getScOutTrans() {
		if (scOutTrans != null && scOutTrans.eIsProxy()) {
			...
			if (scOutTrans != oldScOutTrans) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_OUT_TRANS, oldScOutTrans, scOutTrans));
			}
		}
		return scOutTrans;
	}
	...
	public void setScOutTrans(org.muml.pim.realtimestatechart.Transition newScOutTrans) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_OUT_TRANS, oldScOutTrans, scOutTrans));
	}
	...
	public EntryPoint getScStateEntryP() {
		if (scStateEntryP != null && scStateEntryP.eIsProxy()) {
			...
			if (scStateEntryP != oldScStateEntryP) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_STATE_ENTRY_P, oldScStateEntryP, scStateEntryP));
			}
		}
	...
	public void setScStateEntryP(EntryPoint newScStateEntryP) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_STATE_ENTRY_P, oldScStateEntryP, scStateEntryP));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SF_TRANS:
				if (resolve) return getSfTrans();
				return basicGetSfTrans();
			case Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_IN_TRANS:
				if (resolve) return getScInTrans();
				return basicGetScInTrans();
			case Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_OUT_TRANS:
				if (resolve) return getScOutTrans();
				return basicGetScOutTrans();
			case Behavior_modelPackage.SC_ST_EN_POINT2SF_TRANS__SC_STATE_ENTRY_P:
