...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Comp Inst Config2 Sub Sys</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getInstConfig <em>Inst Config</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getSubSys <em>Sub Sys</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCommunicationSwitch <em>Communication Switch</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusCreator <em>Bus Creator</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusSelector <em>Bus Selector</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusCreatorOutPort <em>Bus Creator Out Port</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusSelectorInPort <em>Bus Selector In Port</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getBusOfBusses <em>Bus Of Busses</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCS_inPort <em>CS in Port</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCS_outPort <em>CS out Port</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.CompInstConfig2SubSysImpl#getCompInstName <em>Comp Inst Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CompInstConfig2SubSysImpl extends AbstractContainerCorrespondenceNodeImpl implements CompInstConfig2SubSys {
	/**
	 ...
	 * @generated
	 */
	protected CompInstConfig2SubSysImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Fujaba2simulinkPackage.Literals.COMP_INST_CONFIG2_SUB_SYS;
	}
		...
		if (instConfig != null && instConfig.eIsProxy()) {
			...
			if (instConfig != oldInstConfig) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Fujaba2simulinkPackage.COMP_INST_CONFIG2_SUB_SYS__INST_CONFIG, oldInstConfig, instConfig));
			}
		}
		return instConfig;
	}
	...
	public void setInstConfig(ComponentInstanceConfiguration newInstConfig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fujaba2simulinkPackage.COMP_INST_CONFIG2_SUB_SYS__INST_CONFIG, oldInstConfig, instConfig));
	}
	...
	public void setCompInstName(String newCompInstName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fujaba2simulinkPackage.COMP_INST_CONFIG2_SUB_SYS__COMP_INST_NAME, oldCompInstName, compInstName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Fujaba2simulinkPackage.COMP_INST_CONFIG2_SUB_SYS__INST_CONFIG:
