 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scSendParaBind2sfActionImpl#getSfParaBAction <em>Sf Para BAction</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scSendParaBind2sfActionImpl#getScAnnotation <em>Sc Annotation</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scSendParaBind2sfActionImpl#getScDetails <em>Sc Details</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class scSendParaBind2sfActionImpl extends AbstractContainerCorrespondenceNodeImpl implements scSendParaBind2sfAction {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.SC_SEND_PARA_BIND2SF_ACTION;
	}
		...
		if (sfParaBAction != null && ((EObject)sfParaBAction).eIsProxy()) {
			...
			if (sfParaBAction != oldSfParaBAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SF_PARA_BACTION, oldSfParaBAction, sfParaBAction));
			}
		}
	...
	public void setSfParaBAction(Action newSfParaBAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SF_PARA_BACTION, oldSfParaBAction, sfParaBAction));
	}
	...
	public EAnnotation getScAnnotation() {
		if (scAnnotation != null && scAnnotation.eIsProxy()) {
			...
			if (scAnnotation != oldScAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SC_ANNOTATION, oldScAnnotation, scAnnotation));
			}
		}
		return scAnnotation;
	}
	...
	public void setScAnnotation(EAnnotation newScAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SC_ANNOTATION, oldScAnnotation, scAnnotation));
	}
	...
	public Map.Entry<String, String> getScDetails() {
		if (scDetails != null && ((EObject)scDetails).eIsProxy()) {
			...
			if (scDetails != oldScDetails) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SC_DETAILS, oldScDetails, scDetails));
			}
		}
		return scDetails;
	}
	...
	public void setScDetails(Map.Entry<String, String> newScDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SC_DETAILS, oldScDetails, scDetails));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SF_PARA_BACTION:
				if (resolve) return getSfParaBAction();
				return basicGetSfParaBAction();
			case Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SC_ANNOTATION:
				if (resolve) return getScAnnotation();
				return basicGetScAnnotation();
			case Behavior_modelPackage.SC_SEND_PARA_BIND2SF_ACTION__SC_DETAILS:
