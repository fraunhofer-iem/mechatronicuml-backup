 ...
 * $Id$
 */
package org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl;
...
import org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.Behavior_modelFactory;
...
import org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.Fujaba2simulinkPackageImpl;
 ...
 * @generated
 */
public class Behavior_modelPackageImpl extends EPackageImpl implements Behavior_modelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.Behavior_modelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Behavior_modelPackageImpl() {
		super(eNS_URI, Behavior_modelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Behavior_modelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Behavior_modelPackage init() {
		if (isInited) return (Behavior_modelPackage)EPackage.Registry.INSTANCE.getEPackage(Behavior_modelPackage.eNS_URI);

		// Obtain or create and register package
		Behavior_modelPackageImpl theBehavior_modelPackage = (Behavior_modelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Behavior_modelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Behavior_modelPackageImpl());
		...
		theBehavior_modelPackage.createPackageContents();
		theFujaba2simulinkPackage.createPackageContents();

		// Initialize created meta-data
		theBehavior_modelPackage.initializePackageContents();
		theFujaba2simulinkPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBehavior_modelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Behavior_modelPackage.eNS_URI, theBehavior_modelPackage);
		return theBehavior_modelPackage;
	}
	 ...
	 * @generated
	 */
	public Behavior_modelFactory getBehavior_modelFactory() {
		return (Behavior_modelFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getMT_Par2MTD_Par(), theBehaviorPackage.getParameter(), null, "par", null, 0, 1, MT_Par2MTD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getscAttribute2sfData_ScAttribute(), theBehaviorPackage.getVariable(), null, "scAttribute", null, 0, 1, scAttribute2sfData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getscSendAsync2sfTransAction_ParBind(), theBehaviorPackage.getParameterBinding(), null, "parBind", null, 0, 1, scSendAsync2sfTransAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getscOp2sfEmbFunc_ScOperation(), theBehaviorPackage.getOperation(), null, "scOperation", null, 0, 1, scOp2sfEmbFunc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getscOpData2sfEmbFuncData_ScParameter(), theBehaviorPackage.getParameter(), null, "scParameter", null, 0, 1, scOpData2sfEmbFuncData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
