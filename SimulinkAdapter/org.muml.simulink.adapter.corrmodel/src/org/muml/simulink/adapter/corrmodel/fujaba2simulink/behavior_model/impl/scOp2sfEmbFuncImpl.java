 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scOp2sfEmbFuncImpl#getScOperation <em>Sc Operation</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scOp2sfEmbFuncImpl#getSfEmbFunc <em>Sf Emb Func</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scOp2sfEmbFuncImpl#getScAnnotation <em>Sc Annotation</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scOp2sfEmbFuncImpl#getScDetails <em>Sc Details</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class scOp2sfEmbFuncImpl extends AbstractContainerCorrespondenceNodeImpl implements scOp2sfEmbFunc {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.SC_OP2SF_EMB_FUNC;
	}
		...
		if (scOperation != null && scOperation.eIsProxy()) {
			...
			if (scOperation != oldScOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_OPERATION, oldScOperation, scOperation));
			}
		}
		return scOperation;
	}
	...
	public void setScOperation(Operation newScOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_OPERATION, oldScOperation, scOperation));
	}
	...
	public EmbeddedFunction getSfEmbFunc() {
		if (sfEmbFunc != null && ((EObject)sfEmbFunc).eIsProxy()) {
			...
			if (sfEmbFunc != oldSfEmbFunc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SF_EMB_FUNC, oldSfEmbFunc, sfEmbFunc));
			}
		}
		return sfEmbFunc;
	}
	...
	public void setSfEmbFunc(EmbeddedFunction newSfEmbFunc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SF_EMB_FUNC, oldSfEmbFunc, sfEmbFunc));
	}
	...
	public EAnnotation getScAnnotation() {
		if (scAnnotation != null && scAnnotation.eIsProxy()) {
			...
			if (scAnnotation != oldScAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_ANNOTATION, oldScAnnotation, scAnnotation));
			}
		}
		return scAnnotation;
	}
	...
	public void setScAnnotation(EAnnotation newScAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_ANNOTATION, oldScAnnotation, scAnnotation));
	}
	...
	public Map.Entry<String, String> getScDetails() {
		if (scDetails != null && ((EObject)scDetails).eIsProxy()) {
			...
			if (scDetails != oldScDetails) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_DETAILS, oldScDetails, scDetails));
			}
		}
		return scDetails;
	}
	...
	public void setScDetails(Map.Entry<String, String> newScDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_DETAILS, oldScDetails, scDetails));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_OPERATION:
				if (resolve) return getScOperation();
				return basicGetScOperation();
			case Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SF_EMB_FUNC:
				if (resolve) return getSfEmbFunc();
				return basicGetSfEmbFunc();
			case Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_ANNOTATION:
				if (resolve) return getScAnnotation();
				return basicGetScAnnotation();
			case Behavior_modelPackage.SC_OP2SF_EMB_FUNC__SC_DETAILS:
