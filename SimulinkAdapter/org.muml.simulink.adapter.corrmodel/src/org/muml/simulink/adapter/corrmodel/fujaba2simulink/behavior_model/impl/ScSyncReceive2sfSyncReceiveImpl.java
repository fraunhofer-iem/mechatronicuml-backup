 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScSyncReceive2sfSyncReceiveImpl#getScSyncReceive <em>Sc Sync Receive</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScSyncReceive2sfSyncReceiveImpl#getSfEntryAction <em>Sf Entry Action</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScSyncReceive2sfSyncReceiveImpl#getSfExitAction <em>Sf Exit Action</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScSyncReceive2sfSyncReceiveImpl#getSfTransEvent <em>Sf Trans Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScSyncReceive2sfSyncReceiveImpl extends AbstractContainerCorrespondenceNodeImpl implements ScSyncReceive2sfSyncReceive {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE;
	}
		...
		if (scSyncReceive != null && scSyncReceive.eIsProxy()) {
			...
			if (scSyncReceive != oldScSyncReceive) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SC_SYNC_RECEIVE, oldScSyncReceive, scSyncReceive));
			}
		}
	...
	public void setScSyncReceive(Synchronization newScSyncReceive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SC_SYNC_RECEIVE, oldScSyncReceive, scSyncReceive));
	}
	...
	public Action getSfEntryAction() {
		if (sfEntryAction != null && ((EObject)sfEntryAction).eIsProxy()) {
			...
			if (sfEntryAction != oldSfEntryAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_ENTRY_ACTION, oldSfEntryAction, sfEntryAction));
			}
		}
	...
	public void setSfEntryAction(Action newSfEntryAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_ENTRY_ACTION, oldSfEntryAction, sfEntryAction));
	}
	...
	public Action getSfExitAction() {
		if (sfExitAction != null && ((EObject)sfExitAction).eIsProxy()) {
			...
			if (sfExitAction != oldSfExitAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_EXIT_ACTION, oldSfExitAction, sfExitAction));
			}
		}
		return sfExitAction;
	}
	...
	public void setSfExitAction(Action newSfExitAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_EXIT_ACTION, oldSfExitAction, sfExitAction));
	}
	...
	public Event getSfTransEvent() {
		if (sfTransEvent != null && ((EObject)sfTransEvent).eIsProxy()) {
			...
			if (sfTransEvent != oldSfTransEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_TRANS_EVENT, oldSfTransEvent, sfTransEvent));
			}
		}
		return sfTransEvent;
	}
	...
	public void setSfTransEvent(Event newSfTransEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_TRANS_EVENT, oldSfTransEvent, sfTransEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SC_SYNC_RECEIVE:
				if (resolve) return getScSyncReceive();
				return basicGetScSyncReceive();
			case Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_ENTRY_ACTION:
				if (resolve) return getSfEntryAction();
				return basicGetSfEntryAction();
			case Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_EXIT_ACTION:
				if (resolve) return getSfExitAction();
				return basicGetSfExitAction();
			case Behavior_modelPackage.SC_SYNC_RECEIVE2SF_SYNC_RECEIVE__SF_TRANS_EVENT:
