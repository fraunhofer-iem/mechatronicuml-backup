 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scAsyncRec2sfAsyncGuardImpl#getGuardAnnotation <em>Guard Annotation</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scAsyncRec2sfAsyncGuardImpl#getEAnnotation <em>EAnnotation</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scAsyncRec2sfAsyncGuardImpl#getAsynchronousMessageEvent <em>Asynchronous Message Event</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scAsyncRec2sfAsyncGuardImpl#getAsyncRecGuard <em>Async Rec Guard</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class scAsyncRec2sfAsyncGuardImpl extends AbstractContainerCorrespondenceNodeImpl implements scAsyncRec2sfAsyncGuard {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.SC_ASYNC_REC2SF_ASYNC_GUARD;
	}
		...
		if (guardAnnotation != null && ((EObject)guardAnnotation).eIsProxy()) {
			...
			if (guardAnnotation != oldGuardAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__GUARD_ANNOTATION, oldGuardAnnotation, guardAnnotation));
			}
		}
	...
	public void setGuardAnnotation(Map.Entry<String, String> newGuardAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__GUARD_ANNOTATION, oldGuardAnnotation, guardAnnotation));
	}
	...
	public EAnnotation getEAnnotation() {
		if (eAnnotation != null && eAnnotation.eIsProxy()) {
			...
			if (eAnnotation != oldEAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__EANNOTATION, oldEAnnotation, eAnnotation));
			}
		}
		return eAnnotation;
	}
	...
	public void setEAnnotation(EAnnotation newEAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__EANNOTATION, oldEAnnotation, eAnnotation));
	}
	...
	public AsynchronousMessageEvent getAsynchronousMessageEvent() {
		if (asynchronousMessageEvent != null && asynchronousMessageEvent.eIsProxy()) {
			...
			if (asynchronousMessageEvent != oldAsynchronousMessageEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__ASYNCHRONOUS_MESSAGE_EVENT, oldAsynchronousMessageEvent, asynchronousMessageEvent));
			}
		}
	...
	public void setAsynchronousMessageEvent(AsynchronousMessageEvent newAsynchronousMessageEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__ASYNCHRONOUS_MESSAGE_EVENT, oldAsynchronousMessageEvent, asynchronousMessageEvent));
	}
	...
	public Action getAsyncRecGuard() {
		if (asyncRecGuard != null && ((EObject)asyncRecGuard).eIsProxy()) {
			...
			if (asyncRecGuard != oldAsyncRecGuard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__ASYNC_REC_GUARD, oldAsyncRecGuard, asyncRecGuard));
			}
		}
	...
	public void setAsyncRecGuard(Action newAsyncRecGuard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__ASYNC_REC_GUARD, oldAsyncRecGuard, asyncRecGuard));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__GUARD_ANNOTATION:
				if (resolve) return getGuardAnnotation();
				return basicGetGuardAnnotation();
			case Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__EANNOTATION:
				if (resolve) return getEAnnotation();
				return basicGetEAnnotation();
			case Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__ASYNCHRONOUS_MESSAGE_EVENT:
				if (resolve) return getAsynchronousMessageEvent();
				return basicGetAsynchronousMessageEvent();
			case Behavior_modelPackage.SC_ASYNC_REC2SF_ASYNC_GUARD__ASYNC_REC_GUARD:
