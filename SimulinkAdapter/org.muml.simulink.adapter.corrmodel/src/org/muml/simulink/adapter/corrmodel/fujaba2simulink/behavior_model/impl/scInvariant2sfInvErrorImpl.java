 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scInvariant2sfInvErrorImpl#getScInvariant <em>Sc Invariant</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scInvariant2sfInvErrorImpl#getScBound <em>Sc Bound</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scInvariant2sfInvErrorImpl#getScClock <em>Sc Clock</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scInvariant2sfInvErrorImpl#getSfInvTrans <em>Sf Inv Trans</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scInvariant2sfInvErrorImpl#getSfInvGuard <em>Sf Inv Guard</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scInvariant2sfInvErrorImpl#getSfInvNode <em>Sf Inv Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class scInvariant2sfInvErrorImpl extends AbstractContainerCorrespondenceNodeImpl implements scInvariant2sfInvError {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.SC_INVARIANT2SF_INV_ERROR;
	}
		...
		if (scInvariant != null && scInvariant.eIsProxy()) {
			...
			if (scInvariant != oldScInvariant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_INVARIANT, oldScInvariant, scInvariant));
			}
		}
		return scInvariant;
	}
	...
	public void setScInvariant(ClockConstraint newScInvariant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_INVARIANT, oldScInvariant, scInvariant));
	}
	...
	public TimeValue getScBound() {
		if (scBound != null && scBound.eIsProxy()) {
			...
			if (scBound != oldScBound) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_BOUND, oldScBound, scBound));
			}
		}
		return scBound;
	}
	...
	public void setScBound(TimeValue newScBound) {
		...
		scBound = newScBound;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_BOUND, oldScBound, scBound));
	}
	...
	public Clock getScClock() {
		if (scClock != null && scClock.eIsProxy()) {
			...
			if (scClock != oldScClock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_CLOCK, oldScClock, scClock));
			}
		}
		return scClock;
	}
	...
	public void setScClock(Clock newScClock) {
		...
		scClock = newScClock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_CLOCK, oldScClock, scClock));
	}
	...
	public Transition getSfInvTrans() {
		if (sfInvTrans != null && ((EObject)sfInvTrans).eIsProxy()) {
			...
			if (sfInvTrans != oldSfInvTrans) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_TRANS, oldSfInvTrans, sfInvTrans));
			}
		}
		return sfInvTrans;
	}
	...
	public void setSfInvTrans(Transition newSfInvTrans) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_TRANS, oldSfInvTrans, sfInvTrans));
	}
	...
	public Action getSfInvGuard() {
		if (sfInvGuard != null && ((EObject)sfInvGuard).eIsProxy()) {
			...
			if (sfInvGuard != oldSfInvGuard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_GUARD, oldSfInvGuard, sfInvGuard));
			}
		}
		return sfInvGuard;
	}
	...
	public void setSfInvGuard(Action newSfInvGuard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_GUARD, oldSfInvGuard, sfInvGuard));
	}
	...
	public State getSfInvNode() {
		if (sfInvNode != null && ((EObject)sfInvNode).eIsProxy()) {
			...
			if (sfInvNode != oldSfInvNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_NODE, oldSfInvNode, sfInvNode));
			}
		}
		return sfInvNode;
	}
	...
	public void setSfInvNode(State newSfInvNode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_NODE, oldSfInvNode, sfInvNode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_INVARIANT:
				if (resolve) return getScInvariant();
				return basicGetScInvariant();
			case Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_BOUND:
				if (resolve) return getScBound();
				return basicGetScBound();
			case Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SC_CLOCK:
				if (resolve) return getScClock();
				return basicGetScClock();
			case Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_TRANS:
				if (resolve) return getSfInvTrans();
				return basicGetSfInvTrans();
			case Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_GUARD:
				if (resolve) return getSfInvGuard();
				return basicGetSfInvGuard();
			case Behavior_modelPackage.SC_INVARIANT2SF_INV_ERROR__SF_INV_NODE:
