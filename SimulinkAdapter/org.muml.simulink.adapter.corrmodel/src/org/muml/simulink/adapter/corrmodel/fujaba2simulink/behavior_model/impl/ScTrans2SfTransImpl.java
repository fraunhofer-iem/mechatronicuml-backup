 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScTrans2SfTransImpl#getScTrans <em>Sc Trans</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScTrans2SfTransImpl#getSfTrans <em>Sf Trans</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScTrans2SfTransImpl#getScReg <em>Sc Reg</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScTrans2SfTransImpl extends AbstractContainerCorrespondenceNodeImpl implements ScTrans2SfTrans {
	 ...
	 * @ordered
	 */
	protected org.muml.simulink.adapter.model.stateflow.Transition sfTrans;
	 ...
	 * @generated
	 */
	public org.muml.simulink.adapter.model.stateflow.Transition getSfTrans() {
		if (sfTrans != null && ((EObject)sfTrans).eIsProxy()) {
			InternalEObject oldSfTrans = (InternalEObject)sfTrans;
			sfTrans = (org.muml.simulink.adapter.model.stateflow.Transition)eResolveProxy(oldSfTrans);
	 ...
	 * @generated
	 */
	public org.muml.simulink.adapter.model.stateflow.Transition basicGetSfTrans() {
		return sfTrans;
	}
	 ...
	 * @generated
	 */
	public void setSfTrans(org.muml.simulink.adapter.model.stateflow.Transition newSfTrans) {
		org.muml.simulink.adapter.model.stateflow.Transition oldSfTrans = sfTrans;
		sfTrans = newSfTrans;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Behavior_modelPackage.SC_TRANS2_SF_TRANS__SC_TRANS:
				...
				return;
			case Behavior_modelPackage.SC_TRANS2_SF_TRANS__SF_TRANS:
				setSfTrans((org.muml.simulink.adapter.model.stateflow.Transition)newValue);
				return;
			case Behavior_modelPackage.SC_TRANS2_SF_TRANS__SC_REG:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Behavior_modelPackage.SC_TRANS2_SF_TRANS__SC_TRANS:
				...
				return;
			case Behavior_modelPackage.SC_TRANS2_SF_TRANS__SF_TRANS:
				setSfTrans((org.muml.simulink.adapter.model.stateflow.Transition)null);
				return;
			case Behavior_modelPackage.SC_TRANS2_SF_TRANS__SC_REG:
