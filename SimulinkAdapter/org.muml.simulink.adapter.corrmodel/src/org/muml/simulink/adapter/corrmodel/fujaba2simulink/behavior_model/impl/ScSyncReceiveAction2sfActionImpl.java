 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScSyncReceiveAction2sfActionImpl#getScAction <em>Sc Action</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScSyncReceiveAction2sfActionImpl#getScActionExpr <em>Sc Action Expr</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScSyncReceiveAction2sfActionImpl#getSfAction <em>Sf Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScSyncReceiveAction2sfActionImpl extends AbstractContainerCorrespondenceNodeImpl implements ScSyncReceiveAction2sfAction {
	 ...
	 * @ordered
	 */
	protected org.muml.simulink.adapter.model.stateflow.Action sfAction;
	 ...
	 * @generated
	 */
	public org.muml.simulink.adapter.model.stateflow.Action getSfAction() {
		if (sfAction != null && ((EObject)sfAction).eIsProxy()) {
			InternalEObject oldSfAction = (InternalEObject)sfAction;
			sfAction = (org.muml.simulink.adapter.model.stateflow.Action)eResolveProxy(oldSfAction);
	 ...
	 * @generated
	 */
	public org.muml.simulink.adapter.model.stateflow.Action basicGetSfAction() {
		return sfAction;
	}
	 ...
	 * @generated
	 */
	public void setSfAction(org.muml.simulink.adapter.model.stateflow.Action newSfAction) {
		org.muml.simulink.adapter.model.stateflow.Action oldSfAction = sfAction;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Behavior_modelPackage.SC_SYNC_RECEIVE_ACTION2SF_ACTION__SC_ACTION_EXPR:
				...
				return;
			case Behavior_modelPackage.SC_SYNC_RECEIVE_ACTION2SF_ACTION__SF_ACTION:
				setSfAction((org.muml.simulink.adapter.model.stateflow.Action)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case Behavior_modelPackage.SC_SYNC_RECEIVE_ACTION2SF_ACTION__SC_ACTION_EXPR:
				...
				return;
			case Behavior_modelPackage.SC_SYNC_RECEIVE_ACTION2SF_ACTION__SF_ACTION:
				setSfAction((org.muml.simulink.adapter.model.stateflow.Action)null);
				return;
		}
