 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scGuard2sfGuardImpl#getSfGuard <em>Sf Guard</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scGuard2sfGuardImpl#getScAnnotation <em>Sc Annotation</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.scGuard2sfGuardImpl#getScDetails <em>Sc Details</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class scGuard2sfGuardImpl extends AbstractContainerCorrespondenceNodeImpl implements scGuard2sfGuard {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.SC_GUARD2SF_GUARD;
	}
		...
		if (sfGuard != null && ((EObject)sfGuard).eIsProxy()) {
			...
			if (sfGuard != oldSfGuard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_GUARD2SF_GUARD__SF_GUARD, oldSfGuard, sfGuard));
			}
		}
		return sfGuard;
	}
	...
	public void setSfGuard(Action newSfGuard) {
		...
		sfGuard = newSfGuard;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_GUARD2SF_GUARD__SF_GUARD, oldSfGuard, sfGuard));
	}
	...
	public EAnnotation getScAnnotation() {
		if (scAnnotation != null && scAnnotation.eIsProxy()) {
			...
			if (scAnnotation != oldScAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_GUARD2SF_GUARD__SC_ANNOTATION, oldScAnnotation, scAnnotation));
			}
		}
		return scAnnotation;
	}
	...
	public void setScAnnotation(EAnnotation newScAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_GUARD2SF_GUARD__SC_ANNOTATION, oldScAnnotation, scAnnotation));
	}
	...
	public Map.Entry<String, String> getScDetails() {
		if (scDetails != null && ((EObject)scDetails).eIsProxy()) {
			...
			if (scDetails != oldScDetails) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.SC_GUARD2SF_GUARD__SC_DETAILS, oldScDetails, scDetails));
			}
		}
		return scDetails;
	}
	...
	public void setScDetails(Map.Entry<String, String> newScDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.SC_GUARD2SF_GUARD__SC_DETAILS, oldScDetails, scDetails));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.SC_GUARD2SF_GUARD__SF_GUARD:
				if (resolve) return getSfGuard();
				return basicGetSfGuard();
			case Behavior_modelPackage.SC_GUARD2SF_GUARD__SC_ANNOTATION:
				if (resolve) return getScAnnotation();
				return basicGetScAnnotation();
			case Behavior_modelPackage.SC_GUARD2SF_GUARD__SC_DETAILS:
