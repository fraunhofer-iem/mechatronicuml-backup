...
import org.muml.simulink.adapter.corrmodel.fujaba2simulink.impl.AbstractContainerCorrespondenceNodeImpl;
 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.FRtSc2ChartImpl#getChart <em>Chart</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.FRtSc2ChartImpl#getFRtSc <em>FRt Sc</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.FRtSc2ChartImpl#getMt_par <em>Mt par</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.FRtSc2ChartImpl#getSfChartState <em>Sf Chart State</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.FRtSc2ChartImpl#getSfChartRegion <em>Sf Chart Region</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.FRtSc2ChartImpl#getSfQueueRegion <em>Sf Queue Region</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.FRtSc2ChartImpl#getSfSelfTrans <em>Sf Self Trans</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FRtSc2ChartImpl extends AbstractContainerCorrespondenceNodeImpl implements FRtSc2Chart {
	...
	protected EClass eStaticClass() {
		return Behavior_modelPackage.Literals.FRT_SC2_CHART;
	}
		...
		if (chart != null && ((EObject)chart).eIsProxy()) {
			...
			if (chart != oldChart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.FRT_SC2_CHART__CHART, oldChart, chart));
			}
		}
		return chart;
	}
	...
	public void setChart(Chart newChart) {
		...
		chart = newChart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.FRT_SC2_CHART__CHART, oldChart, chart));
	}
	...
	public RealtimeStatechart getFRtSc() {
		if (fRtSc != null && fRtSc.eIsProxy()) {
			...
			if (fRtSc != oldFRtSc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.FRT_SC2_CHART__FRT_SC, oldFRtSc, fRtSc));
			}
		}
		return fRtSc;
	}
	...
	public void setFRtSc(RealtimeStatechart newFRtSc) {
		...
		fRtSc = newFRtSc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.FRT_SC2_CHART__FRT_SC, oldFRtSc, fRtSc));
	}
	...
	public EList<MT_Par2MTD> getMt_par() {
		if (mt_par == null) {
			mt_par = new EObjectResolvingEList<MT_Par2MTD>(MT_Par2MTD.class, this, Behavior_modelPackage.FRT_SC2_CHART__MT_PAR);
		}
		return mt_par;
	}
	...
	public State getSfChartState() {
		if (sfChartState != null && ((EObject)sfChartState).eIsProxy()) {
			...
			if (sfChartState != oldSfChartState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.FRT_SC2_CHART__SF_CHART_STATE, oldSfChartState, sfChartState));
			}
		}
		return sfChartState;
	}
	...
	public void setSfChartState(State newSfChartState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.FRT_SC2_CHART__SF_CHART_STATE, oldSfChartState, sfChartState));
	}
	...
	public State getSfChartRegion() {
		if (sfChartRegion != null && ((EObject)sfChartRegion).eIsProxy()) {
			...
			if (sfChartRegion != oldSfChartRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.FRT_SC2_CHART__SF_CHART_REGION, oldSfChartRegion, sfChartRegion));
			}
		}
	...
	public void setSfChartRegion(State newSfChartRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.FRT_SC2_CHART__SF_CHART_REGION, oldSfChartRegion, sfChartRegion));
	}
	...
	public State getSfQueueRegion() {
		if (sfQueueRegion != null && ((EObject)sfQueueRegion).eIsProxy()) {
			...
			if (sfQueueRegion != oldSfQueueRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.FRT_SC2_CHART__SF_QUEUE_REGION, oldSfQueueRegion, sfQueueRegion));
			}
		}
	...
	public void setSfQueueRegion(State newSfQueueRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.FRT_SC2_CHART__SF_QUEUE_REGION, oldSfQueueRegion, sfQueueRegion));
	}
	...
	public Transition getSfSelfTrans() {
		if (sfSelfTrans != null && ((EObject)sfSelfTrans).eIsProxy()) {
			...
			if (sfSelfTrans != oldSfSelfTrans) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Behavior_modelPackage.FRT_SC2_CHART__SF_SELF_TRANS, oldSfSelfTrans, sfSelfTrans));
			}
		}
		return sfSelfTrans;
	}
	...
	public void setSfSelfTrans(Transition newSfSelfTrans) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Behavior_modelPackage.FRT_SC2_CHART__SF_SELF_TRANS, oldSfSelfTrans, sfSelfTrans));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Behavior_modelPackage.FRT_SC2_CHART__CHART:
				if (resolve) return getChart();
				return basicGetChart();
			case Behavior_modelPackage.FRT_SC2_CHART__FRT_SC:
				if (resolve) return getFRtSc();
				return basicGetFRtSc();
			case Behavior_modelPackage.FRT_SC2_CHART__MT_PAR:
				return getMt_par();
			case Behavior_modelPackage.FRT_SC2_CHART__SF_CHART_STATE:
				if (resolve) return getSfChartState();
				return basicGetSfChartState();
			case Behavior_modelPackage.FRT_SC2_CHART__SF_CHART_REGION:
				if (resolve) return getSfChartRegion();
				return basicGetSfChartRegion();
			case Behavior_modelPackage.FRT_SC2_CHART__SF_QUEUE_REGION:
				if (resolve) return getSfQueueRegion();
				return basicGetSfQueueRegion();
			case Behavior_modelPackage.FRT_SC2_CHART__SF_SELF_TRANS:
