 ...
 * <ul>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScState2SfStateImpl#getScState <em>Sc State</em>}</li>
 *   <li>{@link org.muml.simulink.adapter.corrmodel.fujaba2simulink.behavior_model.impl.ScState2SfStateImpl#getSfState <em>Sf State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScState2SfStateImpl extends AbstractContainerCorrespondenceNodeImpl implements ScState2SfState {
	 ...
	 * @ordered
	 */
	protected org.muml.simulink.adapter.model.stateflow.State sfState;
	 ...
	 * @generated
	 */
	public org.muml.simulink.adapter.model.stateflow.State getSfState() {
		if (sfState != null && ((EObject)sfState).eIsProxy()) {
			InternalEObject oldSfState = (InternalEObject)sfState;
			sfState = (org.muml.simulink.adapter.model.stateflow.State)eResolveProxy(oldSfState);
	 ...
	 * @generated
	 */
	public org.muml.simulink.adapter.model.stateflow.State basicGetSfState() {
		return sfState;
	}
	 ...
	 * @generated
	 */
	public void setSfState(org.muml.simulink.adapter.model.stateflow.State newSfState) {
		org.muml.simulink.adapter.model.stateflow.State oldSfState = sfState;
		sfState = newSfState;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Behavior_modelPackage.SC_STATE2_SF_STATE__SC_STATE:
				...
				return;
			case Behavior_modelPackage.SC_STATE2_SF_STATE__SF_STATE:
				setSfState((org.muml.simulink.adapter.model.stateflow.State)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Behavior_modelPackage.SC_STATE2_SF_STATE__SC_STATE:
				...
				return;
			case Behavior_modelPackage.SC_STATE2_SF_STATE__SF_STATE:
				setSfState((org.muml.simulink.adapter.model.stateflow.State)null);
				return;
		}
