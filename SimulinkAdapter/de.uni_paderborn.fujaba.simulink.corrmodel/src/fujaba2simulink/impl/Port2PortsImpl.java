 ...
 * <ul>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getInPort <em>In Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getOutPort <em>Out Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getPort <em>Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getHelp_inPort <em>Help in Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getHelp_outPort <em>Help out Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getPortInst <em>Port Inst</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getMultiPortInst <em>Multi Port Inst</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getCompInst <em>Comp Inst</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_ReadIn <em>Sc Read In</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_ReadOut <em>Sc Read Out</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_WriteIn <em>Sc Write In</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_WriteOut <em>Sc Write Out</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_help_ReadIn <em>Sc help Read In</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_help_ReadOut <em>Sc help Read Out</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_help_WriteIn <em>Sc help Write In</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getSc_help_WriteOut <em>Sc help Write Out</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getMi <em>Mi</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getNet_address_inPort <em>Net address in Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getReceiver_net_address_inPort <em>Receiver net address in Port</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getConstant <em>Constant</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getPortType <em>Port Type</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getLineFromReadOut <em>Line From Read Out</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getLineToReadIn <em>Line To Read In</em>}</li>
 *   <li>{@link fujaba2simulink.impl.Port2PortsImpl#getLinkLayer <em>Link Layer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
