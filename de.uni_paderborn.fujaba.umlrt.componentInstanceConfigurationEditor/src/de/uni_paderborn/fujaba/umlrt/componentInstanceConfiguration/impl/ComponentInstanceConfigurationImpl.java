 ...
 *   <li>{@link de.uni_paderborn.fujaba.umlrt.componentInstanceConfiguration.impl.ComponentInstanceConfigurationImpl#getConnectorInstances <em>Connector Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentInstanceConfigurationImpl extends NamedElementImpl implements ComponentInstanceConfiguration {
	...
	public EList<ConnectorInstance> getConnectorInstances() {
		if (connectorInstances == null) {
			connectorInstances = new EObjectContainmentEList<ConnectorInstance>(ConnectorInstance.class, this, componentInstanceConfigurationPackage.COMPONENT_INSTANCE_CONFIGURATION__CONNECTOR_INSTANCES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case componentInstanceConfigurationPackage.COMPONENT_INSTANCE_CONFIGURATION__CONNECTOR_INSTANCES:
