/**
 */
package de.uni_paderborn.fujaba.muml.psm.apiexpressions.provider;
...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.psm.apiexpressions.APICallExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class APICallExpressionItemProvider extends ExpressionItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addApiCommandPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Api Command feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addApiCommandPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_APICallExpression_apiCommand_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_APICallExpression_apiCommand_feature", "_UI_APICallExpression_type"),
				 ApiexpressionsPackage.Literals.API_CALL_EXPRESSION__API_COMMAND,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParameterBindingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_APICallExpression_parameterBindings_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_APICallExpression_parameterBindings_feature", "_UI_APICallExpression_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApiexpressionsPackage.Literals.API_CALL_EXPRESSION__PARAMETER_BINDINGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(APICallExpression.class)) {
