...
public interface PatternsExpressionsPackage extends EPackage {
	 ...
	 * @generated
	 */
	PatternsExpressionsPackage eINSTANCE = org.storydriven.storydiagrams.patterns.expressions.impl.PatternsExpressionsPackageImpl
			.init();
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ECLASS = ExpressionsPackage.EXPRESSION___ECLASS;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___EIS_PROXY = ExpressionsPackage.EXPRESSION___EIS_PROXY;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ERESOURCE = ExpressionsPackage.EXPRESSION___ERESOURCE;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ECONTAINER = ExpressionsPackage.EXPRESSION___ECONTAINER;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ECONTAINING_FEATURE = ExpressionsPackage.EXPRESSION___ECONTAINING_FEATURE;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ECONTAINMENT_FEATURE = ExpressionsPackage.EXPRESSION___ECONTAINMENT_FEATURE;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ECONTENTS = ExpressionsPackage.EXPRESSION___ECONTENTS;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___EALL_CONTENTS = ExpressionsPackage.EXPRESSION___EALL_CONTENTS;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ECROSS_REFERENCES = ExpressionsPackage.EXPRESSION___ECROSS_REFERENCES;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___EGET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EGET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___EGET__ESTRUCTURALFEATURE_BOOLEAN = ExpressionsPackage.EXPRESSION___EGET__ESTRUCTURALFEATURE_BOOLEAN;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___ESET__ESTRUCTURALFEATURE_OBJECT = ExpressionsPackage.EXPRESSION___ESET__ESTRUCTURALFEATURE_OBJECT;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___EIS_SET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EIS_SET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___EUNSET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EUNSET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___EINVOKE__EOPERATION_ELIST = ExpressionsPackage.EXPRESSION___EINVOKE__EOPERATION_ELIST;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___PROVIDE_EXTENSION__ECLASS = ExpressionsPackage.EXPRESSION___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___GET_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int ATTRIBUTE_VALUE_EXPRESSION___PROVIDE_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___PROVIDE_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ECLASS = ExpressionsPackage.EXPRESSION___ECLASS;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___EIS_PROXY = ExpressionsPackage.EXPRESSION___EIS_PROXY;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ERESOURCE = ExpressionsPackage.EXPRESSION___ERESOURCE;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ECONTAINER = ExpressionsPackage.EXPRESSION___ECONTAINER;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ECONTAINING_FEATURE = ExpressionsPackage.EXPRESSION___ECONTAINING_FEATURE;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ECONTAINMENT_FEATURE = ExpressionsPackage.EXPRESSION___ECONTAINMENT_FEATURE;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ECONTENTS = ExpressionsPackage.EXPRESSION___ECONTENTS;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___EALL_CONTENTS = ExpressionsPackage.EXPRESSION___EALL_CONTENTS;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ECROSS_REFERENCES = ExpressionsPackage.EXPRESSION___ECROSS_REFERENCES;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___EGET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EGET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___EGET__ESTRUCTURALFEATURE_BOOLEAN = ExpressionsPackage.EXPRESSION___EGET__ESTRUCTURALFEATURE_BOOLEAN;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___ESET__ESTRUCTURALFEATURE_OBJECT = ExpressionsPackage.EXPRESSION___ESET__ESTRUCTURALFEATURE_OBJECT;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___EIS_SET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EIS_SET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___EUNSET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EUNSET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___EINVOKE__EOPERATION_ELIST = ExpressionsPackage.EXPRESSION___EINVOKE__EOPERATION_ELIST;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___PROVIDE_EXTENSION__ECLASS = ExpressionsPackage.EXPRESSION___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___GET_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int OBJECT_VARIABLE_EXPRESSION___PROVIDE_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___PROVIDE_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ECLASS = ExpressionsPackage.EXPRESSION___ECLASS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___EIS_PROXY = ExpressionsPackage.EXPRESSION___EIS_PROXY;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ERESOURCE = ExpressionsPackage.EXPRESSION___ERESOURCE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ECONTAINER = ExpressionsPackage.EXPRESSION___ECONTAINER;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ECONTAINING_FEATURE = ExpressionsPackage.EXPRESSION___ECONTAINING_FEATURE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ECONTAINMENT_FEATURE = ExpressionsPackage.EXPRESSION___ECONTAINMENT_FEATURE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ECONTENTS = ExpressionsPackage.EXPRESSION___ECONTENTS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___EALL_CONTENTS = ExpressionsPackage.EXPRESSION___EALL_CONTENTS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ECROSS_REFERENCES = ExpressionsPackage.EXPRESSION___ECROSS_REFERENCES;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___EGET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EGET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___EGET__ESTRUCTURALFEATURE_BOOLEAN = ExpressionsPackage.EXPRESSION___EGET__ESTRUCTURALFEATURE_BOOLEAN;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___ESET__ESTRUCTURALFEATURE_OBJECT = ExpressionsPackage.EXPRESSION___ESET__ESTRUCTURALFEATURE_OBJECT;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___EIS_SET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EIS_SET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___EUNSET__ESTRUCTURALFEATURE = ExpressionsPackage.EXPRESSION___EUNSET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___EINVOKE__EOPERATION_ELIST = ExpressionsPackage.EXPRESSION___EINVOKE__EOPERATION_ELIST;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___PROVIDE_EXTENSION__ECLASS = ExpressionsPackage.EXPRESSION___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___GET_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_VARIABLE_EXPRESSION___PROVIDE_ANNOTATION__STRING = ExpressionsPackage.EXPRESSION___PROVIDE_ANNOTATION__STRING;
