 ...
 * <ul>
 *   <li>{@link org.storydriven.storydiagrams.patterns.Path#getPathExpression <em>Path Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.storydriven.storydiagrams.patterns.PatternsPackage#getPath()
 * @model
 * @generated
 */
public interface Path extends AbstractLinkVariable {
	...
	/**
	 * Sets the value of the '{@link org.storydriven.storydiagrams.patterns.Path#getPathExpression <em>Path Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
