 ...
 * <ul>
 *   <li>{@link org.storydriven.storydiagrams.calls.expressions.impl.MethodCallExpressionImpl#getOwnedParameterBindings <em>Owned Parameter Bindings</em>}</li>
 *   <li>{@link org.storydriven.storydiagrams.calls.expressions.impl.MethodCallExpressionImpl#getCallee <em>Callee</em>}</li>
 *   <li>{@link org.storydriven.storydiagrams.calls.expressions.impl.MethodCallExpressionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.storydriven.storydiagrams.calls.expressions.impl.MethodCallExpressionImpl#getOpaqueCallable <em>Opaque Callable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Invocation.class) {
			...
			case CallsPackage.INVOCATION__OWNED_PARAMETER_BINDINGS:
				return CallsExpressionsPackage.METHOD_CALL_EXPRESSION__OWNED_PARAMETER_BINDINGS;
			case CallsPackage.INVOCATION__CALLEE:
				return CallsExpressionsPackage.METHOD_CALL_EXPRESSION__CALLEE;
			default:
				return -1;
			}
		}
