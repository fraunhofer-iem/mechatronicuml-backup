 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.storydiagram.templates.impl.PropertyBindingImpl#getBoundProperty <em>Bound Property</em>}</li>
 *   <li>{@link org.muml.storydiagram.templates.impl.PropertyBindingImpl#getBindingExpression <em>Binding Expression</em>}</li>
 *   <li>{@link org.muml.storydiagram.templates.impl.PropertyBindingImpl#getTemplateBinding <em>Template Binding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyBindingImpl extends ExtendableElementImpl implements
		...
		if (boundProperty != null && boundProperty.eIsProxy()) {
			...
			if (boundProperty != oldBoundProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TemplatesPackage.PROPERTY_BINDING__BOUND_PROPERTY, oldBoundProperty, boundProperty));
			}
		}
	...
	public void setBoundProperty(EStructuralFeature newBoundProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatesPackage.PROPERTY_BINDING__BOUND_PROPERTY, oldBoundProperty, boundProperty));
	}
	...
	public NotificationChain basicSetBindingExpression(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemplatesPackage.PROPERTY_BINDING__BINDING_EXPRESSION, oldBindingExpression, newBindingExpression);
	...
	public void setBindingExpression(Expression newBindingExpression) {
		if (newBindingExpression != bindingExpression) {
			...
			if (bindingExpression != null)
				msgs = ((InternalEObject)bindingExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemplatesPackage.PROPERTY_BINDING__BINDING_EXPRESSION, null, msgs);
			if (newBindingExpression != null)
				msgs = ((InternalEObject)newBindingExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemplatesPackage.PROPERTY_BINDING__BINDING_EXPRESSION, null, msgs);
			msgs = basicSetBindingExpression(newBindingExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatesPackage.PROPERTY_BINDING__BINDING_EXPRESSION, newBindingExpression, newBindingExpression));
	}
	...
	public TemplateBinding getTemplateBinding() {
		if (eContainerFeatureID() != TemplatesPackage.PROPERTY_BINDING__TEMPLATE_BINDING) return null;
	...
	public NotificationChain basicSetTemplateBinding(
		...
		msgs = eBasicSetContainer((InternalEObject)newTemplateBinding, TemplatesPackage.PROPERTY_BINDING__TEMPLATE_BINDING, msgs);
		return msgs;
	}
	...
	public void setTemplateBinding(TemplateBinding newTemplateBinding) {
		if (newTemplateBinding != eInternalContainer() || (eContainerFeatureID() != TemplatesPackage.PROPERTY_BINDING__TEMPLATE_BINDING && newTemplateBinding != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatesPackage.PROPERTY_BINDING__TEMPLATE_BINDING, newTemplateBinding, newTemplateBinding));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TemplatesPackage.PROPERTY_BINDING__BOUND_PROPERTY:
				if (resolve) return getBoundProperty();
