...
import org.muml.storydiagram.calls.expressions.ExpressionsFactory;
...
public class ExpressionsPackageImpl extends EPackageImpl implements ExpressionsPackage {
	 ...
	 * @see org.muml.storydiagram.calls.expressions.ExpressionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		methodCallExpressionEClass.getESuperTypes().add(theExpressionsPackage_3.getExpression());
		methodCallExpressionEClass.getESuperTypes().add(theCallsPackage.getInvocation());
		parameterExpressionEClass.getESuperTypes().add(theExpressionsPackage_3.getExpression());
		...
		initEReference(getMethodCallExpression_Target(), theExpressionsPackage_3.getExpression(), null, "target", null, 0, 1, MethodCallExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
