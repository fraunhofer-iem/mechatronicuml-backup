 ...
 * @generated
 */
public class StorydiagramSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static StorydiagramPackage modelPackage;
	 ...
	 * @generated
	 */
	public StorydiagramSwitch() {
		if (modelPackage == null) {
			modelPackage = StorydiagramPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StorydiagramPackage.VARIABLE: {
			...
			case StorydiagramPackage.SDM_EXTENSION: {
				SDMExtension sdmExtension = (SDMExtension)theEObject;
				T result = caseSDMExtension(sdmExtension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
