 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.storydiagram.patterns.impl.LinkConstraintImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.muml.storydiagram.patterns.impl.LinkConstraintImpl#getConstraintType <em>Constraint Type</em>}</li>
 *   <li>{@link org.muml.storydiagram.patterns.impl.LinkConstraintImpl#isNegative <em>Negative</em>}</li>
 *   <li>{@link org.muml.storydiagram.patterns.impl.LinkConstraintImpl#getFirstLink <em>First Link</em>}</li>
 *   <li>{@link org.muml.storydiagram.patterns.impl.LinkConstraintImpl#getReferencingObject <em>Referencing Object</em>}</li>
 *   <li>{@link org.muml.storydiagram.patterns.impl.LinkConstraintImpl#getSecondLink <em>Second Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkConstraintImpl extends ExtendableElementImpl implements
	...
	public void setFirstLink(AbstractLinkVariable newFirstLink) {
		if (newFirstLink != firstLink) {
			...
			if (firstLink != null)
				msgs = ((InternalEObject)firstLink).eInverseRemove(this, PatternsPackage.ABSTRACT_LINK_VARIABLE__FIRST_LINK_CONSTRAINTS, AbstractLinkVariable.class, msgs);
			if (newFirstLink != null)
				msgs = ((InternalEObject)newFirstLink).eInverseAdd(this, PatternsPackage.ABSTRACT_LINK_VARIABLE__FIRST_LINK_CONSTRAINTS, AbstractLinkVariable.class, msgs);
	...
	public void setSecondLink(AbstractLinkVariable newSecondLink) {
		if (newSecondLink != secondLink) {
			NotificationChain msgs = null;
			if (secondLink != null)
				msgs = ((InternalEObject)secondLink).eInverseRemove(this, PatternsPackage.ABSTRACT_LINK_VARIABLE__SECOND_LINK_CONSTRAINTS, AbstractLinkVariable.class, msgs);
			if (newSecondLink != null)
				msgs = ((InternalEObject)newSecondLink).eInverseAdd(this, PatternsPackage.ABSTRACT_LINK_VARIABLE__SECOND_LINK_CONSTRAINTS, AbstractLinkVariable.class, msgs);
