 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.storydiagram.patterns.impl.ConstraintImpl#getConstraintExpression <em>Constraint Expression</em>}</li>
 *   <li>{@link org.muml.storydiagram.patterns.impl.ConstraintImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link org.muml.storydiagram.patterns.impl.ConstraintImpl#getObjectVariable <em>Object Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint {
	...
	public NotificationChain basicSetConstraintExpression(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatternsPackage.CONSTRAINT__CONSTRAINT_EXPRESSION, oldConstraintExpression, newConstraintExpression);
	...
	public void setConstraintExpression(Expression newConstraintExpression) {
		if (newConstraintExpression != constraintExpression) {
			...
			if (constraintExpression != null)
				msgs = ((InternalEObject)constraintExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatternsPackage.CONSTRAINT__CONSTRAINT_EXPRESSION, null, msgs);
			if (newConstraintExpression != null)
				msgs = ((InternalEObject)newConstraintExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatternsPackage.CONSTRAINT__CONSTRAINT_EXPRESSION, null, msgs);
			msgs = basicSetConstraintExpression(newConstraintExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatternsPackage.CONSTRAINT__CONSTRAINT_EXPRESSION, newConstraintExpression, newConstraintExpression));
	}
	...
	public StoryPattern getPattern() {
		if (eContainerFeatureID() != PatternsPackage.CONSTRAINT__PATTERN) return null;
	...
	public void setPattern(StoryPattern newPattern) {
		if (newPattern != eInternalContainer() || (eContainerFeatureID() != PatternsPackage.CONSTRAINT__PATTERN && newPattern != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PatternsPackage.CONSTRAINT__PATTERN, newPattern, newPattern));
	}
	...
	public AbstractVariable getObjectVariable() {
		if (eContainerFeatureID() != PatternsPackage.CONSTRAINT__OBJECT_VARIABLE) return null;
	...
	public void setObjectVariable(AbstractVariable newObjectVariable) {
		if (newObjectVariable != eInternalContainer() || (eContainerFeatureID() != PatternsPackage.CONSTRAINT__OBJECT_VARIABLE && newObjectVariable != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PatternsPackage.CONSTRAINT__OBJECT_VARIABLE, newObjectVariable, newObjectVariable));
	}
