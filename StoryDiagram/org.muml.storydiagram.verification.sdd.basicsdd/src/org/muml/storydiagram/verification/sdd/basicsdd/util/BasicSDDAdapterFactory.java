 ...
 * @generated
 */
public class BasicSDDAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected BasicSDDSwitch<Adapter> modelSwitch =
		new BasicSDDSwitch<Adapter>() {
			@Override
			public Adapter caseStoryDecisionDiagram(StoryDecisionDiagram object) {
				return createStoryDecisionDiagramAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseAbstractStoryDecisionDiagram(de.uni_paderborn.fujaba.muml.verification.sdd.AbstractStoryDecisionDiagram object) {
				return createAbstractStoryDecisionDiagramAdapter();
			}
			@Override
			public Adapter caseNode(de.uni_paderborn.fujaba.muml.verification.sdd.Node object) {
				return createNodeAdapter();
			}
			@Override
			public Adapter casePatternNode(de.uni_paderborn.fujaba.muml.verification.sdd.PatternNode object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.muml.storydiagram.verification.sdd.basicsdd.StoryDecisionDiagram <em>Story Decision Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStoryDecisionDiagramAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.muml.storydiagram.verification.sdd.basicsdd.StoryPatternNode <em>Story Pattern Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
