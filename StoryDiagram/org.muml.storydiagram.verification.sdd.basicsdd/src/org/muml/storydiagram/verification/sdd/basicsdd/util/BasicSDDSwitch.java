 ...
 * @generated
 */
public class BasicSDDSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static BasicSDDPackage modelPackage;
	 ...
	 * @generated
	 */
	public BasicSDDSwitch() {
		if (modelPackage == null) {
			modelPackage = BasicSDDPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicSDDPackage.STORY_DECISION_DIAGRAM: {
				StoryDecisionDiagram storyDecisionDiagram = (StoryDecisionDiagram)theEObject;
				T result = caseStoryDecisionDiagram(storyDecisionDiagram);
				if (result == null) result = caseAbstractStoryDecisionDiagram(storyDecisionDiagram);
				if (result == null) result = caseNamedElement(storyDecisionDiagram);
				if (result == null) result = caseExtendableElement(storyDecisionDiagram);
			...
			case BasicSDDPackage.STORY_PATTERN_NODE: {
				...
				if (result == null) result = casePatternNode(storyPatternNode);
				if (result == null) result = caseNode(storyPatternNode);
				if (result == null) result = caseNamedElement(storyPatternNode);
				if (result == null) result = caseExtendableElement(storyPatternNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Story Decision Diagram</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Story Decision Diagram</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStoryDecisionDiagram(StoryDecisionDiagram object) {
		return null;
	}
