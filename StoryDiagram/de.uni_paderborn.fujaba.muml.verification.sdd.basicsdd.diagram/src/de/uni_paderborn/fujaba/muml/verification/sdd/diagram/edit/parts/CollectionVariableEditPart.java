...
public class CollectionVariableEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		installEditPolicy(
				...
				new CreationEditPolicyWithCustomReparent(
						de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry.TYPED_INSTANCE));
		super.createDefaultEditPolicies();
		installEditPolicy(
				EditPolicyRoles.SEMANTIC_ROLE,
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.CollectionVariableItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabelEditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getCollectionVariableOperatorLabel());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableNameEditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getCollectionVariableNameLabel());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabel2EditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabel2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getCollectionVariableTypeLabel());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getCollectionVariableConstraintsRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getCollectionVariableAttributeAssignmentsRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getCollectionVariableConstraintsRectangle();
			pane.remove(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getCollectionVariableAttributeAssignmentsRectangle();
			pane.remove(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableConstraintsCompartmentEditPart) {
			return getPrimaryShape()
					.getCollectionVariableConstraintsRectangle();
		}
		if (editPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentEditPart) {
			return getPrimaryShape()
					.getCollectionVariableAttributeAssignmentsRectangle();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == de.uni_paderborn.fujaba.muml.verification.sdd.diagram.providers.BasicSDDElementTypes.Constraint_3008) {
				return getChildBySemanticHint(de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
			...
			if (type == de.uni_paderborn.fujaba.muml.verification.sdd.diagram.providers.BasicSDDElementTypes.AttributeAssignment_3007) {
				return getChildBySemanticHint(de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
