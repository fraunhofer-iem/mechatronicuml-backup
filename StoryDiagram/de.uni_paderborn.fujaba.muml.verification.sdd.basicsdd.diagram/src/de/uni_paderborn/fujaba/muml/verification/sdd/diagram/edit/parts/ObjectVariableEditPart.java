...
public class ObjectVariableEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.ObjectVariableItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabel3EditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabel3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getObjectVariableOperatorLabel());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableNameEditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getObjectVariableNameLabel());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabel4EditPart) {
			((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.WrappingLabel4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getObjectVariableTypeLabel());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getObjectVariableConstraintsRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableAttributeAssignmentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getObjectVariableAttributeAssignmentsRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableAttributeAssignmentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getObjectVariableConstraintsRectangle();
			pane.remove(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableAttributeAssignmentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getObjectVariableAttributeAssignmentsRectangle();
			pane.remove(((de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableAttributeAssignmentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableConstraintsCompartmentEditPart) {
			return getPrimaryShape().getObjectVariableConstraintsRectangle();
		}
		if (editPart instanceof de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.ObjectVariableObjectVariableAttributeAssignmentsCompartmentEditPart) {
