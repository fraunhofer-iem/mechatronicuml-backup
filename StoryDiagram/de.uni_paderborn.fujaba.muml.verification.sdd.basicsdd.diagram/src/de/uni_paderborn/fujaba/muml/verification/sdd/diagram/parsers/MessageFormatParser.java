package de.uni_paderborn.fujaba.muml.verification.sdd.diagram.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.Messages.MessageFormatParser_InvalidInputError,
