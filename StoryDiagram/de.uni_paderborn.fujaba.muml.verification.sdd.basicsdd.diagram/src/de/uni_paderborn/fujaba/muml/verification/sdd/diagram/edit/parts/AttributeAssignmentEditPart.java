...
public class AttributeAssignmentEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.AttributeAssignmentItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.BasicSDDTextNonResizableEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = de.uni_paderborn.fujaba.muml.verification.sdd.diagram.providers.BasicSDDParserProvider
					.getParser(
