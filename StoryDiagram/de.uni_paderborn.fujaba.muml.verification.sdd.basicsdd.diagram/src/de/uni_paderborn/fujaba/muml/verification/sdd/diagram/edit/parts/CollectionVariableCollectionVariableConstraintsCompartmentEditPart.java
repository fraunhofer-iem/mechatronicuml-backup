...
public class CollectionVariableCollectionVariableConstraintsCompartmentEditPart
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.Messages.CollectionVariableCollectionVariableConstraintsCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.CollectionVariableCollectionVariableConstraintsCompartmentItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.CollectionVariableCollectionVariableConstraintsCompartmentCanonicalEditPolicy());
	}
