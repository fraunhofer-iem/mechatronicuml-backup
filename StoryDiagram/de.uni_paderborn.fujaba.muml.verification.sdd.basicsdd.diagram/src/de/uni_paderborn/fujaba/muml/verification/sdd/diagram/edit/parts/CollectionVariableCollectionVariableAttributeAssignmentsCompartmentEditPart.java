...
public class CollectionVariableCollectionVariableAttributeAssignmentsCompartmentEditPart
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.Messages.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.CollectionVariableCollectionVariableAttributeAssignmentsCompartmentCanonicalEditPolicy());
	}
