 ...
 * @param <Classifier>
 */
public class LinkCheckSuccessfulNotification<StoryPatternObject, StoryPatternLink, Classifier> extends InterpreterNotification<Classifier>
{
	...
	public LinkCheckSuccessfulNotification(
	...
	{
		super(NotificationTypeEnum.LINK_CHECK_SUCCESSFUL, variablesScope, notifier);
