...
/**
 * This is the action bar contributor for the ExecutionTrace model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecutionTraceActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
	/**
	 ...
	 * @generated
	 */
	public ExecutionTraceActionBarContributor()
	{
	...
	{
		toolBarManager.add(new Separator("executiontrace-settings"));
		toolBarManager.add(new Separator("executiontrace-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(ExecutionTraceEditorPlugin.INSTANCE.getString("_UI_ExecutionTraceEditor_menu"),
				"de.mdelab.sdm.interpreter.core.executionTraceMenuID");
		...
		//
		createChildMenuManager = new MenuManager(ExecutionTraceEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(ExecutionTraceEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager)
	{
		...
		submenuManager = new MenuManager(ExecutionTraceEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(ExecutionTraceEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
