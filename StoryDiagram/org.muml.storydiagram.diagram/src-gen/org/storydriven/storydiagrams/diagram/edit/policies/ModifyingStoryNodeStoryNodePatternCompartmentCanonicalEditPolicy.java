 ...
 * @generated
 */
public class ModifyingStoryNodeStoryNodePatternCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getModifyingStoryNodeStoryNodePatternCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return StoryPatternEditPart.VISUAL_ID == StorydiagramsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getModifyingStoryNodeStoryNodePatternCompartment_7001SemanticChildren((View) getHost()
						.getModel());
