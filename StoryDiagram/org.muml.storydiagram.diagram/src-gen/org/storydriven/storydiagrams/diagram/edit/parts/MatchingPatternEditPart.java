...
public class MatchingPatternEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MatchingPatternItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MatchingPatternStoryPatternContentCompartmentEditPart) {
			...
			pane.add(((MatchingPatternStoryPatternContentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof MatchingPatternStoryPatternConstraintsCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((MatchingPatternStoryPatternConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MatchingPatternStoryPatternContentCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getStoryPatternContentRectangle();
			pane.remove(((MatchingPatternStoryPatternContentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof MatchingPatternStoryPatternConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStoryPatternConstraintsRectangle();
			pane.remove(((MatchingPatternStoryPatternConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
