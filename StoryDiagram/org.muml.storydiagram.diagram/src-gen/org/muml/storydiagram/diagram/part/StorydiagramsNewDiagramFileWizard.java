 ...
 * @generated
 */
public class StorydiagramsNewDiagramFileWizard extends Wizard {
	...
	public StorydiagramsNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot,
		...
		myFileCreationPage.setFileName(
				StorydiagramsDiagramEditorUtil.getUniqueFileName(filePath, fileName, "storydiagrams_diagram")); //$NON-NLS-1$
	...
	public boolean performFinish() {
		...
		try {
			...
			StorydiagramsDiagramEditorPlugin.getInstance().logError("Save operation failed for: " + diagramModelURI, //$NON-NLS-1$
					ex);
	...
	private static class DiagramRootElementSelectionPage extends ModelElementSelectionPage {
		...
		protected String getSelectionTitle() {
			return Messages.StorydiagramsNewDiagramFileWizard_RootSelectionPageSelectionTitle;
		}
