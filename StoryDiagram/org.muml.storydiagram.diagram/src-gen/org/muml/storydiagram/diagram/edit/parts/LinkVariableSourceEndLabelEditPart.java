 ...
 * @generated
 */
public class LinkVariableSourceEndLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StorydiagramsVisualIDRegistry
						.getType(org.muml.storydiagram.diagram.edit.parts.LinkVariableSourceEndLabelEditPart.VISUAL_ID),
				new Point(10, 10));
	}
	 ...
	 * @generated
	 */
	public LinkVariableSourceEndLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.LinkVariable_4002,
					getParserElement(), StorydiagramsVisualIDRegistry.getType(
							org.muml.storydiagram.diagram.edit.parts.LinkVariableSourceEndLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
