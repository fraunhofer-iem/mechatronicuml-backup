...
public class InclusionLinkLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StorydiagramsVisualIDRegistry
						.getType(org.muml.storydiagram.diagram.edit.parts.InclusionLinkLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.InclusionLink_4003,
