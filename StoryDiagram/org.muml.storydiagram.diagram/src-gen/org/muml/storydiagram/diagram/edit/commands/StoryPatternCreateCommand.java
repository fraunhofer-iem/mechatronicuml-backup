...
public class StoryPatternCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		ModifyingStoryNode container = (ModifyingStoryNode) getElementToEdit();
		if (container.getOwnedRule() != null) {
			return false;
		}
		return true;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ModifyingStoryNode owner = (ModifyingStoryNode) getElementToEdit();
		owner.setOwnedRule(newElement);
