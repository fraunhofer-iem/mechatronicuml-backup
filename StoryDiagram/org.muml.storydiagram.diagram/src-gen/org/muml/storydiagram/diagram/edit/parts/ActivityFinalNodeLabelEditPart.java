 ...
 * @generated
 */
public class ActivityFinalNodeLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActivityFinalNodeLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.ActivityFinalNode_2008,
					getParserElement(), StorydiagramsVisualIDRegistry.getType(
							org.muml.storydiagram.diagram.edit.parts.ActivityFinalNodeLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
