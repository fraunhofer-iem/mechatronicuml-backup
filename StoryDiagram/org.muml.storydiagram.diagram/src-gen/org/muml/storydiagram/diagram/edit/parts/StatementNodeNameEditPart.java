 ...
 * @generated
 */
public class StatementNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StatementNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.StatementNode_2002,
					getParserElement(), StorydiagramsVisualIDRegistry
							.getType(org.muml.storydiagram.diagram.edit.parts.StatementNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
