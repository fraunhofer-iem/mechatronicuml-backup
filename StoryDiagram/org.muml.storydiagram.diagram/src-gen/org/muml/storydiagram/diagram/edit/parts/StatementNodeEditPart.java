...
import org.muml.storydiagram.diagram.edit.policies.StatementNodeItemSemanticEditPolicy;
...
public class StatementNodeEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new StatementNodeFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public StatementNodeFigureDescriptor getPrimaryShape() {
		return (StatementNodeFigureDescriptor) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StatementNodeExpressionLabelEditPart) {
			((StatementNodeExpressionLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape().getStatementNodeExpressionLabel());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class StatementNodeFigureDescriptor extends RoundedRectangle {
		 ...
		 * @generated
		 */
		public StatementNodeFigureDescriptor() {
	 ...
	 * @generated
	 */
	static final Font FSTATEMENTNODENAMELABEL_FONT = new Font(Display.getCurrent(),
