 ...
 * @generated
 */
public class ActivityCallNodeCalleeLabelEditPart extends CompartmentEditPart
			...
			parser = StorydiagramsParserProvider
					.getParser(
							...
							StorydiagramsVisualIDRegistry
									.getType(org.muml.storydiagram.diagram.edit.parts.ActivityCallNodeCalleeLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
