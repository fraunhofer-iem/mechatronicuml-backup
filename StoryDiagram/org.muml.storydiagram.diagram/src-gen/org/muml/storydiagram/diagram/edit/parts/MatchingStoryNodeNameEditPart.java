 ...
 * @generated
 */
public class MatchingStoryNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MatchingStoryNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.MatchingStoryNode_2004,
					getParserElement(), StorydiagramsVisualIDRegistry
							.getType(org.muml.storydiagram.diagram.edit.parts.MatchingStoryNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
