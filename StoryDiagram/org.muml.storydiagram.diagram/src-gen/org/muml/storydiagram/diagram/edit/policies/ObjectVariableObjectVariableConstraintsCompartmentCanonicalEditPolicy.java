...
public class ObjectVariableObjectVariableConstraintsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getObjectVariableObjectVariableConstraintsCompartment_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ConstraintEditPart.VISUAL_ID == StorydiagramsVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getObjectVariableObjectVariableConstraintsCompartment_7006SemanticChildren(
