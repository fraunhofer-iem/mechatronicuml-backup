 ...
 * @generated
 */
public class ActivityEdgeGuardLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StorydiagramsVisualIDRegistry
						.getType(org.muml.storydiagram.diagram.edit.parts.ActivityEdgeGuardLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ActivityEdgeGuardLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.ActivityEdge_4001,
					getParserElement(), StorydiagramsVisualIDRegistry.getType(
							org.muml.storydiagram.diagram.edit.parts.ActivityEdgeGuardLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
