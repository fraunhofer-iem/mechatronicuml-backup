 ...
 * @generated
 */
public class LinkVariableOperatorLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StorydiagramsVisualIDRegistry
						.getType(org.muml.storydiagram.diagram.edit.parts.LinkVariableOperatorLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	 ...
	 * @generated
	 */
	public LinkVariableOperatorLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.LinkVariable_4002,
					getParserElement(), StorydiagramsVisualIDRegistry.getType(
							org.muml.storydiagram.diagram.edit.parts.LinkVariableOperatorLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
