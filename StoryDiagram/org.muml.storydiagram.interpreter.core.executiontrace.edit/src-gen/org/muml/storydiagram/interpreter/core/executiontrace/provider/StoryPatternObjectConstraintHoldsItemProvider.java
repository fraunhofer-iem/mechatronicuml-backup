 ...
 * @generated
 */
public class StoryPatternObjectConstraintHoldsItemProvider extends StoryPatternObjectConstraintEvaluationItemProvider implements
		...
		ITableItemLabelProvider, ITableItemColorProvider, ITableItemFontProvider, IItemColorProvider, IItemFontProvider
{
	 ...
	 * @generated
	 */
	public StoryPatternObjectConstraintHoldsItemProvider(final AdapterFactory adapterFactory)
	{
	...
	/**
	 * This returns StoryPatternObjectConstraintHolds.gif. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	{
		return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/StoryPatternObjectConstraintHolds"));
	}
	...
	public String getText(final Object object)
	{
		...
		if (storyPatternObjectConstraintHolds.getConstraint() != null)
		{
			...
			{
				label += ((IItemLabelProvider) factory.adapt(storyPatternObjectConstraintHolds.getConstraint(), IItemLabelProvider.class))
						.getText(storyPatternObjectConstraintHolds.getConstraint());
			}
			else
			{
