 ...
 * @generated
 */
public class StoryPatternObjectConstraintEvaluationItemProvider extends StoryPatternObjectExecutionItemProvider implements
		...
		ITableItemLabelProvider, ITableItemColorProvider, ITableItemFontProvider, IItemColorProvider, IItemFontProvider
{
	...
	protected void addConstraintPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description", "_UI_StoryPatternObjectConstraintEvaluation_constraint_feature",
								"_UI_StoryPatternObjectConstraintEvaluation_type"),
						ExecutionTracePackage.Literals.STORY_PATTERN_OBJECT_CONSTRAINT_EVALUATION__CONSTRAINT, true, false, true, null,
						null, null));
	}
	...
	public String getText(Object object)
	{
		...
		return getString("_UI_StoryPatternObjectConstraintEvaluation_type") + " "
				+ storyPatternObjectConstraintEvaluation.getExecutionStartedTimeStamp();
	}
