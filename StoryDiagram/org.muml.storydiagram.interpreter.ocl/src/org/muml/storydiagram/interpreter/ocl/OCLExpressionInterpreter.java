package org.muml.storydiagram.interpreter.ocl;
...
import org.muml.storydiagram.interpreter.core.mdelab.expressions.ExpressionInterpreter;
...
import org.muml.storydiagram.interpreter.ocl.environment.CustomOCLEnvironmentFactory;
import org.muml.storydiagram.interpreter.ocl.environment.MultiResourceLazyExtentMap;
...
public class OCLExpressionInterpreter<Expression> extends ExpressionInterpreter<Expression, EClassifier>
{
	...
	private OCLExpression parseExpression(final String expressionString, EClassifier contextClassifier,
			final VariablesScope<?, ?, ?, ?, ?, ?, EClassifier, ?, Expression> variablesScope, final OCL ocl) throws ParserException,
			SDMException
	{
