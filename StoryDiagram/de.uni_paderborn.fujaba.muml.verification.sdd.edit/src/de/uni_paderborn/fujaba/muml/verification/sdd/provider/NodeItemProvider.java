...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.verification.sdd.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SDDPackage.Literals.NODE__OUTGOING_EDGES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SDDPackage.Literals.NODE__INCOMING_EDGES,
				 true,
				 false,
				 true,
				 null,
