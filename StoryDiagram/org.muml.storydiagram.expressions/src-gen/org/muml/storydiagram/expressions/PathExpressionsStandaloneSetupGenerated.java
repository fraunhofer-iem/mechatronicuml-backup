...
public class PathExpressionsStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.storydriven.org/modeling/expressions/PathExpressions")) {
		EPackage.Registry.INSTANCE.put("http://www.storydriven.org/modeling/expressions/PathExpressions", org.muml.storydiagram.expressions.pathExpressions.PathExpressionsPackage.eINSTANCE);
	}
