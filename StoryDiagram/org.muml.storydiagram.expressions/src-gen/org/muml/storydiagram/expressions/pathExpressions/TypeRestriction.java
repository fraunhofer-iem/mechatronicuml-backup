...
public interface TypeRestriction extends EObject
{
   ...
   * @see org.muml.storydiagram.expressions.pathExpressions.PathExpressionsPackage#getTypeRestriction_Forbidden()
   * @model
   * @generated
   */
  boolean isForbidden();
  ...
  /**
   * Sets the value of the '{@link org.muml.storydiagram.expressions.pathExpressions.TypeRestriction#isForbidden <em>Forbidden</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.muml.storydiagram.expressions.pathExpressions.PathExpressionsPackage#getTypeRestriction_TypeName()
   * @model
   * @generated
   */
  String getTypeName();
  ...
  /**
   * Sets the value of the '{@link org.muml.storydiagram.expressions.pathExpressions.TypeRestriction#getTypeName <em>Type Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
