 ...
 * @generated
 */
public class MatchingPatternStoryPatternContentCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingPatternStoryPatternContentCompartment_7009SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == CollectionVariableEditPart.VISUAL_ID
				|| visualID == ObjectVariableEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingPatternStoryPatternContentCompartment_7009SemanticChildren((View) getHost()
						.getModel());
