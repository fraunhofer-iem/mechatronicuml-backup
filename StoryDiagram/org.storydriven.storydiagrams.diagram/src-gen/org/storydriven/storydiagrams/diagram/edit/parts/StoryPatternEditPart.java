...
import org.storydriven.storydiagrams.diagram.edit.policies.StoryPatternItemSemanticEditPolicy;
...
public class StoryPatternEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StoryPatternStoryPatternContentCompartmentEditPart) {
			...
			pane.add(((StoryPatternStoryPatternContentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof StoryPatternStoryPatternConstraintsCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((StoryPatternStoryPatternConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StoryPatternStoryPatternContentCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getStoryPatternContentRectangle();
			pane.remove(((StoryPatternStoryPatternContentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof StoryPatternStoryPatternConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStoryPatternConstraintsRectangle();
			pane.remove(((StoryPatternStoryPatternConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
