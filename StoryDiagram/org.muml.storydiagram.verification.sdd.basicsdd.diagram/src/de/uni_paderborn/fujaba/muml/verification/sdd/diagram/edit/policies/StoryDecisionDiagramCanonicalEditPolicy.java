...
public class StoryDecisionDiagramCanonicalEditPolicy extends
	...
	public StoryDecisionDiagramCanonicalEditPolicy() {
	}
	...
	protected List getSemanticChildrenList() {
		List<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDNodeDescriptor> childDescriptors = getSemanticChildrenViewDescriptors();
		LinkedList<EObject> result = new LinkedList<EObject>();
		for (de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDNodeDescriptor d : childDescriptors) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!canonicalNodes) {
			...
			List<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDNodeDescriptor> result = new LinkedList<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDNodeDescriptor>();
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] {
								de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodeEditPart.VISUAL_ID,
								de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.LeafNodeEditPart.VISUAL_ID });
		...
		return de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDDiagramUpdater
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
				.getVisualID(view);
		return visualID == de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryPatternNodeEditPart.VISUAL_ID
				|| visualID == de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.LeafNodeEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		for (Iterator<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDNodeDescriptor next = descriptorsIterator
					.next();
			String hint = de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
		...
		for (de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDNodeDescriptor next : childDescriptors) {
			String hint = de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDVisualIDRegistry
			...
			if (nextDiagramLink.getSource() != null
				...
				EObject diagramLinkDst = nextDiagramLink.getTarget()
						.getElement();
				for (Iterator<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDLinkDescriptor> linkDescriptorsIterator = linkDescriptors
						.iterator(); linkDescriptorsIterator.hasNext();) {
					de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
							.next();
	 ...
	 * @generated
	 */
	private Collection<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDLinkDescriptor> collectAllLinks(
		...
		case de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.parts.StoryDecisionDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDDiagramUpdater
	...
	private Collection<IAdaptable> createConnections(
			Collection<de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.BasicSDDLinkDescriptor nextLinkDescriptor : linkDescriptors) {
