...
public class ObjectVariableObjectVariableAttributeAssignmentsCompartmentEditPart
	...
	public String getCompartmentName() {
		return de.uni_paderborn.fujaba.muml.verification.sdd.diagram.part.Messages.ObjectVariableObjectVariableAttributeAssignmentsCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.ObjectVariableObjectVariableAttributeAssignmentsCompartmentItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.verification.sdd.diagram.edit.policies.ObjectVariableObjectVariableAttributeAssignmentsCompartmentCanonicalEditPolicy());
	}
