...
public class AttributeAssignmentEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.policies.AttributeAssignmentItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.policies.BasicSDDTextNonResizableEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = org.muml.storydiagram.verification.sdd.basicsdd.diagram.providers.BasicSDDParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.BasicSDDEditPartFactory
