 ...
 * @generated
 */
public class StoryPatternNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StoryPatternNodeNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = BasicSDDParserProvider.getParser(BasicSDDElementTypes.StoryPatternNode_2003, getParserElement(),
					BasicSDDVisualIDRegistry.getType(
							org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.StoryPatternNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
