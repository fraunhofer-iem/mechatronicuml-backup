...
import org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.policies.BasicSDDTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CollectionVariableNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CollectionVariableNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new BasicSDDTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BasicSDDParserProvider.getParser(BasicSDDElementTypes.CollectionVariable_3006, getParserElement(),
					BasicSDDVisualIDRegistry.getType(
							org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.CollectionVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
