...
import org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.policies.Constraint2ItemSemanticEditPolicy;
...
public class Constraint2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BasicSDDParserProvider.getParser(BasicSDDElementTypes.Constraint_3010, getParserElement(),
					BasicSDDVisualIDRegistry.getType(
							org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.Constraint2EditPart.VISUAL_ID));
		}
		return parser;
	}
