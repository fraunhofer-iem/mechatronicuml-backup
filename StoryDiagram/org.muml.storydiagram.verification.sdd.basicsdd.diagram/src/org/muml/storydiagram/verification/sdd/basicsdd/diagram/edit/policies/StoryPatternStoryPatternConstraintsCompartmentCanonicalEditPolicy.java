...
public class StoryPatternStoryPatternConstraintsCompartmentCanonicalEditPolicy
		...
		if (!canonicalNodes) {
			...
			for (View childView : childViews) {
				...
				List<Integer> visualIDs = Arrays
						.asList(new Integer[] { org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.Constraint2EditPart.VISUAL_ID });
	...
	private boolean isMyDiagramElement(View view) {
		return org.muml.storydiagram.verification.sdd.basicsdd.diagram.edit.parts.Constraint2EditPart.VISUAL_ID == org.muml.storydiagram.verification.sdd.basicsdd.diagram.part.BasicSDDVisualIDRegistry
				.getVisualID(view);
	}
