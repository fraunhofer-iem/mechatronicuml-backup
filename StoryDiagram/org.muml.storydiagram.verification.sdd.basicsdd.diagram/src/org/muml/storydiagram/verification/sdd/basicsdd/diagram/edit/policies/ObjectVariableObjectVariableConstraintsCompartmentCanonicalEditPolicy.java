 ...
 * @generated
 */
public class ObjectVariableObjectVariableConstraintsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public ObjectVariableObjectVariableConstraintsCompartmentCanonicalEditPolicy() {
	}

	public ObjectVariableObjectVariableConstraintsCompartmentCanonicalEditPolicy(boolean canonicalNodes) {
