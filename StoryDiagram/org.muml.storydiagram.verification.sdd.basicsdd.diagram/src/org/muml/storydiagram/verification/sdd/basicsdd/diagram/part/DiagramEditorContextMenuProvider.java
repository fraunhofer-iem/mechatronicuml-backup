...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private org.muml.storydiagram.verification.sdd.basicsdd.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new org.muml.storydiagram.verification.sdd.basicsdd.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
