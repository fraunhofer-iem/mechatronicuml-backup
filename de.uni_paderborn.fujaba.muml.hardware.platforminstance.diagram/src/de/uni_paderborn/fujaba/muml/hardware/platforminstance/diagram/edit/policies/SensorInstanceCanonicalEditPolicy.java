 ...
 * @generated
 */
public class SensorInstanceCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public SensorInstanceCanonicalEditPolicy() {
	}

	public SensorInstanceCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.part.HardwareDiagramUpdater
				.getSensorInstance_3014SemanticChildren(viewObject);
