...
public class DelegationCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorDelegation_4001(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.hardware.platform.Delegation newElement = de.uni_paderborn.fujaba.muml.hardware.platform.PlatformFactory.eINSTANCE
				.createDelegation();
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.hardware.platform.Delegation newElement,
