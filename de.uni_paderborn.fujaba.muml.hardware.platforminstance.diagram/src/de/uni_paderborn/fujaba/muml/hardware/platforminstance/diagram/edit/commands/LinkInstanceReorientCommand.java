 ...
 * @generated
 */
public class LinkInstanceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LinkInstanceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.LinkInstance) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLinkInstance_4009(container,
			...
			String errorMessage = de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
					.getLinkConstraints().getErrorLinkInstance_4009(container,
	 ...
	 * @generated
	 */
	protected de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.LinkInstance getLink() {
		return (de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.LinkInstance) getElementToEdit();
	}
