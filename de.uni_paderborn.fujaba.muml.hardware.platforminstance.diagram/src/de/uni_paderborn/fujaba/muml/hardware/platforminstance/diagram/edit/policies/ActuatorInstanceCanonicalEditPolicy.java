 ...
 * @generated
 */
public class ActuatorInstanceCanonicalEditPolicy extends CanonicalEditPolicy {
	private boolean canonicalNodes = true;

	public ActuatorInstanceCanonicalEditPolicy() {
	}

	public ActuatorInstanceCanonicalEditPolicy(boolean canonicalNodes) {
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		return de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.part.HardwareDiagramUpdater
				.getActuatorInstance_3013SemanticChildren(viewObject);
