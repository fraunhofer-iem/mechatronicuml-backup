 ...
 * @generated
 */
public class LinkInstanceLabelExpressionLabelParser6003 extends
		ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public LinkInstanceLabelExpressionLabelParser6003() {
	}
	...
	public String getEditString(IAdaptable element, int flags) {
		...
		Object result = de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.expressions.HardwareOCLFactory
				.getExpression(
						40,
						de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.HwplatforminstancePackage.eINSTANCE
								.getLinkInstance(), null).evaluate(target);
