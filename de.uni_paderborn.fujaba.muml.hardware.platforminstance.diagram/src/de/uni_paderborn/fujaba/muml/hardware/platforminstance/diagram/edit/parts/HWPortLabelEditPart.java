 ...
 * @generated
 */
public class HWPortLabelEditPart extends LabelEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HardwareTextSelectionEditPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.parts.HardwareEditPartFactory
