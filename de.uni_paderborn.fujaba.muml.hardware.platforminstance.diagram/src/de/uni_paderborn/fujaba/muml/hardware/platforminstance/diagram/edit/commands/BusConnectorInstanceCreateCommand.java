 ...
 * @generated
 */
public class BusConnectorInstanceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BusConnectorInstanceCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (!de.uni_paderborn.fujaba.muml.hardware.platforminstance.diagram.edit.policies.HardwareBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateBusConnectorInstance_4010(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.BusConnectorInstance newElement = de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.HwplatforminstanceFactory.eINSTANCE
				.createBusConnectorInstance();
		getContainer().getNetworkingHardwareInstances().add(newElement);
	...
	protected void doConfigure(
			de.uni_paderborn.fujaba.muml.hardware.hwplatforminstance.BusConnectorInstance newElement,
