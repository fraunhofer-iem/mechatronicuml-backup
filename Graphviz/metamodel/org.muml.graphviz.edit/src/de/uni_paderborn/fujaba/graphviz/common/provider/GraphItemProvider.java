/**
 */
package de.uni_paderborn.fujaba.graphviz.common.provider;
...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.graphviz.common.Graph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommonPackage.Literals.GRAPH__NODES);
			childrenFeatures.add(CommonPackage.Literals.GRAPH__EDGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommonPackage.Literals.GRAPH__NODES,
				 CommonFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(CommonPackage.Literals.GRAPH__NODES,
				 DotFactory.eINSTANCE.createDotNode()));

		newChildDescriptors.add
			(createChildParameter
				(CommonPackage.Literals.GRAPH__NODES,
				 PlainFactory.eINSTANCE.createPlainNode()));

		newChildDescriptors.add
			(createChildParameter
				(CommonPackage.Literals.GRAPH__EDGES,
				 CommonFactory.eINSTANCE.createEdge()));
		...
		newChildDescriptors.add
			(createChildParameter
				(CommonPackage.Literals.GRAPH__EDGES,
				 PlainFactory.eINSTANCE.createPlainEdge()));
	}
