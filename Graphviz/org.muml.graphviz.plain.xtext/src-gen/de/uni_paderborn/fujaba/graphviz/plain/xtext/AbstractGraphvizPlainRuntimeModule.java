...
public abstract class AbstractGraphvizPlainRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/uni_paderborn/fujaba/graphviz/plain/xtext/GraphvizPlain.properties");
	...
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("graphviz_plain");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return de.uni_paderborn.fujaba.graphviz.plain.xtext.services.GraphvizPlainGrammarAccess.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return de.uni_paderborn.fujaba.graphviz.plain.xtext.parser.antlr.GraphvizPlainParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return de.uni_paderborn.fujaba.graphviz.plain.xtext.parser.antlr.GraphvizPlainAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return de.uni_paderborn.fujaba.graphviz.plain.xtext.parser.antlr.internal.InternalGraphvizPlainLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<de.uni_paderborn.fujaba.graphviz.plain.xtext.parser.antlr.internal.InternalGraphvizPlainLexer> provideInternalGraphvizPlainLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(de.uni_paderborn.fujaba.graphviz.plain.xtext.parser.antlr.internal.InternalGraphvizPlainLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(de.uni_paderborn.fujaba.graphviz.plain.xtext.parser.antlr.internal.InternalGraphvizPlainLexer.class);
	}
