...
public class UmlrtPaletteFactory {
	...
	private ToolEntry createMessageInterface1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.providers.UmlrtElementTypes.MessageInterface_2002));
	...
	private ToolEntry createMessageType2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.providers.UmlrtElementTypes.MessageType_3002));
		entry.setId("createMessageType2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.providers.UmlrtElementTypes
				.getImageDescriptor(de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.providers.UmlrtElementTypes.MessageType_3002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createGeneralization3CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.providers.UmlrtElementTypes.MessageInterfaceSuperType_4003));
