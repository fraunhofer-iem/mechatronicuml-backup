...
public class MessageInterfaceMessageTypeCompartmentCanonicalEditPolicy extends
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return de.uni_paderborn.fujaba.umlrt.model.msgiface.MsgifacePackage.eINSTANCE
	...
	protected List getSemanticChildrenList() {
		...
		List<de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.part.MessageinterfaceNodeDescriptor> childDescriptors = de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.part.MessageinterfaceDiagramUpdater
				.getMessageInterfaceMessageTypeCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.edit.parts.MessageTypeEditPart.VISUAL_ID == de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.part.MessageinterfaceVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.part.MessageinterfaceNodeDescriptor> childDescriptors = de.uni_paderborn.fujaba.umlrt.messageinterfaceeditor.diagram.part.MessageinterfaceDiagramUpdater
				.getMessageInterfaceMessageTypeCompartment_7001SemanticChildren((View) getHost()
						.getModel());
