 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.constraint.TextualConstraint#getTextualExpression <em>Textual Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.constraint.ConstraintPackage#getTextualConstraint()
 * @model
 * @generated
 */
public interface TextualConstraint extends VerifiableConstraint, ExtendableElement {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.constraint.ConstraintPackage#getTextualConstraint_TextualExpression()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.constraint.TextualConstraint#getTextualExpression <em>Textual Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
