 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.model.realtimestatechart.impl.EventImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EventImpl extends EObjectImpl implements Event {
	...
	protected EClass eStaticClass() {
		return RealtimestatechartPackage.Literals.EVENT;
	}
	...
	public void setKind(EventKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.EVENT__KIND, oldKind, kind));
	}
