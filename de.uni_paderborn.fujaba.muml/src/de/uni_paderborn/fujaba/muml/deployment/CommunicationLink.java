 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.CommunicationLink#getDeployment <em>Deployment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.CommunicationLink#getQualityOfService <em>Quality Of Service</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.CommunicationLink#getDeployedAssemblyInstances <em>Deployed Assembly Instances</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.CommunicationLink#getHardwarePorts <em>Hardware Ports</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getCommunicationLink()
 * @model
 * @generated
 */
public interface CommunicationLink extends ExtendableElement, Connector {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.deployment.Deployment#getCommunicationLinks <em>Communication Links</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getCommunicationLink_Deployment()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.deployment.CommunicationLink#getDeployment <em>Deployment</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getCommunicationLink_QualityOfService()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.deployment.CommunicationLink#getQualityOfService <em>Quality Of Service</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getCommunicationLink_DeployedAssemblyInstances()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getCommunicationLink_HardwarePorts()
