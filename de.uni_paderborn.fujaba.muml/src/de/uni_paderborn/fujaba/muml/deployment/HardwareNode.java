 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwareNode#getDeployment <em>Deployment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwareNode#getHardwarePorts <em>Hardware Ports</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwareNode#getDeployedInstances <em>Deployed Instances</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwareNode#getHardwareNodeKind <em>Hardware Node Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwareNode()
...
public interface HardwareNode extends NamedElement, CommentableElement {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.deployment.Deployment#getHardwareNodes <em>Hardware Nodes</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwareNode_Deployment()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.deployment.HardwareNode#getDeployment <em>Deployment</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort}.
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort#getHardwareNode <em>Hardware Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwareNode_HardwarePorts()
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwareNode_DeployedInstances()
	 * @model
	 * @generated
	 */
	 ...
	 * The literals are from the enumeration {@link de.uni_paderborn.fujaba.muml.deployment.HardwareNodeKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwareNode_HardwareNodeKind()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.deployment.HardwareNode#getHardwareNodeKind <em>Hardware Node Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
