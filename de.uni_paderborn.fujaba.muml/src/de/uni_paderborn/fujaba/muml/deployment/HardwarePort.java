 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort#getHardwareNode <em>Hardware Node</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort#getDeployedPortInstance <em>Deployed Port Instance</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort#getKind <em>Kind</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort#getCommunicationLinks <em>Communication Links</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwarePort()
 * @model
 * @generated
 */
public interface HardwarePort extends NamedElement, CommentableElement, ConnectorEndpoint {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.deployment.HardwareNode#getHardwarePorts <em>Hardware Ports</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwarePort_HardwareNode()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort#getHardwareNode <em>Hardware Node</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwarePort_DeployedPortInstance()
	 * @model
	 * @generated
	 */
	 ...
	 * The literals are from the enumeration {@link de.uni_paderborn.fujaba.muml.deployment.HardwarePortDirectionKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwarePort_Kind()
	 * @model default=""
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.deployment.HardwarePort#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.deployment.DeploymentPackage#getHardwarePort_CommunicationLinks()
