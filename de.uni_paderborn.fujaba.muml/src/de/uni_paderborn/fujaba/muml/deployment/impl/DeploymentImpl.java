 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.impl.DeploymentImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.impl.DeploymentImpl#getCommunicationLinks <em>Communication Links</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.impl.DeploymentImpl#getHardwareNodes <em>Hardware Nodes</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.impl.DeploymentImpl#getComponentInstanceConfiguration <em>Component Instance Configuration</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.deployment.impl.DeploymentImpl#getQualityOfLinkServices <em>Quality Of Link Services</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
