 ...
 * </p>
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getOverview <em>Overview</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getContext <em>Context</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getProblem <em>Problem</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getSolution <em>Solution</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getBehavior <em>Behavior</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getConsequences <em>Consequences</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getCombineability <em>Combineability</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getVariants <em>Variants</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getAlternatives <em>Alternatives</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.pattern.impl.DescriptionAspectsImpl#getVerification_properties <em>Verification properties</em>}</li>
 * </ul>
 *
 * @generated
 */
