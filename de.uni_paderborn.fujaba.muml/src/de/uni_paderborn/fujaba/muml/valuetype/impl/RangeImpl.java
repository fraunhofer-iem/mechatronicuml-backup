...
public class RangeImpl extends EObjectImpl implements Range {
	 ...
	 * @ordered
	 */
	protected static final long UPPER_BOUND_EDEFAULT = 1L;
	...
	public void setLowerBound(long newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuetypePackage.RANGE__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(long newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuetypePackage.RANGE__UPPER_BOUND, oldUpperBound, upperBound));
	}
