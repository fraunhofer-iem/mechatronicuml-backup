...
public interface ConnectorPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT__ANNOTATION = CorePackage.COMMENTABLE_ELEMENT__ANNOTATION;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT__EXTENSION = CorePackage.COMMENTABLE_ELEMENT__EXTENSION;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ECLASS = CorePackage.COMMENTABLE_ELEMENT___ECLASS;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___EIS_PROXY = CorePackage.COMMENTABLE_ELEMENT___EIS_PROXY;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ERESOURCE = CorePackage.COMMENTABLE_ELEMENT___ERESOURCE;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ECONTAINER = CorePackage.COMMENTABLE_ELEMENT___ECONTAINER;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ECONTAINING_FEATURE = CorePackage.COMMENTABLE_ELEMENT___ECONTAINING_FEATURE;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ECONTAINMENT_FEATURE = CorePackage.COMMENTABLE_ELEMENT___ECONTAINMENT_FEATURE;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ECONTENTS = CorePackage.COMMENTABLE_ELEMENT___ECONTENTS;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___EALL_CONTENTS = CorePackage.COMMENTABLE_ELEMENT___EALL_CONTENTS;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ECROSS_REFERENCES = CorePackage.COMMENTABLE_ELEMENT___ECROSS_REFERENCES;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___EGET__ESTRUCTURALFEATURE = CorePackage.COMMENTABLE_ELEMENT___EGET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___EGET__ESTRUCTURALFEATURE_BOOLEAN = CorePackage.COMMENTABLE_ELEMENT___EGET__ESTRUCTURALFEATURE_BOOLEAN;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___ESET__ESTRUCTURALFEATURE_OBJECT = CorePackage.COMMENTABLE_ELEMENT___ESET__ESTRUCTURALFEATURE_OBJECT;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___EIS_SET__ESTRUCTURALFEATURE = CorePackage.COMMENTABLE_ELEMENT___EIS_SET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___EUNSET__ESTRUCTURALFEATURE = CorePackage.COMMENTABLE_ELEMENT___EUNSET__ESTRUCTURALFEATURE;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___EINVOKE__EOPERATION_ELIST = CorePackage.COMMENTABLE_ELEMENT___EINVOKE__EOPERATION_ELIST;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___PROVIDE_EXTENSION__ECLASS = CorePackage.COMMENTABLE_ELEMENT___PROVIDE_EXTENSION__ECLASS;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___GET_ANNOTATION__STRING = CorePackage.COMMENTABLE_ELEMENT___GET_ANNOTATION__STRING;
	 ...
	 * @ordered
	 */
	int CONNECTOR_ENDPOINT___PROVIDE_ANNOTATION__STRING = CorePackage.COMMENTABLE_ELEMENT___PROVIDE_ANNOTATION__STRING;
	...
	/**
	 * The meta object id for the '{@link de.uni_paderborn.fujaba.muml.connector.impl.MessageBufferImpl <em>Message Buffer</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uni_paderborn.fujaba.muml.connector.impl.MessageBufferImpl
	 * @see de.uni_paderborn.fujaba.muml.connector.impl.ConnectorPackageImpl#getMessageBuffer()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link de.uni_paderborn.fujaba.muml.connector.BufferOverflowAvoidanceStrategy <em>Buffer Overflow Avoidance Strategy</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uni_paderborn.fujaba.muml.connector.BufferOverflowAvoidanceStrategy
	 * @see de.uni_paderborn.fujaba.muml.connector.impl.ConnectorPackageImpl#getBufferOverflowAvoidanceStrategy()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uni_paderborn.fujaba.muml.connector.DiscreteInteractionEndpoint#getReceiverMessageBuffer <em>Receiver Message Buffer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link de.uni_paderborn.fujaba.muml.connector.MessageBuffer <em>Message Buffer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link de.uni_paderborn.fujaba.muml.connector.MessageBuffer#getBufferSize <em>Buffer Size</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Buffer Size</em>'.
	 * @see de.uni_paderborn.fujaba.muml.connector.MessageBuffer#getBufferSize()
	...
	/**
	 * Returns the meta object for the reference list '{@link de.uni_paderborn.fujaba.muml.connector.MessageBuffer#getMessageType <em>Message Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Message Type</em>'.
	 * @see de.uni_paderborn.fujaba.muml.connector.MessageBuffer#getMessageType()
	 * @see #getMessageBuffer()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the container reference '{@link de.uni_paderborn.fujaba.muml.connector.MessageBuffer#getDiscreteInteractionEndpoint <em>Discrete Interaction Endpoint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link de.uni_paderborn.fujaba.muml.connector.MessageBuffer#getBufferOverflowAvoidanceStrategy <em>Buffer Overflow Avoidance Strategy</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Buffer Overflow Avoidance Strategy</em>'.
	 * @see de.uni_paderborn.fujaba.muml.connector.MessageBuffer#getBufferOverflowAvoidanceStrategy()
	 * @see #getMessageBuffer()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link de.uni_paderborn.fujaba.muml.connector.impl.MessageBufferImpl <em>Message Buffer</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uni_paderborn.fujaba.muml.connector.impl.MessageBufferImpl
		 * @see de.uni_paderborn.fujaba.muml.connector.impl.ConnectorPackageImpl#getMessageBuffer()
