...
public interface EntryOrExitEvent extends StateEvent {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.realtimestatechart.RealtimestatechartPackage#getEntryOrExitEvent_ClockResets()
	 * @model
	 * @generated
	 */
	 ...
	 * @see de.uni_paderborn.fujaba.muml.realtimestatechart.RealtimestatechartPackage#getEntryOrExitEvent_Action()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.realtimestatechart.EntryOrExitEvent#getAction <em>Action</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
