 ...
 * <ul>
 *   <li>{@link de.uni_paderborn.fujaba.muml.protocol.MessageBuffer#getBufferSize <em>Buffer Size</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.protocol.MessageBuffer#getMessageType <em>Message Type</em>}</li>
 *   <li>{@link de.uni_paderborn.fujaba.muml.protocol.MessageBuffer#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uni_paderborn.fujaba.muml.protocol.ProtocolPackage#getMessageBuffer()
 * @model
 * @generated
 */
public interface MessageBuffer extends NamedElement, CommentableElement {
	 ...
	 * @see de.uni_paderborn.fujaba.muml.protocol.ProtocolPackage#getMessageBuffer_BufferSize()
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.protocol.MessageBuffer#getBufferSize <em>Buffer Size</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uni_paderborn.fujaba.muml.protocol.ProtocolPackage#getMessageBuffer_MessageType()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link de.uni_paderborn.fujaba.muml.protocol.Role#getReceiverMessageBuffer <em>Receiver Message Buffer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see #setRole(Role)
	 * @see de.uni_paderborn.fujaba.muml.protocol.ProtocolPackage#getMessageBuffer_Role()
	 * @see de.uni_paderborn.fujaba.muml.protocol.Role#getReceiverMessageBuffer
	...
	/**
	 * Sets the value of the '{@link de.uni_paderborn.fujaba.muml.protocol.MessageBuffer#getRole <em>Role</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
