...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.runtime.SingleRoleInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SingleRoleInstanceItemProvider extends RoleInstanceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SingleRoleInstanceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SingleRoleInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SingleRoleInstance"));
	}
	...
	public String getText(Object object) {
		String label = ((SingleRoleInstance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SingleRoleInstance_type") :
			getString("_UI_SingleRoleInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SingleRoleInstance.class)) {
