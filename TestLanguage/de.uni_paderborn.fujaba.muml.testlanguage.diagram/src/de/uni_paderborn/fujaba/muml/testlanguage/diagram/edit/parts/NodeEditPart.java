...
public class NodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.policies.NodeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeLabelEditPart) {
			((de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureNodeLabelFigure());
			return true;
		}
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeNodeFigureCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureNodeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeNodeFigureCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeNodeFigureCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureNodeCompartmentFigure();
			pane.remove(((de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeNodeFigureCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeNodeFigureCompartmentEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(de.uni_paderborn.fujaba.muml.testlanguage.diagram.part.TestLanguageVisualIDRegistry
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == de.uni_paderborn.fujaba.muml.testlanguage.diagram.providers.TestLanguageElementTypes.Input_3001) {
				return getChildBySemanticHint(de.uni_paderborn.fujaba.muml.testlanguage.diagram.part.TestLanguageVisualIDRegistry
						.getType(de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeNodeFigureCompartmentEditPart.VISUAL_ID));
			}
			if (type == de.uni_paderborn.fujaba.muml.testlanguage.diagram.providers.TestLanguageElementTypes.Output_3002) {
				return getChildBySemanticHint(de.uni_paderborn.fujaba.muml.testlanguage.diagram.part.TestLanguageVisualIDRegistry
						.getType(de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.NodeNodeFigureCompartmentEditPart.VISUAL_ID));
			}
		}
