 ...
 * @generated
 */
public class LoadModelItemProvider extends NodeSpecificationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LoadModelItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LoadModel.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		String label = ((LoadModel) object).getLabel();
		return label == null || label.length() == 0 ? getString("_UI_LoadModel_type")
				: getString("_UI_LoadModel_type") + " " + label;
	}
