 ...
 * @generated
 */
public class PrimitiveStringItemProvider extends NodeSpecificationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PrimitiveStringItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PrimitiveString.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((PrimitiveString) object).getLabel();
		return label == null || label.length() == 0 ? getString("_UI_PrimitiveString_type")
				: getString("_UI_PrimitiveString_type") + " " + label;
	}
