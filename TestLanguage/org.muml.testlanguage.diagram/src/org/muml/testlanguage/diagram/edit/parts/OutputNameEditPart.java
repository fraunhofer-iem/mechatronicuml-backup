...
import org.muml.testlanguage.diagram.edit.policies.TestLanguageTextSelectionEditPolicy;
 ...
 * @generated
 */
public class OutputNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OutputNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new TestLanguageTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TestLanguageParserProvider.getParser(TestLanguageElementTypes.Output_3002, getParserElement(),
					TestLanguageVisualIDRegistry
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, TestLanguageEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
