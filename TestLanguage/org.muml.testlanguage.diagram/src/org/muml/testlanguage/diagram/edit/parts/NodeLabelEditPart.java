 ...
 * @generated
 */
public class NodeLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TestLanguageParserProvider.getParser(TestLanguageElementTypes.Node_2001, getParserElement(),
