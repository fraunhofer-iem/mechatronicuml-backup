...
public class OutputEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.policies.OutputItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.OutputNameEditPart) {
			((de.uni_paderborn.fujaba.muml.testlanguage.diagram.edit.parts.OutputNameEditPart) childEditPart)
	...
	public class OutputFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureOutputLabelFigure.setText("");

			GridData constraintFFigureOutputLabelFigure = new GridData();
			constraintFFigureOutputLabelFigure.verticalAlignment = GridData.CENTER;
			constraintFFigureOutputLabelFigure.horizontalAlignment = GridData.END;
			constraintFFigureOutputLabelFigure.horizontalIndent = 0;
			constraintFFigureOutputLabelFigure.horizontalSpan = 1;
