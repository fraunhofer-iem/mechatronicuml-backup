...
public class AssemblyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public boolean isRequired(Object key, int kind) {
		return key == ComponentViewsRepository.Assembly.Properties.fromPort || key == ComponentViewsRepository.Assembly.Properties.toPort || key == ComponentViewsRepository.Assembly.Properties.to || key == ComponentViewsRepository.Assembly.Properties.from || key == ComponentViewsRepository.Assembly.Properties.coordinationPattern;
	}
