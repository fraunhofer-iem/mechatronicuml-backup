 ...
 * 
 */
public class DiscreteMultiPortInstancePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DiscreteMultiPortInstancePropertiesEditionPart {
	 ...
	 * 
	 */
	public DiscreteMultiPortInstancePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(InstanceMessages.DiscreteMultiPortInstancePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, InstanceMessages.DiscreteMultiPortInstancePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.name, InstanceViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.name, InstanceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCommentText(Composite parent) {
		SWTUtils.createPartLabel(parent, InstanceMessages.DiscreteMultiPortInstancePropertiesEditionPart_CommentLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.comment, InstanceViewsRepository.SWT_KIND));
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.comment, InstanceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createPortTypeFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, InstanceMessages.DiscreteMultiPortInstancePropertiesEditionPart_PortTypeLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.portType, InstanceViewsRepository.SWT_KIND));
		portType = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.portType, InstanceViewsRepository.SWT_KIND));
		...
		portType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.portType, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getPortType()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.portType, InstanceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createComponentInstanceFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, InstanceMessages.DiscreteMultiPortInstancePropertiesEditionPart_ComponentInstanceLabel, propertiesEditionComponent.isRequired(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.componentInstance, InstanceViewsRepository.SWT_KIND));
		componentInstance = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.componentInstance, InstanceViewsRepository.SWT_KIND));
		...
		componentInstance.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.componentInstance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getComponentInstance()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.componentInstance, InstanceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createIncomingConnectorInstancesAdvancedReferencesTable(Composite parent) {
		...
		this.incomingConnectorInstances.setHelpText(propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.incomingConnectorInstances, InstanceViewsRepository.SWT_KIND));
		...
		this.incomingConnectorInstances.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.incomingConnectorInstances, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"incomingConnectorInstances", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.incomingConnectorInstances,
	...
	protected void moveIncomingConnectorInstances(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.incomingConnectorInstances, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incomingConnectorInstances.refresh();
	}
	...
	protected void removeFromIncomingConnectorInstances(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.incomingConnectorInstances, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incomingConnectorInstances.refresh();
	}
	...
	protected Composite createOutgoingConnectorInstancesAdvancedReferencesTable(Composite parent) {
		...
		this.outgoingConnectorInstances.setHelpText(propertiesEditionComponent.getHelpContent(InstanceViewsRepository.DiscreteMultiPortInstance.Properties.outgoingConnectorInstances, InstanceViewsRepository.SWT_KIND));
		...
		this.outgoingConnectorInstances.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.outgoingConnectorInstances, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutgoingConnectorInstances() {
		...
		"outgoingConnectorInstances", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.outgoingConnectorInstances,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutgoingConnectorInstances(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.outgoingConnectorInstances, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outgoingConnectorInstances.refresh();
	}
	...
	protected void removeFromOutgoingConnectorInstances(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DiscreteMultiPortInstancePropertiesEditionPartImpl.this, InstanceViewsRepository.DiscreteMultiPortInstance.Properties.outgoingConnectorInstances, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outgoingConnectorInstances.refresh();
	}
