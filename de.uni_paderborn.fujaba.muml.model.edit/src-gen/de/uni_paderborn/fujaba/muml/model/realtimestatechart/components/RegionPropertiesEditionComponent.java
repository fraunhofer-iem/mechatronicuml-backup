...
public class RegionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(RealtimestatechartViewsRepository.Region.Properties.statechart)) {
				// init part
	...
	protected EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == RealtimestatechartViewsRepository.Region.Properties.statechart) {
			return RealtimestatechartPackage.eINSTANCE.getRegion_Statechart();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (RealtimestatechartViewsRepository.Region.Properties.statechart == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (RealtimestatechartPackage.eINSTANCE.getRegion_Statechart().equals(msg.getFeature()) && basePart != null && isAccessible(RealtimestatechartViewsRepository.Region.Properties.statechart))
	...
	public boolean isRequired(Object key, int kind) {
		return key == RealtimestatechartViewsRepository.Region.Properties.name || key == RealtimestatechartViewsRepository.Region.Properties.statechart || key == RealtimestatechartViewsRepository.Region.Properties.parentState;
	}
