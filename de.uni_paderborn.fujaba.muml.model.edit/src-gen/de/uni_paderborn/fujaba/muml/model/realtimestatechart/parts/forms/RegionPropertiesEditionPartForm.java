...
public class RegionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, RegionPropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(RealtimestatechartViewsRepository.Region.Properties.statechart);
		...
		composer = new PartComposer(regionStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RealtimestatechartViewsRepository.Region.Properties.statechart) {
	...
	protected Composite createStatechartFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, RealtimestatechartMessages.RegionPropertiesEditionPart_StatechartLabel, propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Region.Properties.statechart, RealtimestatechartViewsRepository.FORM_KIND));
		statechart = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(RealtimestatechartViewsRepository.Region.Properties.statechart, RealtimestatechartViewsRepository.FORM_KIND));
		...
		statechart.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RegionPropertiesEditionPartForm.this, RealtimestatechartViewsRepository.Region.Properties.statechart, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStatechart()));
			}

		});
		statechart.setID(RealtimestatechartViewsRepository.Region.Properties.statechart);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RealtimestatechartViewsRepository.Region.Properties.statechart, RealtimestatechartViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
...
// End of user code
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.realtimestatechart.parts.RegionPropertiesEditionPart#getStatechart()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.realtimestatechart.parts.RegionPropertiesEditionPart#initStatechart(EObjectFlatComboSettings)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.realtimestatechart.parts.RegionPropertiesEditionPart#setStatechart(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.realtimestatechart.parts.RegionPropertiesEditionPart#setStatechartButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.realtimestatechart.parts.RegionPropertiesEditionPart#addFilterStatechart(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see de.uni_paderborn.fujaba.muml.model.realtimestatechart.parts.RegionPropertiesEditionPart#addBusinessFilterStatechart(ViewerFilter filter)
	 * 
	 */
