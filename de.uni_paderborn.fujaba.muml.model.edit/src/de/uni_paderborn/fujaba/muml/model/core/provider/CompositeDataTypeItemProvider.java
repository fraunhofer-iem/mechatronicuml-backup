...
/**
 * This is the item provider adapter for a {@link de.uni_paderborn.fujaba.muml.model.core.CompositeDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeDataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompositeDataType_innerDeclaration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompositeDataType_innerDeclaration_feature", "_UI_CompositeDataType_type"),
				 CorePackage.Literals.COMPOSITE_DATA_TYPE__INNER_DECLARATION,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.COMPOSITE_DATA_TYPE__INNER_DECLARATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.COMPOSITE_DATA_TYPE__INNER_DECLARATION,
				 CoreFactory.eINSTANCE.createInnerDeclaration()));
	}
