...
public class StateExitPointEditPart extends AbstractBorderItemEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new StateExitPointFigure();
	}

	/**
	 * @generated
	 */
	public StateExitPointFigure getPrimaryShape() {
		return (StateExitPointFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class StateExitPointFigure extends Ellipse {

		/**
		 * @generated
		 */
		public StateExitPointFigure() {
