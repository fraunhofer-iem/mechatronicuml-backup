 ...
 * @generated
 */
public class StateExitPoint2CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public StateExitPoint2CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.providers.ElementInitializers
				.getInstance().init_StateExitPoint_3030(newElement);
