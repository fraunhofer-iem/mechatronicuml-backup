...
public class MumlNavigatorLinkHelper implements ILinkHelper {
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		if (abstractNavigatorItem instanceof de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.navigator.MumlNavigatorItem) {
			...
			if (navigatorGroup.getParent() instanceof de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.navigator.MumlNavigatorItem) {
				navigatorView = ((de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.navigator.MumlNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
