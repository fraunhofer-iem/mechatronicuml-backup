 ...
 * @generated
 */
public class Transition2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Transition2ReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		de.uni_paderborn.fujaba.muml.model.realtimestatechart.Vertex target = getLink()
				.getTarget();
		if (!(getLink().eContainer() instanceof de.uni_paderborn.fujaba.muml.model.realtimestatechart.Region)) {
			return false;
		}
		de.uni_paderborn.fujaba.muml.model.realtimestatechart.Region container = (de.uni_paderborn.fujaba.muml.model.realtimestatechart.Region) getLink()
				.eContainer();
