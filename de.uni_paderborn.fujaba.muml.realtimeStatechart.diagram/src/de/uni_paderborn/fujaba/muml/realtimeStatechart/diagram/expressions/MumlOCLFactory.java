...
public class MumlOCLFactory {
	...
	protected MumlOCLFactory() {
		this.expressions = new de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.expressions.MumlAbstractExpression[16];
	}
	...
	public static de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.expressions.MumlAbstractExpression getExpression(
		...
		if (cached.expressions[index] == null) {
			final String[] exprBodies = new String[] {
					"\'State\'", //$NON-NLS-1$
					"\'entry / \'.concat(if self.action.oclIsUndefined() then \'\' else \'{\'.concat(self.action.name).concat(\'}\') endif)", //$NON-NLS-1$
					"\'action\'", //$NON-NLS-1$
					"\'do / \'.concat(if self.action.oclIsUndefined() then \'\' else \'{\'.concat(self.action.name).concat(\'}\') endif)", //$NON-NLS-1$
					"\'exit / \'.concat(if self.action.oclIsUndefined() then \'\' else \'{\'.concat(self.action.name).concat(\'}\') endif)", //$NON-NLS-1$
