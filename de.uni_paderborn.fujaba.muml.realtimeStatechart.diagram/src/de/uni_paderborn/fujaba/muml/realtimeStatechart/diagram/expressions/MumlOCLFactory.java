	...
	public static de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.expressions.MumlAbstractExpression getExpression(
		...
		if (cached.expressions[index] == null) {
			final String[] exprBodies = new String[] {
					...
					"not (self.oclIsKindOf(EntryPoint) and (not oppositeEnd.oclIsKindOf(State) and not oppositeEnd.oclIsKindOf(StateEntryPoint))) and\nnot (self.oclIsKindOf(ExitPoint) and (not oppositeEnd.oclIsKindOf(State) and not oppositeEnd.oclIsKindOf(StateExitPoint)))", //$NON-NLS-1$
			};
