 ...
 * @generated
 */
public class Transition2EditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.edit.policies.Transition2ItemSemanticEditPolicy());
	}
