 ...
 * @generated
 */
public class FujabaRealtimeStatechartStatechartContentsCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenViewDescriptors() {
		...
		if (!isTopLevelCanonical()) {
			...
			for (View childView : childViews) {
				...
				int visualID = de.uni_paderborn.fujaba.muml.realtimeStatechart.diagram.edit.parts.StateEditPart.VISUAL_ID;
